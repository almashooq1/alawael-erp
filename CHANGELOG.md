...
Sprint suite: **299 passing** (was 274 at 4.0.8).
• +3 rate-limit e2e + 4 request-id contract + 9 provider-registry
consistency (8 touchpoints) + 6 doc-count consistency + 3
