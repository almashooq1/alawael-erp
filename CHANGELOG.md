...
Sprint suite: **298 passing** (was 274 at 4.0.8).
• +3 rate-limit e2e + 4 request-id contract + 8 provider-registry
consistency + 6 doc-count consistency + 3 variant-match assertions
