 ...
 * 
 * @param {AuthenticationService} authService - Mock auth service
 * @param {OAuth2Provider} oauth2Service - Mock OAuth2 provider
 ...
 */
function setServiceInstances(authService, oauth2Service, securityService, userService, permissionService) {
  authenticationServiceInstance = authService;
