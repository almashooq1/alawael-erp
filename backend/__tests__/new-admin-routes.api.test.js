...
describe('Route mounting — new sprint routes are registered', () => {
  const GET_ROUTES = [
    ...
    '/api/admin/nps',
    '/api/admin/nps/overview',
    '/api/admin/nps/trend',
    '/api/admin/nps/themes',
    '/api/admin/nps/export.csv',
    '/api/admin/goal-progress',
    '/api/admin/goal-progress/overview',
    '/api/admin/goal-progress/export.csv',
    '/api/admin/utilization',
    '/api/admin/utilization/leaderboard',
    '/api/admin/utilization/export.csv',
    '/api/admin/waitlist',
    '/api/admin/waitlist/overview',
    '/api/admin/waitlist/prioritized',
    '/api/admin/waitlist/export.csv',
    '/api/admin/referrals',
    '/api/admin/referrals/overview',
    '/api/admin/referrals/top-referrers',
    '/api/admin/referrals/close-loop-gaps',
    '/api/admin/referrals/trend',
    '/api/admin/referrals/export.csv',
    '/api/admin/revenue/overview',
    '/api/admin/revenue/aging',
    '/api/admin/revenue/top-debtors',
    '/api/admin/revenue/trend',
    '/api/admin/revenue/export.csv',
    '/api/admin/claims-analytics/overview',
    '/api/admin/claims-analytics/rejection-reasons',
    '/api/admin/claims-analytics/by-insurer',
    '/api/admin/claims-analytics/trend',
    '/api/admin/claims-analytics/export.csv',
    '/api/admin/revenue-forecast/overview',
    '/api/admin/revenue-forecast/cohorts',
    '/api/admin/revenue-forecast/velocity',
    '/api/admin/revenue-forecast/history',
    '/api/admin/retention/overview',
    '/api/admin/retention/at-risk',
    '/api/admin/retention/cohorts',
    '/api/admin/retention/by-service',
    '/api/admin/retention/trend',
    '/api/admin/retention/export.csv',
    '/api/admin/complaints-analytics/overview',
    '/api/admin/complaints-analytics/by-category',
    '/api/admin/complaints-analytics/by-submitter',
    '/api/admin/complaints-analytics/trend',
    '/api/admin/complaints-analytics/backlog',
    '/api/admin/complaints-analytics/sla-breaches',
    '/api/admin/complaints-analytics/export.csv',
    '/api/admin/saudization/overview',
    '/api/admin/saudization/trend',
    '/api/admin/saudization/history',
    '/api/admin/saudization/runway',
    '/api/admin/onboarding',
    '/api/admin/onboarding/overview',
    '/api/admin/onboarding/by-status',
    '/api/admin/onboarding/task-completion',
    '/api/admin/onboarding/by-responsible',
    '/api/admin/onboarding/stalled',
    '/api/admin/onboarding/trend',
    '/api/admin/onboarding/export.csv',
    '/api/admin/incidents-analytics/overview',
    '/api/admin/incidents-analytics/by-severity',
    '/api/admin/incidents-analytics/by-category',
    '/api/admin/incidents-analytics/root-causes',
    '/api/admin/incidents-analytics/trend',
    '/api/admin/incidents-analytics/backlog',
    '/api/admin/incidents-analytics/export.csv',
    '/api/admin/document-expiry/overview',
    '/api/admin/document-expiry/radar',
    '/api/admin/document-expiry/by-category',
    '/api/admin/document-expiry/upcoming',
    '/api/admin/document-expiry/export.csv',
