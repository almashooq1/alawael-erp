...
/**
 * notify-channel-email-wave518.test.js — Wave 518.
 *
...
describe('W518 — wireEmailNotificationChannel', () => {
  test('throws on missing integrationBus', () => {
    expect(() => service.wireEmailNotificationChannel({ integrationBus: {} })).toThrow(
      /subscribe/
    );
  });
