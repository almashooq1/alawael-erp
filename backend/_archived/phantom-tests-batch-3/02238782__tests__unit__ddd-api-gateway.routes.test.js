/**
 * Auto-generated unit tests for routes/ddd-api-gateway.routes.js
...
jest.mock('../../services/dddApiGateway', () => new Proxy({}, { get: () => jest.fn().mockResolvedValue({}) }));
...
let routeModule;
try { routeModule = require('../../routes/ddd-api-gateway.routes'); } catch(e) { /* load fail */ }

describe('routes/ddd-api-gateway.routes', () => {
