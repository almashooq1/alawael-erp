/**
 * Auto-generated unit tests for routes/ddd-collaboration-hub.routes.js
...
jest.mock('../../services/dddCollaborationHub', () => new Proxy({}, { get: () => jest.fn().mockResolvedValue({}) }));
...
jest.mock('../../validations/collaboration-hub.validation', () => new Proxy({}, { get: (t, p) => p === '__esModule' ? false : jest.fn() }));

let routeModule;
try { routeModule = require('../../routes/ddd-collaboration-hub.routes'); } catch(e) { /* load fail */ }

describe('routes/ddd-collaboration-hub.routes', () => {
