/**
 * Auto-generated unit tests for routes/ddd-access-control.routes.js
...
jest.mock('../../services/dddAccessControl', () => new Proxy({}, { get: () => jest.fn().mockResolvedValue({}) }));
...
let routeModule;
try { routeModule = require('../../routes/ddd-access-control.routes'); } catch(e) { /* load fail */ }

describe('routes/ddd-access-control.routes', () => {
