/**
 * Auto-generated unit tests for routes/ddd-resource-manager.routes.js
...
jest.mock('../../services/dddResourceManager', () => new Proxy({}, { get: () => jest.fn().mockResolvedValue({}) }));

let routeModule;
try { routeModule = require('../../routes/ddd-resource-manager.routes'); } catch(e) { /* load fail */ }

describe('routes/ddd-resource-manager.routes', () => {
