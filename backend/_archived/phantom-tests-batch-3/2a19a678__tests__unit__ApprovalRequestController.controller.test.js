...
// Auto-generated unit test for controllers/ApprovalRequestController
...
jest.mock('../../services/notificationService', () => new Proxy({}, { get: () => jest.fn().mockResolvedValue({}) }));
...
let ctrl;
try { ctrl = require('../../controllers/ApprovalRequestController'); } catch (e) { ctrl = null; }

describe('ApprovalRequestController controller', () => {
