/**
 * Auto-generated unit tests for routes/ddd-task-queue.routes.js
...
jest.mock('../../services/dddTaskQueue', () => new Proxy({}, { get: () => jest.fn().mockResolvedValue({}) }));
...
jest.mock('../../validations/task-queue.validation', () => new Proxy({}, { get: (t, p) => p === '__esModule' ? false : jest.fn() }));

let routeModule;
try { routeModule = require('../../routes/ddd-task-queue.routes'); } catch(e) { /* load fail */ }

describe('routes/ddd-task-queue.routes', () => {
