/**
 * Auto-generated unit tests for routes/ddd-feature-flags.routes.js
...
jest.mock('../../services/dddFeatureFlags', () => new Proxy({}, { get: () => jest.fn().mockResolvedValue({}) }));
...
jest.mock('../../validations/feature-flags.validation', () => new Proxy({}, { get: (t, p) => p === '__esModule' ? false : jest.fn() }));

let routeModule;
try { routeModule = require('../../routes/ddd-feature-flags.routes'); } catch(e) { /* load fail */ }

describe('routes/ddd-feature-flags.routes', () => {
