/**
 * Auto-generated unit tests for models/TrafficFine.js
...
mockModelFn.modelName = 'TrafficFine';
...
let Model;
try { Model = require('../../models/TrafficFine'); } catch(e) { /* load fail */ }

describe('models/TrafficFine', () => {
