/**
 * Auto-generated unit tests for routes/ddd-analytics-dashboard.routes.js
...
jest.mock('../../services/dddAnalyticsDashboard', () => new Proxy({}, { get: () => jest.fn().mockResolvedValue({}) }));
...
jest.mock('../../validations/analytics-dashboard.validation', () => new Proxy({}, { get: (t, p) => p === '__esModule' ? false : jest.fn() }));

let routeModule;
try { routeModule = require('../../routes/ddd-analytics-dashboard.routes'); } catch(e) { /* load fail */ }

describe('routes/ddd-analytics-dashboard.routes', () => {
