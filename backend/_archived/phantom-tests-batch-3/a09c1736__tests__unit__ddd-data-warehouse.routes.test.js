/**
 * Auto-generated unit tests for routes/ddd-data-warehouse.routes.js
...
jest.mock('../../services/dddDataWarehouse', () => new Proxy({}, { get: () => jest.fn().mockResolvedValue({}) }));
...
let routeModule;
try { routeModule = require('../../routes/ddd-data-warehouse.routes'); } catch(e) { /* load fail */ }

describe('routes/ddd-data-warehouse.routes', () => {
