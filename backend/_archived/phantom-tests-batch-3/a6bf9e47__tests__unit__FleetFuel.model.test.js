/**
 * Auto-generated unit tests for models/FleetFuel.js
...
mockModelFn.modelName = 'FleetFuel';
...
let Model;
try { Model = require('../../models/FleetFuel'); } catch(e) { /* load fail */ }

describe('models/FleetFuel', () => {
