/**
 * Auto-generated unit tests for routes/reporting.routes.js
...
let routeModule;
try { routeModule = require('../../routes/reporting.routes'); } catch(e) { /* load fail */ }

describe('routes/reporting.routes', () => {
