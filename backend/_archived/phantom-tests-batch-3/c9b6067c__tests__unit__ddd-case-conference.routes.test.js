/**
 * Auto-generated unit tests for routes/ddd-case-conference.routes.js
...
jest.mock('../../services/dddCaseConference', () => new Proxy({}, { get: () => jest.fn().mockResolvedValue({}) }));
...
jest.mock('../../validations/case-conference.validation', () => new Proxy({}, { get: (t, p) => p === '__esModule' ? false : jest.fn() }));

let routeModule;
try { routeModule = require('../../routes/ddd-case-conference.routes'); } catch(e) { /* load fail */ }

describe('routes/ddd-case-conference.routes', () => {
