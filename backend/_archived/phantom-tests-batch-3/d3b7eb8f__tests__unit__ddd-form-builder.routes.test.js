/**
 * Auto-generated unit tests for routes/ddd-form-builder.routes.js
...
jest.mock('../../services/dddFormBuilder', () => new Proxy({}, { get: () => jest.fn().mockResolvedValue({}) }));

let routeModule;
try { routeModule = require('../../routes/ddd-form-builder.routes'); } catch(e) { /* load fail */ }

describe('routes/ddd-form-builder.routes', () => {
