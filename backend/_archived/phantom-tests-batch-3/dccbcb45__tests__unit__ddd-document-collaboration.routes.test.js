/**
 * Auto-generated unit tests for routes/ddd-document-collaboration.routes.js
...
jest.mock('../../services/dddDocumentCollaboration', () => new Proxy({}, { get: () => jest.fn().mockResolvedValue({}) }));
...
jest.mock('../../validations/document-collaboration.validation', () => new Proxy({}, { get: (t, p) => p === '__esModule' ? false : jest.fn() }));

let routeModule;
try { routeModule = require('../../routes/ddd-document-collaboration.routes'); } catch(e) { /* load fail */ }

describe('routes/ddd-document-collaboration.routes', () => {
