/**
 * Auto-generated unit tests for models/Geofence.js
...
mockModelFn.modelName = 'Geofence';
...
let Model;
try { Model = require('../../models/Geofence'); } catch(e) { /* load fail */ }

describe('models/Geofence', () => {
