...
const ResourceSchema = new mongoose.Schema({
  ...
  info: {
    ...
    type: { type: String, enum: ['equipment', 'furniture', 'vehicle', 'device', 'supply', 'other'] },
    category: String,
    description: String,
    brand: String,
    model: String,
...
class CenterAdministrationService extends EventEmitter {
  ...
  async initialize(connection) {
    ...
    console.log('✅ Center Administration Service initialized');
  }
  ...
  async updateStatistics(centerId) {
    ...
    const staffCount = await this.Staff.countDocuments({ 'employment.centerId': centerId, status: 'active' });
