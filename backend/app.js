...
// Extracted to startup/mfaChallengeBootstrap.js (W277 / Pass 6 — final).
// MUST run BEFORE beneficiaryLifecycleBootstrap (Pass 5) which reads
// app._mfaChallengeService — call order in this file is the ordering invariant.
require('./startup/mfaChallengeBootstrap').wireMfaChallenge(app, { logger });

// ─── Beneficiary 360 Phase 2 — Lifecycle Routes (Wave 40+95) ────────────────
// Extracted to startup/beneficiaryLifecycleBootstrap.js (W277 / Pass 5 of app.js refactor).
...
// Identical behaviour: same service-construction order, same /api/v1/access-review
...
// mount order, same app._hikvisionXxx assignments. See ADR-019 + W276 drift
...
// ─── Parent Chatbot + LLM Telemetry/Anomalies (Wave 120 / 131 / 142+144+146+147) ──
// Extracted to startup/parentChatbotBootstrap.js (W277 / Pass 2 of app.js refactor).
// Identical behaviour: same models, same wiring order, same app._xxx assignments,
// same /api/v1/parent/chatbot + /api/v1/ai/llm-telemetry + /api/v1/ai/llm-anomalies
// routes, same periodic 10-min scan + dispatch timer.
require('./startup/parentChatbotBootstrap').wireParentChatbot(app, { logger });
...
// Extracted to startup/carePlanningBootstrap.js (W277 / Pass 3 of app.js refactor).
