...
const P = Object.freeze({
  ...
  WHATSAPP_BENEFICIARY_CONTEXT: 'whatsapp:beneficiary:context',
  WHATSAPP_NOTES_INTERNAL: 'whatsapp:notes:internal',
...
const META = Object.freeze({
  ...
  'whatsapp:beneficiary:context': {
    tier: 2,
    phi: true,
    hqOnly: false,
    sod: null,
  },
  'whatsapp:notes:internal': {
    tier: 2,
    phi: true,
    hqOnly: false,
    sod: null,
...
const ROLE_GRANTS = Object.freeze({
  ...
  EXD: {
    ...
    'whatsapp:beneficiary:context': 'G·BG',
    'whatsapp:notes:internal': 'G·BG',
  ...
  BRM: {
    ...
    'whatsapp:beneficiary:context': 'B',
    'whatsapp:notes:internal': 'B',
  ...
  UNS: {
    ...
    'whatsapp:beneficiary:context': 'U',
    'whatsapp:notes:internal': 'U',
  ...
  THR: {
    ...
    'whatsapp:beneficiary:context': 'S',
    'whatsapp:notes:internal': 'S',
  ...
  AUD: {
    ...
    'whatsapp:beneficiary:context': 'G',
    'whatsapp:notes:internal': 'G',
    'beneficiary:billing:read': 'G',
    'assessment:record:read': 'G',
    'treatment_plan:plan:read': 'G',
    'session:note:read': 'G',
...
const ROLE_DENY = Object.freeze({
  ...
  EXD: ['user:account:create', 'rbac:policy:manage', 'audit:log:update', 'audit:log:delete'],
  BRM: ['user:account:create', 'rbac:policy:manage', 'audit:log:update', 'audit:log:delete'],
  AUD: ['user:account:create', 'rbac:policy:manage', 'audit:log:update', 'audit:log:delete'],
});

/** archetype-code → canonical archetype name (for the live-role bridge). */
const ARCHETYPES = Object.freeze({
  HQA: 'HQ_ADMIN',
  EXD: 'EXECUTIVE_DIRECTOR',
  BRM: 'BRANCH_MANAGER',
  UNS: 'UNIT_SUPERVISOR',
  THR: 'THERAPIST',
  REC: 'RECEPTIONIST',
