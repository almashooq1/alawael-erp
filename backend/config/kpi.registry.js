...
const KPIS = Object.freeze([
  ...
  // ─── CBAHI / Saudi-specific indicators (Phase 2.4) ─────────────
  {
    id: 'clinical.pediatric.immunization.coverage.pct',
    nameEn: 'Pediatric immunization coverage',
    nameAr: 'نسبة تغطية التطعيمات pediatric',
    domain: 'clinical',
    unit: 'percent',
    direction: 'higher_is_better',
    target: 95,
    ...
    criticalThreshold: 70,
    dataSource: {
      service: 'clinicalMetricsService',
      method: 'pediatricImmunizationCoverage',
      path: 'coveragePct',
    },
    owner: 'clinical_director',
  ...
  {
    id: 'quality.patient_safety.incidents.per_1000_sessions',
    nameEn: 'Patient safety incidents per 1,000 sessions',
    nameAr: 'حوادث سلامة المرضى لكل 1000 جلسة',
    domain: 'quality',
    unit: 'ratio',
    direction: 'lower_is_better',
    target: 1,
  ...
  {
    id: 'compliance.consent.completion.pct',
    nameEn: 'Consent completion rate',
    nameAr: 'نسبة إكمال الموافقات',
    domain: 'compliance',
    unit: 'percent',
    direction: 'higher_is_better',
    target: 98,
    ...
    dataSource: {
      service: 'consentComplianceService',
      method: 'completionSummary',
      path: 'completedPct',
    },
    owner: 'compliance_officer',
  ...
  {
    id: 'hr.scfhs.licensure.compliance.pct',
    nameEn: 'SCFHS licensure compliance',
    nameAr: 'نسبة امتثال تراخيص الهيئة السعودية للتخصصات الصحية',
    domain: 'hr',
    unit: 'percent',
    direction: 'higher_is_better',
    target: 100,
    ...
    dataSource: {
      service: 'hrAnalyticsService',
      method: 'scfhsLicensureCompliance',
      path: 'compliancePct',
    },
    owner: 'hr_manager',
    compliance: ['SCFHS', 'CBAHI'],
    frequency: 'monthly',
  },
  {
    id: 'finance.pre_auth.approval_rate.pct',
    nameEn: 'Pre-authorization approval rate',
    nameAr: 'نسبة الموافقة على التفويض المسبق',
    domain: 'finance',
    unit: 'percent',
    direction: 'higher_is_better',
    target: 90,
    ...
    dataSource: {
      service: 'financeReportBuilder',
      method: 'preAuthApprovalRate',
      path: 'approvalRatePct',
    },
    owner: 'finance_supervisor',
    compliance: ['CCHI', 'NPHIES'],
    frequency: 'monthly',
  ...
  {
    id: 'rehab.fim.delta.mean',
    nameEn: 'Mean FIM score delta',
    nameAr: 'متوسط التغير في درجة FIM',
    domain: 'rehab',
    unit: 'score',
    direction: 'higher_is_better',
    target: 10,
  ...
  {
    id: 'rehab.assessments.reassessment.ontime.pct',
    nameEn: 'On-time reassessment rate',
    nameAr: 'نسبة إعادة التقييم في موعدها',
    domain: 'rehab',
    unit: 'percent',
    direction: 'higher_is_better',
    target: 95,
  ...
  {
    id: 'rehab.wait_time.plan_start.mean_days',
    nameEn: 'Mean wait time to plan start',
    nameAr: 'متوسط وقت انتظار بدء الخطة (أيام)',
    domain: 'rehab',
    unit: 'days',
    direction: 'lower_is_better',
    target: 7,
