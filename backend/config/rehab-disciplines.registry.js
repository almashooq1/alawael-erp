...
const DISCIPLINES = Object.freeze([
  ...
  // ─── Developmental ───────────────────────────────────────────────
  {
    ...
    kpiLinks: [
      ...
      'rehab.goals.achievement_rate.pct',
      'rehab.care_plan.review.ontime.pct',
      'rehab.family.engagement.pct',
      'communications.parent_portal.activation.pct',
    ],
    redFlagLinks: [
      'clinical.progress.regression.significant',
      'clinical.goal.stalled.21d',
