...
const ROUTES = [
  ...
  { path: "/api/v1/early-intervention", file: "routes/early-intervention.routes", auth: false, phase: "migrated", description: "early-intervention (legacy migration v2)", dualMount: true },
  { path: "/api/v1/post-rehab-followup", file: "routes/post-rehab-followup.routes", auth: false, phase: "migrated", description: "post-rehab-followup (legacy migration v2)", dualMount: true },
  { path: "/api/v1/independent-living", file: "routes/independentLiving.routes", auth: true, phase: "migrated", description: "independent-living (legacy migration v2)", dualMount: true },
  { path: "/api/v1/mhpss", file: "routes/mhpss.routes", auth: false, phase: "migrated", description: "mhpss (legacy migration v2)", dualMount: true },
  { path: "/api/v1/mdt-coordination", file: "routes/mdt-coordination.routes", auth: false, phase: "migrated", description: "mdt-coordination (legacy migration v2)", dualMount: true },
  { path: "/api/v1/measures-workflow", file: "routes/measures-workflow.routes", auth: false, phase: "migrated", description: "measures-workflow (legacy migration v2)", dualMount: true },
  { path: "/api/v1/measures-outcomes", file: "routes/measures-outcomes.routes", auth: false, phase: "migrated", description: "measures-outcomes (legacy migration v2)", dualMount: true },
  { path: "/api/v1/therapist-pro", file: "routes/therapistPro.routes", auth: false, phase: "migrated", description: "therapist-pro (legacy migration v2)", dualMount: true },
  { path: "/api/v1/therapist-ultra", file: "routes/therapistUltra.routes", auth: false, phase: "migrated", description: "therapist-ultra (legacy migration v2)", dualMount: true },
  { path: "/api/v1/therapist-elite", file: "routes/therapistElite.routes", auth: false, phase: "migrated", description: "therapist-elite (legacy migration v2)", dualMount: true },
  { path: "/api/v1/ai-communications", file: "routes/aiCommunication.routes", auth: false, phase: "migrated", description: "ai-communications (legacy migration v2)", dualMount: true },
  { path: "/api/v1/admin-communications", file: "routes/admin-communications.routes", auth: false, phase: "migrated", description: "admin-communications (legacy migration v2)", dualMount: true },
  { path: "/api/v1/admin-comm-enhanced", file: "routes/admin-comm-enhanced.routes", auth: false, phase: "migrated", description: "admin-comm-enhanced (legacy migration v2)", dualMount: true },
  { path: "/api/v1/electronic-directives", file: "routes/electronic-directives.routes", auth: false, phase: "migrated", description: "electronic-directives (legacy migration v2)", dualMount: true },
  { path: "/api/v1/communication-module", file: "routes/communication-module.routes", auth: false, phase: "migrated", description: "communication-module (legacy migration v2)", dualMount: true },
  { path: "/api/v1/notifications-module", file: "routes/notifications-module.routes", auth: false, phase: "migrated", description: "notifications-module (legacy migration v2)", dualMount: true },
  { path: "/api/v1/documents-smart", file: "routes/documents.smart.routes", auth: false, phase: "migrated", description: "documents-smart (legacy migration v2)", dualMount: true },
  { path: "/api/v1/documents-advanced", file: "routes/documentAdvanced.routes", auth: false, phase: "migrated", description: "documents-advanced (legacy migration v2)", dualMount: true },
  { path: "/api/v1/form-templates", file: "routes/formTemplate.routes", auth: false, phase: "migrated", description: "form-templates (legacy migration v2)", dualMount: true },
  { path: "/api/v1/media", file: "routes/media.routes", auth: false, phase: "migrated", description: "media (legacy migration v2)", dualMount: true },
  { path: "/api/v1/files-module", file: "routes/files-module.routes", auth: false, phase: "migrated", description: "files-module (legacy migration v2)", dualMount: true },
  { path: "/api/v1/document-center", file: "routes/document-center.routes", auth: false, phase: "migrated", description: "document-center (legacy migration v2)", dualMount: true },
  { path: "/api/v1/academic-years", file: "routes/academicYear.routes", auth: false, phase: "migrated", description: "academic-years (legacy migration v2)", dualMount: true },
  { path: "/api/v1/subjects", file: "routes/subjects.routes", auth: false, phase: "migrated", description: "subjects (legacy migration v2)", dualMount: true },
  { path: "/api/v1/teachers", file: "routes/teachers.routes", auth: false, phase: "migrated", description: "teachers (legacy migration v2)", dualMount: true },
  { path: "/api/v1/classrooms", file: "routes/classrooms.routes", auth: false, phase: "migrated", description: "classrooms (legacy migration v2)", dualMount: true },
  { path: "/api/v1/curriculum", file: "routes/curriculum.routes", auth: false, phase: "migrated", description: "curriculum (legacy migration v2)", dualMount: true },
  { path: "/api/v1/timetable", file: "routes/timetable.routes", auth: false, phase: "migrated", description: "timetable (legacy migration v2)", dualMount: true },
  { path: "/api/v1/exams", file: "routes/exams.routes", auth: false, phase: "migrated", description: "exams (legacy migration v2)", dualMount: true },
  { path: "/api/v1/gradebook", file: "routes/gradebook.routes", auth: false, phase: "migrated", description: "gradebook (legacy migration v2)", dualMount: true },
  { path: "/api/v1/finance-operations", file: "routes/financeOperations.routes", auth: false, phase: "migrated", description: "finance-operations (legacy migration v2)", dualMount: true },
  { path: "/api/v1/finance-module", file: "routes/finance-module.routes", auth: false, phase: "migrated", description: "finance-module (legacy migration v2)", dualMount: true },
  { path: "/api/v1/hr-advanced", file: "routes/hrAdvanced.routes", auth: false, phase: "migrated", description: "hr-advanced (legacy migration v2)", dualMount: true },
  { path: "/api/v1/hr-unified", file: "routes/hrUnified.routes", auth: false, phase: "migrated", description: "hr-unified (legacy migration v2)", dualMount: true },
  { path: "/api/v1/gratuity", file: "routes/gratuity.routes", auth: false, phase: "migrated", description: "gratuity (legacy migration v2)", dualMount: true },
  { path: "/api/v1/succession-planning", file: "routes/successionPlanning.routes", auth: false, phase: "migrated", description: "succession-planning (legacy migration v2)", dualMount: true },
  { path: "/api/v1/smart-attendance", file: "routes/smart_attendance.routes", auth: false, phase: "migrated", description: "smart-attendance (legacy migration v2)", dualMount: true },
  { path: "/api/v1/hr-insurance", file: "routes/hr-insurance.routes", auth: false, phase: "migrated", description: "hr-insurance (legacy migration v2)", dualMount: true },
  { path: "/api/v1/hr-smart", file: "routes/hr-smart.routes", auth: false, phase: "migrated", description: "hr-smart (legacy migration v2)", dualMount: true },
  { path: "/api/v1/hr-module", file: "routes/hr-module.routes", auth: false, phase: "migrated", description: "hr-module (legacy migration v2)", dualMount: true },
  { path: "/api/v1/import-export-pro", file: "routes/importExportPro.routes", auth: false, phase: "migrated", description: "import-export-pro (legacy migration v2)", dualMount: true },
  { path: "/api/v1/strategic-planning", file: "routes/strategicPlanning.routes", auth: false, phase: "migrated", description: "strategic-planning (legacy migration v2)", dualMount: true },
  { path: "/api/v1/student-reports", file: "routes/studentReports.routes", auth: false, phase: "migrated", description: "student-reports (legacy migration v2)", dualMount: true },
  { path: "/api/v1/student-management", file: "routes/student-management.routes", auth: false, phase: "migrated", description: "student-management (legacy migration v2)", dualMount: true },
  { path: "/api/v1/student-complaints", file: "routes/student-complaints.routes", auth: false, phase: "migrated", description: "student-complaints (legacy migration v2)", dualMount: true },
  { path: "/api/v1/student-certificates", file: "routes/student-certificates.routes", auth: false, phase: "migrated", description: "student-certificates (legacy migration v2)", dualMount: true },
  { path: "/api/v1/student-health", file: "routes/student-health-tracker.routes", auth: false, phase: "migrated", description: "student-health (legacy migration v2)", dualMount: true },
  { path: "/api/v1/student-rewards", file: "routes/student-rewards-store.routes", auth: false, phase: "migrated", description: "student-rewards (legacy migration v2)", dualMount: true },
  { path: "/api/v1/student-events", file: "routes/student-events.routes", auth: false, phase: "migrated", description: "student-events (legacy migration v2)", dualMount: true },
  { path: "/api/v1/student-elearning", file: "routes/student-elearning.routes", auth: false, phase: "migrated", description: "student-elearning (legacy migration v2)", dualMount: true },
  { path: "/api/v1/parents", file: "routes/parents.routes", auth: false, phase: "migrated", description: "parents (legacy migration v2)", dualMount: true },
  { path: "/api/v1/parent-portal-enhanced", file: "routes/parent-portal-enhanced.routes", auth: false, phase: "migrated", description: "parent-portal-enhanced (legacy migration v2)", dualMount: true },
  { path: "/api/v1/inspection-submissions", file: "routes/inspectionSubmission.routes", auth: false, phase: "migrated", description: "inspection-submissions (legacy migration v2)", dualMount: true },
