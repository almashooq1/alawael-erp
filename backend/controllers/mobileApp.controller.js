...
exports.registerDevice = async (req, res) => {
  try {
    ...
    return errorResponse(res, 500, 'حدث خطأ داخلي', 'خطأ في تسجيل الجهاز');
  }
};
...
exports.getUserDevices = async (req, res) => {
  try {
    ...
    return errorResponse(res, 500, 'حدث خطأ داخلي', 'خطأ في الحصول على الأجهزة');
  }
};
...
exports.trustDevice = async (req, res) => {
  try {
    ...
    return errorResponse(res, 500, 'حدث خطأ داخلي', 'خطأ في تفعيل الثقة');
  }
};
...
exports.untrustDevice = async (req, res) => {
  try {
    ...
    return errorResponse(res, 500, 'حدث خطأ داخلي', 'خطأ في إزالة الثقة');
  }
};
...
exports.enableBiometric = async (req, res) => {
  try {
    ...
    return errorResponse(res, 500, 'حدث خطأ داخلي', 'خطأ في تفعيل البيومتري');
  }
};
...
exports.deleteDevice = async (req, res) => {
  try {
    ...
    return errorResponse(res, 500, 'حدث خطأ داخلي', 'خطأ في حذف الجهاز');
  }
};
...
exports.getPendingOperations = async (req, res) => {
  try {
    ...
    return errorResponse(res, 500, 'حدث خطأ داخلي', 'خطأ في الحصول على العمليات');
  }
};
...
exports.queueOperation = async (req, res) => {
  try {
    ...
    return errorResponse(res, 500, 'حدث خطأ داخلي', 'خطأ في إضافة العملية');
  }
};
...
exports.syncOperations = async (req, res) => {
  try {
    ...
    return errorResponse(res, 500, 'حدث خطأ داخلي', 'خطأ في المزامنة');
  }
};
...
exports.getSyncStatus = async (req, res) => {
  try {
    ...
    return errorResponse(res, 500, 'حدث خطأ داخلي', 'خطأ في الحصول على الحالة');
  }
};
...
exports.resolveConflict = async (req, res) => {
  try {
    ...
    return errorResponse(res, 500, 'حدث خطأ داخلي', 'خطأ في حل التعارض');
  }
};
...
exports.sendPushNotification = async (req, res) => {
  try {
    ...
    return errorResponse(res, 500, 'حدث خطأ داخلي', 'خطأ في إرسال الإشعار');
  }
};
...
exports.sendBatchNotifications = async (req, res) => {
  try {
    ...
    return errorResponse(res, 500, 'حدث خطأ داخلي', 'خطأ في إرسال الدفعة');
  }
};
...
exports.registerPushToken = async (req, res) => {
  try {
    ...
    return errorResponse(res, 500, 'حدث خطأ داخلي', 'خطأ في التسجيل');
  }
};
...
exports.testPushDelivery = async (req, res) => {
  try {
    ...
    return errorResponse(res, 500, 'حدث خطأ داخلي', 'خطأ في الاختبار');
  }
};
...
exports.getPushStats = async (req, res) => {
  try {
    ...
    return errorResponse(res, 500, 'حدث خطأ داخلي', 'خطأ في الإحصائيات');
  }
};
...
exports.startSession = async (req, res) => {
  try {
    ...
    return errorResponse(res, 500, 'حدث خطأ داخلي', 'خطأ في بدء الجلسة');
  }
};
...
exports.endSession = async (req, res) => {
  try {
    ...
    return errorResponse(res, 500, 'حدث خطأ داخلي', 'خطأ في إنهاء الجلسة');
  }
};
...
exports.trackEvent = async (req, res) => {
  try {
    ...
    return errorResponse(res, 500, 'حدث خطأ داخلي', 'خطأ في التتبع');
  }
};
...
exports.logCrash = async (req, res) => {
  try {
    ...
    return errorResponse(res, 500, 'حدث خطأ داخلي', 'خطأ في تقرير التوقف');
  }
};
...
exports.getUserAnalytics = async (req, res) => {
  try {
    ...
    return errorResponse(res, 500, 'حدث خطأ داخلي', 'خطأ في التحليلات');
  }
};
...
exports.getCrashReport = async (req, res) => {
  try {
    ...
    return errorResponse(res, 500, 'حدث خطأ داخلي', 'خطأ في التقرير');
  }
};
...
exports.getPerformanceReport = async (req, res) => {
  try {
    ...
    return errorResponse(res, 500, 'حدث خطأ داخلي', 'خطأ في تقرير الأداء');
  }
};
