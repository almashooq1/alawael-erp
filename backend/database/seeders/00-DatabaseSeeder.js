...
async function runSeeders() {
  ...
  try {
    ...
    console.log('═══════════════════════════════════════════');
    console.log('  🔑 مدير النظام:       admin@alawael.com');
    console.log('  🔑 مدير فرع الرياض:   ahmed.amri@rehab-center.sa');
    console.log('  🔑 أخصائية نطق:       noura.qahtani@rehab-center.sa');
    console.log('  🔑 موظفة استقبال:      maha.rajhi@rehab-center.sa');
    console.log('  🔑 محاسب:             adel.namri@rehab-center.sa');
    console.log('');
    console.log('  ⚠️  كلمات المرور محددة في ملف 02-UsersSeeder.js');
