...
const unifiedCarePlanSchema = new mongoose.Schema(
  {
    ...
    // ── W1259 — family-friendly version (same shape as CarePlanVersion's;
    // generated by the W43 generator via its unified adapter; consumed by
    // the notify_family side-effect + the W45 retry worker) ───────────
    familyVersion: {
