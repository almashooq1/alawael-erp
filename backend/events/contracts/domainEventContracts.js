...
// ═══════════════════════════════════════════════════════════════════════════════
//  Documents Domain Events — أحداث المستندات (W392)
// ═══════════════════════════════════════════════════════════════════════════════
...
const DOCUMENT_EVENTS = {
  UPLOADED: {
    ...
    version: 1,
    description: 'تم رفع مستند — Document uploaded',
    payload: {
      documentId: 'string',
      entityType: 'string',
      entityId: 'string',
  ...
  UPDATED: {
    ...
    version: 1,
    description: 'تم تحديث مستند — Document updated',
    payload: {
      documentId: 'string',
      entityType: 'string',
      entityId: 'string',
  ...
  RESTORED: {
    ...
    version: 1,
    description: 'تم استعادة مستند — Document restored',
    payload: {
      documentId: 'string',
      entityType: 'string',
      entityId: 'string',
  ...
  SHARED: {
    ...
    version: 1,
    description: 'تم مشاركة مستند — Document shared',
    payload: {
      documentId: 'string',
      entityType: 'string',
      entityId: 'string',
