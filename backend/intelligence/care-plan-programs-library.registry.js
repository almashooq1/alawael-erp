...
const PROGRAMS = Object.freeze([
  ...
  // ─── W1246: multi-discipline expansion (slp/ot/pt/behavior/edu/life/voc) ───
  {
    id: 'pgm.slp.early_language',
    name: 'Early Language Intervention',
    nameAr: 'التدخل اللغوي المبكر',
    modality: 'slp',
    domains: ['receptive_language', 'expressive_language'],
    ageBand: [1, 7],
    indications: ['F80.1', 'F80.2', 'F84.0'],
    contraindications: [],
    minSessionsPerWeek: 1,
    maxSessionsPerWeek: 3,
    sessionDurationMinRange: [30, 45],
    evidenceLevel: 'strong',
    citations: ['ASHA 2008 — Early Intervention'],
  },
  {
    id: 'pgm.slp.fluency',
    name: 'Fluency Therapy (Stuttering)',
    nameAr: 'علاج الطلاقة (التلعثم)',
    modality: 'slp',
    domains: ['expressive_language'],
    ageBand: [5, 18],
    indications: ['F98.5'],
    ...
    sessionDurationMinRange: [40, 60],
    evidenceLevel: 'strong',
    citations: ['Onslow 2003 — Lidcombe Program'],
  },
  {
    id: 'pgm.slp.dysphagia',
    name: 'Feeding & Swallowing Therapy',
    nameAr: 'علاج اضطرابات التغذية والبلع',
    modality: 'slp',
    domains: ['adl'],
    ageBand: [1, 12],
    indications: ['R13.1', 'F98.2'],
    contraindications: [],
    minSessionsPerWeek: 1,
    maxSessionsPerWeek: 3,
    sessionDurationMinRange: [30, 45],
    evidenceLevel: 'moderate',
    citations: ['ASHA — Pediatric Feeding & Swallowing'],
  },
  {
    id: 'pgm.ot.adl_independence',
    name: 'ADL Independence Training',
    nameAr: 'تدريب الاستقلالية في أنشطة الحياة اليومية',
    modality: 'ot',
    domains: ['adl'],
    ageBand: [3, 18],
    indications: ['F84.0', 'F70', 'F71', 'F82'],
    contraindications: [],
    minSessionsPerWeek: 1,
    maxSessionsPerWeek: 4,
    sessionDurationMinRange: [30, 60],
    evidenceLevel: 'strong',
    citations: ['AOTA 2020 — OT Practice Framework'],
  },
  {
    id: 'pgm.pt.gait_balance',
    name: 'Gait & Balance Training',
    nameAr: 'تدريب المشي والتوازن',
    modality: 'pt',
    domains: ['gross_motor'],
    ageBand: [2, 18],
    indications: ['G80', 'F82', 'Q90'],
    contraindications: ['post_surgery_lt_30d'],
    minSessionsPerWeek: 1,
    maxSessionsPerWeek: 4,
    sessionDurationMinRange: [30, 60],
  ...
  {
    id: 'pgm.pt.hydrotherapy',
    name: 'Hydrotherapy (Aquatic PT)',
    nameAr: 'العلاج المائي',
    modality: 'pt',
    domains: ['gross_motor'],
    ageBand: [3, 18],
    indications: ['G80', 'F82'],
    contraindications: ['seizure_high_freq', 'cardiac_unstable', 'post_surgery_lt_30d'],
    minSessionsPerWeek: 1,
    maxSessionsPerWeek: 2,
    sessionDurationMinRange: [30, 45],
    evidenceLevel: 'moderate',
    citations: ['Lai 2015 — Aquatic exercise in CP'],
  },
  {
    id: 'pgm.behavior.fct',
    name: 'Functional Communication Training (FCT)',
    nameAr: 'تدريب التواصل الوظيفي البديل للسلوك',
    modality: 'aba',
    domains: ['behavior', 'expressive_language'],
    ageBand: [2, 14],
    indications: ['F84.0', 'F91', 'F70'],
    contraindications: [],
    minSessionsPerWeek: 2,
    maxSessionsPerWeek: 6,
    sessionDurationMinRange: [20, 45],
    evidenceLevel: 'strong',
    citations: ['Carr & Durand 1985', 'Tiger 2008'],
  },
  {
    id: 'pgm.edu.direct_instruction',
    name: 'Direct Instruction (Academic)',
    nameAr: 'التدريس المباشر للمهارات الأكاديمية',
    modality: 'special_edu',
    domains: ['academic', 'cognitive'],
    ageBand: [5, 16],
    indications: ['F81.0', 'F81.1', 'F70', 'F71'],
    contraindications: [],
    minSessionsPerWeek: 2,
    maxSessionsPerWeek: 5,
    sessionDurationMinRange: [30, 45],
    evidenceLevel: 'strong',
    citations: ['Stockard 2018 — DI meta-analysis'],
  },
  {
    id: 'pgm.life.task_analysis',
    name: 'Life Skills Training (Task Analysis + Chaining)',
    nameAr: 'تدريب المهارات الحياتية بتحليل المهمة والتسلسل',
    modality: 'special_edu',
    domains: ['adl', 'cognitive'],
    ageBand: [6, 18],
    indications: ['F70', 'F71', 'F84.0'],
    contraindications: [],
    minSessionsPerWeek: 1,
    maxSessionsPerWeek: 4,
    sessionDurationMinRange: [30, 60],
    evidenceLevel: 'strong',
    citations: ['Test 2014 — NTACT evidence review'],
  },
  {
    id: 'pgm.vocational.prevoc',
    name: 'Pre-Vocational Skills Training',
    nameAr: 'التدريب على المهارات ما قبل المهنية',
    modality: 'vocational',
    domains: ['adl', 'academic'],
    ageBand: [12, 18],
    indications: ['F70', 'F71', 'F84.0'],
    contraindications: ['aggression_high'],
    minSessionsPerWeek: 1,
    maxSessionsPerWeek: 3,
    sessionDurationMinRange: [45, 90],
    evidenceLevel: 'moderate',
    citations: ['Wehman 2014 — Transition to employment'],
  },
]);
...
const TESTS = Object.freeze([
  ...
  // ─── W1246: discipline-coverage expansion ─────────────────────
  {
    id: 'tst.pdms2',
    name: 'PDMS-2 (Peabody Developmental Motor Scales)',
    nameAr: 'مقياس بيبودي للنمو الحركي - 2',
    kind: 'standardized',
    domains: ['fine_motor', 'gross_motor'],
    ageBand: [0, 5],
    indications: ['F82', 'G80', 'Q90'],
    scoreScale: { min: 46, max: 154, units: 'motor quotient' },
    scoreInterpretation: {
      bands: [
        { from: 46, to: 69, label: 'Very poor' },
        { from: 70, to: 79, label: 'Poor' },
        { from: 80, to: 89, label: 'Below average' },
        { from: 90, to: 110, label: 'Average' },
        { from: 111, to: 154, label: 'Above average' },
      ],
    },
    validityScore: 0.95,
    cadenceWeeksMin: 26,
  ...
  {
    id: 'tst.vineland3',
    name: 'Vineland-3 (Adaptive Behavior Scales)',
    nameAr: 'مقياس فاينلاند للسلوك التكيفي - 3',
    kind: 'standardized',
    domains: ['adl', 'social', 'expressive_language'],
    ageBand: [0, 18],
    indications: [], // any — adaptive behavior applies across diagnoses
    scoreScale: { min: 20, max: 160, units: 'standard score' },
    scoreInterpretation: {
      bands: [
        { from: 20, to: 70, label: 'Low' },
        { from: 71, to: 85, label: 'Moderately low' },
        { from: 86, to: 114, label: 'Adequate' },
        { from: 115, to: 160, label: 'High' },
      ],
    },
    validityScore: 1.0,
    cadenceWeeksMin: 26,
  ...
  {
    id: 'tst.pls5',
    name: 'PLS-5 (Preschool Language Scales)',
    nameAr: 'مقاييس اللغة لما قبل المدرسة - 5',
    kind: 'standardized',
    domains: ['receptive_language', 'expressive_language'],
    ageBand: [0, 7],
    indications: ['F80.1', 'F80.2', 'F84.0'],
    scoreScale: { min: 50, max: 150, units: 'standard score' },
    scoreInterpretation: {
      bands: [
        { from: 50, to: 69, label: 'Severe delay' },
        { from: 70, to: 84, label: 'Delay' },
        { from: 85, to: 115, label: 'Within normal limits' },
        { from: 116, to: 150, label: 'Above average' },
      ],
    },
    validityScore: 0.95,
    cadenceWeeksMin: 26,
  ...
  },
  {
    ...
    nameAr: 'التقييم الإكلينيكي لأساسيات اللغة - 5',
    kind: 'standardized',
    domains: ['receptive_language', 'expressive_language', 'academic'],
    ageBand: [5, 21],
    indications: ['F80.1', 'F80.2', 'F81.0'],
    scoreScale: { min: 40, max: 160, units: 'core language score' },
    scoreInterpretation: {
      bands: [
        { from: 40, to: 69, label: 'Severe disorder' },
        { from: 70, to: 77, label: 'Moderate disorder' },
        { from: 78, to: 85, label: 'Mild disorder' },
        { from: 86, to: 114, label: 'Average' },
        { from: 115, to: 160, label: 'Above average' },
      ],
    },
    validityScore: 1.0,
    cadenceWeeksMin: 26,
...
const MIN_EVIDENCE_BY_PROGRAM = Object.freeze({
  ...
  // W1246 — expansion programs
  'pgm.slp.early_language': { standardizedTests: 1, observationPoints: 0 },
  'pgm.slp.fluency': { standardizedTests: 0, observationPoints: 4 },
  'pgm.slp.dysphagia': { standardizedTests: 0, observationPoints: 4 },
  'pgm.ot.adl_independence': { standardizedTests: 1, observationPoints: 0 },
  'pgm.pt.gait_balance': { standardizedTests: 1, observationPoints: 0 },
  'pgm.pt.hydrotherapy': { standardizedTests: 1, observationPoints: 0 },
  'pgm.behavior.fct': { standardizedTests: 0, observationPoints: 4 },
  'pgm.edu.direct_instruction': { standardizedTests: 1, observationPoints: 0 },
  'pgm.life.task_analysis': { standardizedTests: 0, observationPoints: 4 },
  'pgm.vocational.prevoc': { standardizedTests: 0, observationPoints: 4 },
});
