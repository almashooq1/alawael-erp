...
const REGISTRY = {
  ...
  'kpi.beneficiary.active_count': {
    ...
    levels: [
      ...
      { level: 'record', path: '/care/360/:beneficiaryId' },
    ],
    ...
    actions: [
      {
        ...
        deepLink: '/care/360/:beneficiaryId',
        estimatedMin: 5,
        severity: 'may',
      },
    ],
    ...
    actions: [
      {
        ...
        deepLink: '/care/360/:beneficiaryId?tab=discharge',
        estimatedMin: 10,
        severity: 'should',
      },
    ],
  ...
  'kpi.attendance.daily_rate': {
    ...
    levels: [
      ...
      { level: 'record', path: '/care/360/:beneficiaryId?tab=attendance' },
    ],
    drivers: [
  ...
  'kpi.goals.stalled_count': {
    ...
    levels: [
      ...
      { level: 'record', path: '/care/360/:beneficiaryId?tab=goals' },
    ],
    drivers: [
      'kpi.attendance.daily_rate',
