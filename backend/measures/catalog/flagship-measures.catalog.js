...
const MEASURES = [
  ...
  // ── CFCS — communication function classification (CP) ─────────────────
  {
    ...
    scoringRules: [
      {
        rangeLabel: 'Level I',
        rangeLabel_ar: 'المستوى I — فعّال مع الجميع',
        minScore: 1,
        maxScore: 1,
        severity: 'normal',
        color: '#1b5e20',
      ...
      {
        rangeLabel: 'Level II',
        rangeLabel_ar: 'المستوى II — فعّال بوتيرة أبطأ',
        minScore: 2,
        maxScore: 2,
        severity: 'mild',
        color: '#558b2f',
      ...
      {
        rangeLabel: 'Level III',
        rangeLabel_ar: 'المستوى III — فعّال مع المألوفين',
        minScore: 3,
        maxScore: 3,
        severity: 'moderate',
        color: '#ef6c00',
      ...
      {
        rangeLabel: 'Level IV',
        rangeLabel_ar: 'المستوى IV — غير متّسق مع المألوفين',
        minScore: 4,
        maxScore: 4,
        severity: 'severe',
        color: '#c62828',
      ...
      {
        rangeLabel: 'Level V',
        rangeLabel_ar: 'المستوى V — نادرًا ما يكون فعّالًا',
        minScore: 5,
        maxScore: 5,
        severity: 'critical',
        color: '#b71c1c',
  ...
  // ── EDACS — eating & drinking ability classification (CP) ─────────────
  {
    ...
    scoringRules: [
      {
        rangeLabel: 'Level I',
        rangeLabel_ar: 'المستوى I — بأمان وكفاءة',
        minScore: 1,
        maxScore: 1,
        severity: 'normal',
        color: '#1b5e20',
      ...
      {
        rangeLabel: 'Level II',
        rangeLabel_ar: 'المستوى II — بأمان مع قيود على الكفاءة',
        minScore: 2,
        maxScore: 2,
        severity: 'mild',
        color: '#558b2f',
      ...
      {
        rangeLabel: 'Level III',
        rangeLabel_ar: 'المستوى III — قيود على الأمان',
        minScore: 3,
        maxScore: 3,
        severity: 'moderate',
        color: '#ef6c00',
      ...
      {
        rangeLabel: 'Level IV',
        rangeLabel_ar: 'المستوى IV — قيود كبيرة على الأمان',
        minScore: 4,
        maxScore: 4,
        severity: 'severe',
        color: '#c62828',
      ...
      {
        rangeLabel: 'Level V',
        rangeLabel_ar: 'المستوى V — غير قادر بأمان (تغذية أنبوبية)',
        minScore: 5,
        maxScore: 5,
        severity: 'critical',
        color: '#b71c1c',
...
const _ACTIVATION = {
  BARTHEL: {
    ...
    interpretationStyle: 'tier',
    ageRange: { min: 16, max: 120, unit: 'years' },
    targetPopulation: ['adults', 'physical_disability'],
  },
  CSI: {
    category: 'quality_of_life',
    purpose: 'risk_stratification',
    interpretationStyle: 'cutoff',
  ...
  'GAD-7': {
    ...
    purpose: 'screening',
    interpretationStyle: 'cutoff',
    ageRange: { min: 12, max: 120, unit: 'years' },
    targetPopulation: ['adolescents', 'adults'],
  },
  GCS: {
    category: 'cognitive',
    purpose: 'functional_status',
    interpretationStyle: 'tier',
    ageRange: { min: 2, max: 120, unit: 'years' },
    targetPopulation: ['all'],
    icd10Required: ['S06.*', 'R40.*', 'I60.*', 'I61.*', 'I63.*'],
  },
  KATZ: {
    category: 'functional',
    purpose: 'functional_status',
  ...
  MAS: {
    ...
    ageRange: { min: 2, max: 120, unit: 'years' },
    targetPopulation: ['all'],
    icd10Required: ['G80.*', 'G81.*', 'G82.*', 'G35', 'I69.*'],
  },
  MINICOG: {
    category: 'cognitive',
    purpose: 'screening',
  ...
  NRS: {
    ...
    purpose: 'functional_status',
    interpretationStyle: 'tier',
    ageRange: { min: 8, max: 120, unit: 'years' },
  ...
  'PSS-10': {
    ...
    purpose: 'outcome',
    interpretationStyle: 'tier',
    ageRange: { min: 14, max: 120, unit: 'years' },
    targetPopulation: ['adolescents', 'adults'],
  },
  TINETTI: {
    category: 'motor',
  ...
  'WHO-5': {
    ...
    purpose: 'outcome',
    interpretationStyle: 'tier',
    ageRange: { min: 9, max: 120, unit: 'years' },
    targetPopulation: ['adolescents', 'adults'],
  },
  'WHODAS-12': {
    category: 'functional',
