      ...
      try {
        ...
        if (res.statusCode < 400) {
          client
            ...
            .catch(err => logger.warn('Cache write error:', { error: err.message }));
        }
      } catch (err) {
        logger.warn('Cache serialization error:', { error: err.message });
      }
...
const getCacheStats = async () => {
  ...
  try {
    ...
    logger.warn('Error getting cache stats:', { error: err.message });
    return null;
  }
};
