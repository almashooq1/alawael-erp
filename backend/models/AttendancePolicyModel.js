/**
 * AttendancePolicyModel — سياسات الحضور والانصراف
 * النظام 37: الحضور البيومتري ZKTeco
 * (اسم الملف AttendancePolicyModel لتجنب التعارض مع AttendancePolicy.js الموجود)
 */
...
const attendancePolicySchema = new Schema(
  {
    ...
    lateDeductionMinutes: { type: Number, default: 0 },
    absenceDeductionHours: { type: Number, default: 8 },
    ...
    geofenceCoordinates: { type: Schema.Types.Mixed, default: null },
