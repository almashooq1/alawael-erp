...
dddBIReportSchema.index({ category: 1, isActive: 1, createdAt: -1 });
dddBIReportSchema.index({ owner: 1 });
...
dddScorecardSchema.index({ perspective: 1, isActive: 1, createdAt: -1 });
...
dddBenchmarkSchema.index({ domain: 1, metricKey: 1 });
