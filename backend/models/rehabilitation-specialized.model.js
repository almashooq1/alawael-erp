...
const insuranceClaimSchema = new Schema(
  {
    ...
    claim_details: {
      claim_type: {
        type: String,
        enum: ['service', 'medication', 'equipment', 'therapy', 'assessment'],
      },
    ...
    payments: [
      {
        ...
        payment_method: {
          type: String,
          enum: ['cash', 'credit_card', 'bank_transfer', 'check', 'insurance'],
        },
        amount: Number,
...
const donationSchema = new Schema(
  {
    ...
    donor_info: {
      donor_type: {
        type: String,
        enum: ['individual', 'corporate', 'government', 'foundation', 'anonymous'],
      },
      name: String,
    ...
    recognition: {
      ...
      recognition_type: {
        type: String,
        enum: ['public', 'private', 'certificate', 'plaque', 'naming'],
      },
...
const activitySchema = new Schema(
  {
    ...
    activity_info: {
      ...
      activity_type: {
        type: String,
        enum: ['individual', 'group', 'competition', 'trip', 'event'],
      },
      objectives: [String],
    },
    ...
    goals_addressed: [
      {
        ...
        achievement_level: {
          type: String,
          enum: ['not_started', 'emerging', 'developing', 'achieving', 'achieved'],
        },
      },
    ],
    ...
    interventions: [
      {
        ...
        effectiveness: {
          type: String,
          enum: ['not_effective', 'somewhat_effective', 'effective', 'very_effective'],
        },
      },
    ],
