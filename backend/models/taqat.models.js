...
// التصدير
// ============================================================
const TaqatJobSeeker =
  mongoose.models.TaqatJobSeeker || mongoose.model('TaqatJobSeeker', TaqatJobSeekerSchema);
const TaqatJobOpportunity =
  mongoose.models.TaqatJobOpportunity ||
  mongoose.model('TaqatJobOpportunity', TaqatJobOpportunitySchema);
...
const TaqatEmploymentStats =
  mongoose.models.TaqatEmploymentStats ||
  mongoose.model('TaqatEmploymentStats', TaqatEmploymentStatsSchema);
