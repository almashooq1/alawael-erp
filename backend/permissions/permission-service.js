...
class AdvancedPermissionService {
  ...
  async initialize(connection) {
    ...
    logger.info('✅ Advanced Permission Service initialized');
  }
  ...
  async createDefaultPermissions() {
    const defaultPermissions = [
      // User management
      {
        ...
        type: 'read',
        level: 1,
        resource: { module: 'users', action: 'read' },
      },
      {
        key: 'users.create',
        name: 'إنشاء مستخدم',
        ...
        type: 'write',
        level: 2,
        resource: { module: 'users', action: 'create' },
      },
      {
        key: 'users.update',
        name: 'تعديل مستخدم',
        ...
        type: 'write',
        level: 2,
        resource: { module: 'users', action: 'update' },
      },
      {
        key: 'users.delete',
        name: 'حذف مستخدم',
        ...
        type: 'delete',
        level: 3,
        resource: { module: 'users', action: 'delete' },
      },
      ...
      // Archive
      {
        ...
        type: 'read',
        level: 1,
        resource: { module: 'archive', action: 'read' },
      },
      {
        key: 'archive.upload',
        name: 'رفع مستندات',
        ...
        type: 'write',
        level: 2,
        resource: { module: 'archive', action: 'upload' },
      },
      {
        key: 'archive.delete',
        name: 'حذف مستندات',
        ...
        type: 'delete',
        level: 3,
        resource: { module: 'archive', action: 'delete' },
      },
      {
        key: 'archive.sign',
        name: 'توقيع مستندات',
        ...
        type: 'approve',
        level: 2,
        resource: { module: 'archive', action: 'sign' },
      },
      ...
      // HR
      {
        ...
        type: 'read',
        level: 1,
        resource: { module: 'hr', action: 'read' },
      },
      {
        key: 'hr.manage',
        ...
        type: 'admin',
        level: 4,
        resource: { module: 'hr', action: 'manage' },
      },
      ...
      // Finance
      {
        ...
        type: 'read',
        level: 1,
        resource: { module: 'finance', action: 'read' },
      },
      {
        key: 'finance.approve',
        name: 'موافقة مالية',
        ...
        type: 'approve',
        level: 3,
        resource: { module: 'finance', action: 'approve' },
      },
      ...
      // Reports
      {
        ...
        type: 'read',
        level: 1,
        resource: { module: 'reports', action: 'read' },
      },
      {
        key: 'reports.export',
        name: 'تصدير التقارير',
        ...
        type: 'export',
        level: 2,
        resource: { module: 'reports', action: 'export' },
      },
  ...
  async assignRole(userId, roleKey, options = {}) {
    ...
    const existing = userPerm.roles.find(r => r.role?.toString() === role._id.toString());
  ...
  async removeRole(userId, roleKey, options = {}) {
    ...
    userPerm.roles = userPerm.roles.filter(r => r.role?.toString() !== role._id.toString());
  ...
  async getUserRoles(userId, tenantId) {
    const userPerm = await this.UserPermission.findOne({ userId, tenantId }).populate('roles.role');

    if (!userPerm) return [];

    return userPerm.roles.filter(r => !r.expiresAt || new Date() < r.expiresAt).map(r => r.role);
  }
