 ...
 */
router.get('/metrics', createRBACMiddleware(['analytics:read']), (req, res) => {
  try {
 ...
 * @requires Permission: analytics:read
 */
router.get('/metrics/:name', createRBACMiddleware(['analytics:read']), (req, res) => {
  try {
    const analyticsService = req.app.locals.analyticsService;
 ...
 * Update metric value
 * @requires Permission: analytics:update
 */
router.put('/metrics/:name', createRBACMiddleware(['analytics:update']), (req, res) => {
  try {
    const analyticsService = req.app.locals.analyticsService;
    const { name } = req.params;
...
router.post('/alerts', (req, res) => {
  try {
    ...
    const alert = analyticsService.createAlert(metricName, condition, threshold, severity);
