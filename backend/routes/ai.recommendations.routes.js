...
router.post(
  ...
  authenticateToken,
  aiController.post('/models/:modelId/deploy')
);
...
router.post(
  ...
  authenticateToken,
  aiController.post('/models/:modelId/undeploy')
);
...
router.get(
  ...
  authenticateToken,
  aiController.get('/models/:modelId/metrics')
);
...
router.post(
  ...
  authenticateToken,
  aiController.post('/models/:modelId/train')
);
