 ...
 */
router.post('/webhooks', authorize(['admin', 'system_admin']), (req, res) => {
  try {
 ...
 * Update webhook
 */
router.put('/webhooks/:id', authorize(['admin', 'system_admin']), (req, res) => {
  try {
    const integrationService = req.app.locals.integrationService;
    const { id } = req.params;
 ...
 * Delete webhook
 */
router.delete('/webhooks/:id', authorize(['admin', 'system_admin']), (req, res) => {
  try {
    const integrationService = req.app.locals.integrationService;
    const { id } = req.params;
 ...
 */
router.post('/events', authorize(['admin', 'system_admin']), (req, res) => {
  try {
    const integrationService = req.app.locals.integrationService;
 ...
 */
router.post('/connectors', authorize(['admin', 'system_admin']), (req, res) => {
  try {
    const integrationService = req.app.locals.integrationService;
 ...
 * Delete connector
 */
router.delete('/connectors/:id', authorize(['admin', 'system_admin']), (req, res) => {
  try {
    const integrationService = req.app.locals.integrationService;
    const { id } = req.params;
 ...
 */
router.post('/apis', authorize(['admin', 'system_admin']), (req, res) => {
  try {
    const integrationService = req.app.locals.integrationService;
 ...
 */
router.post('/apis/:name/call', authorize(['admin', 'system_admin']), (req, res) => {
  try {
    const integrationService = req.app.locals.integrationService;
 ...
 */
router.post('/zapier/receive', authorize(['admin', 'system_admin']), (req, res) => {
  try {
    const integrationService = req.app.locals.integrationService;
    const { _hookId, event, data } = req.body;

    // Validate webhook signature if provided
    if (req.headers['x-zapier-signature']) {
      const _signature = req.headers['x-zapier-signature'];
 ...
 */
router.post('/sync/:connectorId', authorize(['admin', 'system_admin']), (req, res) => {
  try {
    const integrationService = req.app.locals.integrationService;
