...
router.get('/categories/:id', authenticate, [
...
router.post('/categories', authenticate, authorize(['admin', 'manager', 'librarian']), [
...
router.put('/categories/:id', authenticate, authorize(['admin', 'manager', 'librarian']), [
  param('id').notEmpty().withMessage('معرّف الفئة مطلوب'),
], async (req, res) => {
  if (handleValidation(req, res)) return;
  try {
...
router.delete('/categories/:id', authenticate, authorize(['admin', 'manager']), [
  param('id').notEmpty().withMessage('معرّف الفئة مطلوب'),
], async (req, res) => {
  if (handleValidation(req, res)) return;
  try {
...
router.get('/resources/search', authenticate, [
...
router.get('/resources/barcode/:barcode', authenticate, [
...
router.get('/resources/:id', authenticate, [
...
router.post('/resources', authenticate, authorize(['admin', 'manager', 'librarian']), [
...
router.put('/resources/:id', authenticate, authorize(['admin', 'manager', 'librarian']), [
  param('id').notEmpty().withMessage('معرّف المورد مطلوب'),
], async (req, res) => {
  if (handleValidation(req, res)) return;
  try {
...
router.delete('/resources/:id', authenticate, authorize(['admin', 'manager']), [
  param('id').notEmpty().withMessage('معرّف المورد مطلوب'),
], async (req, res) => {
  if (handleValidation(req, res)) return;
  try {
...
router.post('/resources/bulk-import', authenticate, authorize(['admin', 'manager']), [
...
router.get('/loans/:id', authenticate, [
...
router.post('/loans', authenticate, authorize(['admin', 'manager', 'librarian', 'staff']), [
...
router.post('/loans/:id/return', authenticate, authorize(['admin', 'manager', 'librarian', 'staff']), [
  param('id').notEmpty().withMessage('معرّف الإعارة مطلوب'),
], async (req, res) => {
  if (handleValidation(req, res)) return;
  try {
...
router.post('/loans/:id/renew', authenticate, authorize(['admin', 'manager', 'librarian', 'staff']), [
  param('id').notEmpty().withMessage('معرّف الإعارة مطلوب'),
], async (req, res) => {
  if (handleValidation(req, res)) return;
  try {
...
router.post('/reservations', authenticate, authorize(['admin', 'manager', 'librarian', 'staff']), [
  body('resourceId').notEmpty().withMessage('المورد مطلوب'),
  body('memberId').notEmpty().withMessage('العضو مطلوب'),
], async (req, res) => {
  if (handleValidation(req, res)) return;
...
router.post('/reservations/:id/cancel', authenticate, authorize(['admin', 'manager', 'librarian', 'staff']), [
...
router.get('/members/:id', authenticate, [
...
router.post('/members', authenticate, authorize(['admin', 'manager', 'librarian']), [
...
router.put('/members/:id', authenticate, authorize(['admin', 'manager', 'librarian']), [
  param('id').notEmpty().withMessage('معرّف العضو مطلوب'),
], async (req, res) => {
  if (handleValidation(req, res)) return;
  try {
...
router.get('/resources/:id/reviews', authenticate, [
  param('id').notEmpty().withMessage('معرّف المورد مطلوب'),
], async (req, res) => {
  if (handleValidation(req, res)) return;
  try {
...
router.post('/resources/:id/reviews', authenticate, [
  param('id').notEmpty().withMessage('معرّف المورد مطلوب'),
...
router.post('/suppliers', authenticate, authorize(['admin', 'manager']), [
...
router.post('/maintenance', authenticate, authorize(['admin', 'manager', 'librarian']), [
  body('resourceId').notEmpty().withMessage('المورد مطلوب'),
