...
router.get('/conversation/:id', async (req, res) => {
  try {
    ...
    const result = await messagingService.getConversationMessages(userId, conversationId, { page, limit });
...
router.delete('/:id', async (req, res) => {
  try {
    ...
    const result = await messagingService.deleteMessage(userId, messageId, deleteForEveryone === 'true');
...
router.post('/conversations/:id/participants', async (req, res) => {
  try {
    ...
    const result = await messagingService.addParticipant(userId, conversationId, newParticipantId);
...
router.delete('/conversations/:id/participants/:userId', async (req, res) => {
  try {
    ...
    const result = await messagingService.removeParticipant(userId, conversationId, participantId);
