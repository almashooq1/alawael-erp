...
// Strict rate limit on MFA login verify to prevent OTP brute-force
const mfaVerifyLimiter = createCustomLimiter({
  windowMs: 15 * 60 * 1000,
  max: 10,
 ...
 */
router.post('/login/verify', mfaVerifyLimiter, mfaController.verifyMFALogin);
