...
router.get(
  '/accreditation/standards/body/:body',
  auth,
  requireBranchAccess,
  accreditationStandards.getByBody
);
router.get(
  '/accreditation/standards/:id',
  auth,
  requireBranchAccess,
  accreditationStandards.getById
);
router.put(
  '/accreditation/standards/:id',
  auth,
  requireBranchAccess,
  accreditationStandards.update
);
router.delete(
  '/accreditation/standards/:id',
  auth,
  requireBranchAccess,
  accreditationStandards.remove
);
router.patch(
...
router.post(
  '/accreditation/standards/:id/evidence',
  auth,
  requireBranchAccess,
  accreditationStandards.addEvidence
);
...
router.get(
  '/accreditation/surveys/upcoming',
  auth,
  requireBranchAccess,
  accreditationSurveys.getUpcoming
);
...
router.patch(
  '/accreditation/surveys/:id/outcome',
  auth,
  requireBranchAccess,
  accreditationSurveys.recordOutcome
);
...
router.get(
  '/family-training/programs/statistics',
  auth,
  requireBranchAccess,
  familyTraining.programs.getStatistics
);
router.get(
...
router.get(
  '/family-training/programs/:id',
  auth,
  requireBranchAccess,
  familyTraining.programs.getById
);
router.put(
  '/family-training/programs/:id',
  auth,
  requireBranchAccess,
  familyTraining.programs.update
);
router.delete(
  '/family-training/programs/:id',
  auth,
  requireBranchAccess,
  familyTraining.programs.remove
);

router.get(
  '/family-training/enrollments',
  auth,
  requireBranchAccess,
  familyTraining.enrollments.getAll
);
router.post(
  '/family-training/enrollments',
  auth,
  requireBranchAccess,
  familyTraining.enrollments.create
);
router.get(
...
router.get(
  '/family-training/enrollments/:id',
  auth,
  requireBranchAccess,
  familyTraining.enrollments.getById
);
router.put(
  '/family-training/enrollments/:id',
  auth,
  requireBranchAccess,
  familyTraining.enrollments.update
);
router.delete(
  '/family-training/enrollments/:id',
  auth,
  requireBranchAccess,
  familyTraining.enrollments.remove
);
router.patch(
...
router.get(
  ...
  auth,
  requireBranchAccess,
  clinicalDecisionSupport.rules.getActive
);
...
router.patch(
  '/cdss/rules/:id/toggle',
  auth,
  requireBranchAccess,
  clinicalDecisionSupport.rules.toggleStatus
);
...
router.get(
  ...
  auth,
  requireBranchAccess,
  clinicalDecisionSupport.alerts.getActiveAlerts
);
router.get(
  '/cdss/alerts/summary',
  auth,
  requireBranchAccess,
  clinicalDecisionSupport.alerts.getAlertSummary
);
router.get('/cdss/alerts/:id', auth, requireBranchAccess, clinicalDecisionSupport.alerts.getById);
router.patch(
  '/cdss/alerts/:id/acknowledge',
  auth,
  requireBranchAccess,
  clinicalDecisionSupport.alerts.acknowledge
);
router.patch(
  '/cdss/alerts/:id/resolve',
  auth,
  requireBranchAccess,
  clinicalDecisionSupport.alerts.resolve
);
...
router.get(
  '/competency/frameworks/role/:role',
  auth,
  requireBranchAccess,
  staffCompetency.frameworks.getByRole
);
router.get(
  '/competency/frameworks/:id',
  auth,
  requireBranchAccess,
  staffCompetency.frameworks.getById
);
router.put(
  '/competency/frameworks/:id',
  auth,
  requireBranchAccess,
  staffCompetency.frameworks.update
);
router.delete(
  '/competency/frameworks/:id',
  auth,
  requireBranchAccess,
  staffCompetency.frameworks.remove
);
...
router.get(
  ...
  auth,
  requireBranchAccess,
  staffCompetency.assessments.getAll
);
router.post(
  '/competency/assessments',
  auth,
  requireBranchAccess,
  staffCompetency.assessments.create
);
router.get(
  '/competency/assessments/overdue',
  auth,
  requireBranchAccess,
  staffCompetency.assessments.getOverdueSummary
);
router.get(
...
router.get(
  '/competency/assessments/:id',
  auth,
  requireBranchAccess,
  staffCompetency.assessments.getById
);
router.put(
  '/competency/assessments/:id',
  auth,
  requireBranchAccess,
  staffCompetency.assessments.update
);
router.patch(
  '/competency/assessments/:id/sign',
  auth,
  requireBranchAccess,
  staffCompetency.assessments.sign
);
...
router.get(
  '/competency/cpd/non-compliant',
  auth,
  requireBranchAccess,
  staffCompetency.cpd.getNonCompliant
);
router.get(
  '/competency/cpd/employee/:employeeId',
  auth,
  requireBranchAccess,
  staffCompetency.cpd.getByEmployee
);
...
router.post(
  '/competency/cpd/:id/activity',
  auth,
  requireBranchAccess,
  staffCompetency.cpd.addActivity
);
...
router.get(
  '/digital-therapeutics/adherence-report',
  auth,
  requireBranchAccess,
  digitalTherapeutics.getAdherenceReport
);
router.get(
...
router.post(
  '/digital-therapeutics/:id/session',
  auth,
  requireBranchAccess,
  digitalTherapeutics.logSession
);
router.post(
  '/digital-therapeutics/:id/metric',
  auth,
  requireBranchAccess,
  digitalTherapeutics.addProgressMetric
);
...
router.patch(
  '/outcome-contracts/:id/metric',
  auth,
  requireBranchAccess,
  outcomeContracting.updateMetricValue
);
