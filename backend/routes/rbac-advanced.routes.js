...
function setupDefaults() {
  try {
    ...
    rbacSystem.assignPermissionToRole('super-admin', 'roles:create');
    rbacSystem.assignPermissionToRole('super-admin', 'roles:read');
    rbacSystem.assignPermissionToRole('super-admin', 'roles:update');
    rbacSystem.assignPermissionToRole('super-admin', 'roles:delete');
    ...
    rbacSystem.assignPermissionToRole('admin', 'roles:read');
    ...
    console.log('⚠️  RBAC Defaults already initialized or error:', error.message);
  }
}

// Initialize defaults on route load
setupDefaults();
