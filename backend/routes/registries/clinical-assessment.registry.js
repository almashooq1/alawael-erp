...
module.exports = function registerClinicalAssessmentRoutes(
  ...
  // Measures Outcomes Surface (W233 + W241 + W244 + W246 + W251) —
  // read-only HTTP for the full reporting trilogy + aggregator +
  ...
  logger.info(
    'Measures Outcomes routes mounted (11 endpoints — W229 aggregator + W240 family + W242 MOHRSD JSON+CSV + W245 clinical deep-dive + W250 multi-branch comparison + W256 per-measure pairs drill-through + W258 pairs CSV)'
  );
