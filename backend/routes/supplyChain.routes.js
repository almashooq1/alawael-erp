 ...
 * Create new supplier
 */
router.post('/suppliers', authorize(['admin', 'manager']), async (req, res) => {
  try {
 ...
 * Update supplier
 */
router.put('/suppliers/:id', authorize(['admin', 'manager']), async (req, res) => {
  try {
 ...
 * Delete supplier
 */
router.delete('/suppliers/:id', authorize(['admin', 'manager']), async (req, res) => {
  try {
    // Validate ID format
    if (!req.params.id || req.params.id.length < 3) {
      return res.status(400).json({
 ...
 */
router.post('/inventory', authorize(['admin', 'manager']), async (req, res) => {
  try {
    // Validate required fields
 ...
 */
router.patch('/inventory/:id', authorize(['admin', 'manager']), async (req, res) => {
  try {
 ...
 * Update order status
 */
router.patch('/orders/:id/status', authorize(['admin', 'manager']), async (req, res) => {
  try {
 ...
 */
router.delete('/orders/:id', authorize(['admin', 'manager']), async (req, res) => {
  try {
    // Validate ID format
    if (!req.params.id || req.params.id.length < 3) {
      return res.status(400).json({
 ...
 * Create shipment
 */
router.post('/shipments', authorize(['admin', 'manager']), async (req, res) => {
  try {
    // Validate required fields
 ...
 */
router.patch('/shipments/:id/status', authorize(['admin', 'manager']), async (req, res) => {
  try {
 ...
 * Delete shipment
 */
router.delete('/shipments/:id', authorize(['admin', 'manager']), async (req, res) => {
  try {
