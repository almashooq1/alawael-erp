...
const ROLE_LABELS = {
  ...
  head_office_admin: 'إدارة المقر الرئيسي',
  ceo: 'المدير التنفيذي',
  group_gm: 'المدير العام',
  group_cfo: 'المدير المالي',
  group_chro: 'مدير الموارد البشرية العام',
  group_quality_officer: 'مدير الجودة العام',
  compliance_officer: 'مسؤول الامتثال',
  internal_auditor: 'المراجع الداخلي',
  it_admin: 'مدير تقنية المعلومات',
  regional_director: 'مدير المنطقة',
  regional_quality: 'منسق جودة المنطقة',
  admin: 'مدير',
  manager: 'مدير إداري',
  ...
  finance_supervisor: 'مشرف المالية',
  therapy_supervisor: 'مشرف علاجي',
  special_ed_supervisor: 'مشرف التربية الخاصة',
  doctor: 'طبيب',
  therapist: 'معالج',
  therapist_slp: 'أخصائي نطق',
  ...
  therapy_assistant: 'معالج مساعد',
  nurse: 'ممرض/ة',
  head_nurse: 'رئيس/ة تمريض',
  nursing_supervisor: 'مشرف/ة تمريض',
  dpo: 'مسؤول حماية البيانات',
  family_counsellor: 'مرشد أسري',
  independent_advocate: 'مناصر مستقل',
  cultural_officer: 'مسؤول التكيّف الثقافي',
  patient_relations_officer: 'مسؤول علاقات المستفيدين',
