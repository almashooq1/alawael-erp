...
const CrmContact = mongoose.models.CrmContact || mongoose.model('CrmContact', ContactSchema);
const CrmDeal = mongoose.models.CrmDeal || mongoose.model('CrmDeal', DealSchema);
const CrmFollowUp = mongoose.models.CrmFollowUp || mongoose.model('CrmFollowUp', FollowUpSchema);
const CrmActivity = mongoose.models.CrmActivity || mongoose.model('CrmActivity', ActivitySchema);
