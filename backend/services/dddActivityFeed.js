...
function createActivityFeedRouter() {
  ...
  r.get('/activity-feed', async (_req, res) => {
    try {
  ...
  r.get('/activity-feed/user/:userId', async (req, res) => {
    try {
  ...
  r.get('/activity-feed/entity/:entityType/:entityId', async (req, res) => {
    try {
      res.json({
        success: true,
  ...
  r.get('/activity-feed/domain/:domain', async (req, res) => {
    try {
  ...
  r.post('/activity-feed', async (req, res) => {
    try {
  ...
  r.post('/activity-feed/:activityId/read', async (req, res) => {
    try {
      res.json({
        success: true,
  ...
  r.get('/activity-feed/unread/:userId', async (req, res) => {
    try {
  ...
  r.get('/activity-feed/subscriptions/:userId', async (req, res) => {
    try {
  ...
  r.post('/activity-feed/subscriptions', async (req, res) => {
    try {
  ...
  r.post('/activity-feed/digest/:userId', async (req, res) => {
    try {
  ...
  r.get('/activity-feed/analytics', async (req, res) => {
    try {
