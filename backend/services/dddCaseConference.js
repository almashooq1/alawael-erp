...
function createCaseConferenceRouter() {
  const r = Router();

  r.get('/case-conferences', async (_req, res) => {
    try {
  ...
  r.get('/case-conferences/list', async (req, res) => {
    try {
      const query = {};
  ...
  r.post('/case-conferences', async (req, res) => {
    try {
  ...
  r.get('/case-conferences/beneficiary/:beneficiaryId', async (req, res) => {
    try {
      res.json({
        success: true,
  ...
  r.post('/case-conferences/:conferenceId/decisions', async (req, res) => {
    try {
  ...
  r.post('/case-conferences/:conferenceId/actions', async (req, res) => {
    try {
  ...
  r.post('/case-conferences/:conferenceId/complete', async (req, res) => {
    try {
      res.json({
        success: true,
  ...
  r.get('/case-conferences/templates', async (_req, res) => {
    try {
  ...
  r.post('/case-conferences/seed', async (_req, res) => {
    try {
