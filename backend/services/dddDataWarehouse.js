...
function createDataWarehouseRouter() {
  const r = Router();

  r.get('/data-warehouse', async (_req, res) => {
    try {
  ...
  r.get('/data-warehouse/pipelines', async (_req, res) => {
    try {
  ...
  r.post('/data-warehouse/pipelines/:pipelineId/run', async (req, res) => {
    try {
  ...
  r.get('/data-warehouse/views', async (_req, res) => {
    try {
  ...
  r.post('/data-warehouse/views/:viewId/refresh', async (req, res) => {
    try {
  ...
  r.get('/data-warehouse/cubes', async (_req, res) => {
    try {
  ...
  r.post('/data-warehouse/cubes/:cubeId/query', async (req, res) => {
    try {
  ...
  r.post('/data-warehouse/seed', async (_req, res) => {
    try {
