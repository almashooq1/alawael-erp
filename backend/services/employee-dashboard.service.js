...
class EmployeeDashboardService extends EventEmitter {
   ...
   */
  _getSalaryCompensation(_employeeId) {
    return {
      currentSalary: {
        baseSalary: 10000,
        housing: 2500,
   ...
   */
  _getInsuranceBenefits(_employeeId) {
    return {
      medicalInsurance: {
   ...
   */
  _getLeaveAttendance(_employeeId) {
    return {
      attendance: {
   ...
   */
  _getPerformanceDevelopment(_employeeId) {
    return {
      performanceReview: {
