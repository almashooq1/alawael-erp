...
class DatabaseHelper {
  ...
  static async clearCollections(_collectionNames) {
    // Clear specific collections
  }

  static async seedData(_data) {
    // Insert seed data
  }

  static async insertDocument(_collection, _data) {
    // Insert single document
  }

  static async findDocument(_collection, _filter) {
    // Find document
  }

  static async updateDocument(_collection, _filter, _update) {
    // Update document
  }

  static async deleteDocument(_collection, _filter) {
    // Delete document
  }

  static async getDocumentCount(_collection) {
    // Get document count
  }
}
...
class PerformanceHelper {
  static createTimer() {
    ...
    return {
      elapsed: () => elapsed,
      reset: () => ((elapsed = 0), (start = Date.now())),
    };
  }
