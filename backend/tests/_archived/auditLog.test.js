...
const {
  auditMiddleware,
  auditAuthMiddleware: _auditAuthMiddleware,
  auditCrudMiddleware: _auditCrudMiddleware,
 ...
 */
const _createAuditLogs = async (count, baseOverrides = {}) => {
  const logs = [];
...
describe('🔧 Audit Middleware', () => {
  ...
  describe('auditBruteForceMiddleware', () => {
    test('should detect brute force attack', async () => {
      ...
      // Middleware should have been called without errors
      expect(next).toHaveBeenCalled();
    });
  });
});
