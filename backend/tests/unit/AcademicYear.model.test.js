/**
 * Auto-generated unit tests for models/AcademicYear.js
...
mockModelFn.modelName = 'AcademicYear';
...
let Model;
try { Model = require('../../models/AcademicYear'); } catch(e) { /* load fail */ }

describe('models/AcademicYear', () => {
