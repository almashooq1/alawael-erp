/**
 * Auto-generated unit tests for models/AdminDecision.js
...
mockModelFn.modelName = 'AdminDecision';
...
let Model;
try { Model = require('../../models/AdminDecision'); } catch(e) { /* load fail */ }

describe('models/AdminDecision', () => {
  ...
  test('static "generateDecisionNumber" attached to schema', () => {
    if (!Model) return;
    // Check if static was assigned during module load
    const fn = mockSchema.statics['generateDecisionNumber'];
