/**
 * Auto-generated unit tests for models/AdvancedTicket.js
...
mockModelFn.modelName = 'AdvancedTicket';
...
let Model;
try { Model = require('../../models/AdvancedTicket'); } catch(e) { /* load fail */ }

describe('models/AdvancedTicket', () => {
