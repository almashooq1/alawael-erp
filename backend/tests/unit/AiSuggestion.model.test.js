/**
 * Auto-generated unit tests for models/AiSuggestion.js
...
mockModelFn.modelName = 'AiSuggestion';
...
let Model;
try { Model = require('../../models/AiSuggestion'); } catch(e) { /* load fail */ }

describe('models/AiSuggestion', () => {
  ...
  test('method "accept" attached to schema', () => {
    if (!Model) return;
    const fn = mockSchema.methods['accept'];
