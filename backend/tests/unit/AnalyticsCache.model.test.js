/**
 * Auto-generated unit tests for models/AnalyticsCache.js
...
mockModelFn.modelName = 'AnalyticsCache';
...
let Model;
try { Model = require('../../models/AnalyticsCache'); } catch(e) { /* load fail */ }

describe('models/AnalyticsCache', () => {
