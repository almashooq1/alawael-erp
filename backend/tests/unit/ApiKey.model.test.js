/**
 * Auto-generated unit tests for models/ApiKey.js
...
let Model;
try { Model = require('../../models/ApiKey'); } catch(e) { /* load fail */ }
...
describe('models/ApiKey', () => {
  ...
  test('static "generateKey" attached to schema', () => {
    if (!Model) return;
    // Check if static was assigned during module load
    const fn = mockSchema.statics['generateKey'];
