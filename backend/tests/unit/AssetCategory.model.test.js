/**
 * Auto-generated unit tests for models/AssetCategory.js
...
mockModelFn.modelName = 'AssetCategory';
...
let Model;
try { Model = require('../../models/AssetCategory'); } catch(e) { /* load fail */ }

describe('models/AssetCategory', () => {
