/**
 * Auto-generated unit tests for models/AssetInventory.js
...
mockModelFn.modelName = 'AssetInventory';
...
let Model;
try { Model = require('../../models/AssetInventory'); } catch(e) { /* load fail */ }

describe('models/AssetInventory', () => {
