/**
 * Auto-generated unit tests for models/AssetTransfer.js
...
mockModelFn.modelName = 'AssetTransfer';
...
let Model;
try { Model = require('../../models/AssetTransfer'); } catch(e) { /* load fail */ }

describe('models/AssetTransfer', () => {
