/**
 * Auto-generated unit tests for models/Attendance.js
...
mockModelFn.modelName = 'Attendance';
...
let Model;
try { Model = require('../../models/Attendance'); } catch(e) { /* load fail */ }

describe('models/Attendance', () => {
  ...
  test('static "findByEmployeeAndDate" attached to schema', () => {
    if (!Model) return;
    // Check if static was assigned during module load
    const fn = mockSchema.statics['findByEmployeeAndDate'];
    if (fn) expect(typeof fn).toBe('function');
    else expect(true).toBe(true); // may not have been assigned in mocked env
  });

  test('static "findByEmployeeRange" attached to schema', () => {
    if (!Model) return;
    // Check if static was assigned during module load
    const fn = mockSchema.statics['findByEmployeeRange'];
    if (fn) expect(typeof fn).toBe('function');
    else expect(true).toBe(true); // may not have been assigned in mocked env
  });

  test('static "getStatsByEmployee" attached to schema', () => {
    if (!Model) return;
    // Check if static was assigned during module load
    const fn = mockSchema.statics['getStatsByEmployee'];
    if (fn) expect(typeof fn).toBe('function');
    else expect(true).toBe(true); // may not have been assigned in mocked env
  });
