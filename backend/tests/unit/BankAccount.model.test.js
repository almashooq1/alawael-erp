/**
 * Auto-generated unit tests for models/BankAccount.js
...
mockModelFn.modelName = 'BankAccount';
...
let Model;
try { Model = require('../../models/BankAccount'); } catch(e) { /* load fail */ }

describe('models/BankAccount', () => {
