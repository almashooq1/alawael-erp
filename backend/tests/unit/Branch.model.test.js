/**
 * Auto-generated unit tests for models/Branch.js
...
let Model;
try { Model = require('../../models/Branch'); } catch(e) { /* load fail */ }
...
describe('models/Branch', () => {
  ...
  test('static "getAllActiveCodes" attached to schema', () => {
    if (!Model) return;
    // Check if static was assigned during module load
    const fn = mockSchema.statics['getAllActiveCodes'];
