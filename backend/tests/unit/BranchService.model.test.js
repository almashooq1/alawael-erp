/**
 * Auto-generated unit tests for models/BranchService.js
...
mockModelFn.modelName = 'BranchService';
...
let Model;
try { Model = require('../../models/BranchService'); } catch(e) { /* load fail */ }

describe('models/BranchService', () => {
