/**
 * Auto-generated unit tests for models/BranchSetting.js
...
mockModelFn.modelName = 'BranchSetting';
...
let Model;
try { Model = require('../../models/BranchSetting'); } catch(e) { /* load fail */ }

describe('models/BranchSetting', () => {
  ...
  test('method "getParsedValue" attached to schema', () => {
    if (!Model) return;
    const fn = mockSchema.methods['getParsedValue'];
