/**
 * Auto-generated unit tests for models/CaseManagement.js
...
mockModelFn.modelName = 'CaseManagement';
...
let Model;
try { Model = require('../../models/CaseManagement'); } catch(e) { /* load fail */ }

describe('models/CaseManagement', () => {
  ...
  test('method "calculateAge" attached to schema', () => {
    if (!Model) return;
    const fn = mockSchema.methods['calculateAge'];
    if (fn) expect(typeof fn).toBe('function');
    else expect(true).toBe(true);
  });

  test('method "getLatestDiagnosis" attached to schema', () => {
    if (!Model) return;
    const fn = mockSchema.methods['getLatestDiagnosis'];
    if (fn) expect(typeof fn).toBe('function');
    else expect(true).toBe(true);
  });

  test('method "getActiveTreatmentPlan" attached to schema', () => {
    if (!Model) return;
    const fn = mockSchema.methods['getActiveTreatmentPlan'];
    if (fn) expect(typeof fn).toBe('function');
    else expect(true).toBe(true);
  });

  test('method "getStatistics" attached to schema', () => {
    if (!Model) return;
    const fn = mockSchema.methods['getStatistics'];
    if (fn) expect(typeof fn).toBe('function');
    else expect(true).toBe(true);
  });
