/**
 * Auto-generated unit tests for models/ChartOfAccounts.js
...
mockModelFn.modelName = 'ChartOfAccounts';
...
let Model;
try { Model = require('../../models/ChartOfAccounts'); } catch(e) { /* load fail */ }

describe('models/ChartOfAccounts', () => {
  ...
  test('method "getPath" attached to schema', () => {
    if (!Model) return;
    const fn = mockSchema.methods['getPath'];
