/**
 * Auto-generated unit tests for models/ClinicalRule.js
...
mockModelFn.modelName = 'ClinicalRule';
...
let Model;
try { Model = require('../../models/ClinicalRule'); } catch(e) { /* load fail */ }

describe('models/ClinicalRule', () => {
