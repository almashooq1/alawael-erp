/**
 * Auto-generated unit tests for models/CommunityEvent.js
...
mockModelFn.modelName = 'CommunityEvent';
...
let Model;
try { Model = require('../../models/CommunityEvent'); } catch(e) { /* load fail */ }

describe('models/CommunityEvent', () => {
