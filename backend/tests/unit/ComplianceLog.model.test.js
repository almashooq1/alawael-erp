/**
 * Auto-generated unit tests for models/ComplianceLog.js
...
mockModelFn.modelName = 'ComplianceLog';
...
let Model;
try { Model = require('../../models/ComplianceLog'); } catch(e) { /* load fail */ }

describe('models/ComplianceLog', () => {
