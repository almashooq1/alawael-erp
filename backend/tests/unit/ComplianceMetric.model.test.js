/**
 * Auto-generated unit tests for models/ComplianceMetric.js
...
mockModelFn.modelName = 'ComplianceMetric';
...
let Model;
try { Model = require('../../models/ComplianceMetric'); } catch(e) { /* load fail */ }

describe('models/ComplianceMetric', () => {
  ...
  test('static "getLatestMetrics" attached to schema', () => {
    if (!Model) return;
    // Check if static was assigned during module load
    const fn = mockSchema.statics['getLatestMetrics'];
