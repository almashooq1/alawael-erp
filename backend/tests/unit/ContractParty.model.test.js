/**
 * Auto-generated unit tests for models/ContractParty.js
...
mockModelFn.modelName = 'ContractParty';
...
let Model;
try { Model = require('../../models/ContractParty'); } catch(e) { /* load fail */ }

describe('models/ContractParty', () => {
