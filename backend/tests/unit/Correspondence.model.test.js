/**
 * Auto-generated unit tests for models/Correspondence.js
...
mockModelFn.modelName = 'Correspondence';
...
let Model;
try { Model = require('../../models/Correspondence'); } catch(e) { /* load fail */ }

describe('models/Correspondence', () => {
  ...
  test('static "generateRefNumber" attached to schema', () => {
    if (!Model) return;
    // Check if static was assigned during module load
    const fn = mockSchema.statics['generateRefNumber'];
