/**
 * Auto-generated unit tests for models/CouponUsage.js
...
mockModelFn.modelName = 'CouponUsage';
...
let Model;
try { Model = require('../../models/CouponUsage'); } catch(e) { /* load fail */ }

describe('models/CouponUsage', () => {
