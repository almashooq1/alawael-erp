/**
 * Auto-generated unit tests for models/CourseModule.js
...
mockModelFn.modelName = 'CourseModule';
...
let Model;
try { Model = require('../../models/CourseModule'); } catch(e) { /* load fail */ }

describe('models/CourseModule', () => {
