/**
 * Auto-generated unit tests for models/CrmCampaign.js
...
mockModelFn.modelName = 'CrmCampaign';
...
let Model;
try { Model = require('../../models/CrmCampaign'); } catch(e) { /* load fail */ }

describe('models/CrmCampaign', () => {
