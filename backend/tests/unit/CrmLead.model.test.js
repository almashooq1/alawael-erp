/**
 * Auto-generated unit tests for models/CrmLead.js
...
let Model;
try { Model = require('../../models/CrmLead'); } catch(e) { /* load fail */ }

describe('models/CrmLead', () => {
  ...
  test('static "calculateScore" attached to schema', () => {
    if (!Model) return;
    // Check if static was assigned during module load
    const fn = mockSchema.statics['calculateScore'];
