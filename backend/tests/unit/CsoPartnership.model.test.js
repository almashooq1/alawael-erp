/**
 * Auto-generated unit tests for models/CsoPartnership.js
...
mockModelFn.modelName = 'CsoPartnership';
...
let Model;
try { Model = require('../../models/CsoPartnership'); } catch(e) { /* load fail */ }

describe('models/CsoPartnership', () => {
