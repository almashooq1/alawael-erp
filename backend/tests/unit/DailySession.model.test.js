/**
 * Auto-generated unit tests for models/DailySession.js
...
mockModelFn.modelName = 'DailySession';
...
let Model;
try { Model = require('../../models/DailySession'); } catch(e) { /* load fail */ }

describe('models/DailySession', () => {
