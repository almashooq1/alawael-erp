/**
 * Auto-generated unit tests for models/Delegation.js
...
mockModelFn.modelName = 'Delegation';
...
let Model;
try { Model = require('../../models/Delegation'); } catch(e) { /* load fail */ }

describe('models/Delegation', () => {
  ...
  test('static "generateDelegationNumber" attached to schema', () => {
    if (!Model) return;
    // Check if static was assigned during module load
    const fn = mockSchema.statics['generateDelegationNumber'];
