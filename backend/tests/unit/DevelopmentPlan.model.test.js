/**
 * Auto-generated unit tests for models/DevelopmentPlan.js
...
mockModelFn.modelName = 'DevelopmentPlan';
...
let Model;
try { Model = require('../../models/DevelopmentPlan'); } catch(e) { /* load fail */ }

describe('models/DevelopmentPlan', () => {
  ...
  test('method "calculateProgress" attached to schema', () => {
    if (!Model) return;
    const fn = mockSchema.methods['calculateProgress'];
