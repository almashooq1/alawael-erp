/**
 * Auto-generated unit tests for models/DigitalWallet.js
...
mockModelFn.modelName = 'DigitalWallet';
...
let Model;
try { Model = require('../../models/DigitalWallet'); } catch(e) { /* load fail */ }

describe('models/DigitalWallet', () => {
