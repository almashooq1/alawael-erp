/**
 * Auto-generated unit tests for models/DiscountCoupon.js
...
mockModelFn.modelName = 'DiscountCoupon';
...
let Model;
try { Model = require('../../models/DiscountCoupon'); } catch(e) { /* load fail */ }

describe('models/DiscountCoupon', () => {
