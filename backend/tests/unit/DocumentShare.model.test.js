/**
 * Auto-generated unit tests for models/DocumentShare.js
...
mockModelFn.modelName = 'DocumentShare';
...
let Model;
try { Model = require('../../models/DocumentShare'); } catch(e) { /* load fail */ }

describe('models/DocumentShare', () => {
