/**
 * Auto-generated unit tests for models/Donation.js
...
mockModelFn.modelName = 'Donation';
...
let Model;
try { Model = require('../../models/Donation'); } catch(e) { /* load fail */ }

describe('models/Donation', () => {
