/**
 * Auto-generated unit tests for models/EInvoice.js
...
mockModelFn.modelName = 'EInvoice';
...
let Model;
try { Model = require('../../models/EInvoice'); } catch(e) { /* load fail */ }

describe('models/EInvoice', () => {
