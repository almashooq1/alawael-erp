/**
 * Auto-generated unit tests for models/ElearningQuiz.js
...
mockModelFn.modelName = 'ElearningQuiz';
...
let Model;
try { Model = require('../../models/ElearningQuiz'); } catch(e) { /* load fail */ }

describe('models/ElearningQuiz', () => {
