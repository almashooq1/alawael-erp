/**
 * Auto-generated unit tests for models/EmployeeRequest.js
...
mockModelFn.modelName = 'EmployeeRequest';
...
let Model;
try { Model = require('../../models/EmployeeRequest'); } catch(e) { /* load fail */ }

describe('models/EmployeeRequest', () => {
  ...
  test('static "getByEmployee" attached to schema', () => {
    if (!Model) return;
    // Check if static was assigned during module load
    const fn = mockSchema.statics['getByEmployee'];
    if (fn) expect(typeof fn).toBe('function');
    else expect(true).toBe(true); // may not have been assigned in mocked env
  });

  test('static "getPendingCount" attached to schema', () => {
    if (!Model) return;
    // Check if static was assigned during module load
    const fn = mockSchema.statics['getPendingCount'];
    if (fn) expect(typeof fn).toBe('function');
    else expect(true).toBe(true); // may not have been assigned in mocked env
  });
