/**
 * Auto-generated unit tests for models/EnterpriseRisk.js
...
mockModelFn.modelName = 'EnterpriseRisk';
...
let Model;
try { Model = require('../../models/EnterpriseRisk'); } catch(e) { /* load fail */ }

describe('models/EnterpriseRisk', () => {
