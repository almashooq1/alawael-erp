/**
 * Auto-generated unit tests for models/EnterpriseUltra.js
...
mockModelFn.modelName = 'LegalCase';
...
let Model;
try { Model = require('../../models/EnterpriseUltra'); } catch(e) { /* load fail */ }

describe('models/EnterpriseUltra', () => {
