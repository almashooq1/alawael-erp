/**
 * Auto-generated unit tests for models/FinancialReport.js
...
mockModelFn.modelName = 'FinancialReport';
...
let Model;
try { Model = require('../../models/FinancialReport'); } catch(e) { /* load fail */ }

describe('models/FinancialReport', () => {
  ...
  test('method "validateEquation" attached to schema', () => {
    if (!Model) return;
    const fn = mockSchema.methods['validateEquation'];
    if (fn) expect(typeof fn).toBe('function');
