/**
 * Auto-generated unit tests for models/FiscalPeriod.js
...
mockModelFn.modelName = 'FiscalPeriod';
...
let Model;
try { Model = require('../../models/FiscalPeriod'); } catch(e) { /* load fail */ }

describe('models/FiscalPeriod', () => {
