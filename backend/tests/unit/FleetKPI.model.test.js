/**
 * Auto-generated unit tests for models/FleetKPI.js
...
mockModelFn.modelName = 'FleetKPI';
...
let Model;
try { Model = require('../../models/FleetKPI'); } catch(e) { /* load fail */ }

describe('models/FleetKPI', () => {
