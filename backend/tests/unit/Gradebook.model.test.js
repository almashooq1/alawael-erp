/**
 * Auto-generated unit tests for models/Gradebook.js
...
mockModelFn.modelName = 'Gradebook';
...
let Model;
try { Model = require('../../models/Gradebook'); } catch(e) { /* load fail */ }

describe('models/Gradebook', () => {
  ...
  test('method "calculateTotals" attached to schema', () => {
    if (!Model) return;
    const fn = mockSchema.methods['calculateTotals'];
