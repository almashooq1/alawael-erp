/**
 * Auto-generated unit tests for models/GroupProgram.js
...
mockModelFn.modelName = 'GroupProgram';
...
let Model;
try { Model = require('../../models/GroupProgram'); } catch(e) { /* load fail */ }

describe('models/GroupProgram', () => {
