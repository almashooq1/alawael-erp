/**
 * Auto-generated tests for models/HR/Payroll.js
...
const SRC = path.resolve(__dirname, '../../models/HR/Payroll.js');

describe('models/HR/Payroll.js', () => {
  let source;
  beforeAll(() => {
  ...
  test('is syntactically valid JavaScript', () => {
    expect(() => new vm.Script(source, { filename: 'Payroll.js' })).not.toThrow();
  });
