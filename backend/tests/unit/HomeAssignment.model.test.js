/**
 * Auto-generated unit tests for models/HomeAssignment.js
...
mockModelFn.modelName = 'HomeAssignment';
...
let Model;
try { Model = require('../../models/HomeAssignment'); } catch(e) { /* load fail */ }

describe('models/HomeAssignment', () => {
