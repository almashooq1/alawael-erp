/**
 * Auto-generated unit tests for models/ImportExportJob.js
...
mockModelFn.modelName = 'ImportExportJob';
...
let Model;
try { Model = require('../../models/ImportExportJob'); } catch(e) { /* load fail */ }

describe('models/ImportExportJob', () => {
  ...
  test('static "getModuleStats" attached to schema', () => {
    if (!Model) return;
    // Check if static was assigned during module load
    const fn = mockSchema.statics['getModuleStats'];
