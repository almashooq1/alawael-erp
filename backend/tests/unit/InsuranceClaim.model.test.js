/**
 * Auto-generated unit tests for models/InsuranceClaim.js
...
mockModelFn.modelName = 'InsuranceClaim';
...
let Model;
try { Model = require('../../models/InsuranceClaim'); } catch(e) { /* load fail */ }

describe('models/InsuranceClaim', () => {
