/**
 * Auto-generated unit tests for models/InventoryItem.js
...
mockModelFn.modelName = 'ItemCategory';
...
let Model;
try { Model = require('../../models/InventoryItem'); } catch(e) { /* load fail */ }

describe('models/InventoryItem', () => {
