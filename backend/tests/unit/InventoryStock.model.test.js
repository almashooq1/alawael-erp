/**
 * Auto-generated unit tests for models/InventoryStock.js
...
mockModelFn.modelName = 'InventoryStock';
...
let Model;
try { Model = require('../../models/InventoryStock'); } catch(e) { /* load fail */ }

describe('models/InventoryStock', () => {
