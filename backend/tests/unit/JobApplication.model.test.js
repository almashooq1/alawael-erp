/**
 * Auto-generated unit tests for models/JobApplication.js
...
mockModelFn.modelName = 'JobApplication';
...
let Model;
try { Model = require('../../models/JobApplication'); } catch(e) { /* load fail */ }

describe('models/JobApplication', () => {
