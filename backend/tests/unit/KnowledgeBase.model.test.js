/**
 * Auto-generated unit tests for models/KnowledgeBase.js
...
mockModelFn.modelName = 'KnowledgeArticle';
...
let Model;
try { Model = require('../../models/KnowledgeBase'); } catch(e) { /* load fail */ }

describe('models/KnowledgeBase', () => {
