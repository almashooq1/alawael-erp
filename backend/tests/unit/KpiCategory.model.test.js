/**
 * Auto-generated unit tests for models/KpiCategory.js
...
mockModelFn.modelName = 'KpiCategory';
...
let Model;
try { Model = require('../../models/KpiCategory'); } catch(e) { /* load fail */ }

describe('models/KpiCategory', () => {
