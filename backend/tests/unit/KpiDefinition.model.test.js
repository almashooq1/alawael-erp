/**
 * Auto-generated unit tests for models/KpiDefinition.js
...
mockModelFn.modelName = 'KpiDefinition';
...
let Model;
try { Model = require('../../models/KpiDefinition'); } catch(e) { /* load fail */ }

describe('models/KpiDefinition', () => {
