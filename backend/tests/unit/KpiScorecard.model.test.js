/**
 * Auto-generated unit tests for models/KpiScorecard.js
...
mockModelFn.modelName = 'KpiScorecard';
...
let Model;
try { Model = require('../../models/KpiScorecard'); } catch(e) { /* load fail */ }

describe('models/KpiScorecard', () => {
