/**
 * Auto-generated unit tests for models/KpiTarget.js
...
mockModelFn.modelName = 'KpiTarget';
...
let Model;
try { Model = require('../../models/KpiTarget'); } catch(e) { /* load fail */ }

describe('models/KpiTarget', () => {
