/**
 * Auto-generated unit tests for models/KpiValue.js
...
mockModelFn.modelName = 'KpiValue';
...
let Model;
try { Model = require('../../models/KpiValue'); } catch(e) { /* load fail */ }

describe('models/KpiValue', () => {
