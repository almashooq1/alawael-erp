/**
 * Auto-generated unit tests for models/LearningPath.js
...
mockModelFn.modelName = 'LearningPath';
...
let Model;
try { Model = require('../../models/LearningPath'); } catch(e) { /* load fail */ }

describe('models/LearningPath', () => {
