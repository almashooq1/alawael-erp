/**
 * Auto-generated unit tests for models/Leave.js
...
jest.mock('../../models/leave.model.js', () => ({}));

let Model;
try { Model = require('../../models/Leave'); } catch(e) { /* load fail */ }

describe('models/Leave', () => {
