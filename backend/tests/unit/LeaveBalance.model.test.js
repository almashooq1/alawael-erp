/**
 * Auto-generated unit tests for models/LeaveBalance.js
...
mockModelFn.modelName = 'LeaveBalance';
...
let Model;
try { Model = require('../../models/LeaveBalance'); } catch(e) { /* load fail */ }

describe('models/LeaveBalance', () => {
