/**
 * Auto-generated unit tests for models/LeaveRequest.js
...
mockModelFn.modelName = 'LeaveRequest';
...
let Model;
try { Model = require('../../models/LeaveRequest'); } catch(e) { /* load fail */ }

describe('models/LeaveRequest', () => {
