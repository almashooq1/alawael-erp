/**
 * Auto-generated unit tests for models/MDTCoordination.js
...
mockModelFn.modelName = 'MDTMeeting';
...
let Model;
try { Model = require('../../models/MDTCoordination'); } catch(e) { /* load fail */ }

describe('models/MDTCoordination', () => {
