/**
 * Auto-generated unit tests for models/Maintenance.js
...
mockModelFn.modelName = 'Maintenance';
...
let Model;
try { Model = require('../../models/Maintenance'); } catch(e) { /* load fail */ }

describe('models/Maintenance', () => {
