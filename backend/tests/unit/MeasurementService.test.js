...
jest.mock('../../models/MeasurementModels', () => ({
  MeasurementType: Object.assign(
    jest.fn().mockImplementation(() => ({ save: jest.fn().mockResolvedValue({ _id: 'id1' }) })),
    mockMeasurementModelsChain
  ),
  MeasurementMaster: Object.assign(
    jest.fn().mockImplementation(() => ({ save: jest.fn().mockResolvedValue({ _id: 'id1' }) })),
    mockMeasurementModelsChain
  ),
  MeasurementResult: Object.assign(
    jest.fn().mockImplementation(() => ({ save: jest.fn().mockResolvedValue({ _id: 'id1' }) })),
    mockMeasurementModelsChain
  ),
  IndividualRehabPlan: Object.assign(
    jest.fn().mockImplementation(() => ({ save: jest.fn().mockResolvedValue({ _id: 'id1' }) })),
    mockMeasurementModelsChain
  ),
  QuickAssessment: Object.assign(
    jest.fn().mockImplementation(() => ({ save: jest.fn().mockResolvedValue({ _id: 'id1' }) })),
    mockMeasurementModelsChain
  ),
  RehabilitationProgram: Object.assign(
    jest.fn().mockImplementation(() => ({ save: jest.fn().mockResolvedValue({ _id: 'id1' }) })),
    mockMeasurementModelsChain
  ),
  ProgramProgress: Object.assign(
    jest.fn().mockImplementation(() => ({ save: jest.fn().mockResolvedValue({ _id: 'id1' }) })),
    mockMeasurementModelsChain
  ),
  ProgramSession: Object.assign(
    jest.fn().mockImplementation(() => ({ save: jest.fn().mockResolvedValue({ _id: 'id1' }) })),
    mockMeasurementModelsChain
  ),
}));
...
jest.mock('../../models/RehabilitationProgramModels', () => ({
  MeasurementType: Object.assign(
    jest.fn().mockImplementation(() => ({ save: jest.fn().mockResolvedValue({ _id: 'id1' }) })),
    mockRehabilitationProgramModelsChain
  ),
  MeasurementMaster: Object.assign(
    jest.fn().mockImplementation(() => ({ save: jest.fn().mockResolvedValue({ _id: 'id1' }) })),
    mockRehabilitationProgramModelsChain
...
describe('MeasurementService service', () => {
  ...
  test('createMeasurementType is callable', async () => {
    ...
    let r;
    try {
      r = await svc.createMeasurementType({});
    } catch (e) {
      r = e;
    }
  ...
  test('createMeasurementMaster is callable', async () => {
    ...
    let r;
    try {
      r = await svc.createMeasurementMaster({});
    } catch (e) {
      r = e;
    }
    expect(r).toBeDefined();
  ...
  test('recordMeasurementResult is callable', async () => {
    ...
    let r;
    try {
      r = await svc.recordMeasurementResult({});
    } catch (e) {
      r = e;
    }
    expect(r).toBeDefined();
  ...
  test('getBeneficiaryLatestResults is callable', async () => {
    ...
    let r;
    try {
      r = await svc.getBeneficiaryLatestResults({});
    } catch (e) {
      r = e;
    }
    expect(r).toBeDefined();
  ...
  test('compareMeasurementResults is callable', async () => {
    ...
    let r;
    try {
      r = await svc.compareMeasurementResults({});
    } catch (e) {
      r = e;
    }
    expect(r).toBeDefined();
  ...
  test('createIndividualRehabPlan is callable', async () => {
    ...
    let r;
    try {
      r = await svc.createIndividualRehabPlan({});
    } catch (e) {
      r = e;
    }
    expect(r).toBeDefined();
  ...
  test('updateIndividualRehabPlan is callable', async () => {
    ...
    let r;
    try {
      r = await svc.updateIndividualRehabPlan({});
    } catch (e) {
      r = e;
    }
    expect(r).toBeDefined();
  ...
  test('getIndividualRehabPlan is callable', async () => {
    ...
    let r;
    try {
      r = await svc.getIndividualRehabPlan({});
    } catch (e) {
      r = e;
    }
    expect(r).toBeDefined();
  ...
  test('generateComprehensiveReport is callable', async () => {
    ...
    let r;
    try {
      r = await svc.generateComprehensiveReport({});
    } catch (e) {
      r = e;
    }
    expect(r).toBeDefined();
  ...
  test('recordProgramSession is callable', async () => {
    ...
    let r;
    try {
      r = await svc.recordProgramSession({});
    } catch (e) {
      r = e;
    }
    expect(r).toBeDefined();
  ...
  test('updateProgramProgress is callable', async () => {
    ...
    let r;
    try {
      r = await svc.updateProgramProgress({});
    } catch (e) {
      r = e;
    }
    expect(r).toBeDefined();
  ...
  test('calculateOverallStatus is callable', async () => {
    ...
    let r;
    try {
      r = await svc.calculateOverallStatus({});
    } catch (e) {
      r = e;
    }
    expect(r).toBeDefined();
  ...
  test('identifyAreasForImprovement is callable', async () => {
    ...
    let r;
    try {
      r = await svc.identifyAreasForImprovement({});
    } catch (e) {
      r = e;
    }
    expect(r).toBeDefined();
  ...
  test('generateFinalRecommendations is callable', async () => {
    ...
    let r;
    try {
      r = await svc.generateFinalRecommendations({});
    } catch (e) {
      r = e;
    }
    expect(r).toBeDefined();
