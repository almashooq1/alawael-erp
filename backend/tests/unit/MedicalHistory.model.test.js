/**
 * Auto-generated unit tests for models/MedicalHistory.js
...
mockModelFn.modelName = 'MedicalHistory';
...
let Model;
try { Model = require('../../models/MedicalHistory'); } catch(e) { /* load fail */ }

describe('models/MedicalHistory', () => {
