/**
 * Auto-generated unit tests for models/ModuleProgress.js
...
mockModelFn.modelName = 'ModuleProgress';
...
let Model;
try { Model = require('../../models/ModuleProgress'); } catch(e) { /* load fail */ }

describe('models/ModuleProgress', () => {
