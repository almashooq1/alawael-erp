/**
 * Auto-generated unit tests for models/NotificationTemplate.js
...
mockModelFn.modelName = 'NotificationTemplate';
...
let Model;
try { Model = require('../../models/NotificationTemplate'); } catch(e) { /* load fail */ }

describe('models/NotificationTemplate', () => {
  ...
  test('method "render" attached to schema', () => {
    if (!Model) return;
    const fn = mockSchema.methods['render'];
