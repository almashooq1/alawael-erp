/**
 * Auto-generated unit tests for models/OutcomeMeasure.js
...
mockModelFn.modelName = 'OutcomeMeasure';
...
let Model;
try { Model = require('../../models/OutcomeMeasure'); } catch(e) { /* load fail */ }

describe('models/OutcomeMeasure', () => {
