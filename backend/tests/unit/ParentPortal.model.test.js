/**
 * Auto-generated unit tests for models/ParentPortal.js
...
mockModelFn.modelName = 'ParentOtp';
...
let Model;
try { Model = require('../../models/ParentPortal'); } catch(e) { /* load fail */ }

describe('models/ParentPortal', () => {
