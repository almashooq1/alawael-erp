/**
 * Auto-generated unit tests for models/PaymentRefund.js
...
mockModelFn.modelName = 'PaymentRefund';
...
let Model;
try { Model = require('../../models/PaymentRefund'); } catch(e) { /* load fail */ }

describe('models/PaymentRefund', () => {
