/**
 * Auto-generated unit tests for models/PaymentVoucher.js
...
mockModelFn.modelName = 'PaymentVoucher';
...
let Model;
try { Model = require('../../models/PaymentVoucher'); } catch(e) { /* load fail */ }

describe('models/PaymentVoucher', () => {
