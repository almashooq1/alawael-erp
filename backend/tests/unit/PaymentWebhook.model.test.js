/**
 * Auto-generated unit tests for models/PaymentWebhook.js
...
mockModelFn.modelName = 'PaymentWebhook';
...
let Model;
try { Model = require('../../models/PaymentWebhook'); } catch(e) { /* load fail */ }

describe('models/PaymentWebhook', () => {
