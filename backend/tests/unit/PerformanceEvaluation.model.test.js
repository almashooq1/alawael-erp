/**
 * Auto-generated unit tests for models/PerformanceEvaluation.js
...
mockModelFn.modelName = 'PerformanceEvaluation';
...
let Model;
try { Model = require('../../models/PerformanceEvaluation'); } catch(e) { /* load fail */ }

describe('models/PerformanceEvaluation', () => {
  ...
  test('method "calculateOverallScore" attached to schema', () => {
    if (!Model) return;
    const fn = mockSchema.methods['calculateOverallScore'];
