/**
 * Auto-generated unit tests for models/PettyCash.js
...
mockModelFn.modelName = 'PettyCashTransaction';
...
let Model;
try { Model = require('../../models/PettyCash'); } catch(e) { /* load fail */ }

describe('models/PettyCash', () => {
