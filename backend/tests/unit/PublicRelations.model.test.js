/**
 * Auto-generated unit tests for models/PublicRelations.js
...
mockModelFn.modelName = 'MediaCoverage';
...
let Model;
try { Model = require('../../models/PublicRelations'); } catch(e) { /* load fail */ }

describe('models/PublicRelations', () => {
