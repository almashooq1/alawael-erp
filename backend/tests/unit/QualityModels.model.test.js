/**
 * Auto-generated unit tests for models/QualityModels.js
...
mockModelFn.modelName = 'QualityStandard';
...
let Model;
try { Model = require('../../models/QualityModels'); } catch(e) { /* load fail */ }

describe('models/QualityModels', () => {
