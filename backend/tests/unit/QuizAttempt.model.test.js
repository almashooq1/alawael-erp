/**
 * Auto-generated unit tests for models/QuizAttempt.js
...
mockModelFn.modelName = 'QuizAttempt';
...
let Model;
try { Model = require('../../models/QuizAttempt'); } catch(e) { /* load fail */ }

describe('models/QuizAttempt', () => {
