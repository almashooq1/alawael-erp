/**
 * Auto-generated unit tests for models/QuizQuestion.js
...
mockModelFn.modelName = 'QuizQuestion';
...
let Model;
try { Model = require('../../models/QuizQuestion'); } catch(e) { /* load fail */ }

describe('models/QuizQuestion', () => {
