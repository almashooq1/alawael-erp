/**
 * Auto-generated unit tests for models/Referral.js
...
mockModelFn.modelName = 'ReferringFacility';
...
let Model;
try { Model = require('../../models/Referral'); } catch(e) { /* load fail */ }

describe('models/Referral', () => {
