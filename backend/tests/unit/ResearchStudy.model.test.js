/**
 * Auto-generated unit tests for models/ResearchStudy.js
...
mockModelFn.modelName = 'ResearchStudy';
...
let Model;
try { Model = require('../../models/ResearchStudy'); } catch(e) { /* load fail */ }

describe('models/ResearchStudy', () => {
