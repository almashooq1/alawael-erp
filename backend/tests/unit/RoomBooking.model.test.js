/**
 * Auto-generated unit tests for models/RoomBooking.js
...
mockModelFn.modelName = 'RoomBooking';
...
let Model;
try { Model = require('../../models/RoomBooking'); } catch(e) { /* load fail */ }

describe('models/RoomBooking', () => {
