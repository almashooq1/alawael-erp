/**
 * Auto-generated unit tests for models/StrategicKPI.js
...
mockModelFn.modelName = 'StrategicKPI';
...
let Model;
try { Model = require('../../models/StrategicKPI'); } catch(e) { /* load fail */ }

describe('models/StrategicKPI', () => {
