/**
 * Auto-generated unit tests for models/SuccessionPlan.js
...
mockModelFn.modelName = 'SuccessionPlan';
...
let Model;
try { Model = require('../../models/SuccessionPlan'); } catch(e) { /* load fail */ }

describe('models/SuccessionPlan', () => {
  ...
  test('method "getBestCandidate" attached to schema', () => {
    if (!Model) return;
    const fn = mockSchema.methods['getBestCandidate'];
