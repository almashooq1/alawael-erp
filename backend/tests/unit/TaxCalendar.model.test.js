/**
 * Auto-generated unit tests for models/TaxCalendar.js
...
mockModelFn.modelName = 'TaxCalendar';
...
let Model;
try { Model = require('../../models/TaxCalendar'); } catch(e) { /* load fail */ }

describe('models/TaxCalendar', () => {
