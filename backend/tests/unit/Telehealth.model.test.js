/**
 * Auto-generated unit tests for models/Telehealth.js
...
mockModelFn.modelName = 'Teleconsultation';
...
let Model;
try { Model = require('../../models/Telehealth'); } catch(e) { /* load fail */ }

describe('models/Telehealth', () => {
