/**
 * Auto-generated unit tests for models/TherapyProgram.js
...
mockModelFn.modelName = 'TherapyProgram';
...
let Model;
try { Model = require('../../models/TherapyProgram'); } catch(e) { /* load fail */ }

describe('models/TherapyProgram', () => {
