/**
 * Auto-generated unit tests for models/TherapyRoom.js
...
mockModelFn.modelName = 'TherapyRoom';
...
let Model;
try { Model = require('../../models/TherapyRoom'); } catch(e) { /* load fail */ }

describe('models/TherapyRoom', () => {
