/**
 * Auto-generated unit tests for models/TherapySession.js
...
mockModelFn.modelName = 'TherapySession';
...
let Model;
try { Model = require('../../models/TherapySession'); } catch(e) { /* load fail */ }

describe('models/TherapySession', () => {
