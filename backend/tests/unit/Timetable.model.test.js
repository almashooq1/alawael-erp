/**
 * Auto-generated unit tests for models/Timetable.js
...
mockModelFn.modelName = 'Timetable';
...
let Model;
try { Model = require('../../models/Timetable'); } catch(e) { /* load fail */ }

describe('models/Timetable', () => {
  ...
  test('method "hasConflict" attached to schema', () => {
    if (!Model) return;
    const fn = mockSchema.methods['hasConflict'];
