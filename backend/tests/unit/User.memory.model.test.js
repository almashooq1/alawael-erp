/**
 * Auto-generated unit tests for models/User.memory.js
...
mockModelFn.modelName = 'User.memory';
...
let Model;
try { Model = require('../../models/User.memory'); } catch(e) { /* load fail */ }

describe('models/User.memory', () => {
