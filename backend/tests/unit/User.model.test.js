/**
 * Auto-generated unit tests for models/User.js
...
describe('models/User', () => {
  ...
  test('method "incLoginAttempts" attached to schema', () => {
    if (!Model) return;
    const fn = mockSchema.methods['incLoginAttempts'];
    if (fn) expect(typeof fn).toBe('function');
    else expect(true).toBe(true);
  });

  test('method "resetLoginAttempts" attached to schema', () => {
    if (!Model) return;
    const fn = mockSchema.methods['resetLoginAttempts'];
    if (fn) expect(typeof fn).toBe('function');
    else expect(true).toBe(true);
  });
