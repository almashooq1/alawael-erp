/**
 * Auto-generated unit tests for models/VirtualSession.js
...
mockModelFn.modelName = 'VirtualSession';
...
let Model;
try { Model = require('../../models/VirtualSession'); } catch(e) { /* load fail */ }

describe('models/VirtualSession', () => {
  ...
  test('static "getUpcomingSessions" attached to schema', () => {
    if (!Model) return;
    // Check if static was assigned during module load
    const fn = mockSchema.statics['getUpcomingSessions'];
