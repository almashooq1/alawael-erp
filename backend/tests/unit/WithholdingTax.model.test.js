/**
 * Auto-generated unit tests for models/WithholdingTax.js
...
mockModelFn.modelName = 'WithholdingTax';
...
let Model;
try { Model = require('../../models/WithholdingTax'); } catch(e) { /* load fail */ }

describe('models/WithholdingTax', () => {
