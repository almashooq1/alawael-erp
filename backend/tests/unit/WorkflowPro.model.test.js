/**
 * Auto-generated unit tests for models/WorkflowPro.js
...
mockModelFn.modelName = 'WorkflowFormTemplate';
...
let Model;
try { Model = require('../../models/WorkflowPro'); } catch(e) { /* load fail */ }

describe('models/WorkflowPro', () => {
