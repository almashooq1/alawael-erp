/**
 * Auto-generated unit tests for routes/academicYear.routes.js
...
let routeModule;
try { routeModule = require('../../routes/academicYear.routes'); } catch(e) { /* load fail */ }

describe('routes/academicYear.routes', () => {
