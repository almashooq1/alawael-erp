/**
 * Auto-generated unit tests for routes/account.real.routes.js
...
let routeModule;
try { routeModule = require('../../routes/account.real.routes'); } catch(e) { /* load fail */ }

describe('routes/account.real.routes', () => {
