/**
 * Auto-generated unit tests for routes/activities.routes.js
...
let routeModule;
try { routeModule = require('../../routes/activities.routes'); } catch(e) { /* load fail */ }

describe('routes/activities.routes', () => {
