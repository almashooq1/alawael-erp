/**
 * Auto-generated unit tests for routes/admin.real.routes.js
...
jest.mock('../../services/systemSettingsService', () => new Proxy({}, { get: () => jest.fn().mockResolvedValue({}) }));
...
let routeModule;
try { routeModule = require('../../routes/admin.real.routes'); } catch(e) { /* load fail */ }

describe('routes/admin.real.routes', () => {
