/**
 * Auto-generated unit tests for routes/advancedSettings.routes.js
...
jest.mock('../../services/settingsService', () => new Proxy({}, { get: () => jest.fn().mockResolvedValue({}) }));
...
let routeModule;
try { routeModule = require('../../routes/advancedSettings.routes'); } catch(e) { /* load fail */ }

describe('routes/advancedSettings.routes', () => {
