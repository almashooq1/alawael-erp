/**
 * Auto-generated unit tests for routes/advancedTickets.routes.js
...
let routeModule;
try { routeModule = require('../../routes/advancedTickets.routes'); } catch(e) { /* load fail */ }

describe('routes/advancedTickets.routes', () => {
