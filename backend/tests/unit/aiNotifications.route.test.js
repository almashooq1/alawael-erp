/**
 * Auto-generated unit tests for routes/aiNotifications.js
...
jest.mock('../../services/aiNotificationService', () => new Proxy({}, { get: () => jest.fn().mockResolvedValue({}) }));
...
let routeModule;
try { routeModule = require('../../routes/aiNotifications'); } catch(e) { /* load fail */ }

describe('routes/aiNotifications', () => {
