/**
 * Auto-generated unit tests for routes/analytics.js
...
jest.mock('../../services/performanceAnalyticsService', () => new Proxy({}, { get: () => jest.fn().mockResolvedValue({}) }));
...
let routeModule;
try { routeModule = require('../../routes/analytics'); } catch(e) { /* load fail */ }
