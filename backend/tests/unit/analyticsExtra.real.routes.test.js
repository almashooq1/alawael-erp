/**
 * Auto-generated unit tests for routes/analyticsExtra.real.routes.js
...
let routeModule;
try { routeModule = require('../../routes/analyticsExtra.real.routes'); } catch(e) { /* load fail */ }

describe('routes/analyticsExtra.real.routes', () => {
