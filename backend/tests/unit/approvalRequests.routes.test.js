/**
 * Auto-generated unit tests for routes/approvalRequests.routes.js
...
let routeModule;
try { routeModule = require('../../routes/approvalRequests.routes'); } catch(e) { /* load fail */ }

describe('routes/approvalRequests.routes', () => {
