/**
 * Auto-generated unit tests for models/assessment.model.js
...
mockModelFn.modelName = 'Assessment';
...
let Model;
try { Model = require('../../models/assessment.model'); } catch(e) { /* load fail */ }

describe('models/assessment.model', () => {
  ...
  test('static "searchByType" attached to schema', () => {
    if (!Model) return;
    // Check if static was assigned during module load
    const fn = mockSchema.statics['searchByType'];
