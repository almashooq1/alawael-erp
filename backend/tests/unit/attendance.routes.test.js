/**
 * Auto-generated unit tests for routes/attendance.routes.js
...
jest.mock('../../services/hr/attendanceService', () => new Proxy({}, { get: () => jest.fn().mockResolvedValue({}) }));
jest.mock('../../services/hr/notificationService', () => new Proxy({}, { get: () => jest.fn().mockResolvedValue({}) }));
...
let routeModule;
try { routeModule = require('../../routes/attendance.routes'); } catch(e) { /* load fail */ }

describe('routes/attendance.routes', () => {
