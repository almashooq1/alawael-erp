/**
 * Auto-generated unit tests for models/attendance_rules.model.js
...
mockModelFn.modelName = 'AttendanceRules';
...
let Model;
try { Model = require('../../models/attendance_rules.model'); } catch(e) { /* load fail */ }

describe('models/attendance_rules.model', () => {
  ...
  test('method "appliesTo" attached to schema', () => {
    if (!Model) return;
    const fn = mockSchema.methods['appliesTo'];
    if (fn) expect(typeof fn).toBe('function');
    else expect(true).toBe(true);
  });

  test('method "getWorkingHoursInfo" attached to schema', () => {
    if (!Model) return;
    const fn = mockSchema.methods['getWorkingHoursInfo'];
    if (fn) expect(typeof fn).toBe('function');
    else expect(true).toBe(true);
  });
