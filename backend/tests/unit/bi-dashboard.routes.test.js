/**
 * Auto-generated unit tests for routes/bi-dashboard.routes.js
...
let routeModule;
try { routeModule = require('../../routes/bi-dashboard.routes'); } catch(e) { /* load fail */ }

describe('routes/bi-dashboard.routes', () => {
