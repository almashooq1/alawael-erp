/**
 * Auto-generated unit tests for routes/biometric-attendance.routes.js
...
jest.mock('../../services/zktecoSdk.service', () => new Proxy({}, { get: () => jest.fn().mockResolvedValue({}) }));
jest.mock('../../services/attendanceProcessing.service', () => new Proxy({}, { get: () => jest.fn().mockResolvedValue({}) }));
...
let routeModule;
try { routeModule = require('../../routes/biometric-attendance.routes'); } catch(e) { /* load fail */ }

describe('routes/biometric-attendance.routes', () => {
