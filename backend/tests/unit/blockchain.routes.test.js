/**
 * Auto-generated unit tests for routes/blockchain.routes.js
...
let routeModule;
try { routeModule = require('../../routes/blockchain.routes'); } catch(e) { /* load fail */ }

describe('routes/blockchain.routes', () => {
