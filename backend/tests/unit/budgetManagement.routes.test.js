/**
 * Auto-generated unit tests for routes/budgetManagement.routes.js
...
let routeModule;
try { routeModule = require('../../routes/budgetManagement.routes'); } catch(e) { /* load fail */ }

describe('routes/budgetManagement.routes', () => {
