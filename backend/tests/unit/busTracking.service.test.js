...
describe('busTracking.service service', () => {
  ...
  test('getStudentsByParent is callable', async () => {
    ...
    let r;
    try {
      r = await svc.getStudentsByParent({});
    } catch (e) {
      r = e;
    }
    expect(r).toBeDefined();
  ...
  test('getAllBusLocations is callable', async () => {
    ...
    let r;
    try {
      r = await svc.getAllBusLocations({});
    } catch (e) {
      r = e;
    }
    expect(r).toBeDefined();
  ...
  test('getBoardingHistory is callable', async () => {
    ...
    let r;
    try {
      r = await svc.getBoardingHistory({});
    } catch (e) {
      r = e;
    }
    expect(r).toBeDefined();
  ...
  test('getParentDashboard is callable', async () => {
    ...
    let r;
    try {
      r = await svc.getParentDashboard({});
    } catch (e) {
      r = e;
    }
    expect(r).toBeDefined();
  ...
  test('getParentNotifications is callable', async () => {
    ...
    let r;
    try {
      r = await svc.getParentNotifications({});
    } catch (e) {
      r = e;
    }
    expect(r).toBeDefined();
  ...
  test('markNotificationRead is callable', async () => {
    ...
    let r;
    try {
      r = await svc.markNotificationRead({});
    } catch (e) {
      r = e;
    }
    expect(r).toBeDefined();
  ...
  test('markAllNotificationsRead is callable', async () => {
    ...
    let r;
    try {
      r = await svc.markAllNotificationsRead({});
    } catch (e) {
      r = e;
    }
    expect(r).toBeDefined();
