/**
 * Auto-generated unit tests for routes/campaigns.real.routes.js
...
let routeModule;
try { routeModule = require('../../routes/campaigns.real.routes'); } catch(e) { /* load fail */ }

describe('routes/campaigns.real.routes', () => {
