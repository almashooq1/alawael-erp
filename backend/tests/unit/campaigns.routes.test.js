/**
 * Auto-generated unit tests for routes/campaigns.routes.js
...
let routeModule;
try { routeModule = require('../../routes/campaigns.routes'); } catch(_e) { /* load fail */ }

describe('routes/campaigns.routes', () => {
