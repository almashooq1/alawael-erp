/**
 * Auto-generated unit tests for routes/central-settings.routes.js
...
let routeModule;
try { routeModule = require('../../routes/central-settings.routes'); } catch(e) { /* load fail */ }

describe('routes/central-settings.routes', () => {
