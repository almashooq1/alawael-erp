/**
 * Auto-generated unit tests for routes/chat.routes.js
...
jest.mock('../../services/chat.service', () => new Proxy({}, { get: () => jest.fn().mockResolvedValue({}) }));
jest.mock('../../utils/safeError', () => new Proxy({}, { get: (t, p) => p === '__esModule' ? false : jest.fn() }));

let routeModule;
try { routeModule = require('../../routes/chat.routes'); } catch(e) { /* load fail */ }
