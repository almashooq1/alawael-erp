/**
 * Auto-generated unit tests for routes/classrooms.routes.js
...
let routeModule;
try { routeModule = require('../../routes/classrooms.routes'); } catch(e) { /* load fail */ }

describe('routes/classrooms.routes', () => {
