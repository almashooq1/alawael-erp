/**
 * Auto-generated unit tests for routes/communications.real.routes.js
...
let routeModule;
try { routeModule = require('../../routes/communications.real.routes'); } catch(e) { /* load fail */ }

describe('routes/communications.real.routes', () => {
