/**
 * Auto-generated unit tests for routes/communications.routes.js
...
let routeModule;
try { routeModule = require('../../routes/communications.routes'); } catch(_e) { /* load fail */ }

describe('routes/communications.routes', () => {
