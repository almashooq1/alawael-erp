/**
 * Auto-generated tests for scheduler/community-service.scheduler.js
 * Validates syntax, structure, and patterns (service — 176L)
...
const SRC = path.resolve(__dirname, '../../scheduler/community-service.scheduler.js');

describe('scheduler/community-service.scheduler.js', () => {
  let source;
  beforeAll(() => {
  ...
  test('exports initCommunityServiceScheduler', () => {
    expect(source).toMatch(/initCommunityServiceScheduler/);
  });
});
