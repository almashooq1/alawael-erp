...
jest.mock('../../models/CommunityActivity', () => ({
  CommunityActivity: Object.assign(
    jest.fn().mockImplementation(() => ({ save: jest.fn().mockResolvedValue({ _id: 'id1' }) })),
    mockCommunityActivityChain
  ),
  CivilPartnership: Object.assign(
    jest.fn().mockImplementation(() => ({ save: jest.fn().mockResolvedValue({ _id: 'id1' }) })),
    mockCommunityActivityChain
  ),
  EventParticipation: Object.assign(
    jest.fn().mockImplementation(() => ({ save: jest.fn().mockResolvedValue({ _id: 'id1' }) })),
    mockCommunityActivityChain
  ),
  IntegrationAssessment: Object.assign(
    jest.fn().mockImplementation(() => ({ save: jest.fn().mockResolvedValue({ _id: 'id1' }) })),
    mockCommunityActivityChain
  ),
  AwarenessProgram: Object.assign(
    jest.fn().mockImplementation(() => ({ save: jest.fn().mockResolvedValue({ _id: 'id1' }) })),
    mockCommunityActivityChain
  ),
}));
...
jest.mock('../../models/IntegrationAssessment', () => ({
  CommunityActivity: Object.assign(
    jest.fn().mockImplementation(() => ({ save: jest.fn().mockResolvedValue({ _id: 'id1' }) })),
    mockIntegrationAssessmentChain
  ),
  CivilPartnership: Object.assign(
    jest.fn().mockImplementation(() => ({ save: jest.fn().mockResolvedValue({ _id: 'id1' }) })),
    mockIntegrationAssessmentChain
...
describe('communityIntegration.service service', () => {
  ...
  test('getPartnershipById is callable', async () => {
    ...
    let r;
    try {
      r = await svc.getPartnershipById({});
    } catch (e) {
      r = e;
    }
    expect(r).toBeDefined();
  ...
  test('getPartnershipStats is callable', async () => {
    ...
    let r;
    try {
      r = await svc.getPartnershipStats({});
    } catch (e) {
      r = e;
    }
    expect(r).toBeDefined();
  ...
  test('registerParticipation is callable', async () => {
    ...
    let r;
    try {
      r = await svc.registerParticipation({});
    } catch (e) {
      r = e;
    }
    expect(r).toBeDefined();
  ...
  test('getParticipationById is callable', async () => {
    ...
    let r;
    try {
      r = await svc.getParticipationById({});
    } catch (e) {
      r = e;
    }
    expect(r).toBeDefined();
  ...
  test('updateParticipation is callable', async () => {
    ...
    let r;
    try {
      r = await svc.updateParticipation({});
    } catch (e) {
      r = e;
    }
    expect(r).toBeDefined();
  ...
  test('getParticipationStats is callable', async () => {
    ...
    let r;
    try {
      r = await svc.getParticipationStats({});
    } catch (e) {
      r = e;
    }
    expect(r).toBeDefined();
  ...
  test('getBeneficiaryHistory is callable', async () => {
    ...
    let r;
    try {
      r = await svc.getBeneficiaryHistory({});
    } catch (e) {
      r = e;
    }
    expect(r).toBeDefined();
  ...
  test('getIntegrationProgress is callable', async () => {
    ...
    let r;
    try {
      r = await svc.getIntegrationProgress({});
    } catch (e) {
      r = e;
    }
    expect(r).toBeDefined();
  ...
  test('getAssessmentStats is callable', async () => {
    ...
    let r;
    try {
      r = await svc.getAssessmentStats({});
    } catch (e) {
      r = e;
    }
    expect(r).toBeDefined();
  ...
  test('createAwarenessProgram is callable', async () => {
    ...
    let r;
    try {
      r = await svc.createAwarenessProgram({});
    } catch (e) {
      r = e;
    }
    expect(r).toBeDefined();
  ...
  test('getAwarenessPrograms is callable', async () => {
    ...
    let r;
    try {
      r = await svc.getAwarenessPrograms({});
    } catch (e) {
      r = e;
    }
    expect(r).toBeDefined();
  ...
  test('getAwarenessProgramById is callable', async () => {
    ...
    let r;
    try {
      r = await svc.getAwarenessProgramById({});
    } catch (e) {
      r = e;
    }
    expect(r).toBeDefined();
  ...
  test('updateAwarenessProgram is callable', async () => {
    ...
    let r;
    try {
      r = await svc.updateAwarenessProgram({});
    } catch (e) {
      r = e;
    }
    expect(r).toBeDefined();
  ...
  test('deleteAwarenessProgram is callable', async () => {
    ...
    let r;
    try {
      r = await svc.deleteAwarenessProgram({});
    } catch (e) {
      r = e;
    }
    expect(r).toBeDefined();
  ...
  test('getAwarenessProgramStats is callable', async () => {
    ...
    let r;
    try {
      r = await svc.getAwarenessProgramStats({});
    } catch (e) {
      r = e;
    }
    expect(r).toBeDefined();
  ...
  test('getCommunityIntegrationDashboard is callable', async () => {
    ...
    let r;
    try {
      r = await svc.getCommunityIntegrationDashboard({});
    } catch (e) {
      r = e;
    }
    expect(r).toBeDefined();
