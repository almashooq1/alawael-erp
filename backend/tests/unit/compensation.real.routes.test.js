/**
 * Auto-generated unit tests for routes/compensation.real.routes.js
...
let routeModule;
try { routeModule = require('../../routes/compensation.real.routes'); } catch(e) { /* load fail */ }

describe('routes/compensation.real.routes', () => {
