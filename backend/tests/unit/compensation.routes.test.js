/**
 * Auto-generated unit tests for routes/compensation.routes.js
...
let routeModule;
try { routeModule = require('../../routes/compensation.routes'); } catch(_e) { /* load fail */ }

describe('routes/compensation.routes', () => {
