/**
 * Auto-generated unit tests for routes/complaints.routes.js
...
let routeModule;
try { routeModule = require('../../routes/complaints.routes'); } catch(e) { /* load fail */ }

describe('routes/complaints.routes', () => {
