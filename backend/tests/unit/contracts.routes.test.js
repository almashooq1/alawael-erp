/**
 * Auto-generated unit tests for routes/contracts.routes.js
...
let routeModule;
try { routeModule = require('../../routes/contracts.routes'); } catch(e) { /* load fail */ }

describe('routes/contracts.routes', () => {
