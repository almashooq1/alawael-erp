/**
 * Auto-generated unit tests for routes/crisis.routes.js
...
let routeModule;
try { routeModule = require('../../routes/crisis.routes'); } catch(e) { /* load fail */ }

describe('routes/crisis.routes', () => {
