/**
 * Auto-generated unit tests for routes/curriculum.routes.js
...
let routeModule;
try { routeModule = require('../../routes/curriculum.routes'); } catch(e) { /* load fail */ }

describe('routes/curriculum.routes', () => {
