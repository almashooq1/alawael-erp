/**
 * Auto-generated unit tests for routes/ddd-appointment-engine.routes.js
...
jest.mock('../../services/dddAppointmentEngine', () => new Proxy({}, { get: () => jest.fn().mockResolvedValue({}) }));

let routeModule;
try { routeModule = require('../../routes/ddd-appointment-engine.routes'); } catch(e) { /* load fail */ }

describe('routes/ddd-appointment-engine.routes', () => {
