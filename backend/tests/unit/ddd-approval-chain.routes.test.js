/**
 * Auto-generated unit tests for routes/ddd-approval-chain.routes.js
...
jest.mock('../../services/dddApprovalChain', () => new Proxy({}, { get: () => jest.fn().mockResolvedValue({}) }));

let routeModule;
try { routeModule = require('../../routes/ddd-approval-chain.routes'); } catch(e) { /* load fail */ }

describe('routes/ddd-approval-chain.routes', () => {
