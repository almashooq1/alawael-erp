/**
 * Auto-generated unit tests for routes/ddd-asset-tracker.routes.js
...
jest.mock('../../services/dddAssetTracker', () => new Proxy({}, { get: () => jest.fn().mockResolvedValue({}) }));

let routeModule;
try { routeModule = require('../../routes/ddd-asset-tracker.routes'); } catch(e) { /* load fail */ }

describe('routes/ddd-asset-tracker.routes', () => {
