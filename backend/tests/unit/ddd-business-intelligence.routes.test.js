/**
 * Auto-generated unit tests for routes/ddd-business-intelligence.routes.js
...
jest.mock('../../services/dddBusinessIntelligence', () => new Proxy({}, { get: () => jest.fn().mockResolvedValue({}) }));
...
jest.mock('../../validations/business-intelligence.validation', () => new Proxy({}, { get: (t, p) => p === '__esModule' ? false : jest.fn() }));

let routeModule;
try { routeModule = require('../../routes/ddd-business-intelligence.routes'); } catch(e) { /* load fail */ }

describe('routes/ddd-business-intelligence.routes', () => {
