/**
 * Auto-generated unit tests for routes/ddd-capacity-planner.routes.js
...
jest.mock('../../services/dddCapacityPlanner', () => new Proxy({}, { get: () => jest.fn().mockResolvedValue({}) }));

let routeModule;
try { routeModule = require('../../routes/ddd-capacity-planner.routes'); } catch(e) { /* load fail */ }

describe('routes/ddd-capacity-planner.routes', () => {
