/**
 * Auto-generated unit tests for routes/ddd-data-migration.routes.js
...
jest.mock('../../services/dddDataMigration', () => new Proxy({}, { get: () => jest.fn().mockResolvedValue({}) }));
...
let routeModule;
try { routeModule = require('../../routes/ddd-data-migration.routes'); } catch(e) { /* load fail */ }

describe('routes/ddd-data-migration.routes', () => {
