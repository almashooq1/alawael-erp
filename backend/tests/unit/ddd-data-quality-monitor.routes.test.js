/**
 * Auto-generated unit tests for routes/ddd-data-quality-monitor.routes.js
...
jest.mock('../../services/dddDataQualityMonitor', () => new Proxy({}, { get: () => jest.fn().mockResolvedValue({}) }));
...
let routeModule;
try { routeModule = require('../../routes/ddd-data-quality-monitor.routes'); } catch(e) { /* load fail */ }

describe('routes/ddd-data-quality-monitor.routes', () => {
