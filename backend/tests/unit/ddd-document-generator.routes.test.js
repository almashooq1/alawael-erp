/**
 * Auto-generated unit tests for routes/ddd-document-generator.routes.js
...
jest.mock('../../services/dddDocumentGenerator', () => new Proxy({}, { get: () => jest.fn().mockResolvedValue({}) }));

let routeModule;
try { routeModule = require('../../routes/ddd-document-generator.routes'); } catch(e) { /* load fail */ }

describe('routes/ddd-document-generator.routes', () => {
