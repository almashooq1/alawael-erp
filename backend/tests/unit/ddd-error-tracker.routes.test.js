/**
 * Auto-generated unit tests for routes/ddd-error-tracker.routes.js
...
jest.mock('../../services/dddErrorTracker', () => new Proxy({}, { get: () => jest.fn().mockResolvedValue({}) }));
...
let routeModule;
try { routeModule = require('../../routes/ddd-error-tracker.routes'); } catch(e) { /* load fail */ }

describe('routes/ddd-error-tracker.routes', () => {
