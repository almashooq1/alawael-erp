/**
 * Auto-generated unit tests for routes/ddd-health-monitor.routes.js
...
jest.mock('../../services/dddHealthMonitor', () => new Proxy({}, { get: () => jest.fn().mockResolvedValue({}) }));

let routeModule;
try { routeModule = require('../../routes/ddd-health-monitor.routes'); } catch(e) { /* load fail */ }

describe('routes/ddd-health-monitor.routes', () => {
