/**
 * Auto-generated unit tests for routes/ddd-interoperability-gateway.routes.js
...
jest.mock('../../services/dddInteroperabilityGateway', () => new Proxy({}, { get: () => jest.fn().mockResolvedValue({}) }));
...
let routeModule;
try { routeModule = require('../../routes/ddd-interoperability-gateway.routes'); } catch(e) { /* load fail */ }

describe('routes/ddd-interoperability-gateway.routes', () => {
