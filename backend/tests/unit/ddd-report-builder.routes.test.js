/**
 * Auto-generated unit tests for routes/ddd-report-builder.routes.js
...
jest.mock('../../services/dddReportBuilder', () => new Proxy({}, { get: () => jest.fn().mockResolvedValue({}) }));
...
let routeModule;
try { routeModule = require('../../routes/ddd-report-builder.routes'); } catch(e) { /* load fail */ }

describe('routes/ddd-report-builder.routes', () => {
