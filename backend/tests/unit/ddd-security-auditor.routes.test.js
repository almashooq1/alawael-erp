/**
 * Auto-generated unit tests for routes/ddd-security-auditor.routes.js
...
jest.mock('../../services/dddSecurityAuditor', () => new Proxy({}, { get: () => jest.fn().mockResolvedValue({}) }));
...
let routeModule;
try { routeModule = require('../../routes/ddd-security-auditor.routes'); } catch(e) { /* load fail */ }

describe('routes/ddd-security-auditor.routes', () => {
