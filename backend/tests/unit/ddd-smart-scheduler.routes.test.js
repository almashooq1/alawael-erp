/**
 * Auto-generated unit tests for routes/ddd-smart-scheduler.routes.js
...
jest.mock('../../services/dddSmartScheduler', () => new Proxy({}, { get: () => jest.fn().mockResolvedValue({}) }));
...
let routeModule;
try { routeModule = require('../../routes/ddd-smart-scheduler.routes'); } catch(e) { /* load fail */ }

describe('routes/ddd-smart-scheduler.routes', () => {
