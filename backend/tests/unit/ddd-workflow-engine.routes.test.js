/**
 * Auto-generated unit tests for routes/ddd-workflow-engine.routes.js
...
jest.mock('../../services/dddWorkflowEngine', () => new Proxy({}, { get: () => jest.fn().mockResolvedValue({}) }));

let routeModule;
try { routeModule = require('../../routes/ddd-workflow-engine.routes'); } catch(e) { /* load fail */ }

describe('routes/ddd-workflow-engine.routes', () => {
