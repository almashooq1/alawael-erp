...
jest.mock('../../models/disabilityAuthority.models', () => ({
  DisabilityAuthorityReport: Object.assign(
    jest.fn().mockImplementation(() => ({ save: jest.fn().mockResolvedValue({ _id: 'id1' }) })),
    mockdisabilityAuthority_modelsChain
  ),
  CBAHIStandard: Object.assign(
    jest.fn().mockImplementation(() => ({ save: jest.fn().mockResolvedValue({ _id: 'id1' }) })),
    mockdisabilityAuthority_modelsChain
  ),
  CBAHICompliance: Object.assign(
    jest.fn().mockImplementation(() => ({ save: jest.fn().mockResolvedValue({ _id: 'id1' }) })),
    mockdisabilityAuthority_modelsChain
  ),
}));
...
describe('disabilityAuthority.service service', () => {
  ...
  test('generateReportData static method is callable', async () => {
    ...
    let r;
    try {
      r = await Svc.generateReportData({});
    } catch (e) {
      r = e;
    }
    expect(r).toBeDefined();
  ...
  test('seedDefaultStandards static method is callable', async () => {
    ...
    let r;
    try {
      r = await Svc.seedDefaultStandards({});
    } catch (e) {
      r = e;
    }
    expect(r).toBeDefined();
  ...
  test('updateStandardResult static method is callable', async () => {
    ...
    let r;
    try {
      r = await Svc.updateStandardResult({});
    } catch (e) {
      r = e;
    }
    expect(r).toBeDefined();
  ...
  test('completeAssessment static method is callable', async () => {
    ...
    let r;
    try {
      r = await Svc.completeAssessment({});
    } catch (e) {
      r = e;
    }
    expect(r).toBeDefined();
  ...
  test('_generateReportNumber static method is callable', async () => {
    ...
    let r;
    try {
      r = await Svc._generateReportNumber({});
    } catch (e) {
      r = e;
    }
    expect(r).toBeDefined();
  ...
  test('_collectBeneficiaryStats static method is callable', async () => {
    ...
    let r;
    try {
      r = await Svc._collectBeneficiaryStats({});
    } catch (e) {
      r = e;
    }
    expect(r).toBeDefined();
  ...
  test('_collectServiceStats static method is callable', async () => {
    ...
    let r;
    try {
      r = await Svc._collectServiceStats({});
    } catch (e) {
      r = e;
    }
    expect(r).toBeDefined();
  ...
  test('_collectStaffStats static method is callable', async () => {
    ...
    let r;
    try {
      r = await Svc._collectStaffStats({});
    } catch (e) {
      r = e;
    }
    expect(r).toBeDefined();
  ...
  test('_collectQualityIndicators static method is callable', async () => {
    ...
    let r;
    try {
      r = await Svc._collectQualityIndicators({});
    } catch (e) {
      r = e;
    }
    expect(r).toBeDefined();
  ...
  test('_collectOutcomeIndicators static method is callable', async () => {
    ...
    let r;
    try {
      r = await Svc._collectOutcomeIndicators({});
    } catch (e) {
      r = e;
    }
    expect(r).toBeDefined();
  ...
  test('_getUpcomingReportDeadlines static method is callable', async () => {
    ...
    let r;
    try {
      r = await Svc._getUpcomingReportDeadlines({});
    } catch (e) {
      r = e;
    }
    expect(r).toBeDefined();
  ...
  test('_recalculateOverallResults static method is callable', async () => {
    ...
    let r;
    try {
      r = await Svc._recalculateOverallResults({});
    } catch (e) {
      r = e;
    }
    expect(r).toBeDefined();
  ...
  test('_calculateChapterResults static method is callable', async () => {
    ...
    let r;
    try {
      r = await Svc._calculateChapterResults({});
    } catch (e) {
      r = e;
    }
    expect(r).toBeDefined();
  ...
  test('_determineReadiness static method is callable', async () => {
    ...
    let r;
    try {
      r = await Svc._determineReadiness({});
    } catch (e) {
      r = e;
    }
    expect(r).toBeDefined();
  ...
  test('_getDefaultCBAHIStandards static method is callable', async () => {
    ...
    let r;
    try {
      r = await Svc._getDefaultCBAHIStandards({});
    } catch (e) {
      r = e;
    }
    expect(r).toBeDefined();
