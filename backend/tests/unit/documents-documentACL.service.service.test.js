/**
 * Auto-generated tests for services/documents/documentACL.service.js
...
const SRC = path.resolve(__dirname, '../../services/documents/documentACL.service.js');

describe('services/documents/documentACL.service.js', () => {
  let source;
  beforeAll(() => {
  ...
  test('is syntactically valid JavaScript', () => {
    expect(() => new vm.Script(source, { filename: 'documentACL.service.js' })).not.toThrow();
  });
