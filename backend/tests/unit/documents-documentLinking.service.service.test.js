/**
 * Auto-generated tests for services/documents/documentLinking.service.js
 * Validates syntax, structure, and patterns (model — 560L)
...
const SRC = path.resolve(__dirname, '../../services/documents/documentLinking.service.js');

describe('services/documents/documentLinking.service.js', () => {
  let source;
  beforeAll(() => {
  ...
  test('is syntactically valid JavaScript', () => {
    expect(() => new vm.Script(source, { filename: 'documentLinking.service.js' })).not.toThrow();
  });
