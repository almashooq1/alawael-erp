/**
 * Auto-generated tests for services/documents/documentTags.service.js
 * Validates syntax, structure, and patterns (model — 723L)
...
const SRC = path.resolve(__dirname, '../../services/documents/documentTags.service.js');

describe('services/documents/documentTags.service.js', () => {
  let source;
  beforeAll(() => {
  ...
  test('is syntactically valid JavaScript', () => {
    expect(() => new vm.Script(source, { filename: 'documentTags.service.js' })).not.toThrow();
  });
