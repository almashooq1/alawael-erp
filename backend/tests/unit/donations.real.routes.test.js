/**
 * Auto-generated unit tests for routes/donations.real.routes.js
...
let routeModule;
try { routeModule = require('../../routes/donations.real.routes'); } catch(e) { /* load fail */ }

describe('routes/donations.real.routes', () => {
