/**
 * Auto-generated unit tests for routes/donations.routes.js
...
let routeModule;
try { routeModule = require('../../routes/donations.routes'); } catch(_e) { /* load fail */ }

describe('routes/donations.routes', () => {
