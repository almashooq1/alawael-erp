/**
 * Auto-generated unit tests for routes/donors.real.routes.js
...
let routeModule;
try { routeModule = require('../../routes/donors.real.routes'); } catch(e) { /* load fail */ }

describe('routes/donors.real.routes', () => {
