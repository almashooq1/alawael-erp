/**
 * Auto-generated unit tests for routes/eInvoicing.routes.js
...
let routeModule;
try { routeModule = require('../../routes/eInvoicing.routes'); } catch(e) { /* load fail */ }

describe('routes/eInvoicing.routes', () => {
