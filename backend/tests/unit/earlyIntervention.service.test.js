...
jest.mock('../../models/EarlyIntervention', () => ({
  EarlyInterventionChild: Object.assign(
    jest.fn().mockImplementation(() => ({ save: jest.fn().mockResolvedValue({ _id: 'id1' }) })),
    mockEarlyInterventionChain
  ),
  DevelopmentalScreening: Object.assign(
    jest.fn().mockImplementation(() => ({ save: jest.fn().mockResolvedValue({ _id: 'id1' }) })),
    mockEarlyInterventionChain
  ),
  DevelopmentalMilestone: Object.assign(
    jest.fn().mockImplementation(() => ({ save: jest.fn().mockResolvedValue({ _id: 'id1' }) })),
    mockEarlyInterventionChain
  ),
  IFSP: Object.assign(
...
describe('earlyIntervention.service service', () => {
  ...
  test('getChildFullProfile is callable', async () => {
    ...
    let r;
    try {
      r = await svc.getChildFullProfile({});
    } catch (e) {
      r = e;
    }
    expect(r).toBeDefined();
  ...
  test('getScreeningsByChild is callable', async () => {
    ...
    let r;
    try {
      r = await svc.getScreeningsByChild({});
    } catch (e) {
      r = e;
    }
    expect(r).toBeDefined();
  ...
  test('getMilestonesByChild is callable', async () => {
    ...
    let r;
    try {
      r = await svc.getMilestonesByChild({});
    } catch (e) {
      r = e;
    }
    expect(r).toBeDefined();
  ...
  test('getMilestoneReport is callable', async () => {
    ...
    let r;
    try {
      r = await svc.getMilestoneReport({});
    } catch (e) {
      r = e;
    }
    expect(r).toBeDefined();
  ...
  test('updateIFSPGoalProgress is callable', async () => {
    ...
    let r;
    try {
      r = await svc.updateIFSPGoalProgress({});
    } catch (e) {
      r = e;
    }
    expect(r).toBeDefined();
  ...
  test('getReferralsByChild is callable', async () => {
    ...
    let r;
    try {
      r = await svc.getReferralsByChild({});
    } catch (e) {
      r = e;
    }
    expect(r).toBeDefined();
  ...
  test('addReferralCommunication is callable', async () => {
    ...
    let r;
    try {
      r = await svc.addReferralCommunication({});
    } catch (e) {
      r = e;
    }
    expect(r).toBeDefined();
  ...
  test('updateReferralStatus is callable', async () => {
    ...
    let r;
    try {
      r = await svc.updateReferralStatus({});
    } catch (e) {
      r = e;
    }
    expect(r).toBeDefined();
  ...
  test('initializeMilestonesForChild is callable', async () => {
    ...
    let r;
    try {
      r = await svc.initializeMilestonesForChild({});
    } catch (e) {
      r = e;
    }
    expect(r).toBeDefined();
