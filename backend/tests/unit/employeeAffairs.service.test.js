...
describe('employeeAffairs.service service', () => {
  ...
  test('getEmployeeProfile is callable', async () => {
    ...
    let r;
    try {
      r = await svc.getEmployeeProfile({});
    } catch (e) {
      r = e;
    }
    expect(r).toBeDefined();
  ...
  test('approveLeaveByManager is callable', async () => {
    ...
    let r;
    try {
      r = await svc.approveLeaveByManager({});
    } catch (e) {
      r = e;
    }
    expect(r).toBeDefined();
  ...
  test('getMonthlyAttendanceReport is callable', async () => {
    ...
    let r;
    try {
      r = await svc.getMonthlyAttendanceReport({});
    } catch (e) {
      r = e;
    }
    expect(r).toBeDefined();
  ...
  test('createPerformanceReview is callable', async () => {
    ...
    let r;
    try {
      r = await svc.createPerformanceReview({});
    } catch (e) {
      r = e;
    }
    expect(r).toBeDefined();
  ...
  test('getPerformanceHistory is callable', async () => {
    ...
    let r;
    try {
      r = await svc.getPerformanceHistory({});
    } catch (e) {
      r = e;
    }
    expect(r).toBeDefined();
  ...
  test('getExpiringContracts is callable', async () => {
    ...
    let r;
    try {
      r = await svc.getExpiringContracts({});
    } catch (e) {
      r = e;
    }
    expect(r).toBeDefined();
  ...
  test('getDepartmentStatistics is callable', async () => {
    ...
    let r;
    try {
      r = await svc.getDepartmentStatistics({});
    } catch (e) {
      r = e;
    }
    expect(r).toBeDefined();
  ...
  test('getEmployeeGovernmentSummary is callable', async () => {
    ...
    let r;
    try {
      r = await svc.getEmployeeGovernmentSummary({});
    } catch (e) {
      r = e;
    }
    expect(r).toBeDefined();
  ...
  test('updateEmployeeMOLData is callable', async () => {
    ...
    let r;
    try {
      r = await svc.updateEmployeeMOLData({});
    } catch (e) {
      r = e;
    }
    expect(r).toBeDefined();
  ...
  test('updateEmployeeSponsorshipData is callable', async () => {
    ...
    let r;
    try {
      r = await svc.updateEmployeeSponsorshipData({});
    } catch (e) {
      r = e;
    }
    expect(r).toBeDefined();
  ...
  test('getExpiringDocumentsReport is callable', async () => {
    ...
    let r;
    try {
      r = await svc.getExpiringDocumentsReport({});
    } catch (e) {
      r = e;
    }
    expect(r).toBeDefined();
  ...
  test('getSaudizationReport is callable', async () => {
    ...
    let r;
    try {
      r = await svc.getSaudizationReport({});
    } catch (e) {
      r = e;
    }
    expect(r).toBeDefined();
