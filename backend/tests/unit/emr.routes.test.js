/**
 * Auto-generated unit tests for routes/emr.routes.js
...
let routeModule;
try { routeModule = require('../../routes/emr.routes'); } catch(e) { /* load fail */ }

describe('routes/emr.routes', () => {
