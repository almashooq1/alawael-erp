/**
 * Auto-generated unit tests for routes/enterprise-risk.routes.js
...
let routeModule;
try { routeModule = require('../../routes/enterprise-risk.routes'); } catch(e) { /* load fail */ }

describe('routes/enterprise-risk.routes', () => {
