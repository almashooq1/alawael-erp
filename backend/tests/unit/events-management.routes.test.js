/**
 * Auto-generated unit tests for routes/events-management.routes.js
...
let routeModule;
try { routeModule = require('../../routes/events-management.routes'); } catch(e) { /* load fail */ }

describe('routes/events-management.routes', () => {
