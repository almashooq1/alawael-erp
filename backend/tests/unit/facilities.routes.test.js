/**
 * Auto-generated unit tests for routes/facilities.routes.js
...
let routeModule;
try { routeModule = require('../../routes/facilities.routes'); } catch(e) { /* load fail */ }

describe('routes/facilities.routes', () => {
