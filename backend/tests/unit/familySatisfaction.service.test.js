...
jest.mock('../../models/familySatisfaction.models', () => ({
  SurveyTemplate: Object.assign(
    jest.fn().mockImplementation(() => ({ save: jest.fn().mockResolvedValue({ _id: 'id1' }) })),
    mockfamilySatisfaction_modelsChain
  ),
  SurveyResponse: Object.assign(
    jest.fn().mockImplementation(() => ({ save: jest.fn().mockResolvedValue({ _id: 'id1' }) })),
    mockfamilySatisfaction_modelsChain
  ),
  SurveyAnalytics: Object.assign(
    jest.fn().mockImplementation(() => ({ save: jest.fn().mockResolvedValue({ _id: 'id1' }) })),
    mockfamilySatisfaction_modelsChain
  ),
}));
...
describe('familySatisfaction.service service', () => {
  ...
  test('seedDefaultTemplates static method is callable', async () => {
    ...
    let r;
    try {
      r = await Svc.seedDefaultTemplates({});
    } catch (e) {
      r = e;
    }
    expect(r).toBeDefined();
  ...
  test('createDirectResponse static method is callable', async () => {
    ...
    let r;
    try {
      r = await Svc.createDirectResponse({});
    } catch (e) {
      r = e;
    }
    expect(r).toBeDefined();
  ...
  test('generateAnalyticsReport static method is callable', async () => {
    ...
    let r;
    try {
      r = await Svc.generateAnalyticsReport({});
    } catch (e) {
      r = e;
    }
    expect(r).toBeDefined();
  ...
  test('_computeNPSFromScores static method is callable', async () => {
    ...
    let r;
    try {
      r = await Svc._computeNPSFromScores({});
    } catch (e) {
      r = e;
    }
    expect(r).toBeDefined();
  ...
  test('_getDefaultTemplates static method is callable', async () => {
    ...
    let r;
    try {
      r = await Svc._getDefaultTemplates({});
    } catch (e) {
      r = e;
    }
    expect(r).toBeDefined();
