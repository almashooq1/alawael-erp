/**
 * Auto-generated unit tests for routes/feedback.routes.js
...
let routeModule;
try { routeModule = require('../../routes/feedback.routes'); } catch(e) { /* load fail */ }

describe('routes/feedback.routes', () => {
