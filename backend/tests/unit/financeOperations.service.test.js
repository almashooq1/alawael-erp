...
jest.mock('../../models/Invoice', () => ({
  ...
  PettyCash: Object.assign(
    jest.fn().mockImplementation(() => ({ save: jest.fn().mockResolvedValue({ _id: 'id1' }) })),
    mockInvoiceChain
  ),
  _CashFlow: Object.assign(
    jest.fn().mockImplementation(() => ({ save: jest.fn().mockResolvedValue({ _id: 'id1' }) })),
    mockInvoiceChain
  ),
  Cheque: Object.assign(
    jest.fn().mockImplementation(() => ({ save: jest.fn().mockResolvedValue({ _id: 'id1' }) })),
    mockInvoiceChain
  ),
  BankReconciliation: Object.assign(
    jest.fn().mockImplementation(() => ({ save: jest.fn().mockResolvedValue({ _id: 'id1' }) })),
    mockInvoiceChain
  ),
...
describe('financeOperations.service service', () => {
  ...
  test('listJournalEntries is callable', async () => {
    ...
    let r;
    try {
      r = await svc.listJournalEntries({});
    } catch (e) {
      r = e;
    }
    expect(r).toBeDefined();
  ...
  test('createJournalEntry is callable', async () => {
    ...
    let r;
    try {
      r = await svc.createJournalEntry({});
    } catch (e) {
      r = e;
    }
    expect(r).toBeDefined();
  ...
  test('updateJournalEntry is callable', async () => {
    ...
    let r;
    try {
      r = await svc.updateJournalEntry({});
    } catch (e) {
      r = e;
    }
    expect(r).toBeDefined();
  ...
  test('deleteJournalEntry is callable', async () => {
    ...
    let r;
    try {
      r = await svc.deleteJournalEntry({});
    } catch (e) {
      r = e;
    }
    expect(r).toBeDefined();
  ...
  test('listBankReconciliations is callable', async () => {
    ...
    let r;
    try {
      r = await svc.listBankReconciliations({});
    } catch (e) {
      r = e;
    }
    expect(r).toBeDefined();
  ...
  test('getBankReconciliation is callable', async () => {
    ...
    let r;
    try {
      r = await svc.getBankReconciliation({});
    } catch (e) {
      r = e;
    }
    expect(r).toBeDefined();
  ...
  test('createBankReconciliation is callable', async () => {
    ...
    let r;
    try {
      r = await svc.createBankReconciliation({});
    } catch (e) {
      r = e;
    }
    expect(r).toBeDefined();
  ...
  test('updateBankReconciliation is callable', async () => {
    ...
    let r;
    try {
      r = await svc.updateBankReconciliation({});
    } catch (e) {
      r = e;
    }
    expect(r).toBeDefined();
  ...
  test('getFinancialSummary is callable', async () => {
    ...
    let r;
    try {
      r = await svc.getFinancialSummary({});
    } catch (e) {
      r = e;
    }
    expect(r).toBeDefined();
