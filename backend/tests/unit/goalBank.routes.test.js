/**
 * Auto-generated unit tests for routes/goalBank.routes.js
...
let routeModule;
try { routeModule = require('../../routes/goalBank.routes'); } catch(e) { /* load fail */ }

describe('routes/goalBank.routes', () => {
