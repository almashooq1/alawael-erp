/**
 * Auto-generated unit tests for routes/goalProgress.routes.js
...
let routeModule;
try { routeModule = require('../../routes/goalProgress.routes'); } catch(e) { /* load fail */ }

describe('routes/goalProgress.routes', () => {
