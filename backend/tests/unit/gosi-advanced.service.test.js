...
let svc;
try {
  svc = require('../../services/gosi-advanced.service');
} catch {
  svc = null;
}
...
describe('gosi-advanced.service service', () => {
  ...
  test('calculateGOSIContributions is callable', async () => {
    ...
    let r;
    try {
      r = await svc.calculateGOSIContributions({});
    } catch (e) {
      r = e;
    }
    expect(r).toBeDefined();
  ...
  test('getSubscriptionStatus is callable', async () => {
    ...
    let r;
    try {
      r = await svc.getSubscriptionStatus({});
    } catch (e) {
      r = e;
    }
    expect(r).toBeDefined();
  ...
  test('generateCertificate is callable', async () => {
    ...
    let r;
    try {
      r = await svc.generateCertificate({});
    } catch (e) {
      r = e;
    }
    expect(r).toBeDefined();
  ...
  test('predictComplianceIssues is callable', async () => {
    ...
    let r;
    try {
      r = await svc.predictComplianceIssues({});
    } catch (e) {
      r = e;
    }
    expect(r).toBeDefined();
  ...
  test('getComplianceReport is callable', async () => {
    ...
    let r;
    try {
      r = await svc.getComplianceReport({});
    } catch (e) {
      r = e;
    }
    expect(r).toBeDefined();
