/**
 * Auto-generated unit tests for routes/gradebook.routes.js
...
let routeModule;
try { routeModule = require('../../routes/gradebook.routes'); } catch(e) { /* load fail */ }

describe('routes/gradebook.routes', () => {
