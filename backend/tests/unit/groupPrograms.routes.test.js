/**
 * Auto-generated unit tests for routes/groupPrograms.routes.js
...
let routeModule;
try { routeModule = require('../../routes/groupPrograms.routes'); } catch(e) { /* load fail */ }

describe('routes/groupPrograms.routes', () => {
