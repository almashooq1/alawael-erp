/**
 * Auto-generated unit tests for routes/guardians.routes.js
...
let routeModule;
try { routeModule = require('../../routes/guardians.routes'); } catch(e) { /* load fail */ }

describe('routes/guardians.routes', () => {
