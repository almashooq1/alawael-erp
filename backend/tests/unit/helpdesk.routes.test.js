/**
 * Auto-generated unit tests for routes/helpdesk.routes.js
...
let routeModule;
try { routeModule = require('../../routes/helpdesk.routes'); } catch(e) { /* load fail */ }

describe('routes/helpdesk.routes', () => {
