/**
 * Auto-generated unit tests for routes/hr-insurance.routes.js
...
jest.mock('../../models/EmployeeInsurance', () => {
...
let routeModule;
try { routeModule = require('../../routes/hr-insurance.routes'); } catch(e) { /* load fail */ }

describe('routes/hr-insurance.routes', () => {
