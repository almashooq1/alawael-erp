/**
 * Auto-generated unit tests for routes/hrSystem.routes.js
...
let routeModule;
try { routeModule = require('../../routes/hrSystem.routes'); } catch(_e) { /* load fail */ }

describe('routes/hrSystem.routes', () => {
