/**
 * Auto-generated unit tests for routes/hse.routes.js
...
let routeModule;
try { routeModule = require('../../routes/hse.routes'); } catch(e) { /* load fail */ }

describe('routes/hse.routes', () => {
