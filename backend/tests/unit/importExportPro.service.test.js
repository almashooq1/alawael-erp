...
jest.mock('../../models/ImportExportJob', () => ({
  ImportExportJob: Object.assign(
    jest.fn().mockImplementation(() => ({ save: jest.fn().mockResolvedValue({ _id: 'id1' }) })),
    mockImportExportJobChain
  ),
  ImportExportTemplate: Object.assign(
    jest.fn().mockImplementation(() => ({ save: jest.fn().mockResolvedValue({ _id: 'id1' }) })),
    mockImportExportJobChain
  ),
}));
...
describe('importExportPro.service service', () => {
  ...
  test('generateImportTemplate is callable', async () => {
    ...
    let r;
    try {
      r = await svc.generateImportTemplate({});
    } catch (e) {
      r = e;
    }
    expect(r).toBeDefined();
  ...
  test('getAvailableModules is callable', async () => {
    ...
    let r;
    try {
      r = await svc.getAvailableModules({});
    } catch (e) {
      r = e;
    }
    expect(r).toBeDefined();
  ...
  test('createScheduledExport is callable', async () => {
    ...
    let r;
    try {
      r = await svc.createScheduledExport({});
    } catch (e) {
      r = e;
    }
    expect(r).toBeDefined();
  ...
  test('listScheduledExports is callable', async () => {
    ...
    let r;
    try {
      r = await svc.listScheduledExports({});
    } catch (e) {
      r = e;
    }
    expect(r).toBeDefined();
  ...
  test('executeScheduledExports is callable', async () => {
    ...
    let r;
    try {
      r = await svc.executeScheduledExports({});
    } catch (e) {
      r = e;
    }
    expect(r).toBeDefined();
  ...
  test('toggleScheduledExport is callable', async () => {
    ...
    let r;
    try {
      r = await svc.toggleScheduledExport({});
    } catch (e) {
      r = e;
    }
    expect(r).toBeDefined();
