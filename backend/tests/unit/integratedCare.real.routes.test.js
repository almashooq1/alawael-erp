/**
 * Auto-generated unit tests for routes/integratedCare.real.routes.js
...
let routeModule;
try { routeModule = require('../../routes/integratedCare.real.routes'); } catch(e) { /* load fail */ }

describe('routes/integratedCare.real.routes', () => {
