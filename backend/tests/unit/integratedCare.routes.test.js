/**
 * Auto-generated unit tests for routes/integratedCare.routes.js
...
let routeModule;
try { routeModule = require('../../routes/integratedCare.routes'); } catch(_e) { /* load fail */ }

describe('routes/integratedCare.routes', () => {
