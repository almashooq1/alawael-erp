/**
 * Auto-generated unit tests for models/internalAudit.js
...
mockModelFn.modelName = 'AnnualAuditPlan';
...
let Model;
try { Model = require('../../models/internalAudit'); } catch(e) { /* load fail */ }

describe('models/internalAudit', () => {
