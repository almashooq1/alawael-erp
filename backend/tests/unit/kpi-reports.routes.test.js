/**
 * Auto-generated unit tests for routes/kpi-reports.routes.js
...
let routeModule;
try { routeModule = require('../../routes/kpi-reports.routes'); } catch(e) { /* load fail */ }

describe('routes/kpi-reports.routes', () => {
