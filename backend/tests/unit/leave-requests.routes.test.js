/**
 * Auto-generated unit tests for routes/leave-requests.routes.js
...
jest.mock('../../services/leaveManagement.service', () => new Proxy({}, { get: () => jest.fn().mockResolvedValue({}) }));
...
let routeModule;
try { routeModule = require('../../routes/leave-requests.routes'); } catch(e) { /* load fail */ }

describe('routes/leave-requests.routes', () => {
