/**
 * Auto-generated unit tests for routes/maintenanceIssues.routes.js
...
let routeModule;
try { routeModule = require('../../routes/maintenanceIssues.routes'); } catch(e) { /* load fail */ }

describe('routes/maintenanceIssues.routes', () => {
