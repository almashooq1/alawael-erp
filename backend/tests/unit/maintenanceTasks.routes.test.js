/**
 * Auto-generated unit tests for routes/maintenanceTasks.routes.js
...
let routeModule;
try { routeModule = require('../../routes/maintenanceTasks.routes'); } catch(e) { /* load fail */ }

describe('routes/maintenanceTasks.routes', () => {
