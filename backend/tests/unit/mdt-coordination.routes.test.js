/**
 * Auto-generated unit tests for routes/mdt-coordination.routes.js
...
let routeModule;
try { routeModule = require('../../routes/mdt-coordination.routes'); } catch(e) { /* load fail */ }

describe('routes/mdt-coordination.routes', () => {
