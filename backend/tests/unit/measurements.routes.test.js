/**
 * Auto-generated unit tests for routes/measurements.routes.js
...
jest.mock('../../utils/paginate', () => new Proxy({}, { get: (t, p) => p === '__esModule' ? false : jest.fn() }));
...
jest.mock('../../services/MeasurementService', () => new Proxy({}, { get: () => jest.fn().mockResolvedValue({}) }));
jest.mock('../../services/SmartMeasurementProgramEngine', () => new Proxy({}, { get: () => jest.fn().mockResolvedValue({}) }));
...
let routeModule;
try { routeModule = require('../../routes/measurements.routes'); } catch(e) { /* load fail */ }

describe('routes/measurements.routes', () => {
