/**
 * Auto-generated unit tests for routes/meetings.routes.js
...
let routeModule;
try { routeModule = require('../../routes/meetings.routes'); } catch(e) { /* load fail */ }

describe('routes/meetings.routes', () => {
