/**
 * Auto-generated unit tests for routes/ml.routes.js
...
jest.mock('../../services/MLService', () => new Proxy({}, { get: () => jest.fn().mockResolvedValue({}) }));
...
let routeModule;
try { routeModule = require('../../routes/ml.routes'); } catch(e) { /* load fail */ }

describe('routes/ml.routes', () => {
