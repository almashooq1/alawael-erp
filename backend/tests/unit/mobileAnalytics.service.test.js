...
describe('mobileAnalytics.service service', () => {
  ...
  test('getPerformanceReport is callable', async () => {
    ...
    let r;
    try {
      r = await svc.getPerformanceReport({});
    } catch (e) {
      r = e;
    }
    expect(r).toBeDefined();
