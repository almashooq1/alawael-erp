/**
 * Auto-generated unit tests for routes/monitoring.real.routes.js
...
let routeModule;
try { routeModule = require('../../routes/monitoring.real.routes'); } catch(e) { /* load fail */ }

describe('routes/monitoring.real.routes', () => {
