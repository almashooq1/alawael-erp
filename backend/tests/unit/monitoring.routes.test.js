/**
 * Auto-generated unit tests for routes/monitoring.routes.js
...
let routeModule;
try { routeModule = require('../../routes/monitoring.routes'); } catch(_e) { /* load fail */ }

describe('routes/monitoring.routes', () => {
