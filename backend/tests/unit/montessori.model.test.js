/**
 * Auto-generated unit tests for models/montessori.js
...
let Model;
try { Model = require('../../models/montessori'); } catch(e) { /* load fail */ }

describe('models/montessori', () => {
