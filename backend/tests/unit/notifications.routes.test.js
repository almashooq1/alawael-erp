/**
 * Auto-generated unit tests for routes/notifications.routes.js
...
jest.mock('../../services/notifications.service', () => new Proxy({}, { get: () => jest.fn().mockResolvedValue({}) }));
...
let routeModule;
try { routeModule = require('../../routes/notifications.routes'); } catch(e) { /* load fail */ }
