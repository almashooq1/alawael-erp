/**
 * Auto-generated unit tests for routes/organization.real.routes.js
...
let routeModule;
try { routeModule = require('../../routes/organization.real.routes'); } catch(e) { /* load fail */ }

describe('routes/organization.real.routes', () => {
