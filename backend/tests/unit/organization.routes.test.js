/**
 * Auto-generated unit tests for routes/organization.routes.js
...
let routeModule;
try { routeModule = require('../../routes/organization.routes'); } catch(_e) { /* load fail */ }

describe('routes/organization.routes', () => {
