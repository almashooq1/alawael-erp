/**
 * Auto-generated unit tests for routes/parentPortal.routes.js
...
let routeModule;
try { routeModule = require('../../routes/parentPortal.routes'); } catch(e) { /* load fail */ }

describe('routes/parentPortal.routes', () => {
