/**
 * Auto-generated unit tests for routes/payment-gateway.routes.js
...
jest.mock('../../services/paymentGateway.service', () => new Proxy({}, { get: () => jest.fn().mockResolvedValue({}) }));
...
let routeModule;
try { routeModule = require('../../routes/payment-gateway.routes'); } catch(e) { /* load fail */ }

describe('routes/payment-gateway.routes', () => {
