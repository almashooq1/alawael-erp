/**
 * Auto-generated unit tests for models/payment.model.js (compatibility proxy)
...
let Model;
try { Model = require('../../models/payment.model'); } catch(e) { /* load fail */ }

describe('models/payment.model (proxy)', () => {
