/**
 * Auto-generated unit tests for routes/payments.real.routes.js
...
let routeModule;
try { routeModule = require('../../routes/payments.real.routes'); } catch(e) { /* load fail */ }

describe('routes/payments.real.routes', () => {
