/**
 * Auto-generated unit tests for routes/payments.routes.js
...
let routeModule;
try { routeModule = require('../../routes/payments.routes'); } catch(_e) { /* load fail */ }

describe('routes/payments.routes', () => {
