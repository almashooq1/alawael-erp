/**
 * Auto-generated unit tests for routes/portalNotifications.routes.js
...
let routeModule;
try { routeModule = require('../../routes/portalNotifications.routes'); } catch(e) { /* load fail */ }

describe('routes/portalNotifications.routes', () => {
