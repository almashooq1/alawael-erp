...
jest.mock('../../models/PostRehabFollowUp', () => ({
  PostRehabCase: Object.assign(
    jest.fn().mockImplementation(() => ({ save: jest.fn().mockResolvedValue({ _id: 'id1' }) })),
    mockPostRehabFollowUpChain
  ),
  FollowUpVisit: Object.assign(
    jest.fn().mockImplementation(() => ({ save: jest.fn().mockResolvedValue({ _id: 'id1' }) })),
    mockPostRehabFollowUpChain
  ),
  ImpactMeasurement: Object.assign(
    jest.fn().mockImplementation(() => ({ save: jest.fn().mockResolvedValue({ _id: 'id1' }) })),
    mockPostRehabFollowUpChain
  ),
  PostRehabSurvey: Object.assign(
    jest.fn().mockImplementation(() => ({ save: jest.fn().mockResolvedValue({ _id: 'id1' }) })),
    mockPostRehabFollowUpChain
  ),
  ReEnrollmentRequest: Object.assign(
    jest.fn().mockImplementation(() => ({ save: jest.fn().mockResolvedValue({ _id: 'id1' }) })),
    mockPostRehabFollowUpChain
  ),
}));
...
describe('postRehabFollowUp.service service', () => {
  ...
  test('createImpactMeasurement is callable', async () => {
    ...
    let r;
    try {
      r = await svc.createImpactMeasurement({});
    } catch (e) {
      r = e;
    }
    expect(r).toBeDefined();
  ...
  test('getImpactMeasurementById is callable', async () => {
    ...
    let r;
    try {
      r = await svc.getImpactMeasurementById({});
    } catch (e) {
      r = e;
    }
    expect(r).toBeDefined();
  ...
  test('listImpactMeasurements is callable', async () => {
    ...
    let r;
    try {
      r = await svc.listImpactMeasurements({});
    } catch (e) {
      r = e;
    }
    expect(r).toBeDefined();
  ...
  test('getImpactComparisonReport is callable', async () => {
    ...
    let r;
    try {
      r = await svc.getImpactComparisonReport({});
    } catch (e) {
      r = e;
    }
    expect(r).toBeDefined();
  ...
  test('submitSurveyResponses is callable', async () => {
    ...
    let r;
    try {
      r = await svc.submitSurveyResponses({});
    } catch (e) {
      r = e;
    }
    expect(r).toBeDefined();
  ...
  test('getSurveyTemplates is callable', async () => {
    ...
    let r;
    try {
      r = await svc.getSurveyTemplates({});
    } catch (e) {
      r = e;
    }
    expect(r).toBeDefined();
  ...
  test('createReEnrollmentRequest is callable', async () => {
    ...
    let r;
    try {
      r = await svc.createReEnrollmentRequest({});
    } catch (e) {
      r = e;
    }
    expect(r).toBeDefined();
  ...
  test('reviewReEnrollmentRequest is callable', async () => {
    ...
    let r;
    try {
      r = await svc.reviewReEnrollmentRequest({});
    } catch (e) {
      r = e;
    }
    expect(r).toBeDefined();
  ...
  test('getReEnrollmentRequestById is callable', async () => {
    ...
    let r;
    try {
      r = await svc.getReEnrollmentRequestById({});
    } catch (e) {
      r = e;
    }
    expect(r).toBeDefined();
  ...
  test('listReEnrollmentRequests is callable', async () => {
    ...
    let r;
    try {
      r = await svc.listReEnrollmentRequests({});
    } catch (e) {
      r = e;
    }
    expect(r).toBeDefined();
