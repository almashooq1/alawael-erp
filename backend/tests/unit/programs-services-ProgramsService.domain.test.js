/**
 * Auto-generated tests for domains/programs/services/ProgramsService.js
 * Validates syntax, structure, and patterns (model — 452L)
...
const SRC = path.resolve(__dirname, '../../domains/programs/services/ProgramsService.js');

describe('domains/programs/services/ProgramsService.js', () => {
  let source;
  beforeAll(() => {
  ...
  test('is syntactically valid JavaScript', () => {
    expect(() => new vm.Script(source, { filename: 'ProgramsService.js' })).not.toThrow();
  });
