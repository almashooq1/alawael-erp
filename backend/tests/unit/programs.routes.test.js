/**
 * Auto-generated unit tests for routes/programs.routes.js
...
let routeModule;
try { routeModule = require('../../routes/programs.routes'); } catch(e) { /* load fail */ }

describe('routes/programs.routes', () => {
