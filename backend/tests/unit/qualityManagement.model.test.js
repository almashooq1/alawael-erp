/**
 * Auto-generated unit tests for models/qualityManagement.js
...
mockModelFn.modelName = 'Standard';
...
let Model;
try { Model = require('../../models/qualityManagement'); } catch(e) { /* load fail */ }

describe('models/qualityManagement', () => {
