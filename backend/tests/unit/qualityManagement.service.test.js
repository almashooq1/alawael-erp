...
describe('qualityManagement.service service', () => {
  ...
  test('getFindingSeverities is callable', async () => {
    ...
    let r;
    try {
      r = await svc.getFindingSeverities({});
    } catch (e) {
      r = e;
    }
    expect(r).toBeDefined();
  ...
  test('listNonConformances is callable', async () => {
    ...
    let r;
    try {
      r = await svc.listNonConformances({});
    } catch (e) {
      r = e;
    }
    expect(r).toBeDefined();
  ...
  test('createNonConformance is callable', async () => {
    ...
    let r;
    try {
      r = await svc.createNonConformance({});
    } catch (e) {
      r = e;
    }
    expect(r).toBeDefined();
  ...
  test('updateNonConformance is callable', async () => {
    ...
    let r;
    try {
      r = await svc.updateNonConformance({});
    } catch (e) {
      r = e;
    }
    expect(r).toBeDefined();
  ...
  test('deleteNonConformance is callable', async () => {
    ...
    let r;
    try {
      r = await svc.deleteNonConformance({});
    } catch (e) {
      r = e;
    }
    expect(r).toBeDefined();
  ...
  test('getIndicatorRecords is callable', async () => {
    ...
    let r;
    try {
      r = await svc.getIndicatorRecords({});
    } catch (e) {
      r = e;
    }
    expect(r).toBeDefined();
  ...
  test('addIndicatorRecord is callable', async () => {
    ...
    let r;
    try {
      r = await svc.addIndicatorRecord({});
    } catch (e) {
      r = e;
    }
    expect(r).toBeDefined();
