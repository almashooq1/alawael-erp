/**
 * Auto-generated unit tests for routes/riskAssessment.routes.js
...
let routeModule;
try { routeModule = require('../../routes/riskAssessment.routes'); } catch(e) { /* load fail */ }

describe('routes/riskAssessment.routes', () => {
