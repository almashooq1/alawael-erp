/**
 * Auto-generated unit tests for routes/scheduling-module.routes.js
...
jest.mock('../../models/scheduling/Appointment', () => {
...
jest.mock('../../models/scheduling/TherapistAvailability', () => {
  const M = jest.fn(() => ({ save: jest.fn().mockResolvedValue({}) }));
  M.find = jest.fn().mockReturnValue({ sort: jest.fn().mockReturnThis(), limit: jest.fn().mockReturnThis(), lean: jest.fn().mockResolvedValue([]) });
  M.findOne = jest.fn().mockResolvedValue(null);
  M.findById = jest.fn().mockResolvedValue(null);
...
jest.mock('../../models/scheduling/AppointmentRecurrence', () => {
  const M = jest.fn(() => ({ save: jest.fn().mockResolvedValue({}) }));
  M.find = jest.fn().mockReturnValue({ sort: jest.fn().mockReturnThis(), limit: jest.fn().mockReturnThis(), lean: jest.fn().mockResolvedValue([]) });
  M.findOne = jest.fn().mockResolvedValue(null);
  M.findById = jest.fn().mockResolvedValue(null);
...
jest.mock('../../models/scheduling/RoomBooking', () => {
  const M = jest.fn(() => ({ save: jest.fn().mockResolvedValue({}) }));
  M.find = jest.fn().mockReturnValue({ sort: jest.fn().mockReturnThis(), limit: jest.fn().mockReturnThis(), lean: jest.fn().mockResolvedValue([]) });
  M.findOne = jest.fn().mockResolvedValue(null);
  M.findById = jest.fn().mockResolvedValue(null);
...
jest.mock('../../models/scheduling/WaitlistEntry', () => {
  const M = jest.fn(() => ({ save: jest.fn().mockResolvedValue({}) }));
  M.find = jest.fn().mockReturnValue({ sort: jest.fn().mockReturnThis(), limit: jest.fn().mockReturnThis(), lean: jest.fn().mockResolvedValue([]) });
  M.findOne = jest.fn().mockResolvedValue(null);
  M.findById = jest.fn().mockResolvedValue(null);
...
jest.mock('../../services/scheduling/SchedulingService', () => new Proxy({}, { get: () => jest.fn().mockResolvedValue({}) }));
jest.mock('../../utils/escapeRegex', () => new Proxy({}, { get: (t, p) => p === '__esModule' ? false : jest.fn() }));

let routeModule;
try { routeModule = require('../../routes/scheduling-module.routes'); } catch(e) { /* load fail */ }

describe('routes/scheduling-module.routes', () => {
