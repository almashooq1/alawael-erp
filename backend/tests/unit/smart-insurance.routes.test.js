/**
 * Auto-generated unit tests for routes/smart-insurance.routes.js
...
jest.mock('../../services/smartInsurance.service', () => new Proxy({}, { get: () => jest.fn().mockResolvedValue({}) }));
...
let routeModule;
try { routeModule = require('../../routes/smart-insurance.routes'); } catch(e) { /* load fail */ }

describe('routes/smart-insurance.routes', () => {
