/**
 * Auto-generated unit tests for routes/smartIRP.routes.js
...
jest.mock('../../services/smartIRP.service', () => new Proxy({}, { get: () => jest.fn().mockResolvedValue({}) }));
...
let routeModule;
try { routeModule = require('../../routes/smartIRP.routes'); } catch(e) { /* load fail */ }

describe('routes/smartIRP.routes', () => {
