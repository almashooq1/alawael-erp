/**
 * Auto-generated unit tests for models/smartScheduler.js
...
mockModelFn.modelName = 'SmartScheduler';
...
let Model;
try { Model = require('../../models/smartScheduler'); } catch(e) { /* load fail */ }

describe('models/smartScheduler', () => {
