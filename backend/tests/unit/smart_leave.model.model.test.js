/**
 * Auto-generated unit tests for models/smart_leave.model.js
...
mockModelFn.modelName = 'SmartLeave';
...
let Model;
try { Model = require('../../models/smart_leave.model'); } catch(e) { /* load fail */ }

describe('models/smart_leave.model', () => {
  ...
  test('static "createLeaveRequest" attached to schema', () => {
    if (!Model) return;
    // Check if static was assigned during module load
    const fn = mockSchema.statics['createLeaveRequest'];
