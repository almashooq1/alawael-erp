/**
 * Auto-generated unit tests for routes/sso.routes.js
...
jest.mock('../../services/sso.service', () => new Proxy({}, { get: () => jest.fn().mockResolvedValue({}) }));
jest.mock('../../services/oauth.service', () => new Proxy({}, { get: () => jest.fn().mockResolvedValue({}) }));
jest.mock('../../middleware/sso-auth.middleware', () => {
...
let routeModule;
try { routeModule = require('../../routes/sso.routes'); } catch(e) { /* load fail */ }

describe('routes/sso.routes', () => {
