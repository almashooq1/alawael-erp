/**
 * Auto-generated unit tests for routes/strategicPlanning.routes.js
...
let routeModule;
try { routeModule = require('../../routes/strategicPlanning.routes'); } catch(e) { /* load fail */ }

describe('routes/strategicPlanning.routes', () => {
