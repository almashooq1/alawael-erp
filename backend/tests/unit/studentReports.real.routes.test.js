/**
 * Auto-generated unit tests for routes/studentReports.real.routes.js
...
let routeModule;
try { routeModule = require('../../routes/studentReports.real.routes'); } catch(e) { /* load fail */ }

describe('routes/studentReports.real.routes', () => {
