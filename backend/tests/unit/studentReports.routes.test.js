/**
 * Auto-generated unit tests for routes/studentReports.routes.js
...
let routeModule;
try { routeModule = require('../../routes/studentReports.routes'); } catch(_e) { /* load fail */ }

describe('routes/studentReports.routes', () => {
