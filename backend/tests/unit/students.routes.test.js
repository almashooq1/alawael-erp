/**
 * Auto-generated unit tests for routes/students.routes.js
...
let routeModule;
try { routeModule = require('../../routes/students.routes'); } catch(_e) { /* load fail */ }

describe('routes/students.routes', () => {
