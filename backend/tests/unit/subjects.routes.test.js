/**
 * Auto-generated unit tests for routes/subjects.routes.js
...
let routeModule;
try { routeModule = require('../../routes/subjects.routes'); } catch(e) { /* load fail */ }

describe('routes/subjects.routes', () => {
