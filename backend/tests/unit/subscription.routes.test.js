/**
 * Auto-generated unit tests for routes/subscription.routes.js
...
let routeModule;
try { routeModule = require('../../routes/subscription.routes'); } catch(e) { /* load fail */ }

describe('routes/subscription.routes', () => {
