/**
 * Auto-generated unit tests for routes/successionPlanning.js
...
let routeModule;
try { routeModule = require('../../routes/successionPlanning'); } catch(e) { /* load fail */ }

describe('routes/successionPlanning', () => {
