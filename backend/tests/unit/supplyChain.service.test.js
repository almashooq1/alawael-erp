...
describe('supplyChain.service service', () => {
  ...
  test('getInventoryStatus is callable', async () => {
    ...
    let r;
    try {
      r = await svc.getInventoryStatus({});
    } catch (e) {
      r = e;
    }
    expect(r).toBeDefined();
  ...
  test('createPurchaseOrder is callable', async () => {
    ...
    let r;
    try {
      r = await svc.createPurchaseOrder({});
    } catch (e) {
      r = e;
    }
    expect(r).toBeDefined();
  ...
  test('listPurchaseOrders is callable', async () => {
    ...
    let r;
    try {
      r = await svc.listPurchaseOrders({});
    } catch (e) {
      r = e;
    }
    expect(r).toBeDefined();
  ...
  test('updateShipmentStatus is callable', async () => {
    ...
    let r;
    try {
      r = await svc.updateShipmentStatus({});
    } catch (e) {
      r = e;
    }
    expect(r).toBeDefined();
  ...
  test('deletePurchaseOrder is callable', async () => {
    ...
    let r;
    try {
      r = await svc.deletePurchaseOrder({});
    } catch (e) {
      r = e;
    }
    expect(r).toBeDefined();
  ...
  test('getSupplyChainAnalytics is callable', async () => {
    ...
    let r;
    try {
      r = await svc.getSupplyChainAnalytics({});
    } catch (e) {
      r = e;
    }
    expect(r).toBeDefined();
