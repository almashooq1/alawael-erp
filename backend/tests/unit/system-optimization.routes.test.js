/**
 * Auto-generated unit tests for routes/system-optimization.routes.js
...
let routeModule;
try { routeModule = require('../../routes/system-optimization.routes'); } catch(e) { /* load fail */ }

describe('routes/system-optimization.routes', () => {
