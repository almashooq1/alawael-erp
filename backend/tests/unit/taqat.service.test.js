...
jest.mock('../../models/taqat.models', () => ({
  TaqatJobSeeker: Object.assign(
    jest.fn().mockImplementation(() => ({ save: jest.fn().mockResolvedValue({ _id: 'id1' }) })),
    mocktaqat_modelsChain
  ),
  TaqatJobOpportunity: Object.assign(
    jest.fn().mockImplementation(() => ({ save: jest.fn().mockResolvedValue({ _id: 'id1' }) })),
    mocktaqat_modelsChain
  ),
  TaqatJobApplication: Object.assign(
    jest.fn().mockImplementation(() => ({ save: jest.fn().mockResolvedValue({ _id: 'id1' }) })),
    mocktaqat_modelsChain
  ),
  TaqatTrainingProgram: Object.assign(
    jest.fn().mockImplementation(() => ({ save: jest.fn().mockResolvedValue({ _id: 'id1' }) })),
    mocktaqat_modelsChain
  ),
  TaqatEmploymentStats: Object.assign(
    jest.fn().mockImplementation(() => ({ save: jest.fn().mockResolvedValue({ _id: 'id1' }) })),
    mocktaqat_modelsChain
  ),
}));
...
describe('taqat.service service', () => {
  ...
  test('assessEmploymentReadiness is callable', async () => {
    ...
    let r;
    try {
      r = await svc.assessEmploymentReadiness({});
    } catch (e) {
      r = e;
    }
    expect(r).toBeDefined();
  ...
  test('createJobOpportunity is callable', async () => {
    ...
    let r;
    try {
      r = await svc.createJobOpportunity({});
    } catch (e) {
      r = e;
    }
    expect(r).toBeDefined();
  ...
  test('updateJobOpportunity is callable', async () => {
    ...
    let r;
    try {
      r = await svc.updateJobOpportunity({});
    } catch (e) {
      r = e;
    }
    expect(r).toBeDefined();
  ...
  test('getJobOpportunities is callable', async () => {
    ...
    let r;
    try {
      r = await svc.getJobOpportunities({});
    } catch (e) {
      r = e;
    }
    expect(r).toBeDefined();
  ...
  test('updateApplicationStatus is callable', async () => {
    ...
    let r;
    try {
      r = await svc.updateApplicationStatus({});
    } catch (e) {
      r = e;
    }
    expect(r).toBeDefined();
  ...
  test('createTrainingProgram is callable', async () => {
    ...
    let r;
    try {
      r = await svc.createTrainingProgram({});
    } catch (e) {
      r = e;
    }
    expect(r).toBeDefined();
  ...
  test('getTrainingPrograms is callable', async () => {
    ...
    let r;
    try {
      r = await svc.getTrainingPrograms({});
    } catch (e) {
      r = e;
    }
    expect(r).toBeDefined();
  ...
  test('generateEmploymentStats is callable', async () => {
    ...
    let r;
    try {
      r = await svc.generateEmploymentStats({});
    } catch (e) {
      r = e;
    }
    expect(r).toBeDefined();
