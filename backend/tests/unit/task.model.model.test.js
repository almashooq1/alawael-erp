/**
 * Auto-generated unit tests for models/task.model.js
...
let Model;
try { Model = require('../../models/task.model'); } catch(e) { /* load fail */ }

describe('models/task.model', () => {
