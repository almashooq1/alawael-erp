/**
 * Auto-generated unit tests for routes/teachers.routes.js
...
let routeModule;
try { routeModule = require('../../routes/teachers.routes'); } catch(e) { /* load fail */ }

describe('routes/teachers.routes', () => {
