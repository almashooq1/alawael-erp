/**
 * Auto-generated unit tests for routes/telehealth.routes.js
...
jest.mock('../../services/telehealthService', () => new Proxy({}, { get: () => jest.fn().mockResolvedValue({}) }));
...
let routeModule;
try { routeModule = require('../../routes/telehealth.routes'); } catch(e) { /* load fail */ }

describe('routes/telehealth.routes', () => {
