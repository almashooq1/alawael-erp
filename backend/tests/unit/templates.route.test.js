/**
 * Auto-generated unit tests for routes/templates.js
...
jest.mock('twilio', () => new Proxy({}, { get: (t, p) => p === '__esModule' ? false : jest.fn() }));
...
jest.mock('../../utils/emailService', () => new Proxy({}, { get: (t, p) => p === '__esModule' ? false : jest.fn() }));
jest.mock('../../services/smsService', () => new Proxy({}, { get: () => jest.fn().mockResolvedValue({}) }));
jest.mock('../../models/Notification', () => {
  const M = jest.fn(() => ({ save: jest.fn().mockResolvedValue({}) }));
  M.find = jest.fn().mockReturnValue({ sort: jest.fn().mockReturnThis(), limit: jest.fn().mockReturnThis(), lean: jest.fn().mockResolvedValue([]) });
  M.findOne = jest.fn().mockResolvedValue(null);
...
let routeModule;
try { routeModule = require('../../routes/templates'); } catch(e) { /* load fail */ }
