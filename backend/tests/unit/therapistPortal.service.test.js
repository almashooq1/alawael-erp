...
describe('therapistPortal.service service', () => {
  ...
  test('addScheduleSession is callable', async () => {
    ...
    let r;
    try {
      r = await svc.addScheduleSession({});
    } catch (e) {
      r = e;
    }
    expect(r).toBeDefined();
  ...
  test('updateScheduleSession is callable', async () => {
    ...
    let r;
    try {
      r = await svc.updateScheduleSession({});
    } catch (e) {
      r = e;
    }
    expect(r).toBeDefined();
  ...
  test('deleteScheduleSession is callable', async () => {
    ...
    let r;
    try {
      r = await svc.deleteScheduleSession({});
    } catch (e) {
      r = e;
    }
    expect(r).toBeDefined();
  ...
  test('updateAvailability is callable', async () => {
    ...
    let r;
    try {
      r = await svc.updateAvailability({});
    } catch (e) {
      r = e;
    }
    expect(r).toBeDefined();
  ...
  test('getSessionDocumentation is callable', async () => {
    ...
    let r;
    try {
      r = await svc.getSessionDocumentation({});
    } catch (e) {
      r = e;
    }
    expect(r).toBeDefined();
  ...
  test('createSessionDocumentation is callable', async () => {
    ...
    let r;
    try {
      r = await svc.createSessionDocumentation({});
    } catch (e) {
      r = e;
    }
    expect(r).toBeDefined();
  ...
  test('getTherapeuticPlans is callable', async () => {
    ...
    let r;
    try {
      r = await svc.getTherapeuticPlans({});
    } catch (e) {
      r = e;
    }
    expect(r).toBeDefined();
  ...
  test('updateGoalProgress is callable', async () => {
    ...
    let r;
    try {
      r = await svc.updateGoalProgress({});
    } catch (e) {
      r = e;
    }
    expect(r).toBeDefined();
  ...
  test('getPerformanceKPIs is callable', async () => {
    ...
    let r;
    try {
      r = await svc.getPerformanceKPIs({});
    } catch (e) {
      r = e;
    }
    expect(r).toBeDefined();
  ...
  test('getPatientProgress is callable', async () => {
    ...
    let r;
    try {
      r = await svc.getPatientProgress({});
    } catch (e) {
      r = e;
    }
    expect(r).toBeDefined();
  ...
  test('getWorkloadAnalytics is callable', async () => {
    ...
    let r;
    try {
      r = await svc.getWorkloadAnalytics({});
    } catch (e) {
      r = e;
    }
    expect(r).toBeDefined();
