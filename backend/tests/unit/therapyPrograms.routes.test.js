/**
 * Auto-generated unit tests for routes/therapyPrograms.routes.js
...
let routeModule;
try { routeModule = require('../../routes/therapyPrograms.routes'); } catch(e) { /* load fail */ }

describe('routes/therapyPrograms.routes', () => {
