/**
 * Auto-generated unit tests for routes/therapyRooms.routes.js
...
let routeModule;
try { routeModule = require('../../routes/therapyRooms.routes'); } catch(e) { /* load fail */ }

describe('routes/therapyRooms.routes', () => {
