/**
 * Auto-generated unit tests for routes/timetable.routes.js
...
let routeModule;
try { routeModule = require('../../routes/timetable.routes'); } catch(e) { /* load fail */ }

describe('routes/timetable.routes', () => {
