/**
 * Auto-generated unit tests for routes/training.routes.js
...
let routeModule;
try { routeModule = require('../../routes/training.routes'); } catch(e) { /* load fail */ }

describe('routes/training.routes', () => {
