/**
 * Auto-generated unit tests for models/transport.models.js
...
let Model;
try { Model = require('../../models/transport.models'); } catch(e) { /* load fail */ }

describe('models/transport.models', () => {
