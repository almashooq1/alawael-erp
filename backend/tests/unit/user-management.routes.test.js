/**
 * Auto-generated unit tests for routes/user-management.routes.js
...
let routeModule;
try { routeModule = require('../../routes/user-management.routes'); } catch(e) { /* load fail */ }

describe('routes/user-management.routes', () => {
