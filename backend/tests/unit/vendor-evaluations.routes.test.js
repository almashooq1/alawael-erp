/**
 * Auto-generated unit tests for routes/vendor-evaluations.routes.js
...
let routeModule;
try { routeModule = require('../../routes/vendor-evaluations.routes'); } catch(_e) { /* load fail */ }

describe('routes/vendor-evaluations.routes', () => {
