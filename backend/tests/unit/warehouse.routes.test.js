/**
 * Auto-generated unit tests for routes/warehouse.routes.js
...
let routeModule;
try { routeModule = require('../../routes/warehouse.routes'); } catch(e) { /* load fail */ }

describe('routes/warehouse.routes', () => {
