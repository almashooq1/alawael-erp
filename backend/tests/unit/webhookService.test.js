...
describe('webhookService service', () => {
  ...
  test('getDeliveryHistory is callable', async () => {
    ...
    let r;
    try {
      r = await svc.getDeliveryHistory({});
    } catch (e) {
      r = e;
    }
    expect(r).toBeDefined();
  ...
  test('getWebhookStatistics is callable', async () => {
    ...
    let r;
    try {
      r = await svc.getWebhookStatistics({});
    } catch (e) {
      r = e;
    }
    expect(r).toBeDefined();
