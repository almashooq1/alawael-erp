...
describe('websocket service', () => {
  ...
  test('initializeWebSocket is callable', async () => {
    ...
    let r;
    try {
      r = await svc.initializeWebSocket({});
    } catch (e) {
      r = e;
    }
  ...
  test('getConnectedUsersCount is callable', async () => {
    ...
    let r;
    try {
      r = await svc.getConnectedUsersCount({});
    } catch (e) {
      r = e;
    }
    expect(r).toBeDefined();
  ...
  test('getConnectedUserIds is callable', async () => {
    ...
    let r;
    try {
      r = await svc.getConnectedUserIds({});
    } catch (e) {
      r = e;
    }
    expect(r).toBeDefined();
  ...
  test('notifyNewNotification is callable', async () => {
    ...
    let r;
    try {
      r = await svc.notifyNewNotification({});
    } catch (e) {
      r = e;
    }
    expect(r).toBeDefined();
  ...
  test('notifySupportTicketUpdate is callable', async () => {
    ...
    let r;
    try {
      r = await svc.notifySupportTicketUpdate({});
    } catch (e) {
      r = e;
    }
    expect(r).toBeDefined();
  ...
  test('notifyPerformanceUpdate is callable', async () => {
    ...
    let r;
    try {
      r = await svc.notifyPerformanceUpdate({});
    } catch (e) {
      r = e;
    }
    expect(r).toBeDefined();
  ...
  test('notifyUserActivity is callable', async () => {
    ...
    let r;
    try {
      r = await svc.notifyUserActivity({});
    } catch (e) {
      r = e;
    }
    expect(r).toBeDefined();
  ...
  test('notifyAnalyticsUpdate is callable', async () => {
    ...
    let r;
    try {
      r = await svc.notifyAnalyticsUpdate({});
    } catch (e) {
      r = e;
    }
    expect(r).toBeDefined();
