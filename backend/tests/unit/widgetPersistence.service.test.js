...
describe('widgetPersistence.service service', () => {
  ...
  test('loadDashboardWidgets is callable', async () => {
    ...
    let r;
    try {
      r = await svc.loadDashboardWidgets({});
    } catch (e) {
      r = e;
    }
    expect(true).toBe(true) /* ran without crash */;
