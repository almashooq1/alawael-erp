/**
 * Auto-generated unit tests for routes/work-shifts.routes.js
...
let routeModule;
try { routeModule = require('../../routes/work-shifts.routes'); } catch(e) { /* load fail */ }

describe('routes/work-shifts.routes', () => {
