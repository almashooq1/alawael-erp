/**
 * Auto-generated unit tests for routes/workflow.routes.js
...
let routeModule;
try { routeModule = require('../../routes/workflow.routes'); } catch(e) { /* load fail */ }

describe('routes/workflow.routes', () => {
