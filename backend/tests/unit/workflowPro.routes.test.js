/**
 * Auto-generated unit tests for routes/workflowPro.routes.js
...
let routeModule;
try { routeModule = require('../../routes/workflowPro.routes'); } catch(e) { /* load fail */ }

describe('routes/workflowPro.routes', () => {
