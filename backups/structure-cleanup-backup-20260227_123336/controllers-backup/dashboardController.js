...
class DashboardController {
  ...
  async listDashboards(req, res, next) {
    try {
      ...
      const dashboards = this.dashboardService.listDashboards(req.user.id, filters);

      const paginated = dashboards.slice(parseInt(offset), parseInt(offset) + parseInt(limit));
