...
class SmartNotificationController {
  ...
  static async sendNotification(req, res) {
    try {
      const { recipientId, title, message, notificationType, priority, channels } = req.body;
      ...
      const notification = await NotificationService.sendQuickNotification(recipientId, {
        title,
        message,
  ...
  static async sendPerformanceReport(req, res) {
    try {
      ...
      const notification = await NotificationService.sendPerformanceReport(driverId, report);
  ...
  static async sendBulkNotification(req, res) {
    try {
      ...
      const result = await NotificationService.sendBulkNotification(filterCriteria, {
        title,
        message,
        notificationType: notificationType || 'custom',
        priority: priority || 'normal',
