...
import CompensationStructureManagement from './components/CompensationStructureManagement';
...
// Lazy-loaded pages (heavy screens)
const AdvancedDashboard = lazyWithRetry(() => import('./components/dashboard/AdvancedDashboard'));
const CommunicationsSystem = lazyWithRetry(() => import('./pages/CommunicationsSystem'));
                    ...
                    <Routes>
                      ...
                      >
                        ...
                        <Route
                          path="crm"
                          element={
                            <ModulePage title="إدارة علاقات العملاء (CRM)" moduleKey="crm" />
                          }
                        />
                        ...
                        <Route
                          ...
                          element={<CompensationStructureManagement />}
                        />
                        ...
                        <Route path="analytics" element={<PayrollAnalyticsDashboard />} />
                        ...
                        <Route
                          path="student-portal/announcements"
                        ...
                        />
                        <Route
                          path="parent-portal/payments-history"
