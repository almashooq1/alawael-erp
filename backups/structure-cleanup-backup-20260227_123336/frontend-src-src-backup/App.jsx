      ...
      >
        <Toolbar>
          ...
          <Tooltip title="الإشعارات">
            <IconButton sx={{ ml: 1 }} onClick={e => setNotificationAnchor(e.currentTarget)}>
          ...
          <IconButton sx={{ ml: 1 }} onClick={e => setAnchorEl(e.currentTarget)}>
            <Avatar sx={{ bgcolor: 'primary.main', width: 36, height: 36 }}>م</Avatar>
          </IconButton>
...
const AIPage = () => (
  <Box sx={{ p: 3 }} dir="rtl">
    ...
    <Typography color="text.secondary">رؤى وتوصيات الذكاء الاصطناعي - قيد التطوير</Typography>
  </Box>
);
...
const SettingsPage = () => (
  <Box sx={{ p: 3 }} dir="rtl">
    ...
    <Typography color="text.secondary">إعدادات النظام - قيد التطوير</Typography>
  </Box>
);
