  ...
  const renderBarChart = () => (
    <ResponsiveContainer width="100%" height={400}>
      <BarChart data={sampleData}>
        ...
        {selectedMetrics.includes('actual') && (
          <Bar dataKey="actual" fill="#764ba2" radius={[8, 8, 0, 0]} />
        )}
      </BarChart>
    </ResponsiveContainer>
  );
          ...
          {!loading && (
            <>
              ...
              <Grid container spacing={2}>
                <Grid item xs={12} sm={6} md={3}>
                  <Paper
                    sx={{ p: 2, textAlign: 'center', borderRadius: '8px', background: '#f0f4ff' }}
                  >
                ...
                <Grid item xs={12} sm={6} md={3}>
                  <Paper
                    sx={{ p: 2, textAlign: 'center', borderRadius: '8px', background: '#f5f0ff' }}
                  >
                ...
                <Grid item xs={12} sm={6} md={3}>
                  <Paper
                    sx={{ p: 2, textAlign: 'center', borderRadius: '8px', background: '#fff0f5' }}
                  >
                ...
                <Grid item xs={12} sm={6} md={3}>
                  <Paper
                    sx={{ p: 2, textAlign: 'center', borderRadius: '8px', background: '#f0fff5' }}
                  >
