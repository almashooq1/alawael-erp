  ...
  const renderPhaseOverview = () => (
    <div className="phase-overview">
      ...
      <div className="phase-card">
        ...
        <div className="status">{statusData.xrSessions?.length || 0} active sessions</div>
      </div>
      ...
      <div className="phase-card">
        ...
        <div className="status">{statusData.k8sClusters?.length || 0} clusters</div>
      </div>
      ...
      <div className="phase-card">
        ...
        <div className="status">{statusData.perfMetrics?.status || 'Monitoring...'}</div>
      </div>
    </div>
  );
