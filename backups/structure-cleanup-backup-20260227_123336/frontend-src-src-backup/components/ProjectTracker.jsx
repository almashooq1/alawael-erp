  ...
  return (
    <div className="project-tracker">
      ...
      <div className="create-project-panel">
        ...
        <button onClick={createProject} className="btn btn-primary" disabled={loading}>
          🚀 Create Project
        </button>
      </div>
                ...
                >
                  ...
                  <div className="progress-section">
                    <div className="progress-header">
                      <span>Progress</span>
                      <span className="progress-percent">{getProgressPercentage(project)}%</span>
                    </div>
              ...
              <div className="gantt-container">
                ...
                <div className="gantt-bars">
                  {projects.slice(0, 10).map(project => {
                    ...
                    const startPos =
                      ((start - new Date(projects[0].startDate)) / (1000 * 60 * 60 * 24)) * 20;
      ...
      {viewMode === 'analytics' && (
        <div className="analytics-section">
          ...
          <div className="analytics-grid">
            ...
            <div className="analytics-card">
              <h3>✅ Completed</h3>
              <p className="big-number">{projects.filter(p => p.status === 'completed').length}</p>
            </div>
            ...
            <div className="analytics-card">
              <h3>👥 Team Members</h3>
              <p className="big-number">{new Set(projects.flatMap(p => p.team || [])).size}</p>
            </div>
