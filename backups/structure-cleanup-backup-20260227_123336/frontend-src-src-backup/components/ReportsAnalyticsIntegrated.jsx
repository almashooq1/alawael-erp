...
export default function ReportsAnalyticsIntegrated() {
  ...
  const handleExportPDF = () => {
    alert('ميزة تصدير PDF قيد التطوير. يرجى استخدام تصدير Excel حالياً.');
  };
    ...
    <div className="space-y-6" dir="rtl">
      ...
      <div className="bg-white rounded-lg shadow">
        ...
        <div className="p-6">
          ...
          {/* Payroll Tab */}
          {activeTab === 'payroll' && (
            <PayrollTab report={payrollReport} trendsData={payrollTrendsData} colors={COLORS} />
          )}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        {departmentData && departmentData.length > 0 && (
          <div className="bg-white rounded-lg shadow p-6">
            <h3 className="text-lg font-semibold text-gray-800 mb-4">توزيع الموظفين حسب الأقسام</h3>
        ...
        {attendanceData && attendanceData.length > 0 && (
          <div className="bg-white rounded-lg shadow p-6">
            <h3 className="text-lg font-semibold text-gray-800 mb-4">اتجاهات الحضور</h3>
            <ResponsiveContainer width="100%" height={300}>
              <LineChart data={attendanceData}>
                ...
                <Tooltip />
                <Legend />
                <Line type="monotone" dataKey="presentCount" stroke="#10B981" name="الحاضرون" />
                <Line type="monotone" dataKey="absentCount" stroke="#EF4444" name="الغائبون" />
              </LineChart>
            </ResponsiveContainer>
          </div>
        )}
      ...
      <div className="bg-gradient-to-r from-blue-50 to-blue-100 rounded-lg p-6 border border-blue-200">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div>
            ...
            <p className="text-2xl font-bold text-blue-600">{report.totalLeavesUsed || 0} يوم</p>
          </div>
          <div>
            <p className="text-sm text-gray-600">معدل الدوران الوظيفي</p>
            <p className="text-2xl font-bold text-blue-600">{report.turnoverRate || 0}%</p>
          </div>
        </div>
      </div>
    </div>
  ...
  return (
    <div className="space-y-6">
      ...
      {trendsData && trendsData.length > 0 && (
        <div className="bg-white rounded-lg shadow p-6">
          <h3 className="text-lg font-semibold text-gray-800 mb-4">اتجاهات الرواتب</h3>
      ...
      <div className="bg-white rounded-lg shadow overflow-hidden">
        <div className="p-6 border-b border-gray-200">
          <h3 className="text-lg font-semibold text-gray-800">تفصيل الرواتب حسب الأقسام</h3>
        </div>
  ...
  return (
    <div className="space-y-6">
      ...
      {performanceData && performanceData.length > 0 && (
        <div className="bg-white rounded-lg shadow p-6">
          <h3 className="text-lg font-semibold text-gray-800 mb-4">توزيع درجات الأداء</h3>
          <ResponsiveContainer width="100%" height={300}>
      ...
      <div className="bg-white rounded-lg shadow overflow-hidden">
        <div className="p-6 border-b border-gray-200">
          <h3 className="text-lg font-semibold text-gray-800">تفصيل الأداء حسب الفئات</h3>
        </div>
        <div className="overflow-x-auto">
          <table className="w-full text-right">
            <thead>
            ...
            <tbody>
              {[
                ...
                <tr key={index} className="border-b hover:bg-gray-50">
                  ...
                  <td className="px-6 py-4 text-gray-700">
                    {(((row.count || 0) / (report.totalEmployees || 1)) * 100).toFixed(1)}%
                  </td>
                </tr>
              ))}
            </tbody>
...
function ExportTab({ onExportExcel, onExportPDF, lastGenerated }) {
  return (
    <div className="space-y-6">
      <div className="bg-white rounded-lg shadow p-6">
        <h3 className="text-lg font-semibold text-gray-800 mb-4">خيارات التصدير</h3>

        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {/* Excel Export */}
          <div className="border-2 border-gray-200 rounded-lg p-6 hover:border-green-500 transition cursor-pointer">
            <div className="text-4xl mb-3">📊</div>
            <h4 className="text-lg font-semibold text-gray-800 mb-2">تصدير Excel</h4>
            <p className="text-gray-600 mb-4">تصدير جميع البيانات والتقارير بصيغة Excel</p>
            <button
          ...
          <div className="border-2 border-gray-200 rounded-lg p-6 hover:border-red-500 transition cursor-pointer">
            <div className="text-4xl mb-3">📄</div>
            <h4 className="text-lg font-semibold text-gray-800 mb-2">تصدير PDF</h4>
            <p className="text-gray-600 mb-4">تصدير التقارير بصيغة PDF للطباعة والأرشفة</p>
            <button
              onClick={onExportPDF}
      ...
      {/* Export History */}
      <div className="bg-white rounded-lg shadow p-6">
        <h3 className="text-lg font-semibold text-gray-800 mb-4">معلومات التصدير</h3>
      ...
      {/* Custom Reports */}
      <div className="bg-white rounded-lg shadow p-6">
        <h3 className="text-lg font-semibold text-gray-800 mb-4">تقارير مخصصة</h3>
