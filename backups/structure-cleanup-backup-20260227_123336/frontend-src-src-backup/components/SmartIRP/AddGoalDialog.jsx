    ...
    <Dialog open={open} onClose={onClose} maxWidth="md" fullWidth>
          ...
          <Grid container spacing={3}>
            ...
            <Grid item xs={12} md={6}>
              <TextField
                ...
                onChange={e =>
                  handleChange('measurable', 'baseline', parseFloat(e.target.value) || 0)
                }
              />
            </Grid>
            ...
            <Grid item xs={12} md={6}>
              <TextField
                ...
                onChange={e =>
                  handleChange('measurable', 'target', parseFloat(e.target.value) || 0)
                }
                required
              />
            </Grid>
                  ...
                  <Chip
                    ...
                    onDelete={() => {
                      setFormData(prev => ({
                        ...
                        achievable: {
                          ...prev.achievable,
                          requiredResources: prev.achievable.requiredResources.filter(
                            (_, i) => i !== index
                          ),
                        },
                      }));
                  ...
                  <Chip
                    ...
                    onDelete={() => {
                      setFormData(prev => ({
                        ...
                        achievable: {
                          ...prev.achievable,
                          potentialBarriers: prev.achievable.potentialBarriers.filter(
                            (_, i) => i !== index
                          ),
                        },
                      }));
                  ...
                  <Chip
                    ...
                    onDelete={() => {
                      setFormData(prev => ({
                        ...
                        achievable: {
                          ...prev.achievable,
                          supportStrategies: prev.achievable.supportStrategies.filter(
                            (_, i) => i !== index
                          ),
                        },
                      }));
      ...
      <DialogActions>
        ...
        <Button
          ...
          disabled={
            loading || !formData.title || !formData.measurable.metric || !formData.measurable.target
          }
        >
