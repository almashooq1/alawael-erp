  ...
  return (
    <AppBar position="sticky" className="header">
      <Toolbar>
        {/* Menu Button */}
        {showMenu && (
          <IconButton edge="start" color="inherit" onClick={onMenuClick} className="menu-button">
            <MenuIcon />
          </IconButton>
        )}
        ...
        <Box className="header-actions">
          ...
          <Tooltip title={user?.name || 'User'}>
            <IconButton onClick={handleMenuOpen} className="user-button">
              <Avatar alt={user?.name} src={user?.avatar} className="user-avatar" />
            </IconButton>
          </Tooltip>
        </Box>
      </Toolbar>
      ...
      >
        <MenuItem onClick={handleNotificationClose}>{t('notifications.noNew')}</MenuItem>
      </Menu>
    </AppBar>
  );
};
