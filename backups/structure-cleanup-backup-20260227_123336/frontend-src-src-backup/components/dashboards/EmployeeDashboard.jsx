          ...
          <section className="section-salary">
              ...
              {salaryCompensation.lastPayslip && (
                <div className="payslip-card">
                  ...
                  <div className="payslip-info">
                    <p className="date">
                      {new Date(salaryCompensation.lastPayslip.date).toLocaleDateString('ar-SA')}
                    </p>
            ...
            {salaryCompensation.bonus.eligible && (
              <div className="bonus-card">
                ...
                <p className="date">
                  تاريخ الصرف المتوقع:{' '}
                  {new Date(salaryCompensation.bonus.expectedDate).toLocaleDateString('ar-SA')}
                </p>
              </div>
            )}
              ...
              <div className="insurance-info">
                ...
                <div className="info-row">
                  ...
                  <span className="value">
                    {new Date(insuranceBenefits.medicalInsurance.expiryDate).toLocaleDateString(
                      'ar-SA'
                    )}
                  </span>
                </div>
                  ...
                  <div key={idx} className="request-card">
                    <div className="request-info">
                      ...
                      <p>
                        ...
                        {new Date(req.endDate).toLocaleDateString('ar-SA')} ({req.duration} أيام)
                      </p>
                    </div>
                  ...
                  <div key={idx} className="document-item">
                    <div className="document-info">
                      ...
                      <p className="doc-date">
                        التاريخ: {new Date(doc.date).toLocaleDateString('ar-SA')}
                      </p>
                      {doc.lastUpdated && (
                        <p className="updated">
                    ...
                    <a href={doc.url} className="btn-download">
                      تحميل
                    </a>
                  </div>
                ))}
                ...
                <div className="documents-list">
                  {documents.certifications.map((cert, idx) => (
                    <div key={idx} className="document-item">
                      ...
                      <a href={cert.url} className="btn-view">
                        عرض
                      </a>
                    </div>
                  ))}
          ...
          <section className="section-performance">
            ...
            <div className="performance-card">
              ...
              <div className="review-info">
                <div className="rating-display">
                  <div className="overall-rating">
                    {performanceDevelopment.performanceReview.overallRating}
                  </div>
                  <p>التقييم الإجمالي من 5</p>
                </div>
                <div className="ratings-breakdown">
                  {Object.entries(performanceDevelopment.performanceReview.ratingDistribution).map(
                    ([category, rating]) => (
              ...
              <p className="next-review">
                التقييم التالي بتاريخ:{' '}
                {new Date(
                  performanceDevelopment.performanceReview.nextReviewDate
                  ...
                  {performanceDevelopment.developmentPlan.goals.map((goal, idx) => (
                    <div key={idx} className="goal-item">
                      ...
                      <p className="due-date">
                        الموعد المقرر: {new Date(goal.dueDate).toLocaleDateString('ar-SA')}
                      </p>
                    </div>
                  ))}
                </div>
                  ...
                  {performanceDevelopment.trainings.inProgress.map((training, idx) => (
                    <div key={idx} className="training-item">
                      ...
                      <div className="training-info">
                        <p>{training.name}</p>
                        <small>
                          {new Date(training.startDate).toLocaleDateString('ar-SA')} -{' '}
                          {new Date(training.endDate).toLocaleDateString('ar-SA')}
                        </small>
                      </div>
                    </div>
                  ))}
