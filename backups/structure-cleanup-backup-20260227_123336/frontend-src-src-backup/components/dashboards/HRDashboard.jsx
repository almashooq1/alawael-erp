              ...
              {employeeRoster.recentChanges.map((change, idx) => (
                <div key={idx} className="change-item">
                  <div className="change-info">
                    <h4>{change.name}</h4>
                    <p>
                      <strong>{change.action}</strong> - {change.department}
                    </p>
                ...
                {personnelManagement.leaves.pending.map((leave, idx) => (
                  <div key={idx} className="leave-request">
                    <div className="request-info">
                      <h4>{leave.name}</h4>
                      <p>
                        {leave.type} - {leave.duration} يومي
                      </p>
                      <p className="dates">
            ...
            <div className="breakdown-list">
              <div className="breakdown-item">
                ...
                <span className="amount">
                  {(payrollCompensation.currentPayroll.deductionsBreakdown.gosi / 1000).toFixed(1)}K
                </span>
              </div>
              <div className="breakdown-item">
                ...
                <span className="amount">
                  {(
                    payrollCompensation.currentPayroll.deductionsBreakdown.insurance / 1000
                  ).toFixed(1)}
                  K
                </span>
              </div>
              <div className="breakdown-item">
                <span>الضريبة</span>
                <span className="amount">
                  {(payrollCompensation.currentPayroll.deductionsBreakdown.tax / 1000).toFixed(1)}K
                </span>
              </div>
            </div>
          </div>
              ...
              <div key={idx} className="requisition-card">
                ...
                <div className="requisition-stats">
                  ...
                  <span>
                    المدة:{' '}
                    {Math.floor(
                      (Date.now() - new Date(req.openSince).getTime()) / (24 * 60 * 60 * 1000)
                    )}{' '}
                    يوم
                  </span>
                </div>
