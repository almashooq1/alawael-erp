                  ...
                  >
                    <ListItemAvatar>
                      <Badge badgeContent={conv.unreadCount || 0} color="error">
                        <Avatar>
                          {conv.groupInfo?.name?.charAt(0) ||
                            conv.participants?.[0]?.user?.fullName?.charAt(0) ||
                            '?'}
                        </Avatar>
                      </Badge>
                    </ListItemAvatar>
                    <ListItemText
                      primary={
                        conv.groupInfo?.name ||
                        conv.participants?.find(p => p.user)?.user?.fullName ||
                        'محادثة'
                      }
              ...
              <>
                ...
                >
                  <Box sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>
                    <Avatar>
                      {selectedConversation.groupInfo?.name?.charAt(0) ||
                        selectedConversation.participants?.[0]?.user?.fullName?.charAt(0) ||
                        '?'}
                    </Avatar>
                    <div>
                      <Typography variant="h6">
                        {selectedConversation.groupInfo?.name ||
                          selectedConversation.participants?.[0]?.user?.fullName ||
                          'محادثة'}
                      </Typography>
