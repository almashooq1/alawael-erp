  ...
  const [crashes, setCrashes] = useState([
    {
      ...
      affectedUsers: 28,
      severity: 'critical',
      lastOccurrence: '2026-01-16 14:30',
    },
    {
      id: 2,
      ...
      affectedUsers: 8,
      severity: 'high',
      lastOccurrence: '2026-01-16 10:15',
    },
    {
      id: 3,
      ...
      affectedUsers: 65,
      severity: 'medium',
      lastOccurrence: '2026-01-16 15:20',
    },
  ]);
        ...
        {[
          {
            ...
            value: metrics.activeUsers.toLocaleString('ar'),
            icon: '👥',
            color: '#667eea',
            change: '+12%',
          },
          {
            label: 'الجلسات',
            value: metrics.sessions.toLocaleString('ar'),
            icon: '📱',
            color: '#4caf50',
            change: '+8%',
          },
          ...
          <Grid item xs={12} sm={6} md={3} key={idx}>
            ...
            >
              ...
              <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                ...
                <Typography
                  variant="caption"
                  sx={{ fontWeight: 600, color: stat.change.includes('+') ? '#4caf50' : '#f44336' }}
                >
                  {stat.change}
                </Typography>
              </Box>
