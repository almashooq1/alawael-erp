...
const NotificationSystem = () => {
  ...
  const notificationStats = useMemo(() => {
    ...
    const avgDeliveryRate = (
      notifications.reduce((sum, n) => sum + n.sendRate, 0) / notifications.length
    ).toFixed(1);
                ...
                <CardContent>
                  <Stack spacing={2}>
                    ...
                    <Chip
                      ...
                      color={template.status === 'نشط' ? 'success' : 'warning'}
                      size="small"
                    />
                  </Stack>
                </CardContent>
            ...
            <TableBody>
              {preferences.map(pref => (
                <TableRow key={pref.id} hover>
                  ...
                  <TableCell>
                    <Chip
                      label={pref.email ? 'مفعل' : 'معطل'}
                      color={pref.email ? 'success' : 'error'}
                      size="small"
                    />
                  </TableCell>
                  <TableCell>
                    <Chip
                      label={pref.sms ? 'مفعل' : 'معطل'}
                      color={pref.sms ? 'success' : 'error'}
                      size="small"
                    />
                  </TableCell>
                  <TableCell>
                    <Chip
                      label={pref.push ? 'مفعل' : 'معطل'}
                      color={pref.push ? 'success' : 'error'}
                      size="small"
                    />
                  </TableCell>
                  <TableCell>
                    <Chip
                      label={pref.inApp ? 'مفعل' : 'معطل'}
                      color={pref.inApp ? 'success' : 'error'}
                      size="small"
                    />
                  </TableCell>
