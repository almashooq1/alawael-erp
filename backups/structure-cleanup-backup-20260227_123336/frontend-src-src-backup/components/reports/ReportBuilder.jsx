                ...
                <Grid container spacing={2}>
                  <Grid item xs={6} md={3}>
                    ...
                    <Typography variant="h6">
                      ${salesReport.summary?.total_sales?.toFixed(2)}
                    </Typography>
                  </Grid>
                  <Grid item xs={6} md={3}>
                    <Typography variant="body2" color="text.secondary">
                  ...
                  <Grid item xs={6} md={3}>
                    ...
                    <Typography variant="h6">
                      ${salesReport.summary?.average_daily_sales?.toFixed(2)}
                    </Typography>
                  </Grid>
                  <Grid item xs={6} md={3}>
                    <Typography variant="body2" color="text.secondary">
                    ...
                    <Typography variant="h6">
                      ${salesReport.summary?.average_transaction_value?.toFixed(2)}
                    </Typography>
                  </Grid>
                </Grid>
              </CardContent>
              ...
              <CardContent>
                ...
                <Grid container spacing={2}>
                  ...
                  <Grid item xs={12} md={4}>
                    ...
                    <Typography variant="h6">
                      ${revenueReport.summary?.average_revenue_per_category?.toFixed(2)}
                    </Typography>
                  </Grid>
                </Grid>
              </CardContent>
    ...
    <Grid container spacing={3}>
      <Grid item xs={12} md={6}>
        <FormControl fullWidth>
          ...
          <Select value={usersRole} onChange={e => setUsersRole(e.target.value)} label="الدور">
            <MenuItem value="all">الكل</MenuItem>
      ...
      <Grid item xs={12} md={6}>
        <FormControl fullWidth>
          ...
          <Select value={usersStatus} onChange={e => setUsersStatus(e.target.value)} label="الحالة">
            <MenuItem value="all">الكل</MenuItem>
                ...
                <Grid container spacing={2}>
                  ...
                  <Grid item xs={6} md={3}>
                    ...
                    <Typography variant="h6" color="success.main">
                      {usersReport.summary?.active_users}
                    </Typography>
                  </Grid>
                  <Grid item xs={6} md={3}>
                    <Typography variant="body2" color="text.secondary">
                    ...
                    <Typography variant="h6" color="error.main">
                      {usersReport.summary?.inactive_users}
                    </Typography>
                  </Grid>
                  <Grid item xs={6} md={3}>
                    <Typography variant="body2" color="text.secondary">
                    ...
                    <Typography variant="h6">
                      {usersReport.summary?.overall_activity_rate}%
                    </Typography>
                  </Grid>
                </Grid>
              </CardContent>
                    ...
                    <TableRow key={index}>
                      ...
                      <TableCell align="right">
                        <Chip
                          ...
                          color={
                            row.activity_rate > 80
                              ? 'success'
                              : row.activity_rate > 60
                                ? 'warning'
                                : 'error'
                          }
                          size="small"
              ...
              <CardContent>
                ...
                <Grid container spacing={2}>
                  <Grid item xs={12} md={6}>
                    ...
                    <Typography variant="h6" color="success.main">
                      {attendanceReport.summary?.average_present_rate?.toFixed(2)}%
                    </Typography>
                  </Grid>
                  <Grid item xs={12} md={6}>
                    <Typography variant="body2" color="text.secondary">
                    ...
                    <Typography variant="h6" color="error.main">
                      {attendanceReport.summary?.average_absent_rate?.toFixed(2)}%
                    </Typography>
                  </Grid>
                </Grid>
              </CardContent>
