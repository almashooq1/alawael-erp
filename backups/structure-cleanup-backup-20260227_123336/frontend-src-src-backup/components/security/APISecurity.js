  ...
  const [blockedIPs, setBlockedIPs] = useState([
    {
      ...
      blockedDate: '2026-01-15',
      unblockDate: '2026-01-22',
      status: 'active',
    },
    {
      id: 2,
    ...
    },
    {
      ...
      ip: '172.16.0.1',
      reason: 'DDoS attempt',
      blockedDate: '2026-01-13',
      unblockDate: '2026-01-20',
      status: 'expired',
    },
  ]);
        ...
        {rateLimits.map(limit => (
          <Box key={limit.id} sx={{ mb: 2 }}>
            ...
            >
              ...
              <Chip
                label={
                  limit.status === 'ok' ? 'عادي' : limit.status === 'warning' ? 'تحذير' : 'حرج'
                }
                color={
                  limit.status === 'ok'
                    ? 'success'
              ...
              <TableRow key={ip.id} sx={{ '&:hover': { backgroundColor: '#f8f9ff' } }}>
                ...
                <TableCell>
                  <Chip
                    ...
                    color={
                      ip.status === 'active' || ip.status === 'permanent' ? 'error' : 'default'
                    }
                    size="small"
                  />
                </TableCell>
