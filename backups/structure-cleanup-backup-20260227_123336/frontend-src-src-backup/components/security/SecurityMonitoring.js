...
const SecurityMonitoring = () => {
  ...
  const rolesList = [
    ...
    },
    {
      ...
      color: '#4ecdc4',
      permissions: 4,
      description: 'إدارة فريق والتقارير',
    },
    {
      id: 'user',
      name: 'مستخدم عادي',
            ...
            <Card key={key.id} sx={{ borderRadius: 2 }}>
              <CardContent>
                ...
                >
                  ...
                  <Chip
                    label={key.status === 'active' ? 'نشط' : 'معطل'}
                  ...
                  <TableRow key={log.id} sx={{ '&:hover': { backgroundColor: '#f8f9ff' } }}>
                    ...
                    <TableCell>
                      <Chip
                        ...
                        size="small"
                        sx={{
                          backgroundColor: getRiskColor(log.risk) + '20',
          ...
          <Card sx={{ borderRadius: 2 }}>
            <CardContent>
              <Stack spacing={2}>
                {[
                  {
                    label: 'المصادقة الثنائية (MFA)',
                    description: 'طلب رمز إضافي عند تسجيل الدخول',
                    enabled: true,
                  },
                  {
                    label: 'تصفية عنوان IP',
                    description: 'السماح فقط بـ IP معينة',
                    enabled: false,
                  },
                  {
                    label: 'التشفير من طرف إلى طرف',
                    description: 'تشفير جميع البيانات المحساسة',
                    enabled: true,
                  },
                  {
                    label: 'سجل الأنشطة المفصل',
                    description: 'تسجيل جميع العمليات الأمنية',
                    enabled: true,
                  },
                  {
                    label: 'تنبيهات الأمان',
                    description: 'إرسال إشعارات عند محاولات مريبة',
                    enabled: true,
                  },
                  {
                    label: 'انتهاء الجلسة تلقائي',
                    description: 'تسجيل الخروج بعد 30 دقيقة من عدم النشاط',
                    enabled: true,
                  },
                ].map((setting, idx) => (
                  <Box
            ...
            {dialogType === 'addUser' ? (
              ...
              <>
                <TextField
                  ...
                  fullWidth
                  required
                  placeholder="مثل: Production API"
                />
                <FormControl fullWidth>
