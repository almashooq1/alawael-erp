...
import { AccountBalance, TrendingUp, Receipt, AttachMoney } from '@mui/icons-material';
...
const AccountingDashboard = () => {
  ...
  const fetchDashboardData = async () => {
    try {
      ...
      const response = await axios.get('/api/accounting/analytics/dashboard', {
        ...
        <Grid item xs={12} sm={6} md={3}>
          <Card>
            <CardContent>
              ...
              <Typography variant="h5">{dashboardData?.totalInvoices || 0}</Typography>
