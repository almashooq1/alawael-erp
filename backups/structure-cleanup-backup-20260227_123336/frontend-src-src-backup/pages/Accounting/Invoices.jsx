...
const Invoices = () => {
  ...
  const handleDownloadPDF = invoiceId => {
    ...
    exportService.exportToPDF(data, `فاتورة_${invoice.invoiceNumber}`, {
      branding,
                ...
                filteredInvoices
                  ...
                  .map(invoice => (
                    <TableRow key={invoice._id} hover>
                      ...
                      <TableCell>{invoice.totalAmount?.toLocaleString('ar-SA')} ر.س</TableCell>
                      <TableCell>{invoice.paidAmount?.toLocaleString('ar-SA')} ر.س</TableCell>
                      <TableCell>{invoice.remainingAmount?.toLocaleString('ar-SA')} ر.س</TableCell>
                      <TableCell>
                        <Chip
          ...
          <Grid container spacing={2} sx={{ mt: 1 }}>
            ...
            {formData.items.map((item, index) => (
              <React.Fragment key={index}>
                ...
                <Grid item xs={4} md={1.5}>
                  <TextField fullWidth label="المجموع" value={item.amount.toFixed(2)} disabled />
                </Grid>
            ...
            <Grid item xs={12}>
              <Box sx={{ textAlign: 'right' }}>
                ...
                <Typography variant="body1">الضريبة: {totals.totalVat.toFixed(2)} ر.س</Typography>
