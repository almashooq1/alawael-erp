...
import { Save as SaveIcon, Restore as RestoreIcon, Lock as LockIcon } from '@mui/icons-material';
    ...
    <Grid container spacing={3}>
      ...
      <Grid item xs={12} md={4}>
        <TextField
          ...
          onChange={e => setAccountingSettings({ ...accountingSettings, currency: e.target.value })}
        >
    ...
    <Grid container spacing={3}>
      ...
      <Grid item xs={12} md={4}>
        <TextField
          ...
          onChange={e => setVatSettings({ ...vatSettings, vatRate: parseFloat(e.target.value) })}
      ...
      {vatSettings.vatEnabled && (
        <Grid item xs={12}>
          <Alert severity="info">
            سيتم تطبيق ضريبة القيمة المضافة بنسبة {vatSettings.vatRate}% على جميع الفواتير والمبيعات
            بدءاً من {format(new Date(vatSettings.vatStartDate), 'dd/MM/yyyy')}.
          </Alert>
        </Grid>
      )}
    </Grid>
    ...
    <Grid container spacing={3}>
      ...
      <Grid item xs={12} md={6}>
        <TextField
          ...
          onChange={e => setDefaultAccounts({ ...defaultAccounts, cashAccount: e.target.value })}
      ...
      <Grid item xs={12} md={6}>
        <TextField
          ...
          onChange={e => setDefaultAccounts({ ...defaultAccounts, bankAccount: e.target.value })}
      ...
      <Grid item xs={12} md={6}>
        <TextField
          ...
          onChange={e => setDefaultAccounts({ ...defaultAccounts, salesAccount: e.target.value })}
