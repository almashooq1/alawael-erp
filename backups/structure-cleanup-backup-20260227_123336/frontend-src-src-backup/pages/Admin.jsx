                  ...
                  {users.length > 0 ? (
                    users.map(user => (
                      <tr key={user.id}>
                        ...
                        <td>
                          <button className="action-btn edit" style={touchButtonStyle}>
                            Edit
                          </button>
                          <button className="action-btn delete" style={touchButtonStyle}>
                            Delete
                          </button>
                        </td>
                      </tr>
              ...
              {alerts.length > 0 ? (
                alerts.map((alert, idx) => (
                  <div key={idx} className={`alert-item alert-${alert.severity || 'info'}`}>
                    ...
                    <button className="alert-dismiss" style={touchButtonStyle}>
                      ×
                    </button>
                  </div>
                ))
            ...
            <form className="settings-form">
              <div className="setting-group">
                ...
                <input
                  ...
                  onChange={e =>
                    setSystemConfig({ ...systemConfig, maxConnections: e.target.value })
                  }
                />
              ...
              <div className="setting-group">
                ...
                <input
                  ...
                  onChange={e =>
                    setSystemConfig({ ...systemConfig, requestTimeout: e.target.value })
                  }
                />
              ...
              <div className="setting-group checkbox">
                <label>
                  <input
                    ...
                    onChange={e =>
                      setSystemConfig({ ...systemConfig, enableMetrics: e.target.checked })
                    }
                  />
