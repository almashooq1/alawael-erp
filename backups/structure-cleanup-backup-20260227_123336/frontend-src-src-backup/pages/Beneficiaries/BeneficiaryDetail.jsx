...
const BeneficiaryDetail = () => {
  ...
  if (!beneficiary) {
    return <Alert severity="error">لم يتم العثور على المستفيد</Alert>;
  }
          ...
          <Card>
            <CardContent>
              ...
              <List dense>
                ...
                <ListItem>
                  <ListItemText primary="رقم الهوية" secondary={beneficiary.national_id} />
                </ListItem>
              </List>
            </CardContent>
          </Card>
        ...
        <Grid item xs={12} md={6}>
          <Card>
            <CardContent>
              ...
              <List dense>
                <ListItem>
                  <ListItemText primary="نوع الإعاقة" secondary={beneficiary.disability_type} />
                </ListItem>
                <ListItem>
                  <ListItemText primary="فئة الإعاقة" secondary={beneficiary.disability_category} />
                </ListItem>
                <ListItem>
                  <ListItemText
                    primary="درجة الشدة"
                ...
                <ListItem>
                  <ListItemText primary="التشخيص الطبي" secondary={beneficiary.medical_diagnosis} />
                </ListItem>
              </List>
            </CardContent>
          </Card>
        ...
        <Grid item xs={12} md={6}>
          <Card>
            <CardContent>
              ...
              <List dense>
                <ListItem>
                  <ListItemText primary="اسم الوصي" secondary={beneficiary.guardian_name} />
                </ListItem>
                <ListItem>
                  <ListItemText
                ...
                <ListItem>
                  <ListItemText primary="الهاتف" secondary={beneficiary.guardian_phone} />
                </ListItem>
                <ListItem>
                  <ListItemText
