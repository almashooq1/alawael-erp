  ...
  return (
    <Box sx={{ p: 3 }}>
        ...
        <Grid item xs={12} sm={6} md={3}>
          <Card>
            <CardContent>
              ...
              <Typography variant="h5">{pagination?.total || 0}</Typography>
            </CardContent>
          </Card>
        </Grid>
        <Grid item xs={12} sm={6} md={3}>
              ...
              <TableBody>
                {beneficiaries.map(beneficiary => (
                  <TableRow key={beneficiary._id} hover>
                    ...
                    <TableCell>
                      <Chip label={beneficiary.insuranceProvider} size="small" />
                    </TableCell>
                    <TableCell>
      ...
      <Dialog open={openDialog} onClose={() => setOpenDialog(false)} maxWidth="sm" fullWidth>
        <DialogTitle>{editingId ? 'تعديل المستفيد' : 'إضافة مستفيد جديد'}</DialogTitle>
        <DialogContent>
