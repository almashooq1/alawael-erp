            ...
            <CardContent>
              <Grid container spacing={2}>
                <Grid item xs={12} sm={6}>
                  ...
                  <Typography variant="body1">{currentBeneficiary.firstName}</Typography>
                </Grid>
                <Grid item xs={12} sm={6}>
                  <Typography color="textSecondary" gutterBottom>
                    الاسم الأخير
                  </Typography>
                  <Typography variant="body1">{currentBeneficiary.lastName}</Typography>
                </Grid>
                <Grid item xs={12} sm={6}>
                  <Typography color="textSecondary" gutterBottom>
                    رقم الملف
                ...
                <Grid item xs={12} sm={6}>
                  ...
                  <Typography variant="body1">{currentBeneficiary.email}</Typography>
                </Grid>
                <Grid item xs={12} sm={6}>
                  <Typography color="textSecondary" gutterBottom>
                    الهاتف
                  </Typography>
                  <Typography variant="body1">{currentBeneficiary.phone}</Typography>
                </Grid>
                <Grid item xs={12} sm={6}>
                  <Typography color="textSecondary" gutterBottom>
                    جهة التأمين
                ...
                <Grid item xs={12}>
                  ...
                  <Typography variant="body1">{currentBeneficiary.address}</Typography>
                </Grid>
              </Grid>
            </CardContent>
          </Card>
            ...
            <CardHeader
              ...
              action={
                <Tooltip title="إضافة سجل طبي">
                  <IconButton size="small" onClick={() => setOpenMedicalDialog(true)}>
                    <AddIcon />
                  </IconButton>
                </Tooltip>
              }
