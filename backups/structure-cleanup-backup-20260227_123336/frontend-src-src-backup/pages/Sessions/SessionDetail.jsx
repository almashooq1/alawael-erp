...
const SessionDetail = () => {
  ...
  if (!session) {
    return <Alert severity="error">لم يتم العثور على الجلسة</Alert>;
  }
          ...
          <Card sx={{ mb: 3 }}>
            <CardContent>
              ...
              <List dense>
                  ...
                  <ListItemText
                    ...
                    secondary={
                      <>
                        ...
                        <Typography variant="body2">الوقت: {session.session_time}</Typography>
                      </>
                    }
                  />
                </ListItem>
                ...
                <ListItem>
                  <ListItemText primary="نوع الجلسة" secondary={session.session_type} />
                </ListItem>
                <ListItem>
                  <ListItemText
                    primary="الحالة"
                    secondary={<Chip label={statusLabel} size="small" color={statusColor} />}
                  />
                </ListItem>
              </List>
            </CardContent>
