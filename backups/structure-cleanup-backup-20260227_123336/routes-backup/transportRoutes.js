...
router.patch(
  ...
  TransportRouteController.updateRouteStatus
);
...
router.post(
  ...
  protect,
  authorize('manager', 'admin'),
  TransportRouteController.optimizeRoute
);
...
router.post(
  ...
  protect,
  authorize('manager', 'admin'),
  TransportRouteController.suggestAlternatives
);
...
router.post(
  ...
  protect,
  authorize('manager', 'admin'),
  TransportRouteController.addPassenger
);
 ...
 */
router.delete(
  '/:id/passengers/:userId',
  protect,
  authorize('manager', 'admin'),
  TransportRouteController.removePassenger
);
...
router.post(
  ...
  TransportRouteController.updateTripStatus
);
...
router.post(
  ...
  protect,
  authorize('manager', 'admin'),
  TransportRouteController.assignVehicle
);
