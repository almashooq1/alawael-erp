/**
 * Auto-generated test for ../../components/DataMigrationDashboard.jsx
...
describe('../../components/DataMigrationDashboard.jsx', () => {
  let src;

  beforeAll(() => {
    const filePath = path.resolve(__dirname, '../../components/DataMigrationDashboard.jsx');
