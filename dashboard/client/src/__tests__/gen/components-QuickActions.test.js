/**
 * Auto-generated test for ../../components/QuickActions.jsx
...
describe('../../components/QuickActions.jsx', () => {
  let src;

  beforeAll(() => {
    const filePath = path.resolve(__dirname, '../../components/QuickActions.jsx');
