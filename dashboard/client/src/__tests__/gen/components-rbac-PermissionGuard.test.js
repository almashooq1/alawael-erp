/**
 * Auto-generated test for ../../components/rbac/PermissionGuard.jsx
...
describe('../../components/rbac/PermissionGuard.jsx', () => {
  let src;

  beforeAll(() => {
    const filePath = path.resolve(__dirname, '../../components/rbac/PermissionGuard.jsx');
