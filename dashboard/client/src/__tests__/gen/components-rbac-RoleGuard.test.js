/**
 * Auto-generated test for ../../components/rbac/RoleGuard.jsx
...
describe('../../components/rbac/RoleGuard.jsx', () => {
  let src;

  beforeAll(() => {
    const filePath = path.resolve(__dirname, '../../components/rbac/RoleGuard.jsx');
    ...
    test('file has reasonable length (89 lines)', () => {
      expect(89).toBeGreaterThan(0);
      expect(89).toBeLessThan(10000);
    });
