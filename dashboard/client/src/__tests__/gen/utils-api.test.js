/**
 * Auto-generated test for ../../utils/api.js
...
describe('../../utils/api.js', () => {
  let src;

  beforeAll(() => {
    const filePath = path.resolve(__dirname, '../../utils/api.js');
    ...
    test('file has reasonable length (90 lines)', () => {
      expect(90).toBeGreaterThan(0);
      expect(90).toBeLessThan(10000);
    });
