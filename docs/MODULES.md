...
> 📑 **Supply chain + ops closure (2026-06)**: [`docs/architecture/SUPPLY_CHAIN_OPS_CLOSURE_2026-06.md`](architecture/SUPPLY_CHAIN_OPS_CLOSURE_2026-06.md) — index W780–W822 (**engineering freeze** after W821; ADR-039 sign-off pending). Staging: `npm run verify:supply-chain-staging`.
