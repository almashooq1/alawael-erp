...
| 2026-05-25 | _pending_             | **Cycle 3 item #3**: ADR-026 decision brief — live ecosystem counts (Structure 2 = 4 files / Structure 3 = 11 files) + 30-min meeting agenda + decision template + 4 no-regrets pre-work items | Cycle 3         |
