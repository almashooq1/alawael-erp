...
| 2026-05-25 | _pending_             | **Cycle 3 no-regrets ship**: items 1 (MFA tier 2 on iep.routes sign/transition/delete + 8-test drift guard) + 4 (frontend /iep vs /iep-plan convention doc). Item 2 WITHDRAWN (PDPL 30-day TTL would auto-delete legal artifacts; needs stakeholder retention policy). Item 3 HELD until ADR-026 decision. | Cycle 3         |
