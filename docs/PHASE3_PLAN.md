...
> آخر مزامنة: 2026-05-19 (بعد Wave 120).
...
| **P3.6** | Parent Chatbot            | ⚠️ **Phase 1 مُسلَّم Wave 120** | [intelligence/parent-chatbot.registry.js](../backend/intelligence/parent-chatbot.registry.js) + [intelligence/parent-chatbot.service.js](../backend/intelligence/parent-chatbot.service.js) + [routes/parent-chatbot.routes.js](../backend/routes/parent-chatbot.routes.js) + [models/ParentChatbotSession.js](../backend/models/ParentChatbotSession.js). 11 intents (rule-based AR+EN classifier) + 11 templates + 3 perms + 2 endpoints. 30/30 tests pass. | Phase 2: LLM + DB context injection. Phase 3: Parent Portal UI                     |

**خلاصة:** 5/6 مُسلَّمة جوهريًا (P3.1-P3.5)، 1/6 Phase 1 فقط (P3.6 — يحتاج Phases 2-3 لاكتمال كامل).
