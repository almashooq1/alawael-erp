...
> Updated: 2026-06-21T17:55:00+03:00  
...
| Surface                | Result                                                                                                                                                                                                                                                                                                                                |
| ---------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `gates`                | ⚠️ 6/7 backend pre-push gates pass with `CHECK_WAVE_SKIP=1`; `check:wave-collision` currently reports collisions because the local branch history was rewritten (renumber W1423→W1427, W1424→W1428, W1425→W1429, W1426→W1430) and now diverges from `origin/feat/w1406-preflight-followup`. A force-push is required to align origin. |
...
2. Before push, run the 7 pre-push gates. Current status: 6/7 pass when wave-collision is skipped; `check:wave-collision` itself shows collisions because the local branch diverges from origin after a history rewrite. The repair waves were renumbered (W1423→W1427, W1424→W1428, W1425→W1429, W1426→W1430) to avoid collisions with prior WhatsApp commits. To make the gate pass without skipping, force-push the rewritten branch to `origin/feat/w1406-preflight-followup`. Alternative: push with `CHECK_WAVE_SKIP=1 git push`.
