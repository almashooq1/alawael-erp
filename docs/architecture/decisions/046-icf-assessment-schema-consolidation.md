...
**Status:** ✅ Accepted — **Option B** (keep distinct). Implemented 2026-06-30:
`models/assessment/ICFAssessment.js` → `ICFAssessmentLegacy.js` (file name now
matches the W1542 model name) + cross-reference headers in both ICF model files.
No schema/contract change; the crash stays fixed (W1542) and guarded (W1544).
Option A remains available only via the stakeholder A1/A2 decision documented below.
**Date:** 2026-06-29 (analysis) · 2026-06-30 (accepted Option B)
