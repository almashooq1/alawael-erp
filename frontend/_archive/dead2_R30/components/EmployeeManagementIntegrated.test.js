...
describe('EmployeeManagementIntegrated Component', () => {
  ...
  describe('Data Fetching', () => {
    ...
    test('should handle API errors gracefully', async () => {
      ...
      await waitFor(() => {
        const matches = screen.getAllByText(/فشل|بيانات بديلة|إدارة الموظفين/i);
  ...
  describe('Create Employee', () => {
    ...
    test('should create new employee when form is submitted', async () => {
      ...
      // Click "موظف جديد" button to open create modal
      fireEvent.click(screen.getByText(/موظف جديد/i));
      ...
      const nameInput = modalDiv.querySelector('input[type="text"]');
      const emailInput = document.querySelector('input[type="email"]');

      fireEvent.change(nameInput, { target: { value: 'محمود حسن' } });
      fireEvent.change(emailInput, { target: { value: 'mahmoud@example.com' } });
  ...
  describe('Update Employee', () => {
    ...
    test('should update employee successfully', async () => {
      ...
      // Click edit button - look for Edit2 icon or pencil icon
      ...
      if (editButton) {
        ...
        // Submit update
        const submitButtons = screen.queryAllByText(/حفظ|تحديث|تعديل/i);
  ...
  describe('Responsive Design', () => {
    test('should be responsive on mobile', async () => {
      ...
      const title = await screen.findByText(/إدارة|management/i);
  ...
  describe('Table Display', () => {
    ...
    test('should display all employee columns', async () => {
      ...
      await waitFor(() => {
        ...
        expect(screen.getByText(/الوظيفة|المنصب|position/i)).toBeInTheDocument();
      });
    });
