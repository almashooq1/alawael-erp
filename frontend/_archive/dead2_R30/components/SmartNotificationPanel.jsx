 ...
 */
function SmartNotificationPanel({ _userId = 'user1' }) {
  const [anchorEl, setAnchorEl] = useState(null);
  const [_selectedNotification, setSelectedNotification] = useState(null);
  ...
  const handleDeleteNotification = async (_notificationId) => {
