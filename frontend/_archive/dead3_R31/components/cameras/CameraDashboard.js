                ...
                >
                  ...
                  <Stack direction="row" spacing={1}>
                    <Button
                      ...
                      onClick={() => fetchCameras(selectedBranch._id)}
                    >
                      تحديث
                    </Button>
                    <Button
                      ...
                      onClick={() => window.alert('إدارة التخزين قيد التطوير')}
                    >
                      التخزين
                    </Button>
                  </Stack>
                      ...
                      >
                        ...
                        <CardContent sx={{ flexGrow: 1 }}>
                          ...
                          <Stack direction="row" spacing={1} sx={{ mb: 2 }} flexWrap="wrap">
                            ...
                            {camera.cloudSettings?.uploadEnabled && (
                              <Chip label="☁️ سحابة" size="small" color="info" variant="outlined" />
                            )}
                          </Stack>
                        </CardContent>
                        ...
                        {/* Actions */}
                        <Box
                          sx={{ display: 'flex', gap: 1, p: 1.5, borderTop: '1px solid #e0e0e0' }}
                        >
