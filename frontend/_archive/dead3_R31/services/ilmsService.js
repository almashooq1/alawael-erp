...
export const recommendationsService = {
  ...
  acceptRecommendation: async recommendationId => {
    try {
      const response = await apiClient.post(`/recommendations/${recommendationId}/accept`);
      return {
        success: true,
        data: response.data,
  ...
  dismissRecommendation: async recommendationId => {
    try {
      const response = await apiClient.post(`/recommendations/${recommendationId}/dismiss`);
      return {
        success: true,
        data: response.data,
...
export const progressService = {
  ...
  updateProgress: async (enrollmentId, progressData) => {
    try {
      const response = await apiClient.put(`/enrollments/${enrollmentId}/progress`, progressData);
      return {
        success: true,
        data: response.data,
...
export const profileService = {
  ...
  uploadAvatar: async (userId, avatarFile) => {
    try {
      ...
      const response = await apiClient.post(`/users/${userId}/profile/avatar`, formData, {
