...
import { Calendar, Users, DollarSign, AlertCircle, CheckCircle } from 'lucide-react';
...
const HRDashboard = () => {
  ...
  const [departmentStats, _setDepartmentStats] = useState([
  ...
  const [attendanceData, _setAttendanceData] = useState([
  ...
  const [recentLeaveRequests, _setRecentLeaveRequests] = useState([
    {
      id: 1,
