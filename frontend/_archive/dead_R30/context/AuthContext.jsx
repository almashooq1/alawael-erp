...
import { getToken, setToken as saveToken, removeToken, getRefreshToken, setRefreshToken, removeRefreshToken, getUserData, setUserData, removeUserData } from '../utils/tokenStorage';
...
export const AuthProvider = ({ children }) => {
  ...
  const forgotPassword = useCallback(async (_identifier, _method) => {
    setLoading(true);
    setError(null);
  ...
  const resetPassword = useCallback(async (_token, _newPassword) => {
    setLoading(true);
    setError(null);
