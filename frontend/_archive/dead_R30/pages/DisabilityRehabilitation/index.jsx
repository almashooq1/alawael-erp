...
const DisabilityRehabilitation = () => {
  ...
  const handleCreateSuccess = (_program) => {
    setActiveTab('dashboard');
  };

  const _handleViewProgram = (programId) => {
  ...
  return (
    <div className="api-documentation">
      ...
      <div className="api-intro mb-5">
        ...
        <ul>
          <li><strong>Base URL:</strong> <code>http://localhost:5000/api/v1/disability-rehabilitation</code></li>
          <li><strong>Authentication:</strong> Bearer Token في Header</li>
