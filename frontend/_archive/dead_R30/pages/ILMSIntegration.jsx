...
import {
  Container, Row, Col, Navbar, Nav, Badge, Dropdown, DropdownButton, Spinner
...
const NavigationBar = ({ user, _token, unreadNotifications, logout = () => {} }) => {
              ...
              <div className="card h-100">
                <div className="card-body">
                  ...
                  <p className="card-text">
                    دورات مخصصة تتكيف مع سرعة تعلمك واحتياجاتك
                  </p>
                </div>
              </div>
            </Col>
            ...
            <Col md={6} className="mb-3">
              <div className="card h-100">
                <div className="card-body">
                  ...
                  <p className="card-text">
                    تتبع تقدمك بتفاصيل شاملة ورؤى قيمة
                  </p>
                </div>
              </div>
            </Col>
            ...
            <Col md={6} className="mb-3">
              <div className="card h-100">
                <div className="card-body">
                  ...
                  <p className="card-text">
                    احصل على توصيات شخصية تحسن تعلمك
                  </p>
                </div>
              </div>
            </Col>
            ...
            <Col md={6} className="mb-3">
              <div className="card h-100">
                <div className="card-body">
                  ...
                  <p className="card-text">
                    محتوى يتناسب مع أسلوب تعلمك الفريد
                  </p>
                </div>
              </div>
            </Col>
