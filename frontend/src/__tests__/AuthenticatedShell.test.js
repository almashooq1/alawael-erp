/**
 * Auto-generated tests for AuthenticatedShell.js
 * Type: module | 409L | React | .js
 * @generated P#107 frontend universal generator (fs-based)
 */
const fs = require('fs');
const path = require('path');

const SRC = path.resolve(__dirname, '../AuthenticatedShell.js');

describe('AuthenticatedShell.js', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (AuthenticatedShell)', () => {
    ...
    expect(source).toMatch(/AuthenticatedShell/);
  });
