/**
 * Auto-generated tests for components/CompensationStructureManagement/useCompensation.js
 * Type: component | 180L | React | .js
 * @generated P#107 frontend universal generator (fs-based)
 */
const fs = require('fs');
const path = require('path');

const SRC = path.resolve(__dirname, '../components/CompensationStructureManagement/useCompensation.js');

describe('components/CompensationStructureManagement/useCompensation.js', () => {
  let source;
  beforeAll(() => {
  ...
  test('file structure', () => {
    // Type: component | Lines: 180 | React: true | Ext: .js
    expect(source.split('\n').length).toBe(180);
  });
});
