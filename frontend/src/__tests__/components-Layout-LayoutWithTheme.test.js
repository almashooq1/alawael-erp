/**
 * Auto-generated tests for components/Layout/LayoutWithTheme.jsx
 * Type: component | 125L | React | .jsx
 * @generated P#107 frontend universal generator (fs-based)
 */
const fs = require('fs');
const path = require('path');

const SRC = path.resolve(__dirname, '../components/Layout/LayoutWithTheme.jsx');

describe('components/Layout/LayoutWithTheme.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('uses React hooks (useState, useTheme, useLocation)', () => {
  ...
  test('has default export (LayoutWithTheme)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/LayoutWithTheme/);
  });
  ...
  test('file structure', () => {
    // Type: component | Lines: 125 | React: true | Ext: .jsx
    expect(source.split('\n').length).toBe(125);
  });
});
