/**
 * Auto-generated tests for components/Layout/ProLayout.jsx
...
const SRC = path.resolve(__dirname, '../components/Layout/ProLayout.jsx');

describe('components/Layout/ProLayout.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('uses React hooks (useState, useEffect, useLocation, useTheme, useMediaQuery)', () => {
  ...
  test('has default export (ProLayout)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/ProLayout/);
  });
