/**
 * Auto-generated tests for components/PayrollAnalyticsDashboard.jsx
...
const SRC = path.resolve(__dirname, '../components/PayrollAnalyticsDashboard.jsx');

describe('components/PayrollAnalyticsDashboard.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (PayrollAnalyticsDashboard)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/PayrollAnalyticsDashboard/);
  });
