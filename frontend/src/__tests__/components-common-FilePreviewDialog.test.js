/**
 * Auto-generated tests for components/common/FilePreviewDialog.js
 * Type: component | 446L | React | .js
 * @generated P#107 frontend universal generator (fs-based)
 */
const fs = require('fs');
const path = require('path');

const SRC = path.resolve(__dirname, '../components/common/FilePreviewDialog.js');

describe('components/common/FilePreviewDialog.js', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (FilePreviewDialog)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/FilePreviewDialog/);
  });
  ...
  test('file structure', () => {
    // Type: component | Lines: 446 | React: true | Ext: .js
    expect(source.split('\n').length).toBe(446);
  });
});
