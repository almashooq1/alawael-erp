/**
 * Auto-generated tests for components/common/LoadingSpinner.jsx
 * Type: component | 25L | React | .jsx
 * @generated P#107 frontend universal generator (fs-based)
 */
const fs = require('fs');
const path = require('path');

const SRC = path.resolve(__dirname, '../components/common/LoadingSpinner.jsx');

describe('components/common/LoadingSpinner.jsx', () => {
  let source;
  beforeAll(() => {
