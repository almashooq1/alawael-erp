/**
 * Auto-generated tests for components/dashboard/AdvancedDashboard/DashboardGlobalStyles.jsx
...
describe('components/dashboard/AdvancedDashboard/DashboardGlobalStyles.jsx', () => {
  ...
  test('has default export (DashboardGlobalStyles)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/DashboardGlobalStyles/);
  });
