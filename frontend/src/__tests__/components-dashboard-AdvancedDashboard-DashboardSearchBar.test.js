/**
 * Auto-generated tests for components/dashboard/AdvancedDashboard/DashboardSearchBar.jsx
...
const SRC = path.resolve(__dirname, '../components/dashboard/AdvancedDashboard/DashboardSearchBar.jsx');

describe('components/dashboard/AdvancedDashboard/DashboardSearchBar.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (DashboardSearchBar)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/DashboardSearchBar/);
  });
