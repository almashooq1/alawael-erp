/**
 * Auto-generated tests for components/dashboard/AdvancedDashboard/DashboardSections.jsx
 * Type: component | 194L | React | .jsx
...
describe('components/dashboard/AdvancedDashboard/DashboardSections.jsx', () => {
  ...
  test('has default export (DashboardSections)', () => {
    ...
    expect(source).toMatch(/DashboardSections/);
  });
