/**
 * Auto-generated tests for components/dashboard/DashboardFooter.jsx
...
const SRC = path.resolve(__dirname, '../components/dashboard/DashboardFooter.jsx');

describe('components/dashboard/DashboardFooter.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (DashboardFooter)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/DashboardFooter/);
  });
