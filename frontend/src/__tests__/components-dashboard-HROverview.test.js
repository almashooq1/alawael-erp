/**
 * Auto-generated tests for components/dashboard/HROverview.jsx
...
const SRC = path.resolve(__dirname, '../components/dashboard/HROverview.jsx');

describe('components/dashboard/HROverview.jsx', () => {
  let source;
  beforeAll(() => {
