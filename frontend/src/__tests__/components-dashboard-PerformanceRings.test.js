/**
 * Auto-generated tests for components/dashboard/PerformanceRings.jsx
...
const SRC = path.resolve(__dirname, '../components/dashboard/PerformanceRings.jsx');

describe('components/dashboard/PerformanceRings.jsx', () => {
  let source;
  beforeAll(() => {
