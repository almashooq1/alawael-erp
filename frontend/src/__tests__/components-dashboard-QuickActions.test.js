/**
 * Auto-generated tests for components/dashboard/QuickActions.jsx
...
const SRC = path.resolve(__dirname, '../components/dashboard/QuickActions.jsx');

describe('components/dashboard/QuickActions.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('uses React hooks (useTheme, useNavigate)', () => {
