/**
 * Auto-generated tests for components/dashboard/SmartInsightsPanel.jsx
...
const SRC = path.resolve(__dirname, '../components/dashboard/SmartInsightsPanel.jsx');

describe('components/dashboard/SmartInsightsPanel.jsx', () => {
  let source;
  beforeAll(() => {
