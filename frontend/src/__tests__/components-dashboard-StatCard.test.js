/**
 * Auto-generated tests for components/dashboard/StatCard.jsx
...
const SRC = path.resolve(__dirname, '../components/dashboard/StatCard.jsx');

describe('components/dashboard/StatCard.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('uses React hooks (useEffect, useRef, useState, useTheme, useNavigate)', () => {
