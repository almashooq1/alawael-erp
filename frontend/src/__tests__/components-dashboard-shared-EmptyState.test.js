/**
 * Auto-generated tests for components/dashboard/shared/EmptyState.jsx
...
const SRC = path.resolve(__dirname, '../components/dashboard/shared/EmptyState.jsx');

describe('components/dashboard/shared/EmptyState.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (EmptyState)', () => {
