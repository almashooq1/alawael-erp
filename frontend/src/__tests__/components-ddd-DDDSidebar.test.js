/**
 * Auto-generated tests for components/ddd/DDDSidebar.jsx
...
const SRC = path.resolve(__dirname, '../components/ddd/DDDSidebar.jsx');

describe('components/ddd/DDDSidebar.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('uses React hooks (useState, useNavigate, useLocation, useMediaQuery, useTheme)', () => {
  ...
  test('has default export (DDDSidebar)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/DDDSidebar/);
  });
