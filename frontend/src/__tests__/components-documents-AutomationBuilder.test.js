/**
 * Auto-generated tests for components/documents/AutomationBuilder.jsx
 * Type: component | 505L | React | .jsx
 * @generated P#107 frontend universal generator (fs-based)
 */
const fs = require('fs');
const path = require('path');

const SRC = path.resolve(__dirname, '../components/documents/AutomationBuilder.jsx');

describe('components/documents/AutomationBuilder.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (AutomationBuilder)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/AutomationBuilder/);
  });
  ...
  test('file structure', () => {
    // Type: component | Lines: 505 | React: true | Ext: .jsx
    expect(source.split('\n').length).toBe(505);
  });
});
