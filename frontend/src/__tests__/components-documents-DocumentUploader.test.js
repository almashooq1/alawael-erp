/**
 * Auto-generated tests for components/documents/DocumentUploader.js
...
const SRC = path.resolve(__dirname, '../components/documents/DocumentUploader.js');

describe('components/documents/DocumentUploader.js', () => {
  let source;
  beforeAll(() => {
  ...
  test('uses React hooks (useState, useRef)', () => {
  ...
  test('has default export (DocumentUploader)', () => {
