/**
 * Auto-generated tests for components/documents/ReportBuilder.jsx
 * Type: component | 423L | React | .jsx
 * @generated P#107 frontend universal generator (fs-based)
 */
const fs = require('fs');
const path = require('path');

const SRC = path.resolve(__dirname, '../components/documents/ReportBuilder.jsx');

describe('components/documents/ReportBuilder.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (ReportBuilder)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/ReportBuilder/);
  });
  ...
  test('file structure', () => {
    // Type: component | Lines: 423 | React: true | Ext: .jsx
    expect(source.split('\n').length).toBe(423);
  });
});
