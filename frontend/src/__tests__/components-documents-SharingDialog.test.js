/**
 * Auto-generated tests for components/documents/SharingDialog.jsx
 * Type: component | 453L | React | .jsx
 * @generated P#107 frontend universal generator (fs-based)
 */
const fs = require('fs');
const path = require('path');

const SRC = path.resolve(__dirname, '../components/documents/SharingDialog.jsx');

describe('components/documents/SharingDialog.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (SharingDialog)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/SharingDialog/);
  });
  ...
  test('file structure', () => {
    // Type: component | Lines: 453 | React: true | Ext: .jsx
    expect(source.split('\n').length).toBe(453);
  });
});
