/**
 * Auto-generated tests for components/hooks/useDocumentSelection.js
 * Type: component | 64L | React | .js
 * @generated P#107 frontend universal generator (fs-based)
 */
const fs = require('fs');
const path = require('path');

const SRC = path.resolve(__dirname, '../components/hooks/useDocumentSelection.js');

describe('components/hooks/useDocumentSelection.js', () => {
  let source;
  beforeAll(() => {
  ...
  test('exports useDocumentSelection', () => {
    expect(source).toMatch(/useDocumentSelection/);
  });
