/**
 * Auto-generated tests for components/shared/ExportMenu.jsx
 * Type: component | 96L | React | .jsx
 * @generated P#107 frontend universal generator (fs-based)
 */
const fs = require('fs');
const path = require('path');

const SRC = path.resolve(__dirname, '../components/shared/ExportMenu.jsx');

describe('components/shared/ExportMenu.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (ExportMenu)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/ExportMenu/);
  });
  ...
  test('file structure', () => {
    // Type: component | Lines: 96 | React: true | Ext: .jsx
    expect(source.split('\n').length).toBe(96);
  });
});
