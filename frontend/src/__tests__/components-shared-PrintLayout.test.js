/**
 * Auto-generated tests for components/shared/PrintLayout.jsx
...
const SRC = path.resolve(__dirname, '../components/shared/PrintLayout.jsx');

describe('components/shared/PrintLayout.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (PrintLayout)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/PrintLayout/);
  });
