/**
 * Auto-generated tests for contexts/NotificationContext.js
 * Type: context | 246L | React | .js
 * @generated P#107 frontend universal generator (fs-based)
 */
const fs = require('fs');
const path = require('path');

const SRC = path.resolve(__dirname, '../contexts/NotificationContext.js');

describe('contexts/NotificationContext.js', () => {
  let source;
  beforeAll(() => {
  ...
  test('exports NotificationProvider', () => {
    expect(source).toMatch(/NotificationProvider/);
  });
