/**
 * Auto-generated tests for pages/Admin/AdminDecisions.js
...
const SRC = path.resolve(__dirname, '../pages/Admin/AdminDecisions.js');

describe('pages/Admin/AdminDecisions.js', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (AdminDecisions)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/AdminDecisions/);
  });
