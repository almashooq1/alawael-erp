/**
 * Auto-generated tests for pages/Admin/Administration.js
 * Type: page | 428L | React | .js
 * @generated P#107 frontend universal generator (fs-based)
 */
const fs = require('fs');
const path = require('path');

const SRC = path.resolve(__dirname, '../pages/Admin/Administration.js');

describe('pages/Admin/Administration.js', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (Administration)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/Administration/);
  });
  ...
  test('file structure', () => {
    // Type: page | Lines: 428 | React: true | Ext: .js
    expect(source.split('\n').length).toBe(428);
  });
});
