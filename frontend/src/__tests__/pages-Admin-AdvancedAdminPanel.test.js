/**
 * Auto-generated tests for pages/Admin/AdvancedAdminPanel.js
...
const SRC = path.resolve(__dirname, '../pages/Admin/AdvancedAdminPanel.js');

describe('pages/Admin/AdvancedAdminPanel.js', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (AdminPanel)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/AdminPanel/);
  });
