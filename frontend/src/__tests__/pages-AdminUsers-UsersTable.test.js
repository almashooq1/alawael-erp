/**
 * Auto-generated tests for pages/AdminUsers/UsersTable.jsx
...
const SRC = path.resolve(__dirname, '../pages/AdminUsers/UsersTable.jsx');

describe('pages/AdminUsers/UsersTable.jsx', () => {
  let source;
  beforeAll(() => {
