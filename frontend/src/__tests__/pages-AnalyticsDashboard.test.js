/**
 * Auto-generated tests for pages/AnalyticsDashboard.jsx
...
const SRC = path.resolve(__dirname, '../pages/AnalyticsDashboard.jsx');

describe('pages/AnalyticsDashboard.jsx', () => {
  let source;
  beforeAll(() => {
