/**
 * Auto-generated tests for pages/Assets/AssetDashboard.jsx
...
const SRC = path.resolve(__dirname, '../pages/Assets/AssetDashboard.jsx');

describe('pages/Assets/AssetDashboard.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (AssetDashboard)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/AssetDashboard/);
  });
