/**
 * Auto-generated tests for pages/Assets/AssetsList.jsx
...
const SRC = path.resolve(__dirname, '../pages/Assets/AssetsList.jsx');

describe('pages/Assets/AssetsList.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (AssetsList)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/AssetsList/);
  });
