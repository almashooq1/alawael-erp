/**
 * Auto-generated tests for pages/AttendanceReports/AIPredictionDialog.jsx
...
const SRC = path.resolve(__dirname, '../pages/AttendanceReports/AIPredictionDialog.jsx');

describe('pages/AttendanceReports/AIPredictionDialog.jsx', () => {
  let source;
  beforeAll(() => {
