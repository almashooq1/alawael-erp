/**
 * Auto-generated tests for pages/BIDashboard/BITrendExplorer.jsx
...
const SRC = path.resolve(__dirname, '../pages/BIDashboard/BITrendExplorer.jsx');

describe('pages/BIDashboard/BITrendExplorer.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (BITrendExplorer)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/BITrendExplorer/);
  });
