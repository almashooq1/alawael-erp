/**
 * Auto-generated tests for pages/Beneficiaries/BeneficiariesTableBody.jsx
 * Type: page | 233L | React | .jsx
 * @generated P#107 frontend universal generator (fs-based)
 */
const fs = require('fs');
const path = require('path');

const SRC = path.resolve(__dirname, '../pages/Beneficiaries/BeneficiariesTableBody.jsx');

describe('pages/Beneficiaries/BeneficiariesTableBody.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (BeneficiariesTableBody)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/BeneficiariesTableBody/);
  });
  ...
  test('file structure', () => {
    // Type: page | Lines: 233 | React: true | Ext: .jsx
    expect(source.split('\n').length).toBe(233);
  });
});
