/**
 * Auto-generated tests for pages/Beneficiaries/BeneficiariesToolbar.jsx
...
const SRC = path.resolve(__dirname, '../pages/Beneficiaries/BeneficiariesToolbar.jsx');

describe('pages/Beneficiaries/BeneficiariesToolbar.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (BeneficiariesToolbar)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/BeneficiariesToolbar/);
  });
