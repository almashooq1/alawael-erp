/**
 * Auto-generated tests for pages/BloodBankProDashboard.jsx
...
const SRC = path.resolve(__dirname, '../pages/BloodBankProDashboard.jsx');

describe('pages/BloodBankProDashboard.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (BloodBankProDashboard)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/BloodBankProDashboard/);
  });
