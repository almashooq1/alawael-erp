/**
 * Auto-generated tests for pages/ClinicalTrialsProDashboard.jsx
...
const SRC = path.resolve(__dirname, '../pages/ClinicalTrialsProDashboard.jsx');

describe('pages/ClinicalTrialsProDashboard.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (ClinicalTrialsProDashboard)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/ClinicalTrialsProDashboard/);
  });
