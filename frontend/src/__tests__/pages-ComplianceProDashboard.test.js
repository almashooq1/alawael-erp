/**
 * Auto-generated tests for pages/ComplianceProDashboard.jsx
...
const SRC = path.resolve(__dirname, '../pages/ComplianceProDashboard.jsx');

describe('pages/ComplianceProDashboard.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (ComplianceProDashboard)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/ComplianceProDashboard/);
  });
