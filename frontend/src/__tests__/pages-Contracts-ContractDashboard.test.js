/**
 * Auto-generated tests for pages/Contracts/ContractDashboard.jsx
...
const SRC = path.resolve(__dirname, '../pages/Contracts/ContractDashboard.jsx');

describe('pages/Contracts/ContractDashboard.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (ContractDashboard)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/ContractDashboard/);
  });
