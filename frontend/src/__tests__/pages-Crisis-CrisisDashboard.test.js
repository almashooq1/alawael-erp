/**
 * Auto-generated tests for pages/Crisis/CrisisDashboard.jsx
...
const SRC = path.resolve(__dirname, '../pages/Crisis/CrisisDashboard.jsx');

describe('pages/Crisis/CrisisDashboard.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (CrisisDashboard)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/CrisisDashboard/);
  });
