/**
 * Auto-generated tests for pages/DisabilityAssessmentScales/AnalyticsTab.jsx
...
const SRC = path.resolve(__dirname, '../pages/DisabilityAssessmentScales/AnalyticsTab.jsx');

describe('pages/DisabilityAssessmentScales/AnalyticsTab.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (AnalyticsTab)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/AnalyticsTab/);
  });
