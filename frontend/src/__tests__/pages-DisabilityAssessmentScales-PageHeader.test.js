/**
 * Auto-generated tests for pages/DisabilityAssessmentScales/PageHeader.jsx
...
const SRC = path.resolve(__dirname, '../pages/DisabilityAssessmentScales/PageHeader.jsx');

describe('pages/DisabilityAssessmentScales/PageHeader.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('uses React hooks (useFlexGap)', () => {
  ...
  test('has default export (PageHeader)', () => {
