/**
 * Auto-generated tests for pages/DisabilityAssessmentScales/RecommendedScalesDialog.jsx
...
describe('pages/DisabilityAssessmentScales/RecommendedScalesDialog.jsx', () => {
  ...
  test('has default export (RecommendedScalesDialog)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/RecommendedScalesDialog/);
  });
