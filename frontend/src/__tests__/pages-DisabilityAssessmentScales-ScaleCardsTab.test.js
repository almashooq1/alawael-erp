/**
 * Auto-generated tests for pages/DisabilityAssessmentScales/ScaleCardsTab.jsx
...
const SRC = path.resolve(__dirname, '../pages/DisabilityAssessmentScales/ScaleCardsTab.jsx');

describe('pages/DisabilityAssessmentScales/ScaleCardsTab.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (ScaleCardsTab)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/ScaleCardsTab/);
  });
