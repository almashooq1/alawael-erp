/**
 * Auto-generated tests for pages/DocumentsMgmt/DocumentsListTab.jsx
...
const SRC = path.resolve(__dirname, '../pages/DocumentsMgmt/DocumentsListTab.jsx');

describe('pages/DocumentsMgmt/DocumentsListTab.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (DocumentsListTab)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/DocumentsListTab/);
  });
