/**
 * Auto-generated tests for pages/EducationRehab/index.js
...
const SRC = path.resolve(__dirname, '../pages/EducationRehab/index.js');

describe('pages/EducationRehab/index.js', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (EducationRehab)', () => {
    ...
    expect(source).toMatch(/EducationRehab/);
  });
