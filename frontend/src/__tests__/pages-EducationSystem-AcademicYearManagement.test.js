/**
 * Auto-generated tests for pages/EducationSystem/AcademicYearManagement.js
...
const SRC = path.resolve(__dirname, '../pages/EducationSystem/AcademicYearManagement.js');

describe('pages/EducationSystem/AcademicYearManagement.js', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (AcademicYearManagement)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/AcademicYearManagement/);
  });
