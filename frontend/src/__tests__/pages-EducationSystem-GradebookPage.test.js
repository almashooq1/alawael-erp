/**
 * Auto-generated tests for pages/EducationSystem/GradebookPage.js
...
const SRC = path.resolve(__dirname, '../pages/EducationSystem/GradebookPage.js');

describe('pages/EducationSystem/GradebookPage.js', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (GradebookPage)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/GradebookPage/);
  });
