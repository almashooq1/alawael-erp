/**
 * Auto-generated tests for pages/EducationSystem/SubjectManagement.js
...
const SRC = path.resolve(__dirname, '../pages/EducationSystem/SubjectManagement.js');

describe('pages/EducationSystem/SubjectManagement.js', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (SubjectManagement)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/SubjectManagement/);
  });
