/**
 * Auto-generated tests for pages/EducationSystem/TimetableBuilder.js
...
const SRC = path.resolve(__dirname, '../pages/EducationSystem/TimetableBuilder.js');

describe('pages/EducationSystem/TimetableBuilder.js', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (TimetableBuilder)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/TimetableBuilder/);
  });
