/**
 * Auto-generated tests for pages/Employee/EmployeeTable.jsx
...
const SRC = path.resolve(__dirname, '../pages/Employee/EmployeeTable.jsx');

describe('pages/Employee/EmployeeTable.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (EmployeeTable)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/EmployeeTable/);
  });
