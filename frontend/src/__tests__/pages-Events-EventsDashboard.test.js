/**
 * Auto-generated tests for pages/Events/EventsDashboard.jsx
...
const SRC = path.resolve(__dirname, '../pages/Events/EventsDashboard.jsx');

describe('pages/Events/EventsDashboard.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (EventsDashboard)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/EventsDashboard/);
  });
