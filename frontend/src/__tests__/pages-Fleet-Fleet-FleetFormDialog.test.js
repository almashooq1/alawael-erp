/**
 * Auto-generated tests for pages/Fleet/Fleet/FleetFormDialog.jsx
 * Type: page | 173L | React | .jsx
 * @generated P#107 frontend universal generator (fs-based)
 */
const fs = require('fs');
const path = require('path');

const SRC = path.resolve(__dirname, '../pages/Fleet/Fleet/FleetFormDialog.jsx');

describe('pages/Fleet/Fleet/FleetFormDialog.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (FleetFormDialog)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/FleetFormDialog/);
  });
  ...
  test('file structure', () => {
    // Type: page | Lines: 173 | React: true | Ext: .jsx
    expect(source.split('\n').length).toBe(173);
  });
});
