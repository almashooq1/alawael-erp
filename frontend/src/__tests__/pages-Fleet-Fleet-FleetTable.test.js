/**
 * Auto-generated tests for pages/Fleet/Fleet/FleetTable.jsx
...
const SRC = path.resolve(__dirname, '../pages/Fleet/Fleet/FleetTable.jsx');

describe('pages/Fleet/Fleet/FleetTable.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (FleetTable)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/FleetTable/);
  });
