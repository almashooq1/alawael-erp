/**
 * Auto-generated tests for pages/Fleet/Fleet/useFleetManagement.js
 * Type: page | 246L | React | .js
 * @generated P#107 frontend universal generator (fs-based)
 */
const fs = require('fs');
const path = require('path');

const SRC = path.resolve(__dirname, '../pages/Fleet/Fleet/useFleetManagement.js');

describe('pages/Fleet/Fleet/useFleetManagement.js', () => {
  let source;
  beforeAll(() => {
