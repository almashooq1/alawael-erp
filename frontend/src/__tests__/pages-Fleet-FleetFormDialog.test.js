/**
 * Auto-generated tests for pages/Fleet/FleetFormDialog.jsx
...
const SRC = path.resolve(__dirname, '../pages/Fleet/FleetFormDialog.jsx');

describe('pages/Fleet/FleetFormDialog.jsx', () => {
  let source;
  beforeAll(() => {
