/**
 * Auto-generated tests for pages/HRAdvancedDashboard/ChartsRow.jsx
...
const SRC = path.resolve(__dirname, '../pages/HRAdvancedDashboard/ChartsRow.jsx');

describe('pages/HRAdvancedDashboard/ChartsRow.jsx', () => {
  let source;
  beforeAll(() => {
