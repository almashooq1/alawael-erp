/**
 * Auto-generated tests for pages/HRAdvancedDashboard/KPICard.jsx
...
const SRC = path.resolve(__dirname, '../pages/HRAdvancedDashboard/KPICard.jsx');

describe('pages/HRAdvancedDashboard/KPICard.jsx', () => {
  let source;
  beforeAll(() => {
