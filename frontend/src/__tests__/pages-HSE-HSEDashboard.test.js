/**
 * Auto-generated tests for pages/HSE/HSEDashboard.jsx
...
const SRC = path.resolve(__dirname, '../pages/HSE/HSEDashboard.jsx');

describe('pages/HSE/HSEDashboard.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (HSEDashboard)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/HSEDashboard/);
  });
