/**
 * Auto-generated tests for pages/HSE/IncidentsList.jsx
...
const SRC = path.resolve(__dirname, '../pages/HSE/IncidentsList.jsx');

describe('pages/HSE/IncidentsList.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (IncidentsList)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/IncidentsList/);
  });
