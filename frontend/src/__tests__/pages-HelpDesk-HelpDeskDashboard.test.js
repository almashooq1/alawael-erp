/**
 * Auto-generated tests for pages/HelpDesk/HelpDeskDashboard.jsx
...
const SRC = path.resolve(__dirname, '../pages/HelpDesk/HelpDeskDashboard.jsx');

describe('pages/HelpDesk/HelpDeskDashboard.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (HelpDeskDashboard)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/HelpDeskDashboard/);
  });
