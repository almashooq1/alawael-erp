/**
 * Auto-generated tests for pages/HelpDesk/TicketsList.jsx
...
const SRC = path.resolve(__dirname, '../pages/HelpDesk/TicketsList.jsx');

describe('pages/HelpDesk/TicketsList.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (TicketsList)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/TicketsList/);
  });
