/**
 * Auto-generated tests for pages/IntegratedCare/CreateCarePlan.js
 * Type: page | 366L | React | .js
 * @generated P#107 frontend universal generator (fs-based)
 */
const fs = require('fs');
const path = require('path');

const SRC = path.resolve(__dirname, '../pages/IntegratedCare/CreateCarePlan.js');

describe('pages/IntegratedCare/CreateCarePlan.js', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (CreateCarePlan)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/CreateCarePlan/);
  });
  ...
  test('file structure', () => {
    // Type: page | Lines: 366 | React: true | Ext: .js
    expect(source.split('\n').length).toBe(366);
  });
});
