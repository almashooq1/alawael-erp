/**
 * Auto-generated tests for pages/InternalAudit/AuditFindings.jsx
...
const SRC = path.resolve(__dirname, '../pages/InternalAudit/AuditFindings.jsx');

describe('pages/InternalAudit/AuditFindings.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (AuditFindings)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/AuditFindings/);
  });
