/**
 * Auto-generated tests for pages/InventoryDashboard.jsx
...
const SRC = path.resolve(__dirname, '../pages/InventoryDashboard.jsx');

describe('pages/InventoryDashboard.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (InventoryDashboard)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/InventoryDashboard/);
  });
