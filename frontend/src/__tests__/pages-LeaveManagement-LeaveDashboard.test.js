/**
 * Auto-generated tests for pages/LeaveManagement/LeaveDashboard.jsx
...
const SRC = path.resolve(__dirname, '../pages/LeaveManagement/LeaveDashboard.jsx');

describe('pages/LeaveManagement/LeaveDashboard.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (LeaveDashboard)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/LeaveDashboard/);
  });
