/**
 * Auto-generated tests for pages/LeaveManagement/LeaveTable.jsx
...
const SRC = path.resolve(__dirname, '../pages/LeaveManagement/LeaveTable.jsx');

describe('pages/LeaveManagement/LeaveTable.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (LeaveTable)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/LeaveTable/);
  });
