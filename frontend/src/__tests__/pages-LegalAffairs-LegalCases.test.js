/**
 * Auto-generated tests for pages/LegalAffairs/LegalCases.jsx
...
const SRC = path.resolve(__dirname, '../pages/LegalAffairs/LegalCases.jsx');

describe('pages/LegalAffairs/LegalCases.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (LegalCases)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/LegalCases/);
  });
