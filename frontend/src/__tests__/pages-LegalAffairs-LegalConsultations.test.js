/**
 * Auto-generated tests for pages/LegalAffairs/LegalConsultations.jsx
 * Type: page | 108L | React | .jsx
 * @generated P#107 frontend universal generator (fs-based)
 */
const fs = require('fs');
const path = require('path');

const SRC = path.resolve(__dirname, '../pages/LegalAffairs/LegalConsultations.jsx');

describe('pages/LegalAffairs/LegalConsultations.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (LegalConsultations)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/LegalConsultations/);
  });
