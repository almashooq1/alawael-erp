/**
 * Auto-generated tests for pages/LegalAffairs/LegalDashboard.jsx
...
const SRC = path.resolve(__dirname, '../pages/LegalAffairs/LegalDashboard.jsx');

describe('pages/LegalAffairs/LegalDashboard.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (LegalDashboard)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/LegalDashboard/);
  });
