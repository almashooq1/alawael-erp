/**
 * Auto-generated tests for pages/Messaging/MessagingDashboard.jsx
...
const SRC = path.resolve(__dirname, '../pages/Messaging/MessagingDashboard.jsx');

describe('pages/Messaging/MessagingDashboard.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (MessagingDashboard)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/MessagingDashboard/);
  });
