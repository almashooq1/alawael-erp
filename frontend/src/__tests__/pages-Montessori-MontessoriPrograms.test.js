/**
 * Auto-generated tests for pages/Montessori/MontessoriPrograms.jsx
...
const SRC = path.resolve(__dirname, '../pages/Montessori/MontessoriPrograms.jsx');

describe('pages/Montessori/MontessoriPrograms.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (MontessoriPrograms)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/MontessoriPrograms/);
  });
