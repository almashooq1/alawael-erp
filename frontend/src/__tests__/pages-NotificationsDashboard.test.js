/**
 * Auto-generated tests for pages/NotificationsDashboard.jsx
...
const SRC = path.resolve(__dirname, '../pages/NotificationsDashboard.jsx');

describe('pages/NotificationsDashboard.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (NotificationsDashboard)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/NotificationsDashboard/);
  });
