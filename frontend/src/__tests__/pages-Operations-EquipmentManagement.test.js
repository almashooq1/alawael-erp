/**
 * Auto-generated tests for pages/Operations/EquipmentManagement.js
...
const SRC = path.resolve(__dirname, '../pages/Operations/EquipmentManagement.js');

describe('pages/Operations/EquipmentManagement.js', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (EquipmentManagement)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/EquipmentManagement/);
  });
