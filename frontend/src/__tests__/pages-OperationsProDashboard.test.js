/**
 * Auto-generated tests for pages/OperationsProDashboard.jsx
...
const SRC = path.resolve(__dirname, '../pages/OperationsProDashboard.jsx');

describe('pages/OperationsProDashboard.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (OperationsProDashboard)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/OperationsProDashboard/);
  });
