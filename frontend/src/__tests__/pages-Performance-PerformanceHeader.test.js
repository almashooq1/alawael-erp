/**
 * Auto-generated tests for pages/Performance/PerformanceHeader.jsx
...
const SRC = path.resolve(__dirname, '../pages/Performance/PerformanceHeader.jsx');

describe('pages/Performance/PerformanceHeader.jsx', () => {
  let source;
  beforeAll(() => {
