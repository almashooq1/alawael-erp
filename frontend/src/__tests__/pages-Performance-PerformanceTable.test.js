/**
 * Auto-generated tests for pages/Performance/PerformanceTable.jsx
...
const SRC = path.resolve(__dirname, '../pages/Performance/PerformanceTable.jsx');

describe('pages/Performance/PerformanceTable.jsx', () => {
  let source;
  beforeAll(() => {
