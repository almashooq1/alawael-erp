/**
 * Auto-generated tests for pages/Performance/performanceEvaluation.constants.js
...
const SRC = path.resolve(__dirname, '../pages/Performance/performanceEvaluation.constants.js');

describe('pages/Performance/performanceEvaluation.constants.js', () => {
  let source;
  beforeAll(() => {
