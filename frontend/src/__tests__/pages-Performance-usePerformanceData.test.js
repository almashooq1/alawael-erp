/**
 * Auto-generated tests for pages/Performance/usePerformanceData.js
...
const SRC = path.resolve(__dirname, '../pages/Performance/usePerformanceData.js');

describe('pages/Performance/usePerformanceData.js', () => {
  let source;
  beforeAll(() => {
