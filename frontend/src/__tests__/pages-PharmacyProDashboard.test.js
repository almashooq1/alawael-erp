/**
 * Auto-generated tests for pages/PharmacyProDashboard.jsx
...
const SRC = path.resolve(__dirname, '../pages/PharmacyProDashboard.jsx');

describe('pages/PharmacyProDashboard.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (PharmacyProDashboard)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/PharmacyProDashboard/);
  });
