/**
 * Auto-generated tests for pages/PrintCenter/templates/AdminPrintTemplates.jsx
 * Type: page | 341L | React | .jsx
 * @generated P#107 frontend universal generator (fs-based)
 */
const fs = require('fs');
const path = require('path');

const SRC = path.resolve(__dirname, '../pages/PrintCenter/templates/AdminPrintTemplates.jsx');

describe('pages/PrintCenter/templates/AdminPrintTemplates.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (AdminTemplateRenderer)', () => {
    ...
    expect(source).toMatch(/AdminTemplateRenderer/);
  });

  test('exports ADMIN_TEMPLATES', () => {
    expect(source).toMatch(/ADMIN_TEMPLATES/);
  });

  test('exports AdminTemplateRenderer', () => {
    expect(source).toMatch(/AdminTemplateRenderer/);
  });
