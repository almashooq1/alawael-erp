/**
 * Auto-generated tests for pages/PrintCenter/templates/EcommerceBlockchainPrintTemplates.jsx
 * Type: page | 261L | React | .jsx
...
describe('pages/PrintCenter/templates/EcommerceBlockchainPrintTemplates.jsx', () => {
  ...
  test('exports ECOMMERCE_BLOCKCHAIN_TEMPLATES', () => {
    expect(source).toMatch(/ECOMMERCE_BLOCKCHAIN_TEMPLATES/);
  });

  test('exports EcommerceBlockchainTemplateRenderer', () => {
    expect(source).toMatch(/EcommerceBlockchainTemplateRenderer/);
  });
  ...
  test('file structure', () => {
    // Type: page | Lines: 261 | React: true | Ext: .jsx
    expect(source.split('\n').length).toBe(261);
  });
});
