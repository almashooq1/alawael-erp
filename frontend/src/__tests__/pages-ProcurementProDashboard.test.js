/**
 * Auto-generated tests for pages/ProcurementProDashboard.jsx
...
const SRC = path.resolve(__dirname, '../pages/ProcurementProDashboard.jsx');

describe('pages/ProcurementProDashboard.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (ProcurementProDashboard)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/ProcurementProDashboard/);
  });
