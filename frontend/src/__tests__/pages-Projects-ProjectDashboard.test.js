/**
 * Auto-generated tests for pages/Projects/ProjectDashboard.jsx
...
const SRC = path.resolve(__dirname, '../pages/Projects/ProjectDashboard.jsx');

describe('pages/Projects/ProjectDashboard.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (ProjectDashboard)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/ProjectDashboard/);
  });
