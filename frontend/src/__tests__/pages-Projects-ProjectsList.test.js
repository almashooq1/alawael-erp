/**
 * Auto-generated tests for pages/Projects/ProjectsList.jsx
...
const SRC = path.resolve(__dirname, '../pages/Projects/ProjectsList.jsx');

describe('pages/Projects/ProjectsList.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (ProjectsList)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/ProjectsList/);
  });
