/**
 * Auto-generated tests for pages/PublicRelations/CampaignsList.jsx
...
const SRC = path.resolve(__dirname, '../pages/PublicRelations/CampaignsList.jsx');

describe('pages/PublicRelations/CampaignsList.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (CampaignsList)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/CampaignsList/);
  });
