/**
 * Auto-generated tests for pages/Quality/QualityDashboard.jsx
...
const SRC = path.resolve(__dirname, '../pages/Quality/QualityDashboard.jsx');

describe('pages/Quality/QualityDashboard.jsx', () => {
  let source;
  beforeAll(() => {
