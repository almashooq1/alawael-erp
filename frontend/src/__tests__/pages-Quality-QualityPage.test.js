/**
 * Auto-generated tests for pages/Quality/QualityPage.jsx
...
const SRC = path.resolve(__dirname, '../pages/Quality/QualityPage.jsx');

describe('pages/Quality/QualityPage.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (QualityPage)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/QualityPage/);
  });
