/**
 * Auto-generated tests for pages/QualityCompliance/DataTable.jsx
...
const SRC = path.resolve(__dirname, '../pages/QualityCompliance/DataTable.jsx');

describe('pages/QualityCompliance/DataTable.jsx', () => {
  let source;
  beforeAll(() => {
