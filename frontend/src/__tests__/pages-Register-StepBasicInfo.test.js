/**
 * Auto-generated tests for pages/Register/StepBasicInfo.jsx
 * Type: page | 88L | React | .jsx
 * @generated P#107 frontend universal generator (fs-based)
 */
const fs = require('fs');
const path = require('path');

const SRC = path.resolve(__dirname, '../pages/Register/StepBasicInfo.jsx');

describe('pages/Register/StepBasicInfo.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (StepBasicInfo)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/StepBasicInfo/);
  });
  ...
  test('file structure', () => {
    // Type: page | Lines: 88 | React: true | Ext: .jsx
    expect(source.split('\n').length).toBe(88);
  });
});
