/**
 * Auto-generated tests for pages/Register/StepRoleSelection.jsx
...
const SRC = path.resolve(__dirname, '../pages/Register/StepRoleSelection.jsx');

describe('pages/Register/StepRoleSelection.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (StepRoleSelection)', () => {
    ...
    expect(source).toMatch(/StepRoleSelection/);
  });
