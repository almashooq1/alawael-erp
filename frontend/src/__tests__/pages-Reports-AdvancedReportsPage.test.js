...
describe('pages/Reports/AdvancedReportsPage.jsx', () => {
  ...
  test('uses React hooks (useState, useEffect, useCallback, useRef, useConfirmDialog)', () => {
  ...
  test('has default export (AdvancedReportsPage)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/AdvancedReportsPage/);
  });
