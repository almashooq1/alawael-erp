/**
 * Auto-generated tests for pages/Sessions/SessionFormDialog.jsx
...
const SRC = path.resolve(__dirname, '../pages/Sessions/SessionFormDialog.jsx');

describe('pages/Sessions/SessionFormDialog.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (SessionFormDialog)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/SessionFormDialog/);
  });
