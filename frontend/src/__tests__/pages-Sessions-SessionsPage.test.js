/**
 * Auto-generated tests for pages/Sessions/SessionsPage.jsx
...
const SRC = path.resolve(__dirname, '../pages/Sessions/SessionsPage.jsx');

describe('pages/Sessions/SessionsPage.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (SessionsPage)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/SessionsPage/);
  });
