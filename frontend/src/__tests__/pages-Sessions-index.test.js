/**
 * Auto-generated tests for pages/Sessions/index.jsx
...
const SRC = path.resolve(__dirname, '../pages/Sessions/index.jsx');

describe('pages/Sessions/index.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('uses React hooks (useSessionsManagement)', () => {
  ...
  test('has default export (SessionsManagement)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/SessionsManagement/);
  });
