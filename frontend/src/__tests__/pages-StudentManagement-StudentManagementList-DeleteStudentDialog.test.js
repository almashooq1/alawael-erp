/**
 * Auto-generated tests for pages/StudentManagement/StudentManagementList/DeleteStudentDialog.jsx
 * Type: page | 34L | React | .jsx
...
describe('pages/StudentManagement/StudentManagementList/DeleteStudentDialog.jsx', () => {
  ...
  test('has default export (DeleteStudentDialog)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/DeleteStudentDialog/);
  });
  ...
  test('file structure', () => {
    // Type: page | Lines: 34 | React: true | Ext: .jsx
    expect(source.split('\n').length).toBe(34);
  });
});
