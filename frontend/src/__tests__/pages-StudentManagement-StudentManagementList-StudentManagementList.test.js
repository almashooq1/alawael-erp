/**
 * Auto-generated tests for pages/StudentManagement/StudentManagementList/StudentManagementList.jsx
 * Type: page | 143L | React | .jsx
...
describe('pages/StudentManagement/StudentManagementList/StudentManagementList.jsx', () => {
  ...
  test('uses React hooks (useStudentList)', () => {
  ...
  test('has default export (StudentManagementList)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/StudentManagementList/);
  });
  ...
  test('file structure', () => {
    // Type: page | Lines: 143 | React: true | Ext: .jsx
    expect(source.split('\n').length).toBe(143);
  });
});
