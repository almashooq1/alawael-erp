/**
 * Auto-generated tests for pages/StudentRegistration/steps/DisabilityStep.jsx
...
const SRC = path.resolve(__dirname, '../pages/StudentRegistration/steps/DisabilityStep.jsx');

describe('pages/StudentRegistration/steps/DisabilityStep.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (DisabilityStep)', () => {
    ...
    expect(source).toMatch(/DisabilityStep/);
  });
