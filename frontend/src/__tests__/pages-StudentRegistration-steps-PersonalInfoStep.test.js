/**
 * Auto-generated tests for pages/StudentRegistration/steps/PersonalInfoStep.jsx
 * Type: page | 112L | React | .jsx
 * @generated P#107 frontend universal generator (fs-based)
 */
const fs = require('fs');
const path = require('path');

const SRC = path.resolve(__dirname, '../pages/StudentRegistration/steps/PersonalInfoStep.jsx');

describe('pages/StudentRegistration/steps/PersonalInfoStep.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (PersonalInfoStep)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/PersonalInfoStep/);
  });
  ...
  test('file structure', () => {
    // Type: page | Lines: 112 | React: true | Ext: .jsx
    expect(source.split('\n').length).toBe(112);
  });
});
