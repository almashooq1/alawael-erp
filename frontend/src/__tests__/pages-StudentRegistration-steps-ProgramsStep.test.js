/**
 * Auto-generated tests for pages/StudentRegistration/steps/ProgramsStep.jsx
 * Type: page | 98L | React | .jsx
 * @generated P#107 frontend universal generator (fs-based)
 */
const fs = require('fs');
const path = require('path');

const SRC = path.resolve(__dirname, '../pages/StudentRegistration/steps/ProgramsStep.jsx');

describe('pages/StudentRegistration/steps/ProgramsStep.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (ProgramsStep)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/ProgramsStep/);
  });
  ...
  test('file structure', () => {
    // Type: page | Lines: 98 | React: true | Ext: .jsx
    expect(source.split('\n').length).toBe(98);
  });
});
