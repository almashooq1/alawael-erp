/**
 * Auto-generated tests for pages/SystemAdmin/SystemAdminTable.jsx
...
const SRC = path.resolve(__dirname, '../pages/SystemAdmin/SystemAdminTable.jsx');

describe('pages/SystemAdmin/SystemAdminTable.jsx', () => {
  let source;
  beforeAll(() => {
