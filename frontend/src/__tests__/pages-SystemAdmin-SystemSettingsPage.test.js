/**
 * Auto-generated tests for pages/SystemAdmin/SystemSettingsPage.jsx
...
const SRC = path.resolve(__dirname, '../pages/SystemAdmin/SystemSettingsPage.jsx');

describe('pages/SystemAdmin/SystemSettingsPage.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (SystemSettingsPage)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/SystemSettingsPage/);
  });
