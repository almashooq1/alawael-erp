/**
 * Auto-generated tests for pages/TelemedicineProDashboard.jsx
...
const SRC = path.resolve(__dirname, '../pages/TelemedicineProDashboard.jsx');

describe('pages/TelemedicineProDashboard.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (TelemedicineProDashboard)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/TelemedicineProDashboard/);
  });
