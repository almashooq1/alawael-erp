/**
 * Auto-generated tests for pages/Training/TrainingPlans.jsx
...
const SRC = path.resolve(__dirname, '../pages/Training/TrainingPlans.jsx');

describe('pages/Training/TrainingPlans.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (TrainingPlans)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/TrainingPlans/);
  });
