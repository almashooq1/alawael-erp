/**
 * Auto-generated tests for pages/TransportProDashboard.jsx
...
const SRC = path.resolve(__dirname, '../pages/TransportProDashboard.jsx');

describe('pages/TransportProDashboard.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (TransportProDashboard)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/TransportProDashboard/);
  });
