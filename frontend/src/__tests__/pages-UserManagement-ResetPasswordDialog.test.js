/**
 * Auto-generated tests for pages/UserManagement/ResetPasswordDialog.jsx
...
const SRC = path.resolve(__dirname, '../pages/UserManagement/ResetPasswordDialog.jsx');

describe('pages/UserManagement/ResetPasswordDialog.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('uses React hooks (useState, useGenerated)', () => {
  ...
  test('has default export (ResetPasswordDialog)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/ResetPasswordDialog/);
  });
