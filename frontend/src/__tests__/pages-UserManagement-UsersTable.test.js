/**
 * Auto-generated tests for pages/UserManagement/UsersTable.jsx
 * Type: page | 422L | React | .jsx
 * @generated P#107 frontend universal generator (fs-based)
 */
const fs = require('fs');
const path = require('path');

const SRC = path.resolve(__dirname, '../pages/UserManagement/UsersTable.jsx');

describe('pages/UserManagement/UsersTable.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (UsersTable)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/UsersTable/);
  });
  ...
  test('file structure', () => {
    // Type: page | Lines: 422 | React: true | Ext: .jsx
    expect(source.split('\n').length).toBe(422);
  });
});
