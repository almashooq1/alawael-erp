/**
 * Auto-generated tests for pages/UserManagement/UsersToolbar.jsx
...
const SRC = path.resolve(__dirname, '../pages/UserManagement/UsersToolbar.jsx');

describe('pages/UserManagement/UsersToolbar.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (UsersToolbar)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/UsersToolbar/);
  });
