/**
 * Auto-generated tests for pages/WasteManagementProDashboard.jsx
...
const SRC = path.resolve(__dirname, '../pages/WasteManagementProDashboard.jsx');

describe('pages/WasteManagementProDashboard.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (WasteManagementProDashboard)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/WasteManagementProDashboard/);
  });
