/**
 * Auto-generated tests for pages/ar-rehab/ARRehabDashboard.jsx
...
const SRC = path.resolve(__dirname, '../pages/ar-rehab/ARRehabDashboard.jsx');

describe('pages/ar-rehab/ARRehabDashboard.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (ARRehabDashboard)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/ARRehabDashboard/);
  });
