/**
 * Auto-generated tests for pages/blockchain/BlockchainDashboard.jsx
...
const SRC = path.resolve(__dirname, '../pages/blockchain/BlockchainDashboard.jsx');

describe('pages/blockchain/BlockchainDashboard.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (BlockchainDashboard)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/BlockchainDashboard/);
  });
