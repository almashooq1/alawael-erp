/**
 * Auto-generated tests for pages/bus-tracking/BusTrackingDashboard.jsx
...
const SRC = path.resolve(__dirname, '../pages/bus-tracking/BusTrackingDashboard.jsx');

describe('pages/bus-tracking/BusTrackingDashboard.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (BusTrackingDashboard)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/BusTrackingDashboard/);
  });
