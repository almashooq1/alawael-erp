/**
 * Auto-generated tests for pages/care-plans/CarePlanPage.jsx
...
const SRC = path.resolve(__dirname, '../pages/care-plans/CarePlanPage.jsx');

describe('pages/care-plans/CarePlanPage.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (CarePlanPage)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/CarePlanPage/);
  });
