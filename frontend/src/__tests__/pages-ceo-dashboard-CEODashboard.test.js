/**
 * Auto-generated tests for pages/ceo-dashboard/CEODashboard.jsx
...
const SRC = path.resolve(__dirname, '../pages/ceo-dashboard/CEODashboard.jsx');

describe('pages/ceo-dashboard/CEODashboard.jsx', () => {
  let source;
  beforeAll(() => {
