/**
 * Auto-generated tests for pages/cms/CMSDashboard.jsx
...
const SRC = path.resolve(__dirname, '../pages/cms/CMSDashboard.jsx');

describe('pages/cms/CMSDashboard.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (CMSDashboard)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/CMSDashboard/);
  });
