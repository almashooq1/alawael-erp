/**
 * Auto-generated tests for pages/common/FormTemplates.js
 * Type: page | 1466L | React | .js
 * @generated P#107 frontend universal generator (fs-based)
 */
const fs = require('fs');
const path = require('path');

const SRC = path.resolve(__dirname, '../pages/common/FormTemplates.js');

describe('pages/common/FormTemplates.js', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (FormTemplates)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/FormTemplates/);
  });
  ...
  test('file structure', () => {
    // Type: page | Lines: 1466 | React: true | Ext: .js
    expect(source.split('\n').length).toBe(1466);
  });
});
