/**
 * Auto-generated tests for pages/common/Friends.js
 * Type: page | 128L | React | .js
 * @generated P#107 frontend universal generator (fs-based)
 */
const fs = require('fs');
const path = require('path');

const SRC = path.resolve(__dirname, '../pages/common/Friends.js');

describe('pages/common/Friends.js', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (Friends)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/Friends/);
  });
  ...
  test('file structure', () => {
    // Type: page | Lines: 128 | React: true | Ext: .js
    expect(source.split('\n').length).toBe(128);
  });
});
