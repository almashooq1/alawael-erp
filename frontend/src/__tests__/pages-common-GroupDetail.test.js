/**
 * Auto-generated tests for pages/common/GroupDetail.js
...
const SRC = path.resolve(__dirname, '../pages/common/GroupDetail.js');

describe('pages/common/GroupDetail.js', () => {
  let source;
  beforeAll(() => {
  ...
  test('uses React hooks (useState, useEffect, useParams)', () => {
  ...
  test('has default export (GroupDetail)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/GroupDetail/);
  });
