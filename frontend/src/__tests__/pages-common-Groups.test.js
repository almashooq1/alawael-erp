/**
 * Auto-generated tests for pages/common/Groups.js
...
const SRC = path.resolve(__dirname, '../pages/common/Groups.js');

describe('pages/common/Groups.js', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (Groups)', () => {
