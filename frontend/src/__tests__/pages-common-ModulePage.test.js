/**
 * Auto-generated tests for pages/common/ModulePage.js
...
const SRC = path.resolve(__dirname, '../pages/common/ModulePage.js');

describe('pages/common/ModulePage.js', () => {
  let source;
  beforeAll(() => {
  ...
  test('uses React hooks (useState, useEffect, useNavigate, useLocation, useSnackbar)', () => {
  ...
  test('has default export (ModulePage)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/ModulePage/);
  });
