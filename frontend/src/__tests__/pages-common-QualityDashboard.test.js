/**
 * Auto-generated tests for pages/common/QualityDashboard.jsx
...
const SRC = path.resolve(__dirname, '../pages/common/QualityDashboard.jsx');

describe('pages/common/QualityDashboard.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (QualityDashboard)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/QualityDashboard/);
  });
