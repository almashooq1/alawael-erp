/**
 * Auto-generated tests for pages/common/TaskManagement.js
...
const SRC = path.resolve(__dirname, '../pages/common/TaskManagement.js');

describe('pages/common/TaskManagement.js', () => {
  let source;
  beforeAll(() => {
