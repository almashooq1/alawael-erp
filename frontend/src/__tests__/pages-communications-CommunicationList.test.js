/**
 * Auto-generated tests for pages/communications/CommunicationList.jsx
...
const SRC = path.resolve(__dirname, '../pages/communications/CommunicationList.jsx');

describe('pages/communications/CommunicationList.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (CommunicationList)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/CommunicationList/);
  });
