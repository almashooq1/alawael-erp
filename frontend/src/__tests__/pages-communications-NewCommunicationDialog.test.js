/**
 * Auto-generated tests for pages/communications/NewCommunicationDialog.jsx
...
const SRC = path.resolve(__dirname, '../pages/communications/NewCommunicationDialog.jsx');

describe('pages/communications/NewCommunicationDialog.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (NewCommunicationDialog)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/NewCommunicationDialog/);
  });
