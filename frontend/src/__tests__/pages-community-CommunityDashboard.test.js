/**
 * Auto-generated tests for pages/community/CommunityDashboard.jsx
...
const SRC = path.resolve(__dirname, '../pages/community/CommunityDashboard.jsx');

describe('pages/community/CommunityDashboard.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (CommunityDashboard)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/CommunityDashboard/);
  });
