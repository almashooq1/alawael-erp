/**
 * Auto-generated tests for pages/complaints/ComplaintsDashboard.jsx
...
const SRC = path.resolve(__dirname, '../pages/complaints/ComplaintsDashboard.jsx');

describe('pages/complaints/ComplaintsDashboard.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (ComplaintsDashboard)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/ComplaintsDashboard/);
  });
