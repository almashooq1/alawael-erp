/**
 * Auto-generated tests for pages/crm/CRMReports.js
...
const SRC = path.resolve(__dirname, '../pages/crm/CRMReports.js');

describe('pages/crm/CRMReports.js', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (CRMReports)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/CRMReports/);
  });
