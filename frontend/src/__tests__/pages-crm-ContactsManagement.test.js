/**
 * Auto-generated tests for pages/crm/ContactsManagement.js
...
const SRC = path.resolve(__dirname, '../pages/crm/ContactsManagement.js');

describe('pages/crm/ContactsManagement.js', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (ContactsManagement)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/ContactsManagement/);
  });
