/**
 * Auto-generated tests for pages/documents/DocumentAdvancedPage.js
 * Type: page | 2394L | React | .js
 * @generated P#107 frontend universal generator (fs-based)
 */
const fs = require('fs');
const path = require('path');

const SRC = path.resolve(__dirname, '../pages/documents/DocumentAdvancedPage.js');

describe('pages/documents/DocumentAdvancedPage.js', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (DocumentAdvancedPage)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/DocumentAdvancedPage/);
  });
  ...
  test('file structure', () => {
    // Type: page | Lines: 2394 | React: true | Ext: .js
    expect(source.split('\n').length).toBe(2394);
  });
});
