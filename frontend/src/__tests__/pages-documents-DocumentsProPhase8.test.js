/**
 * Auto-generated tests for pages/documents/DocumentsProPhase8.jsx
...
const SRC = path.resolve(__dirname, '../pages/documents/DocumentsProPhase8.jsx');

describe('pages/documents/DocumentsProPhase8.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (DocumentsProPhase8)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/DocumentsProPhase8/);
  });
