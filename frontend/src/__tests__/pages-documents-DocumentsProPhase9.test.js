/**
 * Auto-generated tests for pages/documents/DocumentsProPhase9.jsx
...
const SRC = path.resolve(__dirname, '../pages/documents/DocumentsProPhase9.jsx');

describe('pages/documents/DocumentsProPhase9.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('uses React hooks (useState, useEffect, useCallback, useIcon)', () => {
  ...
  test('has default export (DocumentsProPhase9)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/DocumentsProPhase9/);
  });
