/**
 * Auto-generated tests for pages/documents/DocumentsReports.js
...
const SRC = path.resolve(__dirname, '../pages/documents/DocumentsReports.js');

describe('pages/documents/DocumentsReports.js', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (DocumentsReports)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/DocumentsReports/);
  });
