/**
 * Auto-generated tests for pages/documents/SmartDocumentsPage.js
 * Type: page | 2016L | React | .js
 * @generated P#107 frontend universal generator (fs-based)
 */
const fs = require('fs');
const path = require('path');

const SRC = path.resolve(__dirname, '../pages/documents/SmartDocumentsPage.js');

describe('pages/documents/SmartDocumentsPage.js', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (SmartDocumentsPage)', () => {
    ...
    expect(source).toMatch(/SmartDocumentsPage/);
  });
