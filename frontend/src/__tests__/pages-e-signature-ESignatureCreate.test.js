/**
 * Auto-generated tests for pages/e-signature/ESignatureCreate.js
...
const SRC = path.resolve(__dirname, '../pages/e-signature/ESignatureCreate.js');

describe('pages/e-signature/ESignatureCreate.js', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (ESignatureCreate)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/ESignatureCreate/);
  });
