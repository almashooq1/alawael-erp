/**
 * Auto-generated tests for pages/e-signature/ESignatureDashboard.jsx
...
const SRC = path.resolve(__dirname, '../pages/e-signature/ESignatureDashboard.jsx');

describe('pages/e-signature/ESignatureDashboard.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (ESignatureDashboard)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/ESignatureDashboard/);
  });
