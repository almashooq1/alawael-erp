/**
 * Auto-generated tests for pages/e-signature/EStamp.js
...
const SRC = path.resolve(__dirname, '../pages/e-signature/EStamp.js');

describe('pages/e-signature/EStamp.js', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (EStamp)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/EStamp/);
  });
