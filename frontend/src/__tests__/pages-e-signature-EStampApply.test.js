/**
 * Auto-generated tests for pages/e-signature/EStampApply.js
...
const SRC = path.resolve(__dirname, '../pages/e-signature/EStampApply.js');

describe('pages/e-signature/EStampApply.js', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (EStampApply)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/EStampApply/);
  });
