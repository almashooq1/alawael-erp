/**
 * Auto-generated tests for pages/earlyIntervention/EarlyInterventionDashboard.jsx
...
const SRC = path.resolve(__dirname, '../pages/earlyIntervention/EarlyInterventionDashboard.jsx');

describe('pages/earlyIntervention/EarlyInterventionDashboard.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (EarlyInterventionDashboard)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/EarlyInterventionDashboard/);
  });
