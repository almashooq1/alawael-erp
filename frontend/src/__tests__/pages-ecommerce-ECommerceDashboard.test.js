/**
 * Auto-generated tests for pages/ecommerce/ECommerceDashboard.jsx
...
const SRC = path.resolve(__dirname, '../pages/ecommerce/ECommerceDashboard.jsx');

describe('pages/ecommerce/ECommerceDashboard.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (ECommerceDashboard)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/ECommerceDashboard/);
  });
