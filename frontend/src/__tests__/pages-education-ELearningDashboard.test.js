/**
 * Auto-generated tests for pages/education/ELearningDashboard.js
...
const SRC = path.resolve(__dirname, '../pages/education/ELearningDashboard.js');

describe('pages/education/ELearningDashboard.js', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (ELearningDashboard)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/ELearningDashboard/);
  });
