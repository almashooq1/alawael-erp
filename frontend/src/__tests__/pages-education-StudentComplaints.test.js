/**
 * Auto-generated tests for pages/education/StudentComplaints.js
...
const SRC = path.resolve(__dirname, '../pages/education/StudentComplaints.js');

describe('pages/education/StudentComplaints.js', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (StudentComplaints)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/StudentComplaints/);
  });
