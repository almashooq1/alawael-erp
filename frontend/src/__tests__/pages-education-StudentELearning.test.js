/**
 * Auto-generated tests for pages/education/StudentELearning.js
...
const SRC = path.resolve(__dirname, '../pages/education/StudentELearning.js');

describe('pages/education/StudentELearning.js', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (StudentELearning)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/StudentELearning/);
  });
