/**
 * Auto-generated tests for pages/education/StudentEvents.js
...
const SRC = path.resolve(__dirname, '../pages/education/StudentEvents.js');

describe('pages/education/StudentEvents.js', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (StudentEvents)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/StudentEvents/);
  });
