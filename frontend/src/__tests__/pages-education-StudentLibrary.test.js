/**
 * Auto-generated tests for pages/education/StudentLibrary.js
...
const SRC = path.resolve(__dirname, '../pages/education/StudentLibrary.js');

describe('pages/education/StudentLibrary.js', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (StudentLibrary)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/StudentLibrary/);
  });
