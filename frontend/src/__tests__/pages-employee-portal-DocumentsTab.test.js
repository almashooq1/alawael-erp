/**
 * Auto-generated tests for pages/employee-portal/DocumentsTab.jsx
...
const SRC = path.resolve(__dirname, '../pages/employee-portal/DocumentsTab.jsx');

describe('pages/employee-portal/DocumentsTab.jsx', () => {
  let source;
  beforeAll(() => {
