/**
 * Auto-generated tests for pages/employee-portal/LeavesTab.jsx
...
const SRC = path.resolve(__dirname, '../pages/employee-portal/LeavesTab.jsx');

describe('pages/employee-portal/LeavesTab.jsx', () => {
  let source;
  beforeAll(() => {
