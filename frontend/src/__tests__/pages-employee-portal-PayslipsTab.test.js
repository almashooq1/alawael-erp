/**
 * Auto-generated tests for pages/employee-portal/PayslipsTab.jsx
...
const SRC = path.resolve(__dirname, '../pages/employee-portal/PayslipsTab.jsx');

describe('pages/employee-portal/PayslipsTab.jsx', () => {
  let source;
  beforeAll(() => {
