/**
 * Auto-generated tests for pages/employee-portal/ProfileTab.jsx
...
const SRC = path.resolve(__dirname, '../pages/employee-portal/ProfileTab.jsx');

describe('pages/employee-portal/ProfileTab.jsx', () => {
  let source;
  beforeAll(() => {
