/**
 * Auto-generated tests for pages/enterprise/ReportBuilderPage.js
...
const SRC = path.resolve(__dirname, '../pages/enterprise/ReportBuilderPage.js');

describe('pages/enterprise/ReportBuilderPage.js', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (ReportBuilderPage)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/ReportBuilderPage/);
  });
