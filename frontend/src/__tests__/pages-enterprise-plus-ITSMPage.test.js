/**
 * Auto-generated tests for pages/enterprise-plus/ITSMPage.js
 * Type: page | 955L | React | .js
 * @generated P#107 frontend universal generator (fs-based)
 */
const fs = require('fs');
const path = require('path');

const SRC = path.resolve(__dirname, '../pages/enterprise-plus/ITSMPage.js');

describe('pages/enterprise-plus/ITSMPage.js', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (ITSMPage)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/ITSMPage/);
  });
  ...
  test('file structure', () => {
    // Type: page | Lines: 955 | React: true | Ext: .js
    expect(source.split('\n').length).toBe(955);
  });
});
