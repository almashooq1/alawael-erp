/**
 * Auto-generated tests for pages/facility/FacilityDashboard.jsx
...
const SRC = path.resolve(__dirname, '../pages/facility/FacilityDashboard.jsx');

describe('pages/facility/FacilityDashboard.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (FacilityDashboard)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/FacilityDashboard/);
  });
