/**
 * Auto-generated tests for pages/finance/BalanceSheet.js
...
const SRC = path.resolve(__dirname, '../pages/finance/BalanceSheet.js');

describe('pages/finance/BalanceSheet.js', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (BalanceSheet)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/BalanceSheet/);
  });
