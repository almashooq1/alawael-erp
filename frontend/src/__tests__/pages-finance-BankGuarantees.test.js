/**
 * Auto-generated tests for pages/finance/BankGuarantees.js
 * Type: page | 640L | React | .js
 * @generated P#107 frontend universal generator (fs-based)
 */
const fs = require('fs');
const path = require('path');

const SRC = path.resolve(__dirname, '../pages/finance/BankGuarantees.js');

describe('pages/finance/BankGuarantees.js', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (BankGuarantees)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/BankGuarantees/);
  });
  ...
  test('file structure', () => {
    // Type: page | Lines: 640 | React: true | Ext: .js
    expect(source.split('\n').length).toBe(640);
  });
});
