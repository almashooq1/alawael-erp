/**
 * Auto-generated tests for pages/finance/BudgetManagement.js
...
const SRC = path.resolve(__dirname, '../pages/finance/BudgetManagement.js');

describe('pages/finance/BudgetManagement.js', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (BudgetManagement)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/BudgetManagement/);
  });
