/**
 * Auto-generated tests for pages/finance/CompanyLoans.js
 * Type: page | 841L | React | .js
 * @generated P#107 frontend universal generator (fs-based)
 */
const fs = require('fs');
const path = require('path');

const SRC = path.resolve(__dirname, '../pages/finance/CompanyLoans.js');

describe('pages/finance/CompanyLoans.js', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (CompanyLoans)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/CompanyLoans/);
  });
  ...
  test('file structure', () => {
    // Type: page | Lines: 841 | React: true | Ext: .js
    expect(source.split('\n').length).toBe(841);
  });
});
