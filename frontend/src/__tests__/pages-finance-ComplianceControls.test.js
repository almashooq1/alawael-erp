/**
 * Auto-generated tests for pages/finance/ComplianceControls.js
...
const SRC = path.resolve(__dirname, '../pages/finance/ComplianceControls.js');

describe('pages/finance/ComplianceControls.js', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (ComplianceControls)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/ComplianceControls/);
  });
