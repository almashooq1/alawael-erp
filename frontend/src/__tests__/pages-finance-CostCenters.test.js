/**
 * Auto-generated tests for pages/finance/CostCenters.js
...
const SRC = path.resolve(__dirname, '../pages/finance/CostCenters.js');

describe('pages/finance/CostCenters.js', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (CostCenters)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/CostCenters/);
  });
