/**
 * Auto-generated tests for pages/finance/EInvoicing.js
...
const SRC = path.resolve(__dirname, '../pages/finance/EInvoicing.js');

describe('pages/finance/EInvoicing.js', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (EInvoicing)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/EInvoicing/);
  });
