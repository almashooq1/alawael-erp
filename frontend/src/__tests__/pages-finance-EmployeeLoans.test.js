/**
 * Auto-generated tests for pages/finance/EmployeeLoans.js
...
const SRC = path.resolve(__dirname, '../pages/finance/EmployeeLoans.js');

describe('pages/finance/EmployeeLoans.js', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (EmployeeLoans)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/EmployeeLoans/);
  });
