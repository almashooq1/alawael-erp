/**
 * Auto-generated tests for pages/finance/ExecutiveSummary.js
...
const SRC = path.resolve(__dirname, '../pages/finance/ExecutiveSummary.js');

describe('pages/finance/ExecutiveSummary.js', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (ExecutiveSummary)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/ExecutiveSummary/);
  });
