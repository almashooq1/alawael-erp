/**
 * Auto-generated tests for pages/finance/ExpenseManagement.js
...
const SRC = path.resolve(__dirname, '../pages/finance/ExpenseManagement.js');

describe('pages/finance/ExpenseManagement.js', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (ExpenseManagement)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/ExpenseManagement/);
  });
