/**
 * Auto-generated tests for pages/finance/FinanceOperationsPage.jsx
...
const SRC = path.resolve(__dirname, '../pages/finance/FinanceOperationsPage.jsx');

describe('pages/finance/FinanceOperationsPage.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (FinanceOperationsPage)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/FinanceOperationsPage/);
  });
