/**
 * Auto-generated tests for pages/finance/FinancialPlanning.js
...
const SRC = path.resolve(__dirname, '../pages/finance/FinancialPlanning.js');

describe('pages/finance/FinancialPlanning.js', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (FinancialPlanning)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/FinancialPlanning/);
  });
