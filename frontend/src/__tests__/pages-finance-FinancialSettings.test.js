/**
 * Auto-generated tests for pages/finance/FinancialSettings.js
...
const SRC = path.resolve(__dirname, '../pages/finance/FinancialSettings.js');

describe('pages/finance/FinancialSettings.js', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (FinancialSettings)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/FinancialSettings/);
  });
