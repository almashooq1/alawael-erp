/**
 * Auto-generated tests for pages/finance/FiscalPeriods.js
 * Type: page | 249L | React | .js
 * @generated P#107 frontend universal generator (fs-based)
 */
const fs = require('fs');
const path = require('path');

const SRC = path.resolve(__dirname, '../pages/finance/FiscalPeriods.js');

describe('pages/finance/FiscalPeriods.js', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (FiscalPeriods)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/FiscalPeriods/);
  });
  ...
  test('file structure', () => {
    // Type: page | Lines: 249 | React: true | Ext: .js
    expect(source.split('\n').length).toBe(249);
  });
});
