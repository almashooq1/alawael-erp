/**
 * Auto-generated tests for pages/finance/GeneralLedger.js
...
const SRC = path.resolve(__dirname, '../pages/finance/GeneralLedger.js');

describe('pages/finance/GeneralLedger.js', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (GeneralLedger)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/GeneralLedger/);
  });
