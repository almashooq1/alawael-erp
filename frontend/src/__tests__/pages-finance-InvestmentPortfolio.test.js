/**
 * Auto-generated tests for pages/finance/InvestmentPortfolio.js
...
const SRC = path.resolve(__dirname, '../pages/finance/InvestmentPortfolio.js');

describe('pages/finance/InvestmentPortfolio.js', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (InvestmentPortfolio)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/InvestmentPortfolio/);
  });
