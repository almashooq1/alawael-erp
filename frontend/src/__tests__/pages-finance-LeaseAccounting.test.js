/**
 * Auto-generated tests for pages/finance/LeaseAccounting.js
...
const SRC = path.resolve(__dirname, '../pages/finance/LeaseAccounting.js');

describe('pages/finance/LeaseAccounting.js', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (LeaseAccounting)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/LeaseAccounting/);
  });
