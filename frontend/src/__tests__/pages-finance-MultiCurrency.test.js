/**
 * Auto-generated tests for pages/finance/MultiCurrency.js
...
const SRC = path.resolve(__dirname, '../pages/finance/MultiCurrency.js');

describe('pages/finance/MultiCurrency.js', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (MultiCurrency)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/MultiCurrency/);
  });
