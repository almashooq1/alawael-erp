/**
 * Auto-generated tests for pages/finance/PaymentVouchers.js
...
const SRC = path.resolve(__dirname, '../pages/finance/PaymentVouchers.js');

describe('pages/finance/PaymentVouchers.js', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (PaymentVouchers)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/PaymentVouchers/);
  });
