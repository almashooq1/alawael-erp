/**
 * Auto-generated tests for pages/finance/PeriodClosing.js
...
const SRC = path.resolve(__dirname, '../pages/finance/PeriodClosing.js');

describe('pages/finance/PeriodClosing.js', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (PeriodClosing)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/PeriodClosing/);
  });
