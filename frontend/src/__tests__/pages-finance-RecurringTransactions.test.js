/**
 * Auto-generated tests for pages/finance/RecurringTransactions.js
...
const SRC = path.resolve(__dirname, '../pages/finance/RecurringTransactions.js');

describe('pages/finance/RecurringTransactions.js', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (RecurringTransactions)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/RecurringTransactions/);
  });
