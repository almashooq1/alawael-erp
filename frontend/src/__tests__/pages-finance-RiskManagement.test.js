/**
 * Auto-generated tests for pages/finance/RiskManagement.js
...
const SRC = path.resolve(__dirname, '../pages/finance/RiskManagement.js');

describe('pages/finance/RiskManagement.js', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (RiskManagement)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/RiskManagement/);
  });
