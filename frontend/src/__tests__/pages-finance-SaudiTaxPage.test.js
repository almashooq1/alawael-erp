/**
 * Auto-generated tests for pages/finance/SaudiTaxPage.jsx
...
const SRC = path.resolve(__dirname, '../pages/finance/SaudiTaxPage.jsx');

describe('pages/finance/SaudiTaxPage.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (SaudiTaxPage)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/SaudiTaxPage/);
  });
