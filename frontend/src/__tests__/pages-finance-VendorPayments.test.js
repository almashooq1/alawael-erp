/**
 * Auto-generated tests for pages/finance/VendorPayments.js
...
const SRC = path.resolve(__dirname, '../pages/finance/VendorPayments.js');

describe('pages/finance/VendorPayments.js', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (VendorPayments)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/VendorPayments/);
  });
