/**
 * Auto-generated tests for pages/finance/WithholdingTaxPage.js
...
const SRC = path.resolve(__dirname, '../pages/finance/WithholdingTaxPage.js');

describe('pages/finance/WithholdingTaxPage.js', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (WithholdingTaxPage)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/WithholdingTaxPage/);
  });
