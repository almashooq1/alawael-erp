/**
 * Auto-generated tests for pages/gps-tracking/GPSTrackingDashboard.jsx
...
const SRC = path.resolve(__dirname, '../pages/gps-tracking/GPSTrackingDashboard.jsx');

describe('pages/gps-tracking/GPSTrackingDashboard.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (GPSTrackingDashboard)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/GPSTrackingDashboard/);
  });
