/**
 * Auto-generated tests for pages/hr/ComplaintsManagement.js
...
const SRC = path.resolve(__dirname, '../pages/hr/ComplaintsManagement.js');

describe('pages/hr/ComplaintsManagement.js', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (ComplaintsManagement)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/ComplaintsManagement/);
  });
