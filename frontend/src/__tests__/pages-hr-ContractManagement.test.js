/**
 * Auto-generated tests for pages/hr/ContractManagement.js
...
const SRC = path.resolve(__dirname, '../pages/hr/ContractManagement.js');

describe('pages/hr/ContractManagement.js', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (ContractManagement)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/ContractManagement/);
  });
