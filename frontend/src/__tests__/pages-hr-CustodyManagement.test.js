/**
 * Auto-generated tests for pages/hr/CustodyManagement.js
...
const SRC = path.resolve(__dirname, '../pages/hr/CustodyManagement.js');

describe('pages/hr/CustodyManagement.js', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (CustodyManagement)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/CustodyManagement/);
  });
