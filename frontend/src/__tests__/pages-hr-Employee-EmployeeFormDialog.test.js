/**
 * Auto-generated tests for pages/hr/Employee/EmployeeFormDialog.jsx
...
const SRC = path.resolve(__dirname, '../pages/hr/Employee/EmployeeFormDialog.jsx');

describe('pages/hr/Employee/EmployeeFormDialog.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (EmployeeFormDialog)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/EmployeeFormDialog/);
  });
