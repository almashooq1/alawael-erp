/**
 * Auto-generated tests for pages/hr/Employee/EmployeeTable.jsx
...
const SRC = path.resolve(__dirname, '../pages/hr/Employee/EmployeeTable.jsx');

describe('pages/hr/Employee/EmployeeTable.jsx', () => {
  let source;
  beforeAll(() => {
