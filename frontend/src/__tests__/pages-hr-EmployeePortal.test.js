/**
 * Auto-generated tests for pages/hr/EmployeePortal.js
...
const SRC = path.resolve(__dirname, '../pages/hr/EmployeePortal.js');

describe('pages/hr/EmployeePortal.js', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (EmployeePortal)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/EmployeePortal/);
  });
