/**
 * Auto-generated tests for pages/hr/EndOfServiceBenefits.js
 * Type: page | 620L | React | .js
 * @generated P#107 frontend universal generator (fs-based)
 */
const fs = require('fs');
const path = require('path');

const SRC = path.resolve(__dirname, '../pages/hr/EndOfServiceBenefits.js');

describe('pages/hr/EndOfServiceBenefits.js', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (EndOfServiceBenefits)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/EndOfServiceBenefits/);
  });
  ...
  test('file structure', () => {
    // Type: page | Lines: 620 | React: true | Ext: .js
    expect(source.split('\n').length).toBe(620);
  });
});
