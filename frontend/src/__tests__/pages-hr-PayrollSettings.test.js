/**
 * Auto-generated tests for pages/hr/PayrollSettings.js
...
const SRC = path.resolve(__dirname, '../pages/hr/PayrollSettings.js');

describe('pages/hr/PayrollSettings.js', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (PayrollSettings)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/PayrollSettings/);
  });
