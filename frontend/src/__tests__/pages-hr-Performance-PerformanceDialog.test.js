/**
 * Auto-generated tests for pages/hr/Performance/PerformanceDialog.jsx
...
const SRC = path.resolve(__dirname, '../pages/hr/Performance/PerformanceDialog.jsx');

describe('pages/hr/Performance/PerformanceDialog.jsx', () => {
  let source;
  beforeAll(() => {
