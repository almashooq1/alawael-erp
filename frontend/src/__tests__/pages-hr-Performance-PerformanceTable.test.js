/**
 * Auto-generated tests for pages/hr/Performance/PerformanceTable.jsx
...
const SRC = path.resolve(__dirname, '../pages/hr/Performance/PerformanceTable.jsx');

describe('pages/hr/Performance/PerformanceTable.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (PerformanceTable)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/PerformanceTable/);
  });
