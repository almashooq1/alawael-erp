/**
 * Auto-generated tests for pages/hr/RewardsManagement.js
...
const SRC = path.resolve(__dirname, '../pages/hr/RewardsManagement.js');

describe('pages/hr/RewardsManagement.js', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (RewardsManagement)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/RewardsManagement/);
  });
