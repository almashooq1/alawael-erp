/**
 * Auto-generated tests for pages/hr/TrainingDashboard.js
...
const SRC = path.resolve(__dirname, '../pages/hr/TrainingDashboard.js');

describe('pages/hr/TrainingDashboard.js', () => {
  let source;
  beforeAll(() => {
