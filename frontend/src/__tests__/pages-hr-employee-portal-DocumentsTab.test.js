/**
 * Auto-generated tests for pages/hr/employee-portal/DocumentsTab.jsx
...
const SRC = path.resolve(__dirname, '../pages/hr/employee-portal/DocumentsTab.jsx');

describe('pages/hr/employee-portal/DocumentsTab.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (DocumentsTab)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/DocumentsTab/);
  });
