/**
 * Auto-generated tests for pages/hr/employee-portal/LeavesTab.jsx
 * Type: page | 172L | React | .jsx
 * @generated P#107 frontend universal generator (fs-based)
 */
const fs = require('fs');
const path = require('path');

const SRC = path.resolve(__dirname, '../pages/hr/employee-portal/LeavesTab.jsx');

describe('pages/hr/employee-portal/LeavesTab.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (LeavesTab)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/LeavesTab/);
  });
  ...
  test('file structure', () => {
    // Type: page | Lines: 172 | React: true | Ext: .jsx
    expect(source.split('\n').length).toBe(172);
  });
});
