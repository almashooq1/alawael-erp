/**
 * Auto-generated tests for pages/hr/employee-portal/PayslipsTab.jsx
...
const SRC = path.resolve(__dirname, '../pages/hr/employee-portal/PayslipsTab.jsx');

describe('pages/hr/employee-portal/PayslipsTab.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (PayslipsTab)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/PayslipsTab/);
  });
