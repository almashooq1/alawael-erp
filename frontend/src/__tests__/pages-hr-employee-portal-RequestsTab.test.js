/**
 * Auto-generated tests for pages/hr/employee-portal/RequestsTab.jsx
...
const SRC = path.resolve(__dirname, '../pages/hr/employee-portal/RequestsTab.jsx');

describe('pages/hr/employee-portal/RequestsTab.jsx', () => {
  let source;
  beforeAll(() => {
