/**
 * Auto-generated tests for pages/iot/IoTDashboard.jsx
...
const SRC = path.resolve(__dirname, '../pages/iot/IoTDashboard.jsx');

describe('pages/iot/IoTDashboard.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (IoTDashboard)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/IoTDashboard/);
  });
