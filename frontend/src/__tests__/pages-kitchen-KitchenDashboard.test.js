/**
 * Auto-generated tests for pages/kitchen/KitchenDashboard.jsx
...
const SRC = path.resolve(__dirname, '../pages/kitchen/KitchenDashboard.jsx');

describe('pages/kitchen/KitchenDashboard.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (KitchenDashboard)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/KitchenDashboard/);
  });
