/**
 * Auto-generated tests for pages/knowledge/KnowledgeCenterPage.js
 * Type: page | 563L | React | .js
 * @generated P#107 frontend universal generator (fs-based)
 */
const fs = require('fs');
const path = require('path');

const SRC = path.resolve(__dirname, '../pages/knowledge/KnowledgeCenterPage.js');

describe('pages/knowledge/KnowledgeCenterPage.js', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (KnowledgeCenterPage)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/KnowledgeCenterPage/);
  });
  ...
  test('file structure', () => {
    // Type: page | Lines: 563 | React: true | Ext: .js
    expect(source.split('\n').length).toBe(563);
  });
});
