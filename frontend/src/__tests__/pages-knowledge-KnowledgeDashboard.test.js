/**
 * Auto-generated tests for pages/knowledge/KnowledgeDashboard.jsx
...
const SRC = path.resolve(__dirname, '../pages/knowledge/KnowledgeDashboard.jsx');

describe('pages/knowledge/KnowledgeDashboard.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (KnowledgeDashboard)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/KnowledgeDashboard/);
  });
