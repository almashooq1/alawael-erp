/**
 * Auto-generated tests for pages/laundry/LaundryDashboard.jsx
...
const SRC = path.resolve(__dirname, '../pages/laundry/LaundryDashboard.jsx');

describe('pages/laundry/LaundryDashboard.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (LaundryDashboard)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/LaundryDashboard/);
  });
