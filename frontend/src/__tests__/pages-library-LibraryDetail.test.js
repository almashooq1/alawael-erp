/**
 * Auto-generated tests for pages/library/LibraryDetail.jsx
...
const SRC = path.resolve(__dirname, '../pages/library/LibraryDetail.jsx');

describe('pages/library/LibraryDetail.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (LibraryDetail)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/LibraryDetail/);
  });
