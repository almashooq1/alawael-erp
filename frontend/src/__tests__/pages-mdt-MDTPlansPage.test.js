/**
 * Auto-generated tests for pages/mdt/MDTPlansPage.jsx
...
const SRC = path.resolve(__dirname, '../pages/mdt/MDTPlansPage.jsx');

describe('pages/mdt/MDTPlansPage.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (MDTPlansPage)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/MDTPlansPage/);
  });
