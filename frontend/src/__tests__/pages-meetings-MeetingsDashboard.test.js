/**
 * Auto-generated tests for pages/meetings/MeetingsDashboard.jsx
...
const SRC = path.resolve(__dirname, '../pages/meetings/MeetingsDashboard.jsx');

describe('pages/meetings/MeetingsDashboard.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (MeetingsDashboard)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/MeetingsDashboard/);
  });
