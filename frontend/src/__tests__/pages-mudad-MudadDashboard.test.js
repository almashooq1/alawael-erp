/**
 * Auto-generated tests for pages/mudad/MudadDashboard.jsx
...
const SRC = path.resolve(__dirname, '../pages/mudad/MudadDashboard.jsx');

describe('pages/mudad/MudadDashboard.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (MudadDashboard)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/MudadDashboard/);
  });
