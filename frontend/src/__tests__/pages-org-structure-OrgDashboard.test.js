/**
 * Auto-generated tests for pages/org-structure/OrgDashboard.jsx
...
const SRC = path.resolve(__dirname, '../pages/org-structure/OrgDashboard.jsx');

describe('pages/org-structure/OrgDashboard.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (OrgDashboard)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/OrgDashboard/);
  });
