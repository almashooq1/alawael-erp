/**
 * Auto-generated tests for pages/org-structure/OrgStructurePage.js
 * Type: page | 659L | React | .js
 * @generated P#107 frontend universal generator (fs-based)
 */
const fs = require('fs');
const path = require('path');

const SRC = path.resolve(__dirname, '../pages/org-structure/OrgStructurePage.js');

describe('pages/org-structure/OrgStructurePage.js', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (OrgStructurePage)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/OrgStructurePage/);
  });
  ...
  test('file structure', () => {
    // Type: page | Lines: 659 | React: true | Ext: .js
    expect(source.split('\n').length).toBe(659);
  });
});
