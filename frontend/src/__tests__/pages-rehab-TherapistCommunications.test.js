/**
 * Auto-generated tests for pages/rehab/TherapistCommunications.js
...
const SRC = path.resolve(__dirname, '../pages/rehab/TherapistCommunications.js');

describe('pages/rehab/TherapistCommunications.js', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (TherapistCommunications)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/TherapistCommunications/);
  });
