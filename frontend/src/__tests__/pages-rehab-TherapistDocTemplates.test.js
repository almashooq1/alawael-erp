/**
 * Auto-generated tests for pages/rehab/TherapistDocTemplates.js
...
const SRC = path.resolve(__dirname, '../pages/rehab/TherapistDocTemplates.js');

describe('pages/rehab/TherapistDocTemplates.js', () => {
  let source;
  beforeAll(() => {
  ...
  test('uses React hooks (useState, useEffect, useAuth, useSnackbar, useTemplate)', () => {
  ...
  test('has default export (TherapistDocTemplates)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/TherapistDocTemplates/);
  });
