/**
 * Auto-generated tests for pages/rehab/TherapistEquipment.js
 * Type: page | 635L | React | .js
 * @generated P#107 frontend universal generator (fs-based)
 */
const fs = require('fs');
const path = require('path');

const SRC = path.resolve(__dirname, '../pages/rehab/TherapistEquipment.js');

describe('pages/rehab/TherapistEquipment.js', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (TherapistEquipment)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/TherapistEquipment/);
  });
  ...
  test('file structure', () => {
    // Type: page | Lines: 635 | React: true | Ext: .js
    expect(source.split('\n').length).toBe(635);
  });
});
