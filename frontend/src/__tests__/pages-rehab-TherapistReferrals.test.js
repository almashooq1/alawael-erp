/**
 * Auto-generated tests for pages/rehab/TherapistReferrals.js
 * Type: page | 597L | React | .js
 * @generated P#107 frontend universal generator (fs-based)
 */
const fs = require('fs');
const path = require('path');

const SRC = path.resolve(__dirname, '../pages/rehab/TherapistReferrals.js');

describe('pages/rehab/TherapistReferrals.js', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (TherapistReferrals)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/TherapistReferrals/);
  });
  ...
  test('file structure', () => {
    // Type: page | Lines: 597 | React: true | Ext: .js
    expect(source.split('\n').length).toBe(597);
  });
});
