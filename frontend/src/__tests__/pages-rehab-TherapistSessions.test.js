/**
 * Auto-generated tests for pages/rehab/TherapistSessions.js
...
const SRC = path.resolve(__dirname, '../pages/rehab/TherapistSessions.js');

describe('pages/rehab/TherapistSessions.js', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (TherapistSessions)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/TherapistSessions/);
  });
