/**
 * Auto-generated tests for pages/research/ResearchDashboard.jsx
...
const SRC = path.resolve(__dirname, '../pages/research/ResearchDashboard.jsx');

describe('pages/research/ResearchDashboard.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (ResearchDashboard)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/ResearchDashboard/);
  });
