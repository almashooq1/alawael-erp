/**
 * Auto-generated tests for pages/sso-admin/SSOAdminDashboard.jsx
...
const SRC = path.resolve(__dirname, '../pages/sso-admin/SSOAdminDashboard.jsx');

describe('pages/sso-admin/SSOAdminDashboard.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (SSOAdminDashboard)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/SSOAdminDashboard/);
  });
