/**
 * Auto-generated tests for pages/succession/SuccessionDashboard.jsx
...
const SRC = path.resolve(__dirname, '../pages/succession/SuccessionDashboard.jsx');

describe('pages/succession/SuccessionDashboard.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (SuccessionDashboard)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/SuccessionDashboard/);
  });
