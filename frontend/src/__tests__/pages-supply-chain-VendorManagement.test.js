/**
 * Auto-generated tests for pages/supply-chain/VendorManagement.js
...
const SRC = path.resolve(__dirname, '../pages/supply-chain/VendorManagement.js');

describe('pages/supply-chain/VendorManagement.js', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (VendorManagement)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/VendorManagement/);
  });
