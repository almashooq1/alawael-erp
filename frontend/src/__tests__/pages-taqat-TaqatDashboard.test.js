/**
 * Auto-generated tests for pages/taqat/TaqatDashboard.jsx
...
const SRC = path.resolve(__dirname, '../pages/taqat/TaqatDashboard.jsx');

describe('pages/taqat/TaqatDashboard.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (TaqatDashboard)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/TaqatDashboard/);
  });
