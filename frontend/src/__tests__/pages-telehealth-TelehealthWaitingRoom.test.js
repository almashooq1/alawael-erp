/**
 * Auto-generated tests for pages/telehealth/TelehealthWaitingRoom.jsx
...
const SRC = path.resolve(__dirname, '../pages/telehealth/TelehealthWaitingRoom.jsx');

describe('pages/telehealth/TelehealthWaitingRoom.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (TelehealthWaitingRoom)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/TelehealthWaitingRoom/);
  });
