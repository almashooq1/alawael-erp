/**
 * Auto-generated tests for pages/visitors/VisitorsDashboard.jsx
...
const SRC = path.resolve(__dirname, '../pages/visitors/VisitorsDashboard.jsx');

describe('pages/visitors/VisitorsDashboard.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (VisitorsDashboard)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/VisitorsDashboard/);
  });
