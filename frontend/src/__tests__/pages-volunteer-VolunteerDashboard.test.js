/**
 * Auto-generated tests for pages/volunteer/VolunteerDashboard.jsx
...
const SRC = path.resolve(__dirname, '../pages/volunteer/VolunteerDashboard.jsx');

describe('pages/volunteer/VolunteerDashboard.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (VolunteerDashboard)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/VolunteerDashboard/);
  });
