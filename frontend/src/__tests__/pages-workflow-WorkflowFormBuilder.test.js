/**
 * Auto-generated tests for pages/workflow/WorkflowFormBuilder.js
 * Type: page | 417L | React | .js
 * @generated P#107 frontend universal generator (fs-based)
 */
const fs = require('fs');
const path = require('path');

const SRC = path.resolve(__dirname, '../pages/workflow/WorkflowFormBuilder.js');

describe('pages/workflow/WorkflowFormBuilder.js', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (WorkflowFormBuilder)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/WorkflowFormBuilder/);
  });
  ...
  test('file structure', () => {
    // Type: page | Lines: 417 | React: true | Ext: .js
    expect(source.split('\n').length).toBe(417);
  });
});
