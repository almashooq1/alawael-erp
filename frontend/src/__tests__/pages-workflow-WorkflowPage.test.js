/**
 * Auto-generated tests for pages/workflow/WorkflowPage.jsx
...
const SRC = path.resolve(__dirname, '../pages/workflow/WorkflowPage.jsx');

describe('pages/workflow/WorkflowPage.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('uses React hooks (useState, useEffect, useCallback, useNavigate, useFlexGap)', () => {
  ...
  test('has default export (WorkflowPage)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/WorkflowPage/);
  });
