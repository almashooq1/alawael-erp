/**
 * Auto-generated tests for pages/workflow/WorkflowSearch.js
...
const SRC = path.resolve(__dirname, '../pages/workflow/WorkflowSearch.js');

describe('pages/workflow/WorkflowSearch.js', () => {
  let source;
  beforeAll(() => {
  ...
  test('uses React hooks (useState, useCallback, useNavigate, useSnackbar)', () => {
  ...
  test('has default export (WorkflowSearch)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/WorkflowSearch/);
  });
