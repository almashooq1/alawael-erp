/**
 * Auto-generated tests for pages/workflow/WorkflowTags.js
...
const SRC = path.resolve(__dirname, '../pages/workflow/WorkflowTags.js');

describe('pages/workflow/WorkflowTags.js', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (WorkflowTags)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/WorkflowTags/);
  });
