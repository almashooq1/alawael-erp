/**
 * Auto-generated tests for routes/AIDiagnosticRoutes.jsx
...
const SRC = path.resolve(__dirname, '../routes/AIDiagnosticRoutes.jsx');

describe('routes/AIDiagnosticRoutes.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (AIDiagnosticRoutes)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/AIDiagnosticRoutes/);
  });
