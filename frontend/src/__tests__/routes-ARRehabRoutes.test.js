/**
 * Auto-generated tests for routes/ARRehabRoutes.jsx
...
const SRC = path.resolve(__dirname, '../routes/ARRehabRoutes.jsx');

describe('routes/ARRehabRoutes.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (ARRehabRoutes)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/ARRehabRoutes/);
  });
