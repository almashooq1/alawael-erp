/**
 * Auto-generated tests for routes/AttendanceRoutes.jsx
...
const SRC = path.resolve(__dirname, '../routes/AttendanceRoutes.jsx');

describe('routes/AttendanceRoutes.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (AttendanceRoutes)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/AttendanceRoutes/);
  });
