/**
 * Auto-generated tests for routes/AuditLogsRoutes.jsx
...
const SRC = path.resolve(__dirname, '../routes/AuditLogsRoutes.jsx');

describe('routes/AuditLogsRoutes.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (AuditLogsRoutes)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/AuditLogsRoutes/);
  });
