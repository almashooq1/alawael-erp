/**
 * Auto-generated tests for routes/BeneficiaryRoutes.jsx
...
const SRC = path.resolve(__dirname, '../routes/BeneficiaryRoutes.jsx');

describe('routes/BeneficiaryRoutes.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (BeneficiaryRoutes)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/BeneficiaryRoutes/);
  });
