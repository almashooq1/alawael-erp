/**
 * Auto-generated tests for routes/BlockchainRoutes.jsx
...
const SRC = path.resolve(__dirname, '../routes/BlockchainRoutes.jsx');

describe('routes/BlockchainRoutes.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (BlockchainRoutes)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/BlockchainRoutes/);
  });
