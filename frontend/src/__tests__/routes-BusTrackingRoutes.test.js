/**
 * Auto-generated tests for routes/BusTrackingRoutes.jsx
...
const SRC = path.resolve(__dirname, '../routes/BusTrackingRoutes.jsx');

describe('routes/BusTrackingRoutes.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (BusTrackingRoutes)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/BusTrackingRoutes/);
  });
