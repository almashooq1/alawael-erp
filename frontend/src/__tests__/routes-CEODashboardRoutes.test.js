/**
 * Auto-generated tests for routes/CEODashboardRoutes.jsx
...
const SRC = path.resolve(__dirname, '../routes/CEODashboardRoutes.jsx');

describe('routes/CEODashboardRoutes.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (CEODashboardRoutes)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/CEODashboardRoutes/);
  });
