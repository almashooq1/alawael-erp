/**
 * Auto-generated tests for routes/CMSRoutes.jsx
...
const SRC = path.resolve(__dirname, '../routes/CMSRoutes.jsx');

describe('routes/CMSRoutes.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (CMSRoutes)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/CMSRoutes/);
  });
