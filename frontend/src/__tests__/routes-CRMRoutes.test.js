/**
 * Auto-generated tests for routes/CRMRoutes.jsx
...
const SRC = path.resolve(__dirname, '../routes/CRMRoutes.jsx');

describe('routes/CRMRoutes.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (CRMRoutes)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/CRMRoutes/);
  });
