/**
 * Auto-generated tests for routes/ChatRoutes.jsx
...
const SRC = path.resolve(__dirname, '../routes/ChatRoutes.jsx');

describe('routes/ChatRoutes.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (ChatRoutes)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/ChatRoutes/);
  });
