/**
 * Auto-generated tests for routes/CommunityRoutes.jsx
...
const SRC = path.resolve(__dirname, '../routes/CommunityRoutes.jsx');

describe('routes/CommunityRoutes.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (CommunityRoutes)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/CommunityRoutes/);
  });
