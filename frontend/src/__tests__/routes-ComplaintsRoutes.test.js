/**
 * Auto-generated tests for routes/ComplaintsRoutes.jsx
...
const SRC = path.resolve(__dirname, '../routes/ComplaintsRoutes.jsx');

describe('routes/ComplaintsRoutes.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (ComplaintsRoutes)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/ComplaintsRoutes/);
  });
