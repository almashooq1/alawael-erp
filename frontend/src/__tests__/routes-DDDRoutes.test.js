/**
 * Auto-generated tests for routes/DDDRoutes.jsx
 * Type: route | 562L | React | .jsx
 * @generated P#107 frontend universal generator (fs-based)
 */
const fs = require('fs');
const path = require('path');

const SRC = path.resolve(__dirname, '../routes/DDDRoutes.jsx');

describe('routes/DDDRoutes.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (DDDRoutes)', () => {
    ...
    expect(source).toMatch(/DDDRoutes/);
  });
