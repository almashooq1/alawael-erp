/**
 * Auto-generated tests for routes/DisabilityRoutes.jsx
...
const SRC = path.resolve(__dirname, '../routes/DisabilityRoutes.jsx');

describe('routes/DisabilityRoutes.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (DisabilityRoutes)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/DisabilityRoutes/);
  });
