/**
 * Auto-generated tests for routes/ECommerceRoutes.jsx
...
const SRC = path.resolve(__dirname, '../routes/ECommerceRoutes.jsx');

describe('routes/ECommerceRoutes.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (ECommerceRoutes)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/ECommerceRoutes/);
  });
