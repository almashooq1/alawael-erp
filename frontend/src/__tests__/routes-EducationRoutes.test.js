/**
 * Auto-generated tests for routes/EducationRoutes.jsx
 * Type: route | 131L | React | .jsx
 * @generated P#107 frontend universal generator (fs-based)
 */
const fs = require('fs');
const path = require('path');

const SRC = path.resolve(__dirname, '../routes/EducationRoutes.jsx');

describe('routes/EducationRoutes.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (EducationRoutes)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/EducationRoutes/);
  });
  ...
  test('file structure', () => {
    // Type: route | Lines: 131 | React: true | Ext: .jsx
    expect(source.split('\n').length).toBe(131);
  });
});
