/**
 * Auto-generated tests for routes/FacilityRoutes.jsx
...
const SRC = path.resolve(__dirname, '../routes/FacilityRoutes.jsx');

describe('routes/FacilityRoutes.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (FacilityRoutes)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/FacilityRoutes/);
  });
