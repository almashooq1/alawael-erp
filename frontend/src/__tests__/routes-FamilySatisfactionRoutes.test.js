/**
 * Auto-generated tests for routes/FamilySatisfactionRoutes.jsx
 * Type: route | 16L | React | .jsx
 * @generated P#107 frontend universal generator (fs-based)
 */
const fs = require('fs');
const path = require('path');

const SRC = path.resolve(__dirname, '../routes/FamilySatisfactionRoutes.jsx');

describe('routes/FamilySatisfactionRoutes.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (FamilySatisfactionRoutes)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/FamilySatisfactionRoutes/);
  });
