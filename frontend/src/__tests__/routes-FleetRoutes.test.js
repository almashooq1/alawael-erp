/**
 * Auto-generated tests for routes/FleetRoutes.jsx
...
const SRC = path.resolve(__dirname, '../routes/FleetRoutes.jsx');

describe('routes/FleetRoutes.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (FleetRoutes)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/FleetRoutes/);
  });
