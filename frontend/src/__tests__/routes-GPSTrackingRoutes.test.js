/**
 * Auto-generated tests for routes/GPSTrackingRoutes.jsx
...
const SRC = path.resolve(__dirname, '../routes/GPSTrackingRoutes.jsx');

describe('routes/GPSTrackingRoutes.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (GPSTrackingRoutes)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/GPSTrackingRoutes/);
  });
