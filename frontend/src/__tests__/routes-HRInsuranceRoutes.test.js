/**
 * Auto-generated tests for routes/HRInsuranceRoutes.jsx
...
const SRC = path.resolve(__dirname, '../routes/HRInsuranceRoutes.jsx');

describe('routes/HRInsuranceRoutes.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (HRInsuranceRoutes)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/HRInsuranceRoutes/);
  });
