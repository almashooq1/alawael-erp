/**
 * Auto-generated tests for routes/HRRoutes.jsx
 * Type: route | 128L | React | .jsx
 * @generated P#107 frontend universal generator (fs-based)
 */
const fs = require('fs');
const path = require('path');

const SRC = path.resolve(__dirname, '../routes/HRRoutes.jsx');

describe('routes/HRRoutes.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (HRRoutes)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/HRRoutes/);
  });
  ...
  test('file structure', () => {
    // Type: route | Lines: 128 | React: true | Ext: .jsx
    expect(source.split('\n').length).toBe(128);
  });
});
