/**
 * Auto-generated tests for routes/HSERoutes.jsx
...
const SRC = path.resolve(__dirname, '../routes/HSERoutes.jsx');

describe('routes/HSERoutes.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (HSERoutes)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/HSERoutes/);
  });
