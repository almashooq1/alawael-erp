/**
 * Auto-generated tests for routes/HelpDeskRoutes.jsx
...
const SRC = path.resolve(__dirname, '../routes/HelpDeskRoutes.jsx');

describe('routes/HelpDeskRoutes.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (HelpDeskRoutes)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/HelpDeskRoutes/);
  });
