/**
 * Auto-generated tests for routes/ICFAssessmentRoutes.jsx
 * Type: route | 19L | React | .jsx
 * @generated P#107 frontend universal generator (fs-based)
 */
const fs = require('fs');
const path = require('path');

const SRC = path.resolve(__dirname, '../routes/ICFAssessmentRoutes.jsx');

describe('routes/ICFAssessmentRoutes.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (ICFAssessmentRoutes)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/ICFAssessmentRoutes/);
  });
