/**
 * Auto-generated tests for routes/IndependentLivingRoutes.jsx
...
const SRC = path.resolve(__dirname, '../routes/IndependentLivingRoutes.jsx');

describe('routes/IndependentLivingRoutes.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (IndependentLivingRoutes)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/IndependentLivingRoutes/);
  });
