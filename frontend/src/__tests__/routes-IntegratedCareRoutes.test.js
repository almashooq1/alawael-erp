/**
 * Auto-generated tests for routes/IntegratedCareRoutes.jsx
...
const SRC = path.resolve(__dirname, '../routes/IntegratedCareRoutes.jsx');

describe('routes/IntegratedCareRoutes.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (IntegratedCareRoutes)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/IntegratedCareRoutes/);
  });
