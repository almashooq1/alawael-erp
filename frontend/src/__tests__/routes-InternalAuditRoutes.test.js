/**
 * Auto-generated tests for routes/InternalAuditRoutes.jsx
...
const SRC = path.resolve(__dirname, '../routes/InternalAuditRoutes.jsx');

describe('routes/InternalAuditRoutes.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (InternalAuditRoutes)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/InternalAuditRoutes/);
  });
