/**
 * Auto-generated tests for routes/IoTRoutes.jsx
...
const SRC = path.resolve(__dirname, '../routes/IoTRoutes.jsx');

describe('routes/IoTRoutes.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (IoTRoutes)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/IoTRoutes/);
  });
