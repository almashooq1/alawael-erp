/**
 * Auto-generated tests for routes/KitchenRoutes.jsx
...
const SRC = path.resolve(__dirname, '../routes/KitchenRoutes.jsx');

describe('routes/KitchenRoutes.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (KitchenRoutes)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/KitchenRoutes/);
  });
