/**
 * Auto-generated tests for routes/LaundryRoutes.jsx
...
const SRC = path.resolve(__dirname, '../routes/LaundryRoutes.jsx');

describe('routes/LaundryRoutes.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (LaundryRoutes)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/LaundryRoutes/);
  });
