/**
 * Auto-generated tests for routes/LegalAffairsRoutes.jsx
...
const SRC = path.resolve(__dirname, '../routes/LegalAffairsRoutes.jsx');

describe('routes/LegalAffairsRoutes.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (LegalAffairsRoutes)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/LegalAffairsRoutes/);
  });
