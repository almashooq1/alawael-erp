/**
 * Auto-generated tests for routes/LibraryRoutes.jsx
...
const SRC = path.resolve(__dirname, '../routes/LibraryRoutes.jsx');

describe('routes/LibraryRoutes.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (LibraryRoutes)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/LibraryRoutes/);
  });
