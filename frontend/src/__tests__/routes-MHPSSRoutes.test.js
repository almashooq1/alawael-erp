/**
 * Auto-generated tests for routes/MHPSSRoutes.jsx
...
const SRC = path.resolve(__dirname, '../routes/MHPSSRoutes.jsx');

describe('routes/MHPSSRoutes.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (MHPSSRoutes)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/MHPSSRoutes/);
  });
