/**
 * Auto-generated tests for routes/MedicalFilesRoutes.jsx
...
const SRC = path.resolve(__dirname, '../routes/MedicalFilesRoutes.jsx');

describe('routes/MedicalFilesRoutes.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (MedicalFilesRoutes)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/MedicalFilesRoutes/);
  });
