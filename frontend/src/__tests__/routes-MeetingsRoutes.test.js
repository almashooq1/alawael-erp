/**
 * Auto-generated tests for routes/MeetingsRoutes.jsx
...
const SRC = path.resolve(__dirname, '../routes/MeetingsRoutes.jsx');

describe('routes/MeetingsRoutes.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (MeetingsRoutes)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/MeetingsRoutes/);
  });
