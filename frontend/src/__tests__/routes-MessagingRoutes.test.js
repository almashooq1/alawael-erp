/**
 * Auto-generated tests for routes/MessagingRoutes.jsx
...
const SRC = path.resolve(__dirname, '../routes/MessagingRoutes.jsx');

describe('routes/MessagingRoutes.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (MessagingRoutes)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/MessagingRoutes/);
  });
