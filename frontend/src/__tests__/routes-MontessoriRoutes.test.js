/**
 * Auto-generated tests for routes/MontessoriRoutes.jsx
...
const SRC = path.resolve(__dirname, '../routes/MontessoriRoutes.jsx');

describe('routes/MontessoriRoutes.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (MontessoriRoutes)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/MontessoriRoutes/);
  });
