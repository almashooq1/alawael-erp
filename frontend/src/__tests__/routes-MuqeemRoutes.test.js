/**
 * Auto-generated tests for routes/MuqeemRoutes.jsx
...
const SRC = path.resolve(__dirname, '../routes/MuqeemRoutes.jsx');

describe('routes/MuqeemRoutes.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (MuqeemRoutes)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/MuqeemRoutes/);
  });
