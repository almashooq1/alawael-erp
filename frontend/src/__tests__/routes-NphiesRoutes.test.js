/**
 * Auto-generated tests for routes/NphiesRoutes.jsx
...
const SRC = path.resolve(__dirname, '../routes/NphiesRoutes.jsx');

describe('routes/NphiesRoutes.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (NphiesRoutes)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/NphiesRoutes/);
  });
