/**
 * Auto-generated tests for routes/OCRDocumentRoutes.jsx
...
const SRC = path.resolve(__dirname, '../routes/OCRDocumentRoutes.jsx');

describe('routes/OCRDocumentRoutes.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (OCRDocumentRoutes)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/OCRDocumentRoutes/);
  });
