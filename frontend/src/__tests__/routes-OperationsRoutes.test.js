/**
 * Auto-generated tests for routes/OperationsRoutes.jsx
...
const SRC = path.resolve(__dirname, '../routes/OperationsRoutes.jsx');

describe('routes/OperationsRoutes.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (OperationsRoutes)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/OperationsRoutes/);
  });
