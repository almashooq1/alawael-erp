/**
 * Auto-generated tests for routes/OrgStructureRoutes.jsx
...
const SRC = path.resolve(__dirname, '../routes/OrgStructureRoutes.jsx');

describe('routes/OrgStructureRoutes.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (OrgStructureRoutes)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/OrgStructureRoutes/);
  });
