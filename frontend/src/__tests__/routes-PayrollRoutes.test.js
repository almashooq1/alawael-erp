/**
 * Auto-generated tests for routes/PayrollRoutes.jsx
...
const SRC = path.resolve(__dirname, '../routes/PayrollRoutes.jsx');

describe('routes/PayrollRoutes.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (PayrollRoutes)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/PayrollRoutes/);
  });
