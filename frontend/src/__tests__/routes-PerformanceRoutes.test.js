/**
 * Auto-generated tests for routes/PerformanceRoutes.jsx
...
const SRC = path.resolve(__dirname, '../routes/PerformanceRoutes.jsx');

describe('routes/PerformanceRoutes.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (PerformanceRoutes)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/PerformanceRoutes/);
  });
