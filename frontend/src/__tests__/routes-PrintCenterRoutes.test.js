/**
 * Auto-generated tests for routes/PrintCenterRoutes.jsx
...
const SRC = path.resolve(__dirname, '../routes/PrintCenterRoutes.jsx');

describe('routes/PrintCenterRoutes.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (PrintCenterRoutes)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/PrintCenterRoutes/);
  });
