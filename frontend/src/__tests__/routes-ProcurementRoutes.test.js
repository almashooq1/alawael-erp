/**
 * Auto-generated tests for routes/ProcurementRoutes.jsx
...
const SRC = path.resolve(__dirname, '../routes/ProcurementRoutes.jsx');

describe('routes/ProcurementRoutes.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (ProcurementRoutes)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/ProcurementRoutes/);
  });
