/**
 * Auto-generated tests for routes/QualityManagementRoutes.jsx
...
const SRC = path.resolve(__dirname, '../routes/QualityManagementRoutes.jsx');

describe('routes/QualityManagementRoutes.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (QualityManagementRoutes)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/QualityManagementRoutes/);
  });
