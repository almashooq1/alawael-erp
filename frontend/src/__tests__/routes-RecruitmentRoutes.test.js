/**
 * Auto-generated tests for routes/RecruitmentRoutes.jsx
...
const SRC = path.resolve(__dirname, '../routes/RecruitmentRoutes.jsx');

describe('routes/RecruitmentRoutes.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (RecruitmentRoutes)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/RecruitmentRoutes/);
  });
