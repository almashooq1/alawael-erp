/**
 * Auto-generated tests for routes/ReportBuilderRoutes.jsx
...
const SRC = path.resolve(__dirname, '../routes/ReportBuilderRoutes.jsx');

describe('routes/ReportBuilderRoutes.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (ReportBuilderRoutes)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/ReportBuilderRoutes/);
  });
