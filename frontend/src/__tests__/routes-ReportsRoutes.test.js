/**
 * Auto-generated tests for routes/ReportsRoutes.jsx
...
const SRC = path.resolve(__dirname, '../routes/ReportsRoutes.jsx');

describe('routes/ReportsRoutes.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (ReportsRoutes)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/ReportsRoutes/);
  });
