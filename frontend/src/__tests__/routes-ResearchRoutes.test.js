/**
 * Auto-generated tests for routes/ResearchRoutes.jsx
...
const SRC = path.resolve(__dirname, '../routes/ResearchRoutes.jsx');

describe('routes/ResearchRoutes.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (ResearchRoutes)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/ResearchRoutes/);
  });
