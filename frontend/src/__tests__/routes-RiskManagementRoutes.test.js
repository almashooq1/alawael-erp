/**
 * Auto-generated tests for routes/RiskManagementRoutes.jsx
...
const SRC = path.resolve(__dirname, '../routes/RiskManagementRoutes.jsx');

describe('routes/RiskManagementRoutes.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (RiskManagementRoutes)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/RiskManagementRoutes/);
  });
