/**
 * Auto-generated tests for routes/SSOAdminRoutes.jsx
...
const SRC = path.resolve(__dirname, '../routes/SSOAdminRoutes.jsx');

describe('routes/SSOAdminRoutes.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (SSOAdminRoutes)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/SSOAdminRoutes/);
  });
