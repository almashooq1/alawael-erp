/**
 * Auto-generated tests for routes/SessionsRoutes.jsx
...
const SRC = path.resolve(__dirname, '../routes/SessionsRoutes.jsx');

describe('routes/SessionsRoutes.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (SessionsRoutes)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/SessionsRoutes/);
  });
