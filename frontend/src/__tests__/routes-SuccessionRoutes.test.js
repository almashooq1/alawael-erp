/**
 * Auto-generated tests for routes/SuccessionRoutes.jsx
...
const SRC = path.resolve(__dirname, '../routes/SuccessionRoutes.jsx');

describe('routes/SuccessionRoutes.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (SuccessionRoutes)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/SuccessionRoutes/);
  });
