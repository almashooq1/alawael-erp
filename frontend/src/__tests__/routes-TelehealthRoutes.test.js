/**
 * Auto-generated tests for routes/TelehealthRoutes.jsx
...
const SRC = path.resolve(__dirname, '../routes/TelehealthRoutes.jsx');

describe('routes/TelehealthRoutes.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (TelehealthRoutes)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/TelehealthRoutes/);
  });
