/**
 * Auto-generated tests for routes/TrainingRoutes.jsx
...
const SRC = path.resolve(__dirname, '../routes/TrainingRoutes.jsx');

describe('routes/TrainingRoutes.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (TrainingRoutes)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/TrainingRoutes/);
  });
