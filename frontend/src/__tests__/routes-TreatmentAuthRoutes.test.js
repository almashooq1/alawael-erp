/**
 * Auto-generated tests for routes/TreatmentAuthRoutes.jsx
...
const SRC = path.resolve(__dirname, '../routes/TreatmentAuthRoutes.jsx');

describe('routes/TreatmentAuthRoutes.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (TreatmentAuthRoutes)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/TreatmentAuthRoutes/);
  });
