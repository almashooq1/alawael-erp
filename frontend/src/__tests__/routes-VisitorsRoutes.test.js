/**
 * Auto-generated tests for routes/VisitorsRoutes.jsx
...
const SRC = path.resolve(__dirname, '../routes/VisitorsRoutes.jsx');

describe('routes/VisitorsRoutes.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (VisitorsRoutes)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/VisitorsRoutes/);
  });
