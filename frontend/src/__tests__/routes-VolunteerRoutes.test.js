/**
 * Auto-generated tests for routes/VolunteerRoutes.jsx
...
const SRC = path.resolve(__dirname, '../routes/VolunteerRoutes.jsx');

describe('routes/VolunteerRoutes.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (VolunteerRoutes)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/VolunteerRoutes/);
  });
