/**
 * Auto-generated tests for routes/WafRateLimitRoutes.jsx
...
const SRC = path.resolve(__dirname, '../routes/WafRateLimitRoutes.jsx');

describe('routes/WafRateLimitRoutes.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (WafRateLimitRoutes)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/WafRateLimitRoutes/);
  });
