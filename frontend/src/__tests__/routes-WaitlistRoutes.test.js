/**
 * Auto-generated tests for routes/WaitlistRoutes.jsx
...
const SRC = path.resolve(__dirname, '../routes/WaitlistRoutes.jsx');

describe('routes/WaitlistRoutes.jsx', () => {
  let source;
  beforeAll(() => {
  ...
  test('has default export (WaitlistRoutes)', () => {
    expect(source).toMatch(/export\s+default/);
    expect(source).toMatch(/WaitlistRoutes/);
  });
