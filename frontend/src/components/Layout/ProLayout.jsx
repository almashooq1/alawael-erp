    ...
    if (this.state.hasError) {
      return (
        <div
          ...
          style={{ width: this.props.width || 72, height: '100vh', background: '#0A1628' }}
        >
  ...
  return (
    <div id="tailwind-scope" dir="rtl" className="font-cairo">
      <div
        ...
        style={{ backgroundColor: isDark ? '#0B1120' : '#F5F7FA' }}
      >
        ...
        <div className="fixed inset-0 pointer-events-none z-0">
          ...
          {isDark && (
            <div
              ...
              style={{
                background: 'radial-gradient(circle, #4CAF50, transparent 60%)',
                filter: 'blur(80px)',
              }}
            />
          )}
