  ...
  <>
    ...
    {isSectionVisible('finance') && (
      <SectionErrorFallback label="المالية" aria-labelledby="section-finance-heading">
        <SectionDivider
          ...
          onToggle={() => dispatch({ type: 'TOGGLE_SECTION', id: 'finance' })}
        />
    ...
    {isSectionVisible('charts') && (
      <SectionErrorFallback label="الرسوم البيانية" aria-labelledby="section-charts-heading">
        <SectionDivider
          ...
          onToggle={() => dispatch({ type: 'TOGGLE_SECTION', id: 'charts' })}
        />
    ...
    {isSectionVisible('clinical') && (
      <SectionErrorFallback label="السريرية" aria-labelledby="section-clinical-heading">
        <SectionDivider
          label="🏥 الخدمات السريرية والتأهيلية"
          id="section-clinical"
          collapsed={collapsedSections.clinical}
          onToggle={() => dispatch({ type: 'TOGGLE_SECTION', id: 'clinical' })}
        />
    ...
    {isSectionVisible('hr') && (
      <SectionErrorFallback label="الموارد البشرية" aria-labelledby="section-hr-heading">
        <SectionDivider
          ...
          id="section-hr"
          collapsed={collapsedSections.hr}
          onToggle={() => dispatch({ type: 'TOGGLE_SECTION', id: 'hr' })}
        />
    ...
    {isSectionVisible('operations') && (
      <SectionErrorFallback label="العمليات" aria-labelledby="section-operations-heading">
        <SectionDivider
          label="⚙️ العمليات والخدمات اللوجستية"
          id="section-operations"
          collapsed={collapsedSections.operations}
          onToggle={() => dispatch({ type: 'TOGGLE_SECTION', id: 'operations' })}
        />
    ...
    {isSectionVisible('modules') && (
      <SectionErrorFallback label="الوحدات" aria-labelledby="section-modules-heading">
        <SectionDivider
          ...
          onToggle={() => dispatch({ type: 'TOGGLE_SECTION', id: 'modules' })}
        />
    ...
    {isSectionVisible('quick') && (
      <SectionErrorFallback label="إجراءات سريعة" aria-labelledby="section-quick-heading">
        <SectionDivider
          label="⚡ إجراءات سريعة"
          id="section-quick"
          collapsed={collapsedSections.quick}
          onToggle={() => dispatch({ type: 'TOGGLE_SECTION', id: 'quick' })}
        />
    ...
    {isSectionVisible('activity') && (
      <SectionErrorFallback label="النشاط" aria-labelledby="section-activity-heading">
        <SectionDivider
          label="📋 النشاط وصحة النظام"
          id="section-activity"
          collapsed={collapsedSections.activity}
          onToggle={() => dispatch({ type: 'TOGGLE_SECTION', id: 'activity' })}
        />
