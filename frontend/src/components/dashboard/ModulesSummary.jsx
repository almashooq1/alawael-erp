      ...
      >
        <Paper
          ...
          sx={{
            ...
            boxShadow: isDark ? '0 4px 16px rgba(0,0,0,0.25)' : '0 4px 16px rgba(0,0,0,0.05)',
      ...
      [
        {
          ...
          icon: 'People',
          stats: { total: kpis.users?.total || 0, active: kpis.users?.active || 0 },
        ...
        },
        {
          ...
          icon: 'Accessibility',
          stats: { total: kpis.beneficiaries?.total || 0, active: kpis.beneficiaries?.active || 0 },
          path: '/beneficiaries',
        },
        {
          name: 'hr',
          ...
          icon: 'Badge',
          stats: { total: kpis.employees?.total || 0 },
          path: '/hr',
        },
        {
          name: 'sessions',
          label: 'إدارة الجلسات',
          icon: 'EventNote',
          stats: { total: kpis.sessions?.total || 0, today: kpis.sessions?.today || 0 },
          path: '/sessions',
        },
        {
          name: 'finance',
          label: 'المالية',
          icon: 'AccountBalance',
          stats: { total: kpis.payments?.total || 0, pending: kpis.invoices?.pending || 0 },
          path: '/finance',
        },
        {
          name: 'supply',
          ...
          icon: 'LocalShipping',
          stats: {
            total: supplyChain.suppliers?.total || 0,
            inventory: supplyChain.inventory?.total || 0,
          },
          path: '/procurement',
        },
        {
          ...
          label: 'إدارة الأسطول',
          icon: 'DirectionsCar',
          stats: { total: fleet.vehicles?.total || 0 },
          path: '/fleet',
        },
        {
          name: 'crm',
          label: 'إدارة العملاء',
          icon: 'Contacts',
          stats: { total: operations.leads?.total || 0 },
          path: '/crm',
        },
        {
          name: 'maintenance',
          label: 'الصيانة',
          icon: 'Build',
          stats: { open: operations.maintenance?.open || 0 },
          path: '/operations',
        },
        {
          name: 'documents',
          label: 'المستندات',
          icon: 'Description',
          stats: { total: kpis.documents?.total || 0 },
          path: '/documents',
        },
