    ...
    >
      <Paper
        ...
        sx={{
          ...
          boxShadow: isDark ? '0 8px 32px rgba(0,0,0,0.35)' : '0 8px 32px rgba(102,126,234,0.08)',
        }}
      >
        {/* Accent bar */}
        <Box
        ...
        >
          ...
          >
            <Typography
              sx={{ fontSize: '1.3rem', fontWeight: 900, color: scoreColor, lineHeight: 1 }}
            >
              {overallScore}
            </Typography>
            <Typography
              sx={{ fontSize: '0.55rem', fontWeight: 700, color: scoreColor, lineHeight: 1.2 }}
            >
              تحقق
            </Typography>
