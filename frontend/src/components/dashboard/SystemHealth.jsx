...
import { Box, Paper, Typography, Chip, useTheme, Tooltip, LinearProgress } from '@mui/material';
    ...
    <Tooltip title={`${label}: ${Math.round(percent)}%`} arrow placement="top">
      ...
      >
        ...
        >
          ...
          >
            {Math.round(percent)}
            <Box component="span" sx={{ fontSize: '0.55rem', fontWeight: 600 }}>
              %
            </Box>
          </Typography>
          {label && (
            <Typography
              sx={{ fontSize: '0.5rem', color: 'text.disabled', mt: 0.2, letterSpacing: 0 }}
            >
              {label}
            </Typography>
          )}
  ...
  return (
    ...
    >
      ...
      <Box sx={{ flex: 1, minWidth: 0 }}>
        <Typography
          variant="caption"
          sx={{ fontSize: '0.65rem', color: 'text.disabled', display: 'block', lineHeight: 1.2 }}
        >
          {label}
        </Typography>
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* ── Stat Rows ───────────────────── */}
        <Box
          sx={{ display: 'flex', flexDirection: 'column', gap: 1, position: 'relative', zIndex: 1 }}
        >
          <StatRow
            icon={<StorageIcon />}
