...
const UPCOMING_EVENTS = [
  ...
  {
    id: 5,
    title: 'تذكير: موعد تجديد الترخيص',
    type: 'reminder',
    time: '10:00',
    endTime: '10:00',
    location: '',
  ...
  {
    id: 7,
    title: 'جلسة علاج النطق - سارة',
    type: 'session',
    time: '15:00',
    endTime: '15:45',
    location: 'غرفة العلاج 1',
    date: '2026-03-20',
    attendees: 2,
  },
];
                              ...
                              secondary={
                                <Box sx={{ display: 'flex', gap: 1, mt: 0.3, flexWrap: 'wrap' }}>
                                  <Chip
                                    ...
                                    label={`${event.time} - ${event.endTime}`}
                                    sx={{ height: 18, fontSize: '0.55rem' }}
                                  />
                                  {event.location && (
                                    <Chip
                                      size="small"
                                      icon={<LocationOnIcon sx={{ fontSize: '10px !important' }} />}
                                  ...
                                  {event.attendees > 0 && (
                                    <Chip
                                      size="small"
                                      icon={<GroupIcon sx={{ fontSize: '10px !important' }} />}
                                      label={`${event.attendees} حضور`}
                                      sx={{ height: 18, fontSize: '0.55rem' }}
                                    />
                                  )}
                                </Box>
                          ...
                          >
                            ...
                            <ListItemText
                              ...
                              secondary={
                                ...
                                >
                                  {event.time} — {DAYS_AR[eventDate.getDay()]} {eventDate.getDate()}{' '}
                                  {MONTHS_AR[eventDate.getMonth()]}
                                </Typography>
                              }
                            />
                          </ListItem>
