...
const INITIAL_TASKS = [
  {
    ...
    desc: 'مراجعة وتحليل تقارير أداء جميع الأقسام',
    priority: 'urgent',
    status: 'inProgress',
    assignee: 'أحمد',
    dueDate: '2026-03-20',
  ...
  {
    id: 2,
    title: 'إعداد خطة التدريب Q2',
    desc: 'تحضير خطة التدريب للربع الثاني',
    priority: 'high',
    status: 'todo',
    assignee: 'فاطمة',
    dueDate: '2026-03-25',
  ...
  },
  {
    ...
    desc: 'مراجعة وتحديث سياسات الأمان السيبراني',
    priority: 'high',
    status: 'review',
    assignee: 'محمد',
    dueDate: '2026-03-18',
  ...
  },
  {
    ...
    desc: 'تحضير عرض تقديمي لاجتماع مجلس الإدارة',
    priority: 'urgent',
    status: 'todo',
    assignee: 'نورة',
    dueDate: '2026-03-19',
  ...
  },
  {
    ...
    desc: 'تحسين استعلامات وفهارس قاعدة البيانات',
    priority: 'medium',
    status: 'inProgress',
    assignee: 'خالد',
    dueDate: '2026-03-22',
  ...
  {
    id: 6,
    title: 'ترقية النظام v3.5',
    desc: 'نشر التحديث الجديد للنظام',
    priority: 'medium',
    status: 'done',
    assignee: 'سارة',
    dueDate: '2026-03-15',
  ...
  },
  {
    ...
    desc: 'إعداد تقرير الميزانية المقارن',
    priority: 'low',
    status: 'done',
    assignee: 'عبدالله',
    dueDate: '2026-03-14',
  ...
  {
    id: 8,
    title: 'ورشة عمل فريق الدعم',
    desc: 'تنظيم ورشة عمل لتطوير مهارات فريق الدعم',
    priority: 'low',
    status: 'todo',
    assignee: 'ريم',
    dueDate: '2026-03-28',
  ...
  const filteredTasks = useMemo(() => {
    ...
    if (searchQuery.trim()) {
      ...
      result = result.filter(
        t => t.title.includes(q) || t.desc?.includes(q) || t.assignee?.includes(q)
      );
    }
    ...
    >
      ...
      >
        ...
        >
          <Box>
            ...
            <Box sx={{ display: 'flex', gap: 1, mt: 0.5 }}>
              <Chip
                size="small"
                label={`${stats.done}/${stats.total} مكتمل`}
                sx={{
                  height: 20,
                  fontSize: '0.6rem',
              ...
              <Chip
                size="small"
                label={`${stats.inProgress} جاري`}
                sx={{
                  height: 20,
                  fontSize: '0.6rem',
                  bgcolor: `${brandColors.primaryStart}15`,
                  color: brandColors.primaryStart,
                }}
              />
              {stats.overdue > 0 && (
                ...
                >
                  ...
                  >
                    <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
                      <Box
                        sx={{ width: 8, height: 8, borderRadius: '50%', bgcolor: config.color }}
                      />
        ...
        >
          ...
          <DialogActions>
            <Button onClick={() => setShowAddDialog(false)} size="small">
              إلغاء
            </Button>
            <Button
              onClick={addTask}
