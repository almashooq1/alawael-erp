...
import { AddCircleOutline, RefreshOutlined, InboxOutlined } from '@mui/icons-material';
...
const illustrations = {
  empty: ({ color, size }) => (
    <svg width={size} height={size} viewBox="0 0 120 120" fill="none">
      ...
      <circle cx="60" cy="60" r="36" fill={alpha(color, 0.1)} />
      <path
        d="M44 52h32M44 60h24M44 68h16"
        stroke={color}
        strokeWidth="2.5"
        strokeLinecap="round"
        opacity="0.4"
  ...
  search: ({ color, size }) => (
    <svg width={size} height={size} viewBox="0 0 120 120" fill="none">
      ...
      />
      <path
        d="M73 70l8 8a3 3 0 010 4l-1 1a3 3 0 01-4 0l-8-8"
      ...
      />
      <path
        d="M42 40l-4-4M62 40l4-4M42 64l-4 4M62 64l4 4"
        stroke={color}
        strokeWidth="1.5"
        strokeLinecap="round"
        opacity="0.2"
  ...
  noData: ({ color, size }) => (
    <svg width={size} height={size} viewBox="0 0 120 120" fill="none">
      ...
      />
      <path
        d="M58 55l6 6-6 6M50 55l-6 6 6 6"
        stroke={color}
        strokeWidth="2"
        strokeLinecap="round"
  ...
  offline: ({ color, size }) => (
    <svg width={size} height={size} viewBox="0 0 120 120" fill="none">
      <path
        d="M30 70c0-16.6 13.4-30 30-30s30 13.4 30 30"
        stroke={color}
        strokeWidth="2"
        strokeLinecap="round"
        opacity="0.3"
...
const DataPlaceholder = memo(function DataPlaceholder({
  ...
  // isDark removed — not used in render
