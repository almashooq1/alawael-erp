  ...
  about: {
    ...
    values: [
      ...
      { icon: '🌟', iconKey: 'star', title: 'التميّز', desc: 'معايير عالمية في جميع خدماتنا' },
      {
        ...
        title: 'الأمان',
        desc: 'بيئة آمنة ومراقبة على مدار الساعة',
      },
    ],
  },
  ...
  gallery: {
    ...
    items: [
      ...
      },
      {
        ...
        src: 'https://images.unsplash.com/photo-1498940757830-82f7813bf178?w=1200&q=70&auto=format&fit=crop',
      ...
      },
      {
        ...
        src: 'https://images.unsplash.com/photo-1740635341299-3b8e3490f546?w=1200&q=70&auto=format&fit=crop',
      ...
      },
      {
        ...
        src: 'https://images.unsplash.com/photo-1778855400233-f11b92681379?w=1200&q=70&auto=format&fit=crop',
        gradient: 'from-accent-400 to-accent-600',
        icon: '🖐️',
      },
      {
        ...
        src: 'https://images.unsplash.com/photo-1760727408754-c5c9ef169f8d?w=1200&q=70&auto=format&fit=crop',
        gradient: 'from-green-400 to-green-600',
        icon: '✨',
      },
      {
    ...
    items: [
      {
        ...
        detail: 'رخصة مركز تأهيل معتمد',
        icon: '🏛️',
        iconKey: 'building-library',
      },
      { name: 'هيئة رعاية ذوي الإعاقة', detail: 'عضو مسجّل', icon: '💙', iconKey: 'heart' },
      {
        name: 'هيئة التخصصات الصحية (SCFHS)',
        detail: 'أخصائيون مرخّصون',
        icon: '⚕️',
        iconKey: 'badge-check',
      },
      { name: 'ASHA', detail: 'أخصائيات نطق معتمدات دولياً', icon: '🎓', iconKey: 'academic-cap' },
      { name: 'BACB', detail: 'محلّلو سلوك تطبيقي (BCBA)', icon: '📜', iconKey: 'document-text' },
      { name: 'CARF', detail: 'توافق معايير الجودة', icon: '🌍', iconKey: 'globe' },
    ],
  },
