...
const recentDecisions = [
  {
    id: 'Q-2024-042',
    title: 'اعتماد خطة التوسع الجديدة',
    dept: 'مجلس الإدارة',
    date: '٢٠٢٦/٠١/١٥',
    status: 'مُنفَّذ',
    priority: 'عالية',
  ...
  {
    id: 'Q-2024-043',
    title: 'تعيين مدير تقنية المعلومات',
  ...
  {
    id: 'Q-2024-045',
    title: 'إطلاق برنامج التدريب السنوي',
    dept: 'التدريب',
    date: '٢٠٢٦/٠٢/١٠',
    status: 'مُنفَّذ',
    priority: 'متوسطة',
  ...
  {
    id: 'Q-2024-046',
    title: 'تجديد عقود الموردين الرئيسيين',
    dept: 'المشتريات',
    date: '٢٠٢٦/٠٢/١٨',
    status: 'معلّق',
    priority: 'منخفضة',
...
const KPI_CARDS = [
  ...
  },
  {
    label: 'عقد إداري نشط',
    value: '٦٢',
    sub: '١٢ للتجديد قريباً',
    icon: AssignmentIcon,
    color: '#f59e0b',
  },
  {
    label: 'موظف في الدوام',
    value: '٢٣١',
    sub: 'من إجمالي ٢٤٨',
    icon: PeopleAltIcon,
    color: '#ec4899',
  ...
  {
    label: 'هدف استراتيجي مُحقَّق',
    value: '١٨/٢٤',
    sub: '٧٥٪ من الخطة السنوية',
    icon: FlagIcon,
    color: '#dc2626',
  },
];
    ...
    >
      ...
      {payload.map((p, i) => (
        <Box key={i} sx={{ display: 'flex', alignItems: 'center', gap: 0.75 }}>
          ...
          <Typography sx={{ fontSize: '0.72rem', color: p.color }}>
    ...
    <Box sx={{ minHeight: '100vh', direction: 'rtl' }}>
            ...
            <Grid item xs={12} sm={6} md={4} lg={2} key={i}>
              ...
              >
                <GlassCard hoverGlow={`${kpi.color}44`} sx={{ p: 2 }}>
                  ...
                  <Typography
                    sx={{ fontSize: '1.5rem', fontWeight: 800, color: kpi.color, lineHeight: 1 }}
                  >
                    {kpi.value}
                  </Typography>
                  <Typography
      ...
      >
        <GlassCard sx={{ p: 2.5 }}>
          ...
          <Typography
            sx={{ fontSize: '0.75rem', color: isDark ? 'rgba(255,255,255,0.4)' : '#94A3B8', mb: 2 }}
          >
            ...
            <Table size="small">
              ...
              <TableBody>
                {recentDecisions.map((dec, i) => {
                  const s = statusConfig[dec.status] || {
                    color: '#94A3B8',
                    bg: 'rgba(148,163,184,0.1)',
                    icon: CheckCircleIcon,
                  };
                  const pr = priorityConfig[dec.priority] || {
                    color: '#94A3B8',
                    bg: 'rgba(148,163,184,0.1)',
                  };
                  const SIcon = s.icon;
