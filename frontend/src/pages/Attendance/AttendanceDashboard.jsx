    ...
    apiClient
      ...
      .catch(() => {
        setData({
          ...
          lateToday: 16,
          byStatus: [
            { status: 'حاضر', count: 278 },
            { status: 'غائب', count: 18 },
            { status: 'متأخر', count: 16 },
            { status: 'إجازة', count: 12 },
          ],
          weeklyTrend: [
          ...
          >
            <Box>
              ...
              <Typography variant="body2" color="text.secondary">
                متابعة حضور وانصراف الموظفين في الوقت الفعلي
              </Typography>
            </Box>
            <Chip
                ...
                <CardContent sx={{ p: '20px 24px !important' }}>
                  ...
                  >
                    <Box>
                      ...
                      <Typography
                        variant="h4"
                        sx={{ fontWeight: 800, mt: 0.5, mb: 0.5, lineHeight: 1.2 }}
                      >
                        {k.value}
                      </Typography>
                      {k.trend && (
                        <Box sx={{ display: 'flex', alignItems: 'center', gap: 0.5 }}>
                          ...
                          <Typography
                            variant="caption"
                            sx={{ color: k.up ? '#10b981' : '#ef4444', fontWeight: 600 }}
                          >
                            {k.trend}
                          </Typography>
                        </Box>
        ...
        <div>
          <Glass sx={{ p: 3, overflow: 'hidden' }}>
            ...
            >
              ...
              <Chip
                label={`${(data.recentRecords || []).length} سجل`}
                size="small"
                variant="outlined"
                sx={{ borderRadius: '8px', fontWeight: 500 }}
              />
