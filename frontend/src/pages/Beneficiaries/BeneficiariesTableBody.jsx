...
import { MoreVert, KeyboardArrowDown, KeyboardArrowUp, Star } from '@mui/icons-material';
                ...
                >
                  ...
                  <TableCell>
                    <Box display="flex" alignItems="center" gap={1}>
                      ...
                      {row.favorite && <Star fontSize="small" sx={{ color: '#ffc107' }} />}
                    </Box>
                  </TableCell>
                  ...
                  <TableCell>
                    <Typography variant="body2">{row.lastVisit || 'لا يوجد'}</Typography>
                  </TableCell>
                  <TableCell>
                    <IconButton
                      size="small"
