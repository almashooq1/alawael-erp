...
import { Edit, Visibility, Star, StarBorder, CalendarMonth } from '@mui/icons-material';
    ...
    >
      ...
      >
        ...
        >
          ...
          <IconButton
            size="small"
            onClick={() => onToggleFavorite(beneficiary.id || beneficiary._id)}
        ...
        {/* Progress Bar */}
        <Box
          sx={{ minWidth: viewMode === 'list' ? 160 : undefined, mb: viewMode === 'grid' ? 2 : 0 }}
        >
        ...
        >
          <Chip
            ...
            sx={{
              bgcolor: STATUS_COLORS[beneficiary.status] || neutralColors.inactive,
              color: 'white',
              fontWeight: 'bold',
            }}
          />
          ...
          <Tooltip title="تعديل">
            <span>
              <IconButton
                size="small"
                color="primary"
                onClick={() => onEdit(beneficiary.id || beneficiary._id)}
              >
                <Edit fontSize="small" />
              </IconButton>
            </span>
          </Tooltip>
          <Tooltip title="الجدول">
            <span>
