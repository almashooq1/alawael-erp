  ...
  return (
    ...
    >
      ...
      <Box>
        <Typography
          variant="caption"
          sx={{ color: 'text.secondary', fontWeight: 600, letterSpacing: 0.3 }}
        >
          {label}
        </Typography>
...
export default function BeneficiaryProfilePage() {
  ...
  const handleEdit = () => {
    ...
    setEditData({
      ...
      dateOfBirth: beneficiary?.dateOfBirth
        ? new Date(beneficiary.dateOfBirth).toISOString().slice(0, 10)
        : '',
  ...
  const fullName =
    b.fullName ||
    b.name ||
    `${b.firstName_ar || b.firstName || ''} ${b.lastName_ar || b.lastName || ''}`;
  const age =
    b.age ||
    (b.dateOfBirth
    ...
    <Container maxWidth="lg" sx={{ py: 3 }}>
            ...
            {!editing ? (
              <>
                <Button
                  ...
                  color="inherit"
                  startIcon={<Edit />}
                  sx={{ color: brandColors.primaryStart }}
                  onClick={handleEdit}
                >
                  تعديل
                </Button>
        ...
        >
          <Box sx={{ display: 'flex', justifyContent: 'space-between', mb: 1 }}>
            ...
            <Chip
              ...
              size="small"
              sx={{
                bgcolor: (b.progress || 0) >= 80 ? 'rgba(16,185,129,0.1)' : 'rgba(245,158,11,0.1)',
                color: (b.progress || 0) >= 80 ? '#059669' : '#D97706',
                fontWeight: 700,
                borderRadius: '8px',
                height: 24,
              }}
            ...
            <Grid container spacing={2}>
              ...
              <Grid item xs={12} sm={4}>
                <TextField
                  ...
                  onChange={e => setEditData(p => ({ ...p, nationalId: e.target.value }))}
                />
              </Grid>
              <Grid item xs={12} sm={6}>
                <TextField
              ...
              <Grid item xs={12}>
                <TextField
                  ...
                  onChange={e => setEditData(p => ({ ...p, generalNotes: e.target.value }))}
                />
              </Grid>
            </Grid>
          </Paper>
          ...
          <Grid container spacing={3}>
            ...
            <Grid item xs={12} md={6}>
              ...
              >
                ...
                <InfoField
                  label="الهاتف"
                  value={b.contactInfo?.primaryPhone || b.phone}
                  icon={<Phone fontSize="small" />}
                />
                <InfoField label="هاتف بديل" value={b.contactInfo?.alternatePhone} />
                <InfoField
                  label="البريد الإلكتروني"
                  value={b.contactInfo?.email || b.email}
            ...
            <Grid item xs={12} md={6}>
              ...
              >
                ...
                <InfoField
                  label="نوع الإعاقة"
                  value={
                    CATEGORY_LABELS[b.category || b.disability?.type] ||
                    b.category ||
                    b.disability?.type
                  }
                />
      ...
      <TabPanel value={tab} index={1}>
        <Grid container spacing={3}>
          ...
          {[
            {
              val: b.academicScore || b.latestProgress?.academicScore || 0,
              label: 'الدرجة الأكاديمية',
              gradient: 'linear-gradient(135deg, #667eea, #764ba2)',
              color: '#667eea',
            },
            {
              val: `${b.attendanceRate || b.latestProgress?.attendanceRate || 0}%`,
              label: 'نسبة الحضور',
              gradient: 'linear-gradient(135deg, #10b981, #059669)',
              color: statusColors.success,
            },
            {
              val: `${b.behaviorRating || b.latestProgress?.behaviorRating || 0}/10`,
              label: 'تقييم السلوك',
            ...
            <Grid item xs={6} sm={3} key={i}>
              ...
              >
                ...
                <Typography
                  variant="h4"
                  fontWeight={800}
                  sx={{ color: kpi.color, lineHeight: 1.2, mb: 0.5 }}
                >
                  {kpi.val}
                </Typography>
                <Typography
                    ...
                    <tbody>
                      {progressHistory.map((p, i) => (
                        ...
                        >
                          ...
                          <td
                            style={{ textAlign: 'center', padding: '12px 16px', fontWeight: 600 }}
                          >
                            {p.academicScore}
                          </td>
                          <td
                          ...
                          <td style={{ textAlign: 'center', padding: '12px 16px' }}>
                            <Chip
                              size="small"
                              label={
                                p.overallPerformance === 'excellent'
                                  ? 'ممتاز'
                                  : p.overallPerformance === 'good'
                                    ? 'جيد'
                                    : p.overallPerformance === 'satisfactory'
                                      ? 'مقبول'
                                      : 'يحتاج تحسين'
                              }
                              sx={{
        ...
        <Grid container spacing={3}>
          <Grid item xs={12} md={6}>
            ...
            >
              ...
              <InfoField
                ...
                value={(b.medicalInfo?.conditions || []).join('، ') || null}
              />
              <InfoField
                label="الحساسية"
                value={(b.medicalInfo?.allergies || []).join('، ') || null}
              />
          ...
          <Grid item xs={12} md={6}>
            ...
            >
              ...
              <InfoField
                ...
                value={b.educationInfo?.currentLevel || b.currentLevel}
              />
              <InfoField label="الصف" value={b.educationInfo?.gradeLevel} />
              <InfoField label="المدرسة" value={b.educationInfo?.school} />
              <InfoField
                label="خطة تعليمية فردية"
                value={b.educationInfo?.specialEducationPlan ? 'نعم' : 'لا'}
              />
              {b.educationInfo?.iepDetails && (
                <InfoField label="تفاصيل IEP" value={b.educationInfo.iepDetails} />
              )}
            </Paper>
          </Grid>
          ...
          <Grid item xs={12} md={6}>
            ...
            >
              ...
              <InfoField
                label="كرسي متحرك"
                value={b.accessibility?.needsWheelchair ? 'نعم' : 'لا'}
              />
              <InfoField
                label="مترجم إشارة"
                value={b.accessibility?.needsSignInterpreter ? 'نعم' : 'لا'}
              />
              <InfoField label="برايل" value={b.accessibility?.needsBraille ? 'نعم' : 'لا'} />
              <InfoField
                label="جهاز مساعد"
                value={b.accessibility?.needsAssistiveDevice ? 'نعم' : 'لا'}
              />
              {b.accessibility?.assistiveDeviceDetails && (
                <InfoField label="تفاصيل الجهاز" value={b.accessibility.assistiveDeviceDetails} />
              )}
              {b.accessibility?.specialInstructions && (
                <InfoField label="تعليمات خاصة" value={b.accessibility.specialInstructions} />
              )}
            </Paper>
          </Grid>
        </Grid>
