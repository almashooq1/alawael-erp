...
const recentActions = [
  {
    id: 'CA-001',
    standard: 'CBAHI 3.2.1',
    finding: 'عدم اكتمال التوثيق',
    priority: 'عالي',
    status: 'جاري',
    dueDate: '٢٠٢٦/٠٤/١٥',
  },
            ...
            <ResponsiveContainer width="100%" height={280}>
              <PieChart>
                <Pie
                  ...
                  dataKey="value"
                >
                  {standardCategories.map((entry, i) => (
      ...
      <GlassCard delay={0.8}>
        ...
        <TableContainer>
          <Table size="small">
            <TableHead>
              <TableRow>
                {['الرقم', 'المعيار', 'الملاحظة', 'الأولوية', 'الحالة', 'التاريخ المستهدف'].map(
                  h => (
                    <TableCell
                      key={h}
                      sx={{
