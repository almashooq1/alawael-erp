...
import {
  ...
  updateIncident,
  deleteIncident,
} from '../../services/crisisManagement.service';

const typeOptions = [
  { value: 'fire', label: 'حريق' },
  { value: 'earthquake', label: 'زلزال' },
  { value: 'flood', label: 'فيضان' },
  { value: 'medical', label: 'طبي' },
  { value: 'security', label: 'أمني' },
  { value: 'power_outage', label: 'انقطاع كهرباء' },
  { value: 'pandemic', label: 'وباء' },
  { value: 'evacuation', label: 'إخلاء' },
...
export default function CrisisIncidentsList() {
  ...
  const handleSave = async () => {
    const payload = {
      ...
      status: form.status,
      location: { building: form.building, floor: form.floor },
    };
