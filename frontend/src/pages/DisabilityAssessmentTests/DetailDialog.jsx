      ...
      (() => {
        ...
        return (
          <>
            <DialogTitle
              sx={{
                bgcolor: getLevelColor(selectedResult.percentage),
                color: '#fff',
                display: 'flex',
            ...
            >
              ...
              <Box>
                ...
                <IconButton sx={{ color: '#fff' }} onClick={onClose} aria-label="إغلاق">
                  <CloseIcon />
                </IconButton>
              </Box>
            </DialogTitle>
            ...
            <DialogContent sx={{ pt: 3 }}>
              ...
              <Grid container spacing={2} sx={{ mb: 3 }}>
                ...
                <Grid item xs={6} sm={3}>
                  ...
                  <Chip
                    label={selectedResult.overallLevel}
                    sx={{ bgcolor: getLevelColor(selectedResult.percentage), color: '#fff' }}
                  />
                </Grid>
              </Grid>
              ...
              <Paper elevation={1} sx={{ p: 2, mb: 3, textAlign: 'center' }}>
                <Typography
                  variant="h3"
                  fontWeight="bold"
                  color={getLevelColor(selectedResult.percentage)}
                >
                  {selectedResult.percentage}%
                </Typography>
                <Typography variant="body2" color="text.secondary">
                  {selectedResult.totalScore} من {selectedResult.maxPossible} (
                  {selectedResult.totalItems} عنصر)
                </Typography>
                <LinearProgress
                  variant="determinate"
