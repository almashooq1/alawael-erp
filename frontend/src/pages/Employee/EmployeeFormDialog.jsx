          ...
          <DialogContent sx={{ py: 3, minHeight: 320 }}>
            ...
            <Collapse in={activeStep === 0} unmountOnExit>
              <SectionHeader
                ...
                subtitle="المعلومات الأساسية للموظف"
              />
              <Grid container spacing={2}>
                ...
                <Grid item xs={12} sm={6}>
                  {renderField('lastName', 'الاسم الأخير *')}
                </Grid>
                <Grid item xs={12} sm={6}>
                ...
                <Grid item xs={12} sm={6}>
                  {renderField('dateOfBirth', 'تاريخ الميلاد', {
                    type: 'date',
            ...
            <Collapse in={activeStep === 1} unmountOnExit>
              <SectionHeader
                ...
                subtitle="معلومات التوظيف والعقد"
              />
              <Grid container spacing={2}>
                <Grid item xs={12} sm={6}>
                  <TextField
                        ...
                        dialogMode === 'add' ? (
                          <InputAdornment position="end">
                            <Tooltip title="توليد رقم جديد">
                              <IconButton
                                size="small"
                                onClick={() => setField('employeeNumber', generateEmpNumber())}
                              >
                ...
                <Grid item xs={12} sm={6}>
                  {renderField('status', 'الحالة', {
                    select: true,
                    children: Object.entries(STATUS_MAP).map(([k, v]) => (
                ...
                <Grid item xs={12} sm={4}>
                  {renderField('joinDate', 'تاريخ التعيين *', {
                    type: 'date',
                    InputLabelProps: { shrink: true },
                  })}
                </Grid>
                ...
                <Grid item xs={12} sm={4}>
                  <Collapse in={form.contractType !== 'permanent'}>
                    {renderField('contractEndDate', 'تاريخ انتهاء العقد', {
                      type: 'date',
                      InputLabelProps: { shrink: true },
                    })}
                  </Collapse>
            ...
            <Collapse in={activeStep === 2} unmountOnExit>
              <SectionHeader
                ...
                subtitle="بيانات الاتصال والطوارئ"
              />
              <Grid container spacing={2}>
                <Grid item xs={12} sm={6}>
                ...
                <Grid item xs={12}>
                  <Divider sx={{ my: 1 }}>
                    <Chip label="جهة اتصال الطوارئ" size="small" icon={<EmergIcon />} />
                  </Divider>
                </Grid>
                <Grid item xs={12} sm={4}>
                ...
                <Grid item xs={12} sm={4}>
                  {renderField('emergencyRelation', 'صلة القرابة')}
                </Grid>
                <Grid item xs={12} sm={4}>
            ...
            <Collapse in={activeStep === 3} unmountOnExit>
              <SectionHeader
                ...
                subtitle="معلومات الراتب والحساب البنكي"
              />
              <Grid container spacing={2}>
                <Grid item xs={12} sm={6}>
                ...
                <Grid item xs={12}>
                  <Divider sx={{ my: 1 }}>
                    <Chip label="الحساب البنكي" size="small" icon={<BankIcon />} />
                  </Divider>
                </Grid>
                <Grid item xs={12} sm={6}>
