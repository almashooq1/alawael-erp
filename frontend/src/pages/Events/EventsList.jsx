...
export default function EventsList() {
  ...
  const handleSave = async () => {
    setSaving(true);
    try {
      if (mode === 'edit') await updateEvent(selectedId, form);
  ...
  return (
    <Box sx={{ p: { xs: 2, md: 3 } }}>
      ...
      >
        <Box>
          ...
          <Typography variant="body2" color="text.secondary">
            إنشاء وإدارة الفعاليات والأنشطة
          </Typography>
        </Box>
      ...
      {loading ? (
        ...
        >
          <EventIcon sx={{ fontSize: 64, color: theme.palette.grey[300], mb: 2 }} />
          <Typography color="text.secondary">لا توجد فعاليات</Typography>
            ...
            <TableBody>
              {list.map((e, idx) => (
                <TableRow key={e._id || idx}>
                  <TableCell>
                    <Typography fontWeight={600}>{e.eventCode}</Typography>
                  </TableCell>
                  ...
                  <TableCell align="center">
                    <Tooltip title="تعديل">
                      <IconButton size="small" color="primary" onClick={() => openEdit(e)}>
                        <Edit fontSize="small" />
                      </IconButton>
                    </Tooltip>
                    <Tooltip title="حذف">
      ...
      <Dialog open={dialogOpen} onClose={() => setDialogOpen(false)} maxWidth="sm" fullWidth>
        ...
        <DialogActions>
          ...
          <Button
            variant="contained"
            onClick={handleSave}
            disabled={saving || !form.eventCode.trim() || !form.titleAr.trim()}
          >
      ...
      <Dialog open={!!confirmDelete} onClose={() => setConfirmDelete(null)}>
        ...
        <DialogContent>
          <Typography>هل أنت متأكد من حذف هذه الفعالية؟</Typography>
        </DialogContent>
        <DialogActions>
