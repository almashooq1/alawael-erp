    ...
    >
      ...
      >
        ...
        <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
          <Box>
            <Typography
              sx={{ fontSize: '0.7rem', color: 'text.secondary', fontWeight: 500, mb: 0.8 }}
            >
              {title}
            </Typography>
            <Typography
  ...
  return (
    ...
    >
      ...
      <TableCell sx={{ py: 1.4 }}>
        <Chip
          label={
            branch.status === 'active' ? 'نشط' : branch.status === 'maintenance' ? 'صيانة' : 'متوقف'
          }
          size="small"
          sx={{
            height: 20,
        ...
        <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
                ...
                '& .MuiLinearProgress-bar': {
                  ...
                  background:
                    util > 85
                      ...
                      : util > 65
                        ? 'linear-gradient(90deg,#ff9800,#ffd200)'
          ...
          <Typography
            sx={{
              fontSize: '0.7rem',
              fontWeight: 800,
              color: util > 85 ? '#f44336' : 'text.secondary',
              minWidth: 28,
            }}
          >
            {util}%
          ...
          >
            ...
            >
              {i < 3 ? (
                ...
                <Typography sx={{ fontSize: '0.62rem', fontWeight: 900, color: 'white' }}>
                  {i + 1}
                </Typography>
              )}
            </Box>
...
/*  Alert Item                                             */
/* ─────────────────────────────────────────────────────── */
const AlertRow = ({ alert, index, isDark: _isDark }) => {
  const ALERT_COLORS = {
    critical: {
      color: '#f44336',
    ...
    >
      ...
      >
        ...
        <Box sx={{ flex: 1, minWidth: 0 }}>
          ...
          <Typography sx={{ fontSize: '0.62rem', color: 'text.disabled' }}>
            {alert.branch_code} ·{' '}
            {new Date(alert.created_at || Date.now()).toLocaleDateString('ar-SA')}
          </Typography>
        </Box>
      </Box>
    </motion.div>
        ...
        <Box sx={{ display: 'flex', gap: 2, mb: 3, flexWrap: 'wrap' }}>
          {[1, 2, 3, 4, 5].map(i => (
            <Skeleton
              ...
              variant="rounded"
              height={130}
              sx={{ flex: 1, minWidth: 150, borderRadius: '18px' }}
            />
          ))}
        </Box>
          ...
          <Box sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>
            ...
            <Box>
              ...
              <Box sx={{ display: 'flex', alignItems: 'center', gap: 1, mt: 0.3 }}>
                ...
                />
                <Typography sx={{ fontSize: '0.65rem', color: '#4caf50', fontWeight: 700 }}>
                  مباشر
                </Typography>
              </Box>
            </Box>
      ...
      <Grid container spacing={2.5}>
                      ...
                      <>
                        <Grid container spacing={1.5} sx={{ mb: 2 }}>
                          {[
                            {
                              t: 'إجمالي الإيرادات',
                              v: financials.total_revenue ?? 0,
                              g: 'linear-gradient(135deg,#43cea2,#185a9d)',
                              gw: '#43cea2',
                              u: 'ر.س',
                            },
                            {
                              t: 'إجمالي المصروفات',
                              v: financials.total_expenses ?? 0,
                              g: 'linear-gradient(135deg,#f5576c,#f093fb)',
                              gw: '#f5576c',
                              u: 'ر.س',
                            },
                            {
                              t: 'صافي الربح',
                              v: financials.net_profit ?? 0,
                            ...
                            {
                              t: 'نسبة الربحية',
                              v: financials.profit_margin ?? 0,
                              g: 'linear-gradient(135deg,#f7971e,#ffd200)',
                              gw: '#f7971e',
                              u: '%',
                            },
                          ].map((f, i) => (
                              ...
                              {(financials.by_branch || []).map((b, _i) => (
                                ...
                                >
                                  <TableCell sx={{ py: 1.2, fontSize: '0.78rem' }}>
                                    ...
                                    <Typography
                                      sx={{ fontSize: '0.63rem', color: 'text.disabled' }}
                                    >
                                      {b.name_ar}
                                    </Typography>
                                  </TableCell>
                            ...
                            <Box>
                              ...
                              >
                                <Typography sx={{ fontSize: '0.76rem', fontWeight: 700 }}>
                                  ...
                                  <Box
                                    component="span"
                                    sx={{ fontWeight: 400, color: 'text.secondary', mr: 0.5 }}
                                  >
                                    {' '}
                                    {row.name_ar}
                                  </Box>
        ...
        <Grid item xs={12} lg={4}>
          <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2.5 }}>
            {/* Smart AI Insights */}
            <SmartInsightsPanel onRefresh={() => loadData(true)} loading={refreshing} />
                ...
                >
                  {alerts.length === 0 ? (
                    <Box sx={{ py: 3, textAlign: 'center' }}>
                      ...
                      <Typography
                        sx={{ fontSize: '0.78rem', color: 'text.disabled', fontWeight: 600 }}
                      >
                    ...
                    alerts
                      .slice(0, 8)
                      .map((a, i) => <AlertRow key={i} alert={a} index={i} isDark={isDark} />)
                  )}
                </Box>
              </Paper>
            </motion.div>
