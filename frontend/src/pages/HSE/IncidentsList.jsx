...
import {
  ...
  updateIncident,
  deleteIncident,
} from '../../services/hse.service';

const typeOptions = [
  { value: 'injury', label: 'إصابة' },
  { value: 'near_miss', label: 'حادثة قريبة' },
...
const severityOptions = [
  ...
  { value: 'moderate', label: 'متوسط', color: 'info' },
  { value: 'serious', label: 'خطير', color: 'warning' },
  { value: 'critical', label: 'حرج', color: 'error' },
  { value: 'fatal', label: 'مميت', color: 'error' },
];

const statusOptions = [
  { value: 'reported', label: 'مُبلغ', color: 'error' },
  { value: 'under_investigation', label: 'تحقيق', color: 'warning' },
  { value: 'corrective_action', label: 'إجراء تصحيحي', color: 'info' },
              ...
              <TableBody>
                {rows.map(r => (
                  <TableRow key={r._id} hover>
                    ...
                    <TableCell>
                      {typeOptions.find(o => o.value === r.incidentType)?.label || r.incidentType}
                    </TableCell>
                    ...
                    <TableCell>
                      <Chip
                        size="small"
                        label={
                          severityOptions.find(o => o.value === r.severity)?.label || r.severity
                        }
                        color={
                          severityOptions.find(o => o.value === r.severity)?.color || 'default'
                        }
                      />
                    </TableCell>
                    <TableCell>
