      ...
      <Grid container spacing={2} sx={{ mb: 3 }}>
        ...
        <Grid item xs={12} md={4}>
          ...
          >
            <GlassCard>
              <SectionHeader
                title="معدل العدوى بالأقسام"
                subtitle="عدد الحالات والمعدل لكل 1000 يوم"
              />
              <ResponsiveContainer width="100%" height={280}>
      ...
      >
        <GlassCard>
          <SectionHeader
            ...
            subtitle="حالات العدوى المُبلَّغ عنها"
            action={
              <Tooltip title="تحديث">
                  ...
                  >
                    ...
                    >
                      <Chip
                        icon={
                          row.severity === 'حرج' ? (
                            <ErrorIcon sx={{ fontSize: '12px !important' }} />
                          ) : (
