...
import {
  ...
  updateAuditPlan,
  deleteAuditPlan,
} from '../../services/internalAudit.service';
                ...
                {rows.map(r => (
                  <TableRow key={r._id} hover>
                    ...
                    <TableCell>
                      <Chip
                        size="small"
                        label={riskOptions.find(o => o.value === r.riskLevel)?.label || r.riskLevel}
                        color={riskOptions.find(o => o.value === r.riskLevel)?.color || 'default'}
                      />
                    </TableCell>
                    <TableCell>
                      <Chip
