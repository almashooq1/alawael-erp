        ...
        >
          <Box
            sx={{
              ...
              fontSize: 22,
              boxShadow: `0 4px 16px ${gradient.includes('10b9') ? '#10b98144' : '#6366f144'}`,
            }}
          >
            {icon}
          </Box>
    ...
    >
      ...
      <td style={{ padding: '12px 16px' }}>
        <Chip
          label={item.category}
          size="small"
          sx={{ background: `${item.color}22`, color: item.color, fontSize: 10 }}
        />
      </td>
      <td style={{ padding: '12px 16px' }}>
        <Box sx={{ minWidth: 100 }}>
      ...
      <td style={{ padding: '12px 16px' }}>
        <Tooltip title="طلب إعادة تعبئة">
          <IconButton
            size="small"
            onClick={() => onOrder(item)}
            sx={{ color: '#10b981', '&:hover': { background: '#10b98122' } }}
          >
            🛒
          </IconButton>
        </Tooltip>
  ...
  aiAlerts: [
    {
      icon: '⚠️',
      title: 'نقص وشيك',
      text: 'المحاقن 10 مل ستنفد خلال 5 أيام بناءً على معدل الاستهلاك الحالي. يُنصح بطلب 500 علبة فورًا.',
      color: '#ef4444',
      priority: 'عاجل',
    },
    {
      icon: '📅',
      title: 'انتهاء صلاحية',
      text: '7 أصناف ستنتهي صلاحيتها خلال 30 يومًا، منها محاليل ومستلزمات بقيمة إجمالية 8,400 ريال.',
      color: '#f59e0b',
      priority: 'تنبيه',
    },
    {
      icon: '💡',
      title: 'توصية ذكية',
      text: 'بناءً على نمط الاستهلاك، يُنصح بزيادة كميات الشاش الطبي بنسبة 30% قبل موسم الذروة.',
      color: '#6366f1',
      priority: 'اقتراح',
    },
    {
      icon: '📈',
      title: 'توقع الطلب',
      text: 'من المتوقع ارتفاع الطلب على مستلزمات التأهيل بنسبة 25% الشهر القادم بسبب افتتاح الجناح الجديد.',
      color: '#10b981',
      priority: 'معلومة',
    },
  ],
        ...
        kpis: [
          {
            ...DEMO.kpis[0],
            value:
              s.supplyChain?.inventory?.total != null
                ? s.supplyChain.inventory.total.toLocaleString('ar-SA')
                : DEMO.kpis[0].value,
          },
          {
            ...DEMO.kpis[1],
            value:
              s.supplyChain?.inventory?.lowStock != null
                ? s.supplyChain.inventory.lowStock.toString()
                : DEMO.kpis[1].value,
          },
          { ...DEMO.kpis[2] },
          { ...DEMO.kpis[3] },
    ...
    <Box sx={{ minHeight: '100vh', background: bg, p: { xs: 2, md: 3 }, direction: 'rtl' }}>
              ...
              <Grid item xs={12}>
                <Glass sx={{ p: 3 }}>
                  <Typography
                    ...
                    sx={{ color: isDark ? 'rgba(255,255,255,0.9)' : 'rgba(0,0,0,0.85)' }}
                  >
                    🔴 أصناف تحتاج إعادة طلب عاجل
                  </Typography>
                  <Grid container spacing={2}>
                    {(data?.items || [])
                      .filter(it => it.stock / it.maxStock <= 0.4)
                      .map((item, i) => (
                  ...
                  <Glass sx={{ p: 3, overflowX: 'auto' }}>
                    <table style={{ width: '100%', borderCollapse: 'collapse' }}>
                      <thead>
                        ...
                        >
                          {['الصنف', 'الفئة', 'المخزون', 'انتهاء الصلاحية', 'السعر', 'إجراء'].map(
                            h => (
                              <th
                                key={h}
                                style={{
                      ...
                      <tbody>
                        {filtered.map((item, _i) => (
                          <SupplyRow key={item.id} item={item} onOrder={handleOrder} />
                        ))}
                        {filtered.length === 0 && (
                          <tr>
                            <td
                    ...
                    {(data?.items || []).map((item, i) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <td style={{ padding: '12px 16px' }}>
                            <Typography variant="body2" fontWeight={700} sx={{ color: sc }}>
                          ...
                          <td style={{ padding: '12px 16px' }}>
                            <Typography
                              ...
                              sx={{ color: isDark ? 'rgba(255,255,255,0.5)' : 'rgba(0,0,0,0.5)' }}
                            >
                              {Math.round(item.maxStock * 0.2)} {item.unit}
                            </Typography>
                          </td>
                          <td style={{ padding: '12px 16px' }}>
                            <Typography
                            ...
                            >
                              ...
                              <td style={{ padding: '14px 16px' }}>
                                <Chip
                                  label={`${o.items} صنف`}
                                  size="small"
                                  sx={{ background: '#10b98122', color: '#10b981' }}
                                />
                              </td>
                              <td style={{ padding: '14px 16px' }}>
                                <Typography
                      ...
                      <Box sx={{ display: 'flex', alignItems: 'center', gap: 2, mb: 3 }}>
                        ...
                        <Box sx={{ flex: 1 }}>
                          ...
                          <Box sx={{ display: 'flex', alignItems: 'center', gap: 0.5 }}>
                            {Array(5)
                              ...
                              .map((_, si) => (
                                <span
                                  ...
                                  style={{
                                    fontSize: 12,
                                    color: si < Math.floor(s.rating) ? '#f59e0b' : '#d1d5db',
                                  }}
                                >
                                  ★
                                </span>
                            ...
                            <Typography
                              variant="caption"
                              sx={{ color: '#f59e0b', fontWeight: 700, mr: 0.5 }}
                            >
                              {s.rating}
                            </Typography>
                          </Box>
                  ...
                  <Box sx={{ display: 'flex', alignItems: 'center', gap: 2, mb: 3 }}>
                    ...
                    <Box>
                      <Typography
                        ...
                        sx={{ color: isDark ? 'rgba(255,255,255,0.9)' : 'rgba(0,0,0,0.85)' }}
                      >
                        تنبيهات الذكاء الاصطناعي للمخزون
                      </Typography>
                      <Typography
                        variant="caption"
                        sx={{ color: isDark ? 'rgba(255,255,255,0.45)' : 'rgba(0,0,0,0.45)' }}
                      >
                        تحليل ذكي لأنماط الاستهلاك والمخاطر
                      </Typography>
                    </Box>
                  </Box>
                  <Grid container spacing={2}>
                    ...
                    {[
                      {
                        label: 'الطلب المتوقع',
                        value: '+15%',
                        detail: 'بسبب افتتاح الجناح الجديد',
                        icon: '📈',
                        color: '#10b981',
                      },
                      {
      ...
      >
            ...
            >
              ...
              <Box>
                ...
                <Typography
                  ...
                  sx={{ color: isDark ? 'rgba(255,255,255,0.5)' : 'rgba(0,0,0,0.5)' }}
                >
                  المخزون الحالي: {selectedItem.stock} {selectedItem.unit} | السعر:{' '}
        ...
        <DialogActions sx={{ p: 2, gap: 1 }}>
          <Button onClick={() => setOrderDialog(false)} sx={{ borderRadius: 2 }}>
            إلغاء
          </Button>
          <Button
            variant="contained"
