    ...
    <div id="tailwind-scope" dir="rtl" className="font-cairo">
      <div className="min-h-screen flex">
        ...
        <div className="hidden lg:flex lg:w-[55%] relative overflow-hidden bg-gradient-to-br from-primary-900 via-primary-700 to-primary-600 flex-col justify-center items-center p-12 text-white">
          ...
          <div
            className="absolute bottom-20 left-10 w-96 h-96 bg-accent-400/8 rounded-full blur-[100px] animate-blob"
            style={{ animationDelay: '3s' }}
          />
          <div
            className="absolute top-1/2 left-1/3 w-60 h-60 bg-white/5 rounded-full blur-[60px] animate-blob"
          ...
          <div
            className={`relative z-10 text-center max-w-md transition-all duration-1000 ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}
          >
            {/* Logo */}
            <div className="w-24 h-24 mx-auto mb-8 relative">
              ...
              <div className="relative w-full h-full bg-white/10 backdrop-blur-md rounded-3xl flex items-center justify-center border border-white/20 shadow-2xl">
                <span className="text-4xl font-bold bg-gradient-to-b from-accent-300 to-accent-400 bg-clip-text text-transparent">
                  أ
                </span>
              </div>
            </div>

            <h1 className="text-4xl font-bold mb-3 leading-tight">مراكز الأوائل</h1>
            ...
            <p className="text-white/60 text-base mb-12 leading-relaxed max-w-sm mx-auto">
              نظام إدارة متكامل يجمع بين التأهيل والتعليم والموارد البشرية والمالية في منصة واحدة
            </p>
            ...
            <div className="space-y-4 text-right">
              {[
                ...
                <div
                  key={i}
                  className={`flex items-start gap-4 bg-white/[0.06] backdrop-blur-sm rounded-2xl p-4 border border-white/[0.08] hover:bg-white/[0.1] hover:border-white/[0.15] transition-all duration-500 ${mounted ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-8'}`}
            ...
            <div className="flex justify-center gap-10 mt-12">
              {[
                ...
                <div key={i} className="text-center">
                  <div className="text-2xl font-bold bg-gradient-to-b from-accent-300 to-accent-400 bg-clip-text text-transparent">
                    {s.val}
                  </div>
          ...
          >
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div>
                ...
                <div
                  className={`relative rounded-2xl transition-all duration-300 ${focusedField === 'email' ? 'ring-2 ring-primary-500/20 shadow-lg shadow-primary-500/5' : ''}`}
                >
                  <div className="absolute inset-y-0 right-0 flex items-center pr-4 pointer-events-none">
                    <svg
                      className={`w-5 h-5 transition-colors duration-300 ${focusedField === 'email' ? 'text-primary-500' : 'text-gray-400'}`}
                      fill="none"
                      viewBox="0 0 24 24"
                      stroke="currentColor"
                      strokeWidth={1.5}
              ...
              <div>
                ...
                <div
                  className={`relative rounded-2xl transition-all duration-300 ${focusedField === 'password' ? 'ring-2 ring-primary-500/20 shadow-lg shadow-primary-500/5' : ''}`}
                >
                  <div className="absolute inset-y-0 right-0 flex items-center pr-4 pointer-events-none">
                    <svg
                      className={`w-5 h-5 transition-colors duration-300 ${focusedField === 'password' ? 'text-primary-500' : 'text-gray-400'}`}
                      fill="none"
                      viewBox="0 0 24 24"
                      stroke="currentColor"
                      strokeWidth={1.5}
            ...
            >
              ...
              <span>الدخول عبر نفاذ (الهوية الرقمية)</span>
            </button>
            ...
            <div className="grid grid-cols-3 gap-3 mb-7">
              ...
              <button
                type="button"
                className="group flex items-center justify-center gap-2 py-3 px-4 rounded-2xl border border-gray-200 bg-white hover:bg-gray-50 hover:border-gray-300 hover:shadow-md transition-all duration-300 hover:-translate-y-0.5"
              >
