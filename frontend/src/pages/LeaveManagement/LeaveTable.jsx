            ...
            filtered.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map(leave => {
              ...
              return (
                ...
                >
                  ...
                  <TableCell>
                    <Chip
                      icon={getLeaveTypeIcon(leave.leaveType)}
                  ...
                  <TableCell>
                    <Chip
                      label={formatDays(leave.startDate, leave.endDate)}
                      size="small"
                      variant="outlined"
                    />
                  </TableCell>
                  ...
                  <TableCell align="center" onClick={e => e.stopPropagation()}>
                    <Tooltip title="عرض التفاصيل">
                      <IconButton size="small" onClick={() => setViewItem(leave)}>
