...
const recentOrders = [
  {
    id: 'WO-1247',
    desc: 'إصلاح تكييف - الطابق الثالث',
    type: 'تصحيحية',
    priority: 'عالي',
    tech: 'أحمد سالم',
    date: '٢٠٢٦/٠٣/٣٠',
  ...
  return (
    <Box sx={{ direction: 'rtl', minHeight: '100vh' }}>
                      ...
                      <Chip
                        ...
                        sx={{
                          ...
                          backgroundColor: alpha(
                            b.health >= 90 ? '#22c55e' : b.health >= 85 ? '#f59e0b' : '#ef4444',
                            0.12
                          ),
                          color:
                            b.health >= 90 ? '#22c55e' : b.health >= 85 ? '#f59e0b' : '#ef4444',
      ...
      >
        <GlassCard>
          <SectionHeader
            title="أحدث أوامر العمل"
            subtitle="آخر طلبات الصيانة"
            action={
              <Tooltip title="تحديث">
          ...
          <TableContainer>
            <Table size="small">
              <TableHead>
                <TableRow>
                  {['رقم الأمر', 'الوصف', 'النوع', 'الأولوية', 'الفني', 'التاريخ', 'الحالة'].map(
                    h => (
                      <TableCell
                        key={h}
                        sx={{
              ...
              <TableBody>
                {recentOrders.map((row, i) => (
                  ...
                  >
                    ...
                    >
                      <Typography sx={{ fontSize: '0.8rem', fontWeight: 700, color: '#f59e0b' }}>
                        {row.id}
                      </Typography>
                    </TableCell>
                    <TableCell
                      ...
                      <Chip
                        icon={
                          row.status === 'مكتمل' ? (
                            ...
                            <PendingActionsIcon sx={{ fontSize: '12px !important' }} />
                          )
                        }
                        label={row.status}
                        size="small"
