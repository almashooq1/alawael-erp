        ...
        <Box sx={{ flex: 1, minWidth: 0 }}>
          <Box sx={{ display: 'flex', alignItems: 'center', gap: 1, mb: 0.5, flexWrap: 'wrap' }}>
            ...
            <Chip
              label={notif.type}
              size="small"
              sx={{ background: `${color}22`, color, fontSize: 9, height: 18 }}
            />
            {notif.priority === 'عاجل' && (
              <Chip
                label="🔴 عاجل"
                size="small"
                sx={{ background: '#ef444422', color: '#ef4444', fontSize: 9, height: 18 }}
              />
            )}
          </Box>
          <Typography
    ...
    <Glass sx={{ p: 3 }}>
      <Box sx={{ display: 'flex', alignItems: 'center', gap: 2, mb: 2 }}>
        ...
        <Switch
          ...
          size="small"
          sx={{
            '& .MuiSwitch-thumb': { background: channel.color },
            '& .Mui-checked + .MuiSwitch-track': { background: `${channel.color}88` },
          }}
        />
      </Box>
      <Box sx={{ display: 'flex', gap: 1, flexWrap: 'wrap' }}>
        <Chip
          label={`${channel.sent} مُرسَل`}
          size="small"
          sx={{ background: `${channel.color}22`, color: channel.color, fontSize: 10 }}
        />
        <Chip
          label={`${channel.delivered}% وصل`}
          size="small"
          sx={{ background: '#22c55e22', color: '#22c55e', fontSize: 10 }}
        />
      </Box>
    </Glass>
  );
...
const DEMO = {
  ...
  notifications: [
    {
      id: 1,
      title: 'انتهاء صلاحية دواء',
      message: 'محلول ملحي 0.9% سينتهي خلال 30 يومًا. يرجى مراجعة المخزون واتخاذ الإجراء اللازم.',
      type: 'تنبيه',
      icon: '💊',
      source: 'نظام المخزون',
      time: 'منذ 5 دقائق',
    ...
    {
      id: 2,
      title: 'موعد مريض جديد',
      message: 'تم حجز موعد للمريض: أحمد الحارثي - الدكتور محمد العمري - 2026/04/01 الساعة 10:00',
      type: 'معلومة',
      icon: '🗓️',
      source: 'نظام الجدولة',
      time: 'منذ 12 دقيقة',
    ...
    },
    {
      ...
      message: 'تم إنشاء التقرير المالي الشهري لمارس 2026. يمكنك الاطلاع عليه الآن.',
      type: 'نجاح',
      icon: '📊',
    ...
    },
    {
      ...
      message: 'تم رصد محاولة تسجيل دخول فاشلة متكررة من IP: 192.168.1.45 للمستخدم: admin',
      type: 'أمان',
      icon: '🔐',
      source: 'نظام الأمان',
      time: 'منذ 1 ساعة',
    ...
    },
    {
      ...
      message: 'تم إضافة الموظف نورة الزهراني إلى قسم التمريض برقم الموظف: EMP-2847',
      type: 'نجاح',
      icon: '👤',
      source: 'نظام HR',
      time: 'منذ 2 ساعة',
    ...
    },
    {
      id: 6,
      title: 'تحديث النظام',
      message: 'سيتم إجراء صيانة مجدولة للنظام يوم الجمعة 03/04/2026 من 02:00 - 04:00 صباحًا.',
      type: 'نظام',
      icon: '⚙️',
      source: 'فريق IT',
      time: 'منذ 3 ساعات',
    ...
    },
    {
      id: 7,
      title: 'طلب إجازة',
      message: 'قدّم د. خالد العمري طلب إجازة سنوية من 05/04 حتى 12/04/2026. بانتظار الموافقة.',
      type: 'تحذير',
      icon: '🏖️',
      source: 'نظام HR',
      time: 'منذ 5 ساعات',
    ...
    },
    {
      id: 8,
      title: 'مخزون منخفض',
      message: 'وصل مخزون المحاقن 10 مل إلى 9% من الطاقة القصوى. يُنصح بطلب إعادة تعبئة فوري.',
      type: 'تنبيه',
      icon: '📦',
      source: 'نظام المخزون',
      time: 'منذ 6 ساعات',
...
export default function NotificationsDashboard() {
  ...
  const filtered = (tab === 1 ? unread : data?.notifications || []).filter(
    n => typeFilter === 'الكل' || n.type === typeFilter
  );
                ...
                <Glass sx={{ p: 3 }}>
                  ...
                  >
                    ...
                    <FormControl size="small" sx={{ minWidth: 120 }}>
                      ...
                      >
                        {['الكل', 'تنبيه', 'تحذير', 'معلومة', 'نجاح', 'نظام', 'أمان'].map(t => (
                    ...
                    {[
                      ...
                      <Box key={i} sx={{ display: 'flex', alignItems: 'center', gap: 2, mb: 1.5 }}>
                        ...
                        <Typography
                          variant="caption"
                          fontWeight={700}
                          sx={{ color: s.color, minWidth: 24, textAlign: 'right' }}
                        >
                          {s.count}
                        </Typography>
                      </Box>
                    ...
                    <Box key={i} sx={{ mb: 2 }}>
                      <Box sx={{ display: 'flex', justifyContent: 'space-between', mb: 0.5 }}>
                        ...
                        <Typography variant="caption" fontWeight={700} sx={{ color: s.color }}>
                          {s.count.toLocaleString()} إشعار ({s.pct}%)
                        </Typography>
                      </Box>
                      <Box
                        sx={{
                ...
                >
                  ...
                  >
                    ...
                    <Chip
                      label={t.type}
                      size="small"
                      sx={{ background: '#f9731622', color: '#f97316', fontSize: 10 }}
                    />
                    <Chip
                      label={t.status}
                      size="small"
                      sx={{
                        background: t.status === 'نشط' ? '#22c55e22' : '#94a3b822',
                        color: t.status === 'نشط' ? '#22c55e' : '#94a3b8',
                        fontWeight: 700,
                        fontSize: 10,
                      }}
                    />
                ...
                <Glass sx={{ p: 3 }}>
                    ...
                    <Box key={i} sx={{ display: 'flex', alignItems: 'center', gap: 2, mb: 1.5 }}>
                      ...
                      <Box sx={{ flex: 1 }}>
                        ...
                        >
                          <motion.div
                            initial={{ width: 0 }}
                            animate={{ width: `${(d.read / 312) * 100}%` }}
                            transition={{ delay: i * 0.07 + 0.1, duration: 0.7 }}
                            style={{ height: '100%', borderRadius: 4, background: '#22c55e' }}
                          />
                        </Box>
                      </Box>
                      <Box sx={{ textAlign: 'left', minWidth: 60 }}>
                        <Typography variant="caption" sx={{ color: '#f97316', fontWeight: 700 }}>
                          {d.sent}
                        </Typography>
                        <Typography
                          variant="caption"
                  ...
                  <Box sx={{ display: 'flex', gap: 3, mt: 2 }}>
                    <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
                      <Box sx={{ width: 12, height: 8, borderRadius: 2, background: '#f97316' }} />
                      <Typography
                        variant="caption"
                        sx={{ color: isDark ? 'rgba(255,255,255,0.5)' : 'rgba(0,0,0,0.5)' }}
                      >
                    ...
                    <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
                      <Box sx={{ width: 12, height: 5, borderRadius: 2, background: '#22c55e' }} />
                      <Typography
                        variant="caption"
                        sx={{ color: isDark ? 'rgba(255,255,255,0.5)' : 'rgba(0,0,0,0.5)' }}
                      >
                  ...
                  {[
                    {
                      ...
                      desc: 'إشعار عند وصول مخزون لأقل من 20%',
                      enabled: true,
                    },
                    {
                      label: 'إشعارات المواعيد',
                      desc: 'تذكير قبل موعد المريض بـ 24 ساعة',
                      enabled: true,
                    },
                    {
                      label: 'تقارير يومية تلقائية',
                      desc: 'إرسال ملخص يومي للمديرين',
                      enabled: true,
                    },
                    {
                      label: 'تنبيهات الأمان',
                      desc: 'إشعار فوري عند اكتشاف تهديد أمني',
                      enabled: true,
                    },
                    ...
                    >
                      ...
                      <Switch
                        ...
                        size="small"
                        sx={{
                          '& .Mui-checked + .MuiSwitch-track': { background: '#f9731688' },
                          '& .Mui-checked .MuiSwitch-thumb': { background: '#f97316' },
                        }}
                      />
                    </Box>
                  ))}
                ...
                <Glass sx={{ p: 3 }}>
                  ...
                  {[
                    ...
                    >
                      ...
                      >
                        <Typography variant="body2" fontWeight={700} sx={{ color: h.color }}>
                          {h.label}
                        </Typography>
                        <Chip
                          label={`${h.from} - ${h.to}`}
                  ...
                  >
                    ...
                    >
                      ...
                      <Switch
                        size="small"
                        sx={{
                          '& .Mui-checked + .MuiSwitch-track': { background: '#6366f188' },
      ...
      >
        ...
        <DialogContent sx={{ pt: 3, display: 'flex', flexDirection: 'column', gap: 2, mt: 1 }}>
          ...
          <FormControl fullWidth>
            ...
            >
              {['تنبيه', 'تحذير', 'معلومة', 'نجاح', 'نظام', 'أمان'].map(t => (
                <MenuItem key={t} value={t}>
                  {t}
                </MenuItem>
              ))}
          ...
          <FormControl fullWidth>
            <Select
              ...
              onChange={e => setNewNotif(p => ({ ...p, channel: e.target.value }))}
            >
              {['واتساب', 'بريد إلكتروني', 'SMS', 'إشعارات التطبيق', 'جميع القنوات'].map(c => (
        ...
        <DialogActions sx={{ p: 2, gap: 1 }}>
          <Button onClick={() => setSendDialog(false)} sx={{ borderRadius: 2 }}>
            إلغاء
          </Button>
          <Button
            variant="contained"
