    ...
    <Box sx={{ minHeight: '100vh', direction: 'rtl' }}>
                ...
                >
                  ...
                  >
                    <Box sx={{ display: 'flex', justifyContent: 'space-between', mb: 1 }}>
                      ...
                      <Chip
                        label={`نسبة ${shift.ratio}`}
                        size="small"
                        sx={{
                          height: 22,
                          fontSize: '0.7rem',
                          fontWeight: 600,
                          backgroundColor: alpha(GRAD[1], 0.12),
                          color: GRAD[1],
                          border: `1px solid ${alpha(GRAD[1], 0.25)}`,
                        }}
                      />
                    </Box>
                    <LinearProgress
                      variant="determinate"
                      value={(shift.nurses / 35) * 100}
                      sx={{
                        height: 6,
                        borderRadius: 3,
                ...
                >
                  <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.5 }}>
                    ...
                    <Box sx={{ flex: 1 }}>
                      ...
                      >
                        {n.dept} — {n.shifts} وردية — {n.tasks} مهمة
                      </Typography>
                    </Box>
                    <Chip
                      label={`${n.rating}★`}
      ...
      <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.8 }}>
        ...
        >
          ...
          >
            لوحة التمريض والرعاية — متابعة فريق التمريض وجولات الرعاية وعلامات المرضى الحيوية وجودة
            الخدمة
          </Typography>
        </Box>
      </motion.div>
