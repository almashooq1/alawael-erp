...
const WORK_ORDERS = [
  {
    id: 'WO-3401',
    title: 'صيانة نظام التكييف — المبنى A',
  ...
  {
    id: 'WO-3402',
    title: 'إصلاح شبكة المياه — الدور الثاني',
    assignee: 'م. سعد الحربي',
    priority: 'critical',
    status: 'active',
    date: '٢٠٢٦/٠٣/٣٠',
  },
  {
    id: 'WO-3403',
    title: 'تركيب كاميرات مراقبة — المدخل',
    assignee: 'فريق الأمن',
    priority: 'medium',
    status: 'pending',
    date: '٢٠٢٦/٠٣/٣١',
  ...
  {
    id: 'WO-3404',
    title: 'فحص معدات الإطفاء الدوري',
    assignee: 'م. خالد العتيبي',
    priority: 'medium',
    status: 'completed',
    date: '٢٠٢٦/٠٣/٢٩',
  },
  {
    id: 'WO-3405',
    title: 'تحديث أنظمة الإضاءة LED',
    assignee: 'فريق الكهرباء',
    priority: 'low',
    status: 'pending',
    date: '٢٠٢٦/٠٤/٠٢',
  },
  {
    id: 'WO-3406',
    title: 'صيانة المصاعد — فحص ربع سنوي',
    assignee: 'شركة المصاعد',
    priority: 'high',
    status: 'active',
    date: '٢٠٢٦/٠٣/٣١',
  },
                ...
                <Card elevation={0} sx={{ ...glass(isDark), p: 2, textAlign: 'center' }}>
                  ...
                  <Chip
                    ...
                    sx={{
                      ...
                      color: kpi.change.startsWith('-') ? '#10b981' : '#f59e0b',
                      '& .MuiChip-label': { px: 0.6 },
                    }}
                  />
                </Card>
            ...
            <ResponsiveContainer width="100%" height={260}>
              <PieChart>
                <Pie
                  ...
                  dataKey="value"
                >
                  {RESOURCE_ALLOCATION.map((entry, i) => (
              ...
              >
                ...
                >
                  <Box sx={{ display: 'flex', justifyContent: 'space-between', mb: 0.5 }}>
                    ...
                    <Chip
                      label={
                        item.status === 'good' ? 'جيد' : item.status === 'warning' ? 'تحذير' : 'حرج'
                      }
                      size="small"
                      sx={{
                        height: 20,
                  ...
                  <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
                    <LinearProgress
                      variant="determinate"
                      value={Math.min((item.available / (item.reorderPoint * 3)) * 100, 100)}
                      sx={{
                        flex: 1,
                        height: 6,
                        borderRadius: 3,
      ...
      <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.8 }}>
        <Box
          sx={{
            ...
            p: 2.5,
            borderRadius: '16px',
            background: isDark ? alpha(GRAD[1], 0.08) : alpha(GRAD[1], 0.04),
            border: `1px solid ${isDark ? alpha(GRAD[1], 0.2) : alpha(GRAD[1], 0.1)}`,
            display: 'flex',
            alignItems: 'center',
            gap: 2,
          }}
        >
          ...
          >
            لوحة العمليات والتشغيل — متابعة أوامر العمل والصيانة وإدارة المخزون والمرافق في الوقت
            الفعلي
          </Typography>
        </Box>
      </motion.div>
