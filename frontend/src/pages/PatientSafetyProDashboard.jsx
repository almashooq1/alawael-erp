                ...
                <GlassCard>
                  ...
                  <Chip
                    ...
                    sx={{
                      ...
                      fontWeight: 700,
                      backgroundColor:
                        kpi.change < 0 ? alpha('#22c55e', 0.1) : alpha('#22c55e', 0.1),
                      color: '#22c55e',
                    }}
                  />
                </GlassCard>
          ...
          >
            <GlassCard>
              <Typography sx={{ fontWeight: 700, mb: 2, color: isDark ? '#F1F5F9' : '#0F172A' }}>
                اتجاه الحوادث الشهري
              </Typography>
              <ResponsiveContainer width="100%" height={280}>
                <AreaChart data={monthlyData}>
                  <defs>
                    <linearGradient id="psIncident" x1="0" y1="0" x2="0" y2="1">
                      <stop offset="5%" stopColor="#ef4444" stopOpacity={0.3} />
                      <stop offset="95%" stopColor="#ef4444" stopOpacity={0} />
                    </linearGradient>
                    <linearGradient id="psNearMiss" x1="0" y1="0" x2="0" y2="1">
                      <stop offset="5%" stopColor="#f59e0b" stopOpacity={0.3} />
                      <stop offset="95%" stopColor="#f59e0b" stopOpacity={0} />
                    </linearGradient>
                    <linearGradient id="psResolved" x1="0" y1="0" x2="0" y2="1">
              ...
              {safetyGoals.map((g, i) => (
                <Box key={i} sx={{ mb: 2 }}>
                  <Box sx={{ display: 'flex', justifyContent: 'space-between', mb: 0.5 }}>
                    ...
                    <Typography sx={{ fontSize: '0.78rem', fontWeight: 700, color: g.color }}>
                      {g.progress}%
                    </Typography>
                  </Box>
                  <LinearProgress
                    ...
                    sx={{
                      height: 8,
                      borderRadius: 4,
                      backgroundColor: alpha(g.color, 0.12),
                      '& .MuiLinearProgress-bar': {
                        borderRadius: 4,
                        background: `linear-gradient(90deg, ${g.color}, ${alpha(g.color, 0.7)})`,
                      },
                    }}
                  />
                </Box>
        ...
        <GlassCard>
          ...
          <TableContainer>
            <Table size="small">
              <TableHead>
                <TableRow>
                  {['رقم البلاغ', 'النوع', 'الخطورة', 'القسم', 'الإجراء', 'الحالة', 'التاريخ'].map(
                    h => (
                      <TableCell
                        key={h}
                        sx={{
