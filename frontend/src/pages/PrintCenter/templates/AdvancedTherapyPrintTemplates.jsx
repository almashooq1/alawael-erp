...
export const ADVANCED_THERAPY_TEMPLATES = [
  {
    id: 'mdt-meeting-minutes',
    name: 'محضر فريق متعدد التخصصات',
    nameEn: 'MDT Meeting Minutes',
    desc: 'محضر اجتماع الفريق متعدد التخصصات',
    color: '#6a1b9a',
  },
  {
    id: 'therapy-progress-note',
    name: 'ملاحظة تقدم علاجي',
    nameEn: 'Therapy Progress Note',
    desc: 'ملاحظة تقدم الجلسة العلاجية',
    color: '#7b1fa2',
  },
  {
    id: 'sensory-integration-plan',
    name: 'خطة التكامل الحسي',
    nameEn: 'Sensory Integration Plan',
    desc: 'خطة علاج التكامل الحسي',
    color: '#8e24aa',
  },
  {
    id: 'assistive-tech-assessment',
    name: 'تقييم تقنيات مساعدة',
    nameEn: 'Assistive Tech Assessment',
    desc: 'تقييم الحاجة للأجهزة المساعدة',
    color: '#9c27b0',
  },
  {
    id: 'hydrotherapy-session',
    name: 'جلسة العلاج المائي',
    nameEn: 'Hydrotherapy Session Record',
    desc: 'سجل جلسة العلاج المائي',
    color: '#0288d1',
  },
  {
    id: 'art-therapy-plan',
    name: 'خطة العلاج بالفن',
    nameEn: 'Art Therapy Plan',
    desc: 'خطة العلاج بالفن والتعبير',
    color: '#e91e63',
  },
  {
    id: 'music-therapy-session',
    name: 'جلسة العلاج بالموسيقى',
    nameEn: 'Music Therapy Session',
    desc: 'سجل جلسة العلاج بالموسيقى',
    color: '#f06292',
  },
  {
    id: 'aba-data-sheet',
    name: 'ورقة بيانات ABA',
    nameEn: 'ABA Data Collection Sheet',
    desc: 'جمع بيانات تحليل السلوك التطبيقي',
    color: '#4a148c',
  },
  {
    id: 'feeding-therapy-plan',
    name: 'خطة علاج التغذية',
    nameEn: 'Feeding Therapy Plan',
    desc: 'خطة علاج صعوبات التغذية والبلع',
    color: '#ff6f00',
  },
  {
    id: 'splinting-orthotics-rx',
    name: 'وصفة جبائر وأجهزة',
    nameEn: 'Splinting & Orthotics Rx',
    desc: 'وصفة جبائر وأجهزة تعويضية',
    color: '#bf360c',
  },
  {
    id: 'therapy-discharge-summary',
    name: 'ملخص خروج علاجي',
    nameEn: 'Therapy Discharge Summary',
    desc: 'ملخص الخروج من البرنامج العلاجي',
    color: '#d32f2f',
  },
  {
    id: 'home-exercise-program',
    name: 'برنامج تمارين منزلي',
    nameEn: 'Home Exercise Program',
    desc: 'برنامج تمارين منزلي لولي الأمر',
    color: '#2e7d32',
  },
  {
    id: 'group-therapy-record',
    name: 'سجل علاج جماعي',
    nameEn: 'Group Therapy Record',
    desc: 'سجل جلسة علاج جماعية',
    color: '#1565c0',
  },
  {
    id: 'functional-assessment',
    name: 'تقييم وظيفي شامل',
    nameEn: 'Functional Assessment',
    desc: 'تقييم القدرات الوظيفية الشامل',
    color: '#00838f',
  },
  {
    id: 'therapy-referral-form',
    name: 'نموذج تحويل علاجي',
    nameEn: 'Therapy Referral Form',
    desc: 'تحويل حالة بين التخصصات العلاجية',
    color: '#5d4037',
  },
  {
    id: 'outcome-measure-report',
    name: 'تقرير مقاييس النتائج',
    nameEn: 'Outcome Measures Report',
    desc: 'تقرير مقاييس النتائج العلاجية',
    color: '#455a64',
  },
];
  ...
  switch (templateId) {
        ...
        <div style={pageWrapper}>
          ...
          <div style={bodyPad}>
            <div style={fieldRow}>
              ...
              <Field label="رقم الملف" value={d.fileNo} w="12%" />
      ...
      return (
        <div style={pageWrapper}>
          ...
          <div style={bodyPad}>
            <div style={fieldRow}>
              <Field label="المستفيد" value={d.beneficiary} w="25%" />
              <Field label="المعالج" value={d.therapist} w="20%" />
              <Field label="التخصص" value={d.specialty} w="15%" />
              <Field label="التاريخ" value={formatDate(d.date) || today()} w="15%" />
            </div>
            <div style={fieldRow}>
              <Field label="رقم الجلسة" value={d.sessionNo} w="10%" />
              <Field label="المدة" value={d.duration} w="10%" />
            </div>
        ...
        <div style={pageWrapper}>
          ...
          <div style={bodyPad}>
            <div style={fieldRow}>
              ...
              <Field label="المعالج الوظيفي" value={d.therapist} w="20%" />
            </div>
            <Section title="الملف الحسي">
              <EmptyTable
                cols={4}
                rows={7}
                headers={['النظام الحسي', 'فرط استجابة', 'ضعف استجابة', 'ملاحظات']}
              />
            </Section>
            <NotesBox label="الأهداف" value={d.goals} lines={3} />
            <NotesBox label="الأنشطة والتقنيات" value={d.activities} lines={3} />
            <div style={fieldRow}>
              <Field label="التكرار" value={d.frequency} w="12%" />
              <Field label="مدة الخطة" value={d.planDuration} w="12%" />
            </div>
    ...
    case 'assistive-tech-assessment':
      return (
        <div style={pageWrapper}>
          <OrgHeader
            title="تقييم الحاجة للتقنيات المساعدة"
            subtitle="Assistive Technology Assessment"
          />
          <div style={bodyPad}>
            <div style={fieldRow}>
              <Field label="المستفيد" value={d.beneficiary} w="25%" />
            ...
            <Section title="التقنيات المقترحة">
              <EmptyTable
                cols={5}
                rows={5}
                headers={['الجهاز/التقنية', 'الغرض', 'الأولوية', 'التكلفة', 'المورد']}
              />
            </Section>
      ...
      return (
        <div style={pageWrapper}>
          ...
          <div style={bodyPad}>
            ...
            <div style={fieldRow}>
              <Field label="درجة حرارة الماء" value={d.waterTemp} w="12%" />
              <Field label="المدة" value={d.duration} w="10%" />
              <Field label="مستوى المقاومة" value={d.resistance} w="12%" />
            </div>
            <Section title="التمارين المنفذة">
              <EmptyTable
                cols={4}
                rows={6}
                headers={['التمرين', 'التكرار', 'الاستجابة', 'ملاحظات']}
              />
            </Section>
          ...
          <div style={bodyPad}>
            ...
            <Section title="الأنشطة الموسيقية">
              <EmptyTable
                cols={4}
                rows={5}
                headers={['النشاط', 'الأداة', 'استجابة المستفيد', 'ملاحظات']}
              />
            </Section>
    ...
    case 'aba-data-sheet':
      return (
        <div style={pageWrapper}>
          <OrgHeader
            title="ورقة جمع بيانات تحليل السلوك التطبيقي"
            subtitle="ABA Data Collection Sheet"
          />
          <ConfidentialBanner />
          <div style={bodyPad}>
            <div style={fieldRow}>
            ...
            <div style={fieldRow}>
              <Field label="السلوك المستهدف" value={d.targetBehavior} w="30%" />
              <Field label="التعريف الإجرائي" value={d.definition} w="30%" />
            </div>
            <Section title="تسجيل البيانات">
              <EmptyTable
                cols={6}
                rows={8}
                headers={['الوقت', 'المثير', 'السلوك', 'النتيجة', 'المدة', 'الشدة']}
              />
            </Section>
            <div style={fieldRow}>
              <Field label="إجمالي التكرار" value={d.totalFrequency} w="12%" />
              <Field label="النسبة" value={d.percentage} w="10%" />
            </div>
            <NotesBox label="ملاحظات" value={d.notes} lines={2} />
          ...
          <div style={bodyPad}>
            ...
            <Section title="خطة التدخل">
              <EmptyTable
                cols={4}
                rows={6}
                headers={['الهدف', 'التقنية', 'قوام الطعام', 'التكرار']}
              />
            </Section>
    ...
    case 'splinting-orthotics-rx':
      return (
        <div style={pageWrapper}>
          <OrgHeader
            title="وصفة جبائر وأجهزة تعويضية"
            subtitle="Splinting & Orthotics Prescription"
          />
          <div style={bodyPad}>
            <div style={fieldRow}>
              <Field label="المستفيد" value={d.beneficiary} w="25%" />
            ...
            <Section title="الجهاز الموصوف">
              <div style={fieldRow}>
                <Field label="النوع" value={d.deviceType} w="20%" />
                <Field label="الموضع" value={d.bodyPart} w="15%" />
                <Field label="المواصفات" value={d.specs} w="30%" />
              </div>
            </Section>
            ...
            <div style={fieldRow}>
              <Field label="موعد المتابعة" value={formatDate(d.followUp)} w="15%" />
            </div>
        ...
        <div style={pageWrapper}>
          ...
          <div style={bodyPad}>
            <div style={fieldRow}>
              ...
              <Field label="تاريخ القبول" value={formatDate(d.admissionDate)} w="15%" />
              <Field label="تاريخ الخروج" value={formatDate(d.dischargeDate)} w="15%" />
            </div>
            ...
            <Section title="الأهداف والنتائج">
              <EmptyTable
                cols={4}
                rows={5}
                headers={['الهدف', 'الحالة عند القبول', 'الحالة عند الخروج', 'التحقق']}
              />
            </Section>
          ...
          <div style={bodyPad}>
            ...
            <Section title="التمارين المطلوبة">
              <EmptyTable
                cols={5}
                rows={8}
                headers={['التمرين', 'الشرح', 'التكرار', 'المدة', 'التكرار/أسبوع']}
              />
            </Section>
    ...
    case 'group-therapy-record':
      return (
        <div style={pageWrapper}>
          ...
          <div style={bodyPad}>
            <div style={fieldRow}>
              <Field label="اسم المجموعة" value={d.groupName} w="20%" />
              <Field label="المعالج" value={d.therapist} w="20%" />
              <Field label="التاريخ" value={formatDate(d.date) || today()} w="15%" />
              <Field label="رقم الجلسة" value={d.sessionNo} w="10%" />
            </div>
            <Section title="المشاركون">
              <EmptyTable
                cols={4}
                rows={6}
                headers={['المستفيد', 'الحضور', 'المشاركة', 'ملاحظات']}
              />
            </Section>
    ...
    case 'functional-assessment':
      return (
        <div style={pageWrapper}>
          <OrgHeader
            title="تقييم القدرات الوظيفية الشامل"
      ...
      return (
        <div style={pageWrapper}>
          ...
          <div style={bodyPad}>
            <div style={fieldRow}>
              <Field label="المستفيد" value={d.beneficiary} w="25%" />
              <Field label="من تخصص" value={d.fromSpecialty} w="15%" />
              <Field label="إلى تخصص" value={d.toSpecialty} w="15%" />
            </div>
            <div style={fieldRow}>
              <Field label="المحوّل" value={d.referredBy} w="20%" />
    ...
    case 'outcome-measure-report':
      return (
        <div style={pageWrapper}>
          <OrgHeader
            title="تقرير مقاييس النتائج العلاجية"
            subtitle="Therapy Outcome Measures Report"
          />
          <div style={bodyPad}>
            <div style={fieldRow}>
              <Field label="المستفيد" value={d.beneficiary} w="25%" />
            ...
            <Section title="مقاييس النتائج">
              <EmptyTable
                cols={5}
                rows={6}
                headers={['المقياس', 'القياس الأولي', 'القياس الحالي', 'التغيير', 'الهدف']}
              />
            </Section>
