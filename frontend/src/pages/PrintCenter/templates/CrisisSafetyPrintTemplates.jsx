...
export const CRISIS_SAFETY_TEMPLATES = [
  ...
  {
    id: 'risk-register-detailed',
    name: 'سجل المخاطر التفصيلي',
    nameEn: 'Detailed Risk Register',
    desc: 'سجل مخاطر تفصيلي شامل',
    color: '#b71c1c',
  },
  {
    id: 'risk-heatmap-report',
    name: 'تقرير خريطة المخاطر',
    nameEn: 'Risk Heatmap Report',
    desc: 'خريطة حرارية لتصنيف المخاطر',
    color: '#c62828',
  },
  {
    id: 'risk-mitigation-plan',
    name: 'خطة التخفيف من المخاطر',
    nameEn: 'Risk Mitigation Plan',
    desc: 'خطة تخفيف وإدارة المخاطر',
    color: '#d32f2f',
  },
  {
    id: 'risk-appetite-statement',
    name: 'بيان تقبل المخاطر',
    nameEn: 'Risk Appetite Statement',
    desc: 'بيان مستوى تقبل المخاطر المؤسسي',
    color: '#e53935',
  },
  {
    id: 'enterprise-risk-summary',
    name: 'ملخص مخاطر المؤسسة',
    nameEn: 'Enterprise Risk Summary',
    desc: 'ملخص مخاطر المؤسسة الشامل',
    color: '#f44336',
  },
  {
    id: 'risk-incident-log',
    name: 'سجل حوادث المخاطر',
    nameEn: 'Risk Incident Log',
    desc: 'سجل حوادث ووقائع المخاطر',
    color: '#ef5350',
  },
  /* ── إدارة الأزمات ── */
  {
    id: 'crisis-incident-report',
    name: 'تقرير حادثة أزمة',
    nameEn: 'Crisis Incident Report',
    desc: 'تقرير تفصيلي عن حادثة أزمة',
    color: '#e65100',
  },
  {
    ...
    desc: 'خطة شاملة للاستجابة للطوارئ',
    color: '#ef6c00',
  },
  {
    id: 'crisis-communication-plan',
    name: 'خطة التواصل في الأزمات',
    nameEn: 'Crisis Communication Plan',
    desc: 'خطة التواصل أثناء الأزمات',
    color: '#f57c00',
  },
  {
    id: 'after-action-report',
    name: 'تقرير ما بعد الأزمة',
    nameEn: 'After Action Report',
    desc: 'تقرير الدروس المستفادة بعد أزمة',
    color: '#fb8c00',
  },
  {
    id: 'crisis-contact-directory',
    name: 'دليل اتصالات الطوارئ',
    nameEn: 'Emergency Contact Directory',
    desc: 'دليل جهات الاتصال في الطوارئ',
    color: '#ff9800',
  },
  {
    id: 'crisis-drill-report',
    name: 'تقرير تمرين طوارئ',
    nameEn: 'Emergency Drill Report',
    desc: 'تقرير نتائج تمرين إخلاء/طوارئ',
    color: '#ffa726',
  },
  /* ── الدفاع المدني والسلامة ── */
  {
    id: 'evacuation-plan-print',
    name: 'خطة الإخلاء',
    nameEn: 'Evacuation Plan',
    desc: 'خطة الإخلاء في حالات الطوارئ',
    color: '#1b5e20',
  },
  {
    id: 'fire-drill-report',
    name: 'تقرير تمرين إطفاء',
    nameEn: 'Fire Drill Report',
    desc: 'تقرير تمرين الإطفاء والإخلاء',
    color: '#2e7d32',
  },
  {
    id: 'civil-defense-inspection',
    name: 'تقرير فحص الدفاع المدني',
    nameEn: 'Civil Defense Inspection',
    desc: 'تقرير فحص متطلبات الدفاع المدني',
    color: '#388e3c',
  },
  {
    id: 'safety-compliance-cert',
    name: 'شهادة الالتزام بالسلامة',
    nameEn: 'Safety Compliance Certificate',
    desc: 'شهادة التزام بمعايير السلامة',
    color: '#43a047',
  },
  {
    id: 'emergency-equipment-check',
    name: 'فحص معدات الطوارئ',
    nameEn: 'Emergency Equipment Check',
    desc: 'قائمة فحص معدات الطوارئ',
    color: '#4caf50',
  },
  {
    id: 'assembly-point-map',
    name: 'خريطة نقاط التجمع',
    nameEn: 'Assembly Point Map',
    desc: 'خريطة نقاط التجمع في الطوارئ',
    color: '#66bb6a',
  },
];
  ...
  switch (templateId) {
    ...
    case 'risk-register-detailed':
      return (
        <div style={pageWrapper}>
          ...
          <div style={bodyPad}>
            <div style={fieldRow}>
              <Field label="القسم/البرنامج" value={d.department} w="25%" />
              <Field label="الفترة" value={d.period} w="20%" />
              <Field label="المسؤول" value={d.owner} w="25%" />
              <Field label="آخر تحديث" value={formatDate(d.lastUpdate) || today()} w="15%" />
            </div>
            ...
            <Section title="ملخص التصنيفات">
              <EmptyTable
                cols={4}
                rows={4}
                headers={['التصنيف', 'العدد', 'النسبة', 'التغيير عن الفترة السابقة']}
              />
            </Section>
    ...
    case 'risk-heatmap-report':
      return (
        <div style={pageWrapper}>
          ...
          <div style={bodyPad}>
            <div style={fieldRow}>
              <Field label="الجهة" value={d.entity} w="25%" />
              <Field label="الفترة" value={d.period} w="20%" />
              <Field label="إجمالي المخاطر" value={d.totalRisks} w="15%" />
            </div>
            <Section title="التوزيع حسب الاحتمال والأثر">
              <EmptyTable
                cols={6}
                rows={6}
                headers={['', 'أثر (1)', 'أثر (2)', 'أثر (3)', 'أثر (4)', 'أثر (5)']}
              />
            </Section>
            <Section title="أعلى 10 مخاطر">
              <EmptyTable
                cols={5}
                rows={10}
                headers={['#', 'المخاطرة', 'الدرجة', 'الاتجاه', 'الإجراء']}
              />
            </Section>
    ...
    case 'risk-mitigation-plan':
      return (
        <div style={pageWrapper}>
          ...
          <div style={bodyPad}>
            <div style={fieldRow}>
              <Field label="المخاطرة" value={d.riskTitle} w="30%" />
              <Field label="رقم المخاطرة" value={d.riskId} w="15%" />
              <Field label="الدرجة" value={d.riskScore} w="12%" />
              <Field label="التاريخ" value={formatDate(d.date) || today()} w="15%" />
            </div>
            <NotesBox label="وصف المخاطرة" value={d.riskDescription} lines={2} />
            <div style={fieldRow}>
              <Field label="الاستراتيجية" value={d.strategy} w="20%" />
              <Field label="المسؤول" value={d.owner} w="25%" />
            </div>
            <Section title="إجراءات التخفيف">
              <EmptyTable
                cols={5}
                rows={6}
                headers={['الإجراء', 'المسؤول', 'الموعد', 'التكلفة', 'الحالة']}
              />
            </Section>
            <Section title="مؤشرات المراقبة">
              <EmptyTable
                cols={4}
                rows={4}
                headers={['المؤشر', 'الحد المقبول', 'القيمة الحالية', 'الحالة']}
              />
            </Section>
        ...
        <div style={pageWrapper}>
          ...
          <div style={bodyPad}>
            <div style={fieldRow}>
              ...
              <Field label="المراجعة القادمة" value={formatDate(d.nextReview)} w="15%" />
            </div>
            ...
            <Section title="مستويات التقبل حسب الفئة">
              <EmptyTable
                cols={5}
                rows={6}
                headers={['فئة المخاطرة', 'منخفض', 'متوسط', 'مرتفع', 'ملاحظات']}
              />
            </Section>
        ...
        <div style={pageWrapper}>
          ...
          <div style={bodyPad}>
            <div style={fieldRow}>
              ...
              <Field label="إجمالي المخاطر" value={d.totalRisks} w="12%" />
              <Field label="جديدة" value={d.newRisks} w="10%" />
              <Field label="مغلقة" value={d.closedRisks} w="10%" />
            </div>
            <Section title="توزيع المخاطر حسب الفئة">
              <EmptyTable
                cols={5}
                rows={6}
                headers={['الفئة', 'حرجة', 'عالية', 'متوسطة', 'منخفضة']}
              />
            </Section>
      ...
      return (
        <div style={pageWrapper}>
          ...
          <div style={bodyPad}>
            <div style={fieldRow}>
              <Field label="الفترة" value={d.period} w="25%" />
              <Field label="إجمالي الحوادث" value={d.totalIncidents} w="15%" />
            </div>
    ...
    case 'crisis-incident-report':
      return (
        <div style={pageWrapper}>
          ...
          <div style={bodyPad}>
            <div style={fieldRow}>
              <Field label="نوع الأزمة" value={d.crisisType} w="25%" />
              <Field label="تاريخ البدء" value={formatDate(d.startDate)} w="15%" />
              <Field label="تاريخ الانتهاء" value={formatDate(d.endDate)} w="15%" />
              <Field label="الخطورة" value={d.severity} w="12%" />
            </div>
            <div style={fieldRow}>
              <Field label="الموقع" value={d.location} w="25%" />
              <Field label="عدد المتأثرين" value={d.affectedCount} w="15%" />
              <Field label="المبلّغ" value={d.reporter} w="25%" />
            </div>
    ...
    case 'emergency-response-plan':
      return (
        <div style={pageWrapper}>
          <OrgHeader
            title="خطة الاستجابة الشاملة للطوارئ"
            subtitle="Comprehensive Emergency Response Plan"
          />
          <div style={bodyPad}>
            <div style={fieldRow}>
              <Field label="الإصدار" value={d.version} w="10%" />
      ...
      return (
        <div style={pageWrapper}>
          ...
          <div style={bodyPad}>
            <div style={fieldRow}>
              <Field label="نوع الأزمة" value={d.crisisType} w="25%" />
              <Field label="المتحدث الرسمي" value={d.spokesperson} w="25%" />
              <Field label="التاريخ" value={formatDate(d.date) || today()} w="15%" />
            </div>
            <Section title="الرسائل الرئيسية">
              <EmptyTable
                cols={3}
                rows={5}
                headers={['الجمهور المستهدف', 'الرسالة الرئيسية', 'القناة']}
              />
            </Section>
            <Section title="جدول التواصل">
              <EmptyTable
                cols={5}
                rows={6}
                headers={['الوقت', 'الإجراء', 'الجهة', 'القناة', 'المسؤول']}
              />
            </Section>
    ...
    case 'after-action-report':
      return (
        <div style={pageWrapper}>
          <OrgHeader
            title="تقرير ما بعد الأزمة — الدروس المستفادة"
            subtitle="After Action Report"
          />
          <div style={bodyPad}>
            <div style={fieldRow}>
              <Field label="الحادثة" value={d.incident} w="30%" />
            ...
            <Section title="فرص التحسين">
              <EmptyTable
                cols={4}
                rows={4}
                headers={['الجانب', 'الفجوة', 'الإجراء المقترح', 'المسؤول']}
              />
            </Section>
          ...
          <div style={bodyPad}>
            ...
            <Section title="جهات الاتصال الداخلية">
              <EmptyTable
                cols={5}
                rows={8}
                headers={['الدور', 'الاسم', 'الهاتف', 'البريد', 'البديل']}
              />
            </Section>
            <Section title="الجهات الخارجية">
              <EmptyTable
                cols={4}
                rows={8}
                headers={['الجهة', 'رقم الطوارئ', 'الهاتف العام', 'ملاحظات']}
              />
            </Section>
          </div>
          <OrgFooter />
    ...
    case 'crisis-drill-report':
      return (
        <div style={pageWrapper}>
          ...
          <div style={bodyPad}>
            <div style={fieldRow}>
              <Field label="نوع التمرين" value={d.drillType} w="20%" />
              <Field label="التاريخ" value={formatDate(d.date) || today()} w="15%" />
              <Field label="المدة" value={d.duration} w="12%" />
              <Field label="المشاركون" value={d.participants} w="15%" />
            </div>
            <div style={fieldRow}>
              <Field label="الموقع" value={d.location} w="25%" />
            ...
            <div style={fieldRow}>
              <Field label="وقت الإخلاء" value={d.evacuationTime} w="15%" />
        ...
        <div style={pageWrapper}>
          ...
          <div style={bodyPad}>
            <div style={fieldRow}>
              ...
              <Field label="الطابق" value={d.floor} w="12%" />
              <Field label="السعة" value={d.capacity} w="12%" />
              <Field label="آخر تحديث" value={formatDate(d.lastUpdate) || today()} w="15%" />
            </div>
            <Section title="مسارات الإخلاء">
              <EmptyTable
                cols={4}
                rows={6}
                headers={['المنطقة', 'المسار الرئيسي', 'المسار البديل', 'المسؤول']}
              />
            </Section>
      ...
      return (
        <div style={pageWrapper}>
          ...
          <div style={bodyPad}>
            <div style={fieldRow}>
              <Field label="التاريخ" value={formatDate(d.date) || today()} w="15%" />
              <Field label="الوقت" value={d.time} w="10%" />
              <Field label="المبنى" value={d.building} w="20%" />
              <Field label="المشرف" value={d.supervisor} w="25%" />
            </div>
            <div style={fieldRow}>
              <Field label="عدد المشاركين" value={d.participantCount} w="15%" />
              <Field label="زمن الإخلاء" value={d.evacuationTime} w="15%" />
              <Field label="الهدف" value={d.target} w="15%" />
            </div>
    ...
    case 'civil-defense-inspection':
      return (
        <div style={pageWrapper}>
          <OrgHeader
            title="تقرير فحص متطلبات الدفاع المدني"
            subtitle="Civil Defense Inspection Report"
          />
          <RefDateLine refNo={d.refNo} date={d.date} />
          <div style={bodyPad}>
            <div style={fieldRow}>
              <Field label="المنشأة" value={d.facility} w="25%" />
              <Field label="المفتش" value={d.inspector} w="25%" />
              <Field label="التاريخ" value={formatDate(d.date) || today()} w="15%" />
            </div>
            <Section title="قائمة الفحص">
              <EmptyTable
                cols={5}
                rows={15}
                headers={['البند', 'المعيار', 'مطابق', 'غير مطابق', 'ملاحظات']}
              />
            </Section>
            <div style={fieldRow}>
              <Field label="النتيجة العامة" value={d.overallResult} w="20%" />
              <Field label="عدد المخالفات" value={d.violations} w="15%" />
            </div>
    ...
    case 'safety-compliance-cert':
      return (
        <div style={pageWrapper}>
          <OrgHeader
            title="شهادة الالتزام بمعايير السلامة"
            subtitle="Safety Compliance Certificate"
          />
          <div style={bodyPad}>
            <div
              style={{
            ...
            >
              ...
              <div style={fieldRow}>
                <Field label="رقم الشهادة" value={d.certNo} w="25%" />
                <Field label="تاريخ الإصدار" value={formatDate(d.issueDate) || today()} w="15%" />
              </div>
              <div style={fieldRow}>
                <Field label="المنشأة" value={d.facility} w="30%" />
                <Field label="الموقع" value={d.location} w="25%" />
              </div>
              <div style={fieldRow}>
                <Field label="المعيار المرجعي" value={d.standard} w="30%" />
                <Field label="مستوى الامتثال" value={d.complianceLevel} w="20%" />
              </div>
              <div style={fieldRow}>
                <Field label="صالحة حتى" value={formatDate(d.validUntil)} w="15%" />
              </div>
            </div>
      ...
      return (
        <div style={pageWrapper}>
          ...
          <div style={bodyPad}>
            <div style={fieldRow}>
              <Field label="المبنى" value={d.building} w="20%" />
              <Field label="الطابق" value={d.floor} w="10%" />
              <Field label="المفتش" value={d.inspector} w="25%" />
              <Field label="التاريخ" value={formatDate(d.date) || today()} w="15%" />
            </div>
            <Section title="طفايات الحريق">
              <EmptyTable
                cols={5}
                rows={6}
                headers={['الرقم', 'الموقع', 'النوع', 'تاريخ الصلاحية', 'الحالة']}
              />
            </Section>
            <Section title="معدات أخرى">
              <EmptyTable
                cols={5}
                rows={6}
                headers={['المعدة', 'الموقع', 'الكمية', 'الحالة', 'ملاحظات']}
              />
            </Section>
          ...
          <div style={bodyPad}>
            ...
            <Section title="نقاط التجمع">
              <EmptyTable
                cols={6}
                rows={6}
                headers={['رمز النقطة', 'الاسم', 'الموقع', 'السعة', 'المسؤول', 'المناطق المخصصة']}
              />
            </Section>
            <div
              style={{
