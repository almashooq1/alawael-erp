...
export const ENTERPRISE_PLUS_TEMPLATES = [
  ...
  {
    id: 'bcp-plan-document',
    name: 'خطة استمرارية الأعمال',
    nameEn: 'Business Continuity Plan',
    desc: 'وثيقة خطة استمرارية الأعمال الشاملة',
    color: '#283593',
  },
  {
    id: 'bcp-test-report',
    name: 'تقرير اختبار BCP',
    nameEn: 'BCP Test Report',
    desc: 'تقرير اختبار خطة استمرارية الأعمال',
    color: '#303f9f',
  },
  {
    ...
    desc: 'إطار عمل الحوكمة المؤسسية',
    color: '#3949ab',
  },
  {
    id: 'compliance-dashboard-print',
    name: 'لوحة الامتثال',
    nameEn: 'Compliance Dashboard',
    desc: 'طباعة لوحة حالة الامتثال',
    color: '#3f51b5',
  },
  {
    id: 'governance-meeting-report',
    name: 'تقرير اجتماع الحوكمة',
    nameEn: 'Governance Meeting Report',
    desc: 'محضر اجتماع لجنة الحوكمة',
    color: '#5c6bc0',
  },
  /* ── الاستدامة والمسؤولية الاجتماعية ── */
  {
    id: 'sustainability-report',
    name: 'تقرير الاستدامة',
    nameEn: 'Sustainability Report',
    desc: 'تقرير الاستدامة السنوي',
    color: '#2e7d32',
  },
  {
    id: 'carbon-footprint-report',
    name: 'تقرير البصمة الكربونية',
    nameEn: 'Carbon Footprint Report',
    desc: 'تقرير البصمة الكربونية للمنشأة',
    color: '#388e3c',
  },
  {
    id: 'csr-impact-report',
    name: 'تقرير أثر المسؤولية الاجتماعية',
    nameEn: 'CSR Impact Report',
    desc: 'تقرير أثر برامج المسؤولية الاجتماعية',
    color: '#43a047',
  },
  /* ── إدارة خدمات تقنية المعلومات ── */
  {
    id: 'it-service-request-form',
    name: 'طلب خدمة تقنية',
    nameEn: 'IT Service Request',
    desc: 'نموذج طلب خدمة تقنية معلومات',
    color: '#6a1b9a',
  },
  {
    id: 'it-change-management',
    name: 'إدارة التغيير التقني',
    nameEn: 'IT Change Management',
    desc: 'نموذج طلب تغيير تقني',
    color: '#7b1fa2',
  },
  {
    id: 'it-asset-register-print',
    name: 'سجل الأصول التقنية',
    nameEn: 'IT Asset Register',
    desc: 'سجل أصول تقنية المعلومات',
    color: '#8e24aa',
  },
  {
    id: 'it-incident-report',
    name: 'تقرير حادث تقني',
    nameEn: 'IT Incident Report',
    desc: 'تقرير حادث أمني أو تقني',
    color: '#9c27b0',
  },
  /* ── إدارة الموردين ── */
  {
    id: 'vendor-performance-scorecard',
    name: 'بطاقة أداء المورد',
    nameEn: 'Vendor Scorecard',
    desc: 'بطاقة تقييم أداء المورد',
    color: '#00695c',
  },
  {
    id: 'vendor-audit-report',
    name: 'تقرير تدقيق المورد',
    nameEn: 'Vendor Audit Report',
    desc: 'تقرير تدقيق مورد',
    color: '#00796b',
  },
  {
    id: 'vendor-onboarding-form',
    name: 'نموذج تأهيل مورد',
    nameEn: 'Vendor Onboarding',
    desc: 'نموذج تأهيل مورد جديد',
    color: '#00897b',
  },
  /* ── رعاية متكاملة متقدمة ── */
  {
    id: 'integrated-care-pathway',
    name: 'مسار الرعاية المتكاملة',
    nameEn: 'Integrated Care Pathway',
    desc: 'مسار رعاية متكامل للمستفيد',
    color: '#c62828',
  },
  {
    id: 'care-coordination-summary',
    name: 'ملخص تنسيق الرعاية',
    nameEn: 'Care Coordination Summary',
    desc: 'ملخص تنسيق الرعاية بين الفرق',
    color: '#d32f2f',
  },
  {
    id: 'quality-improvement-project',
    name: 'مشروع تحسين الجودة',
    nameEn: 'Quality Improvement Project',
    desc: 'نموذج مشروع تحسين الجودة المستمرة',
    color: '#e53935',
  },
];
  ...
  switch (templateId) {
    ...
    case 'bcp-plan-document':
      return (
        <div style={pageWrapper}>
          ...
          <div style={bodyPad}>
            <div style={fieldRow}>
              <Field label="اسم الخطة" value={d.planName} w="30%" />
              <Field label="الإصدار" value={d.version} w="10%" />
              <Field label="المالك" value={d.owner} w="25%" />
              <Field label="تاريخ المراجعة" value={formatDate(d.reviewDate)} w="15%" />
            </div>
            ...
            <Section title="العمليات الحرجة (BIA)">
              <EmptyTable
                cols={5}
                rows={6}
                headers={['العملية', 'الأولوية', 'RTO', 'RPO', 'البديل']}
              />
            </Section>
            ...
            <Section title="خطوات الاستجابة">
              <EmptyTable
                cols={4}
                rows={6}
                headers={['المرحلة', 'الإجراء', 'المسؤول', 'الجدول الزمني']}
              />
            </Section>
    ...
    case 'bcp-test-report':
      return (
        <div style={pageWrapper}>
          ...
          <div style={bodyPad}>
            <div style={fieldRow}>
              <Field label="نوع الاختبار" value={d.testType} w="20%" />
              <Field label="السيناريو" value={d.scenario} w="25%" />
              <Field label="التاريخ" value={formatDate(d.date) || today()} w="15%" />
              <Field label="القائد" value={d.leader} w="20%" />
            </div>
            <Section title="النتائج">
              <EmptyTable
                cols={5}
                rows={6}
                headers={['الإجراء المختبر', 'النتيجة', 'الوقت الفعلي', 'الوقت المستهدف', 'الحكم']}
              />
            </Section>
      ...
      return (
        <div style={pageWrapper}>
          ...
          <div style={bodyPad}>
            <div style={fieldRow}>
              <Field label="الإصدار" value={d.version} w="10%" />
              <Field label="المعتمد" value={d.approvedBy} w="25%" />
              <Field label="تاريخ الاعتماد" value={formatDate(d.approvalDate)} w="15%" />
            </div>
            ...
            <Section title="هيكل الحوكمة">
              <EmptyTable
                cols={3}
                rows={5}
                headers={['اللجنة/الهيئة', 'المهام', 'دورية الاجتماع']}
              />
            </Section>
        ...
        <div style={pageWrapper}>
          ...
          <div style={bodyPad}>
            <div style={fieldRow}>
              ...
              <Field label="التاريخ" value={formatDate(d.date) || today()} w="15%" />
              <Field label="مسؤول الامتثال" value={d.complianceOfficer} w="25%" />
            </div>
            <Section title="حالة الامتثال حسب المجال">
              <EmptyTable
                cols={5}
                rows={8}
                headers={['المجال', 'متطلبات', 'متحقق', 'النسبة %', 'الحالة']}
              />
            </Section>
            <Section title="المخالفات والملاحظات">
              <EmptyTable
                cols={4}
                rows={5}
                headers={['الملاحظة', 'المستوى', 'الإجراء التصحيحي', 'الموعد']}
              />
            </Section>
            <div style={fieldRow}>
              <Field label="نسبة الامتثال الإجمالية" value={d.overallComplianceRate} w="20%" />
            </div>
    ...
    case 'governance-meeting-report':
      return (
        <div style={pageWrapper}>
          <OrgHeader
            title="محضر اجتماع لجنة الحوكمة"
            subtitle="Governance Committee Meeting Report"
          />
          <RefDateLine refNo={d.refNo} date={d.date} />
          <div style={bodyPad}>
            <div style={fieldRow}>
              <Field label="الاجتماع رقم" value={d.meetingNo} w="10%" />
              <Field label="التاريخ" value={formatDate(d.date) || today()} w="15%" />
              <Field label="الرئيس" value={d.chair} w="25%" />
            </div>
            ...
            <div style={fieldRow}>
              <Field label="الاجتماع القادم" value={formatDate(d.nextMeeting)} w="15%" />
            </div>
    ...
    case 'sustainability-report':
      return (
        <div style={pageWrapper}>
          ...
          <div style={bodyPad}>
            <div style={fieldRow}>
              <Field label="العام" value={d.year} w="10%" />
              <Field label="المعد" value={d.preparer} w="25%" />
              <Field label="التاريخ" value={formatDate(d.date) || today()} w="15%" />
            </div>
            <Section title="مؤشرات الاستدامة">
              <EmptyTable
                cols={5}
                rows={6}
                headers={['المؤشر', 'الهدف', 'الفعلي', 'الفرق', 'الاتجاه']}
              />
            </Section>
      ...
      return (
        <div style={pageWrapper}>
          ...
          <div style={bodyPad}>
            <div style={fieldRow}>
              <Field label="الفترة" value={d.period} w="20%" />
              <Field label="المنشأة" value={d.facility} w="25%" />
              <Field label="التاريخ" value={formatDate(d.date) || today()} w="15%" />
            </div>
            <Section title="مصادر الانبعاثات">
              <EmptyTable
                cols={5}
                rows={6}
                headers={['المصدر', 'النطاق', 'الكمية (طن CO₂)', 'النسبة %', 'ملاحظات']}
              />
            </Section>
            <div style={fieldRow}>
              <Field label="إجمالي الانبعاثات" value={d.totalEmissions} w="20%" />
              <Field label="التغير عن العام السابق" value={d.yearChange} w="20%" />
            </div>
        ...
        <div style={pageWrapper}>
          ...
          <div style={bodyPad}>
            <div style={fieldRow}>
              ...
              <Field label="الفترة" value={d.period} w="20%" />
              <Field label="المسؤول" value={d.manager} w="25%" />
            </div>
            <Section title="المستفيدون">
              <EmptyTable
                cols={4}
                rows={4}
                headers={['الفئة', 'العدد', 'نوع الاستفادة', 'التأثير']}
              />
            </Section>
            <Section title="مؤشرات الأثر">
              <EmptyTable
                cols={4}
                rows={5}
                headers={['المؤشر', 'المستهدف', 'المتحقق', 'ملاحظات']}
              />
            </Section>
            <NotesBox label="الدروس المستفادة" value={d.lessonsLearned} lines={2} />
            <div style={fieldRow}>
              <Field label="الميزانية المصروفة" value={d.budget} w="15%" />
              <Field label="التقييم العام" value={d.overallRating} w="15%" />
            </div>
    ...
    case 'it-service-request-form':
      return (
        <div style={pageWrapper}>
          ...
          <div style={bodyPad}>
            <div style={fieldRow}>
              <Field label="مقدم الطلب" value={d.requester} w="25%" />
              <Field label="القسم" value={d.department} w="20%" />
              <Field label="الأولوية" value={d.priority} w="12%" />
              <Field label="التاريخ" value={formatDate(d.date) || today()} w="15%" />
            </div>
            <div style={fieldRow}>
              <Field label="نوع الطلب" value={d.requestType} w="20%" />
              <Field label="الفئة" value={d.category} w="15%" />
            </div>
    ...
    case 'it-change-management':
      return (
        <div style={pageWrapper}>
          ...
          <div style={bodyPad}>
            <div style={fieldRow}>
              <Field label="عنوان التغيير" value={d.changeTitle} w="30%" />
              <Field label="النوع" value={d.changeType} w="15%" />
              <Field label="الأولوية" value={d.priority} w="12%" />
              <Field label="مقدم الطلب" value={d.requester} w="25%" />
            </div>
            ...
            <div style={fieldRow}>
              <Field label="تاريخ التنفيذ" value={formatDate(d.implementationDate)} w="15%" />
              <Field label="نافذة الصيانة" value={d.maintenanceWindow} w="20%" />
            </div>
      ...
      return (
        <div style={pageWrapper}>
          ...
          <div style={bodyPad}>
            <div style={fieldRow}>
              <Field label="القسم" value={d.department} w="20%" />
              <Field label="تاريخ الطباعة" value={today()} w="15%" />
              <Field label="المسؤول" value={d.manager} w="25%" />
            </div>
            ...
            <div style={fieldRow}>
              <Field label="إجمالي الأصول" value={d.totalAssets} w="15%" />
              <Field label="نشطة" value={d.activeAssets} w="10%" />
              <Field label="متقاعدة" value={d.retiredAssets} w="10%" />
            </div>
    ...
    case 'it-incident-report':
      return (
        <div style={pageWrapper}>
          ...
          <div style={bodyPad}>
            <div style={fieldRow}>
              <Field label="نوع الحادث" value={d.incidentType} w="15%" />
              <Field label="الخطورة" value={d.severity} w="12%" />
              <Field label="المبلّغ" value={d.reporter} w="20%" />
              <Field label="وقت الاكتشاف" value={d.discoveryTime} w="15%" />
            </div>
    ...
    case 'vendor-performance-scorecard':
      return (
        <div style={pageWrapper}>
          ...
          <div style={bodyPad}>
            <div style={fieldRow}>
              <Field label="المورد" value={d.vendor} w="25%" />
              <Field label="فئة التوريد" value={d.category} w="15%" />
              <Field label="الفترة" value={d.period} w="20%" />
              <Field label="المقيِّم" value={d.evaluator} w="20%" />
            </div>
            <Section title="معايير التقييم">
              <EmptyTable
                cols={5}
                rows={8}
                headers={['المعيار', 'الوزن %', 'الدرجة (1-10)', 'الدرجة الموزونة', 'ملاحظات']}
              />
            </Section>
            <div style={fieldRow}>
              <Field label="الدرجة الإجمالية" value={d.totalScore} w="15%" />
              <Field label="التصنيف" value={d.rating} w="15%" />
              <Field label="التوصية" value={d.recommendation} w="25%" />
            </div>
      ...
      return (
        <div style={pageWrapper}>
          ...
          <div style={bodyPad}>
            <div style={fieldRow}>
              <Field label="المورد" value={d.vendor} w="25%" />
              <Field label="الموقع" value={d.location} w="20%" />
              <Field label="المدقق" value={d.auditor} w="20%" />
              <Field label="التاريخ" value={formatDate(d.date) || today()} w="15%" />
            </div>
            <Section title="نتائج التدقيق">
              <EmptyTable
                cols={4}
                rows={8}
                headers={['المجال', 'الملاحظة', 'المستوى', 'الإجراء التصحيحي']}
              />
            </Section>
            <div style={fieldRow}>
              <Field label="عدد الملاحظات" value={d.findingsCount} w="15%" />
              <Field label="حرجة" value={d.critical} w="10%" />
              <Field label="رئيسية" value={d.major} w="10%" />
              <Field label="ثانوية" value={d.minor} w="10%" />
            </div>
            <NotesBox label="التوصيات" value={d.recommendations} lines={2} />
            <div style={fieldRow}>
              <Field label="القرار" value={d.auditDecision} w="20%" />
            </div>
    ...
    case 'vendor-onboarding-form':
      return (
        <div style={pageWrapper}>
          ...
          <div style={bodyPad}>
            <div style={fieldRow}>
              <Field label="اسم المورد" value={d.vendorName} w="25%" />
              <Field label="السجل التجاري" value={d.crNumber} w="15%" />
              <Field label="الرقم الضريبي" value={d.vatNumber} w="15%" />
            </div>
            <div style={fieldRow}>
              <Field label="العنوان" value={d.address} w="30%" />
              <Field label="المسؤول" value={d.contactPerson} w="20%" />
              <Field label="الهاتف" value={d.phone} w="15%" />
            </div>
            <div style={fieldRow}>
              <Field label="البريد" value={d.email} w="20%" />
              <Field label="IBAN" value={d.iban} w="20%" />
              <Field label="فئة التوريد" value={d.category} w="15%" />
            </div>
        ...
        <div style={pageWrapper}>
          ...
          <div style={bodyPad}>
            <div style={fieldRow}>
              ...
              <Field label="التشخيص" value={d.diagnosis} w="20%" />
              <Field label="المنسق" value={d.coordinator} w="20%" />
              <Field label="تاريخ البدء" value={formatDate(d.startDate)} w="15%" />
            </div>
            <Section title="مراحل المسار">
              <EmptyTable
                cols={5}
                rows={6}
                headers={['المرحلة', 'الهدف', 'الخدمات', 'المدة', 'معيار الانتقال']}
              />
            </Section>
          ...
          <div style={bodyPad}>
            ...
            <Section title="الخدمات المقدمة">
              <EmptyTable
                cols={5}
                rows={8}
                headers={['الخدمة', 'المقدم', 'عدد الجلسات', 'التقدم', 'ملاحظات']}
              />
            </Section>
            <Section title="اجتماعات التنسيق">
              <EmptyTable
                cols={4}
                rows={4}
                headers={['التاريخ', 'الحاضرون', 'القرارات', 'المتابعة']}
              />
            </Section>
    ...
    case 'quality-improvement-project':
      return (
        <div style={pageWrapper}>
          <OrgHeader
            title="مشروع تحسين الجودة المستمرة"
            subtitle="Quality Improvement Project (QI)"
          />
          <RefDateLine refNo={d.refNo} date={d.date} />
          <div style={bodyPad}>
            <div style={fieldRow}>
              <Field label="عنوان المشروع" value={d.projectTitle} w="30%" />
              <Field label="القسم" value={d.department} w="15%" />
              <Field label="قائد المشروع" value={d.projectLead} w="25%" />
              <Field label="التاريخ" value={formatDate(d.date) || today()} w="15%" />
            </div>
            ...
            <Section title="المؤشرات">
              <EmptyTable
                cols={4}
                rows={4}
                headers={['المؤشر', 'القياس الأساسي', 'الهدف', 'القياس النهائي']}
              />
            </Section>
