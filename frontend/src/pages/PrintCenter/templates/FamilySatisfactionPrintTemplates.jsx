...
export const FAMILY_SATISFACTION_TEMPLATES = [
  /* ── رضا الأسر ── */
  {
    id: 'family-satisfaction-survey',
    name: 'استبيان رضا الأسرة',
    nameEn: 'Family Satisfaction Survey',
    desc: 'استبيان قياس رضا الأسرة عن الخدمات',
    color: '#e91e63',
  },
  {
    id: 'family-survey-results',
    name: 'نتائج استبيان رضا الأسر',
    nameEn: 'Survey Results Report',
    desc: 'تقرير نتائج استبيان رضا الأسر',
    color: '#f06292',
  },
  {
    id: 'family-feedback-summary',
    name: 'ملخص ملاحظات الأسر',
    nameEn: 'Family Feedback Summary',
    desc: 'ملخص ملاحظات وآراء الأسر',
    color: '#ec407a',
  },
  {
    id: 'family-improvement-plan',
    name: 'خطة تحسين من ملاحظات الأسر',
    nameEn: 'Family Feedback Improvement Plan',
    desc: 'خطة التحسين بناءً على ملاحظات الأسر',
    color: '#c2185b',
  },
  {
    id: 'family-meeting-summary',
    name: 'ملخص اجتماع الأسرة',
    nameEn: 'Family Meeting Summary',
    desc: 'ملخص اجتماع مع أسرة المستفيد',
    color: '#ad1457',
  },
  /* ── نتائج التأهيل ── */
  {
    id: 'rehab-outcome-report',
    name: 'تقرير نتائج التأهيل',
    nameEn: 'Rehabilitation Outcome Report',
    desc: 'تقرير مخرجات البرنامج التأهيلي',
    color: '#00695c',
  },
  {
    ...
    desc: 'تقرير قياس فعالية برنامج تأهيلي',
    color: '#00796b',
  },
  {
    id: 'outcome-comparison',
    name: 'مقارنة النتائج',
    nameEn: 'Outcome Comparison Report',
    desc: 'مقارنة نتائج قبل وبعد التأهيل',
    color: '#00897b',
  },
  {
    id: 'rehab-kpi-report',
    name: 'مؤشرات أداء التأهيل',
    nameEn: 'Rehab KPI Report',
    desc: 'مؤشرات أداء برامج التأهيل',
    color: '#009688',
  },
  {
    id: 'annual-outcome-summary',
    name: 'ملخص النتائج السنوي',
    nameEn: 'Annual Outcome Summary',
    desc: 'ملخص مخرجات التأهيل السنوية',
    color: '#26a69a',
  },
  /* ── المتابعة والانتقال ── */
  {
    id: 'followup-visit-form',
    name: 'نموذج زيارة متابعة',
    nameEn: 'Follow-Up Visit Form',
    desc: 'نموذج زيارة متابعة بعد التخرج',
    color: '#1565c0',
  },
  {
    id: 'reintegration-report',
    name: 'تقرير إعادة الدمج',
    nameEn: 'Reintegration Report',
    desc: 'تقرير إعادة دمج المستفيد في المجتمع',
    color: '#1976d2',
  },
  {
    id: 'transition-plan-form',
    name: 'خطة الانتقال',
    nameEn: 'Transition Plan',
    desc: 'خطة الانتقال بين المراحل/البرامج',
    color: '#1e88e5',
  },
  {
    id: 'aftercare-checklist',
    name: 'قائمة مراجعة ما بعد الخروج',
    nameEn: 'Aftercare Checklist',
    desc: 'قائمة مراجعة خدمات ما بعد الخروج',
    color: '#2196f3',
  },
  {
    id: 'community-reintegration-plan',
    name: 'خطة الدمج المجتمعي',
    nameEn: 'Community Reintegration Plan',
    desc: 'خطة الدمج في المجتمع المحلي',
    color: '#42a5f5',
  },
  {
    id: 'followup-outcome-report',
    name: 'تقرير نتائج المتابعة',
    nameEn: 'Follow-Up Outcome Report',
    desc: 'تقرير نتائج المتابعة بعد الخروج',
    color: '#0d47a1',
  },
];
  ...
  switch (templateId) {
          ...
          <div style={bodyPad}>
            ...
            <Section title="تقييم الخدمات">
              <EmptyTable
                cols={5}
                rows={10}
                headers={['الخدمة', 'ممتاز (5)', 'جيد (4)', 'مقبول (3)', 'ضعيف (1-2)']}
              />
            </Section>
    ...
    case 'family-survey-results':
      return (
        <div style={pageWrapper}>
          <OrgHeader
            title="تقرير نتائج استبيان رضا الأسر"
            subtitle="Family Satisfaction Survey Results"
          />
          <div style={bodyPad}>
            <div style={fieldRow}>
              <Field label="الفترة" value={d.period} w="25%" />
              <Field label="عدد المشاركين" value={d.participants} w="15%" />
              <Field label="نسبة الاستجابة" value={d.responseRate} w="15%" />
              <Field label="المعدل العام" value={d.overallScore} w="15%" />
            </div>
      ...
      return (
        <div style={pageWrapper}>
          ...
          <div style={bodyPad}>
            <div style={fieldRow}>
              <Field label="الفترة" value={d.period} w="25%" />
              <Field label="إجمالي الملاحظات" value={d.totalFeedback} w="15%" />
              <Field label="إيجابية" value={d.positive} w="12%" />
              <Field label="سلبية" value={d.negative} w="12%" />
              <Field label="مقترحات" value={d.suggestions} w="12%" />
            </div>
            <Section title="الملاحظات الشائعة">
              <EmptyTable
                cols={4}
                rows={8}
                headers={['الموضوع', 'النوع', 'التكرار', 'الإجراء المتخذ']}
              />
            </Section>
            <NotesBox label="التوصيات" value={d.recommendations} lines={2} />
    ...
    case 'family-improvement-plan':
      return (
        <div style={pageWrapper}>
          <OrgHeader
            title="خطة التحسين بناءً على ملاحظات الأسر"
            subtitle="Family Feedback Improvement Plan"
          />
          <div style={bodyPad}>
            <div style={fieldRow}>
              <Field label="الفترة المرجعية" value={d.referencePeriod} w="25%" />
            ...
            <Section title="مجالات التحسين">
              <EmptyTable
                cols={6}
                rows={8}
                headers={['المجال', 'الملاحظة', 'الإجراء', 'المسؤول', 'الموعد', 'المؤشر']}
              />
            </Section>
    ...
    case 'rehab-outcome-report':
      return (
        <div style={pageWrapper}>
          <OrgHeader
            title="تقرير مخرجات البرنامج التأهيلي"
            subtitle="Rehabilitation Outcome Report"
          />
          <div style={bodyPad}>
            <div style={fieldRow}>
              <Field label="البرنامج" value={d.program} w="30%" />
              <Field label="الفترة" value={d.period} w="20%" />
              <Field label="عدد المستفيدين" value={d.beneficiaryCount} w="15%" />
            </div>
            ...
            <Section title="توزيع النتائج">
              <EmptyTable
                cols={4}
                rows={5}
                headers={['مستوى التحسن', 'العدد', 'النسبة %', 'ملاحظات']}
              />
            </Section>
          ...
          <div style={bodyPad}>
            ...
            <Section title="معايير الفعالية">
              <EmptyTable
                cols={5}
                rows={8}
                headers={['المعيار', 'الوزن %', 'الدرجة', 'المعدل الموزون', 'ملاحظات']}
              />
            </Section>
            <div style={fieldRow}>
              <Field label="الدرجة الإجمالية" value={d.totalScore} w="20%" />
    ...
    case 'outcome-comparison':
      return (
        <div style={pageWrapper}>
          <OrgHeader
            title="مقارنة نتائج قبل وبعد التأهيل"
            subtitle="Pre-Post Rehabilitation Comparison"
          />
          <div style={bodyPad}>
            <div style={fieldRow}>
              <Field label="المستفيد" value={d.beneficiary} w="25%" />
              <Field label="البرنامج" value={d.program} w="25%" />
              <Field label="مدة التأهيل" value={d.duration} w="15%" />
            </div>
            <Section title="المقارنة">
              <EmptyTable
                cols={5}
                rows={8}
                headers={['المجال', 'قبل التأهيل', 'بعد التأهيل', 'الفرق', 'التحسن %']}
              />
            </Section>
            <Section title="المقاييس المستخدمة">
              <EmptyTable
                cols={4}
                rows={3}
                headers={['المقياس', 'الدرجة القبلية', 'الدرجة البعدية', 'الفرق']}
              />
            </Section>
            <NotesBox label="التحليل" value={d.analysis} lines={2} />
          ...
          <div style={bodyPad}>
            ...
            <Section title="مؤشرات الأداء الرئيسية">
              <EmptyTable
                cols={6}
                rows={10}
                headers={['المؤشر', 'البرنامج', 'المستهدف', 'الفعلي', 'النسبة %', 'الاتجاه']}
              />
            </Section>
    ...
    case 'annual-outcome-summary':
      return (
        <div style={pageWrapper}>
          <OrgHeader
            title="ملخص مخرجات التأهيل السنوية"
            subtitle="Annual Rehabilitation Outcome Summary"
          />
          <div style={bodyPad}>
            <div style={fieldRow}>
              <Field label="السنة" value={d.year} w="15%" />
              <Field label="إجمالي المستفيدين" value={d.totalBeneficiaries} w="15%" />
              <Field label="المتخرجون" value={d.graduated} w="15%" />
              <Field label="معدل النجاح" value={d.successRate} w="15%" />
            </div>
    ...
    case 'followup-visit-form':
      return (
        <div style={pageWrapper}>
          <OrgHeader
            title="نموذج زيارة متابعة بعد التخرج"
            subtitle="Post-Graduation Follow-Up Visit"
          />
          <RefDateLine refNo={d.refNo} date={d.date} />
          <div style={bodyPad}>
            <div style={fieldRow}>
              <Field label="المستفيد" value={d.beneficiary} w="25%" />
              <Field label="تاريخ التخرج" value={formatDate(d.gradDate)} w="15%" />
              <Field label="تاريخ الزيارة" value={formatDate(d.visitDate) || today()} w="15%" />
              <Field label="الزائر" value={d.visitor} w="20%" />
            </div>
        ...
        <div style={pageWrapper}>
          ...
          <div style={bodyPad}>
            <div style={fieldRow}>
              <Field label="المستفيد" value={d.beneficiary} w="25%" />
              <Field label="البرنامج" value={d.program} w="20%" />
              <Field label="تاريخ الخروج" value={formatDate(d.exitDate)} w="15%" />
              <Field label="فترة المتابعة" value={d.followupPeriod} w="20%" />
            </div>
      ...
      return (
        <div style={pageWrapper}>
          ...
          <div style={bodyPad}>
            <div style={fieldRow}>
              <Field label="المستفيد" value={d.beneficiary} w="25%" />
              <Field label="من برنامج" value={d.fromProgram} w="20%" />
              <Field label="إلى برنامج" value={d.toProgram} w="20%" />
        ...
        <div style={pageWrapper}>
          ...
          <div style={bodyPad}>
            <div style={fieldRow}>
              ...
              <Field label="المرحلة" value={d.phase} w="15%" />
            ...
            <Section title="أهداف الدمج">
              <EmptyTable
                cols={5}
                rows={6}
                headers={['الهدف', 'النشاط', 'المسؤول', 'المؤشر', 'الموعد']}
              />
            </Section>
            <Section title="الموارد المجتمعية المحددة">
              <EmptyTable
                cols={4}
                rows={4}
                headers={['المورد/الجهة', 'الخدمة', 'التواصل', 'الحالة']}
              />
            </Section>
    ...
    case 'followup-outcome-report':
      return (
        <div style={pageWrapper}>
          <OrgHeader
            title="تقرير نتائج المتابعة بعد الخروج"
            subtitle="Post-Exit Follow-Up Outcome Report"
          />
          <div style={bodyPad}>
            <div style={fieldRow}>
              <Field label="المستفيد" value={d.beneficiary} w="25%" />
              <Field label="تاريخ الخروج" value={formatDate(d.exitDate)} w="15%" />
              <Field label="فترة المتابعة" value={d.period} w="20%" />
              <Field label="عدد الزيارات" value={d.visitCount} w="12%" />
            </div>
            <Section title="نتائج المتابعة">
              <EmptyTable
                cols={5}
                rows={6}
                headers={['المجال', 'عند الخروج', 'الوضع الحالي', 'التغيير', 'التقييم']}
              />
            </Section>
