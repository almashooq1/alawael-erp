...
export const FEEDBACK_GAMIFICATION_TEMPLATES = [
  {
    id: 'feedback-form',
    name: 'نموذج التغذية الراجعة',
    nameEn: 'Feedback Form',
    desc: 'نموذج تغذية راجعة عام',
    color: '#6a1b9a',
  },
  {
    id: 'employee-survey',
    name: 'استبيان الموظفين',
    nameEn: 'Employee Survey',
    desc: 'استبيان رضا الموظفين',
    color: '#7b1fa2',
  },
  {
    id: 'patient-satisfaction',
    name: 'استبيان رضا المرضى',
    nameEn: 'Patient Satisfaction Survey',
    desc: 'استبيان رضا المرضى والمستفيدين',
    color: '#8e24aa',
  },
  {
    id: 'suggestion-form',
    ...
    desc: 'نموذج تقديم اقتراح',
    color: '#9c27b0',
  },
  {
    id: 'complaint-form',
    name: 'نموذج شكوى',
    nameEn: 'Complaint Form',
    desc: 'نموذج تقديم شكوى رسمية',
    color: '#c62828',
  },
  {
    ...
    desc: 'تقرير حل ومعالجة الشكوى',
    color: '#d32f2f',
  },
  {
    id: 'survey-results-report',
    name: 'نتائج الاستبيان',
    nameEn: 'Survey Results Report',
    desc: 'تقرير نتائج وتحليل الاستبيان',
    color: '#1565c0',
  },
  {
    id: 'nps-report',
    name: 'تقرير NPS',
    nameEn: 'Net Promoter Score Report',
    desc: 'تقرير صافي نقاط الترويج',
    color: '#0d47a1',
  },
  {
    id: 'gamification-rules',
    name: 'قواعد التلعيب',
    nameEn: 'Gamification Rules Document',
    desc: 'وثيقة قواعد وآليات التلعيب',
    color: '#e65100',
  },
  {
    id: 'gamification-leaderboard',
    name: 'لوحة المتصدرين',
    nameEn: 'Gamification Leaderboard',
    desc: 'لوحة ترتيب المتصدرين',
    color: '#ef6c00',
  },
  {
    id: 'achievement-badge',
    name: 'شارة إنجاز',
    nameEn: 'Achievement Badge Certificate',
  ...
  },
  {
    ...
    desc: 'كشف حساب نقاط الموظف',
    color: '#ff8f00',
  },
  {
    id: 'reward-catalog',
    name: 'كتالوج المكافآت',
    nameEn: 'Reward Catalog',
    desc: 'كتالوج المكافآت المتاحة',
    color: '#2e7d32',
  },
  {
    id: 'engagement-report',
    name: 'تقرير المشاركة',
    nameEn: 'Engagement Report',
    desc: 'تقرير مشاركة وتفاعل الموظفين',
    color: '#00695c',
  },
  {
    id: 'feedback-analysis',
    name: 'تحليل التغذية الراجعة',
    nameEn: 'Feedback Analysis Report',
    desc: 'تقرير تحليل التغذية الراجعة',
    color: '#4527a0',
  },
  {
    id: 'gamification-impact',
    name: 'أثر التلعيب',
    nameEn: 'Gamification Impact Report',
    desc: 'تقرير أثر التلعيب على الأداء',
    color: '#283593',
  },
];
...
export const FeedbackGamificationTemplateRenderer = ({ templateId, data = {} }) => {
  ...
  switch (templateId) {
      ...
      return (
        <div style={pageWrapper}>
          ...
          <div style={bodyPad}>
            ...
            <div style={fieldRow}>
              <Field label="من" value={d.fromName} w="30%" />
              <Field label="إلى" value={d.toName} w="30%" />
              <Field label="التاريخ" value={formatDate(d.date) || today()} w="20%" />
            </div>
            <div style={fieldRow}>
              <Field label="الموضوع" value={d.subject} w="50%" />
              <Field label="النوع" value={d.type} w="25%" />
            </div>
      ...
      return (
        <div style={pageWrapper}>
          ...
          <div style={bodyPad}>
            <RefDateLine refNo={d.refNo} date={d.date} />
            <div style={fieldRow}>
              <Field label="الاسم (اختياري)" value={d.name} w="30%" />
      ...
      return (
        <div style={pageWrapper}>
          ...
          <div style={bodyPad}>
            <RefDateLine refNo={d.refNo} date={d.date} />
            <div style={fieldRow}>
              <Field label="المقترِح" value={d.suggestedBy} w="30%" />
              <Field label="القسم" value={d.department} w="25%" />
              <Field label="التاريخ" value={formatDate(d.date) || today()} w="20%" />
            </div>
            <div style={fieldRow}>
              <Field label="عنوان الاقتراح" value={d.title} w="50%" />
      ...
      return (
        <div style={pageWrapper}>
          ...
          <div style={bodyPad}>
            <RefDateLine refNo={d.refNo} date={d.date} />
            <div style={fieldRow}>
              <Field label="مقدّم الشكوى" value={d.complainant} w="30%" />
              <Field label="النوع" value={d.type} w="20%" />
              <Field label="التاريخ" value={formatDate(d.date) || today()} w="20%" />
            </div>
            <div style={fieldRow}>
              <Field label="الجهة المشتكى عنها" value={d.against} w="40%" />
              <Field label="الأولوية" value={d.priority} w="20%" />
            </div>
      ...
      return (
        <div style={pageWrapper}>
          ...
          <div style={bodyPad}>
            <RefDateLine refNo={d.refNo} date={d.date} />
            <div style={fieldRow}>
              <Field label="رقم الشكوى" value={d.complaintNo} w="20%" />
              <Field label="التاريخ" value={formatDate(d.complaintDate)} w="20%" />
              <Field label="المسؤول" value={d.handler} w="30%" />
            </div>
            <Section title="إجراءات المعالجة">
              <EmptyTable
                cols={4}
                rows={5}
                headers={['الإجراء', 'التاريخ', 'المسؤول', 'النتيجة']}
              />
            </Section>
      ...
      return (
        <div style={pageWrapper}>
          ...
          <div style={bodyPad}>
            <RefDateLine refNo={d.refNo} date={d.date} />
            <div style={fieldRow}>
              <Field label="عنوان الاستبيان" value={d.surveyTitle} w="40%" />
              <Field label="عدد المشاركين" value={d.participants} w="20%" />
            ...
            <Section title="النتائج">
              <EmptyTable
                cols={5}
                rows={8}
                headers={['المحور', 'ممتاز %', 'جيد %', 'مقبول %', 'ضعيف %']}
              />
            </Section>
        ...
        <div style={pageWrapper}>
          ...
          <div style={bodyPad}>
            ...
            <div style={fieldRow}>
              ...
              <Field label="عدد الردود" value={d.responses} w="20%" />
              <Field label="نقاط NPS" value={d.npsScore} w="20%" />
            </div>
      ...
      return (
        <div style={pageWrapper}>
          ...
          <div style={bodyPad}>
            <RefDateLine refNo={d.refNo} date={d.date} />
            <div style={fieldRow}>
              <Field label="البرنامج" value={d.programName} w="35%" />
            ...
            <Section title="آليات كسب النقاط">
              <EmptyTable
                cols={4}
                rows={6}
                headers={['النشاط', 'النقاط', 'الحد الأقصى', 'ملاحظات']}
              />
            </Section>
          ...
          <div style={bodyPad}>
            ...
            <Section title="ترتيب المتصدرين">
              <EmptyTable
                cols={6}
                rows={10}
                headers={['الترتيب', 'الموظف', 'القسم', 'النقاط', 'الشارات', 'المستوى']}
              />
            </Section>
      ...
      return (
        <div style={pageWrapper}>
          ...
          <div style={bodyPad}>
            ...
            <div style={fieldRow}>
              <Field label="الشارة" value={d.badgeName} w="30%" />
              <Field label="المستوى" value={d.level} w="20%" />
              <Field label="النقاط" value={d.points} w="20%" />
            </div>
      ...
      return (
        <div style={pageWrapper}>
          ...
          <div style={bodyPad}>
            ...
            <div style={fieldRow}>
              <Field label="اسم الموظف" value={d.employeeName} w="30%" />
              <Field label="الرصيد" value={d.balance} w="20%" />
              <Field label="الفترة" value={d.period} w="25%" />
            </div>
            <Section title="حركات النقاط">
              <EmptyTable
                cols={5}
                rows={8}
                headers={['التاريخ', 'الوصف', 'مكتسبة', 'مستبدلة', 'الرصيد']}
              />
            </Section>
        ...
        <div style={pageWrapper}>
          ...
          <div style={bodyPad}>
            ...
            <div style={fieldRow}>
              ...
              <Field label="عدد المكافآت" value={d.rewardCount} w="20%" />
            </div>
            <Section title="المكافآت المتاحة">
              <EmptyTable
                cols={5}
                rows={10}
                headers={['المكافأة', 'الوصف', 'النقاط المطلوبة', 'الكمية', 'الحالة']}
              />
            </Section>
        ...
        <div style={pageWrapper}>
          ...
          <div style={bodyPad}>
            ...
            <div style={fieldRow}>
              ...
              <Field label="نسبة المشاركة" value={d.engagementRate} w="20%" />
            </div>
      ...
      return (
        <div style={pageWrapper}>
          ...
          <div style={bodyPad}>
            ...
            <div style={fieldRow}>
              <Field label="الفترة" value={d.period} w="25%" />
              <Field label="عدد الردود" value={d.responseCount} w="20%" />
            ...
            <Section title="تحليل المحاور">
              <EmptyTable
                cols={5}
                rows={6}
                headers={['المحور', 'إيجابي %', 'محايد %', 'سلبي %', 'التوصية']}
              />
            </Section>
          ...
          <div style={bodyPad}>
            ...
            <Section title="مؤشرات الأثر">
              <EmptyTable
                cols={5}
                rows={6}
                headers={['المؤشر', 'قبل التلعيب', 'بعد التلعيب', 'التحسّن', 'ملاحظات']}
              />
            </Section>
    ...
    default:
      return (
        <div style={pageWrapper}>
          <OrgHeader title="قالب التغذية الراجعة والتلعيب" />
          <div style={bodyPad}>
