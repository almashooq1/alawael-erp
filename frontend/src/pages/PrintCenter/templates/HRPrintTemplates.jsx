...
export const HR_TEMPLATES = [
  {
    ...
    name: 'كشف الراتب',
    nameEn: 'Salary Slip',
    desc: 'كشف راتب شهري تفصيلي بالاستحقاقات والاستقطاعات',
    color: '#2e7d32',
  },
  {
    id: 'salary-cert',
    ...
    desc: 'شهادة رسمية بمقدار الراتب للجهات الخارجية',
    color: '#1565c0',
  },
  {
    id: 'experience-cert',
    ...
    desc: 'شهادة تثبت فترة العمل والمسمى الوظيفي',
    color: '#6a1b9a',
  },
  {
    ...
    desc: 'عقد عمل رسمي يتضمن كافة الشروط والالتزامات',
    color: '#00695c',
  },
  {
    id: 'leave-request',
    ...
    desc: 'نموذج تقديم طلب إجازة بأنواعها المختلفة',
    color: '#ef6c00',
  },
  {
    id: 'warning-letter',
    ...
    desc: 'خطاب إنذار رسمي للموظف بسبب مخالفة',
    color: '#c62828',
  },
  {
    id: 'promotion-letter',
    ...
    desc: 'خطاب إعلام بالترقية والمسمى والراتب الجديد',
    color: '#1565c0',
  },
  {
    ...
    desc: 'تقرير تقييم أداء سنوي شامل للموظف',
    color: '#ff8f00',
  },
  {
    id: 'attendance-report',
    name: 'كشف الحضور الشهري',
    nameEn: 'Monthly Attendance',
    desc: 'كشف حضور وانصراف شهري تفصيلي',
    color: '#37474f',
  },
  {
    id: 'employee-id',
    name: 'بطاقة موظف',
    nameEn: 'Employee ID Card',
    desc: 'بطاقة تعريف الموظف مع الصورة والبيانات الأساسية',
    color: '#0277bd',
  },
  {
    id: 'clearance-form',
    ...
    desc: 'نموذج إخلاء طرف عند انتهاء الخدمة',
    color: '#4e342e',
  },
  {
    id: 'training-cert',
    ...
    desc: 'شهادة إتمام برنامج تدريبي',
    color: '#00838f',
  },
];
...
export const HRTemplateRenderer = ({ templateId, data }) => {
  ...
  switch (templateId) {
    case 'salary-slip':
      return <SalarySlip d={d} />;
    case 'salary-cert':
      return <SalaryCert d={d} />;
    case 'experience-cert':
      return <ExperienceCert d={d} />;
    case 'employment-contract':
      return <EmploymentContract d={d} />;
    case 'leave-request':
      return <LeaveRequest d={d} />;
    case 'warning-letter':
      return <WarningLetter d={d} />;
    case 'promotion-letter':
      return <PromotionLetter d={d} />;
    case 'performance-review':
      return <PerformanceReview d={d} />;
    case 'attendance-report':
      return <AttendanceReport d={d} />;
    case 'employee-id':
      return <EmployeeIdCard d={d} />;
    case 'clearance-form':
      return <ClearanceForm d={d} />;
    case 'training-cert':
      return <TrainingCert d={d} />;
    default:
      return (
...
const SalarySlip = ({ d }) => (
  <Box sx={pageWrapper}>
    ...
    <Box sx={bodyPad}>
      ...
      <PrintTable
        headers={[
          { label: 'البند', width: '60%' },
          { label: 'المبلغ (ر.س)', center: true },
        ]}
        rows={[
  ...
  <Box sx={pageWrapper}>
    ...
    <Box sx={bodyPad}>
      ...
      <Typography variant="body1" sx={{ lineHeight: 2.5 }}>
        يشهد مركز الأوائل للتأهيل بأن السيد / السيدة:{' '}
        <strong>{d.name || '________________'}</strong>
        <br />
        رقم الهوية: <strong>{d.nationalId || '________________'}</strong>
        <br />
        يعمل / تعمل لدينا بوظيفة: <strong>{d.position || '________________'}</strong>
        <br />
        في قسم: <strong>{d.department || '________________'}</strong>
        <br />
        منذ تاريخ: <strong>{formatDate(d.joinDate)}</strong>
        <br />
        <br />
        ويتقاضى / تتقاضى راتباً شهرياً إجمالياً قدره:
        <br />
        <strong style={{ fontSize: 18, color: '#1a237e' }}>
          {formatMoney(d.totalSalary)} ريال سعودي
        </strong>
        <br />
        <br />
        وقد أُعطيت هذه الشهادة بناءً على طلبه / طلبها دون أدنى مسؤولية على المركز.
      </Typography>
  ...
  <Box sx={{ ...pageWrapper, border: '3px double #1a237e' }}>
    ...
    <Box sx={bodyPad}>
      ...
      <Typography variant="body1" sx={{ lineHeight: 2.5 }}>
        ...
        <strong>{d.name || '________________'}</strong>
        <br />
        رقم الهوية: <strong>{d.nationalId || '________________'}</strong>، الجنسية:{' '}
        <strong>{d.nationality || '________________'}</strong>
        <br />
        <br />
        قد عمل / عملت لدى المركز بوظيفة: <strong>{d.position || '________________'}</strong>
        <br />
        في قسم: <strong>{d.department || '________________'}</strong>
        <br />
        خلال الفترة من: <strong>{formatDate(d.startDate)}</strong> إلى:{' '}
        <strong>{formatDate(d.endDate)}</strong>
        <br />
        <br />
        وخلال فترة عمله / عملها أظهر / أظهرت كفاءة عالية والتزاماً مهنياً وسلوكاً حسناً.
        <br />
        <br />
        وقد أُعطيت هذه الشهادة بناءً على طلبه / طلبها دون أدنى مسؤولية على المركز.
        <br />
        نتمنى له / لها كل التوفيق والنجاح.
      </Typography>
    ...
    <Box sx={bodyPad}>
      ...
      <Box sx={{ bgcolor: '#f5f5f5', p: 2, borderRadius: 2, my: 2 }}>
        <Typography variant="body2">
          <strong>الطرف الأول (صاحب العمل):</strong> مركز الأوائل للتأهيل، سجل تجاري رقم:
          ________________
        </Typography>
        <Typography variant="body2" mt={1}>
          <strong>الطرف الثاني (الموظف):</strong> {d.name || '________________'}، رقم الهوية:{' '}
          {d.nationalId || '________________'}
        </Typography>
      </Box>
      ...
      {[
        [
          'المادة الأولى — نوع العمل',
          `يعمل الطرف الثاني بوظيفة ${d.position || '________'} في قسم ${d.department || '________'}`,
        ],
        [
          'المادة الثانية — مدة العقد',
          `مدة العقد ${d.contractDuration || '________'} تبدأ من ${formatDate(d.startDate)} وتنتهي في ${formatDate(d.endDate)}`,
        ],
        [
          'المادة الثالثة — فترة التجربة',
          'يخضع الطرف الثاني لفترة تجربة مدتها ثلاثة أشهر من تاريخ مباشرة العمل',
        ],
        [
          'المادة الرابعة — الراتب',
          `يتقاضى الطرف الثاني راتباً شهرياً إجمالياً قدره ${formatMoney(d.totalSalary)} ريال سعودي`,
        ],
        [
          'المادة الخامسة — ساعات العمل',
          `ساعات العمل ${d.workHours || '8'} ساعات يومياً، ${d.workDays || '5'} أيام في الأسبوع`,
        ],
        ['المادة السادسة — الإجازات', 'يستحق الطرف الثاني إجازة سنوية وفقاً لنظام العمل السعودي'],
        [
          'المادة السابعة — إنهاء العقد',
          'يجوز لأي طرف إنهاء العقد بإشعار كتابي مسبق وفقاً لنظام العمل',
        ],
        [
          'المادة الثامنة — أحكام عامة',
          'يخضع هذا العقد لأحكام نظام العمل السعودي فيما لم يرد به نص',
        ],
      ].map(([title, text], i) => (
        <Box key={i} sx={{ mb: 2 }}>
      ...
      <Typography variant="body2" mt={3}>
        حُرر هذا العقد من نسختين لكل طرف نسخة للعمل بموجبها.
      </Typography>
...
const LeaveRequest = ({ d }) => (
  <Box sx={pageWrapper}>
    ...
    <Box sx={bodyPad}>
      ...
      <PrintTable
        headers={['النوع', 'المستحق', 'المستخدم', 'المتبقي']}
        headerBg="#fff3e0"
        rows={[
      ...
      <PrintTable
        headers={['الجهة', 'التوقيع', 'التاريخ', 'القرار']}
        headerBg="#fff3e0"
        rows={[
...
const WarningLetter = ({ d }) => (
  <Box sx={{ ...pageWrapper, border: '2px solid #c62828' }}>
    ...
    <Box sx={bodyPad}>
      ...
      <Box sx={fieldRow}>
        <Field label="تاريخ المخالفة" value={formatDate(d.violationDate)} />
        <Field label="نوع المخالفة" value={d.violationType} flex={2} />
      </Box>
  ...
  <Box sx={pageWrapper}>
    ...
    <Box sx={bodyPad}>
      ...
      <Typography variant="body1" sx={{ lineHeight: 2.5 }}>
        ...
        <br />
        الرقم الوظيفي: <strong>{d.empId || '________'}</strong>
        <br />
        <br />
        تحية طيبة وبعد،
        <br />
        <br />
        يسعدنا أن نبلغكم بقرار الإدارة بترقيتكم وذلك اعتباراً من تاريخ{' '}
        <strong>{formatDate(d.effectiveDate)}</strong> كالتالي:
      </Typography>
      <PrintTable
        headers={['', 'السابق', 'الجديد']}
        headerBg="#e3f2fd"
        rows={[
...
const PerformanceReview = ({ d }) => (
  <Box sx={pageWrapper}>
    ...
    <Box sx={bodyPad}>
      ...
      <Box sx={fieldRow}>
        <Field label="المجموع الكلي" value={d.totalScore || '_____ / 40'} />
        <Field
          label="التقدير"
          value={d.grade || '□ ممتاز □ جيد جداً □ جيد □ مقبول □ ضعيف'}
          flex={2}
        />
      </Box>
    ...
    <Box sx={{ width: 400, border: '3px solid #0277bd', borderRadius: 3, overflow: 'hidden' }}>
      ...
      <Box sx={{ p: 2.5, bgcolor: 'white' }}>
        <Box display="flex" gap={2} mb={2}>
          <Avatar sx={{ width: 72, height: 72, bgcolor: '#0277bd', fontSize: 28 }}>
            {(d.name || '?').charAt(0)}
          </Avatar>
          <Box flex={1}>
      ...
      <Box sx={{ background: '#0277bd', color: 'white', p: 1, textAlign: 'center' }}>
        <Typography variant="caption" sx={{ fontSize: 9 }}>
          هذه البطاقة ملك لمركز الأوائل — يرجى إعادتها في حال العثور عليها
        </Typography>
      </Box>
    </Box>
  </Box>
...
const ClearanceForm = ({ d }) => (
  <Box sx={pageWrapper}>
    ...
    <Box sx={bodyPad}>
      ...
      <PrintTable
        headers={['القسم', 'الحالة', 'ملاحظات', 'التوقيع', 'التاريخ']}
        headerBg="#efebe9"
        rows={[
      ...
      <EmptyTable
        headers={['م', 'الصنف', 'العدد', 'الحالة', 'ملاحظات']}
        rowCount={5}
        headerBg="#efebe9"
      />
      ...
      <SignatureBlock
        signatures={['الموظف', 'مدير الموارد البشرية', 'المدير المالي', 'المدير العام']}
      />
      <OrgFooter />
    </Box>
  </Box>
...
const TrainingCert = ({ d }) => (
  <Box sx={{ ...pageWrapper, border: '3px double #00838f' }}>
    ...
    <Box sx={{ p: 4, textAlign: 'center' }}>
      <Typography variant="body1" sx={{ lineHeight: 2.5, mt: 2 }}>
        يشهد مركز الأوائل للتأهيل بأن:
      </Typography>
      <Typography
        variant="h4"
        fontWeight="bold"
      ...
      <Typography variant="body1" sx={{ lineHeight: 2.5 }}>
        ...
        <strong style={{ fontSize: 18 }}>
          {d.programName || '________________________________'}
        </strong>
        <br />
        خلال الفترة من <strong>{formatDate(d.startDate)}</strong> إلى{' '}
        <strong>{formatDate(d.endDate)}</strong>
        <br />
        بواقع <strong>{d.hours || '___'}</strong> ساعة تدريبية
        {d.grade && (
          <>
            <br />
            وحصل / حصلت على تقدير: <strong>{d.grade}</strong>
          </>
        )}
      </Typography>
