...
export const INTEGRATED_CARE_OCR_TEMPLATES = [
  {
    ...
    desc: 'وثيقة مسار الرعاية المتكاملة',
    color: '#00695c',
  },
  {
    ...
    desc: 'نموذج تنسيق الرعاية بين الأقسام',
    color: '#00796b',
  },
  {
    id: 'multidisciplinary-meeting',
    name: 'اجتماع الفريق متعدد التخصصات',
    nameEn: 'Multidisciplinary Team Meeting',
  ...
  },
  {
    id: 'care-transition',
    name: 'انتقال الرعاية',
    nameEn: 'Care Transition Form',
    desc: 'نموذج انتقال الرعاية بين المراحل',
    color: '#009688',
  },
  {
    id: 'integrated-assessment',
    name: 'تقييم متكامل',
    nameEn: 'Integrated Assessment Form',
    desc: 'نموذج التقييم المتكامل للحالة',
    color: '#26a69a',
  },
  {
    id: 'care-plan-summary',
    name: 'ملخص خطة الرعاية',
    nameEn: 'Care Plan Summary',
    desc: 'ملخص خطة الرعاية الشاملة',
    color: '#4db6ac',
  },
  {
    id: 'patient-handoff',
    name: 'تسليم المريض',
    nameEn: 'Patient Handoff Form',
    desc: 'نموذج تسليم واستلام المريض',
    color: '#80cbc4',
  },
  {
    id: 'care-outcome-report',
    name: 'تقرير نتائج الرعاية',
    nameEn: 'Care Outcome Report',
    desc: 'تقرير نتائج ومخرجات الرعاية',
    color: '#1565c0',
  },
  {
    id: 'ocr-scan-log',
    name: 'سجل المسح الضوئي',
    nameEn: 'OCR Scan Log',
    desc: 'سجل عمليات المسح الضوئي',
    color: '#37474f',
  },
  {
    id: 'document-digitization',
    name: 'رقمنة وثائق',
    nameEn: 'Document Digitization Form',
    desc: 'نموذج طلب رقمنة مستندات',
    color: '#455a64',
  },
  {
    id: 'ocr-accuracy-report',
    name: 'تقرير دقة OCR',
    nameEn: 'OCR Accuracy Report',
    desc: 'تقرير دقة التعرف الضوئي',
    color: '#546e7a',
  },
  {
    id: 'document-classification',
    name: 'تصنيف المستندات',
    nameEn: 'Document Classification Report',
    desc: 'تقرير تصنيف المستندات الممسوحة',
    color: '#607d8b',
  },
  {
    id: 'archive-index',
    name: 'فهرس الأرشيف',
    nameEn: 'Archive Index Report',
    desc: 'تقرير فهرس الأرشيف الرقمي',
    color: '#78909c',
  },
  {
    id: 'data-extraction',
    name: 'استخراج البيانات',
    nameEn: 'Data Extraction Report',
    desc: 'تقرير استخراج البيانات من المستندات',
    color: '#6a1b9a',
  },
  {
    id: 'document-analytics',
    name: 'تحليلات المستندات',
    nameEn: 'Document Analytics Report',
    desc: 'تقرير تحليلات المستندات',
    color: '#4527a0',
  },
  {
    id: 'ocr-batch-report',
    name: 'تقرير دفعة OCR',
    nameEn: 'OCR Batch Processing Report',
    desc: 'تقرير معالجة دفعة المسح الضوئي',
    color: '#283593',
  },
];
  ...
  switch (templateId) {
      ...
      return (
        <div style={pageWrapper}>
          ...
          <div style={bodyPad}>
            ...
            <div style={fieldRow}>
              <Field label="اسم المريض" value={d.patientName} w="30%" />
            ...
            <Section title="مراحل المسار">
              <EmptyTable
                cols={5}
                rows={6}
                headers={['المرحلة', 'القسم المسؤول', 'المدة', 'الإجراءات', 'معايير الانتقال']}
              />
            </Section>
      ...
      return (
        <div style={pageWrapper}>
          ...
          <div style={bodyPad}>
            <RefDateLine refNo={d.refNo} date={d.date} />
            <div style={fieldRow}>
              <Field label="المريض" value={d.patientName} w="30%" />
    ...
    case 'multidisciplinary-meeting':
      return (
        <div style={pageWrapper}>
          <OrgHeader
            title="محضر اجتماع الفريق متعدد التخصصات"
            subtitle="Multidisciplinary Team Meeting"
          />
          <div style={bodyPad}>
            <RefDateLine refNo={d.refNo} date={d.date} />
            <div style={fieldRow}>
              <Field label="المريض" value={d.patientName} w="30%" />
              <Field label="التاريخ" value={formatDate(d.meetingDate) || today()} w="20%" />
              <Field label="الرئيس" value={d.chairperson} w="25%" />
            </div>
      ...
      return (
        <div style={pageWrapper}>
          ...
          <div style={bodyPad}>
            <RefDateLine refNo={d.refNo} date={d.date} />
            <div style={fieldRow}>
              <Field label="المريض" value={d.patientName} w="25%" />
              <Field label="من" value={d.fromUnit} w="25%" />
              <Field label="إلى" value={d.toUnit} w="25%" />
              <Field label="التاريخ" value={formatDate(d.transitionDate) || today()} w="20%" />
            </div>
          ...
          <div style={bodyPad}>
            ...
            <Section title="محاور التقييم">
              <EmptyTable
                cols={5}
                rows={8}
                headers={['المحور', 'الحالة', 'الدرجة', 'الملاحظة', 'التوصية']}
              />
            </Section>
          ...
          <div style={bodyPad}>
            ...
            <Section title="خطة الرعاية">
              <EmptyTable
                cols={5}
                rows={6}
                headers={['المكون', 'الوصف', 'المسؤول', 'الجدول', 'الحالة']}
              />
            </Section>
        ...
        <div style={pageWrapper}>
          ...
          <div style={bodyPad}>
            ...
            <div style={fieldRow}>
              ...
              <Field label="المسلّم" value={d.fromStaff} w="25%" />
              <Field label="المستلم" value={d.toStaff} w="25%" />
            </div>
            <Section title="ملخص الحالة">
              <EmptyTable
                cols={4}
                rows={5}
                headers={['البند', 'القيمة', 'الملاحظة', 'إجراء مطلوب']}
              />
            </Section>
          ...
          <div style={bodyPad}>
            ...
            <Section title="مؤشرات النتائج">
              <EmptyTable
                cols={5}
                rows={6}
                headers={['المؤشر', 'الهدف', 'المتحقق', 'الفرق', 'ملاحظات']}
              />
            </Section>
        ...
        <div style={pageWrapper}>
          ...
          <div style={bodyPad}>
            ...
            <div style={fieldRow}>
              ...
              <Field label="عدد الوثائق" value={d.docCount} w="20%" />
            </div>
            <Section title="سجل المسح">
              <EmptyTable
                cols={6}
                rows={10}
                headers={['التاريخ', 'رقم الوثيقة', 'النوع', 'الدقة', 'الحالة', 'ملاحظات']}
              />
            </Section>
      ...
      return (
        <div style={pageWrapper}>
          ...
          <div style={bodyPad}>
            <RefDateLine refNo={d.refNo} date={d.date} />
            <div style={fieldRow}>
              <Field label="الطالب" value={d.requester} w="30%" />
              <Field label="القسم" value={d.department} w="25%" />
              <Field label="التاريخ" value={formatDate(d.date) || today()} w="20%" />
            </div>
            <Section title="المستندات المطلوب رقمنتها">
              <EmptyTable
                cols={5}
                rows={6}
                headers={['الوصف', 'العدد', 'النوع', 'الأولوية', 'ملاحظات']}
              />
            </Section>
      ...
      return (
        <div style={pageWrapper}>
          ...
          <div style={bodyPad}>
            ...
            <div style={fieldRow}>
              <Field label="الفترة" value={d.period} w="25%" />
              <Field label="العينة" value={d.sampleSize} w="20%" />
              <Field label="الدقة العامة" value={d.overallAccuracy} w="20%" />
            </div>
            <Section title="الدقة حسب النوع">
              <EmptyTable
                cols={5}
                rows={6}
                headers={['نوع المستند', 'العدد', 'الدقة', 'الأخطاء', 'التوصية']}
              />
            </Section>
        ...
        <div style={pageWrapper}>
          ...
          <div style={bodyPad}>
            ...
            <div style={fieldRow}>
              ...
              <Field label="المصنّف" value={d.classifier} w="25%" />
            </div>
            <Section title="التصنيف">
              <EmptyTable
                cols={5}
                rows={8}
                headers={['الفئة', 'العدد', 'النسبة', 'الدقة', 'ملاحظات']}
              />
            </Section>
        ...
        <div style={pageWrapper}>
          ...
          <div style={bodyPad}>
            ...
            <div style={fieldRow}>
              <Field label="القسم" value={d.department} w="25%" />
              <Field label="الفترة" value={d.period} w="25%" />
              <Field label="إجمالي الوثائق" value={d.totalDocs} w="20%" />
            </div>
            <Section title="فهرس الوثائق">
              <EmptyTable
                cols={6}
                rows={10}
                headers={['رقم', 'العنوان', 'النوع', 'التاريخ', 'الحجم', 'المرجع']}
              />
            </Section>
      ...
      return (
        <div style={pageWrapper}>
          ...
          <div style={bodyPad}>
            <RefDateLine refNo={d.refNo} date={d.date} />
            <div style={fieldRow}>
              <Field label="المصدر" value={d.source} w="30%" />
              <Field label="عدد المستندات" value={d.docCount} w="20%" />
              <Field label="الدقة" value={d.accuracy} w="20%" />
            </div>
            <Section title="البيانات المستخرجة">
              <EmptyTable
                cols={5}
                rows={8}
                headers={['الحقل', 'القيمة', 'الثقة', 'التحقق', 'ملاحظات']}
              />
            </Section>
          ...
          <div style={bodyPad}>
            ...
            <Section title="إحصائيات المستندات">
              <EmptyTable
                cols={5}
                rows={6}
                headers={['الفئة', 'العدد', 'الحجم', 'معدل المعالجة', 'ملاحظات']}
              />
            </Section>
        ...
        <div style={pageWrapper}>
          ...
          <div style={bodyPad}>
            ...
            <div style={fieldRow}>
              ...
              <Field label="التاريخ" value={formatDate(d.processDate) || today()} w="20%" />
              <Field label="العدد" value={d.docCount} w="15%" />
              <Field label="الدقة" value={d.accuracy} w="15%" />
            </div>
            <Section title="تفاصيل المعالجة">
              <EmptyTable
                cols={5}
                rows={8}
                headers={['المستند', 'الحجم', 'الدقة', 'الوقت', 'الحالة']}
              />
            </Section>
    ...
    default:
      return (
        <div style={pageWrapper}>
          <OrgHeader title="قالب الرعاية المتكاملة و OCR" />
          <div style={bodyPad}>
