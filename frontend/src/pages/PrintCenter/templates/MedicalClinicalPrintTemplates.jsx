...
export const MEDICAL_TEMPLATES = [
  {
    id: 'medical-record',
    name: 'ملخص السجل الطبي',
    nameEn: 'Medical Record Summary',
    desc: 'ملخص الملف الطبي للمستفيد',
    color: '#b71c1c',
  },
  {
    id: 'prescription',
    name: 'وصفة طبية',
    nameEn: 'Prescription',
    desc: 'نموذج وصفة طبية',
    color: '#c62828',
  },
  {
    id: 'lab-request',
    name: 'طلب تحاليل مخبرية',
    nameEn: 'Lab Request Form',
    desc: 'نموذج طلب فحوصات مخبرية',
    color: '#d32f2f',
  },
  {
    id: 'medical-referral',
    name: 'خطاب إحالة طبية',
    nameEn: 'Medical Referral',
    desc: 'إحالة طبية لجهة خارجية',
    color: '#e53935',
  },
  {
    id: 'consent-form',
    name: 'نموذج موافقة طبية',
    nameEn: 'Medical Consent Form',
    desc: 'إقرار موافقة على إجراء طبي',
    color: '#f44336',
  },
  {
    id: 'icf-evaluation',
    name: 'نموذج تقييم ICF',
    nameEn: 'ICF Evaluation Form',
    desc: 'تقييم التصنيف الدولي للوظائف',
    color: '#7b1fa2',
  },
  {
    id: 'icf-summary',
    name: 'ملخص تقييم ICF',
    nameEn: 'ICF Summary Report',
    desc: 'تقرير ملخص تقييم ICF',
    color: '#8e24aa',
  },
  {
    id: 'mdt-meeting',
  ...
  },
  {
    id: 'mdt-team-report',
    name: 'تقرير فريق MDT',
    nameEn: 'MDT Team Report',
    desc: 'تقرير الفريق متعدد التخصصات',
    color: '#00796b',
  },
  {
    id: 'telehealth-session',
    name: 'ملخص جلسة طب عن بعد',
    nameEn: 'Telehealth Session Summary',
    desc: 'تقرير جلسة الطب عن بعد',
    color: '#0277bd',
  },
  {
    id: 'e-prescription',
    name: 'وصفة إلكترونية',
    nameEn: 'e-Prescription',
    desc: 'وصفة طبية إلكترونية',
    color: '#0288d1',
  },
  {
    id: 'psych-assessment',
    ...
    desc: 'نموذج التقييم النفسي',
    color: '#6a1b9a',
  },
  {
    id: 'social-worker-report',
    name: 'تقرير أخصائي اجتماعي',
    nameEn: 'Social Worker Report',
    desc: 'تقرير الأخصائي الاجتماعي',
    color: '#7b1fa2',
  },
  {
    id: 'crisis-intervention',
    name: 'نموذج تدخل أزمات',
    nameEn: 'Crisis Intervention Form',
    desc: 'تقرير التدخل في الأزمات النفسية',
    color: '#ad1457',
  },
  {
    id: 'life-skills',
    name: 'تقييم مهارات الحياة',
    nameEn: 'Life Skills Assessment',
          ...
          <div style={bodyPad}>
            <Section title="بيانات المستفيد">
              <div style={fieldRow}>
                ...
                <Field label="فصيلة الدم" value={d.bloodType} w="20%" />
              </div>
              <div style={fieldRow}>
                <Field label="التشخيص الرئيسي" value={d.diagnosis} w="50%" />
                <Field label="نوع الإعاقة" value={d.disability} w="25%" />
                <Field label="تاريخ القبول" value={formatDate(d.admissionDate)} w="25%" />
              </div>
            </Section>
            <Section title="الحساسية والأمراض المزمنة">
              <div style={fieldRow}>
                <Field label="الحساسية" value={d.allergies} w="50%" />
                <Field label="الأمراض المزمنة" value={d.chronicDiseases} w="50%" />
              </div>
            </Section>
            <Section title="الأدوية الحالية">
              <EmptyTable
                cols={5}
                rows={6}
                headers={['الدواء', 'الجرعة', 'التكرار', 'السبب', 'ملاحظات']}
              />
            </Section>
            <Section title="سجل الزيارات">
              <EmptyTable
                cols={5}
                rows={6}
                headers={['التاريخ', 'الطبيب', 'الشكوى', 'التشخيص', 'العلاج']}
              />
            </Section>
    ...
    case 'prescription':
      return (
        <div style={pageWrapper}>
          ...
          <div style={bodyPad}>
            <div style={fieldRow}>
              <Field label="اسم المستفيد" value={d.patientName} w="40%" />
            ...
            <div style={fieldRow}>
              ...
              <Field label="التشخيص" value={d.diagnosis} w="70%" />
            </div>
            <div
              style={{
                margin: '20px 0',
            ...
            >
              <div style={{ fontSize: 24, color: '#1565c0', fontWeight: 'bold', marginBottom: 16 }}>
                ℞
              </div>
              <EmptyTable
                cols={5}
                rows={6}
                headers={['الدواء', 'الجرعة', 'التكرار', 'المدة', 'تعليمات']}
              />
            </div>
            <NotesBox label="تعليمات خاصة" value={d.instructions} />
            <div style={{ marginTop: 20, display: 'flex', justifyContent: 'space-between' }}>
              <div style={{ textAlign: 'center' }}>
                <div style={{ borderBottom: '2px solid #333', width: 200, marginBottom: 4 }} />
                <div style={{ fontSize: 12 }}>توقيع الطبيب وختمه</div>
              </div>
              <div style={{ textAlign: 'center' }}>
                <div style={{ borderBottom: '2px solid #333', width: 200, marginBottom: 4 }} />
                <div style={{ fontSize: 12 }}>رقم الترخيص</div>
              </div>
            </div>
          </div>
          <OrgFooter />
      ...
      return (
        <div style={pageWrapper}>
          ...
          <div style={bodyPad}>
            <Section title="بيانات المستفيد">
              <div style={fieldRow}>
                <Field label="الاسم" value={d.patientName} w="40%" />
                <Field label="رقم الملف" value={d.fileNo} w="20%" />
                <Field label="العمر" value={d.age} w="20%" />
                <Field label="الجنس" value={d.gender} w="20%" />
              </div>
              <div style={fieldRow}>
                <Field label="التشخيص" value={d.diagnosis} w="50%" />
                <Field label="الطبيب الطالب" value={d.doctor} w="50%" />
              </div>
            </Section>
            ...
            <div style={fieldRow}>
              <Field label="صيام مطلوب" value={d.fasting} w="25%" />
              <Field label="نوع العينة" value={d.sampleType} w="25%" />
              <Field label="الأولوية" value={d.priority} w="25%" />
              <Field label="التاريخ" value={today()} w="25%" />
            </div>
        ...
        <div style={pageWrapper}>
          ...
          <div style={bodyPad}>
            <div style={{ margin: '16px 0', lineHeight: 2 }}>
              <p>
                السادة / <strong>{d.toHospital || '________________________'}</strong> المحترمين
              </p>
              <p>
                قسم / <strong>{d.toDepartment || '________________'}</strong>
              </p>
              <p>السلام عليكم ورحمة الله وبركاته،</p>
              <p>
                نحيل إليكم المريض/ة <strong>{d.patientName || '____________'}</strong> العمر{' '}
                <strong>{d.age || '____'}</strong> رقم الملف{' '}
                <strong>{d.fileNo || '________'}</strong>
              </p>
            </div>
        ...
        <div style={pageWrapper}>
          ...
          <div style={bodyPad}>
            ...
            <Section title="الإجراء المطلوب">
              <div style={fieldRow}>
                <Field label="نوع الإجراء" value={d.procedureType} w="50%" />
                <Field label="الطبيب المسؤول" value={d.doctor} w="50%" />
              </div>
            ...
            >
              ...
              <p style={{ lineHeight: 2 }}>
                أقر أنا الموقع أدناه ولي أمر المستفيد بأنني قد فهمت طبيعة الإجراء والمخاطر المحتملة
                وأوافق على إجرائه.
              </p>
            </div>
            <SignatureBlock rightLabel="ولي الأمر / الوصي" leftLabel="الطبيب المسؤول" />
            <div style={{ marginTop: 16 }}>
              <SignatureBlock rightLabel="الشاهد" leftLabel="" />
            </div>
          </div>
          <OrgFooter />
        </div>
          ...
          <div style={bodyPad}>
            ...
            <Section title="وظائف الجسم (Body Functions)">
              <EmptyTable
                cols={4}
                rows={5}
                headers={['الكود', 'الوظيفة', 'المؤهل (0-4)', 'ملاحظات']}
              />
            </Section>
            <Section title="بنى الجسم (Body Structures)">
              <EmptyTable
                cols={4}
                rows={4}
                headers={['الكود', 'البنية', 'المؤهل (0-4)', 'ملاحظات']}
              />
            </Section>
            <Section title="الأنشطة والمشاركة (Activities & Participation)">
              <EmptyTable
                cols={5}
                rows={6}
                headers={['الكود', 'النشاط', 'الأداء', 'القدرة', 'ملاحظات']}
              />
            </Section>
    ...
    case 'icf-summary':
      return (
        <div style={pageWrapper}>
          ...
          <div style={bodyPad}>
            <div style={fieldRow}>
              <Field label="المستفيد" value={d.name} w="40%" />
              <Field label="رقم الملف" value={d.fileNo} w="20%" />
              <Field label="التاريخ" value={formatDate(d.date) || today()} w="20%" />
              <Field label="المقيّم" value={d.assessor} w="20%" />
            </div>
        ...
        <div style={pageWrapper}>
          ...
          <div style={bodyPad}>
            <Section title="بيانات الاجتماع">
              <div style={fieldRow}>
                <Field label="المستفيد" value={d.beneficiary} w="40%" />
                <Field label="التاريخ" value={formatDate(d.date) || today()} w="30%" />
                <Field label="رقم الاجتماع" value={d.meetingNo} w="30%" />
              </div>
            </Section>
            ...
            <Section title="القرارات والتوصيات">
              <EmptyTable
                cols={4}
                rows={5}
                headers={['القرار / التوصية', 'المسؤول', 'الإطار الزمني', 'الأولوية']}
              />
            </Section>
          ...
          <div style={bodyPad}>
            ...
            <Section title="تقارير التخصصات">
              <EmptyTable
                cols={4}
                rows={8}
                headers={['التخصص', 'الأخصائي', 'ملخص التقييم', 'التوصيات']}
              />
            </Section>
        ...
        <div style={pageWrapper}>
          ...
          <div style={bodyPad}>
            <Section title="بيانات الجلسة">
              <div style={fieldRow}>
                <Field label="المستفيد" value={d.patientName} w="33%" />
                <Field label="الطبيب / الأخصائي" value={d.doctor} w="33%" />
                <Field label="التاريخ" value={formatDate(d.date) || today()} w="34%" />
              </div>
              <div style={fieldRow}>
                <Field label="نوع الجلسة" value={d.sessionType} w="33%" />
                <Field label="المنصة" value={d.platform} w="33%" />
                <Field label="المدة" value={d.duration} w="34%" />
              </div>
            </Section>
            ...
            <div style={fieldRow}>
              <Field label="متابعة" value={d.followUp} w="50%" />
              <Field label="موعد قادم" value={formatDate(d.nextAppointment)} w="50%" />
            </div>
      ...
      return (
        <div style={pageWrapper}>
          ...
          <div style={bodyPad}>
            ...
            >
              وصفة صادرة عبر نظام الطب عن بعد — Issued via Telehealth System
            </div>
            <div style={fieldRow}>
              <Field label="المستفيد" value={d.patientName} w="35%" />
              <Field label="رقم الملف" value={d.fileNo} w="20%" />
              <Field label="العمر" value={d.age} w="15%" />
              <Field label="التاريخ" value={formatDate(d.date) || today()} w="30%" />
            </div>
            <div style={fieldRow}>
              <Field label="التشخيص" value={d.diagnosis} w="60%" />
              <Field label="الطبيب" value={d.doctor} w="40%" />
            </div>
            <div
              style={{
                margin: '16px 0',
            ...
            >
              <div style={{ fontSize: 22, color: '#0288d1', fontWeight: 'bold', marginBottom: 12 }}>
                ℞
              </div>
              <EmptyTable
                cols={5}
            ...
            <div style={{ textAlign: 'center', marginTop: 16, fontSize: 11, color: '#666' }}>
              توقيع رقمي: {d.digitalSignature || '____________________'}
            </div>
          </div>
          <OrgFooter />
        </div>
          ...
          <div style={bodyPad}>
            <Section title="بيانات المستفيد">
              <div style={fieldRow}>
                ...
                <Field label="العمر" value={d.age} w="15%" />
                <Field label="رقم الملف" value={d.fileNo} w="20%" />
                <Field label="مصدر الإحالة" value={d.referralSource} w="25%" />
              </div>
            </Section>
          ...
          <div style={bodyPad}>
            <Section title="بيانات المستفيد">
              <div style={fieldRow}>
                ...
                <Field label="رقم الملف" value={d.fileNo} w="20%" />
                <Field label="التاريخ" value={formatDate(d.date) || today()} w="20%" />
                <Field label="نوع التقرير" value={d.reportType} w="20%" />
              </div>
            </Section>
        ...
        <div style={pageWrapper}>
          ...
          <div style={bodyPad}>
            <Section title="بيانات المستفيد">
              <div style={fieldRow}>
                <Field label="الاسم" value={d.name} w="40%" />
                <Field label="التاريخ والوقت" value={d.dateTime || today()} w="30%" />
                <Field label="مستوى الخطورة" value={d.riskLevel} w="30%" />
              </div>
            </Section>
            ...
            <div style={fieldRow}>
              <Field label="المتابعة" value={d.followUp} w="50%" />
              <Field label="الإحالة" value={d.referral} w="50%" />
            </div>
          ...
          <div style={bodyPad}>
            ...
            <Section title="تقييم المهارات">
              <EmptyTable
                cols={5}
                rows={12}
                headers={['المجال', 'المهارة', 'مستقل', 'بمساعدة', 'غير متمكن']}
              />
            </Section>
