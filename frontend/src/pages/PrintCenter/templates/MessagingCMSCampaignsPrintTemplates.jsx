...
export const MESSAGING_CMS_CAMPAIGNS_TEMPLATES = [
  {
    id: 'sms-campaign-plan',
    name: 'خطة حملة رسائل SMS',
    nameEn: 'SMS Campaign Plan',
    desc: 'تخطيط حملة رسائل نصية',
    color: '#1565c0',
  },
  {
    id: 'email-campaign-report',
    name: 'تقرير حملة بريد إلكتروني',
    nameEn: 'Email Campaign Report',
    desc: 'تقرير نتائج حملة البريد',
    color: '#1976d2',
  },
  {
    id: 'push-notification-log',
    name: 'سجل الإشعارات الفورية',
    nameEn: 'Push Notification Log',
  ...
  },
  {
    ...
    desc: 'تقويم نشر المحتوى الرقمي',
    color: '#7b1fa2',
  },
  {
    id: 'cms-page-inventory',
    name: 'جرد صفحات CMS',
    nameEn: 'CMS Page Inventory',
    desc: 'جرد صفحات نظام إدارة المحتوى',
    color: '#9c27b0',
  },
  {
    id: 'social-media-plan',
    name: 'خطة وسائل التواصل',
    nameEn: 'Social Media Plan',
    desc: 'خطة نشر وسائل التواصل',
    color: '#e91e63',
  },
  {
    id: 'newsletter-template',
    name: 'قالب النشرة البريدية',
    nameEn: 'Newsletter Template',
    desc: 'قالب النشرة البريدية الشهرية',
    color: '#00695c',
  },
  {
    id: 'audience-segmentation',
    name: 'تصنيف الجمهور',
    nameEn: 'Audience Segmentation Report',
    desc: 'تقرير تقسيم الجمهور المستهدف',
    color: '#2e7d32',
  },
  {
    id: 'campaign-roi-report',
    name: 'تقرير العائد على الحملات',
    nameEn: 'Campaign ROI Report',
    desc: 'تقرير عائد الاستثمار',
    color: '#e65100',
  },
  {
    id: 'marketing-budget',
    name: 'ميزانية التسويق',
    nameEn: 'Marketing Budget Report',
    desc: 'تقرير ميزانية التسويق الرقمي',
    color: '#f57c00',
  },
  {
    id: 'unsubscribe-report',
    name: 'تقرير إلغاء الاشتراك',
    nameEn: 'Unsubscribe Report',
    desc: 'تقرير إلغاء اشتراكات القوائم',
    color: '#c62828',
  },
  {
    id: 'broadcast-log',
    name: 'سجل البث الجماعي',
    nameEn: 'Broadcast Message Log',
    desc: 'سجل الرسائل الجماعية',
    color: '#283593',
  },
  {
    id: 'content-approval-form',
    name: 'نموذج اعتماد محتوى',
    nameEn: 'Content Approval Form',
    desc: 'نموذج اعتماد نشر المحتوى',
    color: '#0277bd',
  },
  {
    id: 'media-asset-register',
    name: 'سجل الأصول المرئية',
    nameEn: 'Media Asset Register',
    desc: 'سجل الأصول المرئية والوسائط',
    color: '#4527a0',
  },
  {
    id: 'engagement-analytics',
    name: 'تحليل التفاعل',
    nameEn: 'Engagement Analytics Report',
    desc: 'تقرير تحليل التفاعل الرقمي',
    color: '#558b2f',
  },
  {
    id: 'ab-campaign-test',
    name: 'اختبار حملات A/B',
    nameEn: 'A/B Campaign Test Report',
    desc: 'نتائج اختبار الحملات',
    color: '#455a64',
  },
];
        ...
        <div style={pageWrapper}>
          ...
          <div style={bodyPad}>
            <div style={fieldRow}>
              ...
              <Field label="الميزانية" value={d.budget} w="12%" />
            </div>
            <div style={fieldRow}>
              <Field label="الجمهور المستهدف" value={d.targetAudience} w="30%" />
              <Field label="العدد المقدر" value={d.estimatedCount} w="15%" />
            </div>
            <Section title="جدول الرسائل">
              <EmptyTable
                cols={5}
                rows={6}
                headers={['الرسالة', 'التوقيت', 'الشريحة', 'العدد', 'الحالة']}
              />
            </Section>
        ...
        <div style={pageWrapper}>
          ...
          <div style={bodyPad}>
            <div style={fieldRow}>
              ...
              <Field label="تاريخ الإرسال" value={formatDate(d.sendDate)} w="15%" />
            </div>
            <div style={fieldRow}>
              <Field label="المرسل" value={d.sent} w="10%" />
              <Field label="مفتوح" value={d.opened} w="10%" />
              <Field label="نقرات" value={d.clicks} w="10%" />
              <Field label="إلغاء" value={d.unsubscribed} w="10%" />
            </div>
            <Section title="أداء الروابط">
              <EmptyTable
                cols={4}
                rows={6}
                headers={['الرابط', 'النقرات', 'النسبة %', 'ملاحظات']}
              />
            </Section>
          ...
          <div style={bodyPad}>
            ...
            <Section title="الإشعارات المرسلة">
              <EmptyTable
                cols={6}
                rows={10}
                headers={['التاريخ', 'العنوان', 'المنصة', 'المستلمين', 'التفاعل', 'الحالة']}
              />
            </Section>
          ...
          <div style={bodyPad}>
            ...
            <Section title="جدول المحتوى">
              <EmptyTable
                cols={6}
                rows={12}
                headers={['التاريخ', 'المحتوى', 'القناة', 'المسؤول', 'الحالة', 'ملاحظات']}
              />
            </Section>
        ...
        <div style={pageWrapper}>
          ...
          <div style={bodyPad}>
            <div style={fieldRow}>
              ...
              <Field label="إجمالي الصفحات" value={d.totalPages} w="12%" />
            </div>
            <Section title="الصفحات">
              <EmptyTable
                cols={6}
                rows={10}
                headers={['الصفحة', 'القسم', 'آخر تحديث', 'المسؤول', 'الحالة', 'الزيارات']}
              />
            </Section>
          ...
          <div style={bodyPad}>
            ...
            <Section title="المنشورات المخططة">
              <EmptyTable
                cols={6}
                rows={10}
                headers={['التاريخ', 'المنصة', 'المحتوى', 'النوع', 'الوقت', 'الحالة']}
              />
            </Section>
    ...
    case 'newsletter-template':
      return (
        <div style={pageWrapper}>
          ...
          <div style={bodyPad}>
            <div style={fieldRow}>
              <Field label="الإصدار" value={d.issue} w="10%" />
              <Field label="الشهر" value={d.month} w="12%" />
              <Field label="المحرر" value={d.editor} w="20%" />
            </div>
      ...
      return (
        <div style={pageWrapper}>
          ...
          <div style={bodyPad}>
            <div style={fieldRow}>
              <Field label="التاريخ" value={formatDate(d.date) || today()} w="15%" />
              <Field label="الإجمالي" value={d.totalAudience} w="12%" />
            </div>
            <Section title="الشرائح">
              <EmptyTable
                cols={5}
                rows={8}
                headers={['الشريحة', 'العدد', 'النسبة %', 'المعايير', 'القناة المفضلة']}
              />
            </Section>
          ...
          <div style={bodyPad}>
            ...
            <Section title="الحملات">
              <EmptyTable
                cols={6}
                rows={8}
                headers={['الحملة', 'التكلفة', 'العائد', 'ROI %', 'الوصول', 'ملاحظات']}
              />
            </Section>
            <div style={fieldRow}>
              <Field label="إجمالي التكلفة" value={d.totalCost} w="15%" />
              <Field label="إجمالي العائد" value={d.totalReturn} w="15%" />
            </div>
            <NotesBox label="التوصيات" value={d.recommendations} lines={2} />
      ...
      return (
        <div style={pageWrapper}>
          ...
          <div style={bodyPad}>
            <div style={fieldRow}>
              <Field label="الفترة" value={d.period} w="15%" />
              <Field label="الميزانية الإجمالية" value={d.totalBudget} w="15%" />
            </div>
      ...
      return (
        <div style={pageWrapper}>
          ...
          <div style={bodyPad}>
            <div style={fieldRow}>
              <Field label="الفترة" value={d.period} w="15%" />
              <Field label="إجمالي الإلغاء" value={d.totalUnsub} w="12%" />
            </div>
            <Section title="التفاصيل">
              <EmptyTable
                cols={5}
                rows={8}
                headers={['القائمة', 'الإلغاءات', 'النسبة %', 'السبب الأكثر', 'إجراء']}
              />
            </Section>
            <NotesBox label="التوصيات" value={d.recommendations} lines={2} />
            <SignatureBlock rightLabel="مدير التسويق" leftLabel="" />
          ...
          <div style={bodyPad}>
            ...
            <Section title="الرسائل">
              <EmptyTable
                cols={6}
                rows={10}
                headers={['التاريخ', 'القناة', 'الموضوع', 'المستلمين', 'الحالة', 'بواسطة']}
              />
            </Section>
            <SignatureBlock rightLabel="مدير التواصل" leftLabel="" />
          </div>
    ...
    case 'content-approval-form':
      return (
        <div style={pageWrapper}>
          ...
          <div style={bodyPad}>
            <div style={fieldRow}>
              <Field label="عنوان المحتوى" value={d.contentTitle} w="30%" />
              <Field label="القناة" value={d.channel} w="15%" />
              <Field label="تاريخ النشر" value={formatDate(d.publishDate)} w="15%" />
            </div>
            <div style={fieldRow}>
              <Field label="الكاتب" value={d.author} w="20%" />
          ...
          <div style={bodyPad}>
            ...
            <Section title="الأصول">
              <EmptyTable
                cols={6}
                rows={10}
                headers={['الملف', 'النوع', 'الحجم', 'المالك', 'الترخيص', 'الاستخدام']}
              />
            </Section>
            <NotesBox label="ملاحظات" value={d.notes} lines={1} />
          ...
          <div style={bodyPad}>
            ...
            <Section title="النتائج">
              <EmptyTable
                cols={6}
                rows={6}
                headers={['المتغير', 'النسخة A', 'النسخة B', 'الفارق', 'الأهمية', 'الفائز']}
              />
            </Section>
