...
export const MICROSERVICES_DASHBOARD_TEMPLATES = [
  {
    id: 'service-registry',
    name: 'سجل الخدمات المصغرة',
    nameEn: 'Service Registry',
    desc: 'جرد الخدمات المصغرة وحالتها',
    color: '#1565c0',
  },
  {
    id: 'service-health-report',
    name: 'تقرير صحة الخدمات',
    nameEn: 'Service Health Report',
    desc: 'تقرير حالة صحة الخدمات',
    color: '#1976d2',
  },
  {
    id: 'api-endpoint-doc',
    name: 'توثيق نقاط API',
    nameEn: 'API Endpoint Documentation',
    desc: 'توثيق نقاط نهاية API',
    color: '#1e88e5',
  },
  {
    id: 'dashboard-config-doc',
    name: 'توثيق إعدادات لوحة المتابعة',
    nameEn: 'Dashboard Config Documentation',
    desc: 'توثيق إعدادات لوحات المتابعة',
    color: '#6a1b9a',
  },
  {
    id: 'kpi-dashboard-report',
    name: 'تقرير لوحة KPI',
    nameEn: 'KPI Dashboard Report',
    desc: 'تقرير مؤشرات الأداء',
    color: '#7b1fa2',
  },
  {
    id: 'service-dependency-map',
    name: 'خريطة تبعية الخدمات',
    nameEn: 'Service Dependency Map',
    desc: 'خريطة تبعيات الخدمات',
    color: '#00695c',
  },
  {
    id: 'container-status',
    name: 'حالة الحاويات',
    nameEn: 'Container Status Report',
    desc: 'تقرير حالة حاويات Docker',
    color: '#0277bd',
  },
  {
    id: 'message-queue-report',
    name: 'تقرير طوابير الرسائل',
    nameEn: 'Message Queue Report',
    desc: 'تقرير حالة طوابير الرسائل',
    color: '#283593',
  },
  {
    id: 'caching-report',
    name: 'تقرير التخزين المؤقت',
    nameEn: 'Caching Performance Report',
    desc: 'تقرير أداء التخزين المؤقت',
    color: '#c62828',
  },
  {
    id: 'load-balancer-config',
    name: 'إعدادات موازن الحمل',
    nameEn: 'Load Balancer Config',
    desc: 'توثيق إعدادات موازن الحمل',
    color: '#e65100',
  },
  {
    id: 'ci-cd-pipeline-doc',
    name: 'توثيق أنبوب CI/CD',
    nameEn: 'CI/CD Pipeline Documentation',
    desc: 'توثيق مراحل البناء والنشر',
    color: '#2e7d32',
  },
  {
    id: 'deployment-history',
    name: 'سجل عمليات النشر',
    nameEn: 'Deployment History Log',
    desc: 'سجل عمليات نشر الخدمات',
    color: '#f57c00',
  },
  {
    id: 'widget-catalog',
    name: 'فهرس عناصر لوحة المتابعة',
    nameEn: 'Dashboard Widget Catalog',
    desc: 'فهرس عناصر الواجهة',
    color: '#303f9f',
  },
  {
    id: 'real-time-monitor-config',
    name: 'إعدادات المراقبة الحية',
    nameEn: 'Real-Time Monitor Config',
    desc: 'توثيق إعدادات المراقبة',
    color: '#455a64',
  },
  {
    id: 'log-aggregation-report',
    name: 'تقرير تجميع السجلات',
    nameEn: 'Log Aggregation Report',
    desc: 'تقرير السجلات المجمعة',
    color: '#558b2f',
  },
  {
    id: 'auto-scaling-config',
    name: 'إعدادات التوسع التلقائي',
    nameEn: 'Auto-Scaling Configuration',
    desc: 'توثيق سياسات التوسع',
    color: '#4527a0',
  },
];
  ...
  switch (templateId) {
        ...
        <div style={pageWrapper}>
          ...
          <div style={bodyPad}>
            <div style={fieldRow}>
              ...
              <Field label="إجمالي الخدمات" value={d.totalServices} w="12%" />
            </div>
            <Section title="الخدمات">
              <EmptyTable
                cols={6}
                rows={10}
                headers={['الخدمة', 'الإصدار', 'المنفذ', 'المالك', 'الحالة', 'آخر نشر']}
              />
            </Section>
          ...
          <div style={bodyPad}>
            ...
            <Section title="حالة الخدمات">
              <EmptyTable
                cols={6}
                rows={10}
                headers={['الخدمة', 'CPU %', 'الذاكرة', 'الاستجابة (ms)', 'الأخطاء', 'الحالة']}
              />
            </Section>
    ...
    case 'api-endpoint-doc':
      return (
        <div style={pageWrapper}>
          ...
          <div style={bodyPad}>
            <div style={fieldRow}>
              <Field label="الخدمة" value={d.serviceName} w="20%" />
            ...
            <Section title="نقاط النهاية">
              <EmptyTable
                cols={6}
                rows={12}
                headers={['المسار', 'الطريقة', 'الوصف', 'المصادقة', 'المعاملات', 'الاستجابة']}
              />
            </Section>
            <NotesBox label="ملاحظات" value={d.notes} lines={1} />
    ...
    case 'dashboard-config-doc':
      return (
        <div style={pageWrapper}>
          <OrgHeader
            title="توثيق إعدادات لوحة المتابعة"
            subtitle="Dashboard Configuration Documentation"
          />
          <div style={bodyPad}>
            <div style={fieldRow}>
              <Field label="اللوحة" value={d.dashboardName} w="25%" />
              <Field label="التاريخ" value={formatDate(d.date) || today()} w="15%" />
            </div>
            <Section title="العناصر">
              <EmptyTable
                cols={6}
                rows={8}
                headers={['العنصر', 'النوع', 'مصدر البيانات', 'التحديث', 'الحجم', 'ملاحظات']}
              />
            </Section>
          ...
          <div style={bodyPad}>
            ...
            <Section title="مؤشرات الأداء">
              <EmptyTable
                cols={6}
                rows={10}
                headers={['المؤشر', 'المستهدف', 'الفعلي', 'الإنجاز %', 'الاتجاه', 'الحالة']}
              />
            </Section>
          ...
          <div style={bodyPad}>
            ...
            <Section title="التبعيات">
              <EmptyTable
                cols={5}
                rows={10}
                headers={['الخدمة', 'تعتمد على', 'النوع', 'الأهمية', 'ملاحظات']}
              />
            </Section>
      ...
      return (
        <div style={pageWrapper}>
          ...
          <div style={bodyPad}>
            <div style={fieldRow}>
              <Field label="التاريخ" value={formatDate(d.date) || today()} w="15%" />
              <Field label="إجمالي الحاويات" value={d.totalContainers} w="12%" />
            </div>
            <Section title="الحاويات">
              <EmptyTable
                cols={6}
                rows={10}
                headers={['الحاوية', 'الصورة', 'CPU', 'الذاكرة', 'وقت التشغيل', 'الحالة']}
              />
            </Section>
            <NotesBox label="ملاحظات" value={d.notes} lines={1} />
            <SignatureBlock rightLabel="مدير DevOps" leftLabel="" />
          ...
          <div style={bodyPad}>
            ...
            <Section title="الطوابير">
              <EmptyTable
                cols={6}
                rows={8}
                headers={['الطابور', 'المعلق', 'المعالج/ث', 'زمن المعالجة', 'الأخطاء', 'الحالة']}
              />
            </Section>
    ...
    case 'caching-report':
      return (
        <div style={pageWrapper}>
          ...
          <div style={bodyPad}>
            <div style={fieldRow}>
              <Field label="النظام" value={d.cacheSystem} w="15%" />
              <Field label="الفترة" value={d.period} w="15%" />
            </div>
            <Section title="الأداء">
              <EmptyTable
                cols={6}
                rows={6}
                headers={['المفتاح', 'Hit Rate', 'Miss Rate', 'الحجم', 'TTL', 'ملاحظات']}
              />
            </Section>
            <div style={fieldRow}>
              <Field label="Hit Rate العام" value={d.overallHitRate} w="12%" />
              <Field label="الذاكرة المستخدمة" value={d.memoryUsed} w="12%" />
            </div>
    ...
    case 'load-balancer-config':
      return (
        <div style={pageWrapper}>
          ...
          <div style={bodyPad}>
            <div style={fieldRow}>
              <Field label="النوع" value={d.lbType} w="15%" />
              <Field label="التاريخ" value={formatDate(d.date) || today()} w="15%" />
            </div>
            <Section title="الخوادم الخلفية">
              <EmptyTable
                cols={6}
                rows={6}
                headers={['الخادم', 'المنفذ', 'الوزن', 'Health Check', 'الحالة', 'ملاحظات']}
              />
            </Section>
    ...
    case 'ci-cd-pipeline-doc':
      return (
        <div style={pageWrapper}>
          ...
          <div style={bodyPad}>
            <div style={fieldRow}>
              <Field label="المشروع" value={d.projectName} w="25%" />
              <Field label="التاريخ" value={formatDate(d.date) || today()} w="15%" />
            </div>
            <Section title="مراحل الأنبوب">
              <EmptyTable
                cols={6}
                rows={8}
                headers={['المرحلة', 'الأداة', 'المحفز', 'المدة', 'الشروط', 'ملاحظات']}
              />
            </Section>
          ...
          <div style={bodyPad}>
            ...
            <Section title="عمليات النشر">
              <EmptyTable
                cols={6}
                rows={10}
                headers={['التاريخ', 'الخدمة', 'الإصدار', 'البيئة', 'المنفذ', 'النتيجة']}
              />
            </Section>
          ...
          <div style={bodyPad}>
            ...
            <Section title="العناصر المتاحة">
              <EmptyTable
                cols={6}
                rows={10}
                headers={['العنصر', 'النوع', 'الوصف', 'مصدر البيانات', 'التخصيص', 'الحالة']}
              />
            </Section>
    ...
    case 'real-time-monitor-config':
      return (
        <div style={pageWrapper}>
          <OrgHeader
            title="توثيق إعدادات المراقبة الحية"
            subtitle="Real-Time Monitor Configuration"
          />
          <div style={bodyPad}>
            <div style={fieldRow}>
            ...
            <Section title="نقاط المراقبة">
              <EmptyTable
                cols={6}
                rows={8}
                headers={['النقطة', 'المؤشر', 'الحد الأعلى', 'الحد الأدنى', 'التنبيه', 'الحالة']}
              />
            </Section>
          ...
          <div style={bodyPad}>
            ...
            <Section title="ملخص السجلات">
              <EmptyTable
                cols={5}
                rows={6}
                headers={['المصدر', 'المستوى', 'العدد', 'الأكثر تكراراً', 'ملاحظات']}
              />
            </Section>
      ...
      return (
        <div style={pageWrapper}>
          ...
          <div style={bodyPad}>
            ...
            <div style={fieldRow}>
              <Field label="الحد الأدنى للنسخ" value={d.minReplicas} w="12%" />
              <Field label="الحد الأقصى" value={d.maxReplicas} w="12%" />
            </div>
            <NotesBox label="ملاحظات" value={d.notes} lines={1} />
