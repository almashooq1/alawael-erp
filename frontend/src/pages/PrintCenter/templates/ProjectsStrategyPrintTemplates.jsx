...
export const PROJECTS_STRATEGY_TEMPLATES = [
  ...
  {
    id: 'project-closure',
    name: 'محضر إغلاق مشروع',
    nameEn: 'Project Closure Report',
    desc: 'محضر إغلاق المشروع',
    color: '#1e88e5',
  },
  {
    id: 'project-change-request',
    name: 'طلب تغيير مشروع',
    nameEn: 'Change Request',
    desc: 'نموذج طلب تغيير على المشروع',
    color: '#2196f3',
  },
  {
    id: 'strategic-goal',
    name: 'هدف استراتيجي',
    nameEn: 'Strategic Goal Card',
    desc: 'بطاقة الهدف الاستراتيجي',
    color: '#42a5f5',
  },
  {
    id: 'strategic-initiative',
    name: 'مبادرة استراتيجية',
    nameEn: 'Strategic Initiative',
    desc: 'وثيقة المبادرة الاستراتيجية',
    color: '#0d47a1',
  },
  {
    id: 'kpi-scorecard',
  ...
  },
  {
    ...
    desc: 'نموذج تحليل البيئة الاستراتيجية',
    color: '#01579b',
  },
  {
    ...
    desc: 'بطاقة الأداء المتوازن BSC',
    color: '#0288d1',
  },
  /* ── إدارة المخاطر ── */
  {
  ...
  },
  {
    ...
    desc: 'نموذج تقييم المخاطر',
    color: '#d32f2f',
  },
  {
    id: 'risk-treatment',
    name: 'خطة معالجة المخاطر',
    nameEn: 'Risk Treatment Plan',
    desc: 'خطة معالجة ومتابعة المخاطر',
    color: '#e53935',
  },
  {
    ...
    desc: 'خطة استمرارية الأعمال BCP',
    color: '#b71c1c',
  },
  {
    id: 'succession-plan',
    name: 'خطة تعاقب وظيفي',
    nameEn: 'Succession Plan',
    desc: 'خطة التعاقب الوظيفي',
    color: '#880e4f',
  },
  {
    id: 'lessons-learned',
    ...
    desc: 'تقرير الدروس المستفادة',
    color: '#4a148c',
  },
  {
    id: 'stakeholder-analysis',
    name: 'تحليل أصحاب المصلحة',
    nameEn: 'Stakeholder Analysis',
    desc: 'مصفوفة تحليل أصحاب المصلحة',
    color: '#311b92',
  },
  {
    id: 'milestone-tracker',
    name: 'متتبع المراحل',
    nameEn: 'Milestone Tracker',
    desc: 'جدول مراحل المشروع',
    color: '#1a237e',
  },
  {
    id: 'project-budget',
    name: 'موازنة المشروع',
    nameEn: 'Project Budget',
    desc: 'موازنة المشروع التفصيلية',
    color: '#283593',
  },
];
    ...
    case 'project-charter':
      return (
        <div style={pageWrapper}>
          ...
          <div style={bodyPad}>
            <div style={fieldRow}>
              <Field label="اسم المشروع" value={d.projectName} w="40%" />
              <Field label="الرقم" value={d.projectNo} w="15%" />
              <Field label="مدير المشروع" value={d.manager} w="25%" />
              <Field label="الراعي" value={d.sponsor} w="20%" />
            </div>
            <div style={fieldRow}>
              <Field label="تاريخ البدء" value={formatDate(d.startDate)} w="20%" />
              <Field label="تاريخ الانتهاء" value={formatDate(d.endDate)} w="20%" />
              <Field label="الميزانية" value={formatMoney(d.budget)} w="25%" />
    ...
    case 'project-status':
      return (
        <div style={pageWrapper}>
          ...
          <div style={bodyPad}>
            <div style={fieldRow}>
              <Field label="المشروع" value={d.projectName} w="35%" />
              <Field label="الفترة" value={d.period} w="20%" />
              <Field label="الحالة العامة" value={d.overallStatus} w="15%" />
              <Field label="نسبة الإنجاز" value={d.completion} w="15%" />
            </div>
            <Section title="مؤشرات الحالة">
              <EmptyTable
                cols={4}
                rows={4}
                headers={['المؤشر', 'المخطط', 'الفعلي', 'الحالة (أخضر/أصفر/أحمر)']}
              />
            </Section>
        ...
        <div style={pageWrapper}>
          ...
          <div style={bodyPad}>
            <div style={fieldRow}>
              ...
              <Field label="المدير" value={d.manager} w="30%" />
              <Field label="تاريخ الإغلاق" value={formatDate(d.closureDate) || today()} w="20%" />
            </div>
            <div style={fieldRow}>
              <Field label="البدء الفعلي" value={formatDate(d.actualStart)} w="20%" />
              <Field label="الانتهاء الفعلي" value={formatDate(d.actualEnd)} w="20%" />
              <Field label="الميزانية المعتمدة" value={formatMoney(d.approvedBudget)} w="25%" />
              <Field label="الإنفاق الفعلي" value={formatMoney(d.actualSpend)} w="25%" />
            </div>
      ...
      return (
        <div style={pageWrapper}>
          ...
          <div style={bodyPad}>
            <div style={fieldRow}>
              <Field label="المشروع" value={d.projectName} w="40%" />
              <Field label="رقم التغيير" value={d.changeNo} w="15%" />
            ...
            <div style={fieldRow}>
              ...
              <Field label="تاريخ القرار" value={formatDate(d.decisionDate)} w="25%" />
            </div>
    ...
    case 'strategic-goal':
      return (
        <div style={pageWrapper}>
          ...
          <div style={bodyPad}>
            <div style={fieldRow}>
              <Field label="الهدف" value={d.goalTitle} w="45%" />
              <Field label="المحور" value={d.perspective} w="25%" />
              <Field label="الفترة" value={d.period} w="20%" />
            </div>
            ...
            <Section title="مؤشرات القياس">
              <EmptyTable
                cols={5}
                rows={4}
                headers={['المؤشر', 'المستهدف', 'الفعلي', 'الوزن %', 'النتيجة']}
              />
            </Section>
            <Section title="المبادرات المرتبطة">
              <EmptyTable
                cols={4}
                rows={4}
                headers={['المبادرة', 'المسؤول', 'نسبة الإنجاز', 'ملاحظات']}
              />
            </Section>
    ...
    case 'strategic-initiative':
      return (
        <div style={pageWrapper}>
          ...
          <div style={bodyPad}>
            <div style={fieldRow}>
              <Field label="المبادرة" value={d.initiativeName} w="40%" />
              <Field label="الهدف الاستراتيجي" value={d.strategicGoal} w="35%" />
              <Field label="المسؤول" value={d.owner} w="25%" />
            </div>
            <div style={fieldRow}>
              <Field label="من" value={formatDate(d.startDate)} w="20%" />
              <Field label="إلى" value={formatDate(d.endDate)} w="20%" />
              <Field label="الميزانية" value={formatMoney(d.budget)} w="25%" />
            ...
            <Section title="خطة التنفيذ">
              <EmptyTable
                cols={5}
                rows={6}
                headers={['المهمة', 'المسؤول', 'البدء', 'الانتهاء', 'الحالة']}
              />
            </Section>
    ...
    case 'kpi-scorecard':
      return (
        <div style={pageWrapper}>
          ...
          <div style={bodyPad}>
            <div style={fieldRow}>
              <Field label="القسم/الإدارة" value={d.department} w="30%" />
            ...
            <div style={fieldRow}>
              <Field label="المعدل العام" value={d.overallScore} w="25%" />
              <Field label="التقييم" value={d.rating} w="25%" />
            </div>
    ...
    case 'swot-analysis':
      return (
        <div style={pageWrapper}>
          ...
          <div style={bodyPad}>
            <div style={fieldRow}>
              <Field label="الموضوع/المشروع" value={d.subject} w="40%" />
              <Field label="التاريخ" value={formatDate(d.date) || today()} w="20%" />
              <Field label="المحلل" value={d.analyst} w="25%" />
            </div>
            <div
    ...
    case 'balanced-scorecard':
      return (
        <div style={pageWrapper}>
          ...
          <div style={bodyPad}>
            <div style={fieldRow}>
              <Field label="الإدارة" value={d.department} w="30%" />
              <Field label="الفترة" value={d.period} w="25%" />
              <Field label="التاريخ" value={formatDate(d.date) || today()} w="20%" />
            </div>
            {['المنظور المالي', 'منظور العملاء', 'العمليات الداخلية', 'التعلم والنمو'].map(
              (p, i) => (
                <Section key={i} title={p}>
                  <EmptyTable
                    cols={5}
                    rows={3}
                    headers={['الهدف', 'المؤشر', 'المستهدف', 'الفعلي', 'الحالة']}
                  />
                </Section>
              )
            )}
        ...
        <div style={pageWrapper}>
          ...
          <div style={bodyPad}>
            <div style={fieldRow}>
              ...
              <Field label="المسؤول" value={d.owner} w="25%" />
              <Field label="التاريخ" value={formatDate(d.date) || today()} w="20%" />
              <Field label="عدد المخاطر" value={d.riskCount} w="15%" />
            </div>
    ...
    case 'risk-assessment':
      return (
        <div style={pageWrapper}>
          ...
          <div style={bodyPad}>
            <div style={fieldRow}>
              <Field label="الخطر" value={d.riskTitle} w="40%" />
            ...
            <div style={fieldRow}>
              <Field label="الاحتمال (1-5)" value={d.likelihood} w="20%" />
              <Field label="الأثر (1-5)" value={d.impact} w="20%" />
              <Field label="الدرجة" value={d.riskScore} w="15%" />
              <Field label="المستوى" value={d.riskLevel} w="15%" />
            </div>
            <NotesBox label="الأثر المتوقع" value={d.expectedImpact} lines={2} />
          ...
          <div style={bodyPad}>
            ...
            <Section title="متابعة ما بعد المعالجة">
              <EmptyTable
                cols={4}
                rows={4}
                headers={['التاريخ', 'الاحتمال المتبقي', 'الأثر المتبقي', 'ملاحظات']}
              />
            </Section>
    ...
    case 'business-continuity':
      return (
        <div style={pageWrapper}>
          ...
          <div style={bodyPad}>
            <div style={fieldRow}>
              <Field label="العملية" value={d.processName} w="35%" />
              <Field label="القسم" value={d.department} w="25%" />
              <Field label="الأولوية" value={d.priority} w="15%" />
              <Field label="RTO" value={d.rto} w="12%" />
              <Field label="RPO" value={d.rpo} w="12%" />
            </div>
            ...
            <Section title="خطوات الاستجابة">
              <EmptyTable
                cols={4}
                rows={8}
                headers={['الخطوة', 'المسؤول', 'الإطار الزمني', 'الموارد المطلوبة']}
              />
            </Section>
    ...
    case 'succession-plan':
      return (
        <div style={pageWrapper}>
          ...
          <div style={bodyPad}>
            <div style={fieldRow}>
              <Field label="المنصب" value={d.position} w="30%" />
              <Field label="القسم" value={d.department} w="25%" />
              <Field label="شاغل المنصب" value={d.incumbent} w="25%" />
              <Field label="الفترة" value={d.period} w="20%" />
            </div>
    ...
    case 'lessons-learned':
      return (
        <div style={pageWrapper}>
          ...
          <div style={bodyPad}>
            <div style={fieldRow}>
              <Field label="المشروع/الحدث" value={d.projectName} w="40%" />
              <Field label="المسؤول" value={d.responsible} w="30%" />
              <Field label="التاريخ" value={formatDate(d.date) || today()} w="20%" />
            </div>
    ...
    case 'stakeholder-analysis':
      return (
        <div style={pageWrapper}>
          ...
          <div style={bodyPad}>
            <div style={fieldRow}>
              <Field label="المشروع/المبادرة" value={d.project} w="40%" />
              <Field label="المحلل" value={d.analyst} w="25%" />
              <Field label="التاريخ" value={formatDate(d.date) || today()} w="20%" />
            </div>
        ...
        <div style={pageWrapper}>
          ...
          <div style={bodyPad}>
            <div style={fieldRow}>
              <Field label="المشروع" value={d.projectName} w="40%" />
              <Field label="المدير" value={d.manager} w="30%" />
              <Field label="تاريخ التحديث" value={formatDate(d.date) || today()} w="20%" />
            </div>
            ...
            <div style={fieldRow}>
              <Field label="نسبة الإنجاز الكلية" value={d.overallCompletion} w="25%" />
              <Field label="الحالة العامة" value={d.overallStatus} w="25%" />
            </div>
            <SignatureBlock rightLabel="مدير المشروع" leftLabel="" />
          </div>
          <OrgFooter />
      ...
      return (
        <div style={pageWrapper}>
          ...
          <div style={bodyPad}>
            <div style={fieldRow}>
              <Field label="المشروع" value={d.projectName} w="40%" />
              <Field label="مدير المشروع" value={d.manager} w="30%" />
              <Field label="التاريخ" value={formatDate(d.date) || today()} w="20%" />
            </div>
            <div style={fieldRow}>
              <Field label="الميزانية الإجمالية" value={formatMoney(d.totalBudget)} w="25%" />
              <Field label="المصروف حتى الآن" value={formatMoney(d.spentToDate)} w="25%" />
              <Field label="المتبقي" value={formatMoney(d.remaining)} w="25%" />
              <Field label="نسبة الصرف" value={d.spendPercentage} w="20%" />
            </div>
            <Section title="تفاصيل بنود الميزانية">
              <EmptyTable
                cols={6}
                rows={10}
                headers={['البند', 'المعتمد', 'المصروف', 'المتبقي', 'النسبة %', 'ملاحظات']}
              />
            </Section>
