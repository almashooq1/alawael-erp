...
export const SPECIAL_EDUCATION_TEMPLATES = [
  ...
  {
    id: 'iep-document',
    name: 'الخطة التربوية الفردية',
    nameEn: 'Individual Education Plan (IEP)',
    desc: 'الخطة التربوية الفردية للطالب',
    color: '#1565c0',
  },
  {
    id: 'behavior-intervention-plan',
    name: 'خطة التدخل السلوكي',
    nameEn: 'Behavior Intervention Plan',
    desc: 'خطة تعديل وتدخل سلوكي',
    color: '#1976d2',
  },
  {
    id: 'se-transition-plan',
    name: 'خطة الانتقال التعليمي',
    nameEn: 'Education Transition Plan',
    desc: 'خطة انتقال بين المراحل التعليمية',
    color: '#1e88e5',
  },
  {
    id: 'parent-communication-log',
    name: 'سجل تواصل ولي الأمر',
    nameEn: 'Parent Communication Log',
    desc: 'سجل التواصل مع ولي الأمر',
    color: '#2196f3',
  },
  {
    id: 'se-progress-report',
    name: 'تقرير تقدم تربوي',
    nameEn: 'Education Progress Report',
    desc: 'تقرير تقدم تربوي دوري',
    color: '#42a5f5',
  },
  {
    id: 'curriculum-adaptation',
    name: 'تكييف المنهج',
    nameEn: 'Curriculum Adaptation',
    desc: 'نموذج تكييف المنهج الدراسي',
    color: '#64b5f6',
  },
  {
    id: 'classroom-observation',
    name: 'ملاحظة صفية',
    nameEn: 'Classroom Observation',
    desc: 'نموذج ملاحظة صفية للمعلم',
    color: '#0d47a1',
  },
  {
    id: 'se-report-card',
    name: 'بطاقة تقرير الطالب',
    nameEn: 'Student Report Card',
    desc: 'بطاقة التقرير الدراسي',
    color: '#0277bd',
  },
  {
    id: 'iep-meeting-minutes',
    name: 'محضر اجتماع IEP',
    nameEn: 'IEP Meeting Minutes',
    desc: 'محضر اجتماع فريق الخطة التربوية',
    color: '#01579b',
  },
  /* ── التوظيف المدعوم ── */
  {
    id: 'employment-assessment',
    name: 'تقييم التوظيف',
    nameEn: 'Employment Assessment',
    desc: 'تقييم قدرات واستعداد التوظيف',
    color: '#e65100',
  },
  {
    id: 'job-placement-report',
    name: 'تقرير التوظيف',
    nameEn: 'Job Placement Report',
    desc: 'تقرير إلحاق بعمل',
    color: '#ef6c00',
  },
  {
    id: 'workplace-accommodation',
    name: 'تسهيلات بيئة العمل',
    nameEn: 'Workplace Accommodation',
    desc: 'نموذج طلب تسهيلات في بيئة العمل',
    color: '#f57c00',
  },
  {
    id: 'employment-progress-report',
    name: 'تقرير تقدم وظيفي',
    nameEn: 'Employment Progress',
    desc: 'تقرير تقدم في بيئة العمل',
    color: '#fb8c00',
  },
  {
    id: 'vocational-skills-assessment',
    name: 'تقييم المهارات المهنية',
    nameEn: 'Vocational Skills Assessment',
    desc: 'تقييم المهارات المهنية والحرفية',
    color: '#ff9800',
  },
  {
    id: 'job-coaching-log',
    name: 'سجل مدرب العمل',
    nameEn: 'Job Coaching Log',
    desc: 'سجل متابعة مدرب العمل',
    color: '#ffa726',
  },
  {
    id: 'employer-feedback-form',
    name: 'نموذج ملاحظات صاحب العمل',
    nameEn: 'Employer Feedback',
    desc: 'نموذج تغذية راجعة من صاحب العمل',
    color: '#ffb74d',
  },
  {
    id: 'workplace-safety-assessment',
    name: 'تقييم سلامة بيئة العمل',
    nameEn: 'Workplace Safety Assessment',
    desc: 'تقييم سلامة بيئة العمل للموظف',
    color: '#ff6f00',
  },
  {
    id: 'supported-employment-agreement',
    name: 'اتفاقية التوظيف المدعوم',
    nameEn: 'Supported Employment Agreement',
    desc: 'اتفاقية بين المركز وجهة التوظيف',
    color: '#e65100',
  },
];
  ...
  switch (templateId) {
      ...
      return (
        <div style={pageWrapper}>
          ...
          <div style={bodyPad}>
            ...
            <div style={fieldRow}>
              <Field label="المعلم المسؤول" value={d.teacher} w="25%" />
              <Field label="تاريخ البداية" value={formatDate(d.startDate)} w="15%" />
            ...
            <Section title="الأهداف السنوية">
              <EmptyTable
                cols={5}
                rows={6}
                headers={['المجال', 'الهدف', 'المعيار', 'التقييم', 'الحالة']}
              />
            </Section>
      ...
      return (
        <div style={pageWrapper}>
          ...
          <div style={bodyPad}>
            ...
            <NotesBox
              label="التحليل الوظيفي (وظيفة السلوك)"
              value={d.functionalAnalysis}
              lines={2}
            />
            ...
            <Section title="استراتيجيات الاستبدال">
              <EmptyTable
                cols={3}
                rows={3}
                headers={['السلوك البديل', 'كيفية التعليم', 'التعزيز']}
              />
            </Section>
        ...
        <div style={pageWrapper}>
          ...
          <div style={bodyPad}>
            <div style={fieldRow}>
              <Field label="الطالب" value={d.student} w="25%" />
              <Field label="العمر" value={d.age} w="10%" />
              <Field label="من" value={d.fromProgram} w="20%" />
              <Field label="إلى" value={d.toProgram} w="20%" />
            </div>
            <div style={fieldRow}>
              <Field label="تاريخ الانتقال المتوقع" value={formatDate(d.transitionDate)} w="15%" />
            ...
            <Section title="أهداف المرحلة الجديدة">
              <EmptyTable
                cols={4}
                rows={5}
                headers={['الهدف', 'الخطوات', 'الدعم المطلوب', 'الموعد']}
              />
            </Section>
      ...
      return (
        <div style={pageWrapper}>
          ...
          <div style={bodyPad}>
            <div style={fieldRow}>
              <Field label="الطالب" value={d.student} w="25%" />
              <Field label="ولي الأمر" value={d.parent} w="25%" />
            ...
            <Section title="سجل التواصل">
              <EmptyTable
                cols={6}
                rows={12}
                headers={['التاريخ', 'الطريقة', 'المبادر', 'الموضوع', 'النتيجة', 'المتابعة']}
              />
            </Section>
          ...
          <div style={bodyPad}>
            ...
            <Section title="التقدم في أهداف IEP">
              <EmptyTable
                cols={5}
                rows={6}
                headers={['الهدف', 'المعيار', 'التقدم', 'النسبة %', 'الحالة']}
              />
            </Section>
      ...
      return (
        <div style={pageWrapper}>
          ...
          <div style={bodyPad}>
            <div style={fieldRow}>
              <Field label="الطالب" value={d.student} w="25%" />
              <Field label="المادة" value={d.subject} w="20%" />
              <Field label="الصف" value={d.grade} w="10%" />
              <Field label="المعلم" value={d.teacher} w="25%" />
            </div>
            <Section title="التكييفات">
              <EmptyTable
                cols={4}
                rows={8}
                headers={['المحتوى الأصلي', 'التكييف', 'نوع التكييف', 'ملاحظات']}
              />
            </Section>
      ...
      return (
        <div style={pageWrapper}>
          ...
          <div style={bodyPad}>
            <div style={fieldRow}>
              <Field label="المعلم" value={d.teacher} w="25%" />
              <Field label="المادة" value={d.subject} w="15%" />
              <Field label="الصف" value={d.grade} w="10%" />
              <Field label="الملاحظ" value={d.observer} w="25%" />
              <Field label="التاريخ" value={formatDate(d.date) || today()} w="15%" />
            </div>
            <Section title="معايير الملاحظة">
              <EmptyTable
                cols={5}
                rows={10}
                headers={['المعيار', 'ممتاز', 'جيد', 'مقبول', 'ملاحظات']}
              />
            </Section>
        ...
        <div style={pageWrapper}>
          ...
          <div style={bodyPad}>
            <div style={fieldRow}>
              <Field label="الطالب" value={d.student} w="25%" />
              <Field label="الصف" value={d.grade} w="10%" />
              <Field label="الفصل" value={d.semester} w="15%" />
              <Field label="العام" value={d.year} w="12%" />
            </div>
            <Section title="التقييم الأكاديمي">
              <EmptyTable
                cols={5}
                rows={8}
                headers={['المادة', 'الدرجة', 'التقدير', 'الجهد', 'ملاحظات']}
              />
            </Section>
        ...
        <div style={pageWrapper}>
          ...
          <div style={bodyPad}>
            <div style={fieldRow}>
              <Field label="الطالب" value={d.student} w="25%" />
              <Field label="التاريخ" value={formatDate(d.date) || today()} w="15%" />
              <Field label="نوع الاجتماع" value={d.meetingType} w="15%" />
            </div>
    ...
    case 'employment-assessment':
      return (
        <div style={pageWrapper}>
          <OrgHeader
            title="تقييم قدرات واستعداد التوظيف"
            subtitle="Employment Readiness Assessment"
          />
          <div style={bodyPad}>
            <div style={fieldRow}>
            ...
            <Section title="المهارات الوظيفية">
              <EmptyTable
                cols={4}
                rows={8}
                headers={['المهارة', 'المستوى (1-5)', 'الأهمية', 'ملاحظات']}
              />
            </Section>
            <Section title="المهارات الاجتماعية">
              <EmptyTable
                cols={4}
                rows={5}
                headers={['المهارة', 'المستوى', 'الملاحظة', 'التوصية']}
              />
            </Section>
            ...
            <div style={fieldRow}>
              <Field label="الجاهزية" value={d.readiness} w="20%" />
              <Field label="التوصية" value={d.recommendation} w="30%" />
            </div>
      ...
      return (
        <div style={pageWrapper}>
          ...
          <div style={bodyPad}>
            <div style={fieldRow}>
              <Field label="المستفيد" value={d.beneficiary} w="25%" />
              <Field label="جهة العمل" value={d.employer} w="25%" />
              <Field label="المسمى" value={d.jobTitle} w="20%" />
            </div>
            <div style={fieldRow}>
              <Field label="تاريخ البدء" value={formatDate(d.startDate)} w="15%" />
              <Field label="نوع العقد" value={d.contractType} w="15%" />
              <Field label="الراتب" value={d.salary} w="12%" />
            </div>
    ...
    case 'workplace-accommodation':
      return (
        <div style={pageWrapper}>
          ...
          <div style={bodyPad}>
            <div style={fieldRow}>
              <Field label="الموظف" value={d.employee} w="25%" />
              <Field label="جهة العمل" value={d.employer} w="25%" />
              <Field label="المسمى" value={d.jobTitle} w="20%" />
            </div>
            ...
            <Section title="التسهيلات المطلوبة">
              <EmptyTable
                cols={4}
                rows={5}
                headers={['التسهيل', 'المبرر', 'التكلفة المقدرة', 'الأولوية']}
              />
            </Section>
          ...
          <div style={bodyPad}>
            ...
            <Section title="تقييم الأداء">
              <EmptyTable
                cols={4}
                rows={6}
                headers={['المجال', 'التقييم (1-5)', 'التغير عن السابق', 'ملاحظات']}
              />
            </Section>
    ...
    case 'vocational-skills-assessment':
      return (
        <div style={pageWrapper}>
          <OrgHeader
            title="تقييم المهارات المهنية والحرفية"
            subtitle="Vocational Skills Assessment"
          />
          <div style={bodyPad}>
            <div style={fieldRow}>
              <Field label="المستفيد" value={d.beneficiary} w="25%" />
              <Field label="المجال المهني" value={d.vocationalField} w="20%" />
              <Field label="المقيِّم" value={d.evaluator} w="25%" />
              <Field label="التاريخ" value={formatDate(d.date) || today()} w="15%" />
            </div>
            <Section title="المهارات المهنية">
              <EmptyTable
                cols={4}
                rows={8}
                headers={['المهارة', 'المستوى (1-5)', 'الملاحظة', 'التوصية']}
              />
            </Section>
            <Section title="المهارات العامة في العمل">
              <EmptyTable
                cols={4}
                rows={5}
                headers={['المهارة', 'المستوى', 'ملاحظات', 'أولوية التطوير']}
              />
            </Section>
        ...
        <div style={pageWrapper}>
          ...
          <div style={bodyPad}>
            <div style={fieldRow}>
              <Field label="المستفيد" value={d.beneficiary} w="25%" />
              <Field label="جهة العمل" value={d.employer} w="25%" />
              <Field label="المدرب" value={d.coach} w="25%" />
            </div>
            <Section title="جلسات التدريب">
              <EmptyTable
                cols={6}
                rows={10}
                headers={['التاريخ', 'المدة', 'الهدف', 'الأنشطة', 'التقدم', 'الخطوة التالية']}
              />
            </Section>
            <div style={fieldRow}>
              <Field label="إجمالي الساعات" value={d.totalHours} w="15%" />
              <Field label="التقييم العام" value={d.overallProgress} w="20%" />
            </div>
      ...
      return (
        <div style={pageWrapper}>
          ...
          <div style={bodyPad}>
            <div style={fieldRow}>
              <Field label="جهة العمل" value={d.employer} w="25%" />
              <Field label="المسؤول" value={d.contactPerson} w="25%" />
              <Field label="الموظف (المستفيد)" value={d.employee} w="25%" />
            </div>
            <div style={fieldRow}>
              <Field label="فترة العمل" value={d.workPeriod} w="20%" />
              <Field label="التاريخ" value={formatDate(d.date) || today()} w="15%" />
            </div>
            <Section title="التقييم">
              <EmptyTable
                cols={5}
                rows={8}
                headers={['المعيار', 'ممتاز', 'جيد', 'مقبول', 'ضعيف']}
              />
            </Section>
            <NotesBox label="نقاط القوة" value={d.strengths} lines={2} />
        ...
        <div style={pageWrapper}>
          ...
          <div style={bodyPad}>
            <div style={fieldRow}>
              ...
              <Field label="المقيِّم" value={d.assessor} w="25%" />
              <Field label="التاريخ" value={formatDate(d.date) || today()} w="15%" />
            </div>
            ...
            <NotesBox
              label="التسهيلات الإضافية المطلوبة"
              value={d.accommodationsNeeded}
              lines={2}
            />
            <div style={fieldRow}>
              <Field label="مناسب للتوظيف" value={d.suitableForPlacement} w="20%" />
            </div>
      ...
      return (
        <div style={pageWrapper}>
          ...
          <div style={bodyPad}>
            <div style={fieldRow}>
              <Field
                label="الطرف الأول (المركز)"
                value={d.center || 'مركز الأوائل للتأهيل'}
                w="35%"
              />
              <Field label="الطرف الثاني (جهة العمل)" value={d.employer} w="35%" />
            </div>
            <div style={fieldRow}>
              <Field label="المستفيد" value={d.beneficiary} w="25%" />
              <Field label="المسمى الوظيفي" value={d.jobTitle} w="20%" />
