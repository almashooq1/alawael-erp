...
export const STUDENT_EXTENDED_TEMPLATES = [
  {
    ...
    desc: 'نموذج تسجيل طالب جديد شامل',
    color: '#1565c0',
  },
  {
    id: 'student-withdrawal-form',
    name: 'نموذج انسحاب طالب',
    nameEn: 'Student Withdrawal Form',
    desc: 'نموذج انسحاب وإخلاء طرف',
    color: '#1976d2',
  },
  {
    id: 'student-medical-record',
    name: 'السجل الطبي للطالب',
    nameEn: 'Student Medical Record',
    desc: 'ملف طبي شامل للطالب',
    color: '#c62828',
  },
  {
    id: 'medication-admin-form',
    name: 'نموذج إعطاء الأدوية',
    nameEn: 'Medication Administration',
    desc: 'نموذج إعطاء الأدوية داخل المنشأة',
    color: '#d32f2f',
  },
  {
    id: 'student-incident-report',
    name: 'تقرير حادث طالب',
    nameEn: 'Student Incident Report',
    desc: 'تقرير حادث أو إصابة طالب',
    color: '#e53935',
  },
  {
    id: 'student-absence-letter',
    name: 'خطاب غياب طالب',
    nameEn: 'Student Absence Letter',
    desc: 'خطاب إشعار غياب لولي الأمر',
    color: '#f57c00',
  },
  {
    id: 'student-award-cert',
    name: 'شهادة تكريم طالب',
    nameEn: 'Student Award Certificate',
    desc: 'شهادة تكريم وتميز',
    color: '#ff8f00',
  },
  {
    id: 'student-disciplinary',
    name: 'نموذج إجراء تأديبي',
    nameEn: 'Disciplinary Action Form',
    desc: 'نموذج إجراء تأديبي رسمي',
    color: '#bf360c',
  },
  {
    id: 'bus-permission-form',
    name: 'إذن ركوب الحافلة',
    nameEn: 'Bus Permission Form',
    desc: 'نموذج إذن ولي الأمر لركوب الحافلة',
    color: '#4527a0',
  },
  {
    id: 'pickup-authorization',
    name: 'تفويض استلام طالب',
    nameEn: 'Pickup Authorization',
    desc: 'تفويض شخص لاستلام الطالب',
    color: '#6a1b9a',
  },
  {
    id: 'student-allergy-card',
    name: 'بطاقة حساسية الطالب',
    nameEn: 'Student Allergy Card',
    desc: 'بطاقة الحساسية والتحذيرات الطبية',
    color: '#ad1457',
  },
  {
    id: 'student-daily-report',
    name: 'التقرير اليومي للطالب',
    nameEn: 'Student Daily Report',
    desc: 'تقرير يومي لولي الأمر',
    color: '#00695c',
  },
  {
    id: 'student-photo-consent',
    name: 'إذن تصوير الطالب',
    nameEn: 'Photo Consent Form',
    desc: 'نموذج موافقة ولي الأمر على التصوير',
    color: '#2e7d32',
  },
  {
    id: 'student-activity-reg',
    name: 'تسجيل نشاط طلابي',
    nameEn: 'Student Activity Registration',
    desc: 'نموذج تسجيل في نشاط لامنهجي',
    color: '#0277bd',
  },
  {
    id: 'student-counseling-form',
    name: 'نموذج إرشاد طلابي',
    nameEn: 'Student Counseling Form',
    desc: 'نموذج جلسة إرشاد نفسي/اجتماعي',
    color: '#7b1fa2',
  },
  {
    id: 'student-progress-letter',
    name: 'خطاب تقدم الطالب',
    nameEn: 'Student Progress Letter',
    desc: 'خطاب لولي الأمر عن تقدم الطالب',
    color: '#1e88e5',
  },
];
  ...
  switch (templateId) {
          ...
          <div style={bodyPad}>
            <Section title="بيانات الطالب">
              ...
              <div style={fieldRow}>
                ...
                <Field label="نوع الإعاقة" value={d.disabilityType} w="15%" />
                <Field label="درجتها" value={d.disabilityDegree} w="10%" />
              </div>
            </Section>
            <Section title="بيانات ولي الأمر">
              <div style={fieldRow}>
                <Field label="الاسم" value={d.parentName} w="25%" />
                <Field label="صلة القرابة" value={d.relation} w="12%" />
                <Field label="الهاتف" value={d.phone} w="15%" />
                <Field label="العنوان" value={d.address} w="25%" />
              </div>
            </Section>
    ...
    case 'student-withdrawal-form':
      return (
        <div style={pageWrapper}>
          <OrgHeader
            title="نموذج انسحاب وإخلاء طرف"
            subtitle="Student Withdrawal & Clearance Form"
          />
          <RefDateLine refNo={d.refNo} date={d.date} />
          <div style={bodyPad}>
            <div style={fieldRow}>
              ...
              <Field label="تاريخ الانسحاب" value={formatDate(d.withdrawalDate)} w="15%" />
            </div>
          ...
          <div style={bodyPad}>
            ...
            <Section title="الأدوية المصرح بها">
              <EmptyTable
                cols={6}
                rows={5}
                headers={['الدواء', 'الجرعة', 'الوقت', 'الطريقة', 'المعطي', 'التوقيع']}
              />
            </Section>
        ...
        <div style={pageWrapper}>
          ...
          <div style={bodyPad}>
            ...
            <div style={fieldRow}>
              ...
              <Field label="الشاهد" value={d.witness} w="20%" />
            </div>
            ...
            <div style={fieldRow}>
              <Field label="تم إبلاغ ولي الأمر" value={d.parentNotified} w="15%" />
              <Field label="الوقت" value={d.notificationTime} w="10%" />
            </div>
      ...
      return (
        <div style={pageWrapper}>
          ...
          <div style={bodyPad}>
            <NotesBox
              label=""
              value={`ولي أمر الطالب / ${d.student || '........................'}`}
              lines={0}
            />
            <NotesBox label="" value="السلام عليكم ورحمة الله وبركاته" lines={0} />
            <NotesBox
              label=""
              value={`نفيدكم بأن ابنكم/ابنتكم قد تغيب عن المنشأة بدون عذر خلال الفترة التالية:`}
              lines={0}
            />
            ...
            <div style={fieldRow}>
              <Field label="إجمالي أيام الغياب" value={d.totalDays} w="15%" />
            </div>
            <NotesBox
              label="نأمل التكرم بمراجعة المنشأة أو التواصل مع الإدارة."
              value=""
              lines={0}
            />
        ...
        <div style={pageWrapper}>
          ...
          <div style={bodyPad}>
            <div style={{ textAlign: 'center', padding: '30px 20px' }}>
              <NotesBox
                label=""
                value="يسر مركز الأوائل للتأهيل أن يمنح شهادة تكريم إلى:"
                lines={0}
              />
      ...
      return (
        <div style={pageWrapper}>
          ...
          <div style={bodyPad}>
            ...
            <div style={fieldRow}>
              <Field label="مستوى المخالفة" value={d.level} w="15%" />
              <Field label="التكرار" value={d.occurrence} w="12%" />
            </div>
        ...
        <div style={pageWrapper}>
          ...
          <div style={bodyPad}>
            <div style={fieldRow}>
              <Field label="الطالب" value={d.student} w="25%" />
              <Field label="الصف" value={d.grade} w="10%" />
              <Field label="خط السير" value={d.route} w="20%" />
            </div>
            <div style={fieldRow}>
            ...
            <NotesBox
              label="أقرّ أنا الموقع أدناه بالموافقة على ركوب ابني/ابنتي الحافلة المدرسية والالتزام بتعليمات السلامة."
              value=""
              lines={0}
            />
            <NotesBox
              label="ملاحظات خاصة (حالات صحية، حساسية، إلخ)"
              value={d.specialNotes}
              lines={2}
            />
          ...
          <div style={bodyPad}>
            ...
            <Section title="الأشخاص المفوضون بالاستلام">
              <EmptyTable
                cols={5}
                rows={5}
                headers={['الاسم', 'صلة القرابة', 'رقم الهوية', 'الهاتف', 'التوقيع']}
              />
            </Section>
            <NotesBox
              label="أقرّ أنا ولي الأمر بتفويض الأشخاص المذكورين أعلاه فقط باستلام ابني/ابنتي."
              value=""
              lines={0}
            />
            <SignatureBlock rightLabel="ولي الأمر" leftLabel="مدير المنشأة" />
            ...
            >
              ...
              <Section title="أنواع الحساسية">
                <EmptyTable
                  cols={4}
                  rows={4}
                  headers={['نوع الحساسية', 'المادة المسببة', 'شدة التفاعل', 'الإجراء الطارئ']}
                />
              </Section>
              <NotesBox label="الأدوية الطارئة" value={d.emergencyMeds} lines={1} />
              <div style={fieldRow}>
                <Field label="طبيب الطالب" value={d.doctor} w="25%" />
                <Field label="هاتف الطوارئ" value={d.emergencyPhone} w="15%" />
              </div>
            </div>
        ...
        <div style={pageWrapper}>
          ...
          <div style={bodyPad}>
            <div style={fieldRow}>
              <Field label="الطالب" value={d.student} w="25%" />
              <Field label="الصف" value={d.grade} w="10%" />
              <Field label="اليوم" value={d.day} w="12%" />
              <Field label="التاريخ" value={formatDate(d.date) || today()} w="15%" />
            </div>
            <Section title="التقييم اليومي">
              <EmptyTable
                cols={5}
                rows={6}
                headers={['النشاط', 'ممتاز', 'جيد', 'يحتاج تحسين', 'ملاحظات']}
              />
            </Section>
      ...
      return (
        <div style={pageWrapper}>
          ...
          <div style={bodyPad}>
            ...
            <NotesBox
              label=""
              value="أقرّ أنا الموقع أدناه بالموافقة / عدم الموافقة على تصوير ابني/ابنتي واستخدام الصور في:"
              lines={0}
            />
    ...
    case 'student-activity-reg':
      return (
        <div style={pageWrapper}>
          <OrgHeader
            title="نموذج تسجيل في نشاط لامنهجي"
            subtitle="Extracurricular Activity Registration"
          />
          <div style={bodyPad}>
            <div style={fieldRow}>
              <Field label="الطالب" value={d.student} w="25%" />
              <Field label="الصف" value={d.grade} w="10%" />
              <Field label="النشاط" value={d.activity} w="20%" />
            </div>
            <div style={fieldRow}>
              <Field label="المشرف" value={d.supervisor} w="25%" />
              <Field label="الأيام" value={d.days} w="15%" />
              <Field label="الوقت" value={d.time} w="12%" />
            </div>
            <NotesBox label="أهداف النشاط" value={d.objectives} lines={2} />
            <NotesBox
              label="موافقة ولي الأمر: أوافق على مشاركة ابني/ابنتي في النشاط المذكور أعلاه."
              value=""
              lines={0}
            />
      ...
      return (
        <div style={pageWrapper}>
          ...
          <div style={bodyPad}>
            <div style={fieldRow}>
              <Field label="الطالب" value={d.student} w="25%" />
              <Field label="المرشد" value={d.counselor} w="25%" />
              <Field label="التاريخ" value={formatDate(d.date) || today()} w="15%" />
              <Field label="الجلسة رقم" value={d.sessionNo} w="10%" />
            </div>
            <div style={fieldRow}>
              <Field label="نوع الإرشاد" value={d.type} w="15%" />
            ...
            <div style={fieldRow}>
              <Field label="الجلسة القادمة" value={formatDate(d.nextSession)} w="15%" />
            </div>
      ...
      return (
        <div style={pageWrapper}>
          ...
          <div style={bodyPad}>
            <NotesBox
              label=""
              value={`ولي أمر الطالب / ${d.student || '........................'} — حفظه الله`}
              lines={0}
            />
            <NotesBox label="" value="السلام عليكم ورحمة الله وبركاته" lines={0} />
            <NotesBox
              label=""
              value="يسعدنا إفادتكم بتقدم ابنكم/ابنتكم خلال الفترة الماضية:"
              lines={0}
            />
