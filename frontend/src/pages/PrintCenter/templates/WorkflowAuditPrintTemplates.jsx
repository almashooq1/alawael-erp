...
export const WORKFLOW_AUDIT_TEMPLATES = [
  /* ── سير العمل ── */
  {
    id: 'workflow-request',
    name: 'طلب سير عمل',
    nameEn: 'Workflow Request',
    desc: 'نموذج طلب موافقة إلكتروني',
    color: '#6a1b9a',
  },
  {
    id: 'workflow-approval-log',
    name: 'سجل الموافقات',
    nameEn: 'Approval Log',
    desc: 'سجل الموافقات الإلكترونية',
    color: '#7b1fa2',
  },
  {
    id: 'delegation-authority',
    name: 'تفويض صلاحية',
    nameEn: 'Delegation of Authority',
    desc: 'نموذج تفويض الصلاحيات',
    color: '#8e24aa',
  },
  /* ── التدقيق الداخلي ── */
  {
    id: 'audit-plan',
    name: 'خطة تدقيق داخلي',
    nameEn: 'Internal Audit Plan',
    desc: 'خطة التدقيق الداخلي',
    color: '#4a148c',
  },
  {
    id: 'audit-report',
  ...
  },
  {
    ...
    desc: 'نموذج ملاحظة مراجعة',
    color: '#6a3ea1',
  },
  {
    id: 'corrective-action-req',
    name: 'طلب إجراء تصحيحي',
    nameEn: 'Corrective Action Request',
    desc: 'نموذج الإجراء التصحيحي',
    color: '#7e57c2',
  },
  {
    id: 'management-review',
    name: 'محضر مراجعة إدارية',
    nameEn: 'Management Review',
    desc: 'محضر اجتماع المراجعة الإدارية',
    color: '#9575cd',
  },
  {
    id: 'audit-checklist',
    name: 'قائمة فحص التدقيق',
    nameEn: 'Audit Checklist',
    desc: 'قائمة فحص للتدقيق الداخلي',
    color: '#512da8',
  },
  /* ── التوقيع الإلكتروني والوثائق ── */
  {
    id: 'esign-certificate',
    name: 'شهادة توقيع إلكتروني',
    nameEn: 'E-Sign Certificate',
    desc: 'شهادة التوقيع الإلكتروني',
    color: '#00695c',
  },
  {
    id: 'document-control-log',
    name: 'سجل ضبط الوثائق',
    nameEn: 'Document Control Log',
    desc: 'سجل ضبط الوثائق',
    color: '#00796b',
  },
  {
    id: 'document-change-notice',
    name: 'إشعار تغيير وثيقة',
    nameEn: 'Document Change Notice',
    desc: 'إشعار تعديل الوثيقة',
    color: '#00897b',
  },
  {
    id: 'document-review-form',
    name: 'نموذج مراجعة وثيقة',
    nameEn: 'Document Review Form',
    desc: 'نموذج مراجعة واعتماد الوثائق',
    color: '#009688',
  },
  {
    id: 'archive-request',
    ...
    desc: 'طلب أرشفة وثائق',
    color: '#26a69a',
  },
  {
    id: 'document-destruction',
    name: 'محضر إتلاف وثائق',
    nameEn: 'Document Destruction',
    desc: 'محضر إتلاف وثائق منتهية',
    color: '#4db6ac',
  },
  {
    id: 'sop-template',
    name: 'نموذج إجراء عمل',
    nameEn: 'SOP Template',
    desc: 'نموذج إجراء تشغيل موحد SOP',
    color: '#00bfa5',
  },
  {
    id: 'policy-approval',
    ...
    desc: 'نموذج اعتماد السياسات',
    color: '#1de9b6',
  },
  {
    id: 'compliance-checklist',
    name: 'قائمة فحص الامتثال',
    nameEn: 'Compliance Checklist',
    desc: 'قائمة فحص الالتزام والامتثال',
    color: '#64ffda',
  },
];
    ...
    case 'workflow-request':
      return (
        <div style={pageWrapper}>
          ...
          <div style={bodyPad}>
            <div style={fieldRow}>
              <Field label="مقدم الطلب" value={d.requester} w="30%" />
              <Field label="القسم" value={d.department} w="25%" />
              <Field label="نوع الطلب" value={d.requestType} w="25%" />
            ...
            <Section title="مسار الموافقة">
              <EmptyTable
                cols={5}
                rows={5}
                headers={['المرحلة', 'المعتمد', 'الحالة', 'التاريخ', 'ملاحظات']}
              />
            </Section>
        ...
        <div style={pageWrapper}>
          ...
          <div style={bodyPad}>
            <Section title="المفوِّض">
              <div style={fieldRow}>
                <Field label="الاسم" value={d.delegatorName} w="35%" />
                <Field label="المنصب" value={d.delegatorTitle} w="30%" />
                <Field label="القسم" value={d.delegatorDept} w="25%" />
              </div>
            </Section>
            <Section title="المفوَّض إليه">
              <div style={fieldRow}>
                <Field label="الاسم" value={d.delegateeName} w="35%" />
                <Field label="المنصب" value={d.delegateeTitle} w="30%" />
                <Field label="القسم" value={d.delegateeDept} w="25%" />
              </div>
            </Section>
            ...
            <div style={fieldRow}>
              ...
              <Field label="السبب" value={d.reason} w="40%" />
            </div>
    ...
    case 'audit-plan':
      return (
        <div style={pageWrapper}>
          ...
          <div style={bodyPad}>
            <div style={fieldRow}>
              <Field label="سنة التدقيق" value={d.auditYear} w="20%" />
              <Field label="المدقق الرئيسي" value={d.leadAuditor} w="30%" />
              <Field label="الفترة" value={d.period} w="25%" />
            </div>
    ...
    case 'audit-report':
      return (
        <div style={pageWrapper}>
          ...
          <div style={bodyPad}>
            <div style={fieldRow}>
              <Field label="القسم المدقق" value={d.auditedDept} w="30%" />
              <Field label="المدقق" value={d.auditor} w="25%" />
            ...
            <Section title="نتائج التدقيق">
              <EmptyTable
                cols={5}
                rows={8}
                headers={['الملاحظة', 'المخاطرة', 'الأولوية', 'التوصية', 'رد الإدارة']}
              />
            </Section>
    ...
    case 'audit-finding':
      return (
        <div style={pageWrapper}>
          ...
          <div style={bodyPad}>
            <div style={fieldRow}>
              <Field label="رقم الملاحظة" value={d.findingNo} w="15%" />
              <Field label="التدقيق" value={d.auditRef} w="25%" />
              <Field label="القسم" value={d.department} w="20%" />
              <Field label="الأولوية" value={d.priority} w="15%" />
              <Field label="النوع" value={d.findingType} w="15%" />
            </div>
            ...
            <div style={fieldRow}>
              <Field label="الموعد المستهدف" value={formatDate(d.targetDate)} w="25%" />
    ...
    case 'corrective-action-req':
      return (
        <div style={pageWrapper}>
          ...
          <div style={bodyPad}>
            <div style={fieldRow}>
              <Field label="رقم CAR" value={d.carNo} w="15%" />
              <Field label="المصدر" value={d.source} w="20%" />
              <Field label="القسم" value={d.department} w="20%" />
              <Field label="الأولوية" value={d.priority} w="15%" />
            ...
            <Section title="خطة الإجراءات التصحيحية">
              <EmptyTable
                cols={5}
                rows={5}
                headers={['الإجراء', 'المسؤول', 'الموعد', 'الحالة', 'ملاحظات']}
              />
            </Section>
        ...
        <div style={pageWrapper}>
          ...
          <div style={bodyPad}>
            <div style={fieldRow}>
              ...
              <Field label="الحضور" value={d.attendeesCount} w="15%" />
            </div>
            ...
            <Section title="القرارات والتوصيات">
              <EmptyTable
                cols={4}
                rows={6}
                headers={['القرار/التوصية', 'المسؤول', 'الموعد', 'ملاحظات']}
              />
            </Section>
      ...
      return (
        <div style={pageWrapper}>
          ...
          <div style={bodyPad}>
            <div style={fieldRow}>
              <Field label="القسم" value={d.department} w="25%" />
              <Field label="المعيار" value={d.standard} w="25%" />
              <Field label="المدقق" value={d.auditor} w="25%" />
              <Field label="التاريخ" value={formatDate(d.date) || today()} w="20%" />
            </div>
            <Section title="بنود الفحص">
              <EmptyTable
                cols={5}
                rows={15}
                headers={['م', 'البند/السؤال', 'مطابق', 'غير مطابق', 'ملاحظات']}
              />
            </Section>
            <div style={fieldRow}>
              <Field label="نسبة المطابقة" value={d.complianceRate} w="25%" />
              <Field label="التقييم العام" value={d.overallRating} w="25%" />
            </div>
            <SignatureBlock rightLabel="المدقق" leftLabel="مدير القسم" />
          </div>
          <OrgFooter />
      ...
      return (
        <div style={pageWrapper}>
          ...
          <div style={bodyPad}>
            ...
            >
              <div style={{ fontSize: 16, fontWeight: 700, color: '#00695c', marginBottom: 12 }}>
                شهادة توثيق التوقيع الإلكتروني
              </div>
              <div style={fieldRow}>
                <Field label="الموقِّع" value={d.signerName} w="35%" />
                <Field label="المنصب" value={d.signerTitle} w="30%" />
                <Field label="القسم" value={d.department} w="25%" />
              </div>
              <div style={fieldRow}>
                <Field label="المستند" value={d.documentTitle} w="40%" />
                <Field label="رقم المستند" value={d.documentNo} w="20%" />
                <Field label="تاريخ التوقيع" value={formatDate(d.signDate) || today()} w="20%" />
              </div>
              <div style={fieldRow}>
                <Field label="رمز التحقق" value={d.verificationCode} w="30%" />
                <Field label="خوارزمية التشفير" value={d.algorithm || 'SHA-256'} w="25%" />
                <Field label="الحالة" value={d.status || 'صالح'} w="15%" />
              </div>
            </div>
            <div style={{ fontSize: 10, textAlign: 'center', color: '#666', marginTop: 12 }}>
              هذه الشهادة تثبت أن التوقيع الإلكتروني أعلاه صادر من صاحبه وهو توقيع معتمد وفقاً
              لسياسة التوقيع الإلكتروني المعمول بها.
            </div>
          </div>
          <OrgFooter />
        </div>
        ...
        <div style={pageWrapper}>
          ...
          <div style={bodyPad}>
            <div style={fieldRow}>
              <Field label="القسم" value={d.department} w="25%" />
              <Field label="الفترة" value={d.period} w="25%" />
              <Field label="المسؤول" value={d.controller} w="25%" />
            </div>
    ...
    case 'document-change-notice':
      return (
        <div style={pageWrapper}>
          ...
          <div style={bodyPad}>
            <div style={fieldRow}>
              <Field label="رمز الوثيقة" value={d.docCode} w="20%" />
              <Field label="عنوان الوثيقة" value={d.docTitle} w="40%" />
              <Field label="الإصدار الحالي" value={d.currentVersion} w="15%" />
              <Field label="الإصدار الجديد" value={d.newVersion} w="15%" />
            </div>
            ...
            <div style={fieldRow}>
              ...
              <Field label="تاريخ الإعداد" value={formatDate(d.date) || today()} w="25%" />
            </div>
      ...
      return (
        <div style={pageWrapper}>
          ...
          <div style={bodyPad}>
            <div style={fieldRow}>
              <Field label="رمز الوثيقة" value={d.docCode} w="20%" />
              <Field label="العنوان" value={d.docTitle} w="40%" />
            ...
            <Section title="مراحل المراجعة">
              <EmptyTable
                cols={5}
                rows={5}
                headers={['المرحلة', 'المراجع', 'النتيجة', 'التاريخ', 'ملاحظات']}
              />
            </Section>
          ...
          <div style={bodyPad}>
            ...
            <Section title="الوثائق المطلوب أرشفتها">
              <EmptyTable
                cols={5}
                rows={8}
                headers={['رمز الوثيقة', 'العنوان', 'النوع', 'فترة الحفظ', 'ملاحظات']}
              />
            </Section>
      ...
      return (
        <div style={pageWrapper}>
          ...
          <div style={bodyPad}>
            <div style={fieldRow}>
              <Field label="التاريخ" value={formatDate(d.date) || today()} w="20%" />
              <Field label="اللجنة" value={d.committee} w="40%" />
              <Field label="طريقة الإتلاف" value={d.method} w="25%" />
            </div>
            <Section title="الوثائق المتلفة">
              <EmptyTable
                cols={5}
                rows={8}
                headers={['رمز الوثيقة', 'العنوان', 'فترة الحفظ', 'سبب الإتلاف', 'ملاحظات']}
              />
            </Section>
    ...
    case 'sop-template':
      return (
        <div style={pageWrapper}>
          ...
          <div style={bodyPad}>
            <div style={fieldRow}>
              <Field label="رقم SOP" value={d.sopNo} w="15%" />
              <Field label="العنوان" value={d.title} w="40%" />
              <Field label="الإصدار" value={d.version} w="10%" />
              <Field label="القسم" value={d.department} w="20%" />
            </div>
            <div style={fieldRow}>
              <Field label="المعد" value={d.preparedBy} w="25%" />
              <Field label="المراجع" value={d.reviewedBy} w="25%" />
              <Field label="المعتمد" value={d.approvedBy} w="25%" />
              <Field label="تاريخ السريان" value={formatDate(d.effectiveDate)} w="20%" />
            </div>
    ...
    case 'policy-approval':
      return (
        <div style={pageWrapper}>
          ...
          <div style={bodyPad}>
            <div style={fieldRow}>
              <Field label="السياسة" value={d.policyTitle} w="40%" />
              <Field label="الرقم" value={d.policyNo} w="15%" />
              <Field label="الإصدار" value={d.version} w="10%" />
              <Field label="القسم" value={d.department} w="20%" />
            </div>
            ...
            <Section title="مراحل الاعتماد">
              <EmptyTable
                cols={5}
                rows={4}
                headers={['المرحلة', 'المسؤول', 'القرار', 'التاريخ', 'ملاحظات']}
              />
            </Section>
            <div style={fieldRow}>
              <Field label="تاريخ السريان" value={formatDate(d.effectiveDate)} w="25%" />
              <Field label="تاريخ المراجعة القادمة" value={formatDate(d.nextReviewDate)} w="25%" />
            </div>
      ...
      return (
        <div style={pageWrapper}>
          ...
          <div style={bodyPad}>
            <div style={fieldRow}>
              <Field label="القسم" value={d.department} w="25%" />
              <Field label="المعيار/اللائحة" value={d.standard} w="35%" />
            ...
            <Section title="بنود الامتثال">
              <EmptyTable
                cols={5}
                rows={15}
                headers={['م', 'متطلب الامتثال', 'ملتزم', 'غير ملتزم', 'الإجراء المطلوب']}
              />
            </Section>
            <div style={fieldRow}>
              <Field label="نسبة الامتثال" value={d.complianceRate} w="20%" />
              <Field label="التقييم" value={d.rating} w="20%" />
            </div>
