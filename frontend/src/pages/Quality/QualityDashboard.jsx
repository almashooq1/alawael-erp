...
export default function QualityDashboard() {
    ...
    apiClient
      ...
      .catch(() => {
        setData({
          ...
          openFindings: 12,
          byCategory: [
            { category: 'معايير CBAHI', count: 18 },
            { category: 'ISO 9001', count: 12 },
            { category: 'معايير داخلية', count: 10 },
            { category: 'سلامة مرضى', count: 8 },
          ],
          complianceByDept: [
            { department: 'الإدارة', rate: 92 },
            { department: 'التأهيل', rate: 88 },
            { department: 'التعليم', rate: 85 },
            { department: 'تقنية المعلومات', rate: 90 },
            { department: 'المالية', rate: 82 },
            { department: 'الخدمات', rate: 78 },
          ],
          recentAudits: [
            {
              auditNumber: 'AUD-2026-015',
              area: 'التأهيل الطبي',
              date: '2026-03-10',
              findings: 3,
              status: 'in_progress',
  ...
  const deptCompliance = (data.complianceByDept || []).map(d => ({
    name: d.department,
    rate: d.rate,
  }));
          ...
          >
            <Box>
              ...
              <Typography variant="body2" color="text.secondary">
                مراقبة المعايير ونسب الامتثال والتدقيقات
              </Typography>
            </Box>
            <Chip
              ...
              sx={{
                bgcolor:
                  data.complianceRate >= 85 ? 'rgba(16,185,129,0.1)' : 'rgba(245,158,11,0.1)',
            ...
            <div>
              <Glass sx={{ p: 3, height: '100%' }}>
                ...
                >
                  ...
                  <Chip
                    label={`${categoryData.length} فئات`}
                    size="small"
                    variant="outlined"
                      ...
                      <LinearProgress
                        ...
                        sx={{
                          ...
                          '& .MuiLinearProgress-bar': {
                            borderRadius: 3,
                            background: deptGradients[idx % deptGradients.length],
                          },
                        }}
                      />
                    </Box>
        ...
        <div>
          <Glass sx={{ p: 3, overflow: 'hidden' }}>
            ...
            >
              ...
              <Chip
                label={`${(data.recentAudits || []).length} تدقيق`}
                size="small"
                variant="outlined"
                sx={{ borderRadius: '8px', fontWeight: 500 }}
              />
              ...
              >
                ...
                <TableBody>
                  {(data.recentAudits || []).slice(0, 8).map((a, i) => (
                    <TableRow
                      key={i}
                      sx={{ transition: 'all 0.2s', '&:hover': { bgcolor: 'rgba(0,0,0,0.02)' } }}
                    >
                      ...
                      <TableCell>
                        <Chip
                          ...
                          sx={{
                            bgcolor:
                              a.findings >= 3 ? 'rgba(239,68,68,0.1)' : 'rgba(245,158,11,0.1)',
                            color: a.findings >= 3 ? '#DC2626' : '#D97706',
                            fontWeight: 700,
                            borderRadius: '8px',
                            height: 24,
                            minWidth: 32,
