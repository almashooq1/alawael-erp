...
const KPI_CARDS = [
  ...
  {
    label: 'معدل التحسّن العام',
    value: '٨٤٪',
    sub: '+٦٪ عن الربع الماضي',
    icon: TrendingUpIcon,
    color: '#6366f1',
  },
  {
    label: 'برنامج تأهيلي نشط',
    value: '١٨',
    sub: '٥ أضيفت حديثاً',
                ...
                <Box sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>
                  ...
                  <Box sx={{ flex: 1, minWidth: 0 }}>
                    ...
                    <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
                      ...
                      />
                      <Typography
                        sx={{ fontSize: '0.72rem', fontWeight: 700, color: p.color, minWidth: 30 }}
                      >
                        {p.progress}٪
                      </Typography>
                    </Box>
