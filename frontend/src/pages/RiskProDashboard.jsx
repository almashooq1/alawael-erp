...
const riskRegister = [
  {
    id: 'RSK-034',
    title: 'تعطل نظام المعلومات الصحي',
    category: 'تقنية',
    level: 'حرج',
    owner: 'م. سامي',
    status: 'قيد المعالجة',
  ...
  {
    id: 'RSK-031',
    title: 'عدم الامتثال لمعايير CBAHI',
    category: 'تنظيمية',
    level: 'حرج',
    owner: 'أ. ريم',
    status: 'مفتوح',
  ...
  {
    id: 'RSK-030',
    title: 'تجاوز الميزانية التشغيلية',
    category: 'مالية',
    level: 'متوسط',
    owner: 'أ. عبدالله',
    status: 'مغلق',
...
const statusColor = s => (s === 'مغلق' ? '#22c55e' : s === 'قيد المعالجة' ? '#f59e0b' : '#ef4444');
        ...
        <Card elevation={0} sx={{ ...glass(isDark), p: 2.5 }}>
          ...
          <TableContainer>
            <Table size="small">
              <TableHead>
                <TableRow>
                  {['الرمز', 'الوصف', 'التصنيف', 'المستوى', 'المسؤول', 'الحالة', 'الموعد'].map(
                    h => (
                      <TableCell
                        key={h}
              ...
              <TableBody>
                {riskRegister.map(r => (
                  ...
                  >
                    ...
                    <TableCell sx={{ border: 'none' }}>
                      <Chip
                        ...
                        sx={{
                          ...
                          fontSize: '0.62rem',
                          fontWeight: 600,
                          backgroundColor: `${levelColor(r.level)}22`,
                    ...
                    <TableCell sx={{ fontSize: '0.72rem', color: sub, border: 'none' }}>
                      {r.dueDate}
                    </TableCell>
                  </TableRow>
                ))}
