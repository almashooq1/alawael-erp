...
const SCALE_CATALOG = [
  {
    id: 'mchat',
    name: 'M-CHAT-R/F',
    nameAr: 'قائمة التحقق المعدلة للتوحد',
    icon: <ChildIcon />,
    color: '#e91e63',
    ageRange: '16-30 شهر',
  ...
  },
  {
    id: 'cars2',
    name: 'CARS-2',
    nameAr: 'مقياس تقدير التوحد الطفولي',
    icon: <PsychologyIcon />,
    color: '#9c27b0',
    ageRange: '2+ سنة',
  ...
  },
  {
    id: 'srs2',
    name: 'SRS-2',
    nameAr: 'مقياس الاستجابة الاجتماعية',
    icon: <FamilyIcon />,
    color: '#673ab7',
    ageRange: '2.5-18 سنة',
  ...
  },
  {
    id: 'brief2',
    name: 'BRIEF-2',
    nameAr: 'تقييم الوظائف التنفيذية',
    icon: <ScienceIcon />,
    color: '#00bcd4',
    ageRange: '5-18 سنة',
  ...
  },
  {
    id: 'caregiver-burden',
    name: 'Zarit Burden',
    nameAr: 'عبء مقدم الرعاية',
    icon: <FamilyIcon />,
    color: '#f44336',
    ageRange: 'مقدم الرعاية',
  ...
  {
    id: 'saudi-screening',
    name: 'Saudi Dev Screen',
    nameAr: 'الفحص النمائي السعودي',
...
export default function SmartAssessmentDashboard() {
  ...
  const [_recentAssessments, setRecentAssessments] = useState([]);
  ...
  const fetchManageList = useCallback(
    async (type, page = 1) => {
      setLoading(true);
      setError(null);
      try {
    ...
    <Container maxWidth="xl" sx={{ py: 3 }}>
      ...
      <Box sx={{ display: 'flex', alignItems: 'center', gap: 2, mb: 3 }}>
        ...
        <Box>
          ...
          <Typography variant="body2" color="text.secondary">
            Smart Clinical Assessment Engine — تصحيح تلقائي | دعم القرار | تحليل إحصائي | بروتوكولات
            مبنية على الأدلة
          </Typography>
        </Box>
      </Box>
      ...
      <TabPanel value={tabIndex} index={0}>
        ...
        <Grid container spacing={2} sx={{ mb: 3 }}>
          {[
            ...
            {
              label: 'هذا الشهر',
              value: overviewStats?.thisMonth ?? '—',
              icon: <TrendingUpIcon />,
              color: '#2e7d32',
            },
            {
              label: 'هذا الأسبوع',
              value: overviewStats?.thisWeek ?? '—',
              icon: <SmartIcon />,
              color: '#7b1fa2',
            },
            {
              label: 'عدد المقاييس',
              value: SCALE_CATALOG.length,
              icon: <ScienceIcon />,
              color: '#0288d1',
            },
          ].map((kpi, i) => (
        ...
        <Paper sx={{ p: 2, mb: 3 }}>
          ...
          <Alert severity="error" sx={{ mb: 1 }}>
            <strong>أحمد محمد (5 سنوات)</strong> — انخفاض 2 انحراف معياري في مقياس Vineland-3 خلال
            آخر 3 أشهر. يُنصح بمراجعة الخطة العلاجية فوراً.
          </Alert>
          <Alert severity="warning" sx={{ mb: 1 }}>
            <strong>سارة أحمد (3 سنوات)</strong> — M-CHAT-R/F: خطر مرتفع (8/20 بنود فاشلة). يُنصح
            بإحالة لتقييم تشخيصي شامل.
          </Alert>
          <Alert severity="info">
            <strong>خالد عبدالله (7 سنوات)</strong> — لم يُجرَ تقييم دوري منذ 6 أشهر. يُنصح بإعادة
            التقييم.
          </Alert>
        </Paper>
        ...
        <Paper sx={{ p: 2 }}>
          ...
          <TableContainer>
            <Table size="small">
              <TableHead>
                <TableRow sx={{ backgroundColor: '#f5f5f5' }}>
                  ...
                  <TableCell align="center">
                    <strong>عدد التطبيقات</strong>
                  </TableCell>
                  <TableCell align="center">
                    <strong>الشهر الحالي</strong>
                  </TableCell>
                  <TableCell align="center">
                    <strong>متوسط الدرجة</strong>
                  </TableCell>
                  <TableCell align="center">
              ...
              <TableBody>
                {SCALE_CATALOG.slice(0, 8).map((scale, _i) => (
              ...
              <Grid item xs={12} md={6}>
                <Paper sx={{ p: 3, borderTop: `3px solid ${selectedScale.color}` }}>
                  ...
                  <TextField
                    ...
                    sx={{ mb: 2 }}
                    onChange={e =>
                      setAssessmentForm(p => ({ ...p, age_months: parseInt(e.target.value) }))
                    }
                  />
                    ...
                    <Box>
                      ...
                      {[
                        ...
                        <Box key={i} sx={{ display: 'flex', alignItems: 'center', gap: 1, mb: 1 }}>
                          <Typography variant="body2" sx={{ minWidth: 180, textAlign: 'right' }}>
                            {dim}
                          </Typography>
                          <Rating
                            max={4}
                  ...
                  {!['mchat', 'cars2'].includes(selectedScale.id) && (
                    <Box>
                      ...
                      {selectedScale.id === 'caregiver-burden' && (
                        <Box>
                          <Typography variant="subtitle2" gutterBottom color="primary">
                            مقياس زاريت لعبء مقدم الرعاية (0=أبداً، 1=نادراً، 2=أحياناً، 3=كثيراً،
                            4=دائماً):
                          </Typography>
                          {[
                            ...
                            >
                              ...
                              <Typography variant="caption" color="text.secondary" sx={{ ml: 1 }}>
                                {
                                  ['أبداً', 'نادراً', 'أحياناً', 'كثيراً', 'دائماً'][
                                    (assessmentForm.items || {})[`item_${i + 1}`] || 0
                                  ]
                                }
                              </Typography>
                            </Box>
                      ...
                      {selectedScale.id === 'srs2' && (
                        <Box>
                          <Typography variant="subtitle2" gutterBottom color="primary">
                            مقياس الاستجابة الاجتماعية SRS-2 (1=غير صحيح، 2=صحيح أحياناً، 3=صحيح
                            غالباً، 4=صحيح دائماً):
                          </Typography>
                          {[
                            ...
                            <Box
                              ...
                              sx={{
                                mb: 1,
                                p: 1,
                                backgroundColor: i % 2 === 0 ? '#f3e5f5' : '#fff',
                                borderRadius: 1,
                              }}
                            >
                      ...
                      {selectedScale.id === 'portage' && (
                        <Box>
                          ...
                          {[
                            {
                              domain: 'التنشئة الاجتماعية',
                              items: [
                                'يبتسم استجابة لوجوه مألوفة',
                                'يلعب بجانب أقرانه',
                                'يشارك ألعابه مع الآخرين',
                                'يتبع قواعد اللعب الجماعي',
                                'يعبّر عن مشاعره لفظياً',
                              ],
                            },
                            {
                              domain: 'اللغة',
                              items: [
                                'يستجيب لاسمه',
                                'يقول كلمات مفردة',
                                'يستخدم جمل من كلمتين',
                                'يصف الصور',
                                'يروي قصة بسيطة',
                              ],
                            },
                            {
                              domain: 'المساعدة الذاتية',
                              items: [
                                'يأكل بالملعقة بمساعدة',
                                'يشرب من الكوب',
                                'يخلع ملابسه',
                                'يغسل يديه',
                                'يستخدم المرحاض',
                      ...
                      {selectedScale.id === 'sensory-profile' && (
                        <Box>
                          <Typography variant="subtitle2" gutterBottom color="primary">
                            الملف الحسي (Sensory Profile 2) — تكرار السلوك (1=أبداً، 2=نادراً،
                            3=أحياناً، 4=كثيراً، 5=دائماً):
                          </Typography>
                          <FormControl fullWidth sx={{ mb: 2 }}>
                            ...
                            <Select
                              ...
                              label="نوع النموذج"
                              onChange={e =>
                                setAssessmentForm(p => ({ ...p, form_type: e.target.value }))
                              }
                            >
                          ...
                          {[
                            ...
                            {
                              section: 'المعالجة الحركية/الدهليزية',
                              items: [
                                ...
                                {section.items.map((item, ii) => (
                                  <Box
                                    ...
                                    sx={{
                                      mb: 1.5,
                                      p: 1,
                                      backgroundColor: ii % 2 === 0 ? '#e3f2fd' : '#fff',
                                      borderRadius: 1,
                                    }}
                                  >
                                    <Typography variant="body2" sx={{ mb: 0.5 }}>
                      ...
                      {selectedScale.id === 'transition' && (
                        <Box>
                          <Typography variant="subtitle2" gutterBottom color="primary">
                            تقييم جاهزية الانتقال — قيّم كل مهارة (1=غير مكتسبة، 2=جزئياً،
                            3=بمساعدة، 4=مستقلة):
                          </Typography>
                          <FormControl fullWidth sx={{ mb: 2 }}>
                            ...
                            <Select
                              ...
                              label="نوع الانتقال"
                              onChange={e =>
                                setAssessmentForm(p => ({ ...p, transition_type: e.target.value }))
                              }
                            >
                              <MenuItem value="school">
                                الانتقال المدرسي (حضانة → روضة → ابتدائي)
                              </MenuItem>
                              <MenuItem value="vocational">الانتقال المهني (مدرسة → عمل)</MenuItem>
                              <MenuItem value="community">
                                الانتقال المجتمعي (مركز → مجتمع)
                              </MenuItem>
                          ...
                          {[
                            {
                              domain: 'الاستقلالية الشخصية',
                              items: [
                                'العناية بالنظافة الشخصية',
                                'إعداد وجبات بسيطة',
                                'إدارة الأدوية',
                                'التنقل باستخدام المواصلات',
                                'إدارة المال الشخصي',
                              ],
                            },
                            {
                              ...
                              items: [
                                'بدء المحادثة مع الغير',
                                'حل النزاعات بسلام',
                                'التعبير عن الاحتياجات',
                                'المشاركة في أنشطة جماعية',
                                'فهم الأعراف الاجتماعية',
                              ],
                            },
                            {
                              domain: 'المهارات المهنية/الأكاديمية',
                              items: [
                                'الالتزام بالمواعيد',
                                'اتباع التعليمات',
                                'إنجاز المهام دون إشراف',
                                'استخدام التكنولوجيا الأساسية',
                                'طلب المساعدة عند الحاجة',
                              ],
                            },
                            {
                              domain: 'السلامة والصحة',
                              items: [
                                'التعرف على المخاطر',
                                'الاتصال بالطوارئ',
                                'فهم الأدوية وآثارها',
                          ...
                          {[
                            {
                              ageGroup: '0-3 أشهر',
                              items: [
                                'يتتبع الضوء أو الوجه بصرياً',
                                'يبتسم عند مداعبته',
                                'يرفع رأسه عند وضعه على بطنه',
                                'يصدر أصوات مناغاة',
                              ],
                            },
                            {
                            ...
                            },
                            {
                              ...
                              items: [
                                'يقفز بقدميه',
                                'يستخدم جمل من 3 كلمات',
                                'يطابق الألوان الأساسية',
                                'يرتدي ملابسه بمساعدة',
                                'يلعب مع أقرانه',
                              ],
                            },
                            {
                                  ...
                                  <FormControlLabel
                                    ...
                                    control={
                                      <Switch
                                        ...
                                        onChange={e => {
                                          const items = { ...(assessmentForm.items || {}) };
                                          items[`${group.ageGroup}_${ii + 1}`] = e.target.checked
                                            ? 1
                                            : 0;
                                          setAssessmentForm(p => ({ ...p, items }));
                                        }}
                                    ...
                                    sx={{
                                      ...
                                      mb: 0.5,
                                      p: 0.5,
                                      backgroundColor: ii % 2 === 0 ? '#e8f5e9' : '#fff',
                                      borderRadius: 1,
                                    }}
                                  />
                                ))}
                      ...
                      {selectedScale.id === 'behavioral-function' && (
                        <Box>
                          ...
                          <Typography variant="subtitle2" gutterBottom sx={{ mt: 2 }}>
                            المقدمات الشائعة (ما يحدث قبل السلوك):
                          </Typography>
                          {[
                            'طلب مهمة صعبة',
                            'رفض طلب',
                              ...
                              control={
                                <Switch
                                  onChange={e => {
                                    ...
                                    if (e.target.checked) ants.push(ant);
                                    else {
                          ...
                          <Typography variant="subtitle2" gutterBottom sx={{ mt: 2 }}>
                            الوظيفة المحتملة للسلوك:
                          </Typography>
                          {[
                            {
                              value: 'attention',
                              label: 'الحصول على انتباه',
                              desc: 'السلوك يحدث للحصول على اهتمام الآخرين',
                            },
                            {
                              value: 'escape',
                              label: 'الهروب/التجنب',
                              desc: 'السلوك يحدث لتجنب مهمة أو موقف',
                            },
                            {
                              value: 'tangible',
                              label: 'الحصول على شيء ملموس',
                              desc: 'السلوك يحدث للحصول على شيء مرغوب',
                            },
                            {
                              value: 'sensory',
                              label: 'التحفيز الذاتي/الحسي',
                              desc: 'السلوك يوفر إحساساً حسياً مرغوباً',
                            },
                          ].map((fn, i) => (
                            <FormControlLabel
                              key={i}
                              control={
                                <Switch
                                  ...
                                  onChange={e => {
                                    ...
                                    if (e.target.checked) fns.push(fn.value);
                                    else {
                                      const idx = fns.indexOf(fn.value);
                      ...
                      {selectedScale.id === 'family-needs' && (
                        <Box>
                          <Typography variant="subtitle2" gutterBottom color="primary">
                            استبيان احتياجات الأسرة — حدد مدى احتياجكم لكل خدمة (1=لا نحتاج، 2=ربما،
                            3=نحتاج، 4=نحتاج بشدة):
                          </Typography>
                          {[
                            {
                              category: 'احتياجات المعلومات',
                              items: [
                            ...
                            {
                              category: 'الدعم النفسي والعاطفي',
                              items: [
                            ...
                            <Paper key={ci} sx={{ p: 2, mb: 2, borderLeft: '3px solid #e91e63' }}>
                              <Typography fontWeight="bold" gutterBottom color="secondary">
                                {cat.category}
                              </Typography>
                              {cat.items.map((item, ii) => (
                                <Box
                                  ...
                                  sx={{
                                    ...
                                    mb: 1,
                                    p: 0.5,
                                    backgroundColor: ii % 2 === 0 ? '#fce4ec' : '#fff',
                                    borderRadius: 1,
                                  }}
                                >
                                  <Typography
                                    variant="body2"
                                    sx={{ minWidth: 250, textAlign: 'right' }}
                                  >
                                    {item}
                                  </Typography>
                                  <Rating
              ...
              <Grid item xs={12} md={6}>
                {showResult && scoringResult ? (
                  ...
                  <Paper sx={{ p: 3, textAlign: 'center', color: 'text.secondary' }}>
                    ...
                    <Typography>
                      اختر المقياس وأدخل البيانات ثم اضغط "تصحيح تلقائي ذكي" لعرض النتائج
                    </Typography>
                  </Paper>
                )}
              </Grid>
          ...
          <Grid container spacing={2} sx={{ mb: 3 }}>
            ...
            <Grid item xs={12} sm={4}>
              <FormControl fullWidth>
                ...
                <Select
                  value={batteryDiagnosis}
                  onChange={e => setBatteryDiagnosis(e.target.value)}
                  label="التشخيص"
                >
                  {DIAGNOSES.map(d => (
          ...
          {batteryResult && (
            <Box>
              <Alert severity="success" sx={{ mb: 2 }}>
                تم اقتراح <strong>{batteryResult.recommended_assessments?.length || 0}</strong>{' '}
                مقياس للعمر <strong>{batteryAge} شهر</strong> والتشخيص{' '}
                <strong>{DIAGNOSES.find(d => d.value === batteryDiagnosis)?.label}</strong>
              </Alert>
              ...
              <Grid container spacing={2}>
                {(batteryResult.recommended_assessments || []).map((assessment, i) => (
                  <Grid item xs={12} sm={6} md={4} key={i}>
                    <Card
                      sx={{
                        borderLeft: `4px solid ${['#1565c0', '#2e7d32', '#7b1fa2', '#ed6c02', '#d32f2f'][i % 5]}`,
                      }}
                    >
                      <CardContent>
                        ...
                        {assessment.priority && (
                          <Chip
                            label={
                              assessment.priority === 'essential'
                                ? 'أساسي'
                                : assessment.priority === 'recommended'
                                  ? 'مُوصى به'
                                  : 'اختياري'
                            }
                            size="small"
            ...
            <Grid item xs={12}>
              <Paper sx={{ p: 3, borderTop: '3px solid #4caf50' }}>
                ...
                {analyticsData.effect_size !== undefined && (
                  <Alert
                    severity={
                      Math.abs(analyticsData.effect_size) >= 0.8
                        ? 'success'
                        : Math.abs(analyticsData.effect_size) >= 0.5
                          ? 'warning'
                          : 'info'
                    }
                    sx={{ mb: 2 }}
                ...
                {analyticsData.rci !== undefined && (
                  <Alert
                    severity={analyticsData.is_reliable ? 'success' : 'warning'}
                    sx={{ mb: 2 }}
                  >
                    <strong>RCI = {analyticsData.rci?.toFixed(3)}</strong>
                    {' — '}
                    {analyticsData.is_reliable
                      ? 'التغيير ذو دلالة إحصائية (موثوق)'
                      : 'التغيير غير ذي دلالة إحصائية'}
                  </Alert>
                )}
            ...
            <Grid item xs={12} sm={4} sx={{ display: 'flex', alignItems: 'center' }}>
              <Button
                ...
                onClick={async () => {
                  ...
                  const type =
                    typeEl?.parentElement?.querySelector('input[type=hidden]')?.value ||
                    typeEl?.closest('.MuiInputBase-root')?.querySelector('input')?.value ||
                    'mchat';
          ...
          {compareResult && (
            <Box>
                  ...
                  <Table size="small">
                    <TableHead>
                      <TableRow sx={{ backgroundColor: '#f3e5f5' }}>
                        <TableCell align="right">
                          <strong>البُعد</strong>
                        </TableCell>
                        <TableCell align="center">
                          <strong>القبلي</strong>
                        </TableCell>
                        <TableCell align="center">
                          <strong>البعدي</strong>
                        </TableCell>
                        <TableCell align="center">
                        ...
                        <TableRow key={field} hover>
                          ...
                          <TableCell align="center">
                            <Chip
                              ...
                              size="small"
                              color={
                                data.direction_en === 'improved'
                                  ? 'success'
                                  : data.direction_en === 'declined'
                                    ? 'error'
                                    : 'default'
                              }
                            />
              ...
              {compareResult.effect_size && (
                <Alert
                  severity={
                    Math.abs(compareResult.effect_size.effect_size) >= 0.8 ? 'success' : 'info'
                  }
                  sx={{ mt: 2 }}
                >
                  <strong>حجم الأثر: {compareResult.effect_size.effect_size?.toFixed(3)}</strong>
                  {' — '}
                  {compareResult.effect_size.interpretation_ar ||
                    compareResult.effect_size.interpretation}
                </Alert>
              )}
            </Box>
          )}
      ...
      <TabPanel value={tabIndex} index={4}>
        <Paper sx={{ p: 3 }}>
          ...
          <Typography variant="body2" color="text.secondary" sx={{ mb: 3 }}>
            بروتوكولات معتمدة من الأدبيات العلمية لكل تشخيص — تشمل الأساليب العلاجية وعدد الجلسات
            والأهداف
          </Typography>
          ...
          <Grid container spacing={2} sx={{ mb: 3 }}>
            <Grid item xs={12} sm={6}>
              <FormControl fullWidth>
                ...
                <Select
                  value={protocolDiagnosis}
                  onChange={e => setProtocolDiagnosis(e.target.value)}
                  label="اختر التشخيص"
                >
                  {DIAGNOSES.map(d => (
                    <MenuItem key={d.value} value={d.value}>
                          ...
                          {approach.evidence_level && (
                            <ListItemSecondaryAction>
                              <Chip
                                ...
                                size="small"
                                color={
                                  approach.evidence_level === 'A'
                                    ? 'success'
                                    : approach.evidence_level === 'B'
                                      ? 'warning'
                                      : 'default'
                                }
                              />
        ...
        <Paper sx={{ p: 3 }}>
                ...
                onClick={async () => {
                  const data = await apiFetch('/discharge-readiness', {
                    ...
                    body: JSON.stringify({
                      ...
                      independence_score: parseFloat(
                        document.getElementById('dc-independence').value
                      ),
                      family_satisfaction: parseInt(document.getElementById('dc-family').value),
                      transition_plan_complete: !!parseInt(
                        document.getElementById('dc-plan').value
                      ),
                    }),
                  });
          ...
          {dischargeResult && (
            <Box>
              <Alert
                severity={
                  dischargeResult.readiness_score >= 80
                    ? 'success'
                    : dischargeResult.readiness_score >= 60
                      ? 'warning'
                      : 'error'
                }
                sx={{ mb: 2 }}
      ...
      <TabPanel value={tabIndex} index={6}>
        <Paper sx={{ p: 3, mb: 3 }}>
                  ...
                  <TableBody>
                    {manageList.map((item, i) => (
                      <TableRow key={item._id} hover>
                        ...
                        <TableCell align="center">{item.assessor?.name || '—'}</TableCell>
                        <TableCell align="center">
                          <Tooltip title="عرض التفاصيل">
                            <IconButton
                              size="small"
                              onClick={() => fetchDetail(manageType, item._id)}
                            >
                          ...
                          <Tooltip title="حذف">
                            <IconButton
                              size="small"
                              onClick={() => handleDelete(manageType, item._id)}
                            >
          ...
          {manageList.length === 0 && managePagination.total === 0 && (
            <Alert severity="info">
              لا توجد تقييمات محفوظة من هذا النوع. اضغط "عرض التقييمات" لتحميل البيانات.
            </Alert>
          )}
        </Paper>
              ...
              <Box>
                <Grid container spacing={2} sx={{ mb: 2 }}>
                  <Grid item xs={6}>
                    ...
                    <Typography>
                      {viewDetail.beneficiary?.name || viewDetail.beneficiary || '—'}
                    </Typography>
                  </Grid>
                  <Grid item xs={6}>
                    <Typography variant="subtitle2" color="text.secondary">
