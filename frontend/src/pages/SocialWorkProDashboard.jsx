...
const recentCases = [
  {
    id: 'SW-287',
    patient: 'عبدالله أحمد',
    type: 'إرشاد نفسي',
    worker: 'نورة القحطاني',
    date: '٢٠٢٦/٠٣/٣٠',
    status: 'نشطة',
  },
  {
        ...
        <GlassCard>
          ...
          <TableContainer>
            <Table size="small">
              <TableHead>
                <TableRow>
                  {['رقم الحالة', 'المستفيد', 'نوع الخدمة', 'الأخصائي', 'التاريخ', 'الحالة'].map(
                    h => (
                      <TableCell
                        key={h}
                        sx={{
              ...
              <TableBody>
                {recentCases.map((row, i) => (
                  ...
                  >
                    ...
                    >
                      <Typography sx={{ fontSize: '0.8rem', fontWeight: 700, color: '#8b5cf6' }}>
                        {row.id}
                      </Typography>
                    </TableCell>
                    <TableCell
                      ...
                      <Chip
                        icon={
                          row.status === 'مكتملة' ? (
                            ...
                            <PendingIcon sx={{ fontSize: '12px !important' }} />
                          )
                        }
                        label={row.status}
                        size="small"
