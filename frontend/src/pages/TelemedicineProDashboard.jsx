          ...
          >
            <GlassCard>
              <Typography sx={{ fontWeight: 700, mb: 2, color: isDark ? '#F1F5F9' : '#0F172A' }}>
                الجلسات الشهرية حسب النوع
              </Typography>
              <ResponsiveContainer width="100%" height={280}>
                <AreaChart data={monthlyData}>
                  <defs>
                    <linearGradient id="tmVideo" x1="0" y1="0" x2="0" y2="1">
                      <stop offset="5%" stopColor="#6366f1" stopOpacity={0.3} />
                      <stop offset="95%" stopColor="#6366f1" stopOpacity={0} />
                    </linearGradient>
                    <linearGradient id="tmAudio" x1="0" y1="0" x2="0" y2="1">
                      <stop offset="5%" stopColor="#06b6d4" stopOpacity={0.3} />
                      <stop offset="95%" stopColor="#06b6d4" stopOpacity={0} />
                    </linearGradient>
                    <linearGradient id="tmChat" x1="0" y1="0" x2="0" y2="1">
              ...
              {platformUsage.map((p, i) => (
                <Box key={i} sx={{ mb: 2 }}>
                  <Box sx={{ display: 'flex', justifyContent: 'space-between', mb: 0.5 }}>
                    ...
                    <Typography sx={{ fontSize: '0.78rem', fontWeight: 700, color: p.color }}>
                      {p.usage}%
                    </Typography>
                  </Box>
                  <LinearProgress
                    ...
                    sx={{
                      height: 8,
                      borderRadius: 4,
                      backgroundColor: alpha(p.color, 0.12),
                      '& .MuiLinearProgress-bar': {
                        borderRadius: 4,
                        background: `linear-gradient(90deg, ${p.color}, ${alpha(p.color, 0.7)})`,
                      },
                    }}
                  />
                </Box>
