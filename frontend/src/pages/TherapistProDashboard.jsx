    ...
    <Box sx={{ direction: 'rtl', minHeight: '100vh' }}>
          ...
          >
            ...
            {activeSession && (
              ...
              >
                ...
                <Typography
                  sx={{ fontSize: '0.7rem', color: isDark ? 'rgba(255,255,255,0.5)' : '#94A3B8' }}
                >
                  {activeSession.type}
                </Typography>
              </Box>
              ...
              <ResponsiveContainer width="100%" height={200}>
                ...
                >
                  <RadialBar
                    dataKey="value"
                    cornerRadius={6}
                    background={{ fill: isDark ? 'rgba(255,255,255,0.05)' : '#F8FAFC' }}
                  />
                  <Tooltip
                    formatter={v => [`${v}٪`, 'التقدم']}
                    contentStyle={{
                      borderRadius: 12,
                      border: 'none',
                      background: isDark ? '#1E293B' : '#fff',
          ...
          >
            ...
            >
              ...
              >
                ...
                >
                  {PATIENTS.map(p => (
                    <Avatar key={p.name} sx={{ background: p.color }}>
                      {p.name[0]}
                    </Avatar>
                  ))}
                </AvatarGroup>
                  ...
                  <Box sx={{ mb: 2.25 }}>
                    ...
                    >
                      ...
                      <Box sx={{ textAlign: 'center' }}>
                        <Typography sx={{ fontWeight: 800, fontSize: '0.88rem', color: p.color }}>
                          {p.progress}٪
                        </Typography>
                        <Typography
                          sx={{
      ...
      >
        ...
        >
          ...
          <Box sx={{ flex: 1 }}>
            <Typography
              sx={{ fontWeight: 700, fontSize: '0.88rem', color: isDark ? '#F1F5F9' : '#0F172A' }}
            >
              ٣ تقارير تنتظر مراجعتك
            </Typography>
            <Typography
              sx={{ fontSize: '0.75rem', color: isDark ? 'rgba(255,255,255,0.45)' : '#64748B' }}
            >
