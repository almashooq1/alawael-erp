...
const ACTIVE_PROGRAMS = [
  {
    ...
    trainer: 'د. سعد العمري',
    attendees: 24,
    progress: 85,
    status: 'active',
    startDate: '٢٠٢٦/٠١/١٥',
  },
  {
    id: 'TRN-402',
    name: 'التأهيل المتقدم للمعالجين',
    trainer: 'د. ليلى الحسن',
    attendees: 18,
    progress: 62,
    status: 'active',
    startDate: '٢٠٢٦/٠٢/٠١',
  },
  {
    id: 'TRN-403',
    name: 'الأمن السيبراني الأساسي',
    trainer: 'م. خالد السبيعي',
    attendees: 45,
    progress: 100,
    status: 'completed',
    startDate: '٢٠٢٦/٠١/١٠',
  },
  {
    id: 'TRN-404',
    name: 'إدارة الجودة الشاملة',
    trainer: 'د. منى الشهري',
    attendees: 32,
    progress: 45,
    status: 'active',
  ...
  {
    id: 'TRN-405',
    name: 'الإسعافات الأولية المتقدمة',
    trainer: 'د. فهد القحطاني',
    attendees: 28,
    progress: 30,
    status: 'active',
    startDate: '٢٠٢٦/٠٣/١٥',
  },
  {
    id: 'TRN-406',
    name: 'مهارات التواصل الفعّال',
    trainer: 'أ. نورة العتيبي',
    attendees: 38,
    progress: 0,
    status: 'upcoming',
    startDate: '٢٠٢٦/٠٤/٠١',
  },
  {
    id: 'TRN-407',
    name: 'تحليل البيانات وPower BI',
    trainer: 'م. أحمد الغامدي',
    attendees: 20,
    progress: 72,
    status: 'active',
    startDate: '٢٠٢٦/٠٢/١٥',
  },
];
                          ...
                          <LinearProgress
                            ...
                            sx={{
                              ...
                              backgroundColor: isDark
                                ...
                                : 'rgba(0,0,0,0.06)',
                              '& .MuiLinearProgress-bar': { borderRadius: 3, background: gradient },
                            }}
                          />
                          <Typography
                            sx={{
