          ...
          <Table>
            ...
            <TableBody>
              {list.map((wh, idx) => (
                ...
                >
                  <TableCell>
                    <Typography fontWeight={600}>{wh.code}</Typography>
                  </TableCell>
                  <TableCell>{wh.nameAr}</TableCell>
                  <TableCell>
                    <Chip label={TYPE_LABELS[wh.type] || wh.type} size="small" variant="outlined" />
                  </TableCell>
                  <TableCell>
                    <Chip
                      label={STATUS_LABELS[wh.status] || wh.status}
                      size="small"
                      color={STATUS_COLORS[wh.status] || 'default'}
                    />
                  </TableCell>
                  <TableCell align="center">
                    <Tooltip title="تعديل">
                      <IconButton size="small" color="primary" onClick={() => openEdit(wh)}>
                        <Edit fontSize="small" />
                      </IconButton>
                    </Tooltip>
                    <Tooltip title="إغلاق">
                      <IconButton size="small" color="error" onClick={() => handleDelete(wh._id)}>
      ...
      <Dialog open={dialogOpen} onClose={() => setDialogOpen(false)} maxWidth="sm" fullWidth>
        ...
        <DialogActions>
          ...
          <Button
            variant="contained"
            onClick={handleSave}
            disabled={saving || !form.code.trim() || !form.nameAr.trim()}
          >
