          ...
          <FormControlLabel
            control={
              <Switch
                ...
                onChange={e => updateField('requiresReply', e.target.checked)}
              />
            }
            label="يتطلب رد"
          />
      ...
      <Grid item xs={12}>
        ...
        <Stack direction="row" spacing={1} alignItems="center" flexWrap="wrap" useFlexGap>
          ...
          <TextField
            ...
            sx={{ width: 150 }}
          />
          <IconButton size="small" onClick={addKeyword}>
            <AddIcon fontSize="small" />
          </IconButton>
        </Stack>
      </Grid>
              ...
              <Stack spacing={1}>
                ...
                <Box display="flex" justifyContent="space-between">
                  ...
                  <Chip
                    ...
                    size="small"
                    color={priorityConfig.chipColor}
                    variant="outlined"
                  />
                </Box>
                <Box display="flex" justifyContent="space-between">
                ...
                <Box display="flex" justifyContent="space-between">
                  ...
                  <Typography variant="body2">
                    ...
                    {form.senderDepartment
                      ? ` — ${DEPARTMENTS.find(d => d.value === form.senderDepartment)?.label || ''}`
                      : ''}
                  </Typography>
                </Box>
                <Box display="flex" justifyContent="space-between">
                  ...
                  <Chip
                    label={SENDER_TYPES[form.senderType]?.label}
                    size="small"
                    variant="outlined"
                  />
                </Box>
