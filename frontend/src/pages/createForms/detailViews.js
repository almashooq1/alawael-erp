...
const DETAIL_VIEWS = {
  'ar-rehab/:id': {
    getBase: '/ar-vr',
    backTo: '/ar-rehab',
    title: 'تفاصيل جلسة الواقع المعزّز/الافتراضي',
  },
  'audit/:id': {
    getBase: '/internal-audit/audit-plans',
    backTo: '/audit',
    title: 'تفاصيل خطة التدقيق',
  },
  'cms/content/:id': { getBase: '/cms/pages', backTo: '/cms', title: 'تفاصيل المحتوى' },
  'community/activities/:id': {
    getBase: '/community-integration/activities',
    backTo: '/community',
    title: 'تفاصيل النشاط المجتمعي',
  },
  'crisis/incidents/:id': {
    getBase: '/crisis/incidents',
    backTo: '/crisis',
  ...
  'kitchen/meals/:id': {
    getBase: '/kitchen/menu-items',
    backTo: '/kitchen',
    title: 'تفاصيل عنصر القائمة',
  },
  'knowledge/:id': {
    getBase: '/knowledge-center/articles',
    backTo: '/knowledge',
    title: 'تفاصيل المقال المعرفي',
  },
  'laundry/orders/:id': {
    getBase: '/laundry/orders',
    backTo: '/laundry',
    title: 'تفاصيل طلب الغسيل',
  },
  'leave-management/requests/:id': {
    getBase: '/leave-requests',
    backTo: '/leave-management',
    title: 'تفاصيل طلب الإجازة',
  },
  'legal/cases/:id': {
    getBase: '/legal-affairs/cases',
    backTo: '/legal',
    title: 'تفاصيل القضية القانونية',
  },
  ...
  'research/studies/:id': {
    getBase: '/research',
    backTo: '/research',
    title: 'تفاصيل الدراسة البحثية',
  },
  'supply-chain/orders/:id': {
    getBase: '/supply-chain/orders',
    backTo: '/supply-chain',
  ...
  'recruitment/applicants/:id': {
    getBase: '/recruitment/applicants',
    backTo: '/recruitment',
    title: 'تفاصيل المتقدّم',
  },
  'warehouse/items/:id': {
    getBase: '/warehouse/items',
    backTo: '/warehouse',
    title: 'تفاصيل صنف المستودع',
  },
  'independent-living/beneficiaries/:id': {
    getBase: '/independent-living/beneficiaries',
