...
const RAW = {
  ...
  'employee-affairs/new': {
    title: 'إضافة موظف',
    endpoint: '/employee-affairs',
    method: 'post',
    backTo: '/employee-affairs',
    successMsg: 'تمت الإضافة بنجاح ✓',
    fields: [
  ...
  'succession/new': {
    title: 'إضافة خطة تعاقب',
    endpoint: '/succession-planning',
    method: 'post',
    backTo: '/succession',
    successMsg: 'تمت الإضافة بنجاح ✓',
    fields: [
  ...
  'contracts/new': {
    title: 'إضافة عقد',
    endpoint: '/contract-management/contracts',
    method: 'post',
    backTo: '/contracts',
    successMsg: 'تمت الإضافة بنجاح ✓',
    fields: [
  ...
  'org-structure/new': {
    title: 'إضافة وظيفة',
    endpoint: '/organization/positions',
    method: 'post',
    backTo: '/org-structure',
    successMsg: 'تمت الإضافة بنجاح ✓',
    fields: [
      ...
      { name: 'titleEn', label: 'المسمى بالإنجليزية', type: 'text' },
      {
        ...
        options: [
          { value: 'executive', label: 'تنفيذي' },
          { value: 'senior_management', label: 'إدارة عليا' },
          { value: 'middle_management', label: 'إدارة وسطى' },
  ...
  // ── Clinical / care ──────────────────────────────────────────────────────
  'icf/new': {
    title: 'إضافة تقييم ICF',
    endpoint: '/icf-assessments',
    method: 'post',
    backTo: '/icf',
    successMsg: 'تمت الإضافة بنجاح ✓',
    fields: [
      ...
      { name: 'description', label: 'الوصف', type: 'textarea' },
      {
        ...
        required: true,
        options: [
          { value: 'initial', label: 'تقييم أولي' },
          { value: 'periodic', label: 'تقييم دوري' },
          { value: 'progress', label: 'تقييم تقدم' },
          { value: 'discharge', label: 'تقييم خروج' },
          { value: 'followUp', label: 'تقييم متابعة' },
          { value: 'comprehensive', label: 'تقييم شامل' },
        ],
      },
  ...
  'mhpss/sessions/new': {
    title: 'إضافة جلسة إرشاد نفسي',
    endpoint: '/mhpss/sessions',
    method: 'post',
    backTo: '/mhpss',
    successMsg: 'تمت الإضافة بنجاح ✓',
    fields: [
      ...
      { name: 'startTime', label: 'وقت البدء', type: 'text' },
      {
        ...
        options: [
          { value: 'office', label: 'مكتب' },
          { value: 'therapy-room', label: 'غرفة علاج' },
          { value: 'remote', label: 'عن بعد' },
          { value: 'home-visit', label: 'منزلي' },
        ],
      },
  ...
  'research/studies/new': {
    ...
    fields: [
      ...
      { name: 'abstract', label: 'ملخص الدراسة', type: 'textarea', required: true },
      {
        ...
        required: true,
        options: [
          { value: 'retrospective', label: 'بأثر رجعي' },
          { value: 'prospective', label: 'استشرافي' },
          { value: 'cross-sectional', label: 'مقطعي' },
          { value: 'longitudinal', label: 'طولي' },
          { value: 'case-study', label: 'دراسة حالة' },
          { value: 'cohort', label: 'أتراب' },
          { value: 'quality-improvement', label: 'تحسين الجودة' },
        ],
      },
    ],
  },
  'independent-living/plans/new': {
    title: 'إضافة خطة استقلالية',
    endpoint: '/independent-living/plans',
    method: 'post',
    ...
    fields: [
      {
        ...
        required: true,
        options: [
          { value: 'vr', label: 'واقع افتراضي' },
          { value: 'ar', label: 'واقع معزز' },
          { value: 'mr', label: 'واقع مختلط' },
          { value: 'xr', label: 'واقع ممتد' },
          { value: 'mixed', label: 'مدمج' },
        ],
      },
      {
        name: 'specialty',
        ...
        type: 'select',
        options: [
          { value: 'motor_rehab', label: 'تأهيل حركي' },
          { value: 'cognitive_rehab', label: 'تأهيل معرفي' },
          { value: 'balance_training', label: 'تدريب التوازن' },
          { value: 'pain_management', label: 'إدارة الألم' },
  ...
  'community/activities/new': {
    title: 'إضافة نشاط مجتمعي',
    endpoint: '/community-integration/activities',
    method: 'post',
    backTo: '/community',
    successMsg: 'تمت الإضافة بنجاح ✓',
    fields: [
    ...
    fields: [
      ...
      },
      {
        ...
        options: [
          ...
          { value: 'student', label: 'طالب/مستفيد' },
  ...
  'crisis/incidents/new': {
    title: 'إضافة حادثة طارئة',
    endpoint: '/crisis/incidents',
    method: 'post',
    backTo: '/crisis',
    successMsg: 'تمت الإضافة بنجاح ✓',
    fields: [
    ...
    fields: [
      ...
      { name: 'description', label: 'وصف الحادثة', type: 'textarea', required: true },
      {
        ...
        options: [
          ...
          { value: 'property_damage', label: 'أضرار بالممتلكات' },
  ...
  'risk-management/new': {
    title: 'إضافة مخاطرة',
    endpoint: '/enterprise-risk/risks',
    method: 'post',
    backTo: '/risk-management',
    successMsg: 'تمت الإضافة بنجاح ✓',
    fields: [
  ...
  'legal/cases/new': {
    title: 'إضافة قضية قانونية',
    endpoint: '/legal-affairs/cases',
    method: 'post',
    backTo: '/legal',
    successMsg: 'تمت الإضافة بنجاح ✓',
    fields: [
  ...
  'audit/plans/new': {
    title: 'إضافة خطة تدقيق',
    endpoint: '/internal-audit/audit-plans',
    method: 'post',
    backTo: '/audit',
    successMsg: 'تمت الإضافة بنجاح ✓',
    fields: [
  ...
  'knowledge/new': {
    title: 'إضافة مقال معرفي',
    endpoint: '/knowledge-center/articles',
    method: 'post',
    backTo: '/knowledge',
    successMsg: 'تمت الإضافة بنجاح ✓',
    fields: [
      ...
      { name: 'content', label: 'المحتوى', type: 'textarea', required: true },
      {
        ...
        required: true,
        options: [
          { value: 'therapeutic_protocols', label: 'البروتوكولات العلاجية' },
          { value: 'case_studies', label: 'دراسات الحالة' },
          { value: 'research_experiments', label: 'التجارب البحثية' },
    ...
    fields: [
      ...
      { name: 'description', label: 'الوصف', type: 'textarea', required: true },
      {
        ...
        options: [
          ...
          { value: 'access', label: 'الصلاحيات والوصول' },
    ...
    fields: [
      ...
      { name: 'applicantEmail', label: 'البريد الإلكتروني', type: 'email' },
      {
        ...
        options: [
          ...
          { value: 'multiple', label: 'إعاقة مزدوجة' },
          { value: 'other', label: 'أخرى' },
        ],
      },
      {
  ...
  'kitchen/meals/new': {
    title: 'إضافة عنصر قائمة طعام',
    endpoint: '/kitchen/menu-items',
    method: 'post',
    backTo: '/kitchen',
    successMsg: 'تمت الإضافة بنجاح ✓',
    fields: [
  ...
  'laundry/orders/new': {
    ...
    fields: [
      { name: 'department', label: 'القسم', type: 'text' },
      {
        ...
        options: [
          { value: 'personal', label: 'شخصي' },
          { value: 'bedding', label: 'مفروشات' },
          { value: 'towels', label: 'مناشف' },
          { value: 'uniforms', label: 'أزياء موحدة' },
          { value: 'curtains', label: 'ستائر' },
  ...
  'strategic-planning/new': {
    ...
    endpoint: '/strategic-planning/goals',
    method: 'post',
    backTo: '/strategic-planning',
    successMsg: 'تمت الإضافة بنجاح ✓',
    fields: [
