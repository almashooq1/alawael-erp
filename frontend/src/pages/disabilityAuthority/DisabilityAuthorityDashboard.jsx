                  ...
                  {reports.length === 0 ? (
                    ...
                    reports.map(r => (
                      <TableRow key={r._id} hover>
                        ...
                        <TableCell align="center">
                          {r.data?.serviceStats?.totalSessions || 0}
                        </TableCell>
                        <TableCell align="center">
                          <Chip
                            label={reportStatusLabels[r.status] || r.status}
                            color={reportStatusColors[r.status] || 'default'}
                            size="small"
                          />
                        </TableCell>
                ...
                standards.map(std => (
                  ...
                  >
                    <AccordionSummary expandIcon={<ExpandMore />}>
                      <Box display="flex" alignItems="center" gap={2} width="100%">
                        ...
                        <Typography fontWeight="bold" flex={1}>
                          {std.titleAr || std.title}
                        </Typography>
                        <Chip
                          label={
                            std.priority === 'essential'
                              ? 'أساسي'
                              : std.priority === 'important'
                                ? 'مهم'
                                : 'تطويري'
                          }
                          color={
                    ...
                    <AccordionDetails>
                      ...
                      <Typography variant="body2" color="text.secondary">
                        <strong>الفصل:</strong> {std.chapter} | <strong>القسم:</strong>{' '}
                        {std.section || '—'}
                      </Typography>
                    ...
                    <Box display="flex" justifyContent="space-between" alignItems="center" mb={2}>
                      ...
                      <Box textAlign="center">
                        <Typography
                          ...
                          fontWeight="bold"
                          color={
                            (assess.overallScore || 0) >= 80
                              ? 'success.main'
                              : (assess.overallScore || 0) >= 60
                                ? 'warning.main'
                                : 'error.main'
                          }
                        >
                        ...
                        <Chip
                          label={
                            readinessLabels[assess.readinessLevel] || assess.readinessLevel || '—'
                          }
