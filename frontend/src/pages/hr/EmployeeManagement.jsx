  ...
  return (
    <Container maxWidth="xl" sx={{ py: 3 }}>
      ...
      >
        <Box>
          ...
          <Typography variant="body2" color="text.secondary">
            تسجيل وإدارة بيانات الموظفين والعقود والمعلومات الوظيفية
          </Typography>
        </Box>
        <Box sx={{ display: 'flex', gap: 1, flexWrap: 'wrap' }}>
          <Tooltip title="تحديث">
            <IconButton onClick={h.loadEmployees} disabled={h.loading}>
              <RefreshIcon />
            </IconButton>
          </Tooltip>
          <Button
          ...
          <Button variant="contained" startIcon={<AddIcon />} onClick={h.openAdd}>
            تسجيل موظف جديد
          </Button>
        </Box>
      </Box>
        ...
        <Grid container spacing={2} alignItems="center">
          <Grid item xs={12} sm={4}>
            <TextField
              fullWidth
              size="small"
              placeholder="بحث بالاسم، الرقم، الهاتف أو البريد..."
              value={h.search}
              onChange={e => {
                h.setSearch(e.target.value);
                h.setPage(0);
              }}
              InputProps={{
                startAdornment: (
          ...
          <Grid item xs={12} sm={3}>
            <TextField
              ...
              value={h.deptFilter}
              onChange={e => {
                h.setDeptFilter(e.target.value);
                h.setPage(0);
              }}
            >
          ...
          <Grid item xs={12} sm={3}>
            <TextField
              ...
              onChange={e => {
                h.setStatusFilter(e.target.value);
                h.setPage(0);
              }}
            >
              <MenuItem value="">الكل</MenuItem>
      ...
      <EmployeeTable
        ...
        filtered={h.filtered}
        page={h.page}
        rowsPerPage={h.rowsPerPage}
        setPage={h.setPage}
        setRowsPerPage={h.setRowsPerPage}
        openView={h.openView}
        openEdit={h.openEdit}
        setDeleteTarget={h.setDeleteTarget}
        handleCopyId={h.handleCopyId}
      />
      ...
      <EmployeeFormDialog
        ...
        dialogMode={h.dialogMode}
        setDialogMode={h.setDialogMode}
        form={h.form}
        setField={h.setField}
        positionsList={h.positionsList}
        activeStep={h.activeStep}
        setActiveStep={h.setActiveStep}
        errors={h.errors}
        setErrors={h.setErrors}
        touched={h.touched}
        setTouched={h.setTouched}
        saving={h.saving}
        handleNext={h.handleNext}
        handleBack={h.handleBack}
        handleSave={h.handleSave}
        handlePrint={h.handlePrint}
      />
      ...
      >
        ...
        <DialogContent>
          <Alert severity="warning" sx={{ borderRadius: 2 }}>
            ...
            <strong>
              {h.deleteTarget?.firstName} {h.deleteTarget?.lastName}
            </strong>
      ...
      <Snackbar
        ...
        onClose={() => h.setSnack(s => ({ ...s, open: false }))}
        anchorOrigin={{ vertical: 'bottom', horizontal: 'center' }}
      >
        <Alert
          severity={h.snack.severity}
          onClose={() => h.setSnack(s => ({ ...s, open: false }))}
          variant="filled"
          sx={{ width: '100%' }}
        >
