              ...
              <Grid item xs={12} md={6} key={dept.id}>
                <Card
                  sx={{
                    height: '100%',
                    boxShadow: 3,
                    border: `2px solid ${surfaceColors.divider}`,
                  }}
                >
                  <CardContent>
                    <Typography
                      variant="h6"
                      sx={{ mb: 2, color: statusColors.primaryBlue, fontWeight: 'bold' }}
                    >
                      {dept.name}
                    </Typography>
                    ...
                    {dept.sections && (
                      <Box>
                        ...
                        {dept.sections.map(section => (
                          <Box
                            key={section.id}
                            sx={{ mb: 2, p: 1, bgcolor: surfaceColors.lightGray, borderRadius: 1 }}
                          >
              ...
              <Grid item xs={12} key={branch.id}>
                <Card sx={{ boxShadow: 3 }}>
                  <CardContent>
                    <Typography
                      variant="h6"
                      sx={{ mb: 1, color: statusColors.errorDark, fontWeight: 'bold' }}
                    >
                      {branch.nameArabic}
                    </Typography>
                    <Typography variant="body2" sx={{ mb: 2, color: neutralColors.textSecondary }}>
                        ...
                        <Grid item xs={12} md={6} key={dept.id}>
                          <Paper
                            sx={{
                              ...
                              border: `1px solid ${surfaceColors.borderLight}`,
                            }}
                          >
                            <Typography
                              variant="subtitle1"
                              sx={{ mb: 1, fontWeight: 'bold', color: statusColors.primaryBlue }}
                            >
                              {dept.name}
                            </Typography>
                            <Typography
                              variant="body2"
                              sx={{ mb: 2, color: neutralColors.textSecondary }}
                            >
                              {dept.description}
                            </Typography>
