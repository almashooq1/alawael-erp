    ...
    const fetchData = async () => {
      try {
        ...
        setData({
          ...
          deviceTypes: [
            { name: 'حساسات حرارة', value: 28 },
            { name: 'كاميرات', value: 20 },
            { name: 'حساسات رطوبة', value: 18 },
            { name: 'أقفال ذكية', value: 12 },
            { name: 'أخرى', value: 8 },
          ],
          sensorReadings: [
            { hour: '06:00', temp: 22, humidity: 45 },
            { hour: '09:00', temp: 24, humidity: 42 },
            { hour: '12:00', temp: 28, humidity: 38 },
            { hour: '15:00', temp: 30, humidity: 35 },
            { hour: '18:00', temp: 27, humidity: 40 },
            { hour: '21:00', temp: 23, humidity: 44 },
          ],
          recentAlerts: [
            {
              device: 'حساس حرارة - غرفة 204',
              type: 'حرارة مرتفعة',
              value: '32°C',
              time: '14:30',
              severity: 'تحذير',
                ...
                <TableRow key={i}>
                  ...
                  <TableCell>
                    <Chip
                      label={a.severity}
                      size="small"
                      color={sevColor[a.severity] || 'default'}
                    />
                  </TableCell>
                </TableRow>
              ))}
