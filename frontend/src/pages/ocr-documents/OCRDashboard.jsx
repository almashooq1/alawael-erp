...
export default function OCRDashboard() {
  ...
  const kpiCards = [
    ...
    {
      label: 'مستندات مكتملة',
      value: kpis.completedDocuments ?? 0,
      icon: <VerifiedIcon />,
      color: '#2e7d32',
    },
    {
    ...
    {
      label: 'في الانتظار',
      value: kpis.queuedDocuments ?? 0,
      icon: <QueueIcon />,
      color: '#9c27b0',
    },
    {
      label: 'متوسط الثقة',
      value: `${Math.round((kpis.avgConfidence || 0) * 100)}%`,
      icon: <SpeedIcon />,
      color: '#0288d1',
    },
              ...
              documents.map(doc => (
                <TableRow key={doc.id} hover>
                  ...
                  <TableCell align="right">
                    <Typography
                      variant="body2"
                      sx={{ color: confColor(doc.confidenceScore), fontWeight: 'bold' }}
                    >
