    ...
    const fetchData = async () => {
      try {
        ...
        setData({
          totalReports: 156,
          scheduledReports: 12,
          downloadsThisMonth: 345,
          reportTypes: 8,
          byType: [
            { name: 'مالية', value: 35 },
            { name: 'موارد بشرية', value: 28 },
            { name: 'تشغيلية', value: 42 },
            { name: 'إدارية', value: 22 },
            { name: 'تأهيلية', value: 18 },
            { name: 'أخرى', value: 11 },
          ],
          monthlyGeneration: [
            { month: 'يناير', count: 22 },
            { month: 'فبراير', count: 28 },
            { month: 'مارس', count: 35 },
      ...
      <Fade in timeout={500}>
        <Box sx={{ mb: 4 }}>
          ...
          <Typography variant="body2" color="text.secondary">
            إنشاء وإدارة ومتابعة جميع التقارير
          </Typography>
        </Box>
      </Fade>
            ...
            <div>
              <Glass sx={{ p: 3 }}>
                ...
                >
                  ...
                  <Chip
                    label={`${data.byType?.length || 0} أنواع`}
                    size="small"
                    variant="outlined"
        ...
        <div>
          <Glass sx={{ p: 3, overflow: 'hidden' }}>
            ...
            >
              ...
              <Chip
                label={`${data.recentReports?.length || 0} تقرير`}
                size="small"
                variant="outlined"
                sx={{ borderRadius: '8px', fontWeight: 500 }}
              />
