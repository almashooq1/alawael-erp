                ...
                <Grid item xs={12} md={3}>
                  <Box sx={{ textAlign: 'center' }}>
                    ...
                    <Typography
                      variant="h3"
                      fontWeight="bold"
                      sx={{ color: healthColor(healthScore.status) }}
                    >
                    ...
                    <Chip
                      ...
                      sx={{
                        bgcolor: healthColor(healthScore.status),
                        color: '#fff',
                        fontWeight: 'bold',
                      }}
                    />
                ...
                {headcountPlans.length === 0 ? (
                  ...
                  headcountPlans.map(plan => (
                    <TableRow key={plan.id}>
                      ...
                      <TableCell>
                        <strong>{plan.targetHeadcount}</strong>
                      </TableCell>
                      <TableCell>
                        {plan.budgetedCost ? `${(plan.budgetedCost / 1000).toFixed(0)}K` : '—'}
                      </TableCell>
                      <TableCell>
                        <Chip label={plan.status} color={statusColor(plan.status)} size="small" />
                      </TableCell>
                      <TableCell>
                        <Chip
                          label={plan.approvalStatus}
                          color={statusColor(plan.approvalStatus)}
                          size="small"
                        />
                      </TableCell>
                    </TableRow>
                ...
                {forecasts.length === 0 ? (
                  ...
                  forecasts.map(fc => (
                    <TableRow key={fc.id}>
                      ...
                      <TableCell>
                        <strong>{fc.predictedValue}</strong>
                      </TableCell>
                      <TableCell>
                        {fc.confidence ? `${(fc.confidence * 100).toFixed(0)}%` : '—'}
                      </TableCell>
                ...
                {successionPlans.length === 0 ? (
                  ...
                  successionPlans.map(plan => (
                    <TableRow key={plan.id}>
                        ...
                        <Chip
                          label={
                            plan.criticalityLevel === 'critical'
                              ? 'حرج'
                              : plan.criticalityLevel === 'high'
                                ? 'عالي'
                                : plan.criticalityLevel === 'medium'
                                  ? 'متوسط'
                                  : 'منخفض'
                          }
                          color={
                      ...
                      <TableCell>
                        <Chip
                          label={plan.replacementReadiness}
                          color={statusColor(plan.replacementReadiness)}
                          size="small"
                        />
                      </TableCell>
                      <TableCell>
        ...
        <Box>
          <Paper sx={{ p: 3 }}>
            ...
            <Alert severity="info" sx={{ mb: 2 }}>
              استخدم واجهة برمجة التطبيقات لإنشاء وتحديث خرائط المهارات للموظفين. يتم تحديد فجوات
              المهارات تلقائياً بناءً على مستوى الإتقان وسنوات الخبرة.
            </Alert>
      ...
      >
        ...
        <DialogContent>
          ...
          <TextField
            ...
            onChange={handleFormChange('planYear')}
            margin="normal"
          />
          <TextField
            fullWidth
            ...
            onChange={handleFormChange('currentHeadcount')}
            margin="normal"
          />
          <TextField
            fullWidth
            ...
            onChange={handleFormChange('targetHeadcount')}
            margin="normal"
          />
          <TextField
            fullWidth
            ...
            onChange={handleFormChange('budgetedCost')}
            margin="normal"
          />
        </DialogContent>
        <DialogActions>
          <Button onClick={() => setOpenDialog(null)}>إلغاء</Button>
          <Button variant="contained" onClick={handleCreateHeadcountPlan}>
            إنشاء
          </Button>
        </DialogActions>
      </Dialog>
      ...
      >
        ...
        <DialogContent>
          <TextField
            ...
            onChange={handleFormChange('metric')}
            margin="normal"
          >
          ...
          <TextField
            ...
            onChange={handleFormChange('period')}
            margin="normal"
            placeholder="2026-Q1"
          />
          <TextField
            ...
            onChange={handleFormChange('predictedValue')}
            margin="normal"
          />
          <TextField
            fullWidth
            label="مستوى الثقة (0-1)"
            type="number"
            value={formData.confidence || ''}
            onChange={handleFormChange('confidence')}
            margin="normal"
        ...
        <DialogActions>
          <Button onClick={() => setOpenDialog(null)}>إلغاء</Button>
          <Button variant="contained" onClick={handleCreateForecast}>
            إنشاء
          </Button>
        </DialogActions>
      </Dialog>
      ...
      >
        ...
        <DialogContent>
          ...
          <TextField
            ...
            onChange={handleFormChange('positionTitle')}
            margin="normal"
          />
          <TextField
            fullWidth
            ...
            onChange={handleFormChange('currentHolder')}
            margin="normal"
          />
          <TextField
            fullWidth
            ...
            onChange={handleFormChange('criticalityLevel')}
            margin="normal"
          >
            {[
        ...
        <DialogActions>
          <Button onClick={() => setOpenDialog(null)}>إلغاء</Button>
          <Button variant="contained" onClick={handleCreateSuccessionPlan}>
            إنشاء
          </Button>
        </DialogActions>
      </Dialog>
