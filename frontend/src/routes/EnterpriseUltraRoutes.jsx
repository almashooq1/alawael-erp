...
const LegalManagementPage = lazyWithRetry(
  () => import('../pages/enterprise-ultra/LegalManagementPage')
);
const CorporateGovernancePage = lazyWithRetry(
  () => import('../pages/enterprise-ultra/CorporateGovernancePage')
);
const BusinessContinuityPage = lazyWithRetry(
  () => import('../pages/enterprise-ultra/BusinessContinuityPage')
);
const CustomerExperiencePage = lazyWithRetry(
  () => import('../pages/enterprise-ultra/CustomerExperiencePage')
);
const SustainabilityPage = lazyWithRetry(
  () => import('../pages/enterprise-ultra/SustainabilityPage')
);
const DigitalTransformationPage = lazyWithRetry(
  () => import('../pages/enterprise-ultra/DigitalTransformationPage')
);
