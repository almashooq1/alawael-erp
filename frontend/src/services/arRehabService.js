...
export const sessionsService = {
  ...
  addObject: (sessionId, data) =>
    api.post(`${BASE}/sessions/${sessionId}/objects`, data).then(r => r.data),
  track: (sessionId, data) =>
    api.post(`${BASE}/sessions/${sessionId}/track`, data).then(r => r.data),
...
export const hologramsService = {
  ...
  addInteractive: (id, data) =>
    api.post(`${BASE}/holograms/${id}/interactive`, data).then(r => r.data),
...
export const bciService = {
  ...
  calibrate: (deviceId, data) =>
    api.post(`${BASE}/bci/devices/${deviceId}/calibrate`, data).then(r => r.data),
  capture: (deviceId, data) =>
    api.post(`${BASE}/bci/devices/${deviceId}/capture`, data).then(r => r.data),
  decode: data => api.post(`${BASE}/bci/decode`, data).then(r => r.data),
  train: data => api.post(`${BASE}/bci/train`, data).then(r => r.data),
  getCapabilities: () =>
    api
      .get(`${BASE}/bci/capabilities`)
      .then(r => r.data)
      .catch(() => ({ data: {} })),
};
...
export const collaborationService = {
  ...
  join: (sessionId, data) =>
    api.post(`${BASE}/collaboration/sessions/${sessionId}/join`, data).then(r => r.data),
  sync: (sessionId, data) =>
    api.put(`${BASE}/collaboration/sessions/${sessionId}/sync`, data).then(r => r.data),
  broadcast: (sessionId, data) =>
    api.post(`${BASE}/collaboration/sessions/${sessionId}/broadcast`, data).then(r => r.data),
  getMetrics: sessionId =>
    api.get(`${BASE}/collaboration/sessions/${sessionId}/metrics`).then(r => r.data),
};
...
export const analyticsService = {
  ...
  addWidget: (dashboardId, data) =>
    api.post(`${BASE}/analytics/dashboards/${dashboardId}/widgets`, data).then(r => r.data),
  interactWidget: (dashboardId, widgetId, data) =>
    api
      .post(`${BASE}/analytics/dashboards/${dashboardId}/widgets/${widgetId}/interact`, data)
      .then(r => r.data),
};
