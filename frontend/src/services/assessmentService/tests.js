      ...
      },
      {
        ...
        items: [
          ...
          },
          {
            ...
            levels: [
              'لا يفهم',
              'يستجيب للتوجيه المباشر',
              'يتبع القواعد الأساسية',
              'يفهم معظم القواعد',
              'يطبق القواعد ذاتياً',
            ],
          },
        ...
        items: [
          ...
          },
          {
            ...
            levels: [
              ...
              'يميز سعيد/حزين',
              'يميز 4 مشاعر',
              'يفهم المشاعر في السياق',
              'يفهم المشاعر المعقدة',
            ],
          },
          {
        ...
        items: [
          {
            ...
            levels: [
              'لا يتعامل',
              'بمساعدة كاملة',
              'يتعامل ببطء مع أشياء سهلة',
              'يتعامل مع معظم الأشياء',
              'يتعامل بسهولة وبراعة',
            ],
          },
          {
            key: 'eating_drinking',
      ...
      },
      {
        ...
        items: [
          ...
          },
          {
            ...
            levels: [
              'لا يستخدم وسلة بديلة',
              'يستخدم بتوجيه',
              'يستخدم للطلب',
              'يستخدم لمحادثات بسيطة',
              'يستخدم لتواصل شامل',
            ],
          },
          {
      ...
      },
      {
        ...
        items: [
          ...
          },
          {
            ...
            levels: [
              'ساعات مرنة ومخفضة جداً',
              'دوام جزئي مخفض',
              'دوام جزئي عادي',
              'دوام كامل مع استراحات',
              'دوام كامل عادي',
            ],
          },
          {
        ...
        items: [
          {
            ...
            levels: [
              'لا يعرف حقوقه',
              'معرفة جزئية',
              'يعرف الحقوق الأساسية',
              'يعرف معظم حقوقه',
              'وعي كامل ودفاع عن الحقوق',
            ],
          },
          {
            ...
            name: 'تقرير المصير',
            levels: [
              'الآخرون يقررون كلياً',
              'مشاركة بسيطة',
              'مشاركة في بعض القرارات',
              'يقرر معظم أموره',
              'يقرر جميع أموره',
            ],
          },
