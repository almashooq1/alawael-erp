  ...
  try {
    ...
    return {
      ...
      data: {
        ...
        byType: [
          { type: 'injury', count: 5 },
          { type: 'near_miss', count: 4 },
          { type: 'property_damage', count: 3 },
          { type: 'fire', count: 2 },
          { type: 'fall', count: 2 },
          { type: 'other', count: 2 },
        ],
        recentIncidents: [
          {
            ...
            titleAr: 'إصابة عامل بخط الإنتاج',
            incidentType: 'injury',
            severity: 'serious',
          ...
          {
            _id: '2',
            incidentNumber: 'INC-00002',
            titleAr: 'انسكاب مواد كيميائية',
          ...
          {
            _id: '3',
            incidentNumber: 'INC-00003',
            titleAr: 'سقوط من ارتفاع — حادثة قريبة',
  ...
  try {
    ...
    return {
      ...
      data: [
        {
          _id: '1',
          inspectionNumber: 'INSP-00001',
          titleAr: 'جولة تفتيش المصنع',
          area: 'المصنع أ',
        ...
        {
          _id: '2',
          inspectionNumber: 'INSP-00002',
          titleAr: 'تفتيش مفاجئ — المستودعات',
          area: 'المستودع ب',
