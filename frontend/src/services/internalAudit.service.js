  ...
  try {
    ...
    return {
      ...
      data: {
        ...
        recentAudits: [
          { _id: '1', planId: 'AP-2026-001', title: 'تدقيق الحسابات السنوي', status: 'completed', year: 2026 },
          { _id: '2', planId: 'AP-2026-002', title: 'تدقيق المشتريات', status: 'in_progress', year: 2026 },
          { _id: '3', planId: 'AP-2026-003', title: 'تدقيق الموارد البشرية', status: 'planned', year: 2026 },
        ],
      },
    };
  }
...
export const getAuditPlans = async (params = {}) => {
  try {
    ...
    return {
      success: true,
      data: [
        { _id: '1', planId: 'AP-2026-001', title: 'خطة التدقيق المالي', titleAr: 'خطة التدقيق المالي', year: 2026, status: 'approved', department: 'المالية', riskLevel: 'high' },
        { _id: '2', planId: 'AP-2026-002', title: 'خطة تدقيق المشتريات', titleAr: 'خطة تدقيق المشتريات', year: 2026, status: 'in_progress', department: 'المشتريات', riskLevel: 'medium' },
        { _id: '3', planId: 'AP-2026-003', title: 'خطة تدقيق الموارد البشرية', titleAr: 'خطة تدقيق الموارد البشرية', year: 2026, status: 'draft', department: 'الموارد البشرية', riskLevel: 'low' },
      ],
...
export const getFindings = async (params = {}) => {
  try {
    ...
    return {
      success: true,
      data: [
        { _id: '1', ncrId: 'NCR-001', title: 'خلل في إجراءات الدفع', titleAr: 'خلل في إجراءات الدفع', severity: 'major', status: 'open', department: 'المالية', auditPlan: 'AP-2026-001' },
        { _id: '2', ncrId: 'NCR-002', title: 'نقص في التوثيق', titleAr: 'نقص في التوثيق', severity: 'minor', status: 'corrective_action', department: 'المشتريات', auditPlan: 'AP-2026-002' },
        { _id: '3', ncrId: 'NCR-003', title: 'مخالفة سياسة الأمان', titleAr: 'مخالفة سياسة الأمان', severity: 'critical', status: 'closed', department: 'تقنية المعلومات', auditPlan: 'AP-2026-001' },
      ],
      pagination: { total: 3, page: 1, limit: 10 },
    };
  }
