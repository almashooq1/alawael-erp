...
export const meetingsService = {
  ...
  markAttendance: (id, attendeeId, data) =>
    api.patch(`${BASE}/meetings/${id}/attendees/${attendeeId}/attendance`, data).then(r => r.data),
  addCase: (id, data) => api.post(`${BASE}/meetings/${id}/cases`, data).then(r => r.data),
  updateCase: (id, caseId, data) =>
    api.patch(`${BASE}/meetings/${id}/cases/${caseId}`, data).then(r => r.data),
  addCaseDecision: (id, caseId, data) =>
    api.post(`${BASE}/meetings/${id}/cases/${caseId}/decisions`, data).then(r => r.data),
  addAgenda: (id, data) => api.post(`${BASE}/meetings/${id}/agenda`, data).then(r => r.data),
  getStats: () =>
    api
      .get(`${BASE}/meetings-stats`)
      .then(r => r.data)
      .catch(() => ({ data: {} })),
};
...
export const plansService = {
  ...
  removeTeamMember: (id, memberId) =>
    api.delete(`${BASE}/plans/${id}/team-members/${memberId}`).then(r => r.data),
  addGoal: (id, data) => api.post(`${BASE}/plans/${id}/goals`, data).then(r => r.data),
  updateGoal: (id, goalId, data) =>
    api.put(`${BASE}/plans/${id}/goals/${goalId}`, data).then(r => r.data),
  updateGoalProgress: (id, goalId, data) =>
    api.patch(`${BASE}/plans/${id}/goals/${goalId}/progress`, data).then(r => r.data),
...
export const dashboardService = {
  ...
  getTeamWorkload: () =>
    api
      .get(`${BASE}/dashboard/team-workload`)
      .then(r => r.data)
      .catch(() => ({ data: {} })),
  getDepartment: department =>
    api.get(`${BASE}/dashboard/department/${department}`).then(r => r.data),
  getOverdue: () =>
    api
      .get(`${BASE}/dashboard/overdue`)
      .then(r => r.data)
      .catch(() => ({ data: [] })),
};
...
export const minutesService = {
  create: (meetingId, data) =>
    api.post(`${BASE}/meetings/${meetingId}/minutes`, data).then(r => r.data),
  approve: (meetingId, data) =>
    api.post(`${BASE}/meetings/${meetingId}/minutes/approve`, data).then(r => r.data),
  addDecision: (meetingId, data) =>
    api.post(`${BASE}/meetings/${meetingId}/decisions`, data).then(r => r.data),
  updateDecisionStatus: (meetingId, decisionId, data) =>
    api
      .patch(`${BASE}/meetings/${meetingId}/decisions/${decisionId}/status`, data)
      .then(r => r.data),
  addActionItem: (meetingId, data) =>
    api.post(`${BASE}/meetings/${meetingId}/action-items`, data).then(r => r.data),
  updateActionItemStatus: (meetingId, itemId, data) =>
    api
      .patch(`${BASE}/meetings/${meetingId}/action-items/${itemId}/status`, data)
      .then(r => r.data),
};
...
export const trackersService = {
  getDecisions: () =>
    api
      .get(`${BASE}/decisions-tracker`)
      .then(r => r.data)
      .catch(() => ({ data: [] })),
  getActionItems: () =>
    api
      .get(`${BASE}/action-items-tracker`)
      .then(r => r.data)
      .catch(() => ({ data: [] })),
  getStats: () =>
    api
