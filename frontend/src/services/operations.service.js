...
const operationsService = {
  ...
  getAssets: async () => api.get('/assets').then(r => r.data).catch(() => []),
  getAsset: async id => api.get(`/assets/${id}`).then(r => r.data).catch(() => null),
  ...
  getMaintenance: async () => api.get('/maintenance').then(r => r.data).catch(() => []),
  getMaintenanceById: async id => api.get(`/maintenance/${id}`).then(r => r.data).catch(() => null),
  ...
  // Schedules
  getSchedules: async () => api.get('/schedules').then(r => r.data).catch(() => []),
  getSchedule: async id => api.get(`/schedules/${id}`).then(r => r.data).catch(() => null),
  ...
  // Branches
  getBranches: async () => api.get('/branches').then(r => r.data).catch(() => []),
  getBranch: async id => api.get(`/branches/${id}`).then(r => r.data).catch(() => null),
  ...
  getMaintenanceRequests: async () => api.get('/maintenance').then(r => r.data).catch(() => []),
  getMaintenanceRequest: async id => api.get(`/maintenance/${id}`).then(r => r.data).catch(() => null),
  createMaintenanceRequest: async data => api.post('/maintenance', data).then(r => r.data),
  updateMaintenanceRequest: async (id, data) => api.put(`/maintenance/${id}`, data).then(r => r.data),
