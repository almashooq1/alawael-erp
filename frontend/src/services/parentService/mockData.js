...
/**
 * Mock data fallback functions for Parent Portal Service
 * Extracted from parentService.js for maintainability
 */
...
export function getMockChildrenProgress() {
  return {
    children: [
      {
        id: 'child001',
        ...
        achievements: [
          {
            ...
            date: '2025-01-10',
            color1: brandColors.accentGreen,
            color2: brandColors.accentTeal,
          },
          {
            id: 2,
            title: 'شهادة المثابرة',
            date: '2025-01-05',
            color1: brandColors.accentRose,
            color2: '#fee140',
          },
        ],
        improvedAreas: [
...
export function getMockAttendanceReports() {
  return {
    summaryStats: [
      { id: 1, value: '24', label: 'الجلسات المكتملة', color: statusColors.success },
      { id: 2, value: '95%', label: 'نسبة الحضور', color: statusColors.info },
      { id: 3, value: '1', label: 'جلسات منقطعة', color: statusColors.error },
      { id: 4, value: '2', label: 'جلسات متأخرة', color: statusColors.warning },
    ],
    attendanceRecords: [
      {
        id: 1,
...
export function getMockTherapistCommunications() {
  return {
    therapists: [
      {
        id: 'therapist001',
...
export function getMockPaymentsHistory() {
  return {
    summaryCards: [
      { id: 1, amount: '15,000 ر.س', label: 'إجمالي المدفوع', color: statusColors.success },
      { id: 2, amount: '3,000 ر.س', label: 'قيد الانتظار', color: statusColors.warning },
      { id: 3, amount: '500 ر.س', label: 'متأخر', color: statusColors.error },
      { id: 4, amount: '24', label: 'عدد الفواتير', color: statusColors.info },
    ],
    payments: [
      {
        id: 1,
...
export function getMockDocumentsReports() {
  return {
    stats: [
      { id: 1, value: '32', label: 'إجمالي المستندات', color: brandColors.primaryStart },
      { id: 2, value: '12', label: 'التقارير الطبية', color: brandColors.accentGreen },
      { id: 3, value: '15', label: 'الفحوصات', color: brandColors.accentAmber },
      { id: 4, value: '5', label: 'شهادات الإنجاز', color: brandColors.accentRose },
    ],
    folders: [
...
export function getMockAppointmentsScheduling() {
  return {
    stats: [
      { id: 1, value: '3', label: 'جلسات قادمة', color: brandColors.primaryStart },
      { id: 2, value: '24', label: 'جلسات مكتملة', color: statusColors.success },
      { id: 3, value: '95%', label: 'نسبة الحضور', color: statusColors.info },
      { id: 4, value: '8.5/10', label: 'متوسط الرضا', color: statusColors.warning },
    ],
    therapists: [
...
export function getMockParentMessages() {
  return {
    stats: [
      { id: 1, value: '12', label: 'رسائل جديدة', color: brandColors.primaryStart },
      { id: 2, value: '45', label: 'إجمالي الرسائل', color: statusColors.success },
      { id: 3, value: '8', label: 'إعلانات مهمة', color: statusColors.warning },
      { id: 4, value: '15', label: 'نقاشات فعالة', color: statusColors.info },
    ],
    inbox: [
      {
        id: 1,
        ...
        content:
          'السلام عليكم، أحمد أظهر تحسناً ملحوظاً في النطق الواضح. استمروا على نفس النهج في المنزل.',
        unread: true,
      },
      {
        id: 2,
        ...
        content:
          'الجلسة القادمة تم تأكيدها يوم الخميس الساعة 3:30 مساءً. الرجاء التأكد من الحضور في الوقت المحدد.',
        unread: true,
      },
    ],
    announcements: [
