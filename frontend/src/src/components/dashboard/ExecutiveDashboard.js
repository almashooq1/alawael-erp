          ...
          <Stack direction="row" justifyContent="space-between" alignItems="center">
            <Box sx={{ flex: 1 }}>
              ...
              <Stack direction="row" spacing={2}>
                <Chip label={`${risk.count} حالة`} size="small" sx={{ bgcolor: severityColors[risk.severity], color: 'white' }} />
      ...
      <Stack direction="row" justifyContent="space-between" alignItems="center" mb={4}>
        ...
        <Stack direction="row" spacing={2}>
          <FormControl size="small" sx={{ minWidth: 150 }}>
            ...
            <Select value={timeRange} onChange={e => setTimeRange(e.target.value)} label="الفترة الزمنية">
            ...
            <CardContent>
              ...
              <ResponsiveContainer width="100%" height={350}>
                <ComposedChart data={trends.costs}>
                  ...
                  <Line yAxisId="right" type="monotone" dataKey="total" stroke="#ff9800" strokeWidth={3} name="الإجمالي" />
                </ComposedChart>
              </ResponsiveContainer>
            </CardContent>
          </Card>
            ...
            <CardContent>
              ...
              <ResponsiveContainer width="100%" height={350}>
                ...
                >
                  ...
                  <Radar name="الأداء" dataKey="value" stroke="#667eea" fill="#667eea" fillOpacity={0.6} />
                  <RechartsTooltip />
                </RadarChart>
              </ResponsiveContainer>
            </CardContent>
          ...
          <Card sx={{ borderRadius: 3, boxShadow: 3 }}>
            <CardContent>
              ...
              <Alert severity="info" sx={{ mb: 2 }}>
                ...
                <Typography variant="body2">• {predictions.nextMonthExpiring} رخصة ستنتهي</Typography>
                <Typography variant="body2">• التكلفة المتوقعة: {predictions.nextMonthCost.toLocaleString('ar-SA')} ر.س</Typography>
              </Alert>
              ...
              <Stack direction="row" spacing={2}>
                <Chip label={`الامتثال: ${predictions.complianceTrend === 'improving' ? '⬆️ يتحسن' : '⬇️ يتراجع'}`} color="success" />
                <Chip label={`المخاطر: ${predictions.riskTrend === 'decreasing' ? '⬇️ تتناقص' : '⬆️ تتزايد'}`} color="success" />
              </Stack>
            </CardContent>
          </Card>
        </Grid>
