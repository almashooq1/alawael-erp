...
import {
  detectProcessPatterns,
  identifySuccessfulSequences,
  predictProcessDurationFromPatterns,
  analyzeStepImpact,
} from '../models/process.patterns';
...
router.get('/predict-duration', (_req, res) => {
...
router.get('/step-impact', (_req, res) => {
...
router.get('/patterns-analysis', (_req, res) => {
  const analysis = {
