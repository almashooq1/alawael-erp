...
function getAGI() {
    if (!agiInstance) {
        agiInstance = new agi_core_1.default({
...
router.get('/status', (req, res) => {
    try {
        ...
        const health = monitoring_1.monitoring.getHealthStatus();
        const componentMetrics = monitoring_1.monitoring.getComponentMetrics();
        res.json({
            status: 'active',
            health: health,
...
router.get('/metrics', (req, res) => {
    try {
        const prometheusMetrics = monitoring_1.monitoring.exportPrometheus();
...
router.get('/report', (req, res) => {
    try {
        const report = monitoring_1.monitoring.generateReport();
