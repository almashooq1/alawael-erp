...
const disability_rehab_agi_1 = __importDefault(require("./specialized/disability-rehab-agi"));
const erp_integration_1 = __importDefault(require("./specialized/erp-integration"));
const router = express_1.default.Router();
// Initialize AGI and ERP Integration
const rehabAGI = new disability_rehab_agi_1.default();
const erpIntegration = new erp_integration_1.default({
 ...
 */
router.post('/beneficiary/suggest-program', async (req, res) => {
    try {
        const { beneficiaryId } = req.body;
        if (!beneficiaryId) {
            return res.status(400).json({
 ...
 */
router.post('/beneficiary/predict-progress', async (req, res) => {
    try {
 ...
 */
router.post('/program/analyze-effectiveness', async (req, res) => {
    try {
 ...
 */
router.post('/erp/sync-beneficiary', async (req, res) => {
    try {
 ...
 */
router.post('/erp/create-invoice', async (req, res) => {
    try {
 ...
 * تسجيل دفعة
 */
router.post('/erp/record-payment', async (req, res) => {
    try {
 ...
 * حجز موارد
 */
router.post('/erp/book-resource', async (req, res) => {
    try {
 ...
 */
router.get('/erp/financial-summary/:beneficiaryId', async (req, res) => {
    try {
 ...
 */
router.get('/erp/schedule', async (req, res) => {
    try {
        const { date, therapistId, programType, location } = req.query;
        const schedule = await erpIntegration.getSchedule(new Date(date), {
 ...
 * تحديث حالة الجلسة
 */
router.put('/erp/session/:sessionId/status', async (req, res) => {
    try {
 ...
 * إرسال إشعار
 */
router.post('/erp/send-notification', async (req, res) => {
    try {
 ...
 */
router.post('/erp/analyze-data', async (req, res) => {
    try {
 ...
 * مزامنة شاملة مع ERP
 */
router.post('/erp/full-sync', async (req, res) => {
    try {
