...
const agi_routes_1 = __importDefault(require("./agi.routes"));
const rehab_agi_routes_1 = __importDefault(require("./rehab-agi.routes"));
...
// Routes
app.use('/api/agi', agi_routes_1.default);
app.use('/api/rehab-agi', rehab_agi_routes_1.default); // نظام مراكز التأهيل
// Health check
...
app.listen(PORT, () => {
    // Start monitoring
    monitoring_1.monitoring.startMonitoring(60000); // Check health every 60 seconds
    console.log('');
    console.log('🧠 ═══════════════════════════════════════════════════════');
