...
exports.apiKeyRateLimiter = exports.globalRateLimiter = exports.UserTier = void 0;
exports.userRateLimiter = userRateLimiter;
exports.endpointRateLimiter = endpointRateLimiter;
exports.concurrentRequestsLimiter = concurrentRequestsLimiter;
exports.getRateLimitStatus = getRateLimitStatus;
const express_rate_limit_1 = __importDefault(require("express-rate-limit"));
const rate_limit_redis_1 = __importDefault(require("rate-limit-redis"));
const ioredis_1 = __importDefault(require("ioredis"));
const logger_1 = require("../utils/logger");
const logger = (0, logger_1.createLogger)('RateLimiting');
 ...
 */
function getRateLimitKey(req, window) {
    const user = req.user;
 ...
 */
function userRateLimiter(window) {
 ...
 */
function endpointRateLimiter(endpoint, maxRequests, windowMs = 60 * 1000) {
...
function concurrentRequestsLimiter(req, res, next) {
    const tier = getUserTier(req);
    const limits = tierLimits[tier];
    const user = req.user;
    const userId = user?.id || req.ip;
