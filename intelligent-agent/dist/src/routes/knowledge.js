...
const knowledge = new maintenance_knowledge_1.MaintenanceKnowledge();
// List all articles
router.get('/', sanitizeInput, (req, res) => {
    res.json(knowledge.listArticles());
});
// Get single article
router.get('/:id', sanitizeInput, commonValidations.requiredString('id', 1, 64), handleValidationErrors, (req, res) => {
...
// Delete article
router.delete('/:id', sanitizeInput, commonValidations.requiredString('id', 1, 64), handleValidationErrors, (req, res) => {
...
// Search articles
router.get('/search/:query', sanitizeInput, commonValidations.requiredString('query', 1, 100), handleValidationErrors, (req, res) => {
