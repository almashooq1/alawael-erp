/**
 * Auto-generated test for src/auth-middleware.ts
 * Source: src/auth-middleware.ts (14 lines, type: middleware)
...
const SRC_PATH = path.resolve(__dirname, '../../src/auth-middleware.ts');

describe('src/auth-middleware.ts', () => {
  let src: string;
