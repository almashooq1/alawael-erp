/**
 * Auto-generated test for backend/agi/agi.core.ts
 * Source: backend/agi/agi.core.ts (675 lines, type: agi)
...
const SRC_PATH = path.resolve(__dirname, '../../backend/agi/agi.core.ts');

describe('backend/agi/agi.core.ts', () => {
  let src: string;
