/**
 * Auto-generated test for backend/agi/agi.routes.ts
 * Source: backend/agi/agi.routes.ts (492 lines, type: route)
...
const SRC_PATH = path.resolve(__dirname, '../../backend/agi/agi.routes.ts');

describe('backend/agi/agi.routes.ts', () => {
  let src: string;
