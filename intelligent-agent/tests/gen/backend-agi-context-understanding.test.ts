/**
 * Auto-generated test for backend/agi/context.understanding.ts
 * Source: backend/agi/context.understanding.ts (757 lines, type: module)
...
const SRC_PATH = path.resolve(__dirname, '../../backend/agi/context.understanding.ts');

describe('backend/agi/context.understanding.ts', () => {
  let src: string;
