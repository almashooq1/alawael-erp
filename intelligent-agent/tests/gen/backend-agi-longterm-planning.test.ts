/**
 * Auto-generated test for backend/agi/longterm.planning.ts
 * Source: backend/agi/longterm.planning.ts (624 lines, type: module)
...
const SRC_PATH = path.resolve(__dirname, '../../backend/agi/longterm.planning.ts');

describe('backend/agi/longterm.planning.ts', () => {
  let src: string;
