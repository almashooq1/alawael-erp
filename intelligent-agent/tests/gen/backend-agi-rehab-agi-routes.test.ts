/**
 * Auto-generated test for backend/agi/rehab-agi.routes.ts
 * Source: backend/agi/rehab-agi.routes.ts (598 lines, type: route)
...
const SRC_PATH = path.resolve(__dirname, '../../backend/agi/rehab-agi.routes.ts');

describe('backend/agi/rehab-agi.routes.ts', () => {
  let src: string;
