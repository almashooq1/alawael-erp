/**
 * Auto-generated test for backend/app.ts
 * Source: backend/app.ts (359 lines, type: module)
...
const SRC_PATH = path.resolve(__dirname, '../../backend/app.ts');

describe('backend/app.ts', () => {
  let src: string;
