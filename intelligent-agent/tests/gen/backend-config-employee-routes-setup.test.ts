/**
 * Auto-generated test for backend/config/employee-routes-setup.ts
 * Source: backend/config/employee-routes-setup.ts (189 lines, type: route)
...
const SRC_PATH = path.resolve(__dirname, '../../backend/config/employee-routes-setup.ts');

describe('backend/config/employee-routes-setup.ts', () => {
  let src: string;
