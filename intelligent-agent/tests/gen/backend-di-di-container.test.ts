/**
 * Auto-generated test for backend/di/di-container.ts
 * Source: backend/di/di-container.ts (101 lines, type: module)
...
const SRC_PATH = path.resolve(__dirname, '../../backend/di/di-container.ts');

describe('backend/di/di-container.ts', () => {
  let src: string;
