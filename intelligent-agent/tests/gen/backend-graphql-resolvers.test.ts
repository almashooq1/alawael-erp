/**
 * Auto-generated test for backend/graphql/resolvers.ts
 * Source: backend/graphql/resolvers.ts (522 lines, type: module)
...
const SRC_PATH = path.resolve(__dirname, '../../backend/graphql/resolvers.ts');

describe('backend/graphql/resolvers.ts', () => {
  let src: string;
