/**
 * Auto-generated test for backend/graphql-risk.ts
 * Source: backend/graphql-risk.ts (71 lines, type: graphql)
...
const SRC_PATH = path.resolve(__dirname, '../../backend/graphql-risk.ts');

describe('backend/graphql-risk.ts', () => {
  let src: string;
