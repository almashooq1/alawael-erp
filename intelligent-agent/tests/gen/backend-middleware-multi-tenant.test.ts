/**
 * Auto-generated test for backend/middleware/multi-tenant.ts
 * Source: backend/middleware/multi-tenant.ts (382 lines, type: module)
...
const SRC_PATH = path.resolve(__dirname, '../../backend/middleware/multi-tenant.ts');

describe('backend/middleware/multi-tenant.ts', () => {
  let src: string;
