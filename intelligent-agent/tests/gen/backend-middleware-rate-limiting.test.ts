/**
 * Auto-generated test for backend/middleware/rate-limiting.ts
 * Source: backend/middleware/rate-limiting.ts (369 lines, type: module)
...
const SRC_PATH = path.resolve(__dirname, '../../backend/middleware/rate-limiting.ts');

describe('backend/middleware/rate-limiting.ts', () => {
  let src: string;
