/**
 * Auto-generated test for backend/middleware/versioning.ts
 * Source: backend/middleware/versioning.ts (316 lines, type: module)
...
const SRC_PATH = path.resolve(__dirname, '../../backend/middleware/versioning.ts');

describe('backend/middleware/versioning.ts', () => {
  let src: string;
