/**
 * Auto-generated test for backend/ml-server.ts
 * Source: backend/ml-server.ts (178 lines, type: module)
...
const SRC_PATH = path.resolve(__dirname, '../../backend/ml-server.ts');

describe('backend/ml-server.ts', () => {
  let src: string;
