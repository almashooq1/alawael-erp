/**
 * Auto-generated test for backend/models/crm.customer.model.ts
 * Source: backend/models/crm.customer.model.ts (26 lines, type: model)
...
const SRC_PATH = path.resolve(__dirname, '../../backend/models/crm.customer.model.ts');

describe('backend/models/crm.customer.model.ts', () => {
  let src: string;
