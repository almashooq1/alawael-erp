/**
 * Auto-generated test for backend/models/crm.opportunity.model.ts
 * Source: backend/models/crm.opportunity.model.ts (30 lines, type: model)
...
const SRC_PATH = path.resolve(__dirname, '../../backend/models/crm.opportunity.model.ts');

describe('backend/models/crm.opportunity.model.ts', () => {
  let src: string;
