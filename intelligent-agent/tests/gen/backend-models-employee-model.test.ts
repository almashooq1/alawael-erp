/**
 * Auto-generated test for backend/models/employee.model.ts
 * Source: backend/models/employee.model.ts (439 lines, type: model)
...
const SRC_PATH = path.resolve(__dirname, '../../backend/models/employee.model.ts');

describe('backend/models/employee.model.ts', () => {
  let src: string;
