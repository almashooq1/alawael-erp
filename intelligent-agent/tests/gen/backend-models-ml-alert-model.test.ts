/**
 * Auto-generated test for backend/models/ml.alert.model.ts
 * Source: backend/models/ml.alert.model.ts (37 lines, type: model)
...
const SRC_PATH = path.resolve(__dirname, '../../backend/models/ml.alert.model.ts');

describe('backend/models/ml.alert.model.ts', () => {
  let src: string;
