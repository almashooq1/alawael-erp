/**
 * Auto-generated test for backend/models/ml.drift.model.ts
 * Source: backend/models/ml.drift.model.ts (53 lines, type: model)
...
const SRC_PATH = path.resolve(__dirname, '../../backend/models/ml.drift.model.ts');

describe('backend/models/ml.drift.model.ts', () => {
  let src: string;
