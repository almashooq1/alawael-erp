/**
 * Auto-generated test for backend/models/ml.feedback.model.ts
 * Source: backend/models/ml.feedback.model.ts (33 lines, type: model)
...
const SRC_PATH = path.resolve(__dirname, '../../backend/models/ml.feedback.model.ts');

describe('backend/models/ml.feedback.model.ts', () => {
  let src: string;
