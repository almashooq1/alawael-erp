/**
 * Auto-generated test for backend/models/process.analytics.new.ts
 * Source: backend/models/process.analytics.new.ts (152 lines, type: module)
...
const SRC_PATH = path.resolve(__dirname, '../../backend/models/process.analytics.new.ts');

describe('backend/models/process.analytics.new.ts', () => {
  let src: string;
