/**
 * Auto-generated test for backend/models/process.analytics.ts
 * Source: backend/models/process.analytics.ts (30 lines, type: module)
...
const SRC_PATH = path.resolve(__dirname, '../../backend/models/process.analytics.ts');

describe('backend/models/process.analytics.ts', () => {
  let src: string;
