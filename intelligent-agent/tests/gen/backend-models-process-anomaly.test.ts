/**
 * Auto-generated test for backend/models/process.anomaly.ts
 * Source: backend/models/process.anomaly.ts (342 lines, type: module)
...
const SRC_PATH = path.resolve(__dirname, '../../backend/models/process.anomaly.ts');

describe('backend/models/process.anomaly.ts', () => {
  let src: string;
