/**
 * Auto-generated test for backend/models/process.automation.ts
 * Source: backend/models/process.automation.ts (161 lines, type: module)
...
const SRC_PATH = path.resolve(__dirname, '../../backend/models/process.automation.ts');

describe('backend/models/process.automation.ts', () => {
  let src: string;
