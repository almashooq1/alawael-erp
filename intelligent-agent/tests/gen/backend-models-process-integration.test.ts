/**
 * Auto-generated test for backend/models/process.integration.ts
 * Source: backend/models/process.integration.ts (39 lines, type: module)
...
const SRC_PATH = path.resolve(__dirname, '../../backend/models/process.integration.ts');

describe('backend/models/process.integration.ts', () => {
  let src: string;
