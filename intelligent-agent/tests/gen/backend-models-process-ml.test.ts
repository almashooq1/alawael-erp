/**
 * Auto-generated test for backend/models/process.ml.ts
 * Source: backend/models/process.ml.ts (354 lines, type: module)
...
const SRC_PATH = path.resolve(__dirname, '../../backend/models/process.ml.ts');

describe('backend/models/process.ml.ts', () => {
  let src: string;
