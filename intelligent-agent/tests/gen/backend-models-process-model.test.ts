/**
 * Auto-generated test for backend/models/process.model.ts
 * Source: backend/models/process.model.ts (42 lines, type: model)
...
const SRC_PATH = path.resolve(__dirname, '../../backend/models/process.model.ts');

describe('backend/models/process.model.ts', () => {
  let src: string;
