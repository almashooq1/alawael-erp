/**
 * Auto-generated test for backend/models/process.nlp.ts
 * Source: backend/models/process.nlp.ts (40 lines, type: module)
...
const SRC_PATH = path.resolve(__dirname, '../../backend/models/process.nlp.ts');

describe('backend/models/process.nlp.ts', () => {
  let src: string;
