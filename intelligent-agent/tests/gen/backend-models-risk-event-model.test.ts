/**
 * Auto-generated test for backend/models/risk.event.model.ts
 * Source: backend/models/risk.event.model.ts (22 lines, type: model)
...
const SRC_PATH = path.resolve(__dirname, '../../backend/models/risk.event.model.ts');

describe('backend/models/risk.event.model.ts', () => {
  let src: string;
