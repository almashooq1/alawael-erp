/**
 * Auto-generated test for backend/models/risk.model.ts
 * Source: backend/models/risk.model.ts (41 lines, type: model)
...
const SRC_PATH = path.resolve(__dirname, '../../backend/models/risk.model.ts');

describe('backend/models/risk.model.ts', () => {
  let src: string;
