/**
 * Auto-generated test for backend/routes/ai.analytics.routes.ts
 * Source: backend/routes/ai.analytics.routes.ts (100 lines, type: route)
...
const SRC_PATH = path.resolve(__dirname, '../../backend/routes/ai.analytics.routes.ts');

describe('backend/routes/ai.analytics.routes.ts', () => {
  let src: string;
