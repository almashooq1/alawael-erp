/**
 * Auto-generated test for backend/routes/ai.automation.routes.ts
 * Source: backend/routes/ai.automation.routes.ts (73 lines, type: route)
...
const SRC_PATH = path.resolve(__dirname, '../../backend/routes/ai.automation.routes.ts');

describe('backend/routes/ai.automation.routes.ts', () => {
  let src: string;
