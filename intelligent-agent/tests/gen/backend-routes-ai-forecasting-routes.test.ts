/**
 * Auto-generated test for backend/routes/ai.forecasting.routes.ts
 * Source: backend/routes/ai.forecasting.routes.ts (234 lines, type: route)
...
const SRC_PATH = path.resolve(__dirname, '../../backend/routes/ai.forecasting.routes.ts');

describe('backend/routes/ai.forecasting.routes.ts', () => {
  let src: string;
