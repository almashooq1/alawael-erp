/**
 * Auto-generated test for backend/routes/ai.ml.routes.ts
 * Source: backend/routes/ai.ml.routes.ts (72 lines, type: route)
...
const SRC_PATH = path.resolve(__dirname, '../../backend/routes/ai.ml.routes.ts');

describe('backend/routes/ai.ml.routes.ts', () => {
  let src: string;
