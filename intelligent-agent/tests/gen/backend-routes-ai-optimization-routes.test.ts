/**
 * Auto-generated test for backend/routes/ai.optimization.routes.ts
 * Source: backend/routes/ai.optimization.routes.ts (103 lines, type: route)
...
const SRC_PATH = path.resolve(__dirname, '../../backend/routes/ai.optimization.routes.ts');

describe('backend/routes/ai.optimization.routes.ts', () => {
  let src: string;
