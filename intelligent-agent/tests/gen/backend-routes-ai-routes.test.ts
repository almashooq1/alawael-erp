/**
 * Auto-generated test for backend/routes/ai.routes.ts
 * Source: backend/routes/ai.routes.ts (49 lines, type: route)
...
const SRC_PATH = path.resolve(__dirname, '../../backend/routes/ai.routes.ts');

describe('backend/routes/ai.routes.ts', () => {
  let src: string;
