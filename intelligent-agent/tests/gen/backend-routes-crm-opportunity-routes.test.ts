/**
 * Auto-generated test for backend/routes/crm.opportunity.routes.ts
 * Source: backend/routes/crm.opportunity.routes.ts (66 lines, type: route)
...
const SRC_PATH = path.resolve(__dirname, '../../backend/routes/crm.opportunity.routes.ts');

describe('backend/routes/crm.opportunity.routes.ts', () => {
  let src: string;
