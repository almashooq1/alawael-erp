/**
 * Auto-generated test for backend/routes/employee-ai.routes.ts
 * Source: backend/routes/employee-ai.routes.ts (286 lines, type: route)
...
const SRC_PATH = path.resolve(__dirname, '../../backend/routes/employee-ai.routes.ts');

describe('backend/routes/employee-ai.routes.ts', () => {
  let src: string;
