/**
 * Auto-generated test for backend/routes/employee-analytics.routes.ts
 * Source: backend/routes/employee-analytics.routes.ts (370 lines, type: route)
...
const SRC_PATH = path.resolve(__dirname, '../../backend/routes/employee-analytics.routes.ts');

describe('backend/routes/employee-analytics.routes.ts', () => {
  let src: string;
