/**
 * Auto-generated test for backend/routes/employee-reports.routes.ts
 * Source: backend/routes/employee-reports.routes.ts (287 lines, type: route)
...
const SRC_PATH = path.resolve(__dirname, '../../backend/routes/employee-reports.routes.ts');

describe('backend/routes/employee-reports.routes.ts', () => {
  let src: string;
