/**
 * Auto-generated test for backend/routes/employee.routes.ts
 * Source: backend/routes/employee.routes.ts (462 lines, type: route)
...
const SRC_PATH = path.resolve(__dirname, '../../backend/routes/employee.routes.ts');

describe('backend/routes/employee.routes.ts', () => {
  let src: string;
