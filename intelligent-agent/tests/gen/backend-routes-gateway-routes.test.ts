/**
 * Auto-generated test for backend/routes/gateway.routes.ts
 * Source: backend/routes/gateway.routes.ts (45 lines, type: route)
...
const SRC_PATH = path.resolve(__dirname, '../../backend/routes/gateway.routes.ts');

describe('backend/routes/gateway.routes.ts', () => {
  let src: string;
