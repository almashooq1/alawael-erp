/**
 * Auto-generated test for backend/routes/ml.routes.ts
 * Source: backend/routes/ml.routes.ts (1238 lines, type: route)
...
const SRC_PATH = path.resolve(__dirname, '../../backend/routes/ml.routes.ts');

describe('backend/routes/ml.routes.ts', () => {
  let src: string;
