/**
 * Auto-generated test for backend/routes/notifications.routes.ts
 * Source: backend/routes/notifications.routes.ts (374 lines, type: route)
...
const SRC_PATH = path.resolve(__dirname, '../../backend/routes/notifications.routes.ts');

describe('backend/routes/notifications.routes.ts', () => {
  let src: string;
