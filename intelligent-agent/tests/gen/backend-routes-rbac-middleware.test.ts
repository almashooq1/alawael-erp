/**
 * Auto-generated test for backend/routes/rbac.middleware.ts
 * Source: backend/routes/rbac.middleware.ts (15 lines, type: middleware)
...
const SRC_PATH = path.resolve(__dirname, '../../backend/routes/rbac.middleware.ts');

describe('backend/routes/rbac.middleware.ts', () => {
  let src: string;
