/**
 * Auto-generated test for backend/routes/risk.attachments.routes.ts
 * Source: backend/routes/risk.attachments.routes.ts (40 lines, type: route)
...
const SRC_PATH = path.resolve(__dirname, '../../backend/routes/risk.attachments.routes.ts');

describe('backend/routes/risk.attachments.routes.ts', () => {
  let src: string;
