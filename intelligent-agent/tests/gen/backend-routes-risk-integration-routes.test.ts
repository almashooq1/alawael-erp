/**
 * Auto-generated test for backend/routes/risk.integration.routes.ts
 * Source: backend/routes/risk.integration.routes.ts (31 lines, type: route)
...
const SRC_PATH = path.resolve(__dirname, '../../backend/routes/risk.integration.routes.ts');

describe('backend/routes/risk.integration.routes.ts', () => {
  let src: string;
