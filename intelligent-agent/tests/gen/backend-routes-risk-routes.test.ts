/**
 * Auto-generated test for backend/routes/risk.routes.ts
 * Source: backend/routes/risk.routes.ts (126 lines, type: route)
...
const SRC_PATH = path.resolve(__dirname, '../../backend/routes/risk.routes.ts');

describe('backend/routes/risk.routes.ts', () => {
  let src: string;
