/**
 * Auto-generated test for backend/routes/saudi-dashboard.routes.ts
 * Source: backend/routes/saudi-dashboard.routes.ts (424 lines, type: route)
...
const SRC_PATH = path.resolve(__dirname, '../../backend/routes/saudi-dashboard.routes.ts');

describe('backend/routes/saudi-dashboard.routes.ts', () => {
  let src: string;
