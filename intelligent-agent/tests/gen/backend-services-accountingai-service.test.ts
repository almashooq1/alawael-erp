/**
 * Auto-generated test for backend/services/accountingAi.service.ts
 * Source: backend/services/accountingAi.service.ts (363 lines, type: service)
...
const SRC_PATH = path.resolve(__dirname, '../../backend/services/accountingAi.service.ts');

describe('backend/services/accountingAi.service.ts', () => {
  let src: string;
