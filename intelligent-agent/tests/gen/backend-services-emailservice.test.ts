/**
 * Auto-generated test for backend/services/EmailService.ts
 * Source: backend/services/EmailService.ts (298 lines, type: service)
...
const SRC_PATH = path.resolve(__dirname, '../../backend/services/EmailService.ts');

describe('backend/services/EmailService.ts', () => {
  let src: string;
