/**
 * Auto-generated test for backend/services/employee-reports.service.ts
 * Source: backend/services/employee-reports.service.ts (416 lines, type: service)
...
const SRC_PATH = path.resolve(__dirname, '../../backend/services/employee-reports.service.ts');

describe('backend/services/employee-reports.service.ts', () => {
  let src: string;
