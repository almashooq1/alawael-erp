/**
 * Auto-generated test for backend/services/financial-intelligence.service.ts
 * Source: backend/services/financial-intelligence.service.ts (649 lines, type: service)
...
const SRC_PATH = path.resolve(__dirname, '../../backend/services/financial-intelligence.service.ts');

describe('backend/services/financial-intelligence.service.ts', () => {
  let src: string;
