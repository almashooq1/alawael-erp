/**
 * Auto-generated test for backend/services/gatewayProxy.service.ts
 * Source: backend/services/gatewayProxy.service.ts (58 lines, type: service)
...
const SRC_PATH = path.resolve(__dirname, '../../backend/services/gatewayProxy.service.ts');

describe('backend/services/gatewayProxy.service.ts', () => {
  let src: string;
