/**
 * Auto-generated test for backend/services/ReportGenerator.ts
 * Source: backend/services/ReportGenerator.ts (320 lines, type: module)
...
const SRC_PATH = path.resolve(__dirname, '../../backend/services/ReportGenerator.ts');

describe('backend/services/ReportGenerator.ts', () => {
  let src: string;
