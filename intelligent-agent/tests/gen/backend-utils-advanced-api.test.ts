/**
 * Auto-generated test for backend/utils/advanced.api.ts
 * Source: backend/utils/advanced.api.ts (579 lines, type: api)
...
const SRC_PATH = path.resolve(__dirname, '../../backend/utils/advanced.api.ts');

describe('backend/utils/advanced.api.ts', () => {
  let src: string;
