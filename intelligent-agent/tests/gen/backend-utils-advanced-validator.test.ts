/**
 * Auto-generated test for backend/utils/advanced.validator.ts
 * Source: backend/utils/advanced.validator.ts (418 lines, type: module)
...
const SRC_PATH = path.resolve(__dirname, '../../backend/utils/advanced.validator.ts');

describe('backend/utils/advanced.validator.ts', () => {
  let src: string;
