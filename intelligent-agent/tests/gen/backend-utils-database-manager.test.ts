/**
 * Auto-generated test for backend/utils/database.manager.ts
 * Source: backend/utils/database.manager.ts (515 lines, type: module)
...
const SRC_PATH = path.resolve(__dirname, '../../backend/utils/database.manager.ts');

describe('backend/utils/database.manager.ts', () => {
  let src: string;
