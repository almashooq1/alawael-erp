/**
 * Auto-generated test for backend/utils/database.migrations.ts
 * Source: backend/utils/database.migrations.ts (390 lines, type: module)
...
const SRC_PATH = path.resolve(__dirname, '../../backend/utils/database.migrations.ts');

describe('backend/utils/database.migrations.ts', () => {
  let src: string;
