/**
 * Auto-generated test for backend/utils/database.seeder.ts
 * Source: backend/utils/database.seeder.ts (284 lines, type: module)
...
const SRC_PATH = path.resolve(__dirname, '../../backend/utils/database.seeder.ts');

describe('backend/utils/database.seeder.ts', () => {
  let src: string;
