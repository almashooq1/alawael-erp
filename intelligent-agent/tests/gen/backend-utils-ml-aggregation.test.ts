/**
 * Auto-generated test for backend/utils/ml.aggregation.ts
 * Source: backend/utils/ml.aggregation.ts (434 lines, type: module)
...
const SRC_PATH = path.resolve(__dirname, '../../backend/utils/ml.aggregation.ts');

describe('backend/utils/ml.aggregation.ts', () => {
  let src: string;
