/**
 * Auto-generated test for backend/utils/ml.export.ts
 * Source: backend/utils/ml.export.ts (297 lines, type: exporter)
...
const SRC_PATH = path.resolve(__dirname, '../../backend/utils/ml.export.ts');

describe('backend/utils/ml.export.ts', () => {
  let src: string;
