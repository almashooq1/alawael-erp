/**
 * Auto-generated test for backend/vitest.config.ts
 * Source: backend/vitest.config.ts (19 lines, type: config)
...
const SRC_PATH = path.resolve(__dirname, '../../backend/vitest.config.ts');

describe('backend/vitest.config.ts', () => {
  let src: string;
