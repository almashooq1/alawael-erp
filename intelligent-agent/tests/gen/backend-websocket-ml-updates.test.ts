/**
 * Auto-generated test for backend/websocket/ml-updates.ts
 * Source: backend/websocket/ml-updates.ts (226 lines, type: module)
...
const SRC_PATH = path.resolve(__dirname, '../../backend/websocket/ml-updates.ts');

describe('backend/websocket/ml-updates.ts', () => {
  let src: string;
