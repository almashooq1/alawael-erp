/**
 * Auto-generated test for backend/workers/processors.ts
 * Source: backend/workers/processors.ts (327 lines, type: module)
...
const SRC_PATH = path.resolve(__dirname, '../../backend/workers/processors.ts');

describe('backend/workers/processors.ts', () => {
  let src: string;
