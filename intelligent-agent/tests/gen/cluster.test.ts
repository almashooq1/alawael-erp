/**
 * Auto-generated test for src/cluster.ts
 * Source: src/cluster.ts (19 lines, type: module)
...
const SRC_PATH = path.resolve(__dirname, '../../src/cluster.ts');

describe('src/cluster.ts', () => {
  let src: string;
