/**
 * Auto-generated test for src/config/swagger.ts
 * Source: src/config/swagger.ts (269 lines, type: config)
...
const SRC_PATH = path.resolve(__dirname, '../../src/config/swagger.ts');

describe('src/config/swagger.ts', () => {
  let src: string;
