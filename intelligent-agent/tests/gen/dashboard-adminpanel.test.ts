/**
 * Auto-generated test for dashboard/AdminPanel.tsx
 * Source: dashboard/AdminPanel.tsx (44 lines, type: component)
...
const SRC_PATH = path.resolve(__dirname, '../../dashboard/AdminPanel.tsx');

describe('dashboard/AdminPanel.tsx', () => {
  let src: string;
