/**
 * Auto-generated test for dashboard/archive-old-contracts-scheduler.ts
 * Source: dashboard/archive-old-contracts-scheduler.ts (27 lines, type: component)
...
const SRC_PATH = path.resolve(__dirname, '../../dashboard/archive-old-contracts-scheduler.ts');

describe('dashboard/archive-old-contracts-scheduler.ts', () => {
  let src: string;
