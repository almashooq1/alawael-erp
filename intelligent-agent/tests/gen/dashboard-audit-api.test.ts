/**
 * Auto-generated test for dashboard/audit-api.ts
 * Source: dashboard/audit-api.ts (18 lines, type: component)
...
const SRC_PATH = path.resolve(__dirname, '../../dashboard/audit-api.ts');

describe('dashboard/audit-api.ts', () => {
  let src: string;
