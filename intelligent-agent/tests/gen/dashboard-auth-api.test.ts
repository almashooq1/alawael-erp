/**
 * Auto-generated test for dashboard/auth-api.ts
 * Source: dashboard/auth-api.ts (31 lines, type: component)
...
const SRC_PATH = path.resolve(__dirname, '../../dashboard/auth-api.ts');

describe('dashboard/auth-api.ts', () => {
  let src: string;
