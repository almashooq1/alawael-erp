/**
 * Auto-generated test for dashboard/box-api.ts
 * Source: dashboard/box-api.ts (29 lines, type: component)
...
const SRC_PATH = path.resolve(__dirname, '../../dashboard/box-api.ts');

describe('dashboard/box-api.ts', () => {
  let src: string;
