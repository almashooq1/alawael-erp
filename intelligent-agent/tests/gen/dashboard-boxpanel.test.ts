/**
 * Auto-generated test for dashboard/BoxPanel.tsx
 * Source: dashboard/BoxPanel.tsx (38 lines, type: component)
...
const SRC_PATH = path.resolve(__dirname, '../../dashboard/BoxPanel.tsx');

describe('dashboard/BoxPanel.tsx', () => {
  let src: string;
