/**
 * Auto-generated test for dashboard/contract-activity-api.ts
 * Source: dashboard/contract-activity-api.ts (19 lines, type: component)
...
const SRC_PATH = path.resolve(__dirname, '../../dashboard/contract-activity-api.ts');

describe('dashboard/contract-activity-api.ts', () => {
  let src: string;
