/**
 * Auto-generated test for dashboard/contract-api.ts
 * Source: dashboard/contract-api.ts (103 lines, type: component)
...
const SRC_PATH = path.resolve(__dirname, '../../dashboard/contract-api.ts');

describe('dashboard/contract-api.ts', () => {
  let src: string;
