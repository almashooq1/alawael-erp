/**
 * Auto-generated test for dashboard/contract-file-api.ts
 * Source: dashboard/contract-file-api.ts (25 lines, type: component)
...
const SRC_PATH = path.resolve(__dirname, '../../dashboard/contract-file-api.ts');

describe('dashboard/contract-file-api.ts', () => {
  let src: string;
