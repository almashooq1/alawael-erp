/**
 * Auto-generated test for dashboard/contract-reports-api.ts
 * Source: dashboard/contract-reports-api.ts (10 lines, type: component)
...
const SRC_PATH = path.resolve(__dirname, '../../dashboard/contract-reports-api.ts');

describe('dashboard/contract-reports-api.ts', () => {
  let src: string;
