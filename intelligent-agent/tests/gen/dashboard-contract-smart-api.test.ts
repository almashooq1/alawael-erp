/**
 * Auto-generated test for dashboard/contract-smart-api.ts
 * Source: dashboard/contract-smart-api.ts (15 lines, type: component)
...
const SRC_PATH = path.resolve(__dirname, '../../dashboard/contract-smart-api.ts');

describe('dashboard/contract-smart-api.ts', () => {
  let src: string;
