/**
 * Auto-generated test for dashboard/ContractPanel.tsx
 * Source: dashboard/ContractPanel.tsx (152 lines, type: component)
...
const SRC_PATH = path.resolve(__dirname, '../../dashboard/ContractPanel.tsx');

describe('dashboard/ContractPanel.tsx', () => {
  let src: string;
