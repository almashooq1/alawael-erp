/**
 * Auto-generated test for dashboard/ContractSmartPanel.tsx
 * Source: dashboard/ContractSmartPanel.tsx (23 lines, type: component)
...
const SRC_PATH = path.resolve(__dirname, '../../dashboard/ContractSmartPanel.tsx');

describe('dashboard/ContractSmartPanel.tsx', () => {
  let src: string;
