/**
 * Auto-generated test for dashboard/custom-reports-api.ts
 * Source: dashboard/custom-reports-api.ts (34 lines, type: component)
...
const SRC_PATH = path.resolve(__dirname, '../../dashboard/custom-reports-api.ts');

describe('dashboard/custom-reports-api.ts', () => {
  let src: string;
