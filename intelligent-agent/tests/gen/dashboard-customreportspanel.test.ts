/**
 * Auto-generated test for dashboard/CustomReportsPanel.tsx
 * Source: dashboard/CustomReportsPanel.tsx (39 lines, type: component)
...
const SRC_PATH = path.resolve(__dirname, '../../dashboard/CustomReportsPanel.tsx');

describe('dashboard/CustomReportsPanel.tsx', () => {
  let src: string;
