/**
 * Auto-generated test for dashboard/dropbox-api.ts
 * Source: dashboard/dropbox-api.ts (26 lines, type: component)
...
const SRC_PATH = path.resolve(__dirname, '../../dashboard/dropbox-api.ts');

describe('dashboard/dropbox-api.ts', () => {
  let src: string;
