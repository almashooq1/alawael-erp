/**
 * Auto-generated test for dashboard/DropboxPanel.tsx
 * Source: dashboard/DropboxPanel.tsx (29 lines, type: component)
...
const SRC_PATH = path.resolve(__dirname, '../../dashboard/DropboxPanel.tsx');

describe('dashboard/DropboxPanel.tsx', () => {
  let src: string;
