/**
 * Auto-generated test for dashboard/exporters.ts
 * Source: dashboard/exporters.ts (36 lines, type: component)
...
const SRC_PATH = path.resolve(__dirname, '../../dashboard/exporters.ts');

describe('dashboard/exporters.ts', () => {
  let src: string;
