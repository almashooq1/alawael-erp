/**
 * Auto-generated test for dashboard/ExportFieldsSelector.tsx
 * Source: dashboard/ExportFieldsSelector.tsx (33 lines, type: component)
...
const SRC_PATH = path.resolve(__dirname, '../../dashboard/ExportFieldsSelector.tsx');

describe('dashboard/ExportFieldsSelector.tsx', () => {
  let src: string;
