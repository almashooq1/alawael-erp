/**
 * Auto-generated test for dashboard/gdrive-api.ts
 * Source: dashboard/gdrive-api.ts (28 lines, type: component)
...
const SRC_PATH = path.resolve(__dirname, '../../dashboard/gdrive-api.ts');

describe('dashboard/gdrive-api.ts', () => {
  let src: string;
