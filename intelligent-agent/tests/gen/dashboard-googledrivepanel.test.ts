/**
 * Auto-generated test for dashboard/GoogleDrivePanel.tsx
 * Source: dashboard/GoogleDrivePanel.tsx (34 lines, type: component)
...
const SRC_PATH = path.resolve(__dirname, '../../dashboard/GoogleDrivePanel.tsx');

describe('dashboard/GoogleDrivePanel.tsx', () => {
  let src: string;
