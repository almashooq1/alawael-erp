/**
 * Auto-generated test for dashboard/notification-api.ts
 * Source: dashboard/notification-api.ts (22 lines, type: component)
...
const SRC_PATH = path.resolve(__dirname, '../../dashboard/notification-api.ts');

describe('dashboard/notification-api.ts', () => {
  let src: string;
