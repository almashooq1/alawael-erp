/**
 * Auto-generated test for dashboard/NotificationPanel.tsx
 * Source: dashboard/NotificationPanel.tsx (17 lines, type: component)
...
const SRC_PATH = path.resolve(__dirname, '../../dashboard/NotificationPanel.tsx');

describe('dashboard/NotificationPanel.tsx', () => {
  let src: string;
