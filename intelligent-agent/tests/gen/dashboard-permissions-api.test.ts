/**
 * Auto-generated test for dashboard/permissions-api.ts
 * Source: dashboard/permissions-api.ts (32 lines, type: component)
...
const SRC_PATH = path.resolve(__dirname, '../../dashboard/permissions-api.ts');

describe('dashboard/permissions-api.ts', () => {
  let src: string;
