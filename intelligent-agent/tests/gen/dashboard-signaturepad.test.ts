/**
 * Auto-generated test for dashboard/SignaturePad.tsx
 * Source: dashboard/SignaturePad.tsx (36 lines, type: component)
...
const SRC_PATH = path.resolve(__dirname, '../../dashboard/SignaturePad.tsx');

describe('dashboard/SignaturePad.tsx', () => {
  let src: string;
