/**
 * Auto-generated test for dashboard/sources-api.ts
 * Source: dashboard/sources-api.ts (35 lines, type: component)
...
const SRC_PATH = path.resolve(__dirname, '../../dashboard/sources-api.ts');

describe('dashboard/sources-api.ts', () => {
  let src: string;
