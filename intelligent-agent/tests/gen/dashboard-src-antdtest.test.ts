/**
 * Auto-generated test for dashboard/src/AntdTest.tsx
 * Source: dashboard/src/AntdTest.tsx (7 lines, type: component)
...
const SRC_PATH = path.resolve(__dirname, '../../dashboard/src/AntdTest.tsx');

describe('dashboard/src/AntdTest.tsx', () => {
  let src: string;
