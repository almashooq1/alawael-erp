/**
 * Auto-generated test for dashboard/src/ComplianceAnalyticsPanel.tsx
 * Source: dashboard/src/ComplianceAnalyticsPanel.tsx (101 lines, type: component)
...
const SRC_PATH = path.resolve(__dirname, '../../dashboard/src/ComplianceAnalyticsPanel.tsx');

describe('dashboard/src/ComplianceAnalyticsPanel.tsx', () => {
  let src: string;
