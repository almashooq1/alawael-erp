/**
 * Auto-generated test for dashboard/src/CompliancePanel.tsx
 * Source: dashboard/src/CompliancePanel.tsx (163 lines, type: component)
...
const SRC_PATH = path.resolve(__dirname, '../../dashboard/src/CompliancePanel.tsx');

describe('dashboard/src/CompliancePanel.tsx', () => {
  let src: string;
