/**
 * Auto-generated test for dashboard/src/CompliancePolicyPanel.tsx
 * Source: dashboard/src/CompliancePolicyPanel.tsx (183 lines, type: component)
...
const SRC_PATH = path.resolve(__dirname, '../../dashboard/src/CompliancePolicyPanel.tsx');

describe('dashboard/src/CompliancePolicyPanel.tsx', () => {
  let src: string;
