/**
 * Auto-generated test for dashboard/src/ComplianceRiskEventDetails.tsx
 * Source: dashboard/src/ComplianceRiskEventDetails.tsx (45 lines, type: component)
...
const SRC_PATH = path.resolve(__dirname, '../../dashboard/src/ComplianceRiskEventDetails.tsx');

describe('dashboard/src/ComplianceRiskEventDetails.tsx', () => {
  let src: string;
