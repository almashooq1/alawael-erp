/**
 * Auto-generated test for dashboard/src/ComplianceRiskPanel.tsx
 * Source: dashboard/src/ComplianceRiskPanel.tsx (58 lines, type: component)
...
const SRC_PATH = path.resolve(__dirname, '../../dashboard/src/ComplianceRiskPanel.tsx');

describe('dashboard/src/ComplianceRiskPanel.tsx', () => {
  let src: string;
