/**
 * Auto-generated test for dashboard/src/ComplianceRiskTrends.tsx
 * Source: dashboard/src/ComplianceRiskTrends.tsx (84 lines, type: component)
...
const SRC_PATH = path.resolve(__dirname, '../../dashboard/src/ComplianceRiskTrends.tsx');

describe('dashboard/src/ComplianceRiskTrends.tsx', () => {
  let src: string;
