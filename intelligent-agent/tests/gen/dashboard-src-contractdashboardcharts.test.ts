/**
 * Auto-generated test for dashboard/src/ContractDashboardCharts.tsx
 * Source: dashboard/src/ContractDashboardCharts.tsx (89 lines, type: component)
...
const SRC_PATH = path.resolve(__dirname, '../../dashboard/src/ContractDashboardCharts.tsx');

describe('dashboard/src/ContractDashboardCharts.tsx', () => {
  let src: string;
