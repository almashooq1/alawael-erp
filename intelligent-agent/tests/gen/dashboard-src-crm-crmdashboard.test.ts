/**
 * Auto-generated test for dashboard/src/crm/CrmDashboard.tsx
 * Source: dashboard/src/crm/CrmDashboard.tsx (38 lines, type: component)
...
const SRC_PATH = path.resolve(__dirname, '../../dashboard/src/crm/CrmDashboard.tsx');

describe('dashboard/src/crm/CrmDashboard.tsx', () => {
  let src: string;
