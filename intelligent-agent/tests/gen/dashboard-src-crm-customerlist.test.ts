/**
 * Auto-generated test for dashboard/src/crm/CustomerList.tsx
 * Source: dashboard/src/crm/CustomerList.tsx (46 lines, type: component)
...
const SRC_PATH = path.resolve(__dirname, '../../dashboard/src/crm/CustomerList.tsx');

describe('dashboard/src/crm/CustomerList.tsx', () => {
  let src: string;
