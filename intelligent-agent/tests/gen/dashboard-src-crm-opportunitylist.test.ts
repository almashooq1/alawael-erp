/**
 * Auto-generated test for dashboard/src/crm/OpportunityList.tsx
 * Source: dashboard/src/crm/OpportunityList.tsx (46 lines, type: component)
...
const SRC_PATH = path.resolve(__dirname, '../../dashboard/src/crm/OpportunityList.tsx');

describe('dashboard/src/crm/OpportunityList.tsx', () => {
  let src: string;
