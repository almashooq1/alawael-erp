/**
 * Auto-generated test for dashboard/src/exportPDF.ts
 * Source: dashboard/src/exportPDF.ts (20 lines, type: component)
...
const SRC_PATH = path.resolve(__dirname, '../../dashboard/src/exportPDF.ts');

describe('dashboard/src/exportPDF.ts', () => {
  let src: string;
