/**
 * Auto-generated test for dashboard/src/exportUtils.ts
 * Source: dashboard/src/exportUtils.ts (33 lines, type: util)
...
const SRC_PATH = path.resolve(__dirname, '../../dashboard/src/exportUtils.ts');

describe('dashboard/src/exportUtils.ts', () => {
  let src: string;
