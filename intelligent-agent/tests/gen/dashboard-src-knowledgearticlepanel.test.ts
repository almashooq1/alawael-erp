/**
 * Auto-generated test for dashboard/src/KnowledgeArticlePanel.tsx
 * Source: dashboard/src/KnowledgeArticlePanel.tsx (210 lines, type: component)
...
const SRC_PATH = path.resolve(__dirname, '../../dashboard/src/KnowledgeArticlePanel.tsx');

describe('dashboard/src/KnowledgeArticlePanel.tsx', () => {
  let src: string;
