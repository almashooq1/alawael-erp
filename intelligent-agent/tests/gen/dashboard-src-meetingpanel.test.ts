/**
 * Auto-generated test for dashboard/src/MeetingPanel.tsx
 * Source: dashboard/src/MeetingPanel.tsx (111 lines, type: component)
...
const SRC_PATH = path.resolve(__dirname, '../../dashboard/src/MeetingPanel.tsx');

describe('dashboard/src/MeetingPanel.tsx', () => {
  let src: string;
