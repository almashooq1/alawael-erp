/**
 * Auto-generated test for dashboard/src/process/BPMNEditor.tsx
 * Source: dashboard/src/process/BPMNEditor.tsx (39 lines, type: component)
...
const SRC_PATH = path.resolve(__dirname, '../../dashboard/src/process/BPMNEditor.tsx');

describe('dashboard/src/process/BPMNEditor.tsx', () => {
  let src: string;
