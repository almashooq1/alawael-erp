/**
 * Auto-generated test for dashboard/src/process/DynamicTranslationAdmin.tsx
 * Source: dashboard/src/process/DynamicTranslationAdmin.tsx (61 lines, type: component)
...
const SRC_PATH = path.resolve(__dirname, '../../dashboard/src/process/DynamicTranslationAdmin.tsx');

describe('dashboard/src/process/DynamicTranslationAdmin.tsx', () => {
  let src: string;
