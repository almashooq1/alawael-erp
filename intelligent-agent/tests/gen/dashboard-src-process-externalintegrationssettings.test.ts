/**
 * Auto-generated test for dashboard/src/process/ExternalIntegrationsSettings.tsx
 * Source: dashboard/src/process/ExternalIntegrationsSettings.tsx (42 lines, type: component)
...
const SRC_PATH = path.resolve(__dirname, '../../dashboard/src/process/ExternalIntegrationsSettings.tsx');

describe('dashboard/src/process/ExternalIntegrationsSettings.tsx', () => {
  let src: string;
