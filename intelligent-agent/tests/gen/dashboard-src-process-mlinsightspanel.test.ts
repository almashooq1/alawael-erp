/**
 * Auto-generated test for dashboard/src/process/MLInsightsPanel.tsx
 * Source: dashboard/src/process/MLInsightsPanel.tsx (657 lines, type: component)
...
const SRC_PATH = path.resolve(__dirname, '../../dashboard/src/process/MLInsightsPanel.tsx');

describe('dashboard/src/process/MLInsightsPanel.tsx', () => {
  let src: string;
