/**
 * Auto-generated test for dashboard/src/process/ProcessAnalytics.tsx
 * Source: dashboard/src/process/ProcessAnalytics.tsx (31 lines, type: component)
...
const SRC_PATH = path.resolve(__dirname, '../../dashboard/src/process/ProcessAnalytics.tsx');

describe('dashboard/src/process/ProcessAnalytics.tsx', () => {
  let src: string;
