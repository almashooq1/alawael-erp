/**
 * Auto-generated test for dashboard/src/process/ProcessChangeLog.tsx
 * Source: dashboard/src/process/ProcessChangeLog.tsx (39 lines, type: component)
...
const SRC_PATH = path.resolve(__dirname, '../../dashboard/src/process/ProcessChangeLog.tsx');

describe('dashboard/src/process/ProcessChangeLog.tsx', () => {
  let src: string;
