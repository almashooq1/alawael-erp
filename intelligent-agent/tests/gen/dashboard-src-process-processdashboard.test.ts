/**
 * Auto-generated test for dashboard/src/process/ProcessDashboard.tsx
 * Source: dashboard/src/process/ProcessDashboard.tsx (171 lines, type: component)
...
const SRC_PATH = path.resolve(__dirname, '../../dashboard/src/process/ProcessDashboard.tsx');

describe('dashboard/src/process/ProcessDashboard.tsx', () => {
  let src: string;
