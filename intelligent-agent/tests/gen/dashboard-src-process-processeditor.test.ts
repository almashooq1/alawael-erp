/**
 * Auto-generated test for dashboard/src/process/ProcessEditor.tsx
 * Source: dashboard/src/process/ProcessEditor.tsx (57 lines, type: component)
...
const SRC_PATH = path.resolve(__dirname, '../../dashboard/src/process/ProcessEditor.tsx');

describe('dashboard/src/process/ProcessEditor.tsx', () => {
  let src: string;
