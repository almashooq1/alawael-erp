/**
 * Auto-generated test for dashboard/src/process/RBACSettings.tsx
 * Source: dashboard/src/process/RBACSettings.tsx (49 lines, type: component)
...
const SRC_PATH = path.resolve(__dirname, '../../dashboard/src/process/RBACSettings.tsx');

describe('dashboard/src/process/RBACSettings.tsx', () => {
  let src: string;
