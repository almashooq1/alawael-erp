/**
 * Auto-generated test for dashboard/src/process/RiskAnalytics.tsx
 * Source: dashboard/src/process/RiskAnalytics.tsx (51 lines, type: component)
...
const SRC_PATH = path.resolve(__dirname, '../../dashboard/src/process/RiskAnalytics.tsx');

describe('dashboard/src/process/RiskAnalytics.tsx', () => {
  let src: string;
