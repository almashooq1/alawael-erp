/**
 * Auto-generated test for dashboard/src/process/RiskDashboard.tsx
 * Source: dashboard/src/process/RiskDashboard.tsx (283 lines, type: component)
...
const SRC_PATH = path.resolve(__dirname, '../../dashboard/src/process/RiskDashboard.tsx');

describe('dashboard/src/process/RiskDashboard.tsx', () => {
  let src: string;
