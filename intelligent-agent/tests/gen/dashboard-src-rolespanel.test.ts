/**
 * Auto-generated test for dashboard/src/RolesPanel.tsx
 * Source: dashboard/src/RolesPanel.tsx (61 lines, type: component)
...
const SRC_PATH = path.resolve(__dirname, '../../dashboard/src/RolesPanel.tsx');

describe('dashboard/src/RolesPanel.tsx', () => {
  let src: string;
