/**
 * Auto-generated test for dashboard/src/TranslationAdminPanel.tsx
 * Source: dashboard/src/TranslationAdminPanel.tsx (83 lines, type: component)
...
const SRC_PATH = path.resolve(__dirname, '../../dashboard/src/TranslationAdminPanel.tsx');

describe('dashboard/src/TranslationAdminPanel.tsx', () => {
  let src: string;
