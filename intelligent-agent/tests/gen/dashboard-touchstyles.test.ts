/**
 * Auto-generated test for dashboard/touchStyles.ts
 * Source: dashboard/touchStyles.ts (26 lines, type: component)
...
const SRC_PATH = path.resolve(__dirname, '../../dashboard/touchStyles.ts');

describe('dashboard/touchStyles.ts', () => {
  let src: string;
