/**
 * Auto-generated test for dashboard/UserSelect.tsx
 * Source: dashboard/UserSelect.tsx (13 lines, type: component)
...
const SRC_PATH = path.resolve(__dirname, '../../dashboard/UserSelect.tsx');

describe('dashboard/UserSelect.tsx', () => {
  let src: string;
