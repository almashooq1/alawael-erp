/**
 * Auto-generated test for dashboard/webhook-api.ts
 * Source: dashboard/webhook-api.ts (18 lines, type: component)
...
const SRC_PATH = path.resolve(__dirname, '../../dashboard/webhook-api.ts');

describe('dashboard/webhook-api.ts', () => {
  let src: string;
