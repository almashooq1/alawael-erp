/**
 * Auto-generated test for dashboard/WebhookPanel.tsx
 * Source: dashboard/WebhookPanel.tsx (28 lines, type: component)
...
const SRC_PATH = path.resolve(__dirname, '../../dashboard/WebhookPanel.tsx');

describe('dashboard/WebhookPanel.tsx', () => {
  let src: string;
