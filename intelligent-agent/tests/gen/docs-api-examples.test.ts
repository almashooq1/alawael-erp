/**
 * Auto-generated test for src/docs/api-examples.ts
 * Source: src/docs/api-examples.ts (334 lines, type: doc)
...
const SRC_PATH = path.resolve(__dirname, '../../src/docs/api-examples.ts');

describe('src/docs/api-examples.ts', () => {
  let src: string;
