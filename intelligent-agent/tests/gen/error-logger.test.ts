/**
 * Auto-generated test for src/error-logger.ts
 * Source: src/error-logger.ts (9 lines, type: class)
...
const SRC_PATH = path.resolve(__dirname, '../../src/error-logger.ts');

describe('src/error-logger.ts', () => {
  let src: string;
