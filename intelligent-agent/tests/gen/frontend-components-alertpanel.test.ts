/**
 * Auto-generated test for frontend/components/AlertPanel.tsx
 * Source: frontend/components/AlertPanel.tsx (231 lines, type: component)
...
const SRC_PATH = path.resolve(__dirname, '../../frontend/components/AlertPanel.tsx');

describe('frontend/components/AlertPanel.tsx', () => {
  let src: string;
