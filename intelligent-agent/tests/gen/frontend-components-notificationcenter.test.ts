/**
 * Auto-generated test for frontend/components/NotificationCenter.tsx
 * Source: frontend/components/NotificationCenter.tsx (364 lines, type: component)
...
const SRC_PATH = path.resolve(__dirname, '../../frontend/components/NotificationCenter.tsx');

describe('frontend/components/NotificationCenter.tsx', () => {
  let src: string;
