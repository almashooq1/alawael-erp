/**
 * Auto-generated test for frontend/components/ReportBuilder.tsx
 * Source: frontend/components/ReportBuilder.tsx (334 lines, type: component)
...
const SRC_PATH = path.resolve(__dirname, '../../frontend/components/ReportBuilder.tsx');

describe('frontend/components/ReportBuilder.tsx', () => {
  let src: string;
