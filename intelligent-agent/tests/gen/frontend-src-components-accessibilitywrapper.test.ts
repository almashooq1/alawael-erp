/**
 * Auto-generated test for frontend/src/components/AccessibilityWrapper.tsx
 * Source: frontend/src/components/AccessibilityWrapper.tsx (483 lines, type: component)
...
const SRC_PATH = path.resolve(__dirname, '../../frontend/src/components/AccessibilityWrapper.tsx');

describe('frontend/src/components/AccessibilityWrapper.tsx', () => {
  let src: string;
