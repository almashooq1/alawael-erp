/**
 * Auto-generated test for frontend/src/components/AIProcessReports.tsx
 * Source: frontend/src/components/AIProcessReports.tsx (326 lines, type: component)
...
const SRC_PATH = path.resolve(__dirname, '../../frontend/src/components/AIProcessReports.tsx');

describe('frontend/src/components/AIProcessReports.tsx', () => {
  let src: string;
