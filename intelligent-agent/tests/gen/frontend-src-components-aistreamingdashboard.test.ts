/**
 * Auto-generated test for frontend/src/components/AIStreamingDashboard.tsx
 * Source: frontend/src/components/AIStreamingDashboard.tsx (197 lines, type: component)
...
const SRC_PATH = path.resolve(__dirname, '../../frontend/src/components/AIStreamingDashboard.tsx');

describe('frontend/src/components/AIStreamingDashboard.tsx', () => {
  let src: string;
