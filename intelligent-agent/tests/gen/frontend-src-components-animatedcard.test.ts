/**
 * Auto-generated test for frontend/src/components/AnimatedCard.tsx
 * Source: frontend/src/components/AnimatedCard.tsx (59 lines, type: component)
...
const SRC_PATH = path.resolve(__dirname, '../../frontend/src/components/AnimatedCard.tsx');

describe('frontend/src/components/AnimatedCard.tsx', () => {
  let src: string;
