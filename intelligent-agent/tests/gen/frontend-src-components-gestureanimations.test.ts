/**
 * Auto-generated test for frontend/src/components/GestureAnimations.tsx
 * Source: frontend/src/components/GestureAnimations.tsx (424 lines, type: component)
...
const SRC_PATH = path.resolve(__dirname, '../../frontend/src/components/GestureAnimations.tsx');

describe('frontend/src/components/GestureAnimations.tsx', () => {
  let src: string;
