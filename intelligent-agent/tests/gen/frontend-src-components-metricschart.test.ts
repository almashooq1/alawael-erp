/**
 * Auto-generated test for frontend/src/components/MetricsChart.tsx
 * Source: frontend/src/components/MetricsChart.tsx (156 lines, type: component)
...
const SRC_PATH = path.resolve(__dirname, '../../frontend/src/components/MetricsChart.tsx');

describe('frontend/src/components/MetricsChart.tsx', () => {
  let src: string;
