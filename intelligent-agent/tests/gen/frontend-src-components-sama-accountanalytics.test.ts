/**
 * Auto-generated test for frontend/src/components/SAMA/AccountAnalytics.tsx
 * Source: frontend/src/components/SAMA/AccountAnalytics.tsx (232 lines, type: component)
...
const SRC_PATH = path.resolve(__dirname, '../../frontend/src/components/SAMA/AccountAnalytics.tsx');

describe('frontend/src/components/SAMA/AccountAnalytics.tsx', () => {
  let src: string;
