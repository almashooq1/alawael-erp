/**
 * Auto-generated test for frontend/src/components/SAMA/FinancialReports.tsx
 * Source: frontend/src/components/SAMA/FinancialReports.tsx (322 lines, type: component)
...
const SRC_PATH = path.resolve(__dirname, '../../frontend/src/components/SAMA/FinancialReports.tsx');

describe('frontend/src/components/SAMA/FinancialReports.tsx', () => {
  let src: string;
