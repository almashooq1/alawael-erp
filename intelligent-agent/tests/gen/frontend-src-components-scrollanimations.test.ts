/**
 * Auto-generated test for frontend/src/components/ScrollAnimations.tsx
 * Source: frontend/src/components/ScrollAnimations.tsx (373 lines, type: component)
...
const SRC_PATH = path.resolve(__dirname, '../../frontend/src/components/ScrollAnimations.tsx');

describe('frontend/src/components/ScrollAnimations.tsx', () => {
  let src: string;
