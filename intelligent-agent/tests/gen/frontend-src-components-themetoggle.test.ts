/**
 * Auto-generated test for frontend/src/components/ThemeToggle.tsx
 * Source: frontend/src/components/ThemeToggle.tsx (119 lines, type: component)
...
const SRC_PATH = path.resolve(__dirname, '../../frontend/src/components/ThemeToggle.tsx');

describe('frontend/src/components/ThemeToggle.tsx', () => {
  let src: string;
