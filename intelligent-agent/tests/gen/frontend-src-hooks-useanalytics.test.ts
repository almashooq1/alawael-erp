/**
 * Auto-generated test for frontend/src/hooks/useAnalytics.ts
 * Source: frontend/src/hooks/useAnalytics.ts (401 lines, type: module)
...
const SRC_PATH = path.resolve(__dirname, '../../frontend/src/hooks/useAnalytics.ts');

describe('frontend/src/hooks/useAnalytics.ts', () => {
  let src: string;
