/**
 * Auto-generated test for frontend/src/hooks/useMediaQuery.ts
 * Source: frontend/src/hooks/useMediaQuery.ts (306 lines, type: module)
...
const SRC_PATH = path.resolve(__dirname, '../../frontend/src/hooks/useMediaQuery.ts');

describe('frontend/src/hooks/useMediaQuery.ts', () => {
  let src: string;
