/**
 * Auto-generated test for frontend/src/hooks/useRealtimeChartData.ts
 * Source: frontend/src/hooks/useRealtimeChartData.ts (243 lines, type: component)
...
const SRC_PATH = path.resolve(__dirname, '../../frontend/src/hooks/useRealtimeChartData.ts');

describe('frontend/src/hooks/useRealtimeChartData.ts', () => {
  let src: string;
