/**
 * Auto-generated test for frontend/src/i18n/formatting.ts
 * Source: frontend/src/i18n/formatting.ts (267 lines, type: i18n)
...
const SRC_PATH = path.resolve(__dirname, '../../frontend/src/i18n/formatting.ts');

describe('frontend/src/i18n/formatting.ts', () => {
  let src: string;
