/**
 * Auto-generated test for frontend/src/services/AIClient.ts
 * Source: frontend/src/services/AIClient.ts (156 lines, type: module)
...
const SRC_PATH = path.resolve(__dirname, '../../frontend/src/services/AIClient.ts');

describe('frontend/src/services/AIClient.ts', () => {
  let src: string;
