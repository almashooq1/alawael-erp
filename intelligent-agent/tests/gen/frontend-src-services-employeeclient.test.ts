/**
 * Auto-generated test for frontend/src/services/EmployeeClient.ts
 * Source: frontend/src/services/EmployeeClient.ts (214 lines, type: module)
...
const SRC_PATH = path.resolve(__dirname, '../../frontend/src/services/EmployeeClient.ts');

describe('frontend/src/services/EmployeeClient.ts', () => {
  let src: string;
