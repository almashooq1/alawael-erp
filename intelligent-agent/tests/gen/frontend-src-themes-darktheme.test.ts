/**
 * Auto-generated test for frontend/src/themes/darkTheme.ts
 * Source: frontend/src/themes/darkTheme.ts (210 lines, type: theme)
...
const SRC_PATH = path.resolve(__dirname, '../../frontend/src/themes/darkTheme.ts');

describe('frontend/src/themes/darkTheme.ts', () => {
  let src: string;
