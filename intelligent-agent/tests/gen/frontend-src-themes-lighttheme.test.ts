/**
 * Auto-generated test for frontend/src/themes/lightTheme.ts
 * Source: frontend/src/themes/lightTheme.ts (210 lines, type: theme)
...
const SRC_PATH = path.resolve(__dirname, '../../frontend/src/themes/lightTheme.ts');

describe('frontend/src/themes/lightTheme.ts', () => {
  let src: string;
