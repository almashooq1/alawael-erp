/**
 * Auto-generated test for src/graphql.ts
 * Source: src/graphql.ts (64 lines, type: model)
...
const SRC_PATH = path.resolve(__dirname, '../../src/graphql.ts');

describe('src/graphql.ts', () => {
  let src: string;
