/**
 * Auto-generated test for src/middleware/cache-manager.ts
 * Source: src/middleware/cache-manager.ts (195 lines, type: middleware)
...
const SRC_PATH = path.resolve(__dirname, '../../src/middleware/cache-manager.ts');

describe('src/middleware/cache-manager.ts', () => {
  let src: string;
