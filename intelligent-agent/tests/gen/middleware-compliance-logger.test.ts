/**
 * Auto-generated test for src/middleware/compliance-logger.ts
 * Source: src/middleware/compliance-logger.ts (139 lines, type: middleware)
...
const SRC_PATH = path.resolve(__dirname, '../../src/middleware/compliance-logger.ts');

describe('src/middleware/compliance-logger.ts', () => {
  let src: string;
  ...
  test('functions/methods detected (16+)', () => {
