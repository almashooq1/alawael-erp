/**
 * Auto-generated test for src/middleware/compression.ts
 * Source: src/middleware/compression.ts (31 lines, type: middleware)
...
const SRC_PATH = path.resolve(__dirname, '../../src/middleware/compression.ts');

describe('src/middleware/compression.ts', () => {
  let src: string;
