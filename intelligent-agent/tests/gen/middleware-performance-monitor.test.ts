/**
 * Auto-generated test for src/middleware/performance-monitor.ts
 * Source: src/middleware/performance-monitor.ts (145 lines, type: middleware)
...
const SRC_PATH = path.resolve(__dirname, '../../src/middleware/performance-monitor.ts');

describe('src/middleware/performance-monitor.ts', () => {
  let src: string;
  ...
  test('functions/methods detected (14+)', () => {
