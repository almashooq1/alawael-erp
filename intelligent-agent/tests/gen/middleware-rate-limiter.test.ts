/**
 * Auto-generated test for src/middleware/rate-limiter.ts
 * Source: src/middleware/rate-limiter.ts (101 lines, type: middleware)
...
const SRC_PATH = path.resolve(__dirname, '../../src/middleware/rate-limiter.ts');

describe('src/middleware/rate-limiter.ts', () => {
  let src: string;
