/**
 * Auto-generated test for src/middleware/security.ts
 * Source: src/middleware/security.ts (195 lines, type: middleware)
...
const SRC_PATH = path.resolve(__dirname, '../../src/middleware/security.ts');

describe('src/middleware/security.ts', () => {
  let src: string;
