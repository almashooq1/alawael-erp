/**
 * Auto-generated test for src/models/compliance-event.ts
 * Source: src/models/compliance-event.ts (17 lines, type: model)
...
const SRC_PATH = path.resolve(__dirname, '../../src/models/compliance-event.ts');

describe('src/models/compliance-event.ts', () => {
  let src: string;
  ...
  test('defines Mongoose schema or model', () => {
  ...
  test('functions/methods detected (0+)', () => {
