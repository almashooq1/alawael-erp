/**
 * Auto-generated test for src/models/compliance-policy.ts
 * Source: src/models/compliance-policy.ts (20 lines, type: model)
...
const SRC_PATH = path.resolve(__dirname, '../../src/models/compliance-policy.ts');

describe('src/models/compliance-policy.ts', () => {
  let src: string;
