/**
 * Auto-generated test for src/modules/advanced-user-manager.ts
 * Source: src/modules/advanced-user-manager.ts (43 lines, type: class)
...
const SRC_PATH = path.resolve(__dirname, '../../src/modules/advanced-user-manager.ts');

describe('src/modules/advanced-user-manager.ts', () => {
  let src: string;
  ...
  test('functions/methods detected (6+)', () => {
