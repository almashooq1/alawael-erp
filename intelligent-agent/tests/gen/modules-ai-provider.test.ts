/**
 * Auto-generated test for src/modules/ai-provider.ts
 * Source: src/modules/ai-provider.ts (80 lines, type: class)
...
const SRC_PATH = path.resolve(__dirname, '../../src/modules/ai-provider.ts');

describe('src/modules/ai-provider.ts', () => {
  let src: string;
