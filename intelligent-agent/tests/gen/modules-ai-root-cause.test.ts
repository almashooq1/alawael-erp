/**
 * Auto-generated test for src/modules/ai-root-cause.ts
 * Source: src/modules/ai-root-cause.ts (10 lines, type: module)
...
const SRC_PATH = path.resolve(__dirname, '../../src/modules/ai-root-cause.ts');

describe('src/modules/ai-root-cause.ts', () => {
  let src: string;
