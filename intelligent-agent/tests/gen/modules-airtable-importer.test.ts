/**
 * Auto-generated test for src/modules/airtable-importer.ts
 * Source: src/modules/airtable-importer.ts (22 lines, type: module)
...
const SRC_PATH = path.resolve(__dirname, '../../src/modules/airtable-importer.ts');

describe('src/modules/airtable-importer.ts', () => {
  let src: string;
