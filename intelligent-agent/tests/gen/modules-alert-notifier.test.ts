/**
 * Auto-generated test for src/modules/alert-notifier.ts
 * Source: src/modules/alert-notifier.ts (43 lines, type: module)
...
const SRC_PATH = path.resolve(__dirname, '../../src/modules/alert-notifier.ts');

describe('src/modules/alert-notifier.ts', () => {
  let src: string;
