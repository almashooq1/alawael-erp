/**
 * Auto-generated test for src/modules/asset-management.ts
 * Source: src/modules/asset-management.ts (156 lines, type: class)
...
const SRC_PATH = path.resolve(__dirname, '../../src/modules/asset-management.ts');

describe('src/modules/asset-management.ts', () => {
  let src: string;
