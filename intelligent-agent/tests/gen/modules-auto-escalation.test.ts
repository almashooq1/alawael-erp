/**
 * Auto-generated test for src/modules/auto-escalation.ts
 * Source: src/modules/auto-escalation.ts (52 lines, type: class)
...
const SRC_PATH = path.resolve(__dirname, '../../src/modules/auto-escalation.ts');

describe('src/modules/auto-escalation.ts', () => {
  let src: string;
