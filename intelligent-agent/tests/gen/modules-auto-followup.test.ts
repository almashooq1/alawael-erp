/**
 * Auto-generated test for src/modules/auto-followup.ts
 * Source: src/modules/auto-followup.ts (55 lines, type: module)
...
const SRC_PATH = path.resolve(__dirname, '../../src/modules/auto-followup.ts');

describe('src/modules/auto-followup.ts', () => {
  let src: string;
