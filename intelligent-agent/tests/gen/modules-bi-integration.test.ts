/**
 * Auto-generated test for src/modules/bi-integration.ts
 * Source: src/modules/bi-integration.ts (20 lines, type: class)
...
const SRC_PATH = path.resolve(__dirname, '../../src/modules/bi-integration.ts');

describe('src/modules/bi-integration.ts', () => {
  let src: string;
