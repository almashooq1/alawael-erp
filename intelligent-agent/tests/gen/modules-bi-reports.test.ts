/**
 * Auto-generated test for src/modules/bi-reports.ts
 * Source: src/modules/bi-reports.ts (35 lines, type: class)
...
const SRC_PATH = path.resolve(__dirname, '../../src/modules/bi-reports.ts');

describe('src/modules/bi-reports.ts', () => {
  let src: string;
