/**
 * Auto-generated test for src/modules/box-integration.ts
 * Source: src/modules/box-integration.ts (18 lines, type: module)
...
const SRC_PATH = path.resolve(__dirname, '../../src/modules/box-integration.ts');

describe('src/modules/box-integration.ts', () => {
  let src: string;
