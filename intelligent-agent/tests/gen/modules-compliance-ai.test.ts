/**
 * Auto-generated test for src/modules/compliance-ai.ts
 * Source: src/modules/compliance-ai.ts (46 lines, type: module)
...
const SRC_PATH = path.resolve(__dirname, '../../src/modules/compliance-ai.ts');

describe('src/modules/compliance-ai.ts', () => {
  let src: string;
