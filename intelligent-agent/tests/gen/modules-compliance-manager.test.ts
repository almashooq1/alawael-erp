/**
 * Auto-generated test for src/modules/compliance-manager.ts
 * Source: src/modules/compliance-manager.ts (65 lines, type: class)
...
const SRC_PATH = path.resolve(__dirname, '../../src/modules/compliance-manager.ts');

describe('src/modules/compliance-manager.ts', () => {
  let src: string;
