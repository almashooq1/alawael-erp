/**
 * Auto-generated test for src/modules/compliance-report.ts
 * Source: src/modules/compliance-report.ts (51 lines, type: module)
...
const SRC_PATH = path.resolve(__dirname, '../../src/modules/compliance-report.ts');

describe('src/modules/compliance-report.ts', () => {
  let src: string;
