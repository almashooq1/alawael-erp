/**
 * Auto-generated test for src/modules/compliance-stats.ts
 * Source: src/modules/compliance-stats.ts (48 lines, type: module)
...
const SRC_PATH = path.resolve(__dirname, '../../src/modules/compliance-stats.ts');

describe('src/modules/compliance-stats.ts', () => {
  let src: string;
