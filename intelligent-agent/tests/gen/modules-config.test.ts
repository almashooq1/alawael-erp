/**
 * Auto-generated test for src/modules/config.ts
 * Source: src/modules/config.ts (14 lines, type: module)
...
const SRC_PATH = path.resolve(__dirname, '../../src/modules/config.ts');

describe('src/modules/config.ts', () => {
  let src: string;
