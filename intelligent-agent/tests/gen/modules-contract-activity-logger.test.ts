/**
 * Auto-generated test for src/modules/contract-activity-logger.ts
 * Source: src/modules/contract-activity-logger.ts (42 lines, type: class)
...
const SRC_PATH = path.resolve(__dirname, '../../src/modules/contract-activity-logger.ts');

describe('src/modules/contract-activity-logger.ts', () => {
  let src: string;
