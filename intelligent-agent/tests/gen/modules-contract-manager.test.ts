/**
 * Auto-generated test for src/modules/contract-manager.ts
 * Source: src/modules/contract-manager.ts (66 lines, type: class)
...
const SRC_PATH = path.resolve(__dirname, '../../src/modules/contract-manager.ts');

describe('src/modules/contract-manager.ts', () => {
  let src: string;
