/**
 * Auto-generated test for src/modules/contract-reports.ts
 * Source: src/modules/contract-reports.ts (40 lines, type: module)
...
const SRC_PATH = path.resolve(__dirname, '../../src/modules/contract-reports.ts');

describe('src/modules/contract-reports.ts', () => {
  let src: string;
