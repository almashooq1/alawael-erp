/**
 * Auto-generated test for src/modules/contract-smart-alerts.ts
 * Source: src/modules/contract-smart-alerts.ts (58 lines, type: module)
...
const SRC_PATH = path.resolve(__dirname, '../../src/modules/contract-smart-alerts.ts');

describe('src/modules/contract-smart-alerts.ts', () => {
  let src: string;
  ...
  test('functions/methods detected (10+)', () => {
