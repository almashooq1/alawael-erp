/**
 * Auto-generated test for src/modules/dashboard-reporter.ts
 * Source: src/modules/dashboard-reporter.ts (73 lines, type: class)
...
const SRC_PATH = path.resolve(__dirname, '../../src/modules/dashboard-reporter.ts');

describe('src/modules/dashboard-reporter.ts', () => {
  let src: string;
