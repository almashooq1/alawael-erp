/**
 * Auto-generated test for src/modules/dashboard.ts
 * Source: src/modules/dashboard.ts (161 lines, type: class)
...
const SRC_PATH = path.resolve(__dirname, '../../src/modules/dashboard.ts');

describe('src/modules/dashboard.ts', () => {
  let src: string;
