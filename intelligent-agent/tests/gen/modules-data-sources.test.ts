/**
 * Auto-generated test for src/modules/data-sources.ts
 * Source: src/modules/data-sources.ts (38 lines, type: module)
...
const SRC_PATH = path.resolve(__dirname, '../../src/modules/data-sources.ts');

describe('src/modules/data-sources.ts', () => {
  let src: string;
