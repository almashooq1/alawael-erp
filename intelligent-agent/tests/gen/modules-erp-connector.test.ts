/**
 * Auto-generated test for src/modules/erp-connector.ts
 * Source: src/modules/erp-connector.ts (33 lines, type: class)
...
const SRC_PATH = path.resolve(__dirname, '../../src/modules/erp-connector.ts');

describe('src/modules/erp-connector.ts', () => {
  let src: string;
