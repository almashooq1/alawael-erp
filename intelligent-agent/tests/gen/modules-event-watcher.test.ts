/**
 * Auto-generated test for src/modules/event-watcher.ts
 * Source: src/modules/event-watcher.ts (17 lines, type: class)
...
const SRC_PATH = path.resolve(__dirname, '../../src/modules/event-watcher.ts');

describe('src/modules/event-watcher.ts', () => {
  let src: string;
