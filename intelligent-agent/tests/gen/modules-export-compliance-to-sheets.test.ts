/**
 * Auto-generated test for src/modules/export-compliance-to-sheets.ts
 * Source: src/modules/export-compliance-to-sheets.ts (48 lines, type: module)
...
const SRC_PATH = path.resolve(__dirname, '../../src/modules/export-compliance-to-sheets.ts');

describe('src/modules/export-compliance-to-sheets.ts', () => {
  let src: string;
