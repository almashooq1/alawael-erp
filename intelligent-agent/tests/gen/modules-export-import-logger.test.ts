/**
 * Auto-generated test for src/modules/export-import-logger.ts
 * Source: src/modules/export-import-logger.ts (32 lines, type: class)
...
const SRC_PATH = path.resolve(__dirname, '../../src/modules/export-import-logger.ts');

describe('src/modules/export-import-logger.ts', () => {
  let src: string;
