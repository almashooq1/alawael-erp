/**
 * Auto-generated test for src/modules/external-integrations.ts
 * Source: src/modules/external-integrations.ts (41 lines, type: class)
...
const SRC_PATH = path.resolve(__dirname, '../../src/modules/external-integrations.ts');

describe('src/modules/external-integrations.ts', () => {
  let src: string;
  ...
  test('functions/methods detected (5+)', () => {
