/**
 * Auto-generated test for src/modules/external-learning-import-scheduler.ts
 * Source: src/modules/external-learning-import-scheduler.ts (25 lines, type: module)
...
const SRC_PATH = path.resolve(__dirname, '../../src/modules/external-learning-import-scheduler.ts');

describe('src/modules/external-learning-import-scheduler.ts', () => {
  let src: string;
  ...
  test('functions/methods detected (4+)', () => {
