/**
 * Auto-generated test for src/modules/fine-tuning-manager.ts
 * Source: src/modules/fine-tuning-manager.ts (20 lines, type: class)
...
const SRC_PATH = path.resolve(__dirname, '../../src/modules/fine-tuning-manager.ts');

describe('src/modules/fine-tuning-manager.ts', () => {
  let src: string;
