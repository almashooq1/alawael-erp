/**
 * Auto-generated test for src/modules/github-importer.ts
 * Source: src/modules/github-importer.ts (17 lines, type: module)
...
const SRC_PATH = path.resolve(__dirname, '../../src/modules/github-importer.ts');

describe('src/modules/github-importer.ts', () => {
  let src: string;
