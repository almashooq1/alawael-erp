/**
 * Auto-generated test for src/modules/google-oauth.ts
 * Source: src/modules/google-oauth.ts (38 lines, type: module)
...
const SRC_PATH = path.resolve(__dirname, '../../src/modules/google-oauth.ts');

describe('src/modules/google-oauth.ts', () => {
  let src: string;
