/**
 * Auto-generated test for src/modules/google-sheets-importer.ts
 * Source: src/modules/google-sheets-importer.ts (24 lines, type: module)
...
const SRC_PATH = path.resolve(__dirname, '../../src/modules/google-sheets-importer.ts');

describe('src/modules/google-sheets-importer.ts', () => {
  let src: string;
