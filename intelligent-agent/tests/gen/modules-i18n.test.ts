/**
 * Auto-generated test for src/modules/i18n.ts
 * Source: src/modules/i18n.ts (44 lines, type: class)
...
const SRC_PATH = path.resolve(__dirname, '../../src/modules/i18n.ts');

describe('src/modules/i18n.ts', () => {
  let src: string;
