/**
 * Auto-generated test for src/modules/instant-notifier.ts
 * Source: src/modules/instant-notifier.ts (35 lines, type: class)
...
const SRC_PATH = path.resolve(__dirname, '../../src/modules/instant-notifier.ts');

describe('src/modules/instant-notifier.ts', () => {
  let src: string;
