/**
 * Auto-generated test for src/modules/knowledge-base.ts
 * Source: src/modules/knowledge-base.ts (52 lines, type: class)
...
const SRC_PATH = path.resolve(__dirname, '../../src/modules/knowledge-base.ts');

describe('src/modules/knowledge-base.ts', () => {
  let src: string;
