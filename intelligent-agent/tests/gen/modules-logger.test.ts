/**
 * Auto-generated test for src/modules/logger.ts
 * Source: src/modules/logger.ts (141 lines, type: class)
...
const SRC_PATH = path.resolve(__dirname, '../../src/modules/logger.ts');

describe('src/modules/logger.ts', () => {
  let src: string;
  ...
  test('functions/methods detected (18+)', () => {
