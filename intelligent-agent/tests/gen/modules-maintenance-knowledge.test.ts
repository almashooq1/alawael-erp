/**
 * Auto-generated test for src/modules/maintenance-knowledge.ts
 * Source: src/modules/maintenance-knowledge.ts (93 lines, type: class)
...
const SRC_PATH = path.resolve(__dirname, '../../src/modules/maintenance-knowledge.ts');

describe('src/modules/maintenance-knowledge.ts', () => {
  let src: string;
