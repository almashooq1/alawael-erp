/**
 * Auto-generated test for src/modules/meeting-manager.ts
 * Source: src/modules/meeting-manager.ts (131 lines, type: class)
...
const SRC_PATH = path.resolve(__dirname, '../../src/modules/meeting-manager.ts');

describe('src/modules/meeting-manager.ts', () => {
  let src: string;
  ...
  test('functions/methods detected (17+)', () => {
