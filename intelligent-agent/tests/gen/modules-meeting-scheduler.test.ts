/**
 * Auto-generated test for src/modules/meeting-scheduler.ts
 * Source: src/modules/meeting-scheduler.ts (34 lines, type: class)
...
const SRC_PATH = path.resolve(__dirname, '../../src/modules/meeting-scheduler.ts');

describe('src/modules/meeting-scheduler.ts', () => {
  let src: string;
