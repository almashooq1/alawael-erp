/**
 * Auto-generated test for src/modules/mfa.ts
 * Source: src/modules/mfa.ts (33 lines, type: class)
...
const SRC_PATH = path.resolve(__dirname, '../../src/modules/mfa.ts');

describe('src/modules/mfa.ts', () => {
  let src: string;
