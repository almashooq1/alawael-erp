/**
 * Auto-generated test for src/modules/multi-tenancy.ts
 * Source: src/modules/multi-tenancy.ts (48 lines, type: class)
...
const SRC_PATH = path.resolve(__dirname, '../../src/modules/multi-tenancy.ts');

describe('src/modules/multi-tenancy.ts', () => {
  let src: string;
