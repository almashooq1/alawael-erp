/**
 * Auto-generated test for src/modules/notification-center.ts
 * Source: src/modules/notification-center.ts (67 lines, type: class)
...
const SRC_PATH = path.resolve(__dirname, '../../src/modules/notification-center.ts');

describe('src/modules/notification-center.ts', () => {
  let src: string;
