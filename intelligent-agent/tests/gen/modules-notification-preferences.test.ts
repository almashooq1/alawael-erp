/**
 * Auto-generated test for src/modules/notification-preferences.ts
 * Source: src/modules/notification-preferences.ts (30 lines, type: class)
...
const SRC_PATH = path.resolve(__dirname, '../../src/modules/notification-preferences.ts');

describe('src/modules/notification-preferences.ts', () => {
  let src: string;
