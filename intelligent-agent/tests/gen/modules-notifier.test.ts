/**
 * Auto-generated test for src/modules/notifier.ts
 * Source: src/modules/notifier.ts (26 lines, type: class)
...
const SRC_PATH = path.resolve(__dirname, '../../src/modules/notifier.ts');

describe('src/modules/notifier.ts', () => {
  let src: string;
