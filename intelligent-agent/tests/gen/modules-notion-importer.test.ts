/**
 * Auto-generated test for src/modules/notion-importer.ts
 * Source: src/modules/notion-importer.ts (20 lines, type: module)
...
const SRC_PATH = path.resolve(__dirname, '../../src/modules/notion-importer.ts');

describe('src/modules/notion-importer.ts', () => {
  let src: string;
