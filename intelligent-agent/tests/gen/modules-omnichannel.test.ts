/**
 * Auto-generated test for src/modules/omnichannel.ts
 * Source: src/modules/omnichannel.ts (47 lines, type: class)
...
const SRC_PATH = path.resolve(__dirname, '../../src/modules/omnichannel.ts');

describe('src/modules/omnichannel.ts', () => {
  let src: string;
