/**
 * Auto-generated test for src/modules/permissions.ts
 * Source: src/modules/permissions.ts (35 lines, type: module)
...
const SRC_PATH = path.resolve(__dirname, '../../src/modules/permissions.ts');

describe('src/modules/permissions.ts', () => {
  let src: string;
