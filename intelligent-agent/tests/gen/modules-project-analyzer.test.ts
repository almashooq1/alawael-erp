/**
 * Auto-generated test for src/modules/project-analyzer.ts
 * Source: src/modules/project-analyzer.ts (31 lines, type: class)
...
const SRC_PATH = path.resolve(__dirname, '../../src/modules/project-analyzer.ts');

describe('src/modules/project-analyzer.ts', () => {
  let src: string;
