/**
 * Auto-generated test for src/modules/project-calendar.ts
 * Source: src/modules/project-calendar.ts (58 lines, type: class)
...
const SRC_PATH = path.resolve(__dirname, '../../src/modules/project-calendar.ts');

describe('src/modules/project-calendar.ts', () => {
  let src: string;
