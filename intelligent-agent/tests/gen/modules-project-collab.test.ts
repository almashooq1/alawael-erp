/**
 * Auto-generated test for src/modules/project-collab.ts
 * Source: src/modules/project-collab.ts (59 lines, type: class)
...
const SRC_PATH = path.resolve(__dirname, '../../src/modules/project-collab.ts');

describe('src/modules/project-collab.ts', () => {
  let src: string;
