/**
 * Auto-generated test for src/modules/project-dashboard.ts
 * Source: src/modules/project-dashboard.ts (50 lines, type: class)
...
const SRC_PATH = path.resolve(__dirname, '../../src/modules/project-dashboard.ts');

describe('src/modules/project-dashboard.ts', () => {
  let src: string;
