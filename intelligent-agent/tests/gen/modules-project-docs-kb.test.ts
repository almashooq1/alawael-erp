/**
 * Auto-generated test for src/modules/project-docs-kb.ts
 * Source: src/modules/project-docs-kb.ts (56 lines, type: class)
...
const SRC_PATH = path.resolve(__dirname, '../../src/modules/project-docs-kb.ts');

describe('src/modules/project-docs-kb.ts', () => {
  let src: string;
