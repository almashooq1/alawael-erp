/**
 * Auto-generated test for src/modules/project-import-export.ts
 * Source: src/modules/project-import-export.ts (81 lines, type: class)
...
const SRC_PATH = path.resolve(__dirname, '../../src/modules/project-import-export.ts');

describe('src/modules/project-import-export.ts', () => {
  let src: string;
