/**
 * Auto-generated test for src/modules/provider-selector.ts
 * Source: src/modules/provider-selector.ts (20 lines, type: class)
...
const SRC_PATH = path.resolve(__dirname, '../../src/modules/provider-selector.ts');

describe('src/modules/provider-selector.ts', () => {
  let src: string;
