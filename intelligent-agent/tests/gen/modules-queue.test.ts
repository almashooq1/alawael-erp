/**
 * Auto-generated test for src/modules/queue.ts
 * Source: src/modules/queue.ts (21 lines, type: class)
...
const SRC_PATH = path.resolve(__dirname, '../../src/modules/queue.ts');

describe('src/modules/queue.ts', () => {
  let src: string;
