/**
 * Auto-generated test for src/modules/report-notifiers.ts
 * Source: src/modules/report-notifiers.ts (28 lines, type: module)
...
const SRC_PATH = path.resolve(__dirname, '../../src/modules/report-notifiers.ts');

describe('src/modules/report-notifiers.ts', () => {
  let src: string;
