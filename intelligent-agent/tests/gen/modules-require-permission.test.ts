/**
 * Auto-generated test for src/modules/require-permission.ts
 * Source: src/modules/require-permission.ts (23 lines, type: module)
...
const SRC_PATH = path.resolve(__dirname, '../../src/modules/require-permission.ts');

describe('src/modules/require-permission.ts', () => {
  let src: string;
