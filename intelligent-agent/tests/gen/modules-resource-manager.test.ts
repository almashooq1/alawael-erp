/**
 * Auto-generated test for src/modules/resource-manager.ts
 * Source: src/modules/resource-manager.ts (70 lines, type: class)
...
const SRC_PATH = path.resolve(__dirname, '../../src/modules/resource-manager.ts');

describe('src/modules/resource-manager.ts', () => {
  let src: string;
