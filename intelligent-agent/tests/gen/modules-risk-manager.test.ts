/**
 * Auto-generated test for src/modules/risk-manager.ts
 * Source: src/modules/risk-manager.ts (56 lines, type: class)
...
const SRC_PATH = path.resolve(__dirname, '../../src/modules/risk-manager.ts');

describe('src/modules/risk-manager.ts', () => {
  let src: string;
