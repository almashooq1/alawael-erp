/**
 * Auto-generated test for src/modules/scheduler.ts
 * Source: src/modules/scheduler.ts (17 lines, type: class)
...
const SRC_PATH = path.resolve(__dirname, '../../src/modules/scheduler.ts');

describe('src/modules/scheduler.ts', () => {
  let src: string;
