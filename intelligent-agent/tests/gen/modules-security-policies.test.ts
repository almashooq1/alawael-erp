/**
 * Auto-generated test for src/modules/security-policies.ts
 * Source: src/modules/security-policies.ts (73 lines, type: class)
...
const SRC_PATH = path.resolve(__dirname, '../../src/modules/security-policies.ts');

describe('src/modules/security-policies.ts', () => {
  let src: string;
