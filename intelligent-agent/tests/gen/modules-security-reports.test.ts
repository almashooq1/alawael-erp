/**
 * Auto-generated test for src/modules/security-reports.ts
 * Source: src/modules/security-reports.ts (19 lines, type: class)
...
const SRC_PATH = path.resolve(__dirname, '../../src/modules/security-reports.ts');

describe('src/modules/security-reports.ts', () => {
  let src: string;
