/**
 * Auto-generated test for src/modules/security.ts
 * Source: src/modules/security.ts (59 lines, type: class)
...
const SRC_PATH = path.resolve(__dirname, '../../src/modules/security.ts');

describe('src/modules/security.ts', () => {
  let src: string;
