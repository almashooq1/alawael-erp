/**
 * Auto-generated test for src/modules/self-evaluator.ts
 * Source: src/modules/self-evaluator.ts (35 lines, type: class)
...
const SRC_PATH = path.resolve(__dirname, '../../src/modules/self-evaluator.ts');

describe('src/modules/self-evaluator.ts', () => {
  let src: string;
