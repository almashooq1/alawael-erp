/**
 * Auto-generated test for src/modules/sharepoint-importer.ts
 * Source: src/modules/sharepoint-importer.ts (24 lines, type: module)
...
const SRC_PATH = path.resolve(__dirname, '../../src/modules/sharepoint-importer.ts');

describe('src/modules/sharepoint-importer.ts', () => {
  let src: string;
