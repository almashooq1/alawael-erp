/**
 * Auto-generated test for src/modules/sla-manager.ts
 * Source: src/modules/sla-manager.ts (54 lines, type: class)
...
const SRC_PATH = path.resolve(__dirname, '../../src/modules/sla-manager.ts');

describe('src/modules/sla-manager.ts', () => {
  let src: string;
