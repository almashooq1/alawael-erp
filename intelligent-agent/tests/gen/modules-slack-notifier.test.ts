/**
 * Auto-generated test for src/modules/slack-notifier.ts
 * Source: src/modules/slack-notifier.ts (14 lines, type: module)
...
const SRC_PATH = path.resolve(__dirname, '../../src/modules/slack-notifier.ts');

describe('src/modules/slack-notifier.ts', () => {
  let src: string;
