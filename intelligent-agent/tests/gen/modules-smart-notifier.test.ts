/**
 * Auto-generated test for src/modules/smart-notifier.ts
 * Source: src/modules/smart-notifier.ts (81 lines, type: class)
...
const SRC_PATH = path.resolve(__dirname, '../../src/modules/smart-notifier.ts');

describe('src/modules/smart-notifier.ts', () => {
  let src: string;
