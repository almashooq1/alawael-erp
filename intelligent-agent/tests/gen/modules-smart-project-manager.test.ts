/**
 * Auto-generated test for src/modules/smart-project-manager.ts
 * Source: src/modules/smart-project-manager.ts (143 lines, type: class)
...
const SRC_PATH = path.resolve(__dirname, '../../src/modules/smart-project-manager.ts');

describe('src/modules/smart-project-manager.ts', () => {
  let src: string;
