/**
 * Auto-generated test for src/modules/smart-task-manager.ts
 * Source: src/modules/smart-task-manager.ts (55 lines, type: class)
...
const SRC_PATH = path.resolve(__dirname, '../../src/modules/smart-task-manager.ts');

describe('src/modules/smart-task-manager.ts', () => {
  let src: string;
