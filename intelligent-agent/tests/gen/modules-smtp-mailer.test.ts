/**
 * Auto-generated test for src/modules/smtp-mailer.ts
 * Source: src/modules/smtp-mailer.ts (32 lines, type: module)
...
const SRC_PATH = path.resolve(__dirname, '../../src/modules/smtp-mailer.ts');

describe('src/modules/smtp-mailer.ts', () => {
  let src: string;
