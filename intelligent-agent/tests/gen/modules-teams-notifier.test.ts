/**
 * Auto-generated test for src/modules/teams-notifier.ts
 * Source: src/modules/teams-notifier.ts (14 lines, type: module)
...
const SRC_PATH = path.resolve(__dirname, '../../src/modules/teams-notifier.ts');

describe('src/modules/teams-notifier.ts', () => {
  let src: string;
