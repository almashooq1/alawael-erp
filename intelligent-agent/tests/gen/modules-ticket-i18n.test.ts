/**
 * Auto-generated test for src/modules/ticket-i18n.ts
 * Source: src/modules/ticket-i18n.ts (32 lines, type: class)
...
const SRC_PATH = path.resolve(__dirname, '../../src/modules/ticket-i18n.ts');

describe('src/modules/ticket-i18n.ts', () => {
  let src: string;
