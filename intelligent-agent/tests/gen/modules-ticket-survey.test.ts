/**
 * Auto-generated test for src/modules/ticket-survey.ts
 * Source: src/modules/ticket-survey.ts (34 lines, type: class)
...
const SRC_PATH = path.resolve(__dirname, '../../src/modules/ticket-survey.ts');

describe('src/modules/ticket-survey.ts', () => {
  let src: string;
