/**
 * Auto-generated test for src/modules/two-factor-auth.ts
 * Source: src/modules/two-factor-auth.ts (22 lines, type: class)
...
const SRC_PATH = path.resolve(__dirname, '../../src/modules/two-factor-auth.ts');

describe('src/modules/two-factor-auth.ts', () => {
  let src: string;
