/**
 * Auto-generated test for src/modules/user-auth.ts
 * Source: src/modules/user-auth.ts (42 lines, type: module)
...
const SRC_PATH = path.resolve(__dirname, '../../src/modules/user-auth.ts');

describe('src/modules/user-auth.ts', () => {
  let src: string;
