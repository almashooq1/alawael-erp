/**
 * Auto-generated test for src/modules/user-profile.ts
 * Source: src/modules/user-profile.ts (31 lines, type: class)
...
const SRC_PATH = path.resolve(__dirname, '../../src/modules/user-profile.ts');

describe('src/modules/user-profile.ts', () => {
  let src: string;
