/**
 * Auto-generated test for src/modules/voice-command.ts
 * Source: src/modules/voice-command.ts (18 lines, type: class)
...
const SRC_PATH = path.resolve(__dirname, '../../src/modules/voice-command.ts');

describe('src/modules/voice-command.ts', () => {
  let src: string;
