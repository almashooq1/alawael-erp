/**
 * Auto-generated test for src/modules/webhook-integration.ts
 * Source: src/modules/webhook-integration.ts (6 lines, type: module)
...
const SRC_PATH = path.resolve(__dirname, '../../src/modules/webhook-integration.ts');

describe('src/modules/webhook-integration.ts', () => {
  let src: string;
