/**
 * Auto-generated test for src/modules/webhook-manager.ts
 * Source: src/modules/webhook-manager.ts (44 lines, type: class)
...
const SRC_PATH = path.resolve(__dirname, '../../src/modules/webhook-manager.ts');

describe('src/modules/webhook-manager.ts', () => {
  let src: string;
