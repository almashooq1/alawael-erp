/**
 * Auto-generated test for src/modules/weekly-compliance-summary.ts
 * Source: src/modules/weekly-compliance-summary.ts (47 lines, type: module)
...
const SRC_PATH = path.resolve(__dirname, '../../src/modules/weekly-compliance-summary.ts');

describe('src/modules/weekly-compliance-summary.ts', () => {
  let src: string;
