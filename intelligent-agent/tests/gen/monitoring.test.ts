/**
 * Auto-generated test for src/monitoring.ts
 * Source: src/monitoring.ts (14 lines, type: module)
...
const SRC_PATH = path.resolve(__dirname, '../../src/monitoring.ts');

describe('src/monitoring.ts', () => {
  let src: string;
