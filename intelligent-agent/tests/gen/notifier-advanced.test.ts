/**
 * Auto-generated test for src/notifier-advanced.ts
 * Source: src/notifier-advanced.ts (18 lines, type: class)
...
const SRC_PATH = path.resolve(__dirname, '../../src/notifier-advanced.ts');

describe('src/notifier-advanced.ts', () => {
  let src: string;
