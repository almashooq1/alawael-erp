/**
 * Auto-generated test for src/openai-integration.ts
 * Source: src/openai-integration.ts (28 lines, type: class)
...
const SRC_PATH = path.resolve(__dirname, '../../src/openai-integration.ts');

describe('src/openai-integration.ts', () => {
  let src: string;
