/**
 * Auto-generated test for src/plugin-system.ts
 * Source: src/plugin-system.ts (17 lines, type: class)
...
const SRC_PATH = path.resolve(__dirname, '../../src/plugin-system.ts');

describe('src/plugin-system.ts', () => {
  let src: string;
