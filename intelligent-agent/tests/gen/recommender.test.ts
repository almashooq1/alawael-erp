/**
 * Auto-generated test for src/recommender.ts
 * Source: src/recommender.ts (8 lines, type: class)
...
const SRC_PATH = path.resolve(__dirname, '../../src/recommender.ts');

describe('src/recommender.ts', () => {
  let src: string;
