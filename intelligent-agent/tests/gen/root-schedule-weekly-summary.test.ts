/**
 * Auto-generated test for schedule-weekly-summary.ts
 * Source: schedule-weekly-summary.ts (12 lines, type: module)
...
const SRC_PATH = path.resolve(__dirname, '../../schedule-weekly-summary.ts');

describe('schedule-weekly-summary.ts', () => {
  let src: string;
