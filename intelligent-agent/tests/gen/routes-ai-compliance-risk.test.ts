/**
 * Auto-generated test for src/routes/ai-compliance-risk.ts
 * Source: src/routes/ai-compliance-risk.ts (20 lines, type: route)
...
const SRC_PATH = path.resolve(__dirname, '../../src/routes/ai-compliance-risk.ts');

describe('src/routes/ai-compliance-risk.ts', () => {
  let src: string;
