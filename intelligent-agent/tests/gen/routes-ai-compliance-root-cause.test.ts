/**
 * Auto-generated test for src/routes/ai-compliance-root-cause.ts
 * Source: src/routes/ai-compliance-root-cause.ts (20 lines, type: route)
...
const SRC_PATH = path.resolve(__dirname, '../../src/routes/ai-compliance-root-cause.ts');

describe('src/routes/ai-compliance-root-cause.ts', () => {
  let src: string;
