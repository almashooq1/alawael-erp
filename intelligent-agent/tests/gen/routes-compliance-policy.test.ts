/**
 * Auto-generated test for src/routes/compliance-policy.ts
 * Source: src/routes/compliance-policy.ts (85 lines, type: route)
...
const SRC_PATH = path.resolve(__dirname, '../../src/routes/compliance-policy.ts');

describe('src/routes/compliance-policy.ts', () => {
  let src: string;
