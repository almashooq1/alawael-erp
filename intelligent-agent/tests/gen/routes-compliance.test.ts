/**
 * Auto-generated test for src/routes/compliance.ts
 * Source: src/routes/compliance.ts (56 lines, type: route)
...
const SRC_PATH = path.resolve(__dirname, '../../src/routes/compliance.ts');

describe('src/routes/compliance.ts', () => {
  let src: string;
