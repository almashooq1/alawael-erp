/**
 * Auto-generated test for src/routes/export-compliance-to-sheets.ts
 * Source: src/routes/export-compliance-to-sheets.ts (21 lines, type: route)
...
const SRC_PATH = path.resolve(__dirname, '../../src/routes/export-compliance-to-sheets.ts');

describe('src/routes/export-compliance-to-sheets.ts', () => {
  let src: string;
