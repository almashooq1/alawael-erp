/**
 * Auto-generated test for src/routes/knowledge.ts
 * Source: src/routes/knowledge.ts (85 lines, type: route)
...
const SRC_PATH = path.resolve(__dirname, '../../src/routes/knowledge.ts');

describe('src/routes/knowledge.ts', () => {
  let src: string;
