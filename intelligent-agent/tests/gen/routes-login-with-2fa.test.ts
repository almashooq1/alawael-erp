/**
 * Auto-generated test for src/routes/login-with-2fa.ts
 * Source: src/routes/login-with-2fa.ts (27 lines, type: route)
...
const SRC_PATH = path.resolve(__dirname, '../../src/routes/login-with-2fa.ts');

describe('src/routes/login-with-2fa.ts', () => {
  let src: string;
