/**
 * Auto-generated test for src/routes/monitoring.ts
 * Source: src/routes/monitoring.ts (234 lines, type: route)
...
const SRC_PATH = path.resolve(__dirname, '../../src/routes/monitoring.ts');

describe('src/routes/monitoring.ts', () => {
  let src: string;
