/**
 * Auto-generated test for scripts/auto-optimizer.ts
 * Source: scripts/auto-optimizer.ts (340 lines, type: module)
...
const SRC_PATH = path.resolve(__dirname, '../../scripts/auto-optimizer.ts');

describe('scripts/auto-optimizer.ts', () => {
  let src: string;
