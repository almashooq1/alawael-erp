/**
 * Auto-generated test for scripts/deployment-wizard.ts
 * Source: scripts/deployment-wizard.ts (319 lines, type: module)
...
const SRC_PATH = path.resolve(__dirname, '../../scripts/deployment-wizard.ts');

describe('scripts/deployment-wizard.ts', () => {
  let src: string;
