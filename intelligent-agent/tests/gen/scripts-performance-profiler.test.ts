/**
 * Auto-generated test for scripts/performance-profiler.ts
 * Source: scripts/performance-profiler.ts (406 lines, type: module)
...
const SRC_PATH = path.resolve(__dirname, '../../scripts/performance-profiler.ts');

describe('scripts/performance-profiler.ts', () => {
  let src: string;
