/**
 * Auto-generated test for src/secrets.ts
 * Source: src/secrets.ts (14 lines, type: class)
...
const SRC_PATH = path.resolve(__dirname, '../../src/secrets.ts');

describe('src/secrets.ts', () => {
  let src: string;
