/**
 * Auto-generated test for src/swagger.ts
 * Source: src/swagger.ts (65 lines, type: module)
...
const SRC_PATH = path.resolve(__dirname, '../../src/swagger.ts');

describe('src/swagger.ts', () => {
  let src: string;
