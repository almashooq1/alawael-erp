/**
 * Auto-generated test for src/tenant-middleware.ts
 * Source: src/tenant-middleware.ts (14 lines, type: middleware)
...
const SRC_PATH = path.resolve(__dirname, '../../src/tenant-middleware.ts');

describe('src/tenant-middleware.ts', () => {
  let src: string;
