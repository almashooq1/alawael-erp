/**
 * Auto-generated test for src/usage-analytics.ts
 * Source: src/usage-analytics.ts (14 lines, type: class)
...
const SRC_PATH = path.resolve(__dirname, '../../src/usage-analytics.ts');

describe('src/usage-analytics.ts', () => {
  let src: string;
