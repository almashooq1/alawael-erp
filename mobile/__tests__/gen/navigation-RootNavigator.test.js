/**
 * Auto-generated test for ../../navigation/RootNavigator.js
 * Project: mobile
 * Type: module (React)
...
describe('../../navigation/RootNavigator.js', () => {
  let src;

  beforeAll(() => {
    const filePath = path.resolve(__dirname, '../../navigation/RootNavigator.js');
    ...
    test('file has reasonable length (220 lines)', () => {
      expect(220).toBeGreaterThan(0);
      expect(220).toBeLessThan(10000);
    });
