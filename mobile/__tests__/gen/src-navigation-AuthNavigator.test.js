/**
 * Auto-generated test for ../../src/navigation/AuthNavigator.js
 * Project: mobile
 * Type: module (React)
...
describe('../../src/navigation/AuthNavigator.js', () => {
  let src;

  beforeAll(() => {
    const filePath = path.resolve(__dirname, '../../src/navigation/AuthNavigator.js');
