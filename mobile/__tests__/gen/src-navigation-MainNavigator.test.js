/**
 * Auto-generated test for ../../src/navigation/MainNavigator.js
 * Project: mobile
 * Type: module (React)
...
describe('../../src/navigation/MainNavigator.js', () => {
  let src;

  beforeAll(() => {
    const filePath = path.resolve(__dirname, '../../src/navigation/MainNavigator.js');
