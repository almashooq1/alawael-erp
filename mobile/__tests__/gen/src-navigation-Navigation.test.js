/**
 * Auto-generated test for ../../src/navigation/Navigation.js
 * Project: mobile
 * Type: module (React)
...
describe('../../src/navigation/Navigation.js', () => {
  let src;

  beforeAll(() => {
    const filePath = path.resolve(__dirname, '../../src/navigation/Navigation.js');
