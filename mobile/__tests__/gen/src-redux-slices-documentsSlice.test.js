/**
 * Auto-generated test for ../../src/redux/slices/documentsSlice.js
 * Project: mobile
 * Type: module
...
describe('../../src/redux/slices/documentsSlice.js', () => {
  let src;

  beforeAll(() => {
    const filePath = path.resolve(__dirname, '../../src/redux/slices/documentsSlice.js');
