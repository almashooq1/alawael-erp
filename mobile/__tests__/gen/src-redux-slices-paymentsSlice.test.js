/**
 * Auto-generated test for ../../src/redux/slices/paymentsSlice.js
 * Project: mobile
 * Type: module
...
describe('../../src/redux/slices/paymentsSlice.js', () => {
  let src;

  beforeAll(() => {
    const filePath = path.resolve(__dirname, '../../src/redux/slices/paymentsSlice.js');
