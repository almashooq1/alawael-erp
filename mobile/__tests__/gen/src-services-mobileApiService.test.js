/**
 * Auto-generated test for ../../src/services/mobileApiService.js
 * Project: mobile
 * Type: service
...
describe('../../src/services/mobileApiService.js', () => {
  let src;

  beforeAll(() => {
    const filePath = path.resolve(__dirname, '../../src/services/mobileApiService.js');
