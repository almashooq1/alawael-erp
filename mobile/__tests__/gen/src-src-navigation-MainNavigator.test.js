/**
 * Auto-generated test for ../../src/src/navigation/MainNavigator.js
 * Project: mobile
 * Type: module (React)
...
describe('../../src/src/navigation/MainNavigator.js', () => {
  let src;

  beforeAll(() => {
    const filePath = path.resolve(__dirname, '../../src/src/navigation/MainNavigator.js');
    ...
    test('file has reasonable length (346 lines)', () => {
      expect(346).toBeGreaterThan(0);
      expect(346).toBeLessThan(10000);
    });
