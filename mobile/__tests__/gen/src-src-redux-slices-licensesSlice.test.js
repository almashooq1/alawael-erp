/**
 * Auto-generated test for ../../src/src/redux/slices/licensesSlice.js
 * Project: mobile
 * Type: module
...
describe('../../src/src/redux/slices/licensesSlice.js', () => {
  let src;

  beforeAll(() => {
    const filePath = path.resolve(__dirname, '../../src/src/redux/slices/licensesSlice.js');
