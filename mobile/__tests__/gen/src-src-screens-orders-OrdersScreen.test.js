/**
 * Auto-generated test for ../../src/src/screens/orders/OrdersScreen.tsx
 * Project: mobile
...
describe('../../src/src/screens/orders/OrdersScreen.tsx', () => {
  let src;

  beforeAll(() => {
    const filePath = path.resolve(__dirname, '../../src/src/screens/orders/OrdersScreen.tsx');
    ...
    test('file has reasonable length (337 lines)', () => {
      expect(337).toBeGreaterThan(0);
      expect(337).toBeLessThan(10000);
    });
