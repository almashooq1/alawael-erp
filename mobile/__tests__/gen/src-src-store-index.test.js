/**
 * Auto-generated test for ../../src/src/store/index.ts
 * Project: mobile
 * Type: store
...
describe('../../src/src/store/index.ts', () => {
  let src;

  beforeAll(() => {
    const filePath = path.resolve(__dirname, '../../src/src/store/index.ts');
    ...
    test('file has reasonable length (40 lines)', () => {
      expect(40).toBeGreaterThan(0);
      expect(40).toBeLessThan(10000);
    });
