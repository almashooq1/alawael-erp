/**
 * Auto-generated test for ../../src/src/store/slices/analyticsSlice.ts
 * Project: mobile
 * Type: store
...
describe('../../src/src/store/slices/analyticsSlice.ts', () => {
  let src;

  beforeAll(() => {
    const filePath = path.resolve(__dirname, '../../src/src/store/slices/analyticsSlice.ts');
    ...
    test('file has reasonable length (163 lines)', () => {
      expect(163).toBeGreaterThan(0);
      expect(163).toBeLessThan(10000);
    });
