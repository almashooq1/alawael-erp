/**
 * Auto-generated test for ../../src/store/slices/analyticsSlice.ts
 * Project: mobile
 * Type: store
...
describe('../../src/store/slices/analyticsSlice.ts', () => {
  let src;

  beforeAll(() => {
    const filePath = path.resolve(__dirname, '../../src/store/slices/analyticsSlice.ts');
