/**
 * Auto-generated test for ../../src/store/slices/notificationsSlice.ts
 * Project: mobile
 * Type: store
...
describe('../../src/store/slices/notificationsSlice.ts', () => {
  let src;

  beforeAll(() => {
    const filePath = path.resolve(__dirname, '../../src/store/slices/notificationsSlice.ts');
