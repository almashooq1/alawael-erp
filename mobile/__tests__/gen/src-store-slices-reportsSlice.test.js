/**
 * Auto-generated test for ../../src/store/slices/reportsSlice.ts
 * Project: mobile
 * Type: store
...
describe('../../src/store/slices/reportsSlice.ts', () => {
  let src;

  beforeAll(() => {
    const filePath = path.resolve(__dirname, '../../src/store/slices/reportsSlice.ts');
