/**
 * Auto-generated test for services/analytics-bi-service/server.js
 * Source: services/analytics-bi-service/server.js (614 lines)
...
const SRC_PATH = path.resolve(__dirname, '../../analytics-bi-service/server.js');

describe('services/analytics-bi-service/server.js', () => {
  let src;
