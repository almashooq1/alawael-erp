/**
 * Auto-generated test for services/audit-service/server.js
 * Source: services/audit-service/server.js (301 lines)
...
const SRC_PATH = path.resolve(__dirname, '../../audit-service/server.js');

describe('services/audit-service/server.js', () => {
  let src;
