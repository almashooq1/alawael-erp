/**
 * Auto-generated test for services/backup-recovery-service/server.js
 * Source: services/backup-recovery-service/server.js (718 lines)
...
const SRC_PATH = path.resolve(__dirname, '../../backup-recovery-service/server.js');

describe('services/backup-recovery-service/server.js', () => {
  let src;
