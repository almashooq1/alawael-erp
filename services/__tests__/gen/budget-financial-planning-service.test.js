/**
 * Auto-generated test for services/budget-financial-planning-service/server.js
 * Source: services/budget-financial-planning-service/server.js (381 lines)
...
const SRC_PATH = path.resolve(__dirname, '../../budget-financial-planning-service/server.js');

describe('services/budget-financial-planning-service/server.js', () => {
  let src;
  ...
  test('defines HTTP route handlers (14 routes detected)', () => {
