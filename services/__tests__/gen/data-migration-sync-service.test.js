/**
 * Auto-generated test for services/data-migration-sync-service/server.js
 * Source: services/data-migration-sync-service/server.js (1125 lines)
...
const SRC_PATH = path.resolve(__dirname, '../../data-migration-sync-service/server.js');

describe('services/data-migration-sync-service/server.js', () => {
  let src;
  ...
  test('defines HTTP route handlers (25 routes detected)', () => {
