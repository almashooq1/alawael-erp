/**
 * Auto-generated test for services/external-integration-hub-service/server.js
 * Source: services/external-integration-hub-service/server.js (430 lines)
...
const SRC_PATH = path.resolve(__dirname, '../../external-integration-hub-service/server.js');

describe('services/external-integration-hub-service/server.js', () => {
  let src;
