/**
 * Auto-generated test for services/facility-space-management-service/server.js
 * Source: services/facility-space-management-service/server.js (433 lines)
...
const SRC_PATH = path.resolve(__dirname, '../../facility-space-management-service/server.js');

describe('services/facility-space-management-service/server.js', () => {
  let src;
  ...
  test('defines HTTP route handlers (15 routes detected)', () => {
