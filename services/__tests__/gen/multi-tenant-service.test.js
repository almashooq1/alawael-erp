/**
 * Auto-generated test for services/multi-tenant-service/server.js
 * Source: services/multi-tenant-service/server.js (701 lines)
...
const SRC_PATH = path.resolve(__dirname, '../../multi-tenant-service/server.js');

describe('services/multi-tenant-service/server.js', () => {
  let src;
  ...
  test('defines HTTP route handlers (21 routes detected)', () => {
