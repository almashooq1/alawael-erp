/**
 * Auto-generated test for services/notification-center-service/server.js
 * Source: services/notification-center-service/server.js (722 lines)
...
const SRC_PATH = path.resolve(__dirname, '../../notification-center-service/server.js');

describe('services/notification-center-service/server.js', () => {
  let src;
  ...
  test('defines HTTP route handlers (18 routes detected)', () => {
