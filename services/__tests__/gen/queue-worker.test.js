/**
 * Auto-generated test for services/queue-worker/worker.js
 * Source: services/queue-worker/worker.js (372 lines)
...
const SRC_PATH = path.resolve(__dirname, '../../queue-worker/worker.js');

describe('services/queue-worker/worker.js', () => {
  let src;
  ...
  test('defines HTTP route handlers (4 routes detected)', () => {
