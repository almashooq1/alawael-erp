/**
 * Auto-generated test for services/report-worker/server.js
 * Source: services/report-worker/server.js (285 lines)
...
const SRC_PATH = path.resolve(__dirname, '../../report-worker/server.js');

describe('services/report-worker/server.js', () => {
  let src;
  ...
  test('defines HTTP route handlers (5 routes detected)', () => {
