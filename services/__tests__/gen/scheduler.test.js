/**
 * Auto-generated test for services/scheduler/server.js
 * Source: services/scheduler/server.js (425 lines)
...
const SRC_PATH = path.resolve(__dirname, '../../scheduler/server.js');

describe('services/scheduler/server.js', () => {
  let src;
