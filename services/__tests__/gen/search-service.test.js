/**
 * Auto-generated test for services/search-service/server.js
 * Source: services/search-service/server.js (420 lines)
...
const SRC_PATH = path.resolve(__dirname, '../../search-service/server.js');

describe('services/search-service/server.js', () => {
  let src;
