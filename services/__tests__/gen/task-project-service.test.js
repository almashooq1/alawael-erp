/**
 * Auto-generated test for services/task-project-service/server.js
 * Source: services/task-project-service/server.js (655 lines)
...
const SRC_PATH = path.resolve(__dirname, '../../task-project-service/server.js');

describe('services/task-project-service/server.js', () => {
  let src;
