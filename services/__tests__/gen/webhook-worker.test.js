/**
 * Auto-generated test for services/webhook-worker/server.js
 * Source: services/webhook-worker/server.js (368 lines)
...
const SRC_PATH = path.resolve(__dirname, '../../webhook-worker/server.js');

describe('services/webhook-worker/server.js', () => {
  let src;
  ...
  test('defines HTTP route handlers (9 routes detected)', () => {
