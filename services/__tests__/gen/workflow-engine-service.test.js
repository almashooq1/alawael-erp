/**
 * Auto-generated test for services/workflow-engine-service/server.js
 * Source: services/workflow-engine-service/server.js (984 lines)
...
const SRC_PATH = path.resolve(__dirname, '../../workflow-engine-service/server.js');

describe('services/workflow-engine-service/server.js', () => {
  let src;
