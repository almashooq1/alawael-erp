...
import { Box, Container, Tabs, Tab, Paper, Typography, Button, Stack } from '@mui/material';
  ...
  return (
    <Container maxWidth="xl" sx={{ py: 4 }}>
      ...
      <Paper sx={{ mb: 3 }}>
        ...
        >
          <Tab label="Generate" icon={<AddIcon />} iconPosition="start" id="barcode-tab-0" />
          <Tab label="Scan" icon={<CameraAltIcon />} iconPosition="start" id="barcode-tab-1" />
          <Tab
            label="Batch Create"
            ...
            id="barcode-tab-2"
          />
          <Tab label="Manage" icon={<ListIcon />} iconPosition="start" id="barcode-tab-3" />
          <Tab
            label="Statistics"
