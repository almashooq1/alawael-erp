        ...
        <CardContent>
          ...
          <Grid container spacing={2}>
            <Grid item xs={12} sm={6}>
              ...
              <Typography variant="body1">{caseData.beneficiaryId?.fullName || 'N/A'}</Typography>
            </Grid>
            <Grid item xs={12} sm={6}>
              <Typography variant="body2" color="textSecondary">
                العمر
              </Typography>
              <Typography variant="body1">{caseData.beneficiaryId?.age || 'N/A'} سنة</Typography>
            </Grid>
            <Grid item xs={12} sm={6}>
              <Typography variant="body2" color="textSecondary">
                الجنس
            ...
            <Grid item xs={12} sm={6}>
              ...
              <Typography variant="body1">{caseData.beneficiaryId?.nationalId || 'N/A'}</Typography>
            </Grid>
          </Grid>
        </CardContent>
      </Card>
