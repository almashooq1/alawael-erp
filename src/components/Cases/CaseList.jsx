  ...
  return (
    <>
            ...
            {cases.length > 0 ? (
              cases.map(caseItem => (
                <TableRow key={caseItem._id} hover>
                  ...
                  <TableCell align="right">{caseItem.beneficiaryId?.age || 'N/A'}</TableCell>
                  <TableCell align="right">
      ...
      <Dialog open={showDetails} onClose={() => setShowDetails(false)} maxWidth="md" fullWidth>
        ...
        <DialogContent>{selectedCase && <CaseDetails caseData={selectedCase} />}</DialogContent>
        <DialogActions>
      ...
      <Dialog open={Boolean(deleteConfirm)} onClose={() => setDeleteConfirm(null)}>
        ...
        <DialogActions>
          ...
          <Button onClick={handleDeleteCase} color="error" variant="contained" disabled={deleting}>
