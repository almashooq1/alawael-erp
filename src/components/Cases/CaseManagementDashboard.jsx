...
function CaseManagementDashboard() {
  ...
  return (
    <Container maxWidth="lg" sx={{ py: 4 }}>
      ...
      {activeTab === 2 && statistics && <CaseStatistics statistics={statistics} />}
      ...
      {selectedCase && (
        <Dialog open={true} onClose={() => setSelectedCase(null)} maxWidth="md" fullWidth>
      ...
      >
        ...
        <DialogContent>
          <CreateCase onSubmit={handleCreateCase} onClose={() => setShowCreateDialog(false)} />
        </DialogContent>
      </Dialog>
    </Container>
  );
