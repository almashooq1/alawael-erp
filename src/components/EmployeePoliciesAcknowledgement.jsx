    ...
    <Container className="mt-4" dir="rtl">
      ...
      <Row className="mb-4">
        <Col>
          ...
          <p className="text-muted">هنا يمكنك مراجعة والاعتراف بالسياسات المطلوبة</p>
        </Col>
      </Row>
        ...
        <Col md={4}>
          <Card className="text-center">
            <Card.Body>
              ...
              <h2 className="text-danger">{pendingAcknowledgements.length}</h2>
            </Card.Body>
          </Card>
        </Col>
        <Col md={4}>
          <Card className="text-center">
            <Card.Body>
              <h5>المعترف به</h5>
              <h2 className="text-success">{acknowledgedPolicies.length}</h2>
            </Card.Body>
          </Card>
        </Col>
        <Col md={4}>
                ...
                {pendingAcknowledgements.length === 0
                  ...
                  : (
                      (acknowledgedPolicies.length /
                        (pendingAcknowledgements.length + acknowledgedPolicies.length)) *
                      100
                    ).toFixed(0) + '%'}
              </h2>
            </Card.Body>
          ...
          {loading ? (
            ...
            <>
                      ...
                      <div className="form-check">
                        ...
                        <label className="form-check-label" htmlFor={ack._id}>
                          ...
                          <small className="text-muted">
                            تاريخ الاستحقاق: {new Date(ack.dueDate).toLocaleDateString('ar')}
                          </small>
                        </label>
                      </div>
                      <div>
              ...
              <div className="d-flex gap-2">
                ...
                <Button variant="outline-secondary" onClick={() => setSelectedPolicies([])}>
                  إلغاء التحديد
                </Button>
              </div>
            </>
      ...
      <Modal show={showPolicyModal} onHide={() => setShowPolicyModal(false)} size="lg" dir="rtl">
          ...
          {selectedPolicy && (
            <>
              ...
              <div className="mb-3">
                ...
                <p>{new Date(selectedPolicy.dueDate).toLocaleDateString('ar')}</p>
              </div>

              {selectedPolicy.trainingRequired && (
                <Alert variant="info">⚠️ هذه السياسة تتطلب تدريب إلزامي</Alert>
              )}
            </>
          )}
        </Modal.Body>
