      ...
      {activeTab === 'slack' && (
        <div className="tab-content">
          <div className="config-panel">
            ...
            <p className="status-indicator">Status: {getStatusBadge(slackConfig.testStatus)}</p>
            ...
            <div className="form-group">
              ...
              <input
                ...
                onChange={e => setSlackConfig(prev => ({ ...prev, channelId: e.target.value }))}
              />
            </div>
            ...
            <div className="form-group checkbox">
              <input
                ...
                onChange={e => setSlackConfig(prev => ({ ...prev, isEnabled: e.target.checked }))}
              />
            ...
            <div className="button-group">
              ...
              <button onClick={saveSlackConfig} className="btn btn-primary" disabled={loading}>
                💾 Save Configuration
              </button>
            </div>
          </div>
      ...
      {activeTab === 'email' && (
        <div className="tab-content">
          <div className="config-panel">
            ...
            <p className="status-indicator">Status: {getStatusBadge(emailConfig.testStatus)}</p>
            ...
            <div className="form-group checkbox">
              <input
                ...
                onChange={e => setEmailConfig(prev => ({ ...prev, isEnabled: e.target.checked }))}
              />
            ...
            <div className="button-group">
              ...
              <button onClick={saveEmailConfig} className="btn btn-primary" disabled={loading}>
                💾 Save Configuration
              </button>
            </div>
          </div>
      ...
      {activeTab === 'webhook' && (
        <div className="tab-content">
          <div className="config-panel">
            ...
            <p className="status-indicator">Status: {getStatusBadge(webhookConfig.testStatus)}</p>
            ...
            <div className="form-group">
              ...
              <select
                ...
                onChange={e => setWebhookConfig(prev => ({ ...prev, retryPolicy: e.target.value }))}
              >
            ...
            <div className="form-group">
              ...
              <div className="event-types">
                {['user.created', 'user.updated', 'report.generated', 'project.completed'].map(
                  event => (
            ...
            <div className="button-group">
              ...
              <button onClick={registerWebhook} className="btn btn-primary" disabled={loading}>
                📝 Register Webhook
              </button>
            </div>
          </div>
