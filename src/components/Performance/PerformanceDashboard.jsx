    ...
    <Box className="performance-dashboard-container">
      <div className="dashboard-header">
        ...
        <div className="header-controls">
          ...
          <Button variant="outlined" onClick={loadData} className="btn-refresh">
            🔄 تحديث الآن
          </Button>
        </div>
      </div>
      ...
      <Box className="status-cards">
        ...
        <Card className="status-card">
          <CardContent>
            <h3>معدل الأخطاء</h3>
            {errorRate && (
              <p className="error-rate-text">{errorRate.error_rate_percent.toFixed(2)}%</p>
            )}
          </CardContent>
        </Card>
        ...
        <Card className="status-card">
          <CardContent>
            ...
            {apiMetrics && <p className="requests-text">{Math.round(apiMetrics.request_count)}</p>}
          </CardContent>
        </Card>
      </Box>
                    ...
                    <CardContent>
                      <Box className="metric-display">
                        ...
                        <p className="metric-status">
                          ...
                          <Chip
                            size="small"
                            label={MonitoringService.getStatusText(systemMetrics.memory.status)}
                            style={{
                              backgroundColor: MonitoringService.getStatusColor(
                      ...
                      <Grid container spacing={2}>
                        ...
                        <Grid item xs={6} md={2}>
                          <Box className="metric-box">
                            ...
                            <p className="metric-value">{Math.round(apiMetrics.request_count)}</p>
                          </Box>
                        </Grid>
                      </Grid>
                    </CardContent>
              ...
              <>
                  ...
                  <Card>
                    ...
                    <CardContent>
                      <Box className="error-summary">
                        <p className="error-rate">{errorRate.error_rate_percent.toFixed(2)}%</p>
                ...
                <Grid item xs={12} md={8}>
                  <Card>
                    ...
                    <CardContent>
                      {errorRate.errors_by_status &&
                      Object.keys(errorRate.errors_by_status).length > 0 ? (
                        <Table size="small">
                          <TableHead>
                            <TableRow>
