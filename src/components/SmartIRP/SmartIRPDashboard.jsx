            ...
            <Grid container spacing={2}>
              <Grid item xs={12} md={4}>
                <Box sx={{ textAlign: 'center', p: 2 }}>
                  ...
                  <Typography variant="h4">{irp.kpis.benchmarks.nationalAverage}%</Typography>
                </Box>
              </Grid>
              <Grid item xs={12} md={4}>
                <Box sx={{ textAlign: 'center', p: 2, bgcolor: 'primary.light', borderRadius: 1 }}>
                  <Typography variant="body2">متوسط البرنامج</Typography>
                  <Typography variant="h4">{irp.kpis.benchmarks.programAverage}%</Typography>
                </Box>
              </Grid>
              <Grid item xs={12} md={4}>
                <Box sx={{ textAlign: 'center', p: 2 }}>
                  ...
                  <Typography variant="h4">{irp.kpis.benchmarks.ageGroupAverage}%</Typography>
                </Box>
              </Grid>
            </Grid>
          ...
          <CardContent>
            ...
            {analytics.recentAlerts.map((alert, index) => (
              <Alert
                ...
                action={
                  !alert.acknowledged && (
                    <Button size="small" onClick={() => acknowledgeAlert(alert.goalId, index)}>
                      تأكيد القراءة
                    </Button>
                  )
                }
                ...
                <Grid container spacing={2} alignItems="center">
                  <Grid item xs={12} md={8}>
                    ...
                    <Typography variant="caption" color="textSecondary">
                      الهدف: {goal.measurable.target} {goal.measurable.unit} | الحالي:{' '}
                  ...
                  <Grid item xs={12} md={4}>
                    <Box sx={{ textAlign: { md: 'left' } }}>
                      ...
                      <Typography variant="caption" color="textSecondary">
                        تاريخ الهدف:{' '}
                        {new Date(goal.timeBound.targetDate).toLocaleDateString('ar-SA')}
                      </Typography>
                      <Box sx={{ mt: 1 }}>
                        <Button
                          size="small"
                    ...
                    {goal.alerts
                      ...
                      .map((alert, aIndex) => (
                        <Alert
                          ...
                          sx={{ mb: 1 }}
                          action={
                            <Button size="small" onClick={() => acknowledgeAlert(goal._id, aIndex)}>
                              تأكيد
                            </Button>
                          }
                        >
