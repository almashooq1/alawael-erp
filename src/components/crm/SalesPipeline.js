      ...
      <Grid container spacing={2} sx={{ mb: 3 }}>
        {[
          { label: 'إجمالي العقود', value: statistics.totalDeals, icon: '📊' },
          {
            ...
            value: `${(statistics.totalAmount / 1000).toFixed(0)}K`,
            icon: '💰',
          },
          {
            label: 'القيمة المغلقة',
            value: `${(statistics.wonAmount / 1000).toFixed(0)}K`,
            icon: '✅',
          },
          {
            label: 'متوسط حجم العقد',
            value: `${(statistics.avgDealSize / 1000).toFixed(0)}K`,
            icon: '📈',
          },
        ...
        {stages.map(stage => (
          ...
          >
            ...
            >
              ...
              <Chip
                label={stageDeals[stage.id].length}
                size="small"
                sx={{ backgroundColor: stage.textColor, color: 'white' }}
              />
            </Box>
            <Divider sx={{ mb: 2 }} />
                ...
                >
                  <CardContent sx={{ p: 1.5, '&:last-child': { pb: 1.5 } }}>
                    ...
                    >
                      <Typography
                        variant="body2"
                        sx={{ fontWeight: 600, flex: 1, color: stage.textColor }}
                      >
                        {deal.title}
                      </Typography>
                      <Chip
                        ...
                        sx={{
                          fontSize: '0.75rem',
                          backgroundColor: stage.textColor + '20',
