...
const MaintenanceModule = ({ vehicleId }) => {
  ...
  if (loading) {
    return <Box sx={{ display: 'flex', justifyContent: 'center', p: 3 }}>جاري التحميل...</Box>;
  }
        ...
        <Grid container spacing={2} sx={{ mb: 3 }}>
          ...
          <Grid item xs={12} md={6}>
            ...
            >
              ...
              <Divider sx={{ my: 2, borderColor: 'rgba(255,255,255,0.3)' }} />
              <Typography variant="body2">✓ الحالة: تم إجراء الصيانة بنجاح</Typography>
            </Paper>
          </Grid>
        </Grid>
      )}
            ...
            <TableBody>
              {maintenanceHistory.map(record => (
                <TableRow key={record.id} hover>
                  ...
                  <TableCell sx={{ fontWeight: 600 }}>{record.cost} ر.س</TableCell>
        ...
        <DialogContent sx={{ mt: 2 }}>
          <Stack spacing={2}>
            ...
            <TextField
              ...
              onChange={e =>
                setMaintenanceForm({ ...maintenanceForm, cost: parseFloat(e.target.value) })
              }
              fullWidth
            />
            ...
            <TextField
              ...
              onChange={e =>
                setMaintenanceForm({ ...maintenanceForm, mileage: parseFloat(e.target.value) })
              }
              fullWidth
            />
          ...
          <Stack spacing={2}>
            ...
            <FormControl fullWidth>
              ...
              <Select
                ...
                onChange={e =>
                  setInspectionForm({ ...inspectionForm, emissionStatus: e.target.value })
                }
            ...
            <FormControl fullWidth>
              ...
              <Select
                ...
                onChange={e =>
                  setInspectionForm({ ...inspectionForm, safetyStatus: e.target.value })
                }
                label="حالة الأمان"
              >
                <MenuItem value="جيد">جيد</MenuItem>
