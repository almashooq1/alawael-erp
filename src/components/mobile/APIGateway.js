              ...
              <TableBody>
                {apis.map(api => (
                  <TableRow key={api.id} sx={{ '&:hover': { backgroundColor: '#f8f9ff' } }}>
                    ...
                    <TableCell>
                      <Code
                        sx={{ fontSize: 12, backgroundColor: '#f8f9ff', p: 1, borderRadius: 1 }}
                      >
                  ...
                  >
                    ...
                    <Box sx={{ textAlign: 'right' }}>
                      ...
                      <Typography
                        ...
                        sx={{
                          display: 'block',
                          color: integration.errorRate > 1 ? '#f44336' : '#4caf50',
                        }}
                      >
          ...
          {rateLimits.map(limit => (
            <Paper key={limit.id} sx={{ p: 2.5, borderRadius: 2, mb: 2 }}>
              ...
              >
                ...
                <Typography
                  variant="caption"
                  sx={{ fontWeight: 600, color: limit.percentage > 80 ? '#f44336' : '#4caf50' }}
                >
                  ...
                  <TableRow key={log.id} sx={{ '&:hover': { backgroundColor: '#f8f9ff' } }}>
                    ...
                    <TableCell>
                      <Chip
                        ...
                        icon={
                          log.status === 200 || log.status === 201 ? <CheckIcon /> : <ErrorIcon />
                        }
                      />
                    </TableCell>
