...
import { Warning, TrendingUp, CheckCircle, Info, Lightbulb } from '@mui/icons-material';
          ...
          <Box sx={{ mt: 2 }}>
            <List>
              <ListItem>
                ...
                <ListItemText primary="إجمالي سير العمل" secondary={systemReport.totalWorkflows} />
              </ListItem>
              <ListItem>
                <ListItemIcon>
