...
import { Add, Edit, AccountBalance, Search } from '@mui/icons-material';
...
const AccountsList = () => {
  ...
  const handleSubmit = async () => {
    try {
      ...
      if (editingAccount) {
        await axios.put(`/api/accounting/accounts/${editingAccount._id}`, formData, {
          headers: { Authorization: `Bearer ${token}` },
        });
      } else {
  ...
  return (
    <Box>
          ...
          <Table>
            ...
            <TableBody>
              {loading ? (
                ...
                <TableRow>
                  <TableCell colSpan={6} align="center">
                    <Typography color="textSecondary">لا توجد حسابات</Typography>
                  </TableCell>
                </TableRow>
              ) : (
      ...
      <Dialog open={openDialog} onClose={handleCloseDialog} maxWidth="sm" fullWidth>
        <DialogTitle>{editingAccount ? 'تعديل حساب' : 'حساب جديد'}</DialogTitle>
        <DialogContent>
