            ...
            <CardContent>
              <Box display="flex" justifyContent="space-between" alignItems="center">
                <Box>
                  ...
                  <Typography variant="body2">إجمالي المستفيدين</Typography>
                </Box>
            ...
            <CardContent>
              <Box display="flex" justifyContent="space-between" alignItems="center">
                <Box>
                  ...
                  <Typography variant="body2">مستفيدين نشطين</Typography>
                </Box>
                <Avatar sx={{ bgcolor: 'rgba(255,255,255,0.3)', width: 56, height: 56 }}>
            ...
            <CardContent>
              <Box display="flex" justifyContent="space-between" alignItems="center">
                <Box>
                  ...
                  <Typography variant="body2">جديد هذا الشهر</Typography>
                </Box>
                <Avatar sx={{ bgcolor: 'rgba(255,255,255,0.3)', width: 56, height: 56 }}>
            ...
            >
              <CardContent>
                <Box display="flex" justifyContent="space-between" alignItems="start" mb={2}>
                  <Box display="flex" gap={2}>
                    ...
                    <Box>
                      ...
                      <Chip label={beneficiary.nationalId} size="small" sx={{ mt: 0.5 }} />
                    </Box>
                  </Box>
                  <IconButton size="small" onClick={() => toggleFavorite(beneficiary.id)}>
                ...
                <Stack direction="row" spacing={1} sx={{ mb: 2 }}>
                  ...
                  <Chip
                    label={
                      beneficiary.category === 'physical'
                        ? 'حركية'
                        : beneficiary.category === 'mental'
                          ? 'ذهنية'
                          : beneficiary.category === 'sensory'
                            ? 'حسية'
                            : 'متعددة'
                    }
                    size="small"
