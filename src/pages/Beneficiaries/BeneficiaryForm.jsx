...
const BeneficiaryForm = () => {
  ...
  const disabilityTypes = ['physical', 'mental', 'sensory', 'multiple', 'developmental'];
      ...
      case 0:
        return (
          <Grid container spacing={2}>
            ...
            <Grid item xs={12}>
              <Field as={TextField} fullWidth label="العنوان" name="address" multiline rows={2} />
            </Grid>
            <Grid item xs={12} md={6}>
              <Field as={TextField} fullWidth label="المدينة" name="city" />
            </Grid>
            <Grid item xs={12} md={6}>
              <Field as={TextField} fullWidth label="المنطقة" name="region" />
            </Grid>
          </Grid>
        );
      case 1:
        return (
          <Grid container spacing={2}>
            ...
            <Grid item xs={12} md={6}>
              <Field as={TextField} fullWidth label="فئة الإعاقة" name="disability_category" />
            </Grid>
            <Grid item xs={12} md={6}>
              <FormControl fullWidth>
      ...
      case 2:
        return (
          <Grid container spacing={2}>
            ...
            <Grid item xs={12} md={6}>
              <Field as={TextField} fullWidth label="صلة القرابة" name="guardian_relationship" />
            </Grid>
            <Grid item xs={12} md={6}>
              <Field
                as={TextField}
