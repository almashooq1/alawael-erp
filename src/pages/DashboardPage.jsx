          ...
          <LinearProgress
            ...
            sx={{
              ...
              '& .MuiLinearProgress-bar': {
                borderRadius: 4,
                bgcolor:
                  progress >= 90 ? 'success.main' : progress >= 70 ? 'warning.main' : 'error.main',
              },
            }}
          />
      ...
      <Box dir="rtl" sx={{ bgcolor: 'background.default', minHeight: '100vh', p: 3 }}>
        ...
        <Grid container spacing={3} sx={{ mb: 4 }}>
          <Grid item xs={12} sm={6} md={4}>
            <KPICard label="نسبة الحضور" value={92} target={90} unit="%" progress={102} />
          </Grid>
          <Grid item xs={12} sm={6} md={4}>
            <KPICard label="نسبة الرضا" value={87} target={85} unit="%" progress={102} />
          </Grid>
          <Grid item xs={12} sm={6} md={4}>
            <KPICard label="كفاءة النقل" value={94} target={90} unit="%" progress={104} />
          </Grid>
        </Grid>
              ...
              <CardContent>
                ...
                <List>
                  ...
                  <ListItem>
                    ...
                    <ListItemText primary="تقييم شهري للمستفيدين" secondary="12:00 ظهراً" />
                  </ListItem>
                  <Divider />
                  <ListItem>
                    <ListItemIcon>
                    ...
                    <ListItemText primary="ورشة تدريب للموظفين" secondary="2:00 مساءً" />
                  </ListItem>
                </List>
              </CardContent>
            </Card>
