...
import { Add, Edit, Delete, MoreVert, Search } from '@mui/icons-material';
  ...
  return (
    <Container maxWidth="lg" sx={{ py: 3 }}>
                ...
                {goals.length > 0 ? (
                  goals.map(goal => (
                    <TableRow key={goal.id} hover>
                      ...
                      <TableCell sx={{ maxWidth: 200 }}>{goal.goal_description}</TableCell>
                      ...
                      <TableCell>
                        <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
                          ...
                          />
                          <Typography variant="caption">{goal.current_progress || 0}%</Typography>
                        </Box>
                      </TableCell>
                      <TableCell>
                        <Chip
      ...
      <Dialog open={openDelete} onClose={() => setOpenDelete(false)}>
        ...
        <DialogContent>هل أنت متأكد من حذف هذا الهدف؟</DialogContent>
        <DialogActions>
