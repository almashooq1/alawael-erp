...
import { Edit, Delete, Print, Share, MoreVert, Add, MessageSquare } from '@mui/icons-material';
...
const ReportDetail = () => {
  ...
  if (!report) {
    return <Alert severity="error">لم يتم العثور على التقرير</Alert>;
  }
        ...
        <CardContent>
          <Grid container spacing={2}>
            <Grid item xs={12} md={6}>
              <List dense>
                <ListItem>
                  <ListItemText primary="المستفيد" secondary={report.beneficiary?.first_name} />
                </ListItem>
                <ListItem>
                  <ListItemText
