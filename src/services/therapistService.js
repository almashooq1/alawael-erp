    ...
    return [
      {
        ...
        messages: [
          ...
          { id: 2, sender: 'me', text: 'وعليكم السلام ورحمة الله وبركاته', time: '10:01' },
          {
            ...
            sender: 'other',
            senderName: 'د. محمد أحمد',
            text: 'كيف حالة محمد في آخر جلسة؟',
            time: '10:05',
          },
          {
            id: 4,
            sender: 'me',
            text: 'تحسن ملحوظ جداً، نطق كلمات جديدة بشكل صحيح',
            time: '10:06',
          },
        ],
      },
      {
        ...
        messages: [
          ...
          { id: 2, sender: 'me', text: 'أهلا', time: '09:01' },
          {
            ...
            sender: 'other',
            senderName: 'فاطمة',
            text: 'الاجتماع غداً الساعة 3 مساءً',
            time: '09:05',
          },
        ],
      },
      {
        ...
        messages: [
          ...
          { id: 2, sender: 'me', text: 'وعليكم السلام', time: 'أمس' },
          {
            ...
            sender: 'other',
            senderName: 'الإدارة',
            text: 'يرجى تقديم التقارير قبل نهاية الأسبوع',
            time: 'الآن',
          },
        ],
      },
      ...
      },
      {
        ...
        starred: false,
        messages: [
          { id: 1, sender: 'other', senderName: 'خالد', text: 'مرحباً', time: 'الأسبوع الماضي' },
        ],
      },
    ];
  },
