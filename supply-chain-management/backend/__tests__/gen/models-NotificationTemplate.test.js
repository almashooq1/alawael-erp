/**
 * Auto-generated test for ../../models/NotificationTemplate.js
 * Project: scm-backend
 * Type: model
...
describe('../../models/NotificationTemplate.js', () => {
  let src;

  beforeAll(() => {
    const filePath = path.resolve(__dirname, '../../models/NotificationTemplate.js');
    ...
    test('file has reasonable length (460 lines)', () => {
      expect(460).toBeGreaterThan(0);
      expect(460).toBeLessThan(10000);
    });
