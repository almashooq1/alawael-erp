/**
 * Auto-generated test for ../../models/ReportTemplate.js
 * Project: scm-backend
 * Type: model
...
describe('../../models/ReportTemplate.js', () => {
  let src;

  beforeAll(() => {
    const filePath = path.resolve(__dirname, '../../models/ReportTemplate.js');
    ...
    test('file has reasonable length (488 lines)', () => {
      expect(488).toBeGreaterThan(0);
      expect(488).toBeLessThan(10000);
    });
