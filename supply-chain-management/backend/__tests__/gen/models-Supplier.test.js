/**
 * Auto-generated test for ../../models/Supplier.js
 * Project: scm-backend
 * Type: model
...
describe('../../models/Supplier.js', () => {
  let src;

  beforeAll(() => {
    const filePath = path.resolve(__dirname, '../../models/Supplier.js');
    ...
    test('file has reasonable length (28 lines)', () => {
      expect(28).toBeGreaterThan(0);
      expect(28).toBeLessThan(10000);
    });
