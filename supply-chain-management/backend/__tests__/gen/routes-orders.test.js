/**
 * Auto-generated test for ../../routes/orders.js
 * Project: scm-backend
 * Type: route
...
describe('../../routes/orders.js', () => {
  ...
  beforeAll(() => {
    const filePath = path.resolve(__dirname, '../../routes/orders.js');
