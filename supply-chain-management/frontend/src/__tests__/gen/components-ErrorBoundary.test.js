/**
 * Auto-generated test for ../../components/ErrorBoundary.js
...
describe('../../components/ErrorBoundary.js', () => {
  let src;

  beforeAll(() => {
    const filePath = path.resolve(__dirname, '../../components/ErrorBoundary.js');
    ...
    test('file has reasonable length (84 lines)', () => {
      expect(84).toBeGreaterThan(0);
      expect(84).toBeLessThan(10000);
    });
