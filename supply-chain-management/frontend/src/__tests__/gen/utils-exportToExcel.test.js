/**
 * Auto-generated test for ../../utils/exportToExcel.js
...
describe('../../utils/exportToExcel.js', () => {
  let src;

  beforeAll(() => {
    const filePath = path.resolve(__dirname, '../../utils/exportToExcel.js');
    ...
    test('file has reasonable length (34 lines)', () => {
      expect(34).toBeGreaterThan(0);
      expect(34).toBeLessThan(10000);
    });
