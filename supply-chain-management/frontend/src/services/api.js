...
export const createShipment = data => apiClient.post('/api/shipments', data);
...
// BARCODE APIs
export const generateBarcode = productId => apiClient.post(`/api/barcodes/generate`, { productId });

export const scanBarcode = barcode => apiClient.post('/api/barcodes/scan', { barcode });

export const getBarcode = id => apiClient.get(`/api/barcodes/${id}`);
...
export const getCashFlowDashboard = () => apiClient.get('/api/dashboards/cashflow');

export const getRiskDashboard = () => apiClient.get('/api/dashboards/risk');

export const getComplianceDashboard = () => apiClient.get('/api/dashboards/compliance');
...
export const getValidationViolations = () => apiClient.get('/api/dashboards/validation/violations');

export const getComplianceMetrics = () => apiClient.get('/api/dashboards/validation/metrics');
...
export const getComplianceViolations = () => apiClient.get('/api/dashboards/compliance/violations');
...
export const getAdvancedAnalytics = () => apiClient.get('/api/dashboards/advanced-analytics/data');
