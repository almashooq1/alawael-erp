/**
 * Auto-generated test for ../../src/infra/prisma.ts
 * Project: whatsapp
 * Type: module
...
describe('../../src/infra/prisma.ts', () => {
  let src;

  beforeAll(() => {
    const filePath = path.resolve(__dirname, '../../src/infra/prisma.ts');
    ...
    test('file has reasonable length (4 lines)', () => {
      expect(4).toBeGreaterThan(0);
      expect(4).toBeLessThan(10000);
    });
