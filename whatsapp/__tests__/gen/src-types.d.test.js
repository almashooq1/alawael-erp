/**
 * Auto-generated test for ../../src/types.d.ts
 * Project: whatsapp
 * Type: module
...
describe('../../src/types.d.ts', () => {
  let src;

  beforeAll(() => {
    const filePath = path.resolve(__dirname, '../../src/types.d.ts');
    ...
    test('file has reasonable length (2 lines)', () => {
      expect(2).toBeGreaterThan(0);
      expect(2).toBeLessThan(10000);
    });
